...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo1,$io_pdf)
	{
		...
		$text="ALCALDIA MUNICIPAL DEL HATILLO";
		$io_pdf->addText(25,550,11,$text); // Agregar el título		

		$text="DIRECCION SECTORIAL DE ADMINISTRACION Y FINANZAS";
		$io_pdf->addText(25,538,11,$text); // Agregar el título	
		
		$text="COORDINACION DE CONTABILIDAD Y REGISTRO DE BIENES";
		$io_pdf->addText(25,526,11,$text); // Agregar el título	
		
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=400-($li_tm/2);
		$io_pdf->addText($tm,500,11,$as_titulo); // Agregar el título		
		
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo1);
		$tm=400-($li_tm/2);
		$io_pdf->addText($tm,488,11,$as_titulo1); // Agregar el título
	...
	function uf_print_detalle($la_data,$la_data_p,$la_data_t,$total_activo_t,$ls_total_pasivo, $total_pasivo_result,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta_p'=>array('justification'=>'left','width'=>20), // Justificación y ancho de la columna
						 			   'denom_p'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'saldo_p'=>array('justification'=>'right','width'=>120))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta_t'=>array('justification'=>'left','width'=>20), // Justificación y ancho de la columna
						 			   'denom_t'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'saldo_t'=>array('justification'=>'right','width'=>120))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>560, // Ancho Máximo de la tabla				
						 'xOrientation'=>'right', // Orientación de la tabla
						 'cols'=>array('total'=>array('justification'=>'right','width'=>220),
						               'vacio'=>array('justification'=>'right','width'=>120))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>560, // Ancho Máximo de la tabla				
						 'xOrientation'=>'left', // Orientación de la tabla
						 'cols'=>array('total'=>array('justification'=>'right','width'=>340),
						               'vacio'=>array('justification'=>'right','width'=>10))); // Justificación y ancho de la columna
		$la_columnas=array('total'=>'','vacio'=>'');
	...
	function uf_print_detalle_2($la_data,$la_data_p_h,$ad_tot_act_hac,$ad_tot_pas_hac,$ad_resultado=0,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta_h'=>array('justification'=>'left','width'=>20), // Justificación y ancho de la columna
						 			   'denom_h'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'saldo_h'=>array('justification'=>'right','width'=>120),
						 			   'vacio'=>array('justification'=>'right','width'=>10))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta_p_h'=>array('justification'=>'left','width'=>20), // Justificación y ancho de la columna
						 			   'denom_p_h'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'saldo_p_h'=>array('justification'=>'right','width'=>120))); // Justificación y ancho de la columna
	...
	function uf_print_detalle_3($la_data,$la_data_g,$ls_total_ingreso,$ls_total_gastos,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta_g'=>array('justification'=>'left','width'=>20), // Justificación y ancho de la columna
						 			   'denom_g'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'saldo_g'=>array('justification'=>'right','width'=>120),
						 			   'vacio'=>array('justification'=>'right','width'=>10))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta_i'=>array('justification'=>'left','width'=>20), // Justificación y ancho de la columna
						 			   'denom_i'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'saldo_i'=>array('justification'=>'right','width'=>120))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'right','width'=>20),
						               'vacio'=>array('justification'=>'right','width'=>320))); // Justificación y ancho de la columna
		$la_columnas=array('total'=>'','vacio'=>'');
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$la_data[6]=array('firma1'=>'Lic. Guillermo Mendez Hurtado','firma2'=>'','firma3'=>'Lic. Elizabeth Zabala Ruiz');
		$la_data[7]=array('firma1'=>'DIRECTOR GENERAL SECTORIAL DE ADMINISTRACION  Y FINANZAS','firma2'=>'','firma3'=>'COORDINADORA GENERAL DE CONTABILIDAD Y  REGISTRO DE BIENES');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('firma1'=>array('justification'=>'center','width'=>275), // Justificación y ancho de la columna
						 			   'firma2'=>array('justification'=>'center','width'=>50),
						 			   'firma3'=>array('justification'=>'center','width'=>275))); // Justificación y ancho de la columna
	...
	require_once("sigesp_scf_class_bal_general_hatillo.php");
	$io_report  = new sigesp_scf_class_bal_general_hatillo();
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
		...
		$ls_titulo="<b>BALANCE DE LA HACIENDA PUBLICA MUNICIPAL</b>";
		$ls_titulo1="<b> al ".$ld_fechas."</b>";
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	if($lb_valido)
	{
		...
		$io_pdf->ezSetCmMargins(5,2,2,2); // Configuración de los margenes en centímetros
		...
		$io_pdf->ezStartPageNumbers(760,50,10,'','',1); // Insertar el número de página
			...
			for($li_i=1;$li_i<=$li_tot;$li_i++)
			{
				...
				///--------------------------------------------------------------------------------------------
				$total_activo_t=$total_activo_t+abs($ld_saldo);
				$ld_saldo_t=$ld_saldo_t+abs($ld_saldo);
				if($ld_saldo<0)
				{ 
			...
			{ 
				...
				$ls_total_pasivo=$ls_total_pasivo+abs($ld_saldo_p);
				$ld_saldo_t=$ld_saldo_t-abs($ld_saldo_p);
				if($ld_saldo_p<0)
				{ 
			...
			$la_data_h[1]=array('cuenta_h'=>'200','denom_h'=>'SITUACION FISCAL DEL TESORO','saldo_h'=>$ld_saldo_h,'vacio'=>'');			
			...
			{ 
				...
				$ld_saldo_h=number_format($io_report->ds_activo_h->data["saldo_h"][$li_k],2,".","");						
				$ls_total_activo_H=number_format($ls_total_activo_H+$ld_saldo_h,2,".","");
				if($ld_saldo_h<0)
				{ 
				 $ld_saldo_h="(".number_format(abs($ld_saldo_h),2,",",".").")";				
				}
				...
				$la_data_h[$li_k+1]=array('cuenta_h'=>$ver,'denom_h'=>$ls_denom_h,'saldo_h'=>$ld_saldo_h,'vacio'=>'');
			...
			{ 
				...
				$ld_saldo_p_h=number_format($io_report->ds_pasivo_h->data["saldo_p_h"][$li_l],2,".","");						
				$ls_total_pasivo_H=number_format($ls_total_pasivo_H+$ld_saldo_p_h,2,".","");
				if($ld_saldo_p_h<0)
				{ 
			...
			{ 
				...
				$ld_saldo_i=number_format($io_report->ds_ingreso->data["saldo_i"][$li_m],2,".","");						
				$ls_total_ingreso=number_format($ls_total_ingreso+$ld_saldo_i,2,".","");
				if($ld_saldo_i<0)
				{ 
			...
			{ 
				...
				$ld_saldo_g=number_format($io_report->ds_gasto->data["saldo_g"][$li_n],2,".","");
				$ls_total_gastos=number_format($ls_total_gastos+$ld_saldo_g,2,".","");
				if($ld_saldo_g<0)
				{ 
			...
			$la_data_t[1]=array('cuenta_t'=>'199','denom_t'=>'SITUACION FINANCIERA DEL TESORO','saldo_t'=>$ld_saldo_t);
			...
			$ld_total_resultado = number_format($ls_total_ingreso - $ls_total_gastos,2,".","");	    
			...
			if($ld_total_resultado<>0)
			{
			  if($ld_total_resultado>0)
			  {
			   $ls_total_gastos = number_format($ls_total_gastos + $ld_total_resultado,2,".","");
			  }
			  else
			  {
			   $ls_total_ingreso = number_format($ls_total_ingreso + abs($ld_total_resultado),2,".","");
			  }
		    }
			...
			{	
			    ...
			    uf_print_detalle_4(180,$ld_total_activo,$ld_total_pasivo,$io_pdf);
			}
			else {
				uf_print_detalle_4(180,$ld_total_activo,$ld_total_pasivo,$io_pdf);
			}
