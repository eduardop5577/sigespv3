...
***********************************************************************************/
	...
	$arrResultado = $io_fun_scg->uf_load_seguridad("SCF","sigesp_scf_r_balance_general_anual.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_permisos = $arrResultado['as_permisos'];
	$la_seguridad = $arrResultado['aa_seguridad'];
	$la_permisos = $arrResultado['aa_permisos'];
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	$ls_codemp=$_SESSION["la_empresa"]["codemp"];
	$ls_reporte   = $io_fun_scg->uf_select_config("SCF","REPORTE","BALANCE_GENERAL_ANUAL","sigesp_scf_rpp_balance_general_anual.php","C");//print $ls_reporte;
	$ls_reporteexcel   = $io_fun_scg->uf_select_config("SCF","REPORTE","BALANCE_GENERAL_ANUAL_EXCEL","sigesp_scf_rpp_balance_general_excel.php","C");//print $ls_reporte;
?>
...
<table width="330" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td height="24" colspan="3" align="center" class="titulo-ventana">Balance General Anual </td>
    </tr>
