...
***********************************************************************************/
	...
	$arrResultado = $io_fun_scf->uf_load_seguridad("SCF","sigesp_scf_r_mayor_analitico.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<title>Reporte Mayor Anal&iacute;tico</title>
    ...
    <tr>
      ...
      <table width="600" height="22" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr class="titulo-ventana">
          <td height="22" colspan="4" align="center">Reporte Mayor Anal&iacute;tico</td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="22" align="center"><div align="right">Ordenar </div>
...
function ue_search()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/sigesp_scf_rpp_mayor_analitico.php?fecdes="+fecdes+"&fechas="+fechas+"&orden="+orden;
			pagina=pagina+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta+"&tiporeporte="+tiporeporte;
...
function ue_openexcel()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/sigesp_scf_rpp_mayor_analitico_excel.php?fecdes="+fecdes+"&fechas="+fechas+"&orden="+orden;
			pagina=pagina+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta+"&tiporeporte="+tiporeporte;
			window.open(pagina,"Reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
   	}
