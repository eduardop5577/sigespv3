...
***********************************************************************************/
	...
	$arrResultado = $io_fun_scf->uf_load_seguridad("SCF","sigesp_scf_r_listadocuentas.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<title>Reporte Listado de Cuentas</title>
    ...
    <tr>
      ...
      <table width="600" height="22" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr class="titulo-ventana">
          <td height="22" colspan="4" align="center">Reporte Listado de Cuentas </td>
        </tr>
        <tr>
...
function ue_search()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/sigesp_scf_rpp_listadocuentas.php?cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;
...
function ue_openexcel()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/sigesp_scf_rpp_listadocuentas_excel.php?cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;
			window.open(pagina,"Reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
   	}
	else
