...
class class_srh
{
	...
	{	
		...
		// Fecha CreaciÃ³n: 22/02/2008 								Fecha Ãšltima ModificaciÃ³n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_select_config($as_sistema, $as_seccion, $as_variable, $as_valor, $as_tipo)
	{
		...
		//				   as_seccion  // SecciÃ³n a la que pertenece la variable
		//				   as_variable  // Variable nombre de la variable a buscar
		//				   as_valor  // valor por defecto que debe tener la variable
		//				   as_tipo  // tipo de la variable
		//	      Returns: $ls_resultado variable buscado
		//	  Description: FunciÃ³n que obtiene una variable de la tabla config
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha CreaciÃ³n: 01/01/2006 								Fecha Ãšltima ModificaciÃ³n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$ls_valor="";
		$ls_sql="SELECT value ".
				"  FROM sigesp_config ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->SNO MÃ‰TODO->uf_select_config ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_valido=false;
		}
		else
		{
