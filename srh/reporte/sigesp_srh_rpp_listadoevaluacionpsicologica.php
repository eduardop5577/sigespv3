...
//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_srh->uf_load_seguridad_reporte("SRH","sigesp_srh_r_listado_evaluacionpsicologica.php",$ls_descripcion);
		return $lb_valido;
	}
...
//--------------------------------------------------  Parámetros para Filtar el Reporte  -----------------------------------------
	...
	$ld_concurdes=$io_fun_srh->uf_obtenervalor_get("txtcurdes","");
	$ld_concurhas=$io_fun_srh->uf_obtenervalor_get("txtcurhas","");
