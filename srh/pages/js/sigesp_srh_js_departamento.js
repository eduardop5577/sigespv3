...
function ue_cancelar()
{
  ...
  document.form1.hidstatus.value="1";
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		...
		window.open("../catalogos/sigesp_srh_cat_departamento.php?tipo=2","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
