...
function ue_guardar()
{
  ...
  if (ls_control==0)
  {
	  ...
	  var la_mensajes=new Array ("el numero de evaluacion","el tipo de evaluacion",  "la fecha inicial del periodo de evaluacion" ,"la fecha final del periodo de evaluacion", "el c�digo del personal", "la fecha de la evaluacion","el c�digo del evaluador", "el c�digo del supervisor del evaluador", "el comentario del supervisor");
	  ...
	  if (($F('txtcodsup') == $F('txtcodeva'))  && ($F('txtcodeva')!=""))
		{  
		 alert("El Codigo del Supervisor y el Codigo del Evaluador deben ser diferentes.");
		 lb_valido = false;
		}
	 lb_valido2= ue_comparar_fechas($('txtfecini').value,$('txtfecfin').value,$('txtfecfin'));  
	  ...
	  if((!lb_valido)||(!lb_val))
	  {
		  ...
		  //Arreglo de los objetivos de desempe�o individual
		  var odis = new Array();
		 ...
		 for (f=1; f<(filas.length - 1); f++)
		  {
		   ...
		   //Arreglo de las competencias de evaluaci�n
...
function ue_eliminar()
{
  ...
  var la_mensajes=new Array ("el n�mero de evaluaci�n. Seleccione una Evaluaci�n del Catalago");
  ...
  {
	   alert("Debe elegir una Evaluaci�n del Catalago");
...
function Consultar()
{
     if  ( ($('txtcodper').value=="") ) 		
	 {
		 alert("Debe llenar el C�digo de Personal.");	
...
function ue_print()
{
	...
	{	
   	...
   	{
 		alert("No tiene permiso para realizar esta operaciÃ³n");
   	}		
}
