...
{  
  ...
  $arrResultado = $io_evaluacion_desempeno-> uf_srh_guardarevaluacion_desempeno ($io_obj->nroeval,$io_obj,$_POST["insmod"],$ls_comp, $la_seguridad); 
  $ls_comp = $arrResultado['as_comp'];
