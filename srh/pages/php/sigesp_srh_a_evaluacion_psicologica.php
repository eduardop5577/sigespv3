...
{  
  ...
  else {$ls_salida = 'Error al guardar la Evaluación Psicologica';}
 
}
elseif ($ls_operacion == "ue_eliminar")
{  
  $io_evaluacion_psicologica->uf_srh_eliminarevaluacion_psicologica($_GET["codper"],$_GET["codcon"],$_GET["fecha"], $la_seguridad);
