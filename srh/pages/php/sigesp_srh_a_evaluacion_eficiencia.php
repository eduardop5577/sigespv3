...
{  
  ...
  $io_obj->fecha=$io_funcion->uf_convertirdatetobd($io_obj->fecha);
  $io_obj->fecini=$io_funcion->uf_convertirdatetobd($io_obj->fecini);
  $io_obj->fecfin=$io_funcion->uf_convertirdatetobd($io_obj->fecfin);
