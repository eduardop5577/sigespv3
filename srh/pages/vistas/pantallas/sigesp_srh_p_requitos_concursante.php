...
<?php 
	...
	{
		case "CARGAR":
			$arrResultado=$io_req->uf_srh_cargar_requistos_concurso($ls_codcon,$li_totrows,$lo_object);
		...
		case "CONSULTAR":
			$arrResultado=$io_req->uf_srh_consultar_requistos_concursante($ls_codcon,$ls_codper,$li_totrows,$lo_object,$lb_existe);
			$li_totrows=$arrResultado['ai_totrows'];
			$lo_object=$arrResultado['ao_object'];
