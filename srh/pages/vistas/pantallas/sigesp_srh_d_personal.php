...
***********************************************************************************/
	...
	$la_seguridad = Array();
	$la_permisos = Array();
	$arrResultado = 	$io_fun_srh->uf_load_seguridad("SRH","sigesp_srh_d_personal.php",$ls_permisos,$la_seguridad,$la_permisos);
    ...
    <div class="yui-content">
        ...
        <tr>
          ...
          <td width="403"><div align="left">
          	<?php 
          		if ($_SESSION['la_empresa']['codperalf'] == '0') {
          	?>	
            ...
            <?php 
          		...
          		else if ($_SESSION['la_empresa']['codperalf'] == '1') {
			?>  
          	  <input name="txtcodper" type="text" id="txtcodper" size="13" maxlength="10"   onKeyUp="javascript: ue_validaralfanumerico(this);" onBlur="javascript: ue_rellenarcampo(this,10);ue_chequear_codper()">
          	 <?php 
          		}
          	?>
  ...
  <input name="reset" type="reset" onclick="return showCalendar('txtfecfevid', '%d/%m/%Y');" value=" ... " />          </td>
	  ...
	  <tr>
		...
		<tr>
         ...
         <td colspan="3">
           <div align="left">
             <input name="chkestbec" type="checkbox" class="sin-borde" id="chkestbec" value="1" >
             </div></td></tr>
        <tr>
	...
	<div><p><table width="677" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
	  ...
	  <tr>
       ...
       <tr class="titulo-ventana">
        ...
        <td  colspan="3"><div align="right" class="sin-borde2">C&oacute;digo Personal</div></td>
        <td align="right"><div align="left">
          <input name="txtcodper9" type="text" id="txtcodper9" size="28" class="sin-borde" readonly>
        </div></td>
      </tr>
        <tr>
        <td  colspan="3"><div align="right" class="sin-borde2">N&ordm; Expediente</div></td>
        <td align="right"><div align="left">
          <input name="txtnumexpper9" type="text" id="txtnumexpper9" size="28" class="sin-borde" readonly>
        </div></td>
      </tr>
	  <tr>
        <td  colspan="3" align="right"><div align="right" class="sin-borde2">Tipo Personal</div></td>
        <td  align="right"><div align="left"><input name="txtdestippersss9" type="text" id="txtdestippersss9" size="28" class="sin-borde" readonly></div></td>
      </tr>
        <tr>
          <td height="22"><div align="right">C&oacute;digo</div></td>
          <td colspan="3">
