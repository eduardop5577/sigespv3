...
<script type="text/javascript"  src="../../js/sigesp_srh_js_departamento.js"></script>
...
<p>&nbsp;</p>
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function aceptar_personal (ls_coddep,ls_dendep,ls_coddestino,ls_dendestino, ls_coduniadm, ls_coduniadmdestino, ls_denuniadm, ls_denuniadmdestino, ls_codger,ls_denger,ls_codgerdestino,ls_dengerdestino)
		{
