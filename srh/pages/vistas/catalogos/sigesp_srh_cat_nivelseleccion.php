...
<html>
<head>
<title>Cat&aacute;logo  de Niveles de Selecci&oacute;n</title>
...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo  de Niveles de Selecci&oacute;n</td>
    </tr>
  </table>
<br>
    <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td width="431" height="22"><div align="left">
          <input name="txtcodniv" type="text" id="txtcodniv"onKeyUp="javascript: Buscar()">
        </div></td>
      </tr>
      <tr>
        <td><div align="right">Denominaci&oacute;n</div></td>
        <td height="22"><div align="left">          <input name="txtdenniv" type="text" id="txtdenniv" onKeyUp="javascript: Buscar()">
        </div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
...
<p>&nbsp;</p>
	...
	<script>
		...
		var loadDataURL = "../../php/sigesp_srh_a_nivelseleccion.php?valor=createXML";
		var actionURL = "../../php/sigesp_srh_a_nivelseleccion.php";
		var mygrid;
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/sigesp_srh_a_nivelseleccion.php?valor=buscar"+"&txtcodniv="+codniv+"&txtdenniv="+denniv);
           setTimeout (terminar_buscar,500);
			
		}
		
		function aceptar(ls_codniv,ls_denniv,ls_coddestino,ls_dendestino)
		{
			obj=eval("opener.document.form1."+ls_coddestino+"");
			obj.value=ls_codniv;
			obj1=eval("opener.document.form1."+ls_dendestino+"");
			obj1.value=ls_denniv;
