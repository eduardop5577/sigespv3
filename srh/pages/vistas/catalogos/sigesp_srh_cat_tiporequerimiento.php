...
<html>
<head>
<title>Cat&aacute;logo de Tipos de Requerimientos</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<script type="text/javascript"  src="../shared/js/valida_tecla.js"></script>
<script type="text/javascript"  src="../../js/sigesp_srh_js_tiporequerimiento.js"></script>
...
<input name="hidstatus" type="hidden" id="hidstatus" value="<?php print $ls_ejecucion ?>">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Tipos de Requerimientos </td>
    </tr>
  </table>
<br>
    <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td width="431" height="22"><div align="left">
          <input name="txtcodtipreq" type="text" id="txtcodtipreq" onKeyUp="javascript: Buscar()">
        </div></td>
      </tr>
      <tr>
        <td><div align="right">Denominaci&oacute;n</div></td>
        <td height="22"><div align="left">          <input name="txtdentipreq" type="text" size="60" maxlength="254" id="txtdentipreq" onKeyUp="javascript: Buscar()">
        </div></td>
      </tr>
      <tr>
...
<p>&nbsp;</p>
	...
	<script>
		...
		var loadDataURL = "../../php/sigesp_srh_a_tiporequerimiento.php?valor=createXML";
		var actionURL = "../../php/sigesp_srh_a_tiporequerimiento.php";
		var mygrid;
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/sigesp_srh_a_tiporequerimiento.php?valor=buscar"+"&txtcodtipreq="+codtipreq+"&txtdentipreq="+dentipreq);
           setTimeout (terminar_buscar,500);
			
		}
		
		function aceptar(ls_codtipreq,ls_dentipreq,ls_coddestino,ls_dendestino)
		{
			obj=eval("opener.document.form1."+ls_coddestino+"");
			obj.value=ls_codtipreq;
			obj1=eval("opener.document.form1."+ls_dendestino+"");
			obj1.value=ls_dentipreq;
			...
			opener.document.form1.txtcodtipreq.readOnly=true;
			close();
		}
