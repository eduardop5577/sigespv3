...
<html>
<head>
<title>Cat&aacute;logo de Educaci&oacute;n Informal</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">

<script type="text/javascript"  src="../../../public/js/librerias_comunes.js"></script>
<script type="text/javascript"  src="../../js/sigesp_srh_js_inscripcion_concurso.js"></script>
...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Educaci&oacute;n Informal</td>
    </tr>
...
<script >
        ...
        var loadDataURL = "../../php/sigesp_srh_a_inscripcion_concurso.php?valor=createXML_cursos";
	...
	function aceptar(ls_codcur,ls_descur,ls_codcurdestino,ls_descurdestino,ls_horcur,ls_horcurdestino)
	{
		
		
		  obj=eval("opener.document.form1."+ls_codcurdestino+"");
		  obj.value=ls_codcur;
	      obj1=eval("opener.document.form1."+ls_descurdestino+"");
	      obj1.value=ls_descur;
	   	  obj2=eval("opener.document.form1."+ls_horcurdestino+"");
		  obj2.value=ls_horcur;
		  
	      opener.document.form1.hidguardar_cur.value='modificar';
		  close();
	}
