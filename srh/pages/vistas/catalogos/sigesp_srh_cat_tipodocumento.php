...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo  de Tipo de Documento</td>
    </tr>
  </table>
<br>
    <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td width="431" height="22"><div align="left">
          <input name="txtcodtipdoc" type="text" id="txtcodtipdoc"  onKeyUp="javascript: Buscar()">
        </div></td>
      </tr>
      <tr>
        <td><div align="right">Denominaci&oacute;n</div></td>
        <td height="22"><div align="left">          <input name="txtdentipdoc"  size="60" maxlength="254" type="text" id="txtdentipdoc"  onKeyUp="javascript: Buscar()">
        </div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
...
<p>&nbsp;</p>
	...
	<script>
		var mygrid;
		var loadDataURL = "../../php/sigesp_srh_a_tipodocumento.php?valor=createXML";
		var actionURL = "../../php/sigesp_srh_a_tipodocumento.php";	
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/sigesp_srh_a_tipodocumento.php?valor=buscar"+"&txtcodtipdoc="+codtipdoc+"&txtdentipdoc="+dentipdoc);
 		   setTimeout (terminar_buscar,500);
			
		}
		
		function aceptar(ls_codtipdoc,ls_dentipdoc,ls_coddestino,ls_dendestino)
		{
			obj=eval("opener.document.form1."+ls_coddestino+"");
			obj.value=ls_codtipdoc;
			obj1=eval("opener.document.form1."+ls_dendestino+"");
			obj1.value=ls_dentipdoc;
			...
			opener.document.form1.txtcodtipdoc.readOnly=true;
			close();
		}
