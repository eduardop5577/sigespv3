...
<script type="text/javascript"  src="../../js/sigesp_srh_js_aspectos.js"></script>
...
<script >
	...
	function aceptar_cat(ls_codeval,ls_deneval,ls_codevaldestino,ls_denevaldestino)
	{
		obj1=eval("opener.document.form1."+ls_codevaldestino+".value="+ls_codeval);
		obj1=eval("opener.document.form1."+ls_denevaldestino+".value="+ls_deneval);
		close();
	}
	
	function aceptar(ls_codeval,ls_deneval,ls_codevaldestino,ls_denevaldestino)
	{
		opener.document.form1.txtcodeval.value=ls_codeval;
		opener.document.form1.txtdeneval.value=ls_deneval;
