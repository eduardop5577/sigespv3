...
<html>
<head>
<title>Cat&aacute;logo de Competencias de Adiestramiento</title>
...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Competencias de Adiestramiento </td>
    </tr>
  </table>
<br>
    <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td width="431" height="22"><div align="left">
          <input name="txtcodcompadi" type="text" id="txtcodcompadi" onKeyUp="javascript: Buscar()">
        </div></td>
      </tr>
      <tr>
        <td><div align="right">Denominaci&oacute;n</div></td>
        <td height="22"><div align="left">          <input name="txtdencompadi" type="text" id="txtdencompadi" onKeyUp="javascript: Buscar()">
        </div></td>
      </tr>
      <tr>
      <td>&nbsp;</td>
...
<script>
		...
		var loadDataURL = "../../php/sigesp_srh_a_competencia_adiestramiento.php?valor=createXML";
		var actionURL = "../../php/sigesp_srh_a_competencia_adiestramiento.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/sigesp_srh_a_competencia_adiestramiento.php?valor=buscar"+"&txtcodcompadi="+codcompadi+"&txtdencompadi="+dencompadi);
           setTimeout (terminar_buscar,500);
			
		}
		
		function aceptar(ls_codcompadi,ls_dencompadi,ls_coddestino,ls_dendestino)
		{
			
		
		    obj=eval("opener.document.form1."+ls_coddestino+"");
			obj.value=ls_codcompadi;
			obj1=eval("opener.document.form1."+ls_dendestino+"");
			obj1.value=ls_dencompadi;
			...
			opener.document.form1.txtcodcompadi.readOnly=true;
