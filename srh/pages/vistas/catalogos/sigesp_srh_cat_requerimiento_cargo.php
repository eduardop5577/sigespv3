...
<script type="text/javascript"  src="../../js/sigesp_srh_js_requerimiento_cargo.js"></script>
...
{
     pagina="../catalogos/sigesp_srh_cat_nomina.php?valor_cat=0";
	 window.open(pagina,"catalogo1","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
		...
		var loadDataURL = "../../php/sigesp_srh_a_requerimiento_cargo.php?valor=createXML";
		var actionURL = "../../php/sigesp_srh_a_requerimiento_cargo.php";
		var mygrid;
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/sigesp_srh_a_requerimiento_cargo.php?valor=buscar"+"&txtcodcar="+codcar+"&txtdescar="+descar+"&txtcodnom="+codnom);
		   setTimeout (terminar_buscar,500);
...
function Limpiar_busqueda () 
{
	...
	document.form1.txtdesnom.value="";
		...
		function aceptar(ls_codcar,ls_descar,ls_codnom,ls_desnom,ls_coddestino,ls_dendestino,ls_codnomdestino,ls_desnomdestino)
		{
			...
			opener.document.form1.action="../pantallas/sigesp_srh_d_requerimiento_cargo.php";
