...
<html>
<head>
<title>Cat&aacute;logo de Profesiones</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<script type="text/javascript"  src="../shared/js/valida_tecla.js"></script>
<script type="text/javascript"  src="../../js/sigesp_srh_js_profesion.js"></script>
...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Profesi&oacute;n </td>
    </tr>
  </table>
<br>
    <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td width="431" height="22"><div align="left">
          <input name="txtcodpro" type="text" id="txtcodpro" onKeyUp="javascript: Buscar()">
        </div></td>
      </tr>
      <tr>
        <td><div align="right">Denominaci&oacute;n</div></td>
        <td height="22"><div align="left">          <input name="txtdespro" type="text" id="txtdespro" onKeyUp="javascript: Buscar()">
        </div></td>
      </tr>
      <tr>
      <td>&nbsp;</td>
...
<script>
		...
		var loadDataURL = "../../php/sigesp_srh_a_profesion.php?valor=createXML";
		var actionURL = "../../php/sigesp_srh_a_profesion.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
   		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/sigesp_srh_a_profesion.php?valor=buscar"+"&txtcodpro="+codpro+"&txtdespro="+despro);
		  setTimeout (terminar_buscar,500);
			
		}
		
		function aceptar(ls_codpro,ls_despro,ls_coddestino,ls_dendestino)
		{
			obj=eval("opener.document.form1."+ls_coddestino+"");
			obj.value=ls_codpro;
			obj1=eval("opener.document.form1."+ls_dendestino+"");
			obj1.value=ls_despro;
