...
//Creacion del formulario pagos
	...
	width: 760,
	height: 170,
	title: "<H1 align='center'>Presupuesto de Caja 0813</H1>",
	frame: true,
	autoScroll: true,
...
function irImprimir()
{
	...
	else
	{
		...
		{ 
			pagina="reportes/sigesp_scg_rpp_presupuestocaja0813.php?trimestre="+cmbtrimestral+"&etiqueta=Trimestral";
		}
		else
		{
			pagina="reportes/sigesp_scg_rpp_presupuestocaja0813_excel.php?trimestre="+cmbtrimestral+"&etiqueta=Trimestral";
		}
