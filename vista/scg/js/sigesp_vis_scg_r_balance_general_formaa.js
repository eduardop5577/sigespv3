...
//Creacion del formulario pagos
	...
	width: 750,
	height: 350,
	title: "<H1 align='center'>Balance General (Forma A)</H1>",
	frame: true,
	autoScroll: true,
...
function irImprimir()
{
	...
	{
		formato='sigesp_scg_rpp_balance_general_sudeban_formaa.php';
	}
	else
	{
		formato='sigesp_scg_rpp_balance_general_sudeban_formaa_excel.php';
	}
