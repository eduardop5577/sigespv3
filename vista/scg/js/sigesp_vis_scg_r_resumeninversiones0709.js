...
//Creacion del formulario pagos
	...
	width: 760,
	height: 500,
	title: "<H1 align='center'>Resumen Inversiones 0709</H1>",
	frame: true,
	autoScroll: true,
...
function irImprimir()
{
	...
	if(valido)
	{
		if(hidbot==1)
		{
			...
			{
				pagina="reportes/sigesp_scg_rpp_resumeninversiones0709.php?mesdes="+cmbmesdes
		...
		if(hidbot==2)
		{
			...
			{
				pagina="reportes/sigesp_scg_rpp_resumeninversiones0709.php?mesdes="+cmbbimensual+"&etiqueta=Bimensual";
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
		if(hidbot==3)
		{
			...
			{
				pagina="reportes/sigesp_scg_rpp_resumeninversiones0709.php?mesdes="+cmbtrimestral+"&etiqueta=Trimestral";
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
		if(hidbot==4)
		{
			...
			{
				pagina="reportes/sigesp_scg_rpp_resumeninversiones0709.php?mesdes="+cmbsemestral+"&etiqueta=Semestral";
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
	}
