...
//Creacion del formulario pagos
	...
	width: 760,
	height: 550,
	title: "<H1 align='center'>Resumen Inversiones 0809</H1>",
	frame: true,
	autoScroll: true,
...
function irImprimir()
{
	...
	if(valido)
	{
		reporte = "sigesp_scg_rpp_resumeninversiones0809.php";
		if (Ext.getCmp('tipoimp').getValue()=='E')
		{
			reporte = "sigesp_scg_rpp_resumeninversiones0809_excel.php";
		}
		if(hidbot==1)
		{
			...
			{
				pagina="reportes/"+reporte+"?mesdes="+cmbmesdes+"&meshas="+cmbmeshas+"&etiqueta=Mensual";
		...
		if(hidbot==2)
		{
			...
			{
				pagina="reportes/"+reporte+"?mesdes="+cmbbimensual+"&etiqueta=Bimensual";
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
		if(hidbot==3)
		{
			...
			{
				pagina="reportes/"+reporte+"?mesdes="+cmbtrimestral+"&etiqueta=Trimestral";
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
		if(hidbot==4)
		{
			...
			{
				pagina="reportes/"+reporte+"?mesdes="+cmbsemestral+"&etiqueta=Semestral";
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
	}
