...
class sigesp_scg_class_reportes_presupuestocaja0813
{
	var $io_msg;
	var $io_fecha;
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
			$this->io_mensajes->message("CLASE->sigesp_scg_class_reportes_presupuestocaja0813 ". 
...
/********************************************************************************************************************************/
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    18/08/2008               Fecha última Modificacion :      Hora :
	  ...
	  if($rs_data===false)
	  {   // error interno sql
		  $this->io_msg->message("CLASE->sigesp_scg_class_reportes_presupuestocaja0813  MÉTODO->uf_spg_reporte_select_saldo_empresa  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		  $lb_valido = false;
	  }
	  else
	  {
...
function uf_spg_reporte_select_saldo_inicial_int_08($as_mesdes,$adt_fecdes,$adt_fechas)
{
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if($rs_data===false)
  {   // error interno sql
	  $this->io_msg->message("CLASE->sigesp_scg_class_reportes_presupuestocaja0813  MÉTODO->uf_spg_reporte_select_saldo_inicial_int_08  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
	  $lb_valido = false;
  }
  else
  {
