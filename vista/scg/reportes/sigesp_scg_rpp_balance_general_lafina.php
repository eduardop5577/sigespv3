...
***********************************************************************************/
	...
	function uf_print_detalle_cueproacu($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>115), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>305), // Justificación y ancho de la columna
									   'saldo_cueproacu'=>array('justification'=>'right','width'=>65), // Justificación y ancho de la columna
									   'saldo'=>array('justification'=>'right','width'=>65))); // Justificación y ancho de la columna
		$la_columnas=array('cuenta'=>'<b>Cuenta</b>',
						   'denominacion'=>'<b>Denominación</b>',
						   'saldo_cueproacu'=>'',
						   'saldo'=>'<b>Saldo</b>');
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_balance_general($ldt_fechas,$li_nivel,true,$ls_rango,$ldt_fecdesde,$ldt_fechasta); 
	}
	...
	{// Imprimimos el reporte
		...
		for($li_i=1;$li_i<=$li_tot;$li_i++){
			...
			//se le resta los costos al resultado
