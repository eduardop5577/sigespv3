...
***********************************************************************************/
	...
	global $la_data_tot;
	require_once("sigesp_scg_class_reportes_presupuestocaja.php");
	$io_report = new sigesp_scg_class_reportes_presupuestocaja();
...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	else // Imprimimos el reporte	 
	{
		...
		unset($la_data_tot);
		$lo_libro->close();
		header("Content-Type: application/x-msexcel; name=\"presupuestodecaja0713.xls\"");
		header("Content-Disposition: inline; filename=\"presupuestodecaja0713.xls\"");
