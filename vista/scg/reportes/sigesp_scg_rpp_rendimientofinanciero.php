...
***********************************************************************************/
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_scg->uf_load_seguridad_reporte("SCG","sigesp_vis_scg_r_rendimiento_financiero.html",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
			...
			switch ($ls_nivel)
			{
				...
				case '4':
					...
					if($li_cuenta+1==$nrecord)
					{
						...
						$la_data[] = array('denominacion'=>$ls_dentotniv1,'nota'=>'    ','periodo_an'=>'<b>'.uf_is_negative($ld_totantingreso-$ld_totalantniv1).'</b>','periodo_ac'=>'<b>'.uf_is_negative(abs($ld_totingreso)-abs($ld_totalniv1)).'</b>');
						$la_data[] = array('denominacion'=>' ','nota'=>'    ','periodo_an'=>'===============','periodo_ac'=>'===============');
					}
