...
***********************************************************************************/
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_scg->uf_load_seguridad_reporte("SCG","sigesp_vis_scg_r_resumeninversiones0709.html",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------  Parámetros del encabezado  --------------------------------------------
		$ls_titulo=" <b>RESUMEN DE  INVERSIONES (FORMA 0709)</b>";       
...
//------------------------------------------------------------------------------------------------------------------------------
	...
	if($lb_valido)
	{
	    $lb_valido=$io_report->uf_scg_reportes_comparados_inversiones_0714($ldt_fecdes,$ldt_fechas,$li_mesdes,$li_meshas,$ls_cant_mes);
	}
	 ...
	 else // Imprimimos el reporte
	{
		...
		for($z=1;$z<=$li_total;$z++)
		{
			...
			$ls_denominacion=htmlentities($io_report->dts_reporte->data["denominacion"][$z]);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		...
		for($z=1;$z<=$li_total;$z++)
		{
			...
			$ls_denominacion=htmlentities($io_report->dts_reporte_venta->data["denominacion"][$z]);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		...
		for($z=1;$z<=$li_total;$z++)
		{
			...
			$ls_denominacion=htmlentities($io_report->dts_reporte_prestamo->data["denominacion"][$z]);
