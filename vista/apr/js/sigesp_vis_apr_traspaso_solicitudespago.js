...
var rutaSol =  '../../controlador/apr/sigesp_ctr_apr_traspaso_solicitudespago.php'; 
...
(
	function()
	{
		...
		record = Ext.data.Record.create([{name: 'codtipdoc'},{name: 'dentipdoc'}]);					
		...
		Ext.getCmp('rdpresupuestario').addListener('check',buscarTipoDocumento);
		Ext.getCmp('rdcontable').addListener('check',buscarTipoDocumento);
		buscarTipoDocumento();
...
***********************************************************************************/			
	function buscarTipoDocumento()
	{
		...
		var objdata ={
			'operacion': 'obtenerTipoDocumento', 
			'tipodoc': tipodoc,
			'sistema': sistema,
			'vista': vista
		};		
...
***********************************************************************************/	
	function irProcesar() //destino,valores,donde
	{
		...
		if (validarObjetos('txtprefijo','4','novacio|alfanumerico')!='0' && validarObjetos('txtfecdesde','12','novacio')!='0' && validarObjetos('txtfechasta','12','novacio')!='0'&& validarObjetos('cmbtipodoc','80','novacio')!='0') 
		{
