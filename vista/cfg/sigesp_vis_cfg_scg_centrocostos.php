...
<html>
	<head>
	    ...
	    <title>SIGESP - Definici&oacute;n de Agencias</title>
        <script type="text/javascript">
			var sistema='CFG';
			var vista = 'sigesp_vis_cfg_scg_centrocostos.php';
			var tbnuevo = false;
		...
		<script type="text/javascript" src="js/sigesp_vis_cfg_scg_centrocostos.js"></script>
	</head>
<body class="modfondo">
	<div id="barra_herramientas"></div>
	<div id="formulario_centrocosto"></div>
</body> 
</html>