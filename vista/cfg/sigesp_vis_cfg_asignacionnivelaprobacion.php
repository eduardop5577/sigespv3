...
<html>
	<head>
	    ...
	    <title >SIGESP - Asignacion Niveles De Aprobación</title> 
		<script type="text/javascript">
            var sistema='CFG';
            var vista='sigesp_vis_cfg_asignacionnivelaprobacion.php';
            var tbnuevo = false;
		...
		<script type="text/javascript" src="js/sigesp_vis_cfg_asignacionnivelaprobacion.js"></script>
	</head>
<body class="modfondo" >
