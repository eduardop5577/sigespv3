...
<html>
	<head>
	    ...
	    <title >SIGESP - Plan de Cuentas Institucional</title> 
    	<script type="text/javascript">
			var sistema='CFG';
			var vista='sigesp_vis_cfg_scg_planinstitucional.php';
			var tbnuevo = false;
    	...
    	<script type="text/javascript" src="js/sigesp_vis_cfg_scg_planinstitucional.js"></script>
	</head>
<body class="modfondo">
	<div id="barra_herramientas"></div>
	<div id="formulario_plan_cta_institucional"></div>
</body> 
</html>