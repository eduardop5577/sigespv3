...
<html>
	<head>
	    ...
	    <title >SIGESP - Fuente Financiamiento</title> 
	    <script type="text/javascript">
			var sistema='CFG';
			var vista='sigesp_vis_cfg_spg_fuentefinanciamiento.php';
			var tbnuevo = false;
		...
		<script type="text/javascript" src="js/sigesp_vis_cfg_spg_fuentefinanciamiento.js"></script>
...
<body class="modfondo" >
	...
	<div id="formulario_fuentefinanciamiento"></div>
</body> 
</html>