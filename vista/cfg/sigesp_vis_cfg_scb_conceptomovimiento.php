...
<html>
	<head>
	    ...
	    <title>SIGESP - Definici&oacute;n de Conceptos de Movimientos</title>
        <script type="text/javascript">
			var sistema='CFG';
			var vista = 'sigesp_vis_cfg_scb_conceptomovimiento.php';
			var tbnuevo = false;
		...
		<script type="text/javascript" src="js/sigesp_vis_cfg_scb_conceptomovimiento.js"></script>
	</head>
<body class="modfondo">
	<div id="barra_herramientas"></div>
	<div id="formulario_conmovimiento"></div>
</body> 
</html>
