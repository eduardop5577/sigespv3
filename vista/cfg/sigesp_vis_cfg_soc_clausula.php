...
<html>
	<head>
	    ...
	    <title>SIGESP - Cl&aacute;usulas</title> 
    	<script type="text/javascript">
			var sistema='CFG';
			var vista='sigesp_vis_cfg_soc_clausula.php';
			var tbnuevo = false;
        ...
        <script type="text/javascript" src="js/sigesp_vis_cfg_soc_clausula.js"></script>
	</head>
<body class="modfondo" >
	<div id="barra_herramientas"></div>
	<div id="formulario_soc_clausula"></div>
</body> 
</html>