...
<html>
	<head>
	    ...
	    <title >SIGESP - Plan de Cuentas Patrimoniales</title> 
    	<script type="text/javascript">
			var sistema='CFG';
			var vista='sigesp_vis_cfg_scg_planpatrimonial.php';
			var tbnuevo = false;
    	...
    	<script type="text/javascript" src="js/sigesp_vis_cfg_scg_planpatrimonial.js"></script>
	</head>
<body class="modfondo">
	<div id="barra_herramientas"></div>
	<div id="formulario_plan_cta_patrimonial"></div>
</body> 
</html>