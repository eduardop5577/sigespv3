...
<html>
	<head>
	    ...
	    <script type="text/javascript">
			var sistema='CFG';
			var vista='sigesp_vis_cfg_spg_traspasocuentas.php';
			var tbnuevo = false;
		...
		<script type="text/javascript" src="js/sigesp_vis_cfg_spg_traspasocuentas.js"></script>
	</head>
<body class="modfondo" >
	<div id="barra_herramientas"></div>
	<div id="formulario_traspasocuenta"></div>
</body> 
</html>