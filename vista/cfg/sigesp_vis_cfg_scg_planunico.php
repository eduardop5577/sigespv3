...
<html>
	<head>
	    ...
	    <title >SIGESP - Configuraci&oacute;n</title> 
    	<script type="text/javascript">
			var sistema='CFG';
			var vista='sigesp_vis_cfg_scg_planunico.php';
			var tbnuevo = false;
		...
		<script type="text/javascript" src="js/sigesp_vis_cfg_scg_planunico.js"></script>
	</head>
<body class="modfondo">
	<div id="barra_herramientas"></div>
	<div id="formulario_plan_unico_re"></div>
</body> 
</html>