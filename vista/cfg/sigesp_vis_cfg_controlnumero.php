...
<html>
	<head>
	    ...
	    <title >SIGESP -Registro de Control de Numero</title> 
	<script type="text/javascript">
            var sistema='CFG';
            var vista='sigesp_vis_cfg_controlnumero.php';
            var tbnuevo = false;
	...
	<script type="text/javascript" src="../../base/librerias/js/general/sigesp_lib_comunes.js"></script>
        <script type="text/javascript" src="catalogo/sigesp_vis_cfg_catalogo_controlnumero.js"></script>
        <script type="text/javascript" src="../sss/catalogo/sigesp_vis_sss_catalogo_usuarios.js"></script>
	<script type="text/javascript" src="js/sigesp_vis_cfg_controlnumero.js"></script>
	</head>
<body class="modfondo" >
	<div id="barra_herramientas"></div>
		<div id="formulario_control_nro"></div>
