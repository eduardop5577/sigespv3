...
<html>
	<head>
	    ...
	    <title >SIGESP - Definici&oacute;n de Correo</title> 
        <script type="text/javascript">
            var sistema='CFG';
            var vista='sigesp_vis_cfg_correo.php';
            var tbnuevo = false;
        ...
        <script type="text/javascript" src="js/sigesp_vis_cfg_correo.js"></script>
	</head>
<body class="modfondo" >
	<div id="barra_herramientas"></div>
	<div id="formulario_correo"></div>
</body> 
</html>