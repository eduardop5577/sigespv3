...
function crear_data_store_cod_denominacion()
{
	...
	var objeto_cod_denominacion={"raiz":[{"codsis":'',"nomsis":''}]};
...
function crearFormBusqueda()
{
		...
		items: [{
				...
				changeCheck: function(){
							var v = this.getValue();
							act_data_store_cod_denominacion('codsis',v);
							...
							{
										var v = this.getValue();
										act_data_store_cod_denominacion('nomsis',v);
										if(String(v) !== String(this.startValue))
										{
											this.fireEvent('change', this, v, this.startValue);
										} 
...
function mostrar_catalogo_cod_denominacion()
{
				   crear_grid_catalogo();
