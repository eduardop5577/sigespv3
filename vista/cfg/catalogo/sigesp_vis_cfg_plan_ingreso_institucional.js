...
function crearDsPlanIngreso()
{
	...
	var objetoplaningreso={"raiz":[{"spi_cuenta":'',"denominacion":'',"sc_cuenta":'',"status":''}]};
...
function pasarDatosGridPlanIngreso()
{
	...
	p.set('denominacion',gridplaningreso.getSelectionModel().getSelected().get('dencta'));
	p.set('sc_cuenta',gridplaningreso.getSelectionModel().getSelected().get('sc_cuenta'));	
}


function catalogoPlanIngreso(registroActual)
{
				   ...
				   ventanaplaningreso = new Ext.Window(
                   {
                    ...
                    handler: function()
                    	{ 
                    		rec = gridCatalogoPlanIngreso.getSelectionModel().getSelected().get('spi_cuenta')
...
var personalizado = catalogoPlanIngreso(registroActual);