...
<title>Regístro del Comprobante de Traspaso</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_traspaso.php';
		var tbnuevo = false;
...
<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_traspaso.js"></script>
</head>
<body class="modfondo">
<div id="barra_herramientas"></div>
<div id="formComprobanteTraspaso"></div>
</body>
</html>
