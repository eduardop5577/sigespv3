...
<title>Reporte Modificación del Programado</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_reporte_modif_programado.php';
		var tbnuevo = false;
...
<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_reporte_modif_programado.js"></script>
</head>
<body class="modfondo">
<div id="barra_herramientas"></div>
<div id="formReporteModifProg"></div>
</body>
</html>