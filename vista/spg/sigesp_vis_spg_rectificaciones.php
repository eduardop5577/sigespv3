...
<title>Regístro del Comprobante de Rectificaciones</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_rectificaciones.php';
		var tbnuevo = false;
...
<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_rectificacion.js"></script>
</head>
<body class="modfondo">
<div id="barra_herramientas"></div>
<div id="formComprobanteRectificacion"></div>
</body>
</html>
