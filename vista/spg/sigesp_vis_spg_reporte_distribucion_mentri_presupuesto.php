...
<title>Reporte Distribución Mensual/Trimestral del Presupuesto</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_reporte_distribucion_mentri_presupuesto.php';
		var tbnuevo = false;
	...
	<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_reporte_distribucion_mentri_presupuesto.js"></script>
</head>
<body class="modfondo">
<div id="barra_herramientas"></div>
<div id="formReporteDisMenTriPre"></div>
</body>
</html>