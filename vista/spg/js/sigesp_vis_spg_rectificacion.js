...
Ext.onReady(function() {
	...
	gridDetPresupuestario = new Ext.grid.EditorGridPanel({
 		...
 		height:200,
		frame:true,
		title:"<H1 align='center'>Cuentas de Rectificaciones Presupuestarias</H1>",
		...
		autoScroll:true,
 		...
 		ds: dsDetPresupuestario,
	  	...
	  	tbar:[{
		        text:'Agregar a Cuentas de Rectificaciones Presupuestarias',
		        tooltip:'Agregar',
		        iconCls:'agregar',
		        id: 'btagrebie',
		        handler: function(){
	...
	gridDetCuentas = new Ext.grid.EditorGridPanel({
 		...
 		height:200,
		frame:true,
		title:"<H1 align='center'>Otras Cuentas</H1>",
		sm:new Ext.grid.CheckboxSelectionModel({singleSelect:false}),
	...
	fieldset = new Ext.form.FieldSet({
		...
		items: [{
				...
				items: [{
						...
						items: [{
								xtype:"textfield",
								fieldLabel: 'Total Cuentas de Rectificaciones',
								labelSeparator:'',
								readOnly:true,
								id:'totalcuerec',
								width:150,
	...
	fieldsetdos = new Ext.form.FieldSet({
		...
		height: 60,
		title: '',
		style: 'position:absolute;left:500px;top:685px',
		cls :'fondo',
		items: [{
				layout:"column",
				border:false,
				items: [{
						...
						items: [{
								xtype:"textfield",
								fieldLabel: 'Total Otras Cuentas',
								labelSeparator:'',
								readOnly:true,
								id:'totalotracue',
								width:150,
	...
	var unidad_ejecutora = Ext.data.Record.create([
  	...
  	comcampocatUnidadEjecutora = new com.sigesp.vista.comCampoCatalogo({
  			...
  			arrfiltro:[{etiqueta:'C&#243;digo',id:'codicuentad',valor:'coduac',longitud:'10'},
	...
	fromComprobanteRectificaciones = new Ext.FormPanel({
		title: "<H1 align='center'>Comprobante de Rectificaciones</H1>",
		applyTo: 'formComprobanteRectificacion',
		width: 845,
		height: 550,
	...
	function irGuardar()
	{
		if(Ext.getCmp('procede').getValue()!='SPGREC')
		{
			Ext.Msg.show({
				title:'Mensaje',
		...
		else
		{
	        ...
	        var monto = Math.round((montouno+montodos) * 100) / 100;
	...
	function CatalogoComprobante()
	{
	    ...
	    var ventanaEstructura = new Ext.Window({
	    	...
	    	modal: true,
	    	frame:true,
	    	title:"<H1 align='center'>Cat&#225;logo de Comprobante Rectificaciones</H1>",
