...
Ext.onReady(function() {
	...
	fromReporteEjecFinPryAcc = new Ext.FormPanel({
		...
		width:600, 
		height: 300,
		title: "<H1 align='center'>0604 - Ejecución Financiera de los Proyectos/ Acciones Centralizadas del Organo</H1>",
		frame:true,
		autoScroll:true,
	...
	function irImprimir()
	{
		...
		if(valido){
			var pagina = '';
			if(opcionimp=='P'){
				pagina="reportes/sigesp_spg_rpp_instructivo_06_ejec_fin_pry_acc.php?mes="+mes+"&Tmes="+Tmes;
			}
			else{
				pagina="reportes/sigesp_spg_rpp_instructivo_06_ejec_fin_pry_acc_excel.php?mes="+mes+"&Tmes="+Tmes;
			}
