...
var fromReporteEjeFin = null; //varibale para almacenar la instacia de objeto de formulario 
...
Ext.onReady(function() {
	...
	fieldsettres = new Ext.form.FieldSet({
		...
		style: 'position:absolute;left:100px;top:'+(275+obtenerPosicion())+'px',
		cls :'fondo',
		items: [{
				layout: "column",
				defaults: {border: false},
	...
	fromReporteEjeFin = new Ext.FormPanel({
		applyTo: 'formReporteEjeFin',
		width:965, //700
		height: 500,
		title: "<H1 align='center'>Ejecuci&#243;n Financiera de Presupuesto de Gasto</H1>",
		frame:true,
		autoScroll:true,
		style:'position:absolute;top:'+Ypos+'px;left:'+Xpos+'px',   
		items: [fieldset,fieldsetdos,fieldsettres,fieldsetcuatro,
		        fieldsetcinco,fieldsetseis,fieldsetsiete]
	});	
	fieldsetseis.hide();
	fieldsetsiete.hide();
	fromReporteEjeFin.doLayout();
});	
...
{	 
	if(opcion=='P'){
		pagina="reportes/sigesp_spg_rpp_ejecucion_financiera_gasto.php"+datos;
	}
	else{
		pagina="reportes/sigesp_spg_rpp_ejecucion_financiera_gasto_excel.php"+datos;
	}
