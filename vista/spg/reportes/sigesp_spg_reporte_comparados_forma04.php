...
/****************************************************************************************************************************************/	
class sigesp_spg_reporte_comparados_forma04
{
    //conexion	
	var $sqlca;   
			   ...
			   {				  
				  ...
				  // $ls_codrep="00003";
				   ...
				   if($lb_valido)
				   {
					  ...
					  $ld_ejec_acum_t_ant=$arrResultado['ld_ejec_t_ant'];
					  $lb_valido=$arrResultado['lb_valido'];
				   }	
				   if($lb_valido)
				   {
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //     Creado por :    Ing. Yozelin Barrag�n.
	 // Fecha Creaci�n :    31/05/2006          Fecha �ltima Modificacion :26/06/2006      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  $lb_valido = true;	 
	  $ls_gestor = $_SESSION["ls_gestor"];
	  $ls_codemp = $this->dts_empresa["codemp"];
...
/****************************************************************************************************************************************/	
	///////////////////////////////////////////////////////////////////////////////////////////////////////
	//   CLASE REPORTES SPG  COMPARADOS " EJECUCI�N FINANCIERA DE LOS PROYECTOS DEL ENTE FORMA  #0413 " //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //     Creado por :    Ing. Yozelin Barrag�n.
	 // Fecha Creaci�n :    16/06/2006          Fecha �ltima Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////
					 ...
					 if($lb_valido)
					  {//calculo el reprogramci�n del proximo mes 
						  ...
						  {		
							  ...
							  $ld_aumdisacum=$arrResultado['ad_aumdisacum'];
							  $ld_comprometer=$arrResultado['ad_comprometer'];
							  $ld_causar=$arrResultado['ad_causado'];
							  $ld_pagar=$arrResultado['ad_pagado'];
							  $ld_comprometer_acumulado=$arrResultado['ad_comprometer_acumulado'];
							  $ld_causado_acumulado=$arrResultado['ad_causado_acumulado'];
							  $ld_pagado_acumulado= $arrResultado['ad_pagado_acumulado'];
							  $ld_ejec_acum_t_ant=$arrResultado['ld_ejec_t_ant'];
...
/****************************************************************************************************************************************/
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     $ls_sql=" SELECT  distinct ".$ls_cadena." as programatica ".
             ...
             "        c.codestpro2=r.codestpro2 AND c.codestpro3=r.codestpro3 AND ".
             "        c.codestpro4=r.codestpro4 AND c.codestpro5=r.codestpro5 AND ".
			 "        c.estcla=r.estcla AND c.spg_cuenta = r.spg_cuenta  ".$ls_seguridad;
	 $rs_data=$this->SQL->select($ls_sql);
	 if($rs_data===false)
	 {
		  $lb_valido=false;
...
/****************************************************************************************************************************************/
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//   CLASE REPORTES SPG  COMPARADOS " EJECUCI�N FINANCIERA DE LAS ACCIONES CENTRALIZADAS DEL ENTE #0414 "  //
	////////////////////////////////////////////////////////////////////////////////////////////////////////////
						  ...
						  {//calculo el reprogramci�n del proximo mes 
							  ...
							  {						
								...
								{// calculo la programacion de los meses anteriores
								  ...
								  $ld_monto_progracum_ant=0;
								  $li_mesdes=1;
								  $arrResultado=$this->uf_spg_reporte_calcular_programado($li_mesdes,$li_meshas-1,$ld_monto_programado_ant,
...
/****************************************************************************************************************************************/
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//   CLASE REPORTES SPG  COMPARADOS " EJECUCI�N FINANCIERA DE LAS ACCIONES ESPECIFICAS DEL ENTE FORMA #0415 "  //
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
