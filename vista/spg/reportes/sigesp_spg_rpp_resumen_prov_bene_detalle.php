...
***********************************************************************************/
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  --------------------------------------
		...
		$ls_provbenedes = "";
		if(array_key_exists("txtcodproben",$_GET))
		{
			$ls_provbenedes = $_GET["txtcodproben"];
		}
		$ls_provbenehas = "";	
		if(array_key_exists("txtcodprobenhas",$_GET))
		{
		...
		$ls_nombrehas = "";	
		if(array_key_exists("txtnombrehas",$_GET))
		{
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","sigesp_vis_spg_reporte_resumen_prov_bene.html",$ls_desc_event);
	////////////////////////////////         SEGURIDAD               ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
