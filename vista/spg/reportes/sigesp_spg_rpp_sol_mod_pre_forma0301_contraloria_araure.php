...
function uf_print_encabezado_pagina($as_titulo,$as_procede,$ad_fecha,$as_fuentefin="",$ab_gastoc,$io_pdf){
	...
	$io_pdf->Rectangle(19,30,570,80);
	$io_pdf->line(19,95,590,95);
	$io_pdf->line(200,30,200,110);
	$io_pdf->line(395,30,395,110);
	$io_pdf->line(19,45,590,45);
	$io_pdf->addText(80,100,7,"ELABORADO POR"); // Agregar el título
	$io_pdf->addText(275,100,7,"REVISADO POR"); // Agregar el título
	$io_pdf->addText(460,100,7,"APROBADO POR"); // Agregar el título
	$io_pdf->addText(83,35,7,"FIRMA / SELLO"); // Agregar el título
	$io_pdf->addText(273,35,7,"ADMINISTRACIÓN"); // Agregar el título
	$io_pdf->addText(468,35,7,"CONTRALOR"); // Agregar el título
