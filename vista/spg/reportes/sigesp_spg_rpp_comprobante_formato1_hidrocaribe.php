...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_periodo_comp,$as_fecha_comp,$io_pdf)
	{
		...
		// cuadro inferior
		// MODIFICACION REALIZADA POR FREDDY GONZALEZ
		...
		$io_pdf->addText(75,122,7,"REALIZADO POR:"); // Agregar el título
		$io_pdf->addText(45,68,7,"ANAL. PRESUPUESTO Y COSTOS"); // Agregar el título
		$io_pdf->addText(260,122,7,"CONFORMADO POR:"); // Agregar el título		
		$io_pdf->addText(230,73,7,"SUPERINTENDENTE PRESUP. Y COSTOS");
		$io_pdf->addText(215,63,7,"COORD. CONTROL DE GESTION Y PRESUPUESTO"); // Agregar el título
		//$io_pdf->addText(245,63,7,"JEFE PRESUPUESTO Y COSTOS");
		$io_pdf->addText(460,122,7,"APROBADO POR:"); // Agregar el título
		$io_pdf->addText(413,68,7,"GERENTE CORPORATIVO PLANIF. Y CONTROL"); // Agregar el título
    ...
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	 ...
	 else // Imprimimos el reporte
	 {
		...
		for($li_i=1;$li_i<=$li_tot;$li_i++)
		{
			...
			$lb_valido=$io_report->uf_spg_reporte_comprobante_formato1($ls_procede,$ls_procede,$ls_comprobante,$ls_comprobante,$ldt_fecdes,$ldt_fechas);
            if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$la_data[$li_s]=array('cuenta'=>$ls_spg_cuenta,'dencuenta'=>$ls_dencuenta,'descripcion'=>$ls_descripcion,
