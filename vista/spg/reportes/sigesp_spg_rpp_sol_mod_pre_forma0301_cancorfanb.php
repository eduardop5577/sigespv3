...
function uf_print_encabezado_pagina($as_titulo,$as_procede,$ad_fecha,$as_fuentefin="",$ab_gastoc,$io_pdf){
	...
	$io_pdf->line(130,40,130,100);
	$io_pdf->line(220,40,220,100);
	$io_pdf->line(340,40,340,110);
	$io_pdf->line(425,40,425,100);
	$io_pdf->line(505,40,505,100);

	$io_pdf->addText(150,102,8,"<b>INSTITUCION</b>"); // Agregar el título
	$io_pdf->addText(385,102,8,"<b>OFICINA NACIONAL DE PRESUPUESTO</b>"); // Agregar el título

		
	$io_pdf->addText(50,90,7,"DIRECTOR DE"); // Agregar el título
	$io_pdf->addText(20,83,7,"ADMINISTRACIÓN Y SERVICIOS"); // Agregar el título
	$io_pdf->addText(147,90,7,"RESPONSABLE"); // Agregar el título
	$io_pdf->addText(133,83,7,"DEL PROYECTO/ACCIÓN"); // Agregar el título
	
	$io_pdf->addText(255,90,7,"DIRECTOR DE"); // Agregar el título
	$io_pdf->addText(223,83,7,"PLANIFICACIÓN Y PRESUPUESTO"); // Agregar el título
	$io_pdf->addText(366,90,7,"MÁXIMA"); // Agregar el título
	$io_pdf->addText(360,83,7,"AUTORIDAD"); // Agregar el título
	$io_pdf->addText(445,86,7,"DIRECTOR"); // Agregar el título
	$io_pdf->addText(513,86,7,"DIRECTOR GENERAL"); // Agregar el título
...
//--------------------------------------------------------------------------------------------------------------------------------
function uf_print_detalle($la_data,$ls_titulo1,$ls_titulo2,$ld_monto,$io_pdf,$lb_dis=false){
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if ($la_result_dis->EOF && $la_result_aum->EOF){
	...
	$la_data_detalle_dis = $io_report->uf_obtener_datadetalle($la_result_dis,$ld_tot_dis,false,true);
	uf_print_detalle($la_data_detalle_dis,"Partidas Cedentes","TOTAL PARTIDAS CEDENTES",$ld_tot_dis,$io_pdf,true);
