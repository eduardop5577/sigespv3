...
***********************************************************************************/
   ...
   //--------------------------------------------------  Parámetros para Filtar el Reporte  -----------------------------------------
	  ...
	  if (($ls_coduniadm_des=='')&&($ls_coduniadm_has==''))
	  {
		$ls_minuniadm="";
		$ls_maxuniadm="";
	    $arrResultado=$io_function_report->uf_spg_select_unidadadministrativa($ls_minuniadm,$ls_maxuniadm);
		$ls_minuniadm=$arrResultado['as_minuniadm'];
		$ls_maxuniadm=$arrResultado['as_maxuniadm'];
		$lb_valido=$arrResultado['lb_valido'];
		if($lb_valido)
		  {
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","sigesp_vis_spg_reporte_unidades_ejecutoras.php",$ls_desc_event);
	 ////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
