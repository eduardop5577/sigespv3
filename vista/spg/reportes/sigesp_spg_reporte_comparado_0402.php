...
/****************************************************************************************************************************************/	
class sigesp_spg_reporte_comparado_0402
{
    //conexion	
	var $sqlca;   
...
/****************************************************************************************************************************************/
    ...
    { //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  if($li_mesdes>=2)
	  {		
		  $arrResultado=$this->uf_spg_reporte_select_saldo_empresa($ld_salinipro,$ld_salinieje);
		  $ld_salinipro=$arrResultado['ad_salinipro'];
		  $ld_salinieje=$arrResultado['ad_salinieje'];
	  ...
	  if($lb_valido)
	  {
		...
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
			{
			   ...
			   //se calculan los montos  progamado, programado acumulado, previsto del proximo mes
			   ...
			   if($lb_valido)
			   {
				  ...
				  $ld_monto_previsto=0;
  				  $arrResultado=$this->uf_spg_reporte_calcular_programado($li_mesdes,$li_meshas,$ld_monto_programado,$ld_monto_previsto,
				                                                       $ld_enero,$ld_febrero,$ld_marzo,$ld_abril,$ld_mayo,$ld_junio,
																	   $ld_julio,$ld_agosto,$ld_septiembre,$ld_octubre,$ld_noviembre,
																	   $ld_diciembre,$ld_monto_programado_acumulado);
				 $ld_monto_programado=$arrResultado['ad_monto_programado'];
				 $ld_monto_previsto=$arrResultado['ad_monto_previsto'];
				 $ld_monto_programado_acumulado=$arrResultado['ad_monto_programado_acumulado'];
				 $lb_valido=$arrResultado['lb_valido'];
				  if($lb_valido)
				  {
				     $ls_tipo="O";
					 ...
					 $ld_pagado=0;
					 $arrResultado=$this->uf_spg_reporte_calcular_ejecutado($ls_spg_cuenta,$ls_tipo,$ld_monto_ejecutado,
					 ...
					 if($lb_valido)
					 {
						 ...
						 $this->dts_reporte->insertRow("monto_programado_acumulado",$ld_monto_programado_acumulado);
						 $this->dts_reporte->insertRow("monto_ejecutado",$ld_monto_ejecutado);
						 $this->dts_reporte->insertRow("monto_ejecutado_acumulado",$ld_monto_acumulado);
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    24/08/2006               Fecha última Modificacion :      Hora :
	  ...
	  else
	  {
		...
		$arrResultado['ad_salinipro']=$ad_salinipro;
		$arrResultado['ad_salinieje']=$ad_salinieje;
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    24/08/2006               Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT sum(asignado) as asignado,sum(comprometido) as comprometido, sum(causado) as causado, ".
              ...
              "        sum(febrero) as febrero, sum(marzo) as marzo, sum(abril) as abril, sum(mayo) as mayo, sum(junio) as junio, ".
              "        sum(julio) as julio, sum(agosto) as agosto, sum(septiembre) as septiembre, ".
              "        sum(octubre) as octubre, sum(noviembre) as noviembre, sum(diciembre) as diciembre, max(nivel) as nivel, ".
...
/****************************************************************************************************************************************/	
    function uf_spg_reporte_calcular_programado($ai_mesdes,$ai_meshas,$ad_monto_programado,$ad_monto_previsto,$ad_enero,$ad_febrero,
												...
												$ad_octubre,$ad_noviembre,$ad_diciembre,$ad_monto_programado_acumulado)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     if($lb_valido)
     {
		...
		//// Calculo el ejecutado  
		if (1<=$li_meshas)  {  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_enero; }   
		if (2<=$li_meshas)  {  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_febrero; }   
		if (3<=$li_meshas)  {  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_marzo;  }   
		if (4<=$li_meshas)  {  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_abril; }   
		if (5<=$li_meshas)  {  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_mayo;  }   
		if (6<=$li_meshas)  {  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_junio; }   
		if (7<=$li_meshas)  {  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_julio; }   
		if (8<=$li_meshas)  {  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_agosto; }   
		if (9<=$li_meshas)  {  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_septiembre; }   
		if (10<=$li_meshas) {  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_octubre; }   
		if (11<=$li_meshas)	{  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_noviembre;	}   
		if (12<=$li_meshas)	{  $ad_monto_programado_acumulado=$ad_monto_programado_acumulado+$ad_diciembre;	}   
	}//if
		$arrResultado['ad_monto_programado']=$ad_monto_programado;
		$arrResultado['ad_monto_previsto']=$ad_monto_previsto;
		$arrResultado['ad_monto_programado_acumulado']=$ad_monto_programado_acumulado;
		$arrResultado['lb_valido']=$lb_valido;
		return $arrResultado;		
	   ...
	   $ls_sql=" SELECT spi_cuenta,denominacion ".
		...
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
			{
			   ...
			   $ld_noviembre=0;	   $ld_diciembre=0;
               $ls_codrep="00005"; $li_nivel="";   $ls_status="";
			   $arrResultado=$this->uf_spg_reporte_llenar_datastore_programado_ingreso($ls_codrep,$ls_spi_cuenta,$ld_enero,$ld_febrero,
			   ...
			   if($lb_valido)
			   {
				  ...
				  $ld_previsto=0;
				  $ld_monto_programado_acumulado=0;
  				  $arrResultado=$this->uf_spg_reporte_calcular_programado($li_mesdes,$li_meshas,$ld_monto_programado,$ld_previsto,
				                                                       $ld_enero,$ld_febrero,$ld_marzo,$ld_abril,$ld_mayo,$ld_junio,
																	   $ld_julio,$ld_agosto,$ld_septiembre,$ld_octubre,$ld_noviembre,
																	   $ld_diciembre,$ld_monto_programado_acumulado);
				 $ld_monto_programado=$arrResultado['ad_monto_programado'];
				 $ld_previsto=$arrResultado['ad_monto_previsto'];
				 $ld_monto_programado_acumulado=$arrResultado['ad_monto_programado_acumulado'];
				 $lb_valido=$arrResultado['lb_valido'];
				  if($lb_valido)
				  {
					 ...
					 $arrResultado=$this->uf_spg_reporte_calcular_ejecutado_ingreso($ls_spi_cuenta,$ld_prev,$ld_devengado,
					                                                             $ld_cobrado,$ld_cobrado_anticipado,$ld_aumento,
	                                                                             $ld_disminucion,$adt_fecdes,$adt_fechas,
																				 $ld_cobrado_acumulado);  
					$ld_prev=$arrResultado['ad_previsto'];
					...
					$ld_cobrado_acumulado=$arrResultado['ad_cobrado_acumulado'];
					$lb_valido=$arrResultado['lb_valido'];
					if($lb_valido)
					{
						 $ls_tipo_cuenta="I";
						 ...
						 $this->dts_reporte->insertRow("nivel",$li_nivel);
						 $this->dts_reporte->insertRow("monto_programado",$ld_monto_programado);
						 $this->dts_reporte->insertRow("monto_programado_acumulado",$ld_monto_programado);
						 $this->dts_reporte->insertRow("monto_ejecutado",$ld_cobrado);
						 $this->dts_reporte->insertRow("monto_ejecutado_acumulado",$ld_cobrado_acumulado);
						 $this->dts_reporte->insertRow("variacion_absoluta",$ld_varia_abs);
						 $this->dts_reporte->insertRow("porcentaje_variacion",$ld_porc_varia);
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    25/08/2006               Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  $ls_sql=" SELECT sum(previsto) as previsto,sum(devengado) as devengado, sum(cobrado) as cobrado, max(nivel) as nivel,  ".
              "        sum(cobrado_anticipado) as cobrado_anticipado,sum(aumento) as aumento, sum(disminucion) as disminucion,  ".
              ...
              "        sum(octubre) as octubre, sum(noviembre) as noviembre, sum(diciembre) as diciembre, max(status) as status, ".
...
/****************************************************************************************************************************************/	
    function uf_spg_reporte_calcular_ejecutado_ingreso($as_spi_cuenta,$ad_previsto,$ad_devengado,$ad_cobrado,$ad_cobrado_anticipado,
	                                                   $ad_aumento,$ad_disminucion,$adt_fecini,$adt_fecfin,$ad_cobrado_acumulado)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/****************************************************************************************************************************************/
    ...
    { /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  if($lb_valido)
	  {
		...
		$la_cuenta[20]='306010000'.$ls_ceros;
		$la_cuenta[21]='306020000'.$ls_ceros;
		$la_cuenta[22]='305020100'.$ls_ceros;
		$la_cuenta[23]='305020300'.$ls_ceros;
		$la_cuenta[24]='305020301'.$ls_ceros;
		$la_cuenta[25]='305020302'.$ls_ceros;
		$la_cuenta[26]='305020308'.$ls_ceros;
		$la_cuenta[27]='305020309'.$ls_ceros;
		$la_cuenta[28]='305020500'.$ls_ceros;
		$la_cuenta[29]='305020501'.$ls_ceros;
		$la_cuenta[30]='305020502'.$ls_ceros;
		$la_cuenta[31]='305020503'.$ls_ceros;
		// ---> Ingresos Financieros
		$la_cuenta[32]='307000000'.$ls_ceros;
		$la_cuenta[33]='308000000'.$ls_ceros;
		// ---> Venta de Otras Inversiones Financieras
		$la_cuenta[34]='309000000'.$ls_ceros;
		// ---> Saldo Inicial mas Ingresos
        // ---> Egresos
		$la_cuenta[35]='401000000'.$ls_ceros;
		$la_cuenta[36]='402000000'.$ls_ceros;
		$la_cuenta[37]='403000000'.$ls_ceros;
		$la_cuenta[38]='408000000'.$ls_ceros;
		// ---> Otros Egresos Corrientes
		$la_cuenta[39]='410000000'.$ls_ceros;
		$la_cuenta[40]='407000000'.$ls_ceros;
		$la_cuenta[41]='407010100'.$ls_ceros;
		$la_cuenta[42]='407010300'.$ls_ceros;
		// ---> Otras Transferencias Corrientes Diversas
		$la_cuenta[43]='407030000'.$ls_ceros;
		$la_cuenta[44]='407030100'.$ls_ceros;
		$la_cuenta[45]='407030300'.$ls_ceros;
		$la_cuenta[46]='407020000'.$ls_ceros;
		$la_cuenta[47]='408080000'.$ls_ceros;
		$la_cuenta[48]='404000000'.$ls_ceros;
		$la_cuenta[49]='405000000'.$ls_ceros;
		// ---> Saldo Final
	    ...
	    for($li_i=1;$li_i<=3;$li_i++)
		{
			 ...
			 if($li_i==1)
			 {
			   ...
			   $ld_monto_programado_acumulado=$ad_salinipro;
			   $ld_monto_ejecutado=$ad_salinieje;
			   $ld_monto_ejecutado_acumulado=$ad_salinieje;
			   $ls_tipo=1;
			 }
			 if($li_i==2)
			 {
			 ...
			 $adts_datastore->insertRow("monto_programado_acumulado",$ld_monto_programado_acumulado);
			 $adts_datastore->insertRow("monto_ejecutado",$ld_monto_ejecutado);
			 $adts_datastore->insertRow("monto_ejecutado_acumulado",$ld_monto_ejecutado_acumulado);
		...
		{  //=========================> Incluir encabezado en el datastore
		   ...
		   {				
			 case 14:
				  ...
				  $ld_monto_programado_act_acumulado=0;		  $ld_monto_ejecutado_act_acumulado=0;
				  ...
				  for($li_i=1;$li_i<=$li_total;$li_i++)
				  {
						...
						$ld_monto_programado_acumulado=$this->dts_ctas_ingreso_actividad->getValue("monto_programado_acumulado",$li_i);
						$ld_monto_ejecutado=$this->dts_ctas_ingreso_actividad->getValue("monto_ejecutado",$li_i);
						$ld_monto_ejecutado_acumulado=$this->dts_ctas_ingreso_actividad->getValue("monto_ejecutado_acumulado",$li_i);
						...
						$ld_monto_programado_act_acumulado=$ld_monto_programado_act_acumulado+$ld_monto_programado_acumulado;
						$ld_monto_ejecutado_act=$ld_monto_ejecutado_act+$ld_monto_ejecutado;	
						$ld_monto_ejecutado_act_acumulado=$ld_monto_ejecutado_act_acumulado+$ld_monto_ejecutado_acumulado;	
				 ...
				 $adts_datastore->insertRow("monto_programado_acumulado",$ld_monto_programado_act_acumulado);
				 $adts_datastore->insertRow("monto_ejecutado",$ld_monto_ejecutado_act);
				 $adts_datastore->insertRow("monto_ejecutado_acumulado",$ld_monto_ejecutado_act_acumulado);
			 ...
			 case 16:
				  ...
				  $ld_monto_programado_aux_acumulado=0;		  $ld_monto_ejecutado_aux_acumulado=0;	
				  ...
				  for($li_i=1;$li_i<=$li_total;$li_i++)
				  {
						...
						$ld_monto_programado_acumulado=$this->dts_ctas_ingreso->getValue("monto_programado_acumulado",$li_i);
						$ld_monto_ejecutado=$this->dts_ctas_ingreso->getValue("monto_ejecutado",$li_i);
						$ld_monto_ejecutado_acumulado=$this->dts_ctas_ingreso->getValue("monto_ejecutado_acumulado",$li_i);
						...
						$ld_monto_programado_aux_acumulado=$ld_monto_programado_aux_acumulado+$ld_monto_programado_acumulado;
						$ld_monto_ejecutado_aux=$ld_monto_ejecutado_aux+$ld_monto_ejecutado;	
						$ld_monto_ejecutado_aux_acumulado=$ld_monto_ejecutado_aux_acumulado+$ld_monto_ejecutado_acumulado;	
				 ...
				 $adts_datastore->insertRow("monto_programado_acumulado",$ld_monto_programado_aux_acumulado);
				 $adts_datastore->insertRow("monto_ejecutado",$ld_monto_ejecutado_aux);
				 $adts_datastore->insertRow("monto_ejecutado_acumulado",$ld_monto_ejecutado_aux_acumulado);
				...
				if($li_pos>0)
				{
				  ...
				  $adts_datastore->updateRow("monto_programado_acumulado",$ld_monto_programado_aux_acumulado,$li_pos);	
				  $adts_datastore->updateRow("monto_ejecutado",$ld_monto_ejecutado_aux,$li_pos);			
				  $adts_datastore->updateRow("monto_ejecutado_acumulado",$ld_monto_ejecutado_aux_acumulado,$li_pos);			
			 ...
			 case 20:
				 ...
				 for($li_i=1;$li_i<=$li_total;$li_i++)
				 {
					...
					$ld_monto_programado_acumulado=$this->dts_ctas_ingreso_propiedad->getValue("monto_programado_acumulado",$li_i);
					$ld_monto_ejecutado=$this->dts_ctas_ingreso_propiedad->getValue("monto_ejecutado",$li_i);
					$ld_monto_ejecutado_acumulado=$this->dts_ctas_ingreso_propiedad->getValue("monto_ejecutado_acumulado",$li_i);
			 ...
			 case 34:
				 ...
				 $ld_monto_programado_fin_acumulado=0;		  $ld_monto_ejecutado_fin_acumulado=0;	
				 ...
				 for($li_i=1;$li_i<=$li_total;$li_i++)
				 {
						...
						$ld_monto_programado_acumulado=$this->dts_ctas_ingreso_financieros->getValue("monto_programado_acumulado",$li_i);
						$ld_monto_ejecutado=$this->dts_ctas_ingreso_financieros->getValue("monto_ejecutado",$li_i);
						$ld_monto_ejecutado_acumulado=$this->dts_ctas_ingreso_financieros->getValue("monto_ejecutado_acumulado",$li_i);
						...
						$ld_monto_programado_fin_acumulado=$ld_monto_programado_fin_acumulado+$ld_monto_programado_acumulado;
						$ld_monto_ejecutado_fin=$ld_monto_ejecutado_fin+$ld_monto_ejecutado;
						$ld_monto_ejecutado_fin_acumulado=$ld_monto_ejecutado_fin_acumulado+$ld_monto_ejecutado_acumulado;
				 ...
				 $adts_datastore->insertRow("monto_programado_acumulado",$ld_monto_programado_fin_acumulado);
           	     $adts_datastore->insertRow("monto_ejecutado",$ld_monto_ejecutado_fin);
           	     $adts_datastore->insertRow("monto_ejecutado_acumulado",$ld_monto_ejecutado_fin_acumulado);
			 ...
			 case 39:
				 ...
				 $ld_monto_programado_egr_acumulado=0;		  $ld_monto_ejecutado_egr_acumulado=0;	
				 ...
				 for($li_i=1;$li_i<=$li_total;$li_i++)
				 {
					...
					$ld_monto_programado_acumulado=$this->dts_ctas_egresos->getValue("monto_programado_acumulado",$li_i);
					$ld_monto_ejecutado=$this->dts_ctas_egresos->getValue("monto_ejecutado",$li_i);
					$ld_monto_ejecutado_acumulado=$this->dts_ctas_egresos->getValue("monto_ejecutado_acumulado",$li_i);
					...
					$ld_monto_programado_egr_acumulado=$ld_monto_programado_egr_acumulado+$ld_monto_programado_acumulado;
					$ld_monto_ejecutado_egr=$ld_monto_ejecutado_egr+$ld_monto_ejecutado;	
					$ld_monto_ejecutado_egr_acumulado=$ld_monto_ejecutado_egr_acumulado+$ld_monto_ejecutado_acumulado;	
				 ...
				 $adts_datastore->insertRow("monto_programado_acumulado",$ld_monto_programado_egr_acumulado);
				 $adts_datastore->insertRow("monto_ejecutado",$ld_monto_ejecutado_egr);
				 $adts_datastore->insertRow("monto_ejecutado_acumulado",$ld_monto_ejecutado_egr_acumulado);
		  ...
		  //default:
		   ...
		   { 		
              ...
              $ld_monto_programado_acumulado=$this->dts_reporte->getValue("monto_programado_acumulado",$li_pos);
			  $ld_monto_ejecutado=$this->dts_reporte->getValue("monto_ejecutado",$li_pos);
			  $ld_monto_ejecutado_acumulado=$this->dts_reporte->getValue("monto_ejecutado_acumulado",$li_pos);
		   ...
		   {		
		       $ls_denom="";
			   $arrResultado=$this->uf_spg_reportes_select_denominacion($ls_cuenta,$ls_denom);
			   $ls_denom=$arrResultado['as_denominacion'];
			   $lb_valido=$arrResultado['lb_valido'];
			   if($lb_valido)
			   {
				  $ls_tipo_cuenta="";		            $ls_status="";	      $li_nivel="";		  $ld_monto_programado=0;
				  $ld_monto_ejecutado=0;	            $ld_varia_abs=0;	  $ld_porc_varia=0;   $ld_previsto=0;
				  $ld_monto_programado_acumulado=0;     $ld_monto_ejecutado_acumulado=0;
		   ...
		   if($li==42)
		   {
			  ...
			  for($li_i=1;$li_i<=$li_total;$li_i++)
			  {
				...
				if($li_pos>0)
				{
					...
					$ld_monto_programado_acumulado=$this->dts_curft->getValue("monto_programado_acumulado",$li_pos);
					$ld_monto_ejecutado=$this->dts_curft->getValue("monto_ejecutado",$li_pos);
					$ld_monto_ejecutado_acumulado=$this->dts_curft->getValue("monto_ejecutado_acumulado",$li_pos);
		...
		$ld_monto_programado_ingreso=0;               $ld_monto_programado_ingreso_acumulado=0;      		  
		$ld_monto_ejecutado_ingreso=0;                $ld_monto_ejecutado_ingreso_acumulado=0;     
		
		$ld_monto_programado_egreso=0;                $ld_monto_ejecutado_egreso=0;
		$ld_monto_programado_egreso_acumulado=0;      $ld_monto_ejecutado_egreso_acumulado=0;
		...
		$ld_monto_programado_ingreso_total_acumulado=0;
		...
		for($li_i=1;$li_i<=$li_total;$li_i++)
	    {
			...
			$ld_monto_programado_acumulado=$adts_datastore->getValue("monto_programado_acumulado",$li_i);
			$ld_monto_ejecutado=$adts_datastore->getValue("monto_ejecutado",$li_i);
			$ld_monto_ejecutado_acumulado=$adts_datastore->getValue("monto_ejecutado_acumulado",$li_i);
			   ...
			   ($ls_cuenta_final=='308000000')||($ls_cuenta_final=='309000000'))
			{
				...
				$ld_monto_programado_ingreso_acumulado=$ld_monto_programado_ingreso_acumulado+$ld_monto_programado_acumulado;
				
				$ld_monto_ejecutado_ingreso=$ld_monto_ejecutado_ingreso+$ld_monto_ejecutado;	
				$ld_monto_ejecutado_ingreso_acumulado=$ld_monto_ejecutado_ingreso_acumulado+$ld_monto_ejecutado_acumulado;	
		   ...
		   //EGRESO
			   ...
			   ($ls_cuenta_final=='408080000')||($ls_cuenta_final=='404000000')||($ls_cuenta_final=='405000000'))
			{
				...
				$ld_monto_programado_egreso_acumulado=$ld_monto_programado_egreso_acumulado+$ld_monto_programado_acumulado;
				
				$ld_monto_ejecutado_egreso=$ld_monto_ejecutado_egreso+$ld_monto_ejecutado;	
				$ld_monto_ejecutado_egreso_acumulado=$ld_monto_ejecutado_egreso_acumulado+$ld_monto_ejecutado_acumulado;	
		...
		$ld_suma_acumulado=0;
		$ld_suma_acumulado=$adts_datastore->getValue("monto_ejecutado_acumulado","3");
		$ld_suma_acumulado=$ld_suma+$adts_datastore->getValue("monto_ejecutado_acumulado","17");
		$ld_suma_acumulado=$ld_suma+$adts_datastore->getValue("monto_ejecutado_acumulado","25");
		$ld_suma_acumulado=$ld_suma+$adts_datastore->getValue("monto_ejecutado_acumulado","41");

		$li_pos=$adts_datastore->find("tipo","2");
		if($li_pos>0)
		{
			$ld_monto_programado=$adts_datastore->getValue("monto_programado",$li_pos);
			$ld_monto_programado_acumulado=$adts_datastore->getValue("monto_programado_acumulado",$li_pos);
			...
			$ld_monto_programado_ingreso_total_acumulado=$ld_monto_programado_ingreso_total_acumulado+$ld_monto_programado_acumulado;
			...
			$adts_datastore->updateRow("monto_programado_acumulado",$ld_monto_programado_ingreso_total_acumulado,$li_pos);	
			$adts_datastore->updateRow("monto_ejecutado",$ld_suma,$li_pos);	
			$adts_datastore->updateRow("monto_ejecutado_acumulado",$ld_suma_acumulado,$li_pos);	
		...
		if($li_pos>0)
		{
		  ...
		  $ld_monto_programado_saling_acumulado=$ld_monto_programado_ingreso_acumulado+$ad_salinipro;
		  
		  $ld_monto_ejecutado_saling=$ld_suma+$ad_salinieje;
		  $ld_monto_ejecutado_saling_acumulado=$ld_suma_acumulado+$ad_salinieje;
          ...
          $adts_datastore->updateRow("monto_programado_acumulado",$ld_monto_programado_saling_acumulado,$li_pos);
		  			
		  $adts_datastore->updateRow("monto_ejecutado",$ld_monto_ejecutado_saling,$li_pos);
		  $adts_datastore->updateRow("monto_ejecutado_acumulado",$ld_monto_ejecutado_saling_acumulado,$li_pos);
		...
		if($li_pos>0)
		{
		  ...
		  $adts_datastore->updateRow("monto_programado_acumulado",$ld_monto_programado_egreso_acumulado,$li_pos);	

		  $adts_datastore->updateRow("monto_ejecutado",$ld_monto_ejecutado_egreso,$li_pos);
		  $adts_datastore->updateRow("monto_ejecutado_acumulado",$ld_monto_ejecutado_egreso_acumulado,$li_pos);
		...
		$adts_datastore->insertRow("denominacion","<b>SALDO FINAL Bs.</b>");
		$adts_datastore->insertRow("tipo_cuenta",$ls_tipo_cuenta);
		$adts_datastore->insertRow("spg_cuenta",$ls_spg_cuenta);
		$adts_datastore->insertRow("status",$ls_status);
		$adts_datastore->insertRow("nivel",$li_nivel);
		$adts_datastore->insertRow("monto_programado",$ld_monto_programado_sf);
		$adts_datastore->insertRow("monto_programado_acumulado",$ld_monto_programado_sf);
		$adts_datastore->insertRow("monto_ejecutado",$ld_monto_ejecutado_sf);
		$adts_datastore->insertRow("monto_ejecutado_acumulado",$ld_monto_ejecutado_sf);
		...
		if($li_pos>0)
		{
		  ...
		  $ld_monto_programado_final_acumulado=($ld_monto_programado_ingreso_acumulado+$ad_salinipro)-$ld_monto_programado_egreso_acumulado;
		  
		  $ld_monto_ejecutado_final=($ld_suma+$ad_salinieje)-$ld_monto_ejecutado_egreso;
		  $ld_monto_ejecutado_final_acumulado=($ld_suma_acumulado+$ad_salinieje)-$ld_monto_ejecutado_egreso_acumulado;
		  ...
		  $adts_datastore->updateRow("monto_programado_acumulado",$ld_monto_programado_final_acumulado,$li_pos);	
		  		
		  $adts_datastore->updateRow("monto_ejecutado",$ld_monto_ejecutado_final,$li_pos);
		  $adts_datastore->updateRow("monto_ejecutado_acumulado",$ld_monto_ejecutado_final_acumulado,$li_pos);
				 ...
				 $lb_valido=$arrResultado['lb_valido'];
				  if($lb_valido)
				  {
					 ...
					 if($lb_valido)
					 {
						 ...
						 $this->dts_curft->insertRow("monto_programado_acumulado",$ld_monto_programado_acumulado);
			   ...
			   if($lb_valido)
			   {
				 ...
				 $lb_valido=$arrResultado['lb_valido'];
				  if($lb_valido)
				  {
					 $ld_prev=0;
                     $ld_cobrado_acumulado=0;
					 $arrResultado=$this->uf_spg_reporte_calcular_ejecutado_otros_ingreso($ls_spi_cuenta,$ld_prev,$ld_devengado,
					                                                             $ld_cobrado,$ld_cobrado_anticipado,$ld_aumento,
	                                                                             $ld_disminucion,$adt_fecdes,$adt_fechas,
																				 $ld_cobrado_acumulado);  
					$ld_prev=$arrResultado['ad_previsto'];
					...
					{	
						 ...
						 $this->dts_ctas_ingreso->insertRow("monto_programado_acumulado",$ld_monto_programado_acumulado);
						 $this->dts_ctas_ingreso->insertRow("monto_ejecutado",$ld_cobrado);
						 $this->dts_ctas_ingreso->insertRow("monto_ejecutado_acumulado",$ld_cobrado_acumulado);
				 ...
				 $lb_valido=$arrResultado['lb_valido'];
				  if($lb_valido)
				  {
					...
					{	
						 ...
						 $this->dts_ctas_ingreso_propiedad->insertRow("monto_programado_acumulado",$ld_monto_programado_acumulado);
						 $this->dts_ctas_ingreso_propiedad->insertRow("monto_ejecutado",$ld_cobrado);
						 $this->dts_ctas_ingreso_propiedad->insertRow("monto_ejecutado_acumulado",$ld_cobrado_acumulado);
			   ...
			   if($lb_valido)
			   {
				  ...
				  $ld_monto_programado_acumulado=0;
  				  $arrResultado=$this->uf_spg_reporte_calcular_programado($li_mesdes,$li_meshas,$ld_monto_programado,$ld_previsto,
				                                                       $ld_enero,$ld_febrero,$ld_marzo,$ld_abril,$ld_mayo,$ld_junio,
																	   $ld_julio,$ld_agosto,$ld_septiembre,$ld_octubre,$ld_noviembre,
																	   $ld_diciembre,$ld_monto_programado,$ld_monto_programado_acumulado);
				 $ld_monto_programado=$arrResultado['ad_monto_programado'];
				 $ld_previsto=$arrResultado['ad_monto_previsto'];
				 $ld_monto_programado_acumulado=$arrResultado['ad_monto_programado_acumulado'];
				 $lb_valido=$arrResultado['lb_valido'];
				  if($lb_valido)
				  {
					 ...
					 $arrResultado=$this->uf_spg_reporte_calcular_ejecutado_otros_ingreso($ls_spi_cuenta,$ld_prev,$ld_devengado,
					                                                             $ld_cobrado,$ld_cobrado_anticipado,$ld_aumento,
	                                                                             $ld_disminucion,$adt_fecdes,$adt_fechas,
																				 $ld_cobrado_acumulado,$ld_cobrado_acumulado);  
			   ...
			   if($lb_valido)
			   {
				 ...
				 $lb_valido=$arrResultado['lb_valido'];
				  if($lb_valido)
				  {
					 ...
					 $arrResultado=$this->uf_spg_reporte_calcular_ejecutado_otros_ingreso($ls_spi_cuenta,$ld_prev,$ld_devengado,
					                                                             $ld_cobrado,$ld_cobrado_anticipado,$ld_aumento,
	                                                                             $ld_disminucion,$adt_fecdes,$adt_fechas,$ld_cobrado_acumulado);  
					...
					{	
						 ...
						 $this->dts_ctas_ingreso_financieros->insertRow("monto_programado_acumulado",$ld_monto_programado_acumulado);
						 $this->dts_ctas_ingreso_financieros->insertRow("monto_ejecutado",$ld_cobrado);
						 $this->dts_ctas_ingreso_financieros->insertRow("monto_ejecutado_acumulado",$ld_cobrado_acumulado);
				 ...
				 $lb_valido=$arrResultado['lb_valido'];
				  if($lb_valido)
				  {
					 ...
					 if($lb_valido)
					 {
						 ...
						 $this->dts_ctas_egresos->insertRow("monto_programado_acumulado",$ld_monto_programado_acumulado);
						 $this->dts_ctas_egresos->insertRow("monto_ejecutado",$ld_monto_ejecutado);
						 $this->dts_ctas_egresos->insertRow("monto_ejecutado_acumulado",$ld_monto_acumulado);
