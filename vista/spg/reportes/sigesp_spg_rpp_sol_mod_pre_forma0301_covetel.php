...
function uf_print_encabezado_pagina($as_titulo,$as_procede,$ad_fecha,$as_fuentefin="",$io_pdf){
	...
	$io_pdf->addText(30,750,8,"ENTE:{$_SESSION['la_empresa']['nombre']}");
	$io_pdf->addText(383,750,8,"<b>PÁGINA N°.</b>");
	$io_pdf->addText(510,745,8,"COD. A-1207");
	...
	$io_pdf->Rectangle(19,40,570,100);
	$io_pdf->line(19,130,590,130);
	$io_pdf->line(19,120,400,120);
	$io_pdf->line(19,75,590,75);
	$io_pdf->line(95,40,95,130);
	$io_pdf->line(180,40,180,130);
	$io_pdf->line(290,40,290,130);
	$io_pdf->line(400,40,400,130);
	$io_pdf->line(480,40,480,130);

	//Encabezado tabla
	$io_pdf->addText(200,133,7,"<b>INSTITUCION</b>");
	$io_pdf->addText(410,133,7,"<b>OFICINA NACIONAL DE PRESUPUESTO</b>");

	//Columna Elaborado
	$io_pdf->addText(25,123,7,"ELABORADO:");
	$io_pdf->addText(25,65,6,"COORDINACION DE ");
	$io_pdf->addText(25,58,6,"PLANIFICACION, ");
	$io_pdf->addText(25,51,6,"PRESUPUESTO Y ");
	$io_pdf->addText(25,44,6,"ORGANIZACION ");

	//Columna Conformado
	$io_pdf->addText(110,123,7,"CONFORMADO:");
	$io_pdf->addText(110,58,6,"COORDINACION DE ");
	$io_pdf->addText(110,51,6,"ADMINISTRACION Y ");
	$io_pdf->addText(115,44,6,"FINANZAS ");

	//Columna Autorizado
	$io_pdf->addText(200,123,7,"AUTORIZADO:");
	$io_pdf->addText(200,58,6,"VICEPRESIDENCIA DE ");
	$io_pdf->addText(210,51,6,"GESTION INTERNA");

	//Columna Aprobado
	$io_pdf->addText(320,123,7,"APROBADO:");
	$io_pdf->addText(320,58,6,"PRESIDENCIA");

	//Columna jefe sector
	$io_pdf->addText(420,58,6,"JEFE DE SECTOR");

	//Columna director
	$io_pdf->addText(505,58,6,"DIRECTOR G.");
	$io_pdf->addText(510,51,6,"SECTORIAL");
...
$io_pdf->ezStartPageNumbers(450,750,8,'','',1); // Insertar el número de página
