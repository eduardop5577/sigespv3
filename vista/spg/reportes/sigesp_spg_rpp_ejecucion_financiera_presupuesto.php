...
//--------------------------------------------------  Parámetros para Filtar el Reporte  ------------------------------------
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","sigesp_vis_spg_reporte_resumen_ejecucion_financiera.php",$ls_desc_event);
	////////////////////////////////         SEGURIDAD               ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $lb_valido=$io_report->uf_spg_reportes_resumen_ejecucion_financiera_presupuesto($ls_codestpro1,$ls_codestpro2,
	 ...
	 else // Imprimimos el reporte
	 {
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			$ld_liber           = "0,00";
			$ld_precomprometidoact = $ld_precomprometido - abs($ld_libprecomprometido);
			$ld_disponible      =$io_report->dts_reporte->data["asignado"][$z] -($ld_trimestre_i + $ld_trimestre_ii + $ld_trimestre_iii + $ld_trimestre_iv+$ld_precomprometidoact)+$ld_ajuste;
