			...
			{  
				...
				// var_dump($ld_totspg_por_pagar);
			      ...
			      if(($ls_spg_cuenta!=$ls_spg_cuenta_next)&& ($li_tmp!=($li_totrow_det-1)))
			      {
					 ...
					 $ld_saldo_comprometer_cuenta = abs($ld_totspg_monto_actualizado-$ld_totspg_precompromiso-$ld_totspg_compromiso);					 
					 ...
					 $la_data_subtot[1]=array('TOTAL CUENTA '.$ls_spg_cuenta.' SALDO POR COMPROMETER Bs.  '.number_format($ld_saldo_comprometer_cuenta,2,",","."),number_format($ld_totspg_asignado,2,",","."),
					 ...
					 $io_tcpdf->uf_print_total($la_data_subtot,'3',0,$ls_mostrar);
				...
				if($li_tmp==($li_totrow_det-1))
				{
					  ...
					  $ld_temp_monto_actualizado = $ld_monto_actualizado;
