...
//-----------------------------------------------------------------------------------------------------------------------------
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  -----------------------------------------
		...
		$ls_codestpro1_min  = str_pad($_GET["codestpro1"],25,"0",0);
		$ls_codestpro2_min  = str_pad($_GET["codestpro2"],25,"0",0);
		$ls_codestpro3_min  = "";
		$ls_codestpro1h_max = str_pad($_GET["codestpro1h"],25,"0",0);
		$ls_codestpro2h_max = str_pad($_GET["codestpro2h"],25,"0",0);
		$ls_codestpro3h_max = "";
	    if(($ls_codestpro1_min=="")&&($ls_codestpro2_min==""))
		{
			$arrResultado=$io_report->uf_spg_reporte_select_min_programatica($ls_codestpro1_min,$ls_codestpro2_min,$ls_codestpro3_min);				
		...
		{
				$arrResultado=$io_report->uf_spg_reporte_select_max_programatica($ls_codestpro1h_max,$ls_codestpro2h_max,$ls_codestpro3h_max);
	 ...
	 else // Imprimimos el reporte
	 {
		...
		if($lb_valido_proyectos)
		{
			...
			for($z=1;$z<=$li_total;$z++)
			{
				...
				$ls_denestpro1          = "";
				$arrResultado=$io_report->uf_spg_reporte_select_denestpro1($ls_codestpro1,$ls_denestpro1);
				...
				{
				  $ls_denestpro2="";
				  $arrResultado=$io_report->uf_spg_reporte_select_denestpro2($ls_codestpro1,$ls_codestpro2,$ls_denestpro2);
				...
				{
				  $ls_denestpro3="";
				  $arrResultado=$io_report->uf_spg_reporte_select_denestpro3($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_denestpro3);
