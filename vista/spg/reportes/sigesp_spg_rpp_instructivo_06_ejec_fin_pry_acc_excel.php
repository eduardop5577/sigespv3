...
//----------------------------------------------------  Parámetros del encabezado  ---------------------------------------------
		$ls_titulo="EJECUCIÓN FINANCIERA ".$ls_titmes1." DE LOS PROYECTOS / ACCIONES CENTRALIZADAS DEL ORGANO";       
//--------------------------------------------------------------------------------------------------------------------------------
	 ...
	 else // Imprimimos el reporte
	 {
		...
		$lo_hoja->write(2, 0,$ls_titmes,$lo_titulo);
		...
		$lo_hoja->write(7,2,$ls_titmes1,$lo_titulo);
		$lo_hoja->write(7,3,"Acumulado",$lo_titulo);
		$lo_hoja->write(7,4,$ls_titmes1,$lo_dataright2);
