...
//------------------------------------------------------------------------------------------------------------------------------
	...
	$arrResultado=$io_report->uf_spg_reporte_acumulado_cuentas2($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,
	...
	$rs_data=$arrResultado['rs_cuentas'];
	$lb_valido=$arrResultado['lb_valido'];
	...
	else // Imprimimos el reporte
	{
		...
		$ld_total_asignado2=0;
		$ld_total_aumento2=0;
		$ld_total_disminucion2=0;
		$ld_total_monto_actualizado2=0;
		$ld_total_compromiso2=0;
		$ld_total_precompromiso2=0;
		$ld_total_compromiso2=0;
		$ld_total_saldo_comprometer2=0;
		$ld_total_causado2=0;
		$ld_total_pagado2=0;
		$ld_total_por_paga2=0;
		...
		while(!$rs_data->EOF)
		{
			...
			//die();
			  ...
			  $rs_data2="";
			  $arrResultado=$io_report->uf_spg_reporte_detalle_acumulado_cuentas($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,
															                   ...
															                   $ldt_fecfin,$ls_codfuefindes,$ls_codfuefinhas,$rs_data2);
			  ...
			  while((!$rs_data2->EOF)&&($lb_valido2))
			  {
			   ...
			   if($ls_nivel==1)
			   {
				  ...
				  $lb_total_ok = true;
			  	  ...
			  	  $ld_total_asignado2=$ld_total_asignado2+$ld_asignado;
				  $ld_total_aumento2=$ld_total_aumento2+$ld_aumento;
				  $ld_total_disminucion2=$ld_total_disminucion2+$ld_disminucion;
				  $ld_total_monto_actualizado2=$ld_total_monto_actualizado2+$ld_monto_actualizado;
				  $ld_total_precompromiso2=$ld_total_precompromiso2+$ld_precompromiso;
				  $ld_total_compromiso2=$ld_total_compromiso2+$ld_compromiso;
				  $ld_total_saldo_comprometer2=$ld_total_saldo_comprometer2+$ld_saldo_comprometer;
				  $ld_total_causado2=$ld_total_causado2+$ld_causado;

				  $ld_total_pagado2=$ld_total_pagado2+$ld_pagado;
				  $ld_total_por_paga2=$ld_total_por_paga2+$ld_por_paga;
			...
			if($z==($li_tot-1))
			{
				  ...
				  if($lb_total_ok){
				  	...
				  	$ld_total_asignado2=number_format($ld_total_asignado2,2,",",".");
				  	$ld_total_aumento2=number_format($ld_total_aumento2,2,",",".");
				  	$ld_total_disminucion2=number_format($ld_total_disminucion2,2,",",".");
				    $ld_total_monto_actualizado2=number_format($ld_total_monto_actualizado2,2,",",".");
				    $ld_total_precompromiso2=number_format($ld_total_precompromiso2,2,",",".");
				    $ld_total_compromiso2=number_format($ld_total_compromiso2,2,",",".");
				    $ld_total_saldo_comprometer2=number_format($ld_total_saldo_comprometer2,2,",",".");
				    $ld_total_causado2=number_format($ld_total_causado2,2,",",".");
				    $ld_total_pagado2=number_format($ld_total_pagado2,2,",",".");
				    $ld_total_por_paga2=number_format($ld_total_por_paga2,2,",",".");
				  	$la_data_tot[$z]=array('TOTAL Bs.',$ld_total_asignado2,$ld_total_aumento2,$ld_total_disminucion2,
				  						$ld_total_monto_actualizado2,$ld_total_precompromiso2,$ld_total_compromiso2,
										$ld_total_saldo_comprometer2,$ld_total_causado2,$ld_total_pagado2,$ld_total_por_paga2);
				  }
			}//if
			  $rs_data->MoveNext();
			  $z=$z+1;
		...
		if($lb_valido2)
		{
			...
			$io_tcpdf->Output("sigesp_spg_rpp_acum_x_cuenta_cmsp.pdf", "I");
			unset($io_tcpdf);
		}
		else
		{
