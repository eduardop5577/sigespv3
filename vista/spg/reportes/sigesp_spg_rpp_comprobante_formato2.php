...
//-----------------------------------------------------------------------------------------------------------------------------
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  -----------------------------------------
		...
		if($ls_cuentades_min=="")
		{
		   $arrResultado=$io_report->uf_spg_reporte_select_min_cuenta($ls_cuentades_min);
		...
		if($ls_cuentahas_max=="")
		{
		   $arrResultado=$io_report->uf_spg_reporte_select_max_cuenta($ls_cuentahas_max);
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","sigesp_vis_spg_reporte_comprobante_f1_f2.html",$ls_desc_event);
	////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )
	 $arrResultado=$io_report->uf_spg_reporte_select_comprobante_formato2($ls_cuentades,$ls_cuentahas,$ldt_fecdes,$ldt_fechas,$rsDatos1);
	 $rsDatos1=$arrResultado['rs_data'];
	 $lb_valido=$arrResultado['lb_valido'];
	 ...
	 //	$io_tcpdf->Cell(0,11,$ls_fecha_comp,0,1,'C');
		...
		{	
			...
			$ls_numconcom=$rsDatos1->fields["numconcom"];
	 	  ...
	 	  $io_tcpdf->uf_print_cabecera_comformato2($ls_procede,$ls_comprobante,$ls_nomprobene,$ls_numconcom); // Imprimimos la cabecera del registro
			$rsDatos2="";
	 	  $arrResultado=$io_report->uf_spg_reporte_comprobante_formato2($ls_cuentades,$ls_cuentahas,$ldt_fecdes,$ldt_fechas,
			                                                           $ls_comprobante,$ls_procede,$rsDatos2);                                
		  $rsDatos2=$arrResultado['rs_data'];
		  $lb_valido=$arrResultado['lb_valido'];
			if($lb_valido)
			{
				$li_s=0;
				...
				$ls_denestpro1="";
			   $arrResultado = $io_report->uf_spg_reporte_select_denestpro1($rsDatos2->fields["codestpro1"],$ls_denestpro1,$rsDatos2->fields["estcla"]);
			   ...
			   { //print "PASO 02";
				$ls_denestpro2="";
			     $arrResultado=$io_report->io_spg_report_funciones->uf_spg_reporte_select_denestpro2($rsDatos2->fields["codestpro1"],$rsDatos2->fields["codestpro2"],$ls_denestpro2,$rsDatos2->fields["estcla"]);
			   ...
			   { //print "PASO 03";
			     $ls_denestpro3="";
			     $arrResultado=$io_report->io_spg_report_funciones->uf_spg_reporte_select_denestpro3($rsDatos2->fields["codestpro1"],$rsDatos2->fields["codestpro2"],$rsDatos2->fields["codestpro3"],$ls_denestpro3,$rsDatos2->fields["estcla"]);
			   ...
			   { //print "PASO 04";
			     $ls_denestpro4="";
			     $arrResultado=$io_report->io_spg_report_funciones->uf_spg_reporte_select_denestpro4($rsDatos2->fields["codestpro1"],$rsDatos2->fields["codestpro2"],$rsDatos2->fields["codestpro3"],$rsDatos2->fields["codestpro4"],$ls_denestpro4,$rsDatos2->fields["estcla"]);
			   ...
			   { //print "PASO 05";
			     $ls_denestpro5="";
			     $arrResultado=$io_report->io_spg_report_funciones->uf_spg_reporte_select_denestpro5($rsDatos2->fields["codestpro1"],$rsDatos2->fields["codestpro2"],$rsDatos2->fields["codestpro3"],$rsDatos2->fields["codestpro4"],$rsDatos2->fields["codestpro5"],$ls_denestpro5,$rsDatos2->fields["estcla"]);
