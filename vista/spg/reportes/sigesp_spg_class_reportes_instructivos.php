...
class sigesp_spg_class_reportes_instructivos
{
	...
	/////////////////////////////////////////////////////////////////////////////////
	function uf_spg_reporte_consolidado_de_ejecucion_trimestral($adt_fecdes,$adt_fechas,$as_mesdes,$as_meshas,$codestproD,$codestproH)
	{///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if(!empty($codestproD) && !empty($codestproH)) {
		...
		{
	 		$filtroSQL = " AND (CONCAT(codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,estcla) BETWEEN '{$codestproD}' AND '{$codestproH}') ";
	 	}
	 	else {
	 		$filtroSQL = " AND ((codestpro1||codestpro2||codestpro3||codestpro4||codestpro5||estcla) BETWEEN '{$codestproD}' AND '{$codestproH}') ";
	 	}
	 ...
	 $ls_sql=" SELECT max(codemp) as codemp, spg_cuenta, max(denominacion) as denominacion,             ".
             ...
             " FROM spg_cuentas                                                                         ".
             " WHERE codemp='".$this->ls_codemp."'  AND  nivel = '1' {$filtroSQL}                       ".
             " GROUP BY spg_cuenta                                                                      ".
             " ORDER BY spg_cuenta ";
	 ...
	 else
	 {
	 	...
	 	if($li_numrows>=0)
	 	{
			 ...
			 while(!$rs_data->EOF)
			 {
			 	...
			 	$arrResultado=$this->uf_spg_ejecutado_trimestral($ls_spg_cuenta,$adt_fecdes,$adt_fechas,$ld_comprometer,
			 	$ld_causado,$ld_pagado,$ld_aumento,$ld_disminucion,$codestproD,$codestproH);
				...
				$lb_valido=$arrResultado['lb_valido'];
			 	...
			 	if($lb_valido)
			 	{
			 		$arrResultado=$this->uf_spg_ejecutado_acumulado($ls_spg_cuenta,$adt_fechas,$ld_comprometer_acumulado,
			 		$ld_causado_acumulado,$ld_pagado_acumulado,$ld_aumento_acumulado,
			 		$ld_disminucion_acumulado,$codestproD,$codestproH);
					$ld_comprometer_acumulado=$arrResultado['ad_comprometer_acumulado'];
					$ld_causado_acumulado=$arrResultado['ad_causado_acumulado'];
					$ld_pagado_acumulado=$arrResultado['ad_pagado_acumulado'];
	...
	$ad_aumento,$ad_disminucion,$codestproD,$codestproH)
	{///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $ls_sql_compromiso = "SELECT COALESCE(SUM(DT.monto),0.00) as compromiso ".
						  ...
						  "        DT.fecha BETWEEN '".$adt_fecdes."' AND  '".$adt_fechas."' {$filtroSQL}";
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_spg_ejecutado_acumulado($as_spg_cuenta,$adt_fechas,$ad_comprometer_acumulado,$ad_causado_acumulado,$ad_pagado_acumulado,$ad_aumento_acumulado,
	                                    $ad_disminucion_acumulado,$codestproD,$codestproH)
	{///////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_ejecutado_trimestral
	 //         Access :	private
	 //     Argumentos :    $as_spg_cuenta  -----> cuenta
	 ...
	 // Fecha Creación :    18/05/2008
		...
		else
		{
			...
			while(!$rs_data->EOF)
			{
				...
				$ld_cauacutri     = 0;
				$ld_pagacutri     = 0;
				$arrResultado=$this->uf_buscar_programacion($ls_criterio,$ls_spg_cuenta, $li_trimestre, $ld_programado, $ld_programado_acum);
				$ld_programado=$arrResultado['ld_programado'];
				$ld_programado_acum=$arrResultado['ld_programado_acum'];
				$arrResultado=$this->uf_spg_reporte_calcular_ejecutado_trimestre($ls_spg_cuenta,$ls_estructura5_desde,
				...
				$ld_comtriact=$arrResultado['ad_comtriact'];
				$ld_cautriact=$arrResultado['ad_cautriact'];
				$ld_pagtriact=$arrResultado['ad_pagtriact'];
				$ld_comacutri=$arrResultado['ad_comacutri'];
				$ld_cauacutri=$arrResultado['ad_cauacutri'];
				$ld_pagacutri=$arrResultado['ad_pagacutri'];
				$lb_valido=$arrResultado['lb_valido'];
	...
	function uf_buscar_programacion($ls_criterio, $as_spgcuenta, $li_trimestre, $ld_programado, $ld_programado_acum) {
		...
		$ls_sql=" SELECT C.spg_cuenta, max(C.nivel) as nivel, max(C.denominacion) as denominacion, ".
				...
				"        sum(C.noviembre) as noviembre, sum(C.diciembre) as diciembre, MAX(C.status) as status ".
			    " FROM   spg_cuentas C ". 
			    " WHERE  C.codemp='".$this->dts_empresa["codemp"]."' and C.spg_cuenta='".$as_spgcuenta."'".
				$ls_criterio.
				" GROUP BY C.spg_cuenta ".
       			" ORDER BY C.spg_cuenta  ";
		//echo $ls_sql;
		...
		$arrResultado['ld_programado']=$ld_programado;
		$arrResultado['ld_programado_acum']=$ld_programado_acum;
		return $arrResultado;				
	}
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    18/05/2008          Fecha última Modificacion :      Hora :
		...
		if($rs_ejec===false)
		{
			$this->is_msg_error="Error en consulta metodo uf_spg_reporte_calcular_ejecutado_trimestre".$this->io_funciones->uf_convertirmsg($this->io_sql->message);
			$lb_valido = false;
		}
		else
		{
		...
		$arrResultado['ad_comtriact']=$ad_comtriact;
		$arrResultado['ad_cautriact']=$ad_cautriact;
		$arrResultado['ad_pagtriact']=$ad_pagtriact;
		$arrResultado['ad_comacutri']=$ad_comacutri;
		$arrResultado['ad_cauacutri']=$ad_cauacutri;
		$arrResultado['ad_pagacutri']=$ad_pagacutri;
		$arrResultado['lb_valido']=$lb_valido;
		return $arrResultado;		
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	 	$this->is_msg_error="Error en consulta metodo uf_spg_reporte_select_denestpro1 ".$this->io_funciones->uf_convertirmsg($this->io_sql->message);
	 	$lb_valido = false;
	 }
	 else
	 {
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	 	$this->is_msg_error="Error en consulta metodo uf_spg_reporte_select_denestpro2 ".$this->io_funciones->uf_convertirmsg($this->io_sql->message);
	 	$lb_valido = false;
	 }
	 else
	 {
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	 	$this->is_msg_error="Error en consulta metodo uf_spg_reporte_select_denestpro3 ".$this->io_funciones->uf_convertirmsg($this->io_sql->message);
	 	$lb_valido = false;
	 }
	 else
	 {
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	 	$this->is_msg_error="Error en consulta metodo uf_spg_reporte_select_denestpro4 ".$this->io_funciones->uf_convertirmsg($this->io_sql->message);
	 	$lb_valido = false;
	 }
	 else
	 {
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	 	$this->is_msg_error="Error en consulta metodo uf_spg_reporte_select_min_codestpro1 ".$this->io_funciones->uf_convertirmsg($this->io_sql->message);
	 	$lb_valido = false;
	 }
	 else
	 {
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	 	$this->is_msg_error="Error en consulta metodo uf_spg_reporte_select_min_codestpro2 ".$this->io_funciones->uf_convertirmsg($this->io_sql->message);
	 	$lb_valido = false;
	 }
	 else
	 {
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	 	$this->is_msg_error="Error en consulta metodo uf_spg_reporte_select_min_codestpro3 ".$this->io_funciones->uf_convertirmsg($this->io_sql->message);
	 	$lb_valido = false;
	 }
	 else
	 {
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	 	$this->is_msg_error="Error en consulta metodo uf_spg_reporte_select_max_codestpro1 ".$this->io_funciones->uf_convertirmsg($this->io_sql->message);
	 	$lb_valido = false;
	 }
	 else
	 {
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	 	$this->is_msg_error="Error en consulta metodo uf_spg_reporte_select_max_codestpro2 ".$this->io_funciones->uf_convertirmsg($this->io_sql->message);
	 	$lb_valido = false;
	 }
	 else
	 {
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	 	$this->is_msg_error="Error en consulta metodo uf_spg_reporte_select_max_codestpro3 ".$this->io_funciones->uf_convertirmsg($this->io_sql->message);
	 	$lb_valido = false;
	 }
	 else
	 {
	 	...
	 	for($i=1;$i<=13;$i++)
	 	{
	 		...
	 		if($li_pos>0)
	 		{
				...
				else
				{
					...
					$arrResultado=$this->uf_spg_reportes_select_denominacion($ls_cuenta_buscar,$ls_denom);
		...
		else
		{
			...
			if($li_numrows>=0)
			{
			 ...
			 while(!$rs_data->EOF)
			 {
			 	...
			 	$arrResultado=$this->uf_spi_ejecutado_trimestral($ls_spi_cuenta,$adt_fecdes,$adt_fechas,$ld_cobrado_anticipado,
				...
				$lb_valido =$arrResultado['lb_valido'];
			 	if($lb_valido)
			 	{
			 		$arrResultado=$this->uf_spi_ejecutado_acumulado($ls_spi_cuenta,$adt_fechas,$ld_cobrado_anticipado_acumulado,
			 		$ld_cobrado_acumulado,$ld_devengado_acumulado,
			 		$ld_aumento_acumulado,$ld_disminucion_acumulado,
			 		$ls_detallar);
					$ld_cobrado_anticipado_acumulado=$arrResultado['ad_cobrado_anticipado_acumulado'];
					$ld_cobrado_acumulado=$arrResultado['ad_cobrado_acumulado'];
					$ld_devengado_acumulado=$arrResultado['ad_devengado_acumulado'];
					$ld_aumento_acumulado=$arrResultado['ad_aumento_acumulado'];
					$ld_disminucion_acumulado=$arrResultado['ad_disminucion_acumulado'];
					$lb_valido=$arrResultado['lb_valido'];
			 	}//if
		...
		else
		{
			...
			if($li_numrows>=0)
			{
			 ...
			 while(!$rs_data->EOF)
			 {
			 	...
			 	$arrResultado=$this->uf_spg_ejecutado_trimestral_estado_resultado($ls_spg_cuenta,$adt_fecdes,$adt_fechas,
				...
				$lb_valido=$arrResultado['lb_valido'];
			 	if($lb_valido)
			 	{
			 		$arrResultado=$this->uf_spg_ejecutado_acumulado_estado_resultado($ls_spg_cuenta,$adt_fechas,$ld_comprometer_acumulado,
			 ...
			 while(!$rs_data->EOF)
			 {
				...
				$lb_valido=$arrResultado['lb_valido'];
			 	if($lb_valido)
			 	{
			 		$arrResultado=$this->uf_spg_ejecutado_acumulado_estado_resultado($ls_spg_cuenta,$adt_fechas,$ld_comprometer_acumulado,
			 		$ld_causado_acumulado,$ld_pagado_acumulado,
			 		$ld_aumento_acumulado,$ld_disminucion_acumulado,$ls_detallar);
					$ld_comprometer_acumulado=$arrResultado['ad_comprometer_acumulado'];
					$ld_causado_acumulado=$arrResultado['ad_causado_acumulado'];
					$ld_pagado_acumulado=$arrResultado['ad_pagado_acumulado'];
					$ld_aumento_acumulado=$arrResultado['ad_aumento_acumulado'];
	...
	{///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $this->io_sql->free_result($rs_ejecutado_aum);
	 $this->io_sql->free_result($rs_ejecutado_dis);
	$arrResultado['ad_cobrado_anticipado_acumulado']=$ad_cobrado_anticipado_acumulado;
	$arrResultado['ad_cobrado_acumulado']=$ad_cobrado_acumulado;
	$arrResultado['ad_devengado_acumulado']=$ad_devengado_acumulado;
	$arrResultado['ad_aumento_acumulado']=$ad_aumento_acumulado;
	$arrResultado['ad_disminucion_acumulado']=$ad_disminucion_acumulado;
	$arrResultado['lb_valido']=$lb_valido;
		return $arrResultado;		
			   ...
			   $ld_programado_acumulado=$rs_data->fields["trimestrei"]+$rs_data->fields["trimestreii"]+$rs_data->fields["trimestreiii"]+$rs_data->fields["trimestreiv"];
					...
					switch(substr($ls_cuenta,0,1))
					{
						case '3':
							...
							$ld_disminucion_acum = 0;
							$ls_detallar = false;
							$arrResultado = $this->uf_spi_ejecutado_trimestral($ls_cuenta,$ad_fecdes,$ad_fechas,$ld_cobrado_anticipado,
							...
							if($lb_valido)
							{
								$arrResultado = $this->uf_spi_ejecutado_trimestral($ls_cuenta,$ld_fecdesacum,$ad_fechas,$ld_cobrado_anticipado_acum,
								$ld_cobrado_acum,$ld_devengado_acum,$ld_aumento_acum,$ld_disminucion_acum,$ls_detallar);
								$ld_cobrado_anticipado_acum =$arrResultado['ad_cobrado_anticipado'];
								$ld_cobrado_acum =$arrResultado['ad_cobrado'];
								$ld_devengado_acum =$arrResultado['ad_devengado'];
								$ld_aumento_acum =$arrResultado['ad_aumento'];
								$ld_disminucion_acum =$arrResultado['ad_disminucion'];
								$lb_valido =$arrResultado['lb_valido'];
				    ...
				    $this->dts_reporte->insertRow("tipo","EG");
							...
							$arrResultado=$this->uf_spg_ejecutado_trimestral_estado_resultado($ls_cuenta,$ad_fecdes,$ad_fechas,$ld_comprometer,$ld_causado,$ld_pagado,
							$ld_aumento,$ld_disminucion,$ls_detallar);
							$ld_comprometer=$arrResultado['ad_comprometer'];
							$ld_causado=$arrResultado['ad_causado'];
							$ld_pagado=$arrResultado['ad_pagado'];
							...
							if($lb_valido)
							{
								$arrResultado=$this->uf_spg_ejecutado_trimestral_estado_resultado($ls_cuenta,$ld_fecdesacum,$ad_fechas,$ld_comprometer_acum,$ld_causado_acum,$ld_pagado_acum,
								$ld_aumento_acum,$ld_disminucion_acum,$ls_detallar);
								$ld_comprometer_acum=$arrResultado['ad_comprometer'];
								$ld_causado_acum=$arrResultado['ad_causado'];
								$ld_pagado_acum=$arrResultado['ad_pagado'];
								$ld_aumento_acum=$arrResultado['ad_aumento'];
								$ld_disminucion_acum=$arrResultado['ad_disminucion'];
								$lb_valido=$arrResultado['lb_valido'];
								$ld_modificado += $ld_aumento_acum;
	...
	function uf_spg_reporte_de_ejecucion_mensual_recursos($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,
	$as_codestpro4_ori,$as_codestpro5_ori,$as_codestpro1_des,
	$as_codestpro2_des,$as_codestpro3_des,$as_codestpro4_des,
	$as_codestpro5_des,$adt_fecdes,$adt_fechas,
	$as_codfuefindes,$as_codfuefinhas,$as_estclades,$as_estclahas)
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    18/05/2008
		...
		$li_mesdes=$adt_fecdes;
		$li_meshas=$adt_fechas;
		$li_mes = substr($li_mesdes,5,2);
		$li_mes = intval($li_mes);
		$ls_criterio="";
		if($as_codestpro1_ori!="0000000000000000000000000")
		{
			if($as_codestpro2_ori!="0000000000000000000000000")
		...
		else
		{
			...
			while(!$rs_data->EOF)
			{
				...
				$ld_cauacutri     = 0;
				$ld_pagacutri     = 0;
				$arrResultado=$this->uf_buscar_programacion_mensual($ls_criterio,$ls_spg_cuenta, $li_mes, $ld_programado, $ld_programado_acum);
				$ld_programado=$arrResultado['ld_programado'];
				$ld_programado_acum=$arrResultado['ld_programado_acum'];
				$arrResultado=$this->uf_spg_reporte_calcular_ejecutado_mes($ls_spg_cuenta,$ls_estructura5_desde,
				$ls_estructura5_hasta,$li_mesdes,$li_meshas,
				$as_codestpro1_ori,$as_codestpro2_ori,
				$as_codestpro3_ori,$as_codestpro4_ori,
				$as_codestpro5_ori,$as_codestpro1_des,
				$as_codestpro2_des,$as_codestpro3_des,
				$as_codestpro4_des,$as_codestpro5_des);
                                $ad_compromiso=$arrResultado['compromiso'];
                                $ad_causado=$arrResultado['causado'];
                                $ad_pagado=$arrResultado['pagado'];
                                $ld_aumento=$arrResultado['aumento'];
                                $ld_disminucion=$arrResultado['disminucion'];
                                $ad_compromiso_acum=$arrResultado['compromiso_acum'];
                                $ad_causado_acum=$arrResultado['causado_acum'];
                                $ad_pagado_acum=$arrResultado['pagado_acum'];
                                $ld_aumento_acum=$arrResultado['aumento_acum'];
                                $ld_disminucion_acum=$arrResultado['disminucion_acum'];
				$lb_valido=$arrResultado['valido'];

				if($lb_valido)
				{
					$ld_dispon_fecha=$ld_asignado+$ld_aumento_acum-$ld_disminucion_acum-$ad_compromiso_acum;
					$ld_dispon_causado=$ld_asignado+$ld_aumento_acum-$ld_disminucion_acum-$ad_causado_acum;
					$ld_modificado = $ld_asignado +$ld_aumento-$ld_disminucion;
					$this->dts_reporte->insertRow("spg_cuenta",$ls_spg_cuenta);
					$this->dts_reporte->insertRow("denominacion",$ls_denominacion);
					$this->dts_reporte->insertRow("asignado",$ld_asignado);
					...
					$this->dts_reporte->insertRow("modificado",$ld_modificado);
					$this->dts_reporte->insertRow("programado",$ld_programado);
					$this->dts_reporte->insertRow("compromiso",$ad_compromiso);
					$this->dts_reporte->insertRow("causado",$ad_causado);
					$this->dts_reporte->insertRow("pagado",$ad_pagado);
					$this->dts_reporte->insertRow("programado_acum",$ld_programado_acum);
					$this->dts_reporte->insertRow("compromiso_acum",$ad_compromiso_acum);
					$this->dts_reporte->insertRow("causado_acum",$ad_causado_acum);
					$this->dts_reporte->insertRow("pagado_acum",$ad_pagado_acum);
					$this->dts_reporte->insertRow("aumento_acum",$ld_aumento_acum);
					$this->dts_reporte->insertRow("disminucion_acum",$ld_disminucion_acum);
					$this->dts_reporte->insertRow("disponible_fecha",$ld_dispon_fecha);
					$this->dts_reporte->insertRow("disponible_causado",$ld_dispon_causado);
					$this->dts_reporte->insertRow("status",$ls_status);
					$lb_valido=true;
				}//if
	...
	function uf_spg_reporte_calcular_ejecutado_mes($as_spg_cuenta,$as_estructura_desde,$as_estructura_hasta,$ai_mesdes,
	$ai_meshas,$as_codestpro1_ori,
	$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,$as_codestpro5_ori,
	$as_codestpro1_des,$as_codestpro2_des,$as_codestpro3_des,$as_codestpro4_des,
	$as_codestpro5_des)
	{
		...
		else
		{
		  ...
		  if((($li_comprometer))&&($ldt_fecha>=$li_mesdes)&&($ldt_fecha<=$li_meshas))
		  {
		  	$ad_compromiso=$ad_compromiso+$ld_monto;
		  }//if
		  if(($li_causar)&&($ldt_fecha>=$li_mesdes)&&($ldt_fecha<=$li_meshas))
		  {
		  ...
		  if((($li_comprometer))&&($ldt_fecha<=$li_meshas))
		  {
		  	$ad_compromiso_acum=$ad_compromiso_acum+$ld_monto;
		  }//if
		  if(($li_causar)&&($ldt_fecha<=$li_meshas))
		  {
		  	$ad_causado_acum=$ad_causado_acum+$ld_monto;
		  }//if
		  if(($li_pagar)&&($ldt_fecha<=$li_meshas))
		  {
		  	$ad_pagado_acum=$ad_pagado_acum+$ld_monto;
		  }//if
		  if(($li_aumento)&&($ldt_fecha<=$li_meshas))
		  {
		...
		$arrResultado['compromiso']=$ad_compromiso;
		$arrResultado['causado']=$ad_causado;
		$arrResultado['pagado']=$ad_pagado;
		$arrResultado['aumento']=$ld_aumento;
		$arrResultado['disminucion']=$ld_disminucion;
		$arrResultado['compromiso_acum']=$ad_compromiso_acum;
		$arrResultado['causado_acum']=$ad_causado_acum;
		$arrResultado['pagado_acum']=$ad_pagado_acum;
		$arrResultado['aumento_acum']=$ld_aumento_acum;
		$arrResultado['disminucion_acum']=$ld_disminucion_acum;
		$arrResultado['valido']=$lb_valido;
		return $arrResultado;		
	}//fin uf_spg_reporte_calcular_ejecutado_trimestre
	/****************************************************************************************************************************************/
	function uf_buscar_programacion_mensual($ls_criterio, $as_spgcuenta, $li_mes, $ld_programado, $ld_programado_acum) {
		...
		if($rs_data===false){   // error interno sql
			...
			while(!$rs_data->EOF){
				...
				switch ($li_mes){
					case 1:
						$ld_programado      =  $ld_enero;
						$ld_programado_acum =  $ld_enero;
						break;

					case 2:
						$ld_programado      =  $ld_febrero;
						$ld_programado_acum =  $ld_enero + $ld_febrero ;
						break;

					case 3:
						$ld_programado      =  $ld_marzo;
						$ld_programado_acum =  $ld_enero + $ld_febrero + $ld_marzo;
						break;

					case 4:
						$ld_programado      =  $ld_abril;
						$ld_programado_acum =  $ld_enero + $ld_febrero + $ld_marzo + $ld_abril;
						break;
							
					case 5:
						$ld_programado      =  $ld_mayo;
						$ld_programado_acum =  $ld_enero + $ld_febrero + $ld_marzo + $ld_abril + $ld_mayo;
						break;
					case 6:
						$ld_programado      =  $ld_junio;
						$ld_programado_acum =  $ld_enero + $ld_febrero + $ld_marzo + $ld_abril + $ld_mayo + $ld_junio;
						break;
					case 7:
						$ld_programado      =  $ld_julio;
						$ld_programado_acum =  $ld_enero + $ld_febrero + $ld_marzo + $ld_abril + $ld_mayo + $ld_junio + $ld_julio;
						break;
					case 8:
						$ld_programado      =  $ld_agosto;
						$ld_programado_acum =  $ld_enero + $ld_febrero + $ld_marzo + $ld_abril + $ld_mayo + $ld_junio +
						$ld_julio + $ld_agosto;
						break;
					case 9:
						$ld_programado      =  $ld_septiembre;
						$ld_programado_acum =  $ld_enero + $ld_febrero + $ld_marzo + $ld_abril + $ld_mayo + $ld_junio +
						$ld_julio + $ld_agosto + $ld_septiembre;
						break;
							
					case 10:
						$ld_programado      =  $ld_octubre;
						$ld_programado_acum =  $ld_enero + $ld_febrero + $ld_marzo +  $ld_abril + $ld_mayo + $ld_junio + $ld_julio + $ld_agosto + $ld_septiembre + $ld_octubre;
						break;
					case 11:
						$ld_programado      =  $ld_noviembre;
						$ld_programado_acum =  $ld_enero + $ld_febrero + $ld_marzo +  $ld_abril + $ld_mayo + $ld_junio + $ld_julio + $ld_agosto + $ld_septiembre + $ld_octubre + $ld_noviembre;
						break;
					case 12:
						$ld_programado      =  $ld_diciembre;
						$ld_programado_acum =  $ld_enero + $ld_febrero + $ld_marzo +  $ld_abril + $ld_mayo + $ld_junio + $ld_julio + $ld_agosto + $ld_septiembre + $ld_octubre + $ld_noviembre + $ld_diciembre;
						break;
				}
