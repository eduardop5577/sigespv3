...
//--------------------------------------------------  Parámetros para Filtar el Reporte  --------------------------------------
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","sigesp_vis_spg_reporte_resumen_fideicomiso.html",$ls_desc_event);
	////////////////////////////////         SEGURIDAD               ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------  Parámetros del encabezado  --------------------------------------------------------------------------------------------------------------------------------------
		$ls_denfuefin="";
		$arrResultado=$io_report->uf_select_denominacion_fuentefideicomiso($ls_codfuefindes,$ls_denfuefin);
