...
if ($la_result_dis->EOF && $la_result_aum->EOF){
	...
	$arrResultado = $io_report->uf_obtener_datadetalle($la_result_dis,$ld_tot_dis,true);
	...
	$arrResultado = $io_report->uf_obtener_datadetalle($la_result_aum,$ld_tot_aum,true);
