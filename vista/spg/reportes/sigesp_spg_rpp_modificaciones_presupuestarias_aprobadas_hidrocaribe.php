...
***********************************************************************************/
	...
	function uf_print_cabecera_detalle($io_encabezado,$as_descripcion,$as_numdoc,$as_fecmov,$as_fecaprmod,$as_tipmodpre,$io_pdf)
	{
		...
		$io_pdf->rectangle(40,40,550,100);
		$io_pdf->line(40,125,590,125);
		$io_pdf->line(315,40,315,140);
		$io_pdf->addText(145,130,8,'Nivel Elaboracion');
		$io_pdf->addText(420,130,8,'Nivel Aprobacion');

		$io_pdf->line(108,40,108,125);
		$io_pdf->line(177,40,177,125);
		$io_pdf->line(245,40,245,125);
		$io_pdf->line(40,110,315,110);
		$io_pdf->addText(45,115,8,'Preparado Por:');
		$io_pdf->addText(115,115,8,'Revisado Por:');
		$io_pdf->addText(181,115,8,'Conformado Por:');
		$io_pdf->addText(252,115,8,'Autorizado Por:');
		$io_pdf->addText(48,45,8,'Firma / Sello');
		$io_pdf->addText(118,45,8,'Firma / Sello');
		$io_pdf->addText(184,45,8,'Firma / Sello');
		$io_pdf->addText(256,45,8,'Firma / Sello');
		
		$io_pdf->rectangle(320,112,10,10);
		$io_pdf->addText(335,112,7,'Gerente');
		$io_pdf->rectangle(410,112,10,10);
		$io_pdf->addText(428,117,7,'Presidente /');
		$io_pdf->addText(425,109,7,'Vicepresidente');
		$io_pdf->rectangle(500,112,10,10);
		$io_pdf->addText(515,117,7,'Ministro del');
		$io_pdf->addText(518,109,7,'Ambiente');
		$io_pdf->rectangle(320,90,10,10);
		$io_pdf->addText(335,95,7,'Oficina Nacional');
		$io_pdf->addText(337,87,7,'de Presupuesto');
		$io_pdf->rectangle(500,90,10,10);
		$io_pdf->addText(515,95,7,'Presidente de la');
		$io_pdf->addText(525,87,7,'Republica');


		$io_pdf->addText(400,45,8,'Firma                               Sello');
