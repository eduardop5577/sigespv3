	...
	function uf_print_cabecera_detalle($io_encabezado,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la
						 			   ...
						 			   'asignado'=>array('justification'=>'right','width'=>82), // Justificación y ancho de la
						 			   'actualizado'=>array('justification'=>'right','width'=>82), // Justificación y ancho de la
									   'disponibilidad'=>array('justification'=>'right','width'=>86))); // Justificación y ancho de
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'colGap'=>1,
				 		 'cols'=>array('total'=>array('justification'=>'right','width'=>300), // Justificación y ancho de la columna
						 	           'asignado'=>array('justification'=>'right','width'=>82), // Justificación y ancho de la
				 		 			   'actualizado'=>array('justification'=>'right','width'=>82), // Justificación y ancho de la
							           'disminucion'=>array('justification'=>'right','width'=>86))); // Justificación y ancho de la
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			if (!empty($ls_programatica))
		    {
				...
				$la_data[$z]=array('cuenta'=>$ls_spg_cuenta,'denominacion'=>$ls_denominacion,
								   'asignado'=>$ld_asignado,'actualizado'=>$ld_actualizado,'disponibilidad'=>$ld_disponible);
