...
***********************************************************************************/
	...
	function uf_print_cabecera_detalle($io_encabezado,$io_pdf)
	{
		...
		$la_data=array(array('cuenta'=>'<b>Cuenta</b>','denominacion'=>'<b>Denominación</b>','asignado'=>'<b>Asignado</b>',
		                     'actualizado'=>'<b>Actualizado</b>','disponibilidad'=>'<b>Disponibilidad</b>'));
		$la_columnas=array('cuenta'=>'','denominacion'=>'','asignado'=>'','actualizado'=>'','disponibilidad'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la
						 			   ...
						 			   'asignado'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la
						 		       'actualizado'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la
									   'disponibilidad'=>array('justification'=>'center','width'=>90))); // Justificación y ancho
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
						 			   ...
						 			   'asignado'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la
						 			   'actualizado'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la
									   'disponibilidad'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera($ad_totalasignado,$ad_totalactualizado,$ad_totaldisponible,$as_denominacion,$io_pdf)
	{
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_pdf;
		$la_data=array(array('total'=>'<b> Total '.$as_denominacion.' </b>','asignado'=>$ad_totalasignado,
							 'actualizado'=>$ad_totalactualizado,'disminucion'=>$ad_totaldisponible));
		$la_columna=array('total'=>'','asignado'=>'','actualizado'=>'','disminucion'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 ...
						 'colGap'=>1,
				 		 'cols'=>array('total'=>array('justification'=>'right','width'=>280), // Justificación y ancho de la columna
						 	           'asignado'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la
				 		 			   'actualizado'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la
							           'disminucion'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de la
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			if($li_tot==1)
			{
				...
				if($li_estmodest==2)
				{
					...
					{
					  $ls_denestpro4="";
					  $arrResultado=$io_report->uf_spg_reporte_select_denestpro4($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_denestpro4,$ls_denestpro4,$ls_estcla);
					  $ls_denestpro4=$arrResultado['as_denestpro4'];
					  $lb_valido=$arrResultado['lb_valido'];
					  $ls_denestpro4=trim($ls_denestpro4);
					}
			...
			/*if(!empty($ls_programatica_next))
			{
				...
				if($li_estmodest==2)
				{
					...
					{
					  $ls_denestpro5="";
					  $arrResultado=$io_report->uf_spg_reporte_select_denestpro5($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,$ls_denestpro5,$ls_denestpro5,$ls_estcla);
					  $ls_denestpro5=$arrResultado['as_denestpro5'];
					  $lb_valido=$arrResultado['lb_valido'];
					  $ls_denestpro5=trim($ls_denestpro5);
					}
			...
			if (!empty($ls_programatica))
		    {
				...
				$ld_disponible=number_format($ld_disponible,2,",",".");
				 if ($ls_status=="S")
				 {
                                     $la_data[$z]=array('cuenta'=>'<b>'.$ls_spg_cuenta.'</b>','denominacion'=>'<b>'.$ls_denominacion.'</b>', 'asignado'=>'<b>'.$ld_asignado.'</b>',
                                                        'actualizado'=>'<b>'.$ld_actualizado.'</b>','disponibilidad'=>'<b>'.$ld_disponible.'</b>');
                                 }
                                 else
                                 {
			...
			if (!empty($ls_programatica_next))
			{
				...
				$ld_disponible=number_format($ld_disponible,2,",",".");
				 if ($ls_status=="S")
				 {
                                     ...
                                     $ld_actualizado='<b>'.$ld_actualizado.'</b>';
				...
				uf_print_pie_cabecera($ld_totalasignado,$ld_totalactualizado,$ld_totaldisponible,'Bs.',$io_pdf);
