	 ...
	 else
	 {
	 	...
	 	if($li_numrows>=0)
	 	{
	 		while($row=$this->io_sql->fetch_row($rs_data))
			 {
			 	...
			 	$arrResultado=$this->uf_spg_ejecutado_mensual($ls_codestpro1,"","",$adt_fecdes,$adt_fechas,$ld_ejecutado_mens_comp,
				...
				$lb_valido=$arrResultado['lb_valido'];
			 	if($lb_valido)
			 	{
			 		$arrResultado=$this->uf_spg_ejecutado_acumulado($ls_codestpro1,"","",$adt_fechas,$ld_ejecutado_acum_comp,
	 ...
	 else
	 {
	 	...
	 	if($li_numrows>=0)
	 	{
	 		while($row=$this->io_sql->fetch_row($rs_data))
			 {
			 	...
			 	$arrResultado=$this->uf_spg_ejecutado_mensual($ls_codestpro1,$ls_codestpro2 ,"",$adt_fecdes,$adt_fechas,$ld_ejecutado_mens_comp,
			 	$ld_ejecutado_mens_caus,$ld_ejecutado_mens_paga,$ld_ejecutado_mens_aume,$ld_ejecutado_mens_dism);
				$ld_ejecutado_mens_comp=$arrResultado['ad_comprometer'];
				$ld_ejecutado_mens_caus=$arrResultado['ad_causado'];
				$ld_ejecutado_mens_paga=$arrResultado['ad_pagado'];
				...
				$lb_valido=$arrResultado['lb_valido'];
			 	if($lb_valido)
			 	{
			 		$arrResultado=$this->uf_spg_ejecutado_acumulado($ls_codestpro1,$ls_codestpro2,"",$adt_fechas,$ld_ejecutado_acum_comp,
			 		$ld_ejecutado_acum_caus,$ld_ejecutado_acum_paga,$ld_ejecutado_acum_aume,
			 		$ld_ejecutado_acum_dism);
					$ld_ejecutado_acum_comp=$arrResultado['ad_comprometer_acumulado'];
					$ld_ejecutado_acum_caus=$arrResultado['ad_causado_acumulado'];
