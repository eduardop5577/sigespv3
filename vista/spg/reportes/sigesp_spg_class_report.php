...
class sigesp_spg_class_report
{
	...
	$as_codestpro3_ori,$as_codestpro4_ori,$as_codestpro5_ori,$as_codestpro1_des,
	$as_codestpro2_des,$as_codestpro3_des,$as_codestpro4_des,$as_codestpro5_des,
	$as_Sql_Where,$as_str_estructura_from,$as_str_estructura_to )
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //	Description :	Método  que ejecuta todas funciones de acumulado para asi sacar el acumulado por cuentas
		...
		// Global
		$arrResultado=$this->uf_calcular_acumulado_operacion_asignacion($as_str_sql_where,$as_spg_cuenta,$adec_monto_asignado);
		...
		if ($lb_valido)
		{
			...
			$arrResultado=$this->uf_calcular_acumulado_operacion_anterior($as_str_sql_where,$adt_fecini,$as_spg_cuenta,$adec_monto_aumento_a,$ls_operacion);
		...
		if ($lb_valido)
		{
			...
			$arrResultado=$this->uf_calcular_acumulado_operacion_anterior($as_str_sql_where,$adt_fecini,$as_spg_cuenta,$adec_monto_disminucion_a,$ls_operacion);
		...
		if ($lb_valido)
		{
			...
			$arrResultado=$this->uf_calcular_acumulado_operacion_anterior($as_str_sql_where,$adt_fecini,$as_spg_cuenta,$adec_monto_precompromiso_a,$ls_operacion);
		...
		if ($lb_valido)
		{
			...
			$arrResultado=$this->uf_calcular_acumulado_operacion_anterior($as_str_sql_where,$adt_fecini,$as_spg_cuenta,$adec_monto_compromiso_a,$ls_operacion);
		...
		{
			$ls_operacion="causar";
			$arrResultado=$this->uf_calcular_acumulado_operacion_anterior($as_str_sql_where,$adt_fecini,$as_spg_cuenta,$adec_monto_causado_a,$ls_operacion);
		...
		{
			$ls_operacion="pagar";
			$arrResultado=$this->uf_calcular_acumulado_operacion_anterior($as_str_sql_where,$adt_fecini,$as_spg_cuenta,$adec_monto_pagado_a,$ls_operacion);
		...
		{
			$ls_operacion="aumento";
			$arrResultado=$this->uf_calcular_acumulado_operacion_por_rango($as_str_sql_where,$adt_fecini,$adt_fecfin,$as_spg_cuenta,$adec_monto_aumento,$ls_operacion);
		...
		{
			$ls_operacion="disminucion";
			$arrResultado=$this->uf_calcular_acumulado_operacion_por_rango($as_str_sql_where,$adt_fecini,$adt_fecfin,$as_spg_cuenta,$adec_monto_disminucion,$ls_operacion);
		...
		{
			$ls_operacion="precomprometer";
			$arrResultado=$this->uf_calcular_acumulado_operacion_por_rango($as_str_sql_where,$adt_fecini,$adt_fecfin,$as_spg_cuenta,$adec_monto_precompromiso,$ls_operacion);
		...
		{
			$ls_operacion="comprometer";
			$arrResultado=$this->uf_calcular_acumulado_operacion_por_rango($as_str_sql_where,$adt_fecini,$adt_fecfin,$as_spg_cuenta,$adec_monto_compromiso,$ls_operacion);
		...
		{
			$ls_operacion="causar";
			$arrResultado=$this->uf_calcular_acumulado_operacion_por_rango($as_str_sql_where,$adt_fecini,$adt_fecfin,$as_spg_cuenta,$adec_monto_causado,$ls_operacion);
		...
		{
			$ls_operacion="pagar";
			$arrResultado=$this->uf_calcular_acumulado_operacion_por_rango($as_str_sql_where,$adt_fecini,$adt_fecfin,$as_spg_cuenta,$adec_monto_pagado,$ls_operacion);
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 else
	 {
			while($row=$this->SQL->fetch_row($rs_data))
			{
				...
				$ld_precompromisos,$ld_compromisos,$ld_causado,$ld_pagado,$ls_operacion,$ld_monto);
				...
				{
					$arrResultado=$this->uf_spg_reporte_chequear_autorizacion_traspaso($ls_procede,$ls_comprobante,$ldt_fecha,
					$ls_doc_autor,$ls_autorizante,$ldt_fecha_aut,$ls_observacion,$ls_codemp);
					$ls_doc_autor=$arrResultado['as_doc_autor'];
					$ls_autorizante=$arrResultado['as_autorizante'];
					$ldt_fecha_aut=$arrResultado['adt_fecha_aut'];
					$ls_observacion=$arrResultado['as_observacion'];
					$lb_valido=$arrResultado['lb_valido'];
					if($lb_valido)
					{
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //	Description :	Método  que ejecuta todas funciones de acumulado para asi sacar el acumulado por cuentas
		...
		$as_spg_cuenta=$this->sigesp_int_spg->uf_spg_cuenta_sin_cero($as_spg_cuenta)."%";
		// Global
		$arrResultado=$this->uf_calcular_disponible_asignacion($as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,
	...
	/****************************************************************************************************************************************/
	function uf_calcular_disponible_asignacion($as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,$as_spg_cuenta,$adec_monto)
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    19/04/2006          Fecha última Modificacion :      Hora :
		...
		else
		{
			while($row=$this->SQL->fetch_row($rs_data))
			{
				...
				$ls_codestpro1=$row["codestpro1"];
				$ls_denestpro1="";
				$arrResultado=$this->uf_spg_reporte_select_denestpro1($ls_codestpro1,$ls_denestpro1);
				...
				{
					$ls_denestpro2="";
					$arrResultado=$this->uf_spg_reporte_select_denestpro2($ls_codestpro1,$ls_codestpro2,$ls_denestpro2);
				...
				{
					$ls_denestpro3="";
					$arrResultado=$this->uf_spg_reporte_select_denestpro3($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_denestpro3);
