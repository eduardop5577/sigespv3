...
//--------------------------------------------------------------------------------------------------------------------------------
function uf_print_encabezado_pagina($as_titulo,$as_procede,$ad_fecha,$as_fuentefin="",$ab_gastoc,$as_codusu,$io_pdf){
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$io_pdf->addText(22,45,5,$ls_nomusu); // Agregar el título
	$io_pdf->addText(100,90,7,"UNIDAD DE PLANIF."); // Agregar el título
	$io_pdf->addText(100,83,7," Y PRESUPUESTO"); // Agregar el título
	$io_pdf->addText(175,90,7,"COORDINACION DE "); // Agregar el título
	$io_pdf->addText(175,83,7," ADMINISTRACION"); // Agregar el título
	$io_pdf->addText(255,90,7,"  DIR. SOPORTE"); // Agregar el título
	$io_pdf->addText(255,83,7,"ADMINISTRATIVO"); // Agregar el título
	$io_pdf->addText(333,90,7,"   DIR. GENERAL"); // Agregar el título
	$io_pdf->addText(415,90,7,"ANALISTA DE"); // Agregar el título
	$io_pdf->addText(413,83,7,"PRESUPUESTO"); // Agregar el título
...
uf_print_encabezado_pagina($ls_titulo,$ls_procede,$ld_fecha,$ls_fuentefin,$lb_gasto_capital,$ls_codusu,$io_pdf); // Imprimimos el encabezado de la página
