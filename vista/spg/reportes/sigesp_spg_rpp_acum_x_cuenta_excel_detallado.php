...
$ls_codestproH = '';
if (!empty($ls_codestpro1h) && !empty($ls_codestpro2h) && !empty($ls_codestpro3h)) {
...
$dataEstructura = $io_report->buscarEstructuraCuenta($codestproD, $codestproH, $ls_cuentades, $ls_cuentahas, $ls_cmbnivel);	
