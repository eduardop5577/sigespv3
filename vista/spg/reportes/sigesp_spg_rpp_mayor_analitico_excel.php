		...
		while(!$rs_data->EOF)
		{
			...
			{  
				...
				while(!$rs_data2->EOF)
				{
						 ...
						 {  
							...
							while (!$rs_data3->EOF)
							{
							    ...
							    $ld_totspg_por_pagar         = $ld_totspg_por_pagar + $ld_por_paga2;
								 ...
								 $lo_hoja->write($li_row, 5, 'SALDOS ANTERIORES',$lo_dataleft);
								 $lo_hoja->write($li_row, 6, $ld_asignado2,$lo_dataright);
								 $lo_hoja->write($li_row, 7, $ld_aumento2,$lo_dataright);
								 $lo_hoja->write($li_row, 8, $ld_disminucion2,$lo_dataright);
								 $lo_hoja->write($li_row, 9, $ld_monto_actualizado2,$lo_dataright);
								 $lo_hoja->write($li_row, 10, $ld_precompromiso2,$lo_dataright);
								 $lo_hoja->write($li_row, 11, $ld_compromiso2,$lo_dataright);
								 $lo_hoja->write($li_row, 12, $ld_causado2,$lo_dataright);
								 $lo_hoja->write($li_row, 13, $ld_pagado2,$lo_dataright);
								 $lo_hoja->write($li_row, 14, $ld_por_paga2,$lo_dataright);
				  ...
				  $lo_hoja->write($li_row, 3, $ls_procede,$lo_dataleft);
				  $lo_hoja->write($li_row, 4, $ls_nomproben,$lo_dataleft);              //nombre proveedor-beneficiario
				  $lo_hoja->write($li_row, 5, $ls_descripcion." ",$lo_dataleft);
				  $lo_hoja->write($li_row, 6, $ld_asignado,$lo_dataright);
				  $lo_hoja->write($li_row, 7, $ld_aumento,$lo_dataright);
				  $lo_hoja->write($li_row, 8, $ld_disminucion,$lo_dataright);
				  $lo_hoja->write($li_row, 9, $ld_monto_actualizado,$lo_dataright);
				  $lo_hoja->write($li_row, 10, $ld_precompromiso,$lo_dataright);
				  $lo_hoja->write($li_row, 11, $ld_compromiso,$lo_dataright);
				  $lo_hoja->write($li_row, 12, $ld_causado,$lo_dataright);
				  $lo_hoja->write($li_row, 13, $ld_pagado,$lo_dataright);
				  $lo_hoja->write($li_row, 14, $ld_por_paga,$lo_dataright);
