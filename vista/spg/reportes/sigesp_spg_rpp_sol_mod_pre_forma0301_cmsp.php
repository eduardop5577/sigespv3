...
function uf_print_pie_de_pagina($io_pdf)
{
	...
	$io_pdf->line(210,20,210,110);
	$io_pdf->line(400,20,400,110);

	$io_pdf->addText(60,92,8,"<b>ANALISTA DE PRESUPUESTO</b>"); // Agregar el título
	$io_pdf->addText(240,92,8,"<b>DIRECCIÓN DE ADMINISTRACIÓN</b>"); // Agregar el título
	$io_pdf->addText(440,92,8,"<b>CONTRALORA MUNICIPAL</b>"); // Agregar el título
