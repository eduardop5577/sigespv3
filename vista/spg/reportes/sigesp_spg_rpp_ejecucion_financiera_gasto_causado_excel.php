...
***********************************************************************************/
	...
	//		    Acess: private
	//	    Arguments: la_data // arreglo de informaci�n
	//    Description: funci�n que imprime el detalle en negrita
	//	   Creado Por: Ing.Arnaldo Su�rez
	// Fecha Creaci�n: 18/05/2010
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $lo_datacenter= &$lo_libro->addformat();
...
//--------------------------------------------------  Par�metros para Filtar el Reporte  ------------------------------------
	...
	elseif($li_estmodest==2)
	{
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","sigesp_vis_spg_reporte_ejecucion_financiera_causado.php",$ls_desc_event);
	////////////////////////////////         SEGURIDAD               ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $lb_valido=$io_report->uf_spg_reportes_ejecucion_financiera_presupuesto_causado($ls_codestpro1,$ls_codestpro2,
	 ...
	 else // Se Transfiere la data a otro arreglo para incluir subtotales por partida
	 {
	  ...
	  if($li_consolidado == 1)
	  {
		...
		$ls_denestpro4h="";
		$ls_denestpro5h="";
		$arrResultado=$io_function_report->uf_spg_reporte_select_denestpro1($ls_codestpro1,$ls_denestpro1,$ls_estclades);
		...
		if($lb_valido)
		{
		  $arrResultado=$io_function_report->uf_spg_reporte_select_denestpro2($ls_codestpro1,$ls_codestpro2,$ls_denestpro2,$ls_estclades);
		...
		if($lb_valido)
		{
		  $arrResultado=$io_function_report->uf_spg_reporte_select_denestpro3($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_denestpro3,$ls_estclades);
		...
		if($li_estmodest==2)
		{
			...
			{
			  $ls_denestpro4="";
                          $arrResultado=$io_function_report->uf_spg_reporte_select_denestpro4($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_denestpro4,$ls_estclades);
			...
			{
			  $ls_denestpro5="";
                          $arrResultado=$io_function_report->uf_spg_reporte_select_denestpro5($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,$ls_denestpro5,$ls_estclades);
		...
		$ls_denestpro1h="";
		$arrResultado=$io_function_report->uf_spg_reporte_select_denestpro1($ls_codestpro1h,$ls_denestpro1h,$ls_estclahas);
		...
		{
		  $ls_denestpro2h="";
                  $arrResultado=$io_function_report->uf_spg_reporte_select_denestpro2($ls_codestpro1h,$ls_codestpro2h,$ls_denestpro2h,$ls_estclahas);
		...
		{
		  $ls_denestpro3h="";
                  $arrResultado=$io_function_report->uf_spg_reporte_select_denestpro3($ls_codestpro1h,$ls_codestpro2h,$ls_codestpro3h,$ls_denestpro3h,$ls_estclahas);
		...
		if($li_estmodest==2)
		{
			...
			{
			  $ls_denestpro4h="";
                          $arrResultado=$io_function_report->uf_spg_reporte_select_denestpro4($ls_codestpro1h,$ls_codestpro2h,$ls_codestpro3h,$ls_codestpro4h,$ls_denestpro4h,$ls_estclahas);
			...
			{
			  $ls_denestpro5h="";
                          $arrResultado=$io_function_report->uf_spg_reporte_select_denestpro5($ls_codestpro1h,$ls_codestpro2h,$ls_codestpro3h,$ls_codestpro4h,$ls_codestpro5h,$ls_denestpro5h,$ls_estclahas);
		...
		$li_fila=uf_print_cabecera_consolidado($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,
		...
		$li_fila=uf_print_cabecera_detalle($lo_libro,$lo_hoja,$io_encabezado,$ld_tipper,$as_nomper01,$as_nomper02,$as_nomper03,$ld_fecfinrep,$li_fila,$li_consolidado);
		$la_data_cta[] = array();
		...
		for($z=1;$z<=$li_tot;$z++)
		{
				...
				{
					$li_fila=uf_print_detalle($lo_libro,$lo_hoja,$la_data_cta,$ld_tipper,$as_nomper01,$as_nomper02,$as_nomper03,$li_fila);
					switch($ld_tipper)
			 		{
			  			case 1:
					...
					$ld_totalp_per2				= 0;
					$ld_totalp_per3				= 0;
					$li_fila=uf_print_detalle_bold($lo_libro,$lo_hoja,$la_data_tot_cta,$ld_tipper,$as_nomper01,$as_nomper02,$as_nomper03,$li_fila);
			}
			else
			{
			 $li_fila=uf_print_detalle($lo_libro,$lo_hoja,$la_data_cta,$ld_tipper,$as_nomper01,$as_nomper02,$as_nomper03,$li_fila);
		...
		$li_fila++;
		$li_fila=uf_print_detalle_bold($lo_libro,$lo_hoja,$la_data_tot,$ld_tipper,$as_nomper01,$as_nomper02,$as_nomper03,$li_fila);
	  }
	  elseif($li_consolidado == 0)
	  {
		...
		for($z=1;$z<=$li_tot;$z++)
		{
				...
				if(is_bool($ok))
				{
				    ...
				    $li_fila=uf_print_cabecera_detallado($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,
											$ls_denestpro1,$ls_denestpro2,$ls_denestpro3,$ls_denestpro4,$ls_denestpro5,
											$ls_desper,$ls_lapso_meses,$ls_text_periodo,$li_fila,$lo_titulo,$lo_hoja,$lo_libro,$li_consolidado);
