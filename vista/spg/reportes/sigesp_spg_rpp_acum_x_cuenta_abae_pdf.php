	...
	//	$io_tcpdf->setTableHeader(true);
		...
		while(!$rs_data->EOF)
		{
			...
			//die();
			  ...
			  if($lb_codfuefin) {
			  	$ld_asignado=$io_report->uf_buscar_asignado_fuente($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,
			  														$ls_codestpro4,$ls_codestpro5,
			  														$ls_codestpro1h,$ls_codestpro2h,$ls_codestpro3h,
			  														$ls_codestpro4h,$ls_codestpro5h,
			  														$ls_estclades,$ls_estclahas,$ls_codfuefindes,$ls_codfuefinhas,
			  														$ls_spg_cuenta, $ls_nivel);
			  }
			  else {
