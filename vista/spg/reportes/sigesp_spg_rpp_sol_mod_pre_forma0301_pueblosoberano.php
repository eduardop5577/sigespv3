...
function uf_print_encabezado_pagina($as_titulo,$as_procede,$ad_fecha,$as_fuentefin="",$ab_gastoc,$io_pdf){
	...
	if($as_procede=='SPGTRA')
	{
		...
		$io_pdf->line(400,50,400,150);
		$io_pdf->line(480,50,480,150);
	
	
		$io_pdf->addText(35,76,6,"JOSE ZAMBRANO"); // Agregar el título
		$io_pdf->addText(32,69,6,"RESPONSABLE DEL"); // Agregar el título
		$io_pdf->addText(32,62,6,"PROYECTO/ACCION"); // Agregar el título
		$io_pdf->addText(37,55,6,"CENTRALIZADA"); // Agregar el título
		$io_pdf->addText(108,76,6,"MIGUEL S. CASTILLO"); // Agregar el título
		$io_pdf->addText(113,69,6,"DIRECTOR DE"); // Agregar el título
		$io_pdf->addText(112,62,6,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(200,76,6,"LOURDES FREITEZ B."); // Agregar el título
		$io_pdf->addText(205,69,6,"PRESUPUESTO Y"); // Agregar el título
		$io_pdf->addText(203,62,6,"CONTROL PREVIO"); // Agregar el título
		$io_pdf->addText(317,76,6,"JOSE ZAMBRANO"); // Agregar el título
		$io_pdf->addText(313,62,6,"MAXIMA AUTORIDAD"); // Agregar el título
		$io_pdf->addText(422,76,6,"DIRECTOR"); // Agregar el título
		$io_pdf->addText(505,76,6,"DIRECTOR GENERAL"); // Agregar el título
	}
	else
	{
		...
		$io_pdf->addText(36,92,6,"DIRECTOR DE"); // Agregar el título
		$io_pdf->addText(32,85,6,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(110,94,6,"RESPONSABLE DEL"); // Agregar el título
		$io_pdf->addText(110,88,6,"PROYECTO/ACCION"); // Agregar el título
		$io_pdf->addText(116,82,6,"CENTRALIZADA"); // Agregar el título
		$io_pdf->addText(200,90,6,"UNIDAD DE PRESUPUESTO "); // Agregar el título
		$io_pdf->addText(210,83,6,"Y CONTROL PREVIO"); // Agregar el título
		$io_pdf->addText(315,90,6,"MAXIMA  AUTORIDAD"); // Agregar el título
		$io_pdf->addText(425,90,6,"DIRECTOR"); // Agregar el título
		$io_pdf->addText(505,90,6,"DIRECTOR GENERAL"); // Agregar el título
	}
