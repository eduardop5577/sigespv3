...
<title>Reporte Operacion por Especifica</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_reporte_operacion_por_especifica.php';
		var tbnuevo = false;
	...
	<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_reporte_operacion_por_especifica.js"></script>
</head>
<body class="modfondo">
<div id="barra_herramientas"></div>
<div id="formReporteOpexEsp"></div>
</body>
</html>