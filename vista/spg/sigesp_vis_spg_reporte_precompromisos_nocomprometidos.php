...
<html>
	...
	<title>Reporte Pre-Compromisos</title>
	<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_reporte_precompromisos_nocomprometidos.php';
		var tbnuevo = false;
	...
	<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_reporte_precompromisos_nocomprometidos.js"></script>
