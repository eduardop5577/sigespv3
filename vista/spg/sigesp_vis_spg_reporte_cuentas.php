...
<title>Reporte Listado de Cuentas Presupuestarias</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_reporte_cuentas.php';
		var tbnuevo = false;
	...
	<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_reporte_cuentas.js"></script>
</head>
<body class="modfondo">
<div id="barra_herramientas"></div>
<div id="formReporteCuentas"></div>
</body>
</html>