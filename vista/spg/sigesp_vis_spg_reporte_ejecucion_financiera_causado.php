...
<title>Reporte Ejecución Financiera de Presupuesto de Gasto - Causado</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_reporte_ejecucion_financiera_causado.php';
		var tbnuevo = false;
	...
	<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_reporte_ejecucion_financiera_causado.js"></script>
...
<div id="formReporteEjeFinCau"></div>
</body>
</html>