...
<title>Generar Comprobantes</title>
    <script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_sigeproden_generar_comprobante.php';
		var tbnuevo = false;
    ...
    <script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_sigeproden_generar_comprobante.js"></script>
