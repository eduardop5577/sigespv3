...
<title>Reporte de Apertura de Cuentas </title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_reporte_listado_apertura.php';
		var tbnuevo = false;
	...
	<script type="text/javascript" src="../../base/librerias/js/componentes/sigesp_com_fieldsetestpre.js"></script>
 	<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_reporte_listado_apertura.js"></script>
</head>
<body class="modfondo">
<div id="barra_herramientas"></div>
<div id="formReporteAperturaCuentas"></div>
</body>
</html>