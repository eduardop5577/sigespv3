...
<title>Reporte Unidades Ejecutoras</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_reporte_unidades_ejecutoras.php';
		var tbnuevo = false;
	...
	<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_reporte_unidades_ejecutoras.js"></script>
</head>
<body class="modfondo">
<div id="barra_herramientas"></div>
<div id="formReporteUnidadesEjecutoras"></div>
</body>
</html>