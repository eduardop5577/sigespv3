...
<title>Regístro del Comprobante de Crédito ó Ingreso Adicional</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_adicional.php';
		var tbnuevo = false;
...
<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_adicional.js"></script>
</head>
<body class="modfondo">
<div id="barra_herramientas"></div>
<div id="formComprobanteAdicional"></div>
</body>
</html>
