...
<title>Regístro del Comprobante Presupuestario</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_comprobante.php';
		var tbnuevo = false;
	...
	<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_comprobante.js"></script>
	<script type="text/javascript" src="catalogo/sigesp_vis_spg_cat_detalle_contable.js"></script>
</head>
<body class="modfondo">
