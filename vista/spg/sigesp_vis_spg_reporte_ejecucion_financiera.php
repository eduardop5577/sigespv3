...
<title>Reporte Ejecución Financiera de Presupuesto de Gasto</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_reporte_ejecucion_financiera.php';
		var tbnuevo = false;
	...
	<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_reporte_ejecucion_financiera.js"></script>
