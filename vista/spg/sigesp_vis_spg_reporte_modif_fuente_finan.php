...
<title>Reporte Presupuesto Modificado Detallado por Fuente de Financiamiento</title>
<script type="text/javascript">
		var sistema='SPG';
		var vista='sigesp_vis_spg_reporte_modif_fuente_finan.php';
		var tbnuevo = false;
	...
	<script type="text/javascript" src="../../vista/spg/js/sigesp_vis_spg_reporte_modif_fuente_finan.js"></script>
</head>
<body class="modfondo">
<div id="barra_herramientas"></div>
<div id="formReporteModifFueFin"></div>
</body>
</html>