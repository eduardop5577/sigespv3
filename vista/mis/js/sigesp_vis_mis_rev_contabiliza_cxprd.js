...
//creando datastore y columnmodel para la grid de solicitudes
var gridRecepcion = new Ext.grid.GridPanel({
	width:870,
	height:250,
	frame:true,
	title:'',
	...
	'rowcontextmenu': {
		fn: function(grid, numFila, evento){
			...
			var comDetalleModificacion = new com.sigesp.vista.comDetalleComprobante({
				tituloVentana: 'Reversar Contabilizaci&#243;n de Recepci&#243;n de Documentos',
				anchoVentana: 600,
				altoVentana: 500,
				anchoFormulario: 580,
				altoFormulario:150,
...
Ext.onReady(function() {
	...
	var	fromContabilzarCXP = new Ext.FormPanel({
		...
		title: "<H1 align='center'>Reversar Contabilizaci&#243;n de Recepci&#243;n de Documentos</H1>",
		frame: true,
		autoScroll:true,
...
function irBuscar(){
	...
	var JSONObject = {
		'operacion' : 'buscar_por_reversar_rec',
		'numrecdoc' : numrecdoc,
		'tipo'      : destino,
		'codigo'    : cod_pro,
		'fecreg'    : fecregdoc,
...
function irProcesar(){
	var cadenaJson = "{'operacion': 'rev_contabilizar_rec', 'recepciones':[";				
		...
		Ext.Ajax.request({
			...
			success: function (resultado, request) {
				...
				var comResultado = new com.sigesp.vista.comResultadoIntegrador({
					tituloVentana: 'Resultado Reverso de Contabilizaci&#243;n de Recepci&#243;n de Documentos',
					anchoLabel: 200,
					labelTotal:'Total Recepci&#243;n de Documentos procesadas',
					valorTotal: arrResultado[0],
					labelProcesada:'Total Recepci&#243;n de Documentos reversadas',
