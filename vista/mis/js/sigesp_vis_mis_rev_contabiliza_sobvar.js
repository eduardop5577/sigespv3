...
Ext.onReady(function(){
	...
	gridSolicitud = new Ext.grid.GridPanel({
		...
		height:250,
		frame:true,
		title:"<H1 align='center'>Variaciones Contabilizadas</H1>",
	...
	plContabilizaSobvar = new Ext.FormPanel({
		...
		width:613,
		height: 500,
		title: "<H1 align='center'>Reverso de Variaci&#243;n</H1>",
		frame:true,
		autoScroll:false,
...
function irProcesar(){
	...
	cadenajson = "{'operacion':'rev_contabilizar_sobvar','codsis':'"+sistema+"','nomven':'"+vista+"', 'arrDetalle':[";
	total = grid.length;
	if(total>0)
	{
		...
		Ext.Ajax.request({
			...
			{ 
				...
				var comResultado = new com.sigesp.vista.comResultadoIntegrador({
					tituloVentana: 'Resultado Reversar las Variaciones',
					anchoLabel: 200,
					labelTotal:'Total variaciones procesados',
					valorTotal: arrResultado[0],
					labelProcesada:'Total variaciones reversadas',
