	...
	'rowcontextmenu': {
		fn: function(grid, numFila, evento){
			...
			var comDetalleModificacion = new com.sigesp.vista.comDetalleComprobante({
				tituloVentana: 'Reversar Anulaci&#243;n de Recepci&#243;n de Documentos',
				anchoVentana: 600,
				altoVentana: 500,
				anchoFormulario: 580,
				altoFormulario:150,
...
Ext.onReady(function() {
	...
	var	fromContabilzarCXP = new Ext.FormPanel({
		...
		title: "<H1 align='center'>Reversar Anulaci&#243;n de Recepci&#243;n de Documentos</H1>",
		frame: true,
		autoScroll:true,
...
function irBuscar(){
	...
	var JSONObject = {
		'operacion' : 'buscar_por_rev_anulacion_rec',
		'numrecdoc' : numrecdoc,
		'tipo'      : destino,
		'codigo'    : cod_pro,
		'fecreg'    : fecregdoc,
...
function irProcesar(){
	var cadenaJson = "{'operacion': 'rev_anular_rec', 'recepciones':[";				
		...
		Ext.Ajax.request({
			...
			success: function (resultado, request) {
				...
				var comResultado = new com.sigesp.vista.comResultadoIntegrador({
					tituloVentana: 'Resultado Reverso de Anulaci&#243;n de Recepci&#243;n de Documentos',
					anchoLabel: 200,
