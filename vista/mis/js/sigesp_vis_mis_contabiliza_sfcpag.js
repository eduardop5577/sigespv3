...
Ext.onReady(function(){
	...
	var	fromIntegraPag = new Ext.FormPanel({
		applyTo: 'formulario',
		width: 935,
		height: 400,
		style:'position:absolute;margin-left:'+Xpos+'px;margin-top:45px;',
		title: "<H1 align='center'>Integración de Pagos</H1>",
		frame: true,
		autoScroll:true,
		items: [fromSFCPAG,
		        gridPagos
	...
	gridPagos = new Ext.grid.EditorGridPanel({
    	width:870,
 		height:180,
		frame:true,
		title:"<H1 align='center'>Movimientos de Pagos por Contabilizar</H1>",
		...
		'rowcontextmenu': {
			fn: function(grid, numFila, evento){
				...
				var comDetalleModificacion = new com.sigesp.vista.comDetalleComprobante({
					tituloVentana: "<H1 align='center'>Integración de Pagos</H1>",
					anchoVentana: 600,
					altoVentana: 500,
					anchoFormulario: 580,
					altoFormulario:150,
...
function irBuscar(){
	...
	var JSONObject = {
		'operacion'  : 'buscar_contabilizar_pag',
...
function irProcesar(){
	var cadenaJson = "{'operacion': 'contabilizar_pag', 'pagos':[";				
		...
		Ext.Ajax.request({
			...
			success: function (resultado, request) {
				...
				var comResultado = new com.sigesp.vista.comResultadoIntegrador({
					tituloVentana: 'Resultado Integraci&#243;n de Pagos',
					anchoLabel: 200,
