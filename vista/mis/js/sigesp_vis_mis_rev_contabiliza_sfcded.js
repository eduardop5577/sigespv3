...
Ext.onReady(function(){
	...
	var	p1fromRevSFCDED = new Ext.FormPanel({
		applyTo: 'formulario',
		width: 935,
		height: 400,
		style:'position:absolute;margin-left:'+Xpos+'px;margin-top:45px;',
		title: "<H1 align='center'> Reverso de Contabilización de Deducciones</H1>",
		frame: true,
		autoScroll:true,
		items: [fromSFCDED,
		        gridDeduccion
		...
		Ext.Ajax.request({
			...
			success: function (resultado, request) {
				...
				var comResultado = new com.sigesp.vista.comResultadoIntegrador({
					tituloVentana: 'Resultado Reverso Contabilizaci&#243;n de Deducciones',
					anchoLabel: 200,
