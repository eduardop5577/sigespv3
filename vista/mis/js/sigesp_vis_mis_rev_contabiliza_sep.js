...
var cmSolicitud = new Ext.grid.ColumnModel([
    ...
    {header: "<CENTER>Concepto</CENTER>", width: 100, sortable: true, dataIndex: 'consol'}
]);
	...
	'rowcontextmenu': {
		fn: function(grid, numFila, evento){
			...
			var comDetalleModificacion = new com.sigesp.vista.comDetalleComprobante({
				tituloVentana: 'Reverso de Contabilización de Solicitud de Ejecución Presupuestaria',
				anchoVentana: 600,
				altoVentana: 500,
				anchoFormulario: 580,
				altoFormulario:150,
...
//creando funcion que construye formulario principal Reverso Contabilizar
var	fromReversoSEP = new Ext.form.FieldSet({
...
Ext.onReady(function() {
	...
	var	fromRevContabilzarSEP = new Ext.FormPanel({
		applyTo: 'formularioSEP',
		width: 940,
		height: 500,
		style:'position:absolute;margin-left:'+Xpos+'px;margin-top:25px;',
		title: "<H1 align='center'>Reverso de Contabilización de Solicitud de Ejecución Presupuestaria</H1>",
		frame: true,
		autoScroll:true,
		items: [fromReversoSEP,
		        gridSolicitud]
	});

	fromRevContabilzarSEP.doLayout();
});
...
function irCancelar(){
	limpiarFormulario(fromReversoSEP);
	gridSolicitud.store.removeAll();	
}
		...
		Ext.Ajax.request({
			...
			{ 
				...
				var comResultado = new com.sigesp.vista.comResultadoIntegrador({
					tituloVentana: "<H1 align='center'>Resultado de Solicitudes de Ejecuci&#243;n Presupuestaria Reversadas</H1>",
					anchoLabel: 200,
