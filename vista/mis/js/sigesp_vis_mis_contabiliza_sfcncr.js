...
Ext.onReady(function(){
	...
	var	fromRevFactCobrNCD = new Ext.FormPanel({
		...
		title: "<H1 align='center'>Contabilización de Notas de Crédito/Débito</H1>",
		frame: true,
		autoScroll:true,
		items: [
		        fromSFCNCD,
		...
		'rowcontextmenu': {
			fn: function(grid, numFila, evento){
				...
				var comDetalleModificacion = new com.sigesp.vista.comDetalleComprobante({
					tituloVentana: "<H1 align='center'>Contabilización de  Notas de Crédito/Débito</H1>",
					anchoVentana: 700,
					altoVentana: 500,
					anchoFormulario: 680,
					altoFormulario:150,
...
function irBuscar(){
	...
	if(documento!=''){
		...
		var JSONObject = {
			'operacion'  : 'buscar_contabilizar_ncd',
...
function irProcesar(){
	var cadenaJson = "{'operacion': 'contabilizar_ncd', 'cuentaCobrar':[";				
