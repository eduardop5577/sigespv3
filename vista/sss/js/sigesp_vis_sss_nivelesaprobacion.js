...
(
	function()
	{
		...
		var agregar = new Ext.Action(
		{
        	...
        	tooltip: 'Agregar usuario a un Nivel de Aprobación'
		});
		...
		var quitar = new Ext.Action(
		{
			...
			handler: irQuitar,
			iconCls: 'bmenuquitar',
        	tooltip: 'Quitar usuario de un Nivel de Aprobación'
		});
		
		var datosSistemas={'raiz':[{'codsis':'1','nomsis':'Aprobación Solicitud de Ejecución Presupuestaria'},
								   {'codsis':'2','nomsis':'Aprobación Ordenes de Compra'},
								   {'codsis':'3','nomsis':'Aprobación Cuentas por Pagar'}]};
		...
		items:[{
			    ...
			    items:[{			   
					...
					xtype:'fieldset',
					title:'Datos del Nivel de Aprobación',
					id:'fsformnivel',
					autoHeight:true,
					autoWidth:true,
					cls :'fondo',	
					items:[{			   
							xtype:'textfield',
							fieldLabel:'Código',
							name:'Código Asignación del nivel de aprobación',
							id:'txtcodasiniv',
							disabled: true,
							width:80
						},{			   
							xtype:'textfield',
							fieldLabel:'Nivel',
							name:'Código del nivel de aprobación',
							id:'txtcodniv',
							disabled: true,
							width:80
						},{
							...
							name:'Denominación del nivel de aprobación',
							id:'txtdespridoc',
							disabled: true,
							width:400					
					}]
					...
					xtype:'panel',
					width:500,
					title:'Usuarios para la Niveles de Aprobación',
					tbar: [agregar,quitar],
...
***********************************************************************************/
	function irGuardar()
	{
		...
		{
			Ext.Msg.alert('Mensaje','Debe seleccionar un nivel de aprobación');
		}
