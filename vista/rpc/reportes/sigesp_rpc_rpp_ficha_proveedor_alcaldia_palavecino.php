...
function uf_print_encabezado_pagina($as_titulo,$io_pdf)
{
    ...
    $io_pdf->addText(43,650,9,'<b> LA DIVISIÓN DE COMPRAS Y SUMINISTROS DE LA ALCALDIA DEL MUNICIPIO PALAVECINO DEL ESTADO LARA,</b>');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	unset($la_columna);
	unset($la_config);
	$la_columna = array('denominacion'=>'                                  <b>Denominación</b>','recepcion'=>'<b>Fecha Recepción</b>','vencimiento'=>'<b>Fecha Vencimiento o  Plazo de Entrega</b>','estatus'=>'<b>Estatus</b>');
		 ...
		 for ($z=1;$z<=$li_total;$z++)
			 {
			  ...
			  $io_pdf->addText(43,535,10,'Ha sido inscrita en esta División el:');
			  $io_pdf->addText(215,535,10,'<b>'.$ls_fecregmod.'</b>');
			  $io_pdf->addText(43,523,10,'Bajo el código de registro número:');
