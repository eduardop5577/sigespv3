...
***********************************************************************************/
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_datatit = array(array('codigo'=>'<b>Código</b>','nombre'=>'<b>Nombre</b>','direccion'=>'<b>Direccion</b>',
		                          'telefono'=>'<b>Teléfono</b>','rif'=>'<b>RIF</b>','capital'=>'<b>Capital Social Suscrito</b>',
								  'repleg'=>'<b>Representante Legal</b>','numreg'=>'<b>Nº RNC</b>','scgcta'=>'<b>Contable</b>',
		...
		$la_config  = array('showHeadings'=>0, // Mostrar encabezados
							...
							'cols'=>array('codigo'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
										  ...
										  'direccion'=>array('justification'=>'center','width'=>110), // Justificación y ancho de la columna
										  'telefono'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
										  'rif'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
										  'capital'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
										  'repleg'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
										  'numreg'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
										  'scgcta'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
									   ...
									   'direccion'=>array('justification'=>'left','width'=>110), // Justificación y ancho de la columna
									   'telefono'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
									   'rif'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
									   'capital'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
									   'repleg'=>array('justification'=>'left','width'=>90), // Justificación y ancho de la columna
									   'numreg'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
									   'scgcta'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
									   'especialidad'=>array('justification'=>'left','width'=>90))); // Justificación y ancho de la columna
