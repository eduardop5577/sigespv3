...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_resctabm4.php",$ls_permisos,$la_seguridad,$la_permisos);
...
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","BM4","sigesp_saf_rpp_resctabm4.php","C");
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<html>
<head>
<title>Resumen de la Cuenta de Bienes Muebles</title>
...
?>	
  ...
  <table width="542" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Resumen de la Cuenta de Bienes Muebles </td>
    </tr>
  </table>
  <table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <div align="left" class="style14">
            <div align="left" class="style14">
              <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                ...
                <tr>
                  <td><div align="right">Unidad de Trabajo  </div></td>
    ...
    <tr>
      <td colspan="3" align="center">
        <div align="center">
          <input name="chkut" type="checkbox" class="sin-borde" id="chkut" value="1">
          Filtrar por valor &gt; 14 U.T. (Pub. 21) </div></td></tr>
    <tr>
...
<script language="JavaScript">
	...
	{
		window.open("sigesp_saf_cat_unidad_srvdep.php?destino="+ ls_destino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,left=120,top=70,location=no,resizable=yes");
	}
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				if((ls_desde != "")&&(ls_hasta != "")) 
				{
				 ...
				 window.open("reportes/"+formato+"?coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&coduniadm="+ls_coduniadm+"&denuniadm="+ls_denuniadm+"&tipoformato="+tipoformato+"&unitri="+unitri,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				 f.operacion.value="REPORT";
				 f.action="sigesp_siv_r_resctabm4.php";
				}
				else
				{
				 alert("Indique Rango de Fecha...")
				}
