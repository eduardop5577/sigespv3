...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_incdesinc.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Reporte de Incorporaciones y Desincorporaciones de Bienes Muebles de un Departamento</title>
...
?>	
  ...
  <table width="542" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Incorporaciones y Desincorporaciones de los Bienes de un Departamento </td>
    </tr>
  </table>
...
function ue_seccion()
{
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				window.open("reportes/sigesp_saf_rpp_incdesinc.php?coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&codgru="+ls_grupo+"&codsubgru="+ls_subgrupo+"&codsec="+ls_seccion+"&coduniadm="+ls_coduniadm+"&denuniadm="+ls_denuniadm+"&tipoformato="+tipoformato+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="sigesp_siv_r_incdesinc.php";
				//f.submit();
			}
			else
