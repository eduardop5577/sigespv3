	...
	if($li_rows>0)
	{
		while($row=$io_sql->fetch_row($rs_cta))
		{
			...
			switch ($ls_tipo)
			{
				...
				break;
				case "desde";
					print "<td><a href=\"javascript: aceptar_desde('$ls_codgru','$ls_codsubgru','$ls_codsec','$ls_densec');\">".$ls_codgru."</a></td>";
					print "<td>".$ls_codsubgru."</td>";
					print "<td>".$ls_codsec."</td>";
					print "<td>".$ls_densec."</td>";
				break;
				case "hasta";
					print "<td><a href=\"javascript: aceptar_hasta('$ls_codgru','$ls_codsubgru','$ls_codsec','$ls_densec');\">".$ls_codgru."</a></td>";
					print "<td>".$ls_codsubgru."</td>";
					print "<td>".$ls_codsec."</td>";
					print "<td>".$ls_densec."</td>";
				break;
...
<script language="JavaScript">
	...
	function aceptar_desde(codgrupo,codsubgrupo,codseccion,denominacion)
	{
		opener.document.form1.txtcodsec.value=codseccion;
		opener.document.form1.txtdensec.value=denominacion;
		opener.document.form1.txtcodsechas.value=codseccion;
		opener.document.form1.txtdensechas.value=denominacion;
		close();
	}
	function aceptar_hasta(codgrupo,codsubgrupo,codseccion,denominacion)
	{
		opener.document.form1.txtcodsechas.value=codseccion;
		opener.document.form1.txtdensechas.value=denominacion;
		close();
