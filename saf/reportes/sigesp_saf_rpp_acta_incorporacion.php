...
***********************************************************************************/
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_cabecera($ls_titulo_emp,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////
	    ...
	    $la_data=array(array('name'=>'   Los sucritos ___________________________________________________, mayores de edad, hacemos'),
					   ...
					   array('name'=>'   instrucciones recibidas de '.$ls_titulo_emp),
	...
	function uf_print_pie_cabecera($io_pdf)
	{
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->addText(45,230,11,"   Esta  acta es realizada por quintuplicado a un solo tenor y efecto para los fines de la incorporación ");   
        $io_pdf->addText(45,215,11,"   correspondiente, en la ciudad de _______________________________ a los _________________________. ");
        ...
        $io_pdf->addText(370,195,10,"TESTIGO");   
        $io_pdf->addText(370,165,10,"__________________________________");   
        $io_pdf->addText(370,150,10,"<b>Nombre:</b>");   
        $io_pdf->addText(370,135,10,"<b>C:I. No.:</b>");   
        $io_pdf->addText(370,115,10,"<b>Cargo:</b>");   
		
		$io_pdf->addText(200,115,10,"TESTIGO");   
        $io_pdf->addText(200,95,10,"__________________________________");   
        $io_pdf->addText(200,80,10,"<b>Nombre:</b>");   
        $io_pdf->addText(200,65,10,"<b>C:I. No.:</b>");   
        $io_pdf->addText(200,50,10,"<b>Cargo:</b>");  
	...
	if($lb_valido==false) // Existe algún error ó no hay registros
	{
	 ...
	 else // Imprimimos el reporte
	 {
		...
		$io_pdf->ezSetCmMargins(3.5,7,3,3); // Configuración de los margenes en centímetros
		...
		$li_s=0;
		$li_totrow_det=0;
	    uf_cabecera($ls_titulo_emp,$io_pdf);
		if($lb_valido)
		{
			$li_aux=0;
			$i=1;
