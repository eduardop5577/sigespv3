...
***********************************************************************************/
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('seract'=>array('justification'=>'left','width'=>100), // Justificación y ancho de la columna
						 			   ...
						 			   'nomrespri'=>array('justification'=>'left','width'=>140), // Justificación y ancho de la columna
						 			   'nomresuso'=>array('justification'=>'left','width'=>140), // Justificación y ancho de la columna
						 			   ...
						 			   'denconbie'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$la_data[$li_s]=array('seract'=>$ls_seract,'ideact'=>$ls_ideact,'idchapa'=>$ls_chapa,'nomrespri'=>$ls_nomrespri,
										  ...
										  'fecdesact'=>$ld_fecdesact,'denconbie'=>$ls_denconbie,'estact'=>$ls_estact);
				}
