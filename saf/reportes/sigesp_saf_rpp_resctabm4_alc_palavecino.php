...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_estado,$as_municipio,$as_denunisrv,$as_titulo,$as_cmpmov,$ad_fecha,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->ezSetY(525);
		$la_data=array(array('name'=>'<b> ESTADO:</b>  LARA'),
	...
	$io_pdf->addText(250,150,9,"Nombre y Apellido:______________________________________");
	$io_pdf->addText(530,150,9,"C.I.: ______________________________");
	$io_pdf->addText(730,150,9,"Firma:______________________________");
	
	$io_pdf->addText(40,110,9,"RESPONSABLE DE BIENES");	
       $io_pdf->addText(40,100,9,"EN LA UNIDAD DE TRABAJO:");	
	$io_pdf->addText(250,100,9,"Nombre y Apellido:______________________________________");
	$io_pdf->addText(530,100,9,"C.I.: ______________________________");
	$io_pdf->addText(730,100,9,"Firma:______________________________");
       
       $io_pdf->addText(40,55,9,"COORDINACION DE BIENES MUNICIPALES:");	
	$io_pdf->addText(250,55,9,"Nombre y Apellido:______________________________________");
	$io_pdf->addText(530,55,9,"C.I.: ______________________________");
	$io_pdf->addText(730,55,9,"Firma:______________________________");
	...
	else // Imprimimos el reporte
	{
		...
		$li_tot_desinc_060_mes=0.00;
			...
			if($lb_valido_desinc_060)
			{
				...
				uf_print_encabezado_pagina($ls_estemp,'',$ls_denuniadm,$ls_titulo,"",$ld_fecha,$io_pdf); // Imprimimos el encabezado de la página
