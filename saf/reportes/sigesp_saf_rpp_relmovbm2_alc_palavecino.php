...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_estado,$as_municipio,$as_diremp,$as_codemp,$as_nomemp,$as_denunisrv,$as_denunidep,$as_periodo,$as_titulo,$as_cmpmov,$ad_fecha,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->ezSetY(525);
		$la_data=array(array('name'=>'<b>1. ESTADO:</b>  LARA'),
					   array('name'=>'<b>2. MUNICIPIO:</b> PALAVECINO'),
					   array('name'=>'<b>3. PARROQUIA:</b>  CABUDARE'),
					   array('name'=>'<b>4. DIRECCION O LUGAR:</b>  '.$as_diremp.''),
					   array('name'=>'<b>5. DEPENDENCIA O UNIDAD PRIMARIA:</b>  '.$as_codemp."-".$as_nomemp.''),
					   array('name'=>'<b>6. SERVICIO:</b>  '.$as_denunisrv.''),
					   array('name'=>'<b>7. UNIDAD DE TRABAJO O DEPENDENCIA:</b> '.$as_denunidep.''),
					   array('name'=>'<b>8. PERIODO DE LA CUENTA: (MES Y AÑO)</b>  '.$as_periodo.''));
	...
	$io_pdf->addText(700,150,9,"                            COORDINACIÓN DE BIENES MUNICIPALES              ");	
...
//					$li_total=$io_fun_activos->uf_formatonumerico($li_total);
				...
				{
					$i=$i +1;
					uf_print_encabezado_pagina($ls_estemp,'',$ls_direccion,$ls_codemp,$ls_nomemp,$ls_denuniadm,'',$periodo,$ls_titulo,"",$ld_fecha,$io_pdf); // Imprimimos el encabezado de la página
