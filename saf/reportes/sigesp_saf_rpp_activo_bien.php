	...
	else // Imprimimos el reporte
	{
	   $lb_valido=true;
		...
		$io_pdf->ezStartPageNumbers(940,50,10,'','',1); // Insertar el número de página
			...
			{
				$i=$i +1;
				uf_print_encabezado_pagina($ls_codemp,$ls_nomemp,$ls_denuni,$ls_distrito,$ls_direccion,$ls_denuni,$ls_titulo,"",$ld_fecha,$io_pdf); // Imprimimos el encabezado de la página	
