	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codart'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
						 			   'denart'=>array('justification'=>'left','width'=>130), // Justificación y ancho de la columna
						 			   'ideact'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
						 			   'desmov'=>array('justification'=>'left','width'=>135), // Justificación y ancho de la columna
				...
				if($ls_estcon!="0")
				{
					...
					if($lb_valido)
					{
						...
						for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
						{
							...
							$la_datac[$li_s]=array('cuenta'=>$ls_cuenta,'documento'=>$ls_documento,'debhab'=>$ls_debhab,'monto'=>$li_monto);
						}
						...
						uf_print_detallecontable($la_datac,$io_pdf); // Imprimimos el detalle 
