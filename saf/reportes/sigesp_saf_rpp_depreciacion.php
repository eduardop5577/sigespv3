...
***********************************************************************************/
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_codemp,$as_nomemp,$as_codact,$as_denact,$as_ideact,$ai_vidautil,$ad_fecmpact,$ad_feincact,
							   $ai_costo,$ai_cossal,$ai_mondep,$ai_depmen,$ai_depanu,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$li_modificacionsal=$io_report->uf_saf_load_montosalmodificacion($ls_codemp,$ls_codact,"");
			$li_cossal=$li_cossal+$li_modificacionsal;
			...
			uf_print_cabecera($ls_codemp,$ls_nomemp,$ls_codact,$ls_denact,$ls_ideact,$li_vidautil,$ld_fecmpactaux,
							  $ld_feincactaux,$li_costoaux,$li_cossalaux,$li_mondep,$li_depmen,$li_depanu,$io_pdf); 
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$li_valcont=(($li_costo-$li_modificacion)-$li_mondepacu);
               ...
               /*if($li_valcont!=$li_cossal)
				...
				elseif ($io_pdf->ezPageCount>1)
				{
					...
					{// Hacemos un rollback de los registros, agregamos una nueva página y volvemos a imprimir
						...
						uf_print_cabecera($ls_codemp,$ls_nomemp,$ls_codact,$ls_denact,$ls_ideact,$li_vidautil,
										  $ld_fecmpactaux,$ld_feincactaux,$li_costoaux,
										  $li_cossalaux,$li_mondep,$li_depmen,$li_depanu,$io_pdf); // Imprimimos la cabecera del registro
						uf_print_detalle($la_data,$io_pdf); // Imprimimos el detalle 
						uf_print_pie_cabecera($li_montot,$io_pdf); // Imprimimos pie de la cabecera
					}
				}
