...
***********************************************************************************/
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_cabecera($ls_nomemp,$ls_feccmp,$ls_denunimed,$ls_dencau,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////
	    ...
	    $la_data=array(array('name'=>' Los sucritos ______________________________________________________, mayores de edad, hacemos constar por la presente acta que con'.
									 ' fecha:   '.$ls_feccmp.   ', y de conformidad con las instrucciones recibidas de '.$ls_nomemp.'  se han desincorporado del inventario'.
									 ' de la Unidad    '.$ls_denunimed.'    que funciona en Sarare, Municipio Simon Planas del Estado Lara, los bienes que a continuación se'.
									 ' especifican, debido a '.$ls_dencau));
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_detalle($ls_feccmp,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////
...
//		$io_pdf->addObject($io_encabezado,'all');
	...
	function uf_print_pie_cabecera($io_pdf)
	{
        ...
        $io_pdf->addText(30,205,10,"QUIEN SEDE");   
        ...
        $io_pdf->addText(370,220,10,"BIENES");   
        $io_pdf->addText(370,170,10,"__________________________________");   
        $io_pdf->addText(370,155,10,"<b>ING. YAINETH HERRERA</b>");   
        $io_pdf->addText(370,140,10,"<b>C:I. No.: 15.339.694</b>");   
        $io_pdf->addText(370,125,10,"<b>ADM. DE BIENES Y SERVICIOS JUNIOR</b>");   
	...
	$ls_denunimed=$arrResultado["denuniadm"];
	...
	if($lb_valido==false) // Existe algún error ó no hay registros
	{
	 ...
	 else // Imprimimos el reporte
	 {
		...
		$io_pdf->ezSetCmMargins(6,6,3,3); // Configuración de los margenes en centímetros
		...
		unset($la_data);			
		unset($la_datat);			
		uf_print_pie_detalle($ls_feccmp,$io_pdf); 
