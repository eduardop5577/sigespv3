...
***********************************************************************************/
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_columna=array('codact'=>'<b>Código</b>',
						  ...
						  'ideact'=>'<b>No. de Bien</b>',
						  'estact'=>'<b>Estado</b>',
						  'maract'=>'<b>Marca</b>',
						  'modact'=>'<b>Modelo</b>',
						  'seract'=>'<b>Serial</b>',
						  'denconbie'=>'<b>Condicion</b>',
						  'denuniadm'=>'<b>Ubicacion</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>900, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codact'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
						 			   'denact'=>array('justification'=>'left','width'=>130), // Justificación y ancho de la columna
									   'ideact'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
									   'estact'=>array('justification'=>'center','width'=>75), // Justificación y ancho de la columna
									   'maract'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
						 			   'modact'=>array('justification'=>'left','width'=>105), // Justificación y ancho de la columna
									   'seract'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna 
									   'denconbie'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna 
									   'denuniadm'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna 
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$la_data[$li_i]=array('codact'=>$ls_codact,'denact'=>$ls_denact,'estact'=>$ls_estact,'maract'=>$ls_maract,
			                      'modact'=>$ls_modact,'seract'=>$ls_seract,'costo'=>$li_costo,'denconbie'=>$ls_denconbie,'ideact'=>$ls_ideact,'denuniadm'=>$ls_denuniadm);
		}
