...
***********************************************************************************/
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_estado,$as_municipio,$as_denuniadm,$as_cmpmov,$ad_feccmp,$as_titulo,$as_cmpmov,$ad_fecha,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function uf_print_pie_de_pagina($io_pdf)
{
 ...
 $io_pdf->addText(560,80,9,"                                <b>FIRMA:______________________________________________________</b>");
	...
	$lb_valido=$io_report->uf_saf_load_relbiemuefal($ls_codemp,$ls_coduniadm,$ls_cmpmov_desde,$ls_cmpmov_hasta,$ld_desde,$ld_hasta,
													$li_orden,$ls_codgru,$ls_codsubgru,$ls_codsec,$ls_grupohas,$ls_subgrupohas,$ls_seccionhas); // Cargar el DS con los datos de la cabecera del reporte
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			if($lb_valido)
			{
				...
				{
					$i=$i +1;
					uf_print_encabezado_pagina($ls_estemp,'',$ls_denuniadm,$ls_cmpmov,$ld_feccmp,$ls_titulo,"",$ld_fecha,$io_pdf); // Imprimimos el encabezado de la página
