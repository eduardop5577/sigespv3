...
//		$io_pdf->addText(405,43,7,"FIRMA AUTOGRAFA, SELLO, FECHA"); // Agregar el título
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($ls_codemp,$ls_nomemp,$ls_codcau,$ls_dencau,$ls_descmp,$ls_codsed,$ls_densed,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data=array(array('name'=>'<b>Organismo:</b>         '.$ls_codemp." - ".$ls_nomemp.''),
					   ...
					   array ('name'=>'<b>Sede:</b>  '.$ls_codsed." - ".$ls_densed.''));
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$ls_codsed=$io_report->ds->data["codsed"][$li_i];
			$ls_densed=$io_report->ds->data["densed"][$li_i];
			uf_print_encabezado_pagina($ls_titulo,$ls_numcmp,$ld_fecha,$io_pdf); // Imprimimos el encabezado de la página
			uf_print_cabecera($ls_codemp,$ls_nomemp,$ls_codcau,$ls_dencau,$ls_descmp,$ls_codsed,$ls_densed,$io_pdf); // Imprimimos la cabecera del registro
