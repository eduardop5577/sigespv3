	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codgru'=>array('justification'=>'left','width'=>50), // Justificación y ancho de la columna
						 			   ...
						 			   'maract'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'modact'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   ...
						 			   'cantdif'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
						 			   'costot'=>array('justification'=>'right','width'=>50))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$la_data[$li_s]=array('codgru'=>$ls_grupo,'codsubgru'=>$ls_subgrupo,'codsec'=>$ls_seccion,'ideact'=>$ls_ideact,
										  ...
										  'cantidad'=>$ls_cantidad,'regcont'=>'','costo'=>$ls_costo,'cantdif'=>'','costot'=>'','denconbie'=>$ls_denconbie);
				}
				if($la_data!="")
				{
					$i=$i +1;
