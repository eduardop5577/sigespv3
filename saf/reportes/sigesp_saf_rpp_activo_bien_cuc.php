...
***********************************************************************************/
	...
	function uf_print_pie_cabecera($ai_montot,$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_pdf;
		$la_data=array(array('name'=>'Total General','name2'=>$ai_montot));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'width'=>900,
						 'cols'=>array('name'=>array('justification'=>'right','width'=>820),
						 			   'name2'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
	...
	function uf_print_firmas($io_pdf)
	{
		...
		global $io_pdf;
		$io_pdf->ezSetDy(-170);
		$la_data[1]=array('name1'=>'JEFE DE LA UNIDAD DE TRABAJO','name2'=>'REPONSABLE POR USO','name3'=>'UNIDAD DE BIENES NACIONALES');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=$io_report->uf_select_inventario_unidad($ls_coduniadm,$ld_desde,$ld_hasta,$ls_status,$ls_ordenact,$ls_coddesde,
		...
		$io_pdf->ezStartPageNumbers(940,50,10,'','',1); // Insertar el número de página
			...
			{			
				...
				{  				
					...
					$li_acumcosto=$li_acumcosto+$li_costo;
				...
				if($la_data!="")
				{
					...
					$li_acumcosto=$io_fun_activos->uf_formatonumerico($li_acumcosto);
	  			    uf_print_pie_cabecera($li_acumcosto,$io_pdf);
