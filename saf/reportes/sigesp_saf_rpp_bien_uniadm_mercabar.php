...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_cabecera_detalle($as_unidadm,$io_pdf)
	{
		...
		$la_data[0]=array('numero'=>'<b>3. NÚMERO</b>',
						  ...
						  'denconbie'=>'<b>10. CONDICION</b>',
						  'precio'=>'<b>11. PRECIO SIN IVA</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'grupo'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'subgrupo'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
									   'seccion'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   ...
						 			   'descripcion'=>array('justification'=>'left','width'=>180), // Justificación y ancho de la columna
						 			   'denconbie'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
...
function uf_print_detalle($la_data,$ls_totcosto,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>900, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('numero'=>array('justification'=>'right','width'=>670), // Justificación y ancho de la columna
	...
	function uf_print_pie_cabecera($io_pdf)
	{
		...
		$io_pdf->addText(20,40,9,"V.B Presidente de Mercabar"); // Agregar el título
		$io_pdf->addText(20,25,9,"Nombre:"); // Agregar el título
		$io_pdf->addText(20,10,9,"C.I:"); // Agregar el título
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			if ($aux_uniad == $ls_codnidadm) 
			{
				...
				$ls_descripcion=ltrim($io_report->ds->data["denact"][$li_i]);
				...
				$la_data[$num]=array('numero'=>$ls_numero,'grupo'=>$ls_codgru,'subgrupo'=>$ls_codsubgru,'seccion'=>$ls_codsec,
									  'cantidad'=>$ls_cantidad,'codigo'=>$ls_codact,'descripcion'=>$ls_descripcion,'denconbie'=>$ls_denconbie,'precio'=>$li_costo);
			   $num=$num+1;
			   $ls_cantidad=0;	
			}
			else
