...
{
	$ls_sql="SELECT saf_activo.codact,saf_activo.denact,saf_activo.maract,saf_activo.modact, saf_dta.ideact, saf_dta.idchapa, saf_dta.seract".
	...
	else
	{
		...
		if ($li_totrows>0)
		{
			while(!$rs_data->EOF)
			{
				...
				print "<td>".$ls_seract."</td>";
				print "<td>".$ls_ideact."</td>";
				print "<td>".$ls_denact."</td>";
				print "<td>".$ls_maract."</td>";
				print "<td>".$ls_modact."</td>";
				print "<td>".$ls_ideact."</td>";
				print "</tr>";			
                $rs_data->MoveNext();
			}
