...
{
	codres=opener.document.form1.txtcodres.value;
	if(codper==codres)
	{
		alert("El nuevo responsable no debe ser igual al actual");
	}
	else
	{
		opener.document.form1.txtcodresnew.value=codper;
		opener.document.form1.txtcodresnew.readOnly=true;
		opener.document.form1.txtnomresnew.value=nomper+" "+apeper;
		close();
	}
}
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="sigesp_cat_personalnuevo.php";
  	f.submit();
}
</script>
</html>
