...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_resbiegru.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Resumen de Bienes Muebles por Grupo</title>
...
if ($ls_operacion=="REPORT")
{
	...
	$ls_evento="REPORT";
	$ls_descripcion="Generó un Reporte de Bienes por Grupo. Desde el  ". $ld_fecdesde ." hasta el ".$ld_fechasta.$ls_desccod;
...
?>	
  ...
  <table width="578" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="561" colspan="2" class="titulo-ventana"> Resumen de Bienes Muebles por Grupo </td>
    </tr>
  </table>
        ...
        <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="175"><div align="center"></div>
              <div align="center"><strong>SubGrupo</strong></div></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/sigesp_saf_rpp_resbiegru.php?ordenact="+li_ordenact+"&desde="+ld_desde+
				         "&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&tipoformato="+tipoformato+"&grupo="+ls_grupo+"&subgrupo="+ls_subgrupo+"&seccion="+ls_seccion;
