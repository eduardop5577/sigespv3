		  ...
		  while(!$rs_data->EOF)
			   {
				...
				$li_estaper=$fun_activos->uf_formatonumerico($li_estaper);
				$li_pesper=$rs_data->fields["pesper"];			
				$li_pesper=$fun_activos->uf_formatonumerico($li_pesper);
				...
				$li_monpagvivper=$fun_activos->uf_formatonumerico($li_monpagvivper);				
...
<form name="form1" method="post" action="">
  ...
  <br>
	...
	$ls_tipo=$fun_activos->uf_obtenertipo();
	$ls_codnom=$fun_activos->uf_obtenervalor_get("codnom","");
