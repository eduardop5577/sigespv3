...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_invgenbie.php",$ls_permisos,$la_seguridad,$la_permisos);
...
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","INVGENBIE","sigesp_saf_rpp_invgenbie.php","C");
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
?>	
  ...
  <table width="578" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="561" colspan="2" class="titulo-ventana"> Inventario General de Bienes Muebles</td>
    </tr>
  </table>
    ...
    <tr>
      <td height="22" colspan="3" align="center"><div align="right" class="style1 style14">
        <div align="center">
          ...
          Filtrar por valor &gt; 14 U.T. (Pub. 21) </div>
      </div>  
      <div align="right" class="style1 style14"></div>        <div align="left">
    ...
    <tr>
      <td colspan="3" align="center"><div align="left">
        <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td height="22"><div align="right"></div><div align="right">C&oacute;digo
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/"+formato+"?ordenact="+li_ordenact+"&desde="+ld_desde+
				         "&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+
						 "&coduni="+ls_coduni+"&tipoformato="+tipoformato+"&grupo="+ls_grupo+"&subgrupo="+ls_subgrupo+"&seccion="+ls_seccion+"&unitri="+unitri;
				...
				f.action="sigesp_siv_r_invgenbie.php";
