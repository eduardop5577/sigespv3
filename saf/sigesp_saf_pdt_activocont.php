...
$ls_codemp=$arre["codemp"];
	...
	switch ($ls_operacion) 
	{
		case "BUSCARACTIVO":
			...
			$arrResultado=$io_saf->uf_saf_select_activocuenta($ls_codemp,$ls_codact,$ls_ideact,$li_monact,$ls_sccuenta);
			$li_monact=$arrResultado['ai_monact'];
...
<form name="form1" method="post" action="">
  <table width="502" border="0" align="center" class="formato-blanco">
    ...
    <tr>
      ...
      <input name="hidestcon" type="hidden" id="hidestcon" value="<?php print $ls_estcon; ?>"></td>
