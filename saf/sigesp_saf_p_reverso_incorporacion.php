...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_p_reverso_incorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
switch ($ls_operacion){
  ...
  case "CARGAR_COMPROBANTES":
    uf_load_variables();
	$arrResultado=$io_objsaf->uf_load_comprobantes_reversar($ls_numcmp,$ls_fecdes,$ls_fechas,$lo_object,$li_totrows);
