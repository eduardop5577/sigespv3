...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_relmovbm2.php",$ls_permisos,$la_seguridad,$la_permisos);
...
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","BM2","sigesp_saf_rpp_relmovbm2.php","C");
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<html>
<head>
<title>Relaci&oacute;n de Movimientos de Bienes Muebles</title>
...
if ($ls_operacion=="REPORT")
{
	...
	$ls_evento="REPORT";
	$ls_descripcion="Generó un reporte de Relacion de Movimientos de Bienes Muebles. Desde el  ". $ld_fecdesde ." hasta el ".$ld_fechasta.$ls_desccod;
...
?>	
  ...
  <table width="542" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Relaci&oacute;n del Movimiento de Bienes Muebles </td>
    </tr>
  </table>
  <table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
            ...
            <div align="left" class="style14">
              <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                ...
                <tr>
                  ...
                  <td height="22"><input name="txtcodunidep" type="text" id="txtcodunidep" size="15"  style="text-align:center" readonly>
                      ...
                      <input name="txtdenunidep" type="text" class="sin-borde" id="txtdenunidep" size="40" readonly></td>
                </tr>
              </table>
            </div>
          </div>
      ...
      <td height="22" colspan="3" align="center"><div align="left" class="style14">
        <div align="left" class="style14">
          <div align="center">
            <table width="510" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
              <tr>
        ...
        <div align="left" class="style14">
          <div align="center">
            <table width="497" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
                ...
                <tr>
                  <td><div align="right">Jefe de la Unidad  </div></td>
                  <td height="22"><input name="txtcodrespri" type="text" id="txtcodrespri" size="15" style="text-align:center" readonly>
                    <a href="javascript: uf_resprimario('repasignadospri');"><img src="../shared/imagebank/tools15/buscar.gif" alt="BUSCAR" width="15" height="15" border="0"></a>
                    <input name="txtdenrespri" type="text" class="sin-borde" id="txtdenrespri" size="40" readonly>                  </td>
                </tr> 
                <tr>
                  <td><div align="right">Responsable de Bienes  </div></td>
                ...
                <tr>
                  <td><div align="right">Unidad de Bienes </div></td>
                  <td height="22"><input name="txtcodresact" type="text" id="txtcodresact" size="15"  style="text-align:center" readonly>
                    <a href="javascript: uf_resprimario('responsableactual');"><img src="../shared/imagebank/tools15/buscar.gif" alt="BUSCAR" width="15" height="15" border="0"></a>
                    <input name="txtnomresact" type="text" class="sin-borde" id="txtnomresact" size="40" readonly>                 </td>
                </tr>
                      </table>
          </div>
        </div>
...
function ue_seccion(origen)
{
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				ls_codunidep= f.txtcodunidep.value;
				ls_denunidep= f.txtdenunidep.value;
				ls_grupo= f.txtcodgru.value;
				ls_subgrupo= f.txtcodsubgru.value;
				ls_seccion= f.txtcodsec.value;
				ls_codjefeuni= f.txtcodrespri.value;
				ls_nomjefuni= f.txtdenrespri.value;
				ls_codresuni= f.txtcodresuso.value;
				ls_nomresuni= f.txtdenrespri.value;
				ls_codunibie= f.txtcodresact.value;
				ls_nomunibie= f.txtnomresact.value;
				...
				window.open("reportes/"+formato+"?ordenact="+li_ordenact+"&coddesde="+ls_coddesde
							+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&codgru="+ls_grupo
							+"&codsubgru="+ls_subgrupo+"&codsec="+ls_seccion+"&coduniadm="+ls_coduniadm
							+"&denuniadm="+ls_denuniadm+"&tipoformato="+tipoformato+"&grupohas="+ls_grupohas
							+"&subgrupohas="+ls_subgrupohas+"&seccionhas="+ls_seccionhas+"&unitri="+unitri+"&denunidep="+ls_denunidep,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="sigesp_siv_r_relmovbm2.php";
				//f.submit();
			}
			else
	...
	function ue_openexcel()
	{
			...
			if(li_imprimir==1)
			{
				...
				window.open("reportes/sigesp_saf_rpp_relmovbm2_excel.php?ordenact="+li_ordenact+"&coddesde="+ls_coddesde
							+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&codgru="+ls_grupo
							+"&codsubgru="+ls_subgrupo+"&codsec="+ls_seccion+"&coduniadm="+ls_coduniadm
							+"&denuniadm="+ls_denuniadm+"&tipoformato="+tipoformato+"&grupohas="+ls_grupohas
							+"&subgrupohas="+ls_subgrupohas+"&seccionhas="+ls_seccionhas+"&unitri="+unitri+"&denunidep="+ls_denunidep,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
