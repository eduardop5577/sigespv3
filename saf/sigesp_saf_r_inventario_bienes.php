...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_inventario_bienes.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Reporte de Inventario de Bienes Inmuebles</title>
...
<table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center" class="titulo-ventana">Reporte de Inventario de Bienes Inmuebles</td>
    </tr>
    <tr>
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/sigesp_saf_rpp_inventario_bienes.php?ordenact="+li_ordenact+"&desde="+ld_desde+
				         "&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&tipoformato="+tipoformato+
						 "&grupo="+ls_grupo+"&subgrupo="+ls_subgrupo+"&seccion="+ls_seccion+"&grupohas="+ls_grupohas+
						 "&subgrupohas="+ls_subgrupohas+"&seccionhas="+ls_seccionhas+"&unitri="+unitri;
