...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_sigecof.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="547" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Cat&aacute;logo SIGECOF  </td>
    </tr>
  </table>
  <table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td colspan="2"><div align="left"><strong>Rango</strong></div></td>
        </tr>
        <tr>
    ...
    <tr>
      <td height="22" colspan="3" align="center"><div align="right" class="style1 style14"></div>        <div align="left">
...
function uf_mostrar_reporte()
{
	...
	if(li_imprimir==1)
	{
		...
		window.open("reportes/sigesp_saf_rpp_sigecof.php?orden="+li_orden+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
	else
