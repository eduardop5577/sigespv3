	...
	if($li_row>0)
	{
		while($row=$io_sql->fetch_row($rs_cta))
		{
			...
			print "<td><a href=\"javascript: aceptar('$ls_cmpmov','$ls_codcau','$ls_dencau','$ld_feccmp','$ls_descmp',".
				  "'$ls_estpromov','$ls_coddestino','$ls_numcmp','$ls_coduniadm','$ls_denuniadm');\">".$ls_numcmp."</a></td>";
...
function aceptar(ls_cmpmov,ls_codcau,ls_dencau,ld_fectraact,ls_obstra,ls_estpromov,ls_coddestino,as_numcmp,ls_coduniadm,ls_denuniadm)
{
	f=document.form1;
