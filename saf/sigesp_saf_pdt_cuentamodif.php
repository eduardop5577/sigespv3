...
$ls_codemp=$arre["codemp"];
	...
	switch ($ls_operacion) 
	{
		case "BUSCARACTIVO":
			...
			$la_debhab = uf_seleccionarcombo("D-H",$ls_debhab,$la_debhab,2);			
			//$arrResultado=$io_saf->uf_saf_select_activocuenta($ls_codemp,$ls_codact,$ls_seract,$li_monact,$ls_sccuenta);
