...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_actadesincorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
$ls_permisos=$arrResultado['as_permisos'];
$la_seguridad=$arrResultado['aa_seguridad'];
$la_permisos=$arrResultado['aa_permisos'];
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","FORMATO_ACTADESINCORPORACION","sigesp_saf_rpp_acta_desincorporacion.php","C");
...
<html>
<head>
<title>Acta de Desincorporaci&oacute;n</title>
...
?>	
  ...
  <table width="547" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Acta de Desincorporaci&oacute;n</td>
    </tr>
  </table>
...
function uf_mostrar_reporte(ls_reporte)
{
	...
	if(li_imprimir==1)
	{
		...
		{
			//window.open("reportes/"+ls_reporte+"?cmpmov="+ls_cmpmov+"&coduniadm="+ls_coduniadm+"&codres="+ls_codres+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
