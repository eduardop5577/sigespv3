...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_incorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","INCORPORACION","sigesp_saf_rpp_incorporacion.php","C");
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<html>
<head>
<title>Reporte de Incorporaci&oacute;n</title>
...
<table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center" class="titulo-ventana">Reporte de Incorporaci&oacute;n</td>
    </tr>
    <tr>
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			{
				window.open("reportes/"+formato+"?desde="+ld_desde+"&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&orden="+li_orden+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			}
			else
			{
