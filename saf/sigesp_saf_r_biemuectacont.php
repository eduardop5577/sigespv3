...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_biemuectacont.php",$ls_permisos,$la_seguridad,$la_permisos);
...
if ($ls_operacion=="REPORT")
{
	...
	$ls_evento="REPORT";
	$ls_descripcion="Generó un reporte de Bienes Muebles por Cuenta Contable. Desde el  ". $ld_fecdesde ." hasta el ".$ld_fechasta.$ls_desccod;
...
?>	
  ...
  <table width="542" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Bienes Muebles por Cuenta Contable </td>
    </tr>
  </table>
    ...
    <tr>
      ...
      <td height="22" colspan="3" align="center"><div align="left" class="style14">
        <div align="left" class="style14">
          <div align="left" class="style14">
            <div align="left"><strong>Cuentas Contables </strong></div>
          </div>
        </div>
      </div></td>
    </tr>
        <tr>
          ...
          <td width="418" height="22"><div align="left">
              ...
              <input name="txtdenctacon1" type="text" class="sin-borde" id="txtdenctacon1" size="40" readonly>
          </div>
        ...
        <tr>
          ...
          <td height="22"><div align="left">
              <input name="txtctacon2" type="text" id="txtctacon2" size="21" maxlength="20"  style="text-align:center">
              <a href="javascript:uf_catalogo_ctasscg('txtctacon2','txtdenctacon2');"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
              <input name="txtdenctacon2" type="text" class="sin-borde" id="txtdenctacon2" size="40" readonly>
          </div>
            <div align="left"> </div></td>
        </tr>
      </table></td>
        ...
        <div align="left" class="style14">
          <div align="center">
            <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              <tr>
                <td height="22" colspan="5"><strong>Intervalo de Fecha de Compra del Activo </strong></td>
              </tr>
              <tr>
          ...
          <div align="left" class="style14">
            <div align="left" class="style14">
              <div align="left" class="style14">
                <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                  <tr>
                    <td height="22"><strong>Tipo de Reporte  </strong></td>
                  </tr>
                  <tr>
                    <td><div align="right">
                      <table width="393" height="26" align="center">
                        <tr>
                          <td width="191"><label>
                            <input type="radio" name="radio_reporte" value="0" checked>
                            Resumido</label></td>
                          <td width="190"><input type="radio" name="radio_reporte" value="1"> 
                            Detallado
</td>
                        </tr>
                      </table>
        ...
        <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="175"><div align="center"></div>
                <div align="center"><strong>Cuenta Contable </strong></div></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				ls_coddesde= f.txtctacon1.value;
				ls_codhasta= f.txtctacon2.value;
				...
				if (f.radio_reporte[0].checked)
				{
				window.open("reportes/sigesp_saf_rpp_biemuectacont_res.php?ordenact="+li_ordenact+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&tipoformato="+tipoformato+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="sigesp_siv_r_biemuectacont.php";
				}
				else
				{
				 window.open("reportes/sigesp_saf_rpp_biemuectacont_det.php?ordenact="+li_ordenact+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&tipoformato="+tipoformato+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="sigesp_siv_r_biemuectacont.php";
				}
			}
