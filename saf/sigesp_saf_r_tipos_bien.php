...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_tipos_bien.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Reporte de Tipos de Adquisici&oacute;n de Bienes</title>
...
if ($ls_operacion=="REPORT")
{
	...
	$ls_evento="REPORT";
	$ls_descripcion="Generó un Reporte de Tipos de Adquisicion de Bienes. Desde el  ". $ld_fecdesde ." hasta el ".$ld_fechasta.$ls_desccod;
...
?>	
  ...
  <table width="578" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="561" colspan="2" class="titulo-ventana">Reporte de Tipos Adquisici&oacute;n de Bienes</td>
    </tr>
  </table>
  <table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><table width="511" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          <td colspan="2"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
            <tr>
              <td width="121"><strong>Proveedor</strong></td>
              <td width="376">&nbsp;</td>
            </tr>
            <tr>
              <td><div align="right">Desde</div></td>
              <td height="22"><input name="txtcodpro" type="text" id="txtcodpro" size="15"  style="text-align:center" readonly>
                  <a href="javascript: uf_proveedor('txtcodpro','txtdenpro');"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
                  <input name="txtdenpro" type="text" class="sin-borde" id="txtdenpro" size="40" readonly>            </tr>
            <tr>
              <td><div align="right">Hasta</div></td>
              <td height="22"><input name="txtcodhasp" type="text" id="txtcodhasp" size="15"  style="text-align:center" readonly>
                  <a href="javascript: uf_proveedor('txtcodhasp','txtnomp');"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
                  <input name="txtnomp" type="text" class="sin-borde" id="txtnomp" size="40" readonly>              </td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="129"><div align="right">Desde</div></td>
          <td width="387" height="22"><div align="left">
    ...
    <tr>
      ...
      <td height="13" colspan="3" align="center"><table width="517" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
    ...
    <tr>
      <td height="33" colspan="3" align="center">      <div align="left">
        <table width="516" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
      ...
      <td colspan="3" align="center"><div align="left">
        <table width="516" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <div align="center"><strong>Proveedor y Activo</strong></div></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
...
<script language="JavaScript">
	...
	function uf_proveedor(ls_coddestino,ls_dendestino)
	{
		window.open("sigesp_catdinamic_prov.php?coddestino1="+ ls_coddestino +"&dendestino1="+ ls_dendestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,left=120,top=70,location=no,resizable=yes");
	}
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				ld_desde=    f.txtdesde.value;////fecha 1
				ld_hasta=    f.txthasta.value; /////fecha 2
				ls_coddesde= f.txtcoddesde.value;//// codigo activo
				ls_codhasta= f.txtcodhasta.value;//// codigo activo							
				ls_coddesp=  f.txtcodpro.value;//////codigo proveedor
				ls_codhasp=  f.txtcodhasp.value;//////codigo proveedor
				ls_unidad=   f.txtcoduni.value;/////codigo de la unidad	
				...
				pantalla="reportes/sigesp_saf_rpp_tipo_bien.php?ordenact="+li_ordenact+"&desde="+ld_desde+
				         "&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&codprod="+ls_coddesp+"&codprohas="+ls_codhasp+"&cod_unidad="+ls_unidad+"&tipoformato="+tipoformato;
				...
				f.action="sigesp_siv_r_tipos_bien.php";
			}
			else
