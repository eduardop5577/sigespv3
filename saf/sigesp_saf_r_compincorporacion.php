...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_compincorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Comprobante de Incorporaci&oacute;n</title>
...
?>	
  ...
  <table width="547" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Comprobante  de Incorporaci&oacute;n</td>
    </tr>
  </table>
  <table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><table width="512" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          <td width="126"><div align="right"><strong>Incorporaci&oacute;n</strong></div></td>
          <td width="384" height="22"><div align="left">
        ...
        <tr>
          ...
          <td height="22"><div align="left">
            ...
            <?php
				...
				if($rs_data=="")
				{print "<option value='---'>-Seleccione una incorporación-</option>";}
	     ?>
            </select>
            </div>
            <div align="left"> </div></td>
...
function uf_catalogoincorporacion()
{
	...
	window.open("sigesp_saf_cat_incorporaciones.php?coddestino="+ ls_coddestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
}
...
function uf_mostrar_reporte()
{
	...
	if(li_imprimir==1)
	{
		...
		{
			window.open("reportes/sigesp_saf_rpp_comincorporacion.php?cmpmov="+ls_cmpmov+"&coduniadm="+ls_coduniadm+"&codres="+ls_codres+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
		}
		else
