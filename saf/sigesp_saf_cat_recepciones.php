...
<form name="form1" method="post" action="">
  ...
  <tr>
    ...
    <td height="22" colspan="-1"><input name="txtnumrec" type="text" id="txtnumrec" value="<?php print $ls_numrec ?>" size="20" maxlength="15" style="text-align:center ">
    ...
    <td height="22"><p align="left">Desde      
      <input name="txtfecdes" type="text" id="txtfecdes" onBlur="valFecha(document.form1.txtfecdes)" value="<?php print $ls_fecdes ?>" size="12" maxlength="10" datepicker="true">
      &nbsp;&nbsp;&nbsp;
Hasta 

<input name="txtfechas" type="text" id="txtfechas" onBlur="valFecha(document.form1.txtfechas)" value="<?php print $ls_fechas ?>" size="12" maxlength="10" datepicker="true">
    </p>      </td>
    </tr>
  <tr>
    <td height="22">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="22" colspan="-1"><input name="txtcodproben" type="text" id="txtcodproben" value="<?php print $ls_codproben ?>" size="24" maxlength="10" style="text-align:center "></td>
    <td height="22" colspan="-1"><div align="right">Nombre</div></td>
    <td height="22" colspan="-1"><input name="txtnombre" type="text" id="txtnombre" value="<?php print $ls_nomproben ?>" size="30" maxlength="50" style="text-align:left "></td>
    <td height="22" colspan="-1">&nbsp;</td>
  </tr>
  <tr>
