		...
		while($row=$io_sql->fetch_row($rs_cta))
		{
			switch($ls_tipo)
			{
				...
				case 'desde':
					...
					$ls_codsubgru=$row["codsubgru"];
					$ls_densubgru=$row["densubgru"];
					print "<td><a href=\"javascript: aceptar_desde('$ls_codgru','$ls_codsubgru','$ls_densubgru');\">".$ls_codgru."</a></td>";
					print "<td>".$ls_codsubgru."</td>";
					print "<td>".$ls_densubgru."</td>";
				break;
				case 'hasta':
					...
					$ls_codsubgru=$row["codsubgru"];
					$ls_densubgru=$row["densubgru"];
					print "<td><a href=\"javascript: aceptar_hasta('$ls_codgru','$ls_codsubgru','$ls_densubgru');\">".$ls_codgru."</a></td>";
					print "<td>".$ls_codsubgru."</td>";
					print "<td>".$ls_densubgru."</td>";
				break;
		 	 print "</tr>";	
...
<script language="JavaScript">
	...
	function aceptar_desde(codgrupo,codsubgrupo,denominacion)
	{
		opener.document.form1.txtcodsubgru.value=codsubgrupo;
		opener.document.form1.txtdensubgru.value=denominacion;
		opener.document.form1.txtcodsubgruhas.value=codsubgrupo;
		opener.document.form1.txtdensubgruhas.value=denominacion;
		opener.document.form1.txtcodgru.readOnly=true;
		opener.document.form1.txtdengru.readOnly=true;
		opener.document.form1.txtcodsubgru.readOnly=true;
		close();
	}
	function aceptar_hasta(codgrupo,codsubgrupo,denominacion)
	{
		opener.document.form1.txtcodsubgruhas.value=codsubgrupo;
		opener.document.form1.txtdensubgruhas.value=denominacion;
		close();
