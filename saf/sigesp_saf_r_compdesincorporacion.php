...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_compdesincorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="547" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Comprobante  de Desincorporaci&oacute;n</td>
    </tr>
  </table>
    ...
    <tr>
      <td colspan="3" align="center"><table width="512" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr style="visibility:hidden">
          <td><div align="right"><strong>Reporte en</strong></div></td>
          <td><div align="left">
        ...
        <tr>
          <td width="96"><div align="right"><strong>Desincorporaci&oacute;n</strong></div></td>
          <td width="414" height="22"><div align="left">
              ...
              <a href="javascript:uf_catalogoincorporacion();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
        ...
        <tr>
          <td height="10"><div align="right"><span class="style14 style1"><strong>Unidad Ejecutora </strong></span></div></td>
          <td height="22"><div align="left">
            ...
            <?php
				...
				if($rs_data=="")
				{print "<option value='---'>-Seleccione una desincorporación-</option>";}
	     ?>
            </select>
            </div>
            <div align="left"> </div></td>
        ...
        <tr>
          <td height="10"><div align="right"><strong>Responsable</strong></div></td>
          <td height="22"><div align="left">
            <input name="txtcodres" type="text" id="txtcodres" style="text-align:center" value="<?php print $ls_codres  ?>" size="20" readonly>
            <a href="javascript:uf_catalogoresponsable();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
            <input name="txtnomres" type="text" class="sin-borde" id="txtnomres" value="<?php print $ls_nomres  ?>" size="40" readonly>
          </div></td>
        </tr>
      </table></td>
    </tr>
...
function uf_catalogoincorporacion()
{
	ls_coddestino="reporte";
	window.open("sigesp_saf_cat_desincorporaciones.php?coddestino="+ ls_coddestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
}
...
function uf_mostrar_reporte()
{
	...
	if(li_imprimir==1)
	{
		...
		{
			window.open("reportes/sigesp_saf_rpp_comdesincorporacion.php?cmpmov="+ls_cmpmov+"&coduniadm="+ls_coduniadm+"&codres="+ls_codres+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
		}
		else
