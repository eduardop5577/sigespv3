  ...
  {     
    ...
    if($li_row>0)
	{
		while($row=$io_sql->fetch_row($rs_data))
		{
		  ...
		  elseif($ls_destino == "unidep")
		  {
		   print "<td align=center width=100><a href=\"javascript: aceptar_unidep('$ls_codigo','$ls_denominacion');\">".$ls_codigo."</a></td>";
		   print "<td align=left  width=370>".$ls_denominacion."</td>";		  
		   print "</tr>";
		  }
		  else
...
f=document.form1;
   ...
   function aceptar_unidep(codigo,denominacion)
   {
	 opener.document.form1.txtcodunidep.value=codigo;
     opener.document.form1.txtdenunidep.value=denominacion;	
     close(); 
   }
</script>
</html>