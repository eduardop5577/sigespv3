...
<html>
<head>
<title>Reporte de Autorizaci&oacute;n de Salida de Bienes Muebles</title>
...
?>	
  ...
  <table width="578" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="561" colspan="2" class="titulo-ventana">Reporte de Autorizaci&oacute;n de Salidas </td>
    </tr>
  </table>
  <table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr style="display:none">
      <td colspan="3" align="center"><table width="511" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td width="495" height="19"><strong>Reporte en</strong>
    ...
    <tr>
      <td height="22" colspan="3" align="center"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td width="123"><div align="right"><strong>Comprobante:</strong></div></td>
          <td width="123" height="22"><input name="txtcodmov" type="text" id="txtcodmov" size="15"  style="text-align:center" readonly>
              <a href="javascript: uf_comprobante();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
              <input name="txtcausa" type="hidden" class="sin-borde" id="txtcausa">          </td>
          <td width="263">&nbsp;</td>
        </tr>
      </table></td>
    </tr>
    ...
    <tr>
      <td height="33" colspan="3" align="center">      <div align="left">
        <table width="511" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td height="22" colspan="5"><strong>Intervalo de Fecha del comprobante </strong></td>
            </tr>
          <tr>
    ...
    <tr>
      <td height="22" colspan="3" align="center"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td width="198"><div align="right"><strong>Persona que Recibe conforme: </strong></div></td>
          <td width="311" height="22"><input name="txtcodres" type="text" id="txtcodres" size="15"  style="text-align:center" readonly>
              <a href="javascript: uf_personal('');"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0">
              <input name="txtnomres" type="text" id="txtnomres" size="30"  style="text-align:center" readonly>
            </a></td>
        </tr>
      </table></td>
    </tr>
    ...
    <tr>
      <td height="13" colspan="3" align="center"><div align="left" class="style14"></div></td>
    </tr>
    <tr>
...
<script language="JavaScript">
	...
	function uf_comprobante(ls_destino)
	{
		window.open("sigesp_catdinamic_movimientos_salidas.php?destino="+ ls_destino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,left=120,top=70,location=no,resizable=yes");
	}
	
	function uf_personal(ls_destino)
	{
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				ls_cmpmvo=   f.txtcodmov.value;
				ls_causa=    f.txtcausa.value;
				ls_codper=   f.txtcodres.value;
				ls_nomper=   f.txtnomres.value;
				...
				pantalla="reportes/sigesp_saf_rpp_autorizacion.php?ordenact="+li_ordenact+"&desde="+ld_desde+
				         "&hasta="+ld_hasta+"&nromvo="+ls_cmpmvo+"&causa="+ls_causa+"&codper="+ls_codper+"&nomper="+ls_nomper+"&tipoformato="+tipoformato;
				...
				f.action="sigesp_saf_r_autorizacion.php";
