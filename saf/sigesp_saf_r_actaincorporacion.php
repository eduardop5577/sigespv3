...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_actaincorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
$ls_permisos=$arrResultado['as_permisos'];
$la_seguridad=$arrResultado['aa_seguridad'];
$la_permisos=$arrResultado['aa_permisos'];
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","FORMATO_ACTAINCORPORACION","sigesp_saf_rpp_acta_incorporacion.php","C");
...
<html>
<head>
<title>Acta de Incorporaci&oacute;n</title>
...
?>	
  ...
  <table width="547" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Acta de Incorporaci&oacute;n</td>
    </tr>
  </table>
