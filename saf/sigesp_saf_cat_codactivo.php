...
if ($ls_operacion=="BUSCAR")
   {
    ...
    $ls_sqlaux = ",".$ls_cadena_personal." as nomrespri, ".$ls_cadena_beneficiario." as respri";
	 $ls_sql="SELECT saf_activo.codact,saf_activo.denact,saf_activo.maract,saf_activo.modact, saf_dta.codres, saf_dta.idchapa, saf_activo.costo,
			   ...
			   WHERE saf_activo.codact like '".$ls_codact."'
			     ...
			     AND (saf_activo.modact like '".$ls_modact."'  OR  saf_activo.modact IS NULL) $ls_sqlest
				 AND saf_dta.idchapa like '".$ls_idchapa."'
				 AND saf_activo.codact = saf_dta.codact ORDER BY saf_activo.codact";//print $ls_sql.'<br>';
