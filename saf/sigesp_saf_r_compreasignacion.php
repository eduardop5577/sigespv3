...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_compreasignacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Comprobante de Reasignaci&oacute;n</title>
...
?>	
  ...
  <table width="547" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Comprobante  de Reasignaci&oacute;n</td>
    </tr>
  </table>
      ...
      <td colspan="3" align="center"><table width="512" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td height="28"><div align="left">
            ...
            <?php
				...
				if($rs_data=="")
				{print "<option value='---'>-Seleccione una reasignación-</option>";}
	     ?>
            </select>
            </div>
            <div align="left"> </div></td>
        ...
        <tr>
          <td height="32"><div align="right">
            <div align="right"><strong>Responsable Primario</strong></div>
          </div></td>
        ...
        <tr>
          <td height="28"><div align="right"><strong>Responsable por Uso </strong></div></td>
          <td height="28"><input name="txtcodresuso" type="text" id="txtcodresuso" style="text-align:center" value="<?php print $ls_codres  ?>" size="20" readonly>
            <a href="javascript:uf_catalogoresponsableuso();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
            <input name="txtnomresuso" type="text" class="sin-borde" id="txtnomresuso" value="<?php print $ls_nomres  ?>" size="40" readonly></td>
        </tr>
      </table></td>
    </tr>
...
function uf_mostrar_reporte()
{
	...
	if(li_imprimir==1)
	{
		...
		{
			window.open("reportes/sigesp_saf_rpp_comreasignacion.php?cmpmov="+ls_cmpmov+"&coduniadm="+ls_coduniadm+"&codres="+ls_codres+"&codresuso="+ls_codresuso+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
		}
		else
