...
***********************************************************************************/
	...
	$la_seguridad = Array();
	$la_permisos = Array();
	$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_d_grupo.php",$ls_permisos,$la_seguridad,$la_permisos);
   ...
   function uf_limpiarvariables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		global $ls_codsec,$ls_densec,$disabled,$readonly;
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    ...
    <td class="toolbar" width="25"><div align="center"><a href="javascript: ue_buscar();"><img src="../shared/imagebank/tools20/buscar.gif" alt="Buscar" title="Bucar" width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="25"><div align="center"><img src="../shared/imagebank/tools20/imprimir.gif" alt="Imprimir" width="20" height="20" title="Imprmir"></div></td>
...
<table width="566" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              ...
              <tr class="formato-blanco">
                ...
                <td height="22" colspan="2"><div align="left">
                  <input name="txtcodsec" type="text" id="txtcodsec" value="<?php print $ls_codsec?>" size="4" maxlength="3" style="text-align:center"  onBlur="javascript:rellenar_cad(this.value,3,'cod')" <?php print $readonly?> >
                </div></td>
              </tr>
              <tr class="formato-blanco">
                <td height="30"><div align="right">Denominaci&oacute;n</div></td>
                <td colspan="2" rowspan="2" align="left"><textarea name="txtdensec" cols="82" rows="2" id="txtdensec" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz[]{}!¡@#$%&/(),.:; ¿?');"><?php print $ls_densec?></textarea></td>
              </tr>
              <tr class="formato-blanco">
                <td height="13">&nbsp;</td>
              </tr>
              <tr class="formato-blanco">
                <td height="20">&nbsp;</td>
                <td height="20" colspan="2" align="left"><input name="botestpro2" type="button" class="boton" id="botestpro2" onClick="javascript: uf_volver();" value="Volver a Sub Grupo" >
	...
	if (li_leer==1)
   	{
		...
		window.open("sigesp_saf_cat_seccion.php?txtcodgru="+codgru+"&txtdengru="+dengru+"&txtcodsubgru="+codsubgru+"&txtdensubgru="+densubgru+"&tipo","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
   	}
	else
   	{
 		alert("No tiene permiso para realizar esta operacion");
