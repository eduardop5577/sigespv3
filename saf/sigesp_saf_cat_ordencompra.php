...
<form name="form1" method="post" action="">
  ...
  <table width="550" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" height="15" colspan="2" class="titulo-celda">Cat&aacute;logo de Ordenes de Compra </td>
    </tr>
  </table>
<br>
...
if($ls_operacion=="BUSCAR")
{
	$ls_sql="SELECT soc_ordencompra.*,".
			"(SELECT nompro FROM rpc_proveedor WHERE soc_ordencompra.cod_pro=rpc_proveedor.cod_pro) AS denpro".
