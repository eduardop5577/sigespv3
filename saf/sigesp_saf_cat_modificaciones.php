...
if($ls_operacion=="BUSCAR")
{
	...
	if($li_num>0)
	{
		while($row=$io_sql->fetch_row($rs_cta))
		{
			...
			print "<td><a href=\"javascript: aceptar('$ls_cmpmov','$ls_codact','$ls_ideact','$ls_denact','$ls_descmp','$ld_feccmp','$ls_codcau','$ls_dencau','$ls_estpromov','$ls_seract','$ls_numcmp');\">".$ls_numcmp."</a></td>";
...
function aceptar(ls_cmpmov,ls_codact,ls_ideact,ls_denact,ls_descmp,ls_feccmp,ls_codcau,ls_dencau,ls_estpromov,ls_seract,as_numcmp)
{
