...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_p_retorno_activos.php",$ls_permisos,$la_seguridad,$la_permisos);
...
switch ($ls_operacion){
  ...
  case "LOAD_ACTIVOS":
    uf_load_variables();
	$arrResultado=$io_objsaf->uf_load_activos_pendientes($ls_numcmp,$ls_tipcmp,$lo_object,$li_totrows);//Carga de activos en Calidad de Préstamo.
