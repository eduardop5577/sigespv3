...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_bien_general.php",$ls_permisos,$la_seguridad,$la_permisos);
...
if ($ls_operacion=="REPORT")
{
	...
	$ls_evento="REPORT";
	$ls_descripcion="Generó un Reporte .General de Bienes Desde el  ". $ld_fecdesde ." hasta el ".$ld_fechasta.$ls_desccod;
...
?>	
  ...
  <table width="578" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="561" colspan="2" class="titulo-ventana">Reporte de Adquisici&oacute;n de Bienes General </td>
    </tr>
  </table>
  <table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><table width="511" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          <td width="131"><div align="right">Desde</div></td>
          <td width="385" height="22"><div align="left">
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/sigesp_saf_rpp_bien_general.php?ordenact="+li_ordenact+"&desde="+ld_desde+
				         "&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&codprod="+ls_coddesp+"&codprohas="+ls_codhasp+"&tipoformato="+tipoformato;
				...
				f.action="sigesp_siv_r_bien_general.php";
