...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_desincorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","DESINCORPORACION","sigesp_saf_rpp_desincorporacion.php","C");
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<html>
<head>
<title>Reporte de Desincorporaci&oacute;n</title>
...
<table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center" class="titulo-ventana">Reporte de Desincorporaci&oacute;n</td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" align="center"><div align="left">
        <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="175"><div align="center"><strong>Comprobante</strong></div></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td height="22"><div align="right">Ascendente
                    <input name="radioorden" type="radio" class="sin-borde" value="radiobutton" checked>
              </div></td>
            <td width="333">&nbsp;</td>
          </tr>
          <tr>
            <td height="22"><div align="right">Descendente
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			{
				window.open("reportes/"+formato+"?orden="+li_orden+"&desde="+ld_desde+"&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			}
			else
			{
