...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_relbmf3.php",$ls_permisos,$la_seguridad,$la_permisos);
...
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","BM3","sigesp_saf_rpp_relbmf3.php","C");
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
            ...
            <table width="497" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
                ...
                <tr>
                  ...
                  <td width="368" height="22"><input name="codcmpmov" type="text" id="codcmpmov" size="15" style="text-align:center" readonly>
                    <a href="javascript: uf_desincorporaciones('codcmpmov');"><img src="../shared/imagebank/tools15/buscar.gif" alt="BUSCAR" width="15" height="15" border="0"></a>				  </td>
                </tr>
                      </table>
          </div>
        </div>
	...
	function uf_mostrar_reporte()
	{
	 if (document.form1.codcmpmov.value != "")
	 {
			...
			if(li_imprimir==1)
			{
				...
				window.open("reportes/"+formato+"?ordenact="+li_ordenact+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&codgru="+ls_grupo+"&codsubgru="+ls_subgrupo+"&codsec="+ls_seccion+"&coduniadm="+ls_coduniadm+"&denuniadm="+ls_denuniadm+"&tipoformato="+tipoformato+"&cmpmov_desde="+ls_cmpmov_desde+"&cmpmov_hasta="+ls_cmpmov_hasta+"&grupohas="+ls_grupohas+"&subgrupohas="+ls_subgrupohas+"&seccionhas="+ls_seccionhas+"&unitri="+unitri,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	...
	function ue_openexcel()
	{
	 if (document.form1.codcmpmov.value != "")
	 {
			...
			if(li_imprimir==1)
			{
				...
				window.open("reportes/sigesp_saf_rpp_relbmf3_excel.php?ordenact="+li_ordenact+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&codgru="+ls_grupo+"&codsubgru="+ls_subgrupo+"&codsec="+ls_seccion+"&coduniadm="+ls_coduniadm+"&denuniadm="+ls_denuniadm+"&tipoformato="+tipoformato+"&cmpmov_desde="+ls_cmpmov_desde+"&cmpmov_hasta="+ls_cmpmov_hasta+"&grupohas="+ls_grupohas+"&subgrupohas="+ls_subgrupohas+"&seccionhas="+ls_seccionhas+"&unitri="+unitri,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="sigesp_siv_r_relbmf3.php";
			}
			else
