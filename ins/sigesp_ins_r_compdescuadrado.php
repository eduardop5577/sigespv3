...
***********************************************************************************/
	...
	$la_seguridad = Array();
	$la_permisos = Array();
	$arrResultado = $oi_fun_instala->uf_load_seguridad("INS","sigesp_ins_r_compdescuadrado.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<form name="form1" method="post" action="">
  ...
  <table width="350" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td width="435" height="22" colspan="4" align="center"><div align="center">Listado de Comprobantes Descuadrados  </div></td>
    </tr>
    <tr>
...
{
  f=document.form1;
  pagina="reportes/sigesp_ins_rpp_comprobantesdescuadrados.php";
