...
class sigesp_ins_c_cambioiva
 {
	...
	function uf_guardar($ai_poraliant,$ai_pornueali,$as_formula,$aa_seguridad)
	{
		...
		$ls_seccion="RELEASE";
		$lb_ejecutado = "";
		$arrResultado=$this->uf_verificar_cambioiva($ls_codigo,$ls_codsis,$ls_seccion,$lb_ejecutado);
		$lb_ejecutado = $arrResultado['ab_ejecutado'];
	...
	function uf_verificar_cambioiva($as_codigo,$as_codsis,$as_seccion,$ab_ejecutado)
	{
		...
		$arrResultado['ab_ejecutado']=$ab_ejecutado;
