...
class sigesp_ins_c_reprocesar_scg
{
	...
	function uf_redondear_monto_detalles()
	{
		...
		//  Arguments:  
		//	  Returns:  Boolean
		//Description:  Este método redondea a dos cifras el monto de cada detalle de comprobante
		////////////////////////////////////////////////////////////////////////////////////////////////////
		$ls_cadena="";
		...
		if($li_numrow===false)
		{
            $this->io_message->message("CLASE->Reprocesar SCG MÉTODO->uf_redondear_monto_detalles ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			$lb_valido=false;
		}
	...
	function uf_redondear_monto_saldos()
	{
		...
		//  Arguments:  
		//	  Returns:  Boolean
		//Description:  Este método redondea a dos cifras el monto debe y haber de cada cuenta en la tabla saldos
		////////////////////////////////////////////////////////////////////////////////////////////////////
		$ls_cadenadebe="";
		$ls_cadenahaber="";
