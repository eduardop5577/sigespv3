	...
	function uf_print($as_codestpro1, $as_denestpro1)
   	{
		...
		$li_len5 = "";
		$ls_titulo = "";
		$arrResultado = $io_fun_ins->uf_loadmodalidad($li_len1,$li_len2,$li_len3,$li_len4,$li_len5,$ls_titulo);
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_codestpro1 = $io_fun_ins->uf_formato_programatica_detallado($li_len1,$ls_codestpro1);
