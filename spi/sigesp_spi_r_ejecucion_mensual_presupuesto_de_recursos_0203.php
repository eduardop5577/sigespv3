...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPI";
	$ls_ventanas="sigesp_spi_r_ejecucion_mensual_presupuesto_de_recursos_0203.php";
...
<title>SIGESP - Reporte de Ejecución Mensual del Presupuesto de Recursos 0203</title>
...
<table width="605" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="3" align="center">Ejecución Mensual del Presupuesto de Recursos 0203</td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" colspan="3" align="left"><table width="550" height="40" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr class="titulo-celdanew">
          <td height="13" colspan="2"><strong class="titulo-celdanew">Seleccione Mes</strong></td>
        </tr>
        <tr>
          <td width="244" height="21" style="text-align:right">Mes</td>
	...
	if (cmbmes=="s1")
	...
	else
	   {
	     ...
	     if (li_estpreing==1)
		    ...
		    {
			  pagina="reportes/sigesp_spi_rpp_ejecucion_mensual_presupuesto_de_recursos_0203.php?cmbmes="+cmbmes;
			}
	...
	if (cmbmes=="s1")
	...
	else
	   {
	     ...
	     if (li_estpreing==1)
		    ...
		    {
			  pagina="reportes/sigesp_spi_rpp_ejecucion_mensual_presupuesto_de_recursos_0203_excel.php?cmbmes="+cmbmes;
			}
         window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
       }
}
