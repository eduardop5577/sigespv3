...
<table width="798" height="241" border="0" align="center">
  <tr>
    <td height="237"><table width="550" height="272" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      <?php
	   ...
	   <tr height="50" colspan="5">
	     <td height="15" <?php print $ls_mostrar_estruc ?>>&nbsp;</td>
	     <td colspan="4" <?php print $ls_mostrar_estruc ?>>&nbsp;</td>
	     </tr>
    ...
    Manual </td>
      ...
      <tr <?php print $ls_mostrar_estruc ?>>
        <td width="109" height="22" <?php print $ls_mostrar_estruc ?>>&nbsp;</td>
        <td colspan="4" <?php print $ls_mostrar_estruc ?>>&nbsp;</td>
      </tr>
      <tr>
