...
{    
	 ...
	 if ($li_estpreing==1)
		...
		{		  
			$ls_cadena =" SELECT spi_cuentas.*,((previsto+(aumento-disminucion))-devengado) as disponible 
				  FROM spi_cuentas 
...
<script >
  ...
  function ue_search()
  {
	  ...
	  f.action="sigesp_cat_ctasspi.php?codestpro1=+<?php print $ls_codestpro1?>&codestpro2=+<?php print $ls_codestpro2?>+&codestpro3=<?php print $ls_codestpro3?>+&codestpro4=<?php print $ls_codestpro4?>+&codestpro5=<?php print $ls_codestpro5?>+&estcla=<?php print $ls_estcla?>";
