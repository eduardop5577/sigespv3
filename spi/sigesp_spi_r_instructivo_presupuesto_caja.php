...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
 ...
 <?php
	...
	{
		print ('<tr>');
		print ('<td height="20" class="cd-menu"><script type="text/javascript" src="js/menu.js"></script></td>' );
		print ('</tr>');
	}
  ?>  
  <tr>
...
<?php
	...
	if ($ls_valor!='scg')
	{
		print ('<a href="sigespwindow_blank.php"><img src="../shared/imagebank/tools20/salir.gif" title="Salir" alt="Salir" width="20" height="20" border="0"></a>' );	   
	}
	else
	{
		print ('<a href="javascript: close();"><img src="../shared/imagebank/tools20/salir.gif" title="Salir" alt="Salir" width="20" height="20" border="0"></a>' );	
	}
?>
...
<?php 
	...
	else
	{
		...
		{
			print("<script language=JavaScript>");
			print(" location.href='javascript: close();'");
			print("</script>");
		}
	}
	//////////////////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////
