...
***********************************************************************************/
	...
	$io_fun_scg->uf_load_seguridad("SPI","sigesp_spi_r_ejecucion_trimestral.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_reporte = $io_fun_scg->uf_select_config("SPI","REPORTE","ESTADO_RESULTADO","sigesp_scg_rpp_estado_resultado.php","C");
	$ls_reporte="sigesp_scg_rpp_estado_resultado_estpre_consolidado.php";
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno" style="height:35px;border-top:0px;">
  <tr>
    <td height="20" width="25" class="toolbar" style="border-bottom:0px;">
    <div align="center">
    <a href="javascript:ue_imprimir('<?php echo $ls_codemp; ?>','<?php echo $ls_reporte ?>');"><img src="../shared/imagebank/tools20/imprimir.gif" alt="Imprimir" title="Imprimir" width="20" height="20" border="0"></a>
    </div></td>
    <td class="toolbar" width="25"><div align="center"><a href="javascript:ue_openexcel('<?php echo $ls_codemp; ?>');"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" title="Excel" width="20" height="20" border="0"></a></div></td>
...
<input type="hidden" name="jasonest" id="jasonest" value="">
<input type="hidden" name="hidcodemp" id="hidcodemp" value="">
<input type="hidden" name="cmbnivel" id="cmbnivel" value="1">
<?php
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
function ue_imprimir(codemp,as_reporte)
{
	...
	{
		f.setAttribute("action", "reportes/sigesp_scg_rpp_estado_resultado_estpre.php");
		f.setAttribute("target", "_blank");
		//as_reporte = "sigesp_scg_rpp_estado_resultado_estpre.php";
	}
	else
	{
		f.setAttribute("action", "reportes/sigesp_scg_rpp_estado_resultado_estpre_consolidado.php");
		f.setAttribute("target", "_blank");
	...
	f.jasonest.value=cadjson;
	f.hidcodemp.value=codemp;
	li_imprimir=f.imprimir.value;
	if(li_imprimir==0)/// PERMISOS 04OCT18
	{	
		...
		if(hidbot==true)
		{
			...
			{
				f.submit();
				//pagina="reportes/"+as_reporte+"?hidcodemp="+codemp+"&cmbmesdes="+cmbmesdes+"&cmbmeshas="+cmbmeshas+"&cmbagnodes="+cmbagnodes+"&cmbagnohas="+cmbagnohas+"&cmbnivel="+cmbnivel+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&jasonest="+cadjson;
		...
		if(hidbot==false)
		{
			...
			{
				f.submit();
				//pagina="reportes/"+as_reporte+"?hidcodemp="+codemp+"&txtfecdes="+txtfecdes+"&txtfechas="+txtfechas+"&cmbnivel="+cmbnivel+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte+"&jasonest="+cadjson;
...
function ue_openexcel(codemp)
{
	...
	if(document.getElementById('rdodetallado').checked==true)
	{
		f.setAttribute("action", "reportes/sigesp_scg_rpp_estado_resultado_estpre_excel.php");
		f.setAttribute("target", "_blank");
		//as_reporte = "sigesp_scg_rpp_estado_resultado_estpre_excel.php";
	}
	else
	{
		f.setAttribute("action", "reportes/sigesp_scg_rpp_estado_resultado_estpre_excel_consolidado.php");
		f.setAttribute("target", "_blank");
	...
	f.hidcodemp.value=codemp;
	li_imprimir=f.imprimir.value;
	if(li_imprimir==0) /// PERMISOS 05OCT18
	{	
		hidbot = f.hidbot.value;
		//cmbnivel = "1";
		tiporeporte=f.cmbbsf.value;
