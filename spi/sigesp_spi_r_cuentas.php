...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_ingreso->uf_load_seguridad("SPI","sigesp_spi_r_cuentas.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>
  ...
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td colspan="2" align="center" <?php print $ls_mostrar_estruc ?>><div align="left">
        <?php 
      ...
      <td width="298" align="center" <?php print $ls_mostrar_estruc ?>><div align="left">
        <?php 
		  }
		 if($li_estmodest==1)
		 {
    ...
    <tr>
      <td height="13" colspan="2" align="center" <?php print $ls_mostrar_estruc ?>><div align="left">
        <?php 
		  }
		 if($li_estmodest==2)
		 {
      ...
      <td height="13" align="center" <?php print $ls_mostrar_estruc ?>><div align="left">
        <?php 
		 if($li_estmodest==2)
		  {
		?>
