...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_ingreso->uf_load_seguridad("SPI","sigesp_spi_r_acum_x_cuentas.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>
  ...
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr <?php print $ls_mostrar_estruc; ?>>
     	<td <?php print $ls_mostrar_estruc; ?> colspan="2" align="center"><div align="left" >
          <?php 
	   ...
	   ?>
          <table width="275" height="77" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
            <!--DWLayoutTable-->
            <tr class="titulo-celda" <?php print $ls_mostrar_estruc; ?>>
            ...
            <tr class="formato-blanco" <?php print $ls_mostrar_estruc; ?>>
              <td><!--DWLayoutEmptyCell-->&nbsp;</td>
              <td height="20" <?php print $ls_mostrar_estruc ?> >
                <div align="right">
        ...
        <td width="307" align="center" <?php print $ls_mostrar_estruc; ?> ><div align="left">
          <?php 
		  }
		 if($li_estmodest==1)
		 {
    ...
    <tr>
      ...
      <table width="362" height="55" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco" <?php echo $ls_mostrar_estruc; ?>>
        ...
        <tr>
          <td height="21"><div align="center">
            <label>
            <input type="checkbox" name="chkocultarsaldocero" value="1">
            </label>
          Ocultar Saldo Cero </div></td>
        </tr>
      </table>      </td>
    </tr>
    <tr>
...
function ue_showouput()
{
      ...
      if(li_imprimir==1)
      {
		...
		if(f.chkocultarsaldocero.checked==true)
		{
			chkocultarsaldocero = f.chkocultarsaldocero.value;
		} 
		else
		{
			chkocultarsaldocero = 0;
		} 
		...
		{    
	      if(estmodest==1)
	      {
			  ...
			  else
			  {
				if(estpreing==1)
				{
					  pagina = "reportes/"+nomreporte+"?cmbnivel="+cmbnivel+"&saldocero="+chkocultarsaldocero
		  ...
		  {      
			  ...
			  else
			  {
				...
				{ 
					  ...
					  pagina="reportes/sigesp_spi_rpp_acum_x_cuenta.php?cmbnivel="+cmbnivel+"&saldocero="+chkocultarsaldocero
		...
		if(estmodest==1)
		{
			  if(estpreing==1)
				...
				else
				{
				  ...
				  {
					pagina="reportes/sigesp_spi_rpp_acum_x_cuenta_excel.php?cmbnivel="+cmbnivel+"&saldocero="+chkocultarsaldocero
				   +"&cmbmeshas="+cmbmeshas+"&tiporeporte="+ls_tiporeporte+"&checksubniv="+checksubniv+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;
				   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
