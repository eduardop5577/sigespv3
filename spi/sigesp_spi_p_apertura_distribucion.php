...
<form name="form1" method="post" action="">
  ...
  <table width="596" height="368" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="193">
        <div align="left">
          <input name="txtEnero" type="text" class="fd-blanco" id="txtEnero" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')" onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php print $ld_enero ?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly ?>>
</div></td><td colspan="2" class="fd-blanco"><div align="right">Julio</div></td>
      <td><input name="txtJulio" type="text" class="fd-blanco" id="txtJulio" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')"  onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php print $ld_julio?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly ?>>        <div align="right">
        </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="txtFebrero" type="text" class="fd-blanco" id="txtFebrero" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')"  onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php  print $ld_febrero?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly ?>></td>
      <td colspan="2" class="fd-blanco"><div align="right">Agosto</div></td>
      <td><input name="txtAgosto" type="text" class="fd-blanco" id="txtAgosto" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')"  onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php  print $ld_agosto?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly ?>></td>
    </tr>
    <tr>
      <td class="fd-blanco Estilo1">&nbsp;</td>
      <td><span class="Estilo1"></span></td>
    ...
    <tr>
      ...
      <td><input name="txtMarzo" type="text" class="fd-blanco" id="txtMarzo" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')"  onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php print $ld_marzo?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly ?>></td>
      <td colspan="2" class="fd-blanco"><div align="right">Septiembre</div></td>
      <td><input name="txtSeptiembre" type="text" class="fd-blanco" id="txtSeptiembre" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')" onKeyPress='return keyRestrictgrid(event)'onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php print $ld_septiembre?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly ?>></td>
    </tr>
    <tr>
      <td class="fd-blanco Estilo1">&nbsp;</td>
      <td><span class="Estilo1"></span></td>
    ...
    <tr>
      ...
      <td><input name="txtAbril" type="text" class="fd-blanco" id="txtAbril" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')"  onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php print $ld_abril?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly ?>></td>
      <td colspan="2" class="fd-blanco"><div align="right">Octubre</div></td>
      <td><input name="txtOctubre" type="text" class="fd-blanco" id="txtOctubre" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')"  onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php print $ld_octubre?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly ?>></td>
    </tr>
    <tr>
      <td class="fd-blanco Estilo1">&nbsp;</td>
      <td><span class="Estilo1"></span></td>
    ...
    <tr>
      ...
      <td><input name="txtMayo" type="text" class="fd-blanco" id="txtMayo" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')" onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php print $ld_mayo?>" size="25" style="text-align:right" <?php print $ls_readonly ?>></td>
      <td colspan="2" class="fd-blanco"><div align="right">Noviembre</div></td>
      <td><input name="txtNoviembre" type="text" class="fd-blanco" id="txtNoviembre" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')" onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php print $ld_noviembre?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly ?>></td>
    </tr>
    <tr>
      <td class="fd-blanco Estilo1">&nbsp;</td>
      <td><span class="Estilo1"></span></td>
    ...
    <tr>
      ...
      <td><input name="txtJunio" type="text" class="fd-blanco" id="txtJunio" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')" onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php print $ld_junio?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly ?>></td>
      <td colspan="2" class="fd-blanco"><div align="right">Diciembre</div></td>
      <td><input name="txtDiciembre" type="text" class="fd-blanco" id="txtDiciembre" onBlur="uf_actualizar(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')" onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,'<?php echo $_SESSION['la_empresa']['estspidecimal'] ?>')' value="<?php print $ld_diciembre?>" size="25" maxlength="25" style="text-align:right" <?php print $ls_readonly ?>></td>
    </tr>
    <tr>
      <td class="fd-blanco Estilo1">&nbsp;</td>
      <td><span class="Estilo1"></span></td>
    ...
    <tr>
      ...
      <td><input name="txtTotal" type="text" class="fd-blanco" id="txtTotal2"  onKeyPress='return keyRestrictgrid(event)' value="<?php print $ld_total ?>" size="25" maxlength="25" readonly style="text-align:right"></td>
    ...
    <tr>
      <td class="fd-blanco"><div align="right">Previsto</div></td>
      <td><input name="txtPrevisto" type="text" class="fd-blanco" id="txtPrevisto2"  onKeyPress='return keyRestrictgrid(event)' value="<?php print $ld_previsto ?>" size="25" maxlength="25" readonly style="text-align:right"></td>
    </tr>
    <tr>
      <td class="fd-blanco">&nbsp;</td>
      <td>&nbsp;</td>
...
function uf_actualizar(obj,estspidecimal)
{
		f=document.form1;
		/*if(obj.value=="")
		{
