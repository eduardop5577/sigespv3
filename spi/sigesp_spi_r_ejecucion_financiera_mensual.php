...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_ingreso->uf_load_seguridad("SPI","sigesp_spi_r_ejecucion_financiera_mensual.php",$ls_permisos,$la_seguridad,$la_permisos);
  ...
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      ...
      <tr <?php print $ls_mostrar_estruc ?>>
        ...
        <td align="center" <?php print $ls_mostrar_estruc ?>><?php 
		 if($li_estmodest==2)
		  {
		?>
          <table width="275" height="117" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
