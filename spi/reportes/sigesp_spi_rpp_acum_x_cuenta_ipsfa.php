...
//--------------------------------------------------  Parámetros para Filtar el Reporte  ---------------------------------------
		...
		for($j=1;($j<=$li_totfila);$j++)
		{
			...
			$li_tot=$io_report->dts_reporte->getRowCount("spi_cuenta");
				...
				if ($ab_agregar)
				{
					...
					$la_data1[$linroreg]=array('cuenta'=>$ls_spi_cuenta,'denominacion'=>$ls_denominacion,'previsto'=>$ld_previsto,
	...
	$la_data_tot[0]=array('total'=>'<b>TOTAL</b>','previsto'=>$ld_total_previsto,'aumento'=>$ld_total_aumento,
	 ...
	 {
   	    $arrResultado=$io_report->uf_spi_reporte_acumulado_cuentas($ldt_fecini,$ldt_fecfin,$ls_cmbnivel,$lb_subniv,$ai_MenorNivel,$ls_saldocero);
