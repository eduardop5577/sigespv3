...
//--------------------------------------------------  Parámetros para Filtar el Reporte  ---------------------------------------
    ...
    if ($ls_estpreing==1)
	{
		...
		for($j=1;(($j<=$li_totfila)&&($lb_valido));$j++)
		{
		      ...
		      $arrResultado=$io_report->uf_spi_reporte_acumulado_cuentas2($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,
															...
															$ls_cmbnivel,$lb_subniv,$ai_MenorNivel,$ls_modalidad,$cuentamin,$cuentamax,$ls_saldocero);
	...
	{
		$ai_MenorNivel=0;
		$arrResultado=$io_report->uf_spi_reporte_acumulado_cuentas($ldt_fecini,$ldt_fecfin,$ls_cmbnivel,$lb_subniv,$ai_MenorNivel,$cuentamin,$cuentamax,$ls_saldocero);
		$ai_MenorNivel = $arrResultado['ai_MenorNivel'];
		$lb_valido=$arrResultado['lb_valido'];
