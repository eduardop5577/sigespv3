...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		// AGREGADO POR OFIMATICA DE VENEZUELA EL 08/11/2016
		if(file_exists('../../shared/imagebank/logo1.jpg'))
		{
    		$io_pdf->addJpegFromFile('../../shared/imagebank/logo1.jpg',800,550,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo		
		}
		// FIN AGREGADO		
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		$la_data=array(array('cuenta'=>'<b>Cuenta</b>','denominacion'=>'<b>Denominación</b>','previsto'=>'<b>Previsto</b>',
		                     'aumento'=>'<b>Aumento</b>','disminución'=>'<b>Disminución</b>','montoactualizado'=>'<b>Monto Actualizado</b>','devengado'=>'<b>Devengado</b>',
							 'cobrado'=>'<b>Cobrado</b>','cobrado_anticipado'=>'<b>Cobrado Anticipado</b>',
							 'porcobrar'=>'<b>Por Cobrar</b>'));
		
		$la_columna=array('cuenta'=>'','denominacion'=>'','previsto'=>'','aumento'=>'','disminución'=>'','montoactualizado'=>'','devengado'=>'',
		                  'cobrado'=>'','cobrado_anticipado'=>'','porcobrar'=>'');
...
//--------------------------------------------------  Parámetros para Filtar el Reporte  ---------------------------------------
	...
	{
		$lb_valido=$io_report->uf_spi_reporte_acumulado_cuentas($ldt_fecini,$ldt_fecfin,$ls_cmbnivel,$lb_subniv,$ai_MenorNivel,$cuentamin,$cuentamax,$ls_saldocero);
