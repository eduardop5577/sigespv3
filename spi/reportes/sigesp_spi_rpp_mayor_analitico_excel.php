...
***********************************************************************************/
	...
	if($li_estmodest==1)
	{
		...
		else
		{
			...
			{	
				$arrResultado = $io_function_report->uf_spi_reporte_select_min_codestpro1($ls_codestpro1_min,$ls_estclades);
				$ls_codestpro1_min = $arrResultado['as_codestpro1'];
			...
			{	
				$arrResultado = $io_function_report->uf_spi_reporte_select_min_codestpro2($ls_codestpro1_min,$ls_codestpro2_min,$ls_estclades);
				$ls_codestpro2_min = $arrResultado['as_codestpro2'];
				$ls_estclades = $arrResultado['as_estclades'];
				$ls_codestpro1=$ls_codestpro1_min;
			}
			...
			{	
				$arrResultado = $io_function_report->uf_spi_reporte_select_min_codestpro3($ls_codestpro1_min,$ls_codestpro2_min,$ls_codestpro3_min,$ls_estclades);
				$ls_codestpro3_min = $arrResultado['as_codestpro3'];
				$ls_estclades = $arrResultado['as_estclades'];
				$ls_codestpro1=$ls_codestpro1_min;
			}
