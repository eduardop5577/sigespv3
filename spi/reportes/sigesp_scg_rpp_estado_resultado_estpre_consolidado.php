...
/*		global $io_fun_scg;	
	...
	if ($_POST['jasonest']) 	
	{
		//echo $jvariable = $_POST['jasonest']; die;
		$submit = str_replace("\\","",$_POST['jasonest']); 
		//$submit = utf8_decode($submit);
		$json = new Services_JSON;
		$ArJson = $json->decode($submit);	

		 $arreglo=$ArJson->estructuras[0]->codestpro1; 
		 $arreglo=$ArJson->estructuras[1]->codestpro2;
		 $arreglo=$ArJson->estructuras[2]->codestpro3;
	...
	{
		$ls_tiporeporte=$_POST["tiporeporte"];
	}
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  -----------------------------------------
	 $ls_hidbot=$_POST["hidbot"];
	 if($ls_hidbot==true)
	 {
	   $ls_cmbmesdes=$_POST["cmbmesdes"];
	   $ls_cmbagnodes=$_POST["cmbagnodes"];
	   ...
	   $ls_cmbagnohas=$_POST["cmbagnohas"];
