...
class sigesp_spi_class_reportes_instructivos
{
	 ...
	 {		
		...
		if($li_numrows>0)
		{
		     while(!$rs_data->EOF)
			 {
			   ...
			   $arrResultado=$this->uf_spi_ejecutado_trimestral($ls_spi_cuenta,$adt_fecdes,$adt_fechas,$ld_recaudado,$ld_cobrado,$ld_devengado,$ld_aumento,$ld_disminucion);
			   $ld_recaudado = $arrResultado['ad_recaudado'];
			   ...
			   if($lb_valido)
		       {
				   $arrResultado=$this->uf_spi_ejecutado_acumulado($ls_spi_cuenta,$adt_fechas,$ld_recaudado_acumulado,$ld_cobrado_acumulado,$ld_devengado_acumulado,$ld_aumento_acumulado,$ld_disminucion_acumulado);
					$ld_recaudado_acumulado = $arrResultado['ad_recaudado_acumulado'];
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 {
	   $li_total = count((array)$aa_cuentas);
	 ...
	 {		
		...
		if($li_numrows>=0)
		{
			 ...
			 while(!$rs_data->EOF)
			 {
			   ...
			   $arrResultado=$this->uf_spi_ejecutado_trimestral($ls_spi_cuenta,$adt_fecdes,$adt_fechas,$ld_recaudado,$ld_ejecutado,$ld_devengado,$ld_aumento,$ld_disminucion);
			   $ld_recaudado = $arrResultado['ad_recaudado'];
			   $ld_ejecutado = $arrResultado['ad_cobrado'];
			   $ld_devengado = $arrResultado['ad_devengado'];
			   $ld_aumento = $arrResultado['ad_aumento'];
			   $ld_disminucion = $arrResultado['ad_disminucion'];
			   $lb_valido = $arrResultado['lb_valido'];
			   if($lb_valido)
		       {
				   $arrResultado=$this->uf_spi_ejecutado_acumulado($ls_spi_cuenta,$adt_fechas,$ld_recaudado_acumulado,
																$ld_ejecutadoacum,$ld_devengado_acumulado,
																$ld_aumento_acumulado,$ld_disminucion_acumulado);
					$ld_recaudado_acumulado = $arrResultado['ad_recaudado_acumulado'];
					$ld_ejecutadoacum = $arrResultado['ad_cobrado_acumulado'];
					$ld_devengado_acumulado = $arrResultado['ad_devengado_acumulado'];
					$ld_aumento_acumulado =  $arrResultado['ad_aumento_acumulado'];
					$ld_disminucion_acumulado = $arrResultado['ad_disminucion_acumulado'];
					$lb_valido= $arrResultado['lb_valido'];
		...
		if($li_numrows>=0)
		{
			 ...
			 while(!$rs_data->EOF)
			 {
			   ...
			   $arrResultado=$this->uf_spg_ejecutado_trimestral_estado_resultado($ls_spg_cuenta,$adt_fecdes,$adt_fechas,
				...
				$ld_ejecutado = $arrResultado['ad_causado'];
				...
				if($lb_valido)
				{
					   $arrResultado=$this->uf_spg_ejecutado_acumulado_estado_resultado($ls_spg_cuenta,$adt_fechas,$ld_comprometer_acumulado,
																					    ...
																					    $ld_aumento_acumulado,$ld_disminucion_acumulado,false,true);
					 $ld_comprometer_acumulado = $arrResultado['ad_comprometer_acumulado'];
					 $ld_ejecutadoacum = $arrResultado['ad_causado_acumulado'];
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $arrResultado['ad_recaudado']=$ad_recaudado;
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $this->io_sql->free_result($rs_ejecutado_aum);
	 $this->io_sql->free_result($rs_ejecutado_dis);
	 $arrResultado['ad_recaudado_acumulado']=$ad_recaudado_acumulado;
		...
		else
		{
			while(!$rs_data->EOF)
			{
			   ...
			   $ld_resacum       = 0;
			    ...
			    $arrResultado=$this->uf_spi_calcular_programado_trimestre($ls_spi_cuenta,$la_codestpro_desde,$la_codestpro_hasta,$li_trimestre,$ld_programado,$ld_programado_acum);
				$ld_programado =$arrResultado['ad_progtrimestre'];
				$ld_programado_acum = $arrResultado['ad_acumtrimestre'];
				$lb_valido=$arrResultado['lb_valido'];
				if($lb_valido)
				{
			     		  
				 $arrResultado=$this->uf_spi_reporte_calcular_ejecutado_trimestre_estructura($ls_spi_cuenta,$la_codestpro_desde,$la_codestpro_hasta,$li_mesdes,$li_meshas,$ld_aumdisacum,
			                                                                                 $ld_pretriact,$ld_devtriact,$ld_cobtriact,$ld_restriact,$ld_preacum,$ld_devacum,$ld_cobacum,$ld_resacum);
				 $ld_aumdisacum = $arrResultado['ad_aumdisacum'];
				 $ld_pretriact = $arrResultado['ad_pretriact'];
				 $ld_devtriact = $arrResultado['ad_devtriact'];
				 $ld_cobtriact = $arrResultado['ad_cobtriact'];
				 $ld_restriact = $arrResultado['ad_restriact'];
				 $ld_preacum = $arrResultado['ad_preacum'];
				 $ld_devacum = $arrResultado['ad_devacum'];
				 $ld_cobacum = $arrResultado['ad_cobacum'];
				 $ld_resacum = $arrResultado['ad_resacum'];
				 $lb_valido= $arrResultado['lb_valido'];
				}															
			   if($lb_valido)
			   {
		...
		else
		{
			while(!$rs_data->EOF)
			{
			   ...
			   switch ($li_trimestre)
			   {
				...
				$arrResultado=$this->uf_spi_reporte_calcular_ejecutado_trimestre($ls_spi_cuenta,$li_mesdes,$li_meshas,$ld_aumdisacum,
																			     $ld_pretriact,$ld_devtriact,$ld_cobtriact,$ld_restriact,$ld_preacum,$ld_devacum,$ld_cobacum,$ld_resacum);
				 $ld_aumdisacum = $arrResultado['ad_aumdisacum'];
				 $ld_pretriact = $arrResultado['ad_pretriact'];
				 $ld_devtriact = $arrResultado['ad_devtriact'];
...
function uf_spi_reporte_calcular_ejecutado_trimestre($as_spi_cuenta,$ai_mesdes,$ai_meshas,$ad_aumdisacum,$ad_pretriact,$ad_devtriact,$ad_cobtriact,$ad_restriact,$ad_preacum,$ad_devacum,$ad_cobacum,$ad_resacum)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $arrResultado['ad_pretriact']=$ad_pretriact;
	 $arrResultado['ad_devtriact']=$ad_devtriact;
	 $arrResultado['ad_cobtriact']=$ad_cobtriact;
	 $arrResultado['ad_restriact']=$ad_restriact;
	 $arrResultado['ad_preacum']=$ad_preacum;
	 $arrResultado['ad_devacum']=$ad_devacum;
	 $arrResultado['ad_cobacum']=$ad_cobacum;
	 $arrResultado['ad_resacum']=$ad_resacum;
	 $arrResultado['lb_valido']=$lb_valido;
	 return $arrResultado;		
	...
	function uf_spi_reporte_calcular_ejecutado_trimestre_estructura($as_spi_cuenta,$aa_codestpro_desde,$aa_codestpro_hasta,$ai_mesdes,$ai_meshas,$ad_aumdisacum,$ad_pretriact,
																    $ad_devtriact,$ad_cobtriact,$ad_restriact,$ad_preacum,$ad_devacum,$ad_cobacum,$ad_resacum)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    18/05/2008          Fecha última Modificacion :      Hora :
	  ...
	  if((!empty($aa_codestpro_desde[0]))&&(!empty($aa_codestpro_hasta[0])))
	  {
		...
		switch($ls_gestor)
		{
		 ...
		 case 'MYSQLI':   $ls_codestpro="CONCAT(DT.codestpro1,DT.codestpro2,DT.codestpro3,DT.codestpro4,DT.codestpro5,DT.estcla)"; 
						  break;
...
/****************************************************************************************************************************************/	
	...
	{///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $arrResultado['ad_progtrimestre']=$ad_progtrimestre;
	 $arrResultado['ad_acumtrimestre']=$ad_acumtrimestre;
	 $arrResultado['lb_valido']=$lb_valido;
	 return $arrResultado;		
	}
		...
		if($li_numrows>=0)
		{
		     while(!$rs_data->EOF)
			 {
			   ...
			   if($lb_valido)
		       {
				   $arrResultado=$this->uf_spg_ejecutado_acumulado_estado_resultado($ls_spg_cuenta,$adt_fechas,$ld_comprometer_acumulado,
				                                                                 $ld_causado_acumulado,$ld_pagado_acumulado,
																				 $ld_aumento_acumulado,$ld_disminucion_acumulado,$ls_detallar,true);
					 $ld_comprometer_acumulado = $arrResultado['ad_comprometer_acumulado'];
					 $ld_causado_acumulado = $arrResultado['ad_causado_acumulado'];
					 $ld_pagado_acumulado = $arrResultado['ad_pagado_acumulado'];
					 $ld_aumento_acumulado=$arrResultado['ad_aumento_acumulado'];
	...
	{////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 {	
			...
			for($i=2;$i<=57;$i++)
			{
			  ...
			  if($i<=35)
			  {
			   $arrResultado=$this->uf_spi_reportes_ingresos_pres_caja_inst_08($ls_cuenta,$adt_fecdes,$adt_fechas,$as_mesdes,$as_meshas,$lb_detallar,$rs_ingreso);
			   $rs_ingreso = $arrResultado['rs_data'];
			   $lb_valido= $arrResultado['lb_valido'];
			   if(!$rs_ingreso->EOF)
			   {
				 while(!$rs_ingreso->EOF)
				 {
				   ...
				   $ls_denominacion="";
				   $arrResultado=$this->uf_spg_reportes_select_denominacion($ls_spi_cuenta,$ls_denominacion);
				   ...
				   $arrResultado=$this->uf_spi_ejecutado_trimestral($ls_spi_cuenta,$adt_fecdes,$adt_fechas,$ld_recaudado,$ld_cobrado,$ld_devengado,$ld_aumento,$ld_disminucion,$la_cuentas);
				   $ld_recaudado = $arrResultado['ad_recaudado'];
				   $ld_cobrado = $arrResultado['ad_cobrado'];
				   $ld_devengado = $arrResultado['ad_devengado'];
				   $ld_aumento = $arrResultado['ad_aumento'];
				   ...
				   if($lb_valido)
				   {
					   $arrResultado=$this->uf_spi_ejecutado_acumulado($ls_spi_cuenta,$adt_fechas,$ld_recaudado_acumulado,$ld_cobrado_acumulado,$ld_devengado_acumulado,$ld_aumento_acumulado,$ld_disminucion_acumulado,$la_cuentas);
						$ld_recaudado_acumulado = $arrResultado['ad_recaudado_acumulado'];
						$ld_cobrado_acumulado = $arrResultado['ad_cobrado_acumulado'];
						$ld_devengado_acumulado = $arrResultado['ad_devengado_acumulado'];
						$ld_aumento_acumulado =  $arrResultado['ad_aumento_acumulado'];
			   ...
			   {
			    $ls_denominacion="";
			    $arrResultado=$this->uf_spg_reportes_select_denominacion($ls_cuenta,$ls_denominacion);
			    $ls_denominacion=$arrResultado['as_denominacion'];
			    $lb_valido=$arrResultado['lb_valido'];
			    $this->dts_reporte->insertRow("cuenta",$ls_cuenta);
				$this->dts_reporte->insertRow("denominacion",$ls_denominacion);
			  ...
			  else
			  {
			   ...
			   else
			   {
				   ...
				   $arrResultado=$this->uf_spg_reportes_ingresos_pres_caja_inst_08($ls_cuenta,$adt_fecdes,$adt_fechas,$as_mesdes,$as_meshas,$ab_detallar,$rs_gasto);
				   $rs_gasto = $arrResultado['rs_data'];
				   $lb_valido= $arrResultado['lb_valido'];
				   if(!$rs_gasto->EOF)
				   {
					 while(!$rs_gasto->EOF)
					 {
					   ...
					   $ls_denominacion="";
					   $arrResultado=$this->uf_spg_reportes_select_denominacion($ls_spg_cuenta,$ls_denominacion);
					   $ls_denominacion=$arrResultado['as_denominacion'];
					   $lb_valido=$arrResultado['lb_valido'];
					   ...
					   {
						   $arrResultado=$this->uf_spg_ejecutado_acumulado_estado_resultado($ls_spg_cuenta,$adt_fechas,$ld_comprometer_acumulado,
																						 $ld_causado_acumulado,$ld_pagado_acumulado,$ld_aumento_acumulado,$ld_disminucion_acumulado,false,true,$la_cuentas);
							 $ld_comprometer_acumulado = $arrResultado['ad_comprometer_acumulado'];
							 $ld_causado_acumulado = $arrResultado['ad_causado_acumulado'];
							 $ld_pagado_acumulado = $arrResultado['ad_pagado_acumulado'];
							 $ld_aumento_acumulado=$arrResultado['ad_aumento_acumulado'];
...
function uf_spg_reporte_select_saldo_inicial_int_08($as_mesdes,$adt_fecdes,$adt_fechas)
{
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if($as_mesdes != "Enero")
  {
	  ...
	  $li_toting = count((array)$la_cuentas_ingreso);
	  for($i=0;$i<$li_toting;$i++)
	  {
		$arrResultado=$this->uf_spi_ejecutado_acumulado($la_cuentas_ingreso[$i],$ldt_fechas,$ld_recaudado_acumulado,$ld_cobrado_acumulado,$ld_devengado_acumulado,$ld_aumento_acumulado,$ld_disminucion_acumulado);
		$ld_recaudado_acumulado = $arrResultado['ad_recaudado_acumulado'];
		$ld_cobrado_acumulado = $arrResultado['ad_cobrado_acumulado'];
		$ld_devengado_acumulado = $arrResultado['ad_devengado_acumulado'];
		$ld_aumento_acumulado =  $arrResultado['ad_aumento_acumulado'];
	  ...
	  $li_totgas = count((array)$la_cuentas_gasto);
	  for($j=0;$j<$li_totgas;$j++)
	  {
		$arrResultado=$this->uf_spg_ejecutado_acumulado_estado_resultado($la_cuentas_gasto[$j],$ldt_fechas,$ld_comprometer_acumulado,$ld_causado_acumulado,$ld_pagado_acumulado,$ld_aumento_acumulado,$ld_disminucion_acumulado,false,true);
		 $ld_comprometer_acumulado = $arrResultado['ad_comprometer_acumulado'];
		 $ld_causado_acumulado = $arrResultado['ad_causado_acumulado'];
		 $ld_pagado_acumulado = $arrResultado['ad_pagado_acumulado'];
		 $ld_aumento_acumulado=$arrResultado['ad_aumento_acumulado'];
...
/********************************************************************************************************************************/
	...
	/////////////////////////////////////////////////////////////////////////////////
    function uf_spi_reporte_de_ejecucion_mensual_recursos($as_mes,$adt_fecdes,$adt_fechas)
    {
	 $lb_valido = true;	 
	 $ls_sql=" SELECT max(codemp) as codemp, spi_cuenta, max(denominacion) as denominacion,             ".
	         "        max(status) as status, max(sc_cuenta) as sc_cuenta, sum(previsto) as previsto,    ".
	 ...
	 {		
		...
		if($li_numrows>0)
		{
		     while(!$rs_data->EOF)
			 {
			   ...
			   $arrResultado=$this->uf_spi_ejecutado_mensual($ls_spi_cuenta,$adt_fecdes,$adt_fechas);
			   $ld_recaudado = $arrResultado['ad_recaudado'];
			   $ld_cobrado = $arrResultado['ad_cobrado'];
			   $ld_devengado = $arrResultado['ad_devengado'];
			   $ld_aumento = $arrResultado['ad_aumento'];
			   ...
			   if($lb_valido)
		           {
                                $arrResultado=$this->uf_spi_ejecutado_acumulado_mensual($ls_spi_cuenta,$adt_fechas);
                                $ld_recaudado_acumulado = $arrResultado['ad_recaudado_acumulado'];
                                $ld_cobrado_acumulado = $arrResultado['ad_cobrado_acumulado'];
                                $ld_devengado_acumulado = $arrResultado['ad_devengado_acumulado'];
                                $ld_aumento_acumulado =  $arrResultado['ad_aumento_acumulado'];
			   ...
			   $this->dts_reporte->insertRow("aumento_acumulado",$ld_aumento_acumulado);
			   $this->dts_reporte->insertRow("disminucion_acumulado",$ld_disminucion_acumulado);
			   $this->dts_reporte->insertRow("programado_acumulado",$ld_programado_acumulado);
			   $this->dts_reporte->insertRow("recaudado_acumulado",$ld_recaudado_acumulado);
		  	   $this->dts_reporte->insertRow("cobrado_acumulado",$ld_cobrado_acumulado);					 
			   $this->dts_reporte->insertRow("devengado_acumulado",$ld_devengado_acumulado);	
    ...
    //-----------------------------------------------------------------------------------------------------------------------------------
    function uf_spi_ejecutado_mensual($as_spi_cuenta,$adt_fecdes,$adt_fechas)
    {
	 $lb_valido = true;	 
	 $ad_recaudado = 0;
	 $ad_cobrado = 0;
	 ...
	 {
	  $ad_cobrado = $rs_ejecutado_cob->fields["cobrado"];
          $ad_recaudado = $rs_ejecutado_cob->fields["cobrado"];
	 }
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_spi_ejecutado_acumulado_mensual($as_spi_cuenta,$adt_fechas,$aa_cuentas=NULL)
    {
	 $lb_valido = true;
	 $ad_recaudado_acumulado = 0;
	 $ad_cobrado_acumulado = 0;
