...
public function __construct()
{
	...
	$this->in_class_mis=new class_funciones_spi();
				...
				if($li_numrows > 0)
				{
					...
					{ 
						...
						while(!$rs_detconsolidacion->EOF)
						{
							...
							$ls_formato_estructura= $this->in_class_mis->uf_formatoprogramatica($ls_codestpro,$ls_formato_estructura); 
  ...
  *******************************************************************************************************************************/	
	...
	{   
		...
		{  
			...
			$arrResultado = $this->io_int_spi->uf_spi_select_cuenta($arr_cmp["codemp"],$as_cuenta,$ls_status,$ls_denominacion,$ls_sc_cuenta);
