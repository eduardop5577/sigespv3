...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_ingreso->uf_load_seguridad("SPI","sigesp_spi_r_listado_apertura.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>
  ...
  <table width="580" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="289" align="center" <?php print $ls_mostrar_estruc ?> ><div align="left">
        <?php 
		  }
		 if($li_estmodest==1)
		 {
