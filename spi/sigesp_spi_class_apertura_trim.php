                                  ...
                                  $adec_m12,$estprog, $as_cuenta,$adec_asignado,$ai_distribuir)
{
	...
	$arrResultado = $this->int_xspg->uf_spg_select_movimiento($estprog,$as_cuenta,$this->is_procedencia,$this->is_comprobante,"AAP",$ldec_monto_ant,$li_orden,$this->id_fecha);
	$ldec_monto_ant = $arrResultado['adec_monto'];
