...
if($ls_operacion=="GUARDARPRE")
{
	...
	//---------------------------------------------------------------------------------------------------------------------
	$arrResultado=$in_classcmp->uf_spi_saldo_select($dat["codemp"],$ls_cuenta,$ld_previsto,$ld_aumento,$ld_disminucion,$ld_devengado,$ld_cobrado,$ld_cobrado_ant);
	$ld_previsto = $arrResultado['adec_previsto'];
	$ld_aumento = $arrResultado['adec_aumento'];
	$ld_disminucion = $arrResultado['adec_disminucion'];
	$ld_devengado = $arrResultado['adec_devengado'];
	$ld_cobrado = $arrResultado['adec_cobrado'];
	$ld_cobrado_ant = $arrResultado['adec_cobrado_ant'];
...
<table width="583" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  ...
  <tr>
    ...
    <td><input name="txtcuenta" type="text" id="txtcuenta" value="<?php print $ls_cuentaplan ?>" size="22" style="text-align:center" readonly="true"> 
    <a href="javascript:catalogo_cuentasSPI();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Catálogo de Cuentas de Gastos"></a>	 <input name="txtdenominacion" type="text" class="sin-borde" id="txtdenominacion3" style="text-align:left" value="<?php print $ls_denominacion ?>" size="50" maxlength="254"></td>
  </tr>
  <tr>
