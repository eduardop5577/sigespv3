...
<script type="text/javascript" src="js/valida_tecla_grid.js"></script>
...
<table width="798" height="241" border="0" align="center">
  <tr>
    <td height="237"><table width="550" height="230" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr <?php print $ls_mostrar_estruc ?>>
	  <?php
			 $la_empresa =  $_SESSION["la_empresa"];
		  ...
		  ?>
        <td height="22" <?php print $ls_mostrar_estruc ?>><div align="right"><?php print $ls_NomEstPro1;?></div>         </td>
       ...
       <tr class="formato-blanco" <?php print $ls_mostrar_estruc ?>>
    ...
    <?php
	    ...
	    ?>
      <tr <?php print $ls_mostrar_estruc ?>>
        <td height="20"><div align="right" <?php print $ls_mostrar_estruc ?>><?php print $ls_NomEstPro4;?></div></td>
      ...
      <tr <?php print $ls_mostrar_estruc ?>>
        <td height="20"><div align="right" <?php print $ls_mostrar_estruc ?>><?php print $ls_NomEstPro5;?></div></td>
...
{ 
   ...
   { 
      ...
      if($lb_valido)
      {
		   ...
		   if($li_estpreing=='0')
		   {
		   		$arrResultado=$class_aper->uf_spi_load_cuentas_apertura($rs_data);
		   ...
		   {
		   		$arrResultado=$class_aper->uf_spi_load_cuentas_apertura_con_estructuras($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,$ls_estcla,$rs_data);
				$rs_data = $arrResultado['rs_data'];
				$lb_valido = $arrResultado['lb_valido'];
		   }
		   if($lb_valido)
		   {
			  if($row=$SQL->fetch_row($rs_data))
			  {
			   ...
			   {    
					...
					$object[$i][3]="<input type=text name=txtPrevisto".$i." class=sin-borde onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")' onFocus= uf_fila(".$i.") value=$ld_previsto style=text-align:right><input name=enero".$i." type=hidden id=enero".$i." value='$ld_enero'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
									<input name=febrero".$i." type=hidden id=febrero".$i." value='$ld_febrero'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")' >
									<input name=marzo".$i." type=hidden id=marzo".$i." value='$ld_marzo' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
									<input name=abril".$i." type=hidden id=abril".$i." value='$ld_abril' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
									<input name=mayo".$i." type=hidden id=mayo".$i." value='$ld_mayo'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")' >
									<input name=junio".$i." type=hidden id=junio".$i." value='$ld_junio' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
									<input name=julio".$i." type=hidden id=julio".$i." value='$ld_julio' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
									<input name=agosto".$i." type=hidden id=agosto".$i." value='$ld_agosto' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
									<input name=septiembre".$i." type=hidden id=septiembre".$i." value='$ld_septiembre'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")' >
									<input name=octubre".$i." type=hidden id=octubre".$i." value='$ld_octubre' onBlur='uf_formaot(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
									<input name=noviembre".$i." type=hidden id=noviembre".$i." value='$ld_noviembre' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
									<input name=diciembre".$i." type=hidden id=diciembre".$i." value='$ld_diciembre' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>";
			   }//for    
		   ...
		   if($lb_valido)
		   {
			  if($row=$SQL->fetch_row($rs_data))
			  {
			   ...
			   {    
					...
					$object[$i][1]="<input type=text name=txtCuenta".$i." value=$ls_cuenta class=sin-borde size=10 readonly><input name=cuenta".$i." type=hidden id=cuenta value='$ls_cuenta'><input name=distribuir".$i." type=hidden id=distribuir value='$ls_distribuir'>";
					$object[$i][2]="<input type=text name=txtDenominacion".$i." value='$ls_denominacion' size=105 class=sin-borde readonly >";
					$object[$i][3]="<input type=text name=txtPrevisto".$i." onBlur='uf_formato(this)' class=sin-borde onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")' onFocus= uf_fila(".$i.") value=$ld_previsto style=text-align:right>
				                    <input name=marzo".$i." type=hidden id=marzo".$i." value='$ld_marzo' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
									<input name=junio".$i." type=hidden id=junio".$i." value='$ld_junio' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
								    <input name=septiembre".$i." type=hidden id=septiembre".$i." value='$ld_septiembre' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
									<input name=diciembre".$i." type=hidden id=diciembre".$i." value='$ld_diciembre' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>";
...
if ($ls_operacion=="GUARDAR")
{
   ...
   { 
		...
		$object[$i][1]="<input type=text name=txtCuenta".$i." value=$ls_cuenta class=sin-borde size=10 readonly><input name=cuenta".$i." type=hidden id=cuenta value='$ls_cuenta'><input name=distribuir".$i." type=hidden id=distribuir value='$ls_distribuir'>";
		$object[$i][2]="<input type=text name=txtDenominacion".$i." value='$ls_denominacion' size=105 class=sin-borde readonly >";
		$object[$i][3]="<input type=text name=txtPrevisto".$i." class=sin-borde onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")' onFocus= uf_fila(".$i.") value=$ld_previsto style=text-align:right>
		                <input name=enero".$i." type=hidden id=enero".$i." value='$ld_enero' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
						<input name=febrero".$i." type=hidden id=febrero".$i." value='$ld_febrero' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
						<input name=marzo".$i." type=hidden id=marzo".$i." value='$ld_marzo' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
						<input name=abril".$i." type=hidden id=abril".$i." value='$ld_abril'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")' >
						<input name=mayo".$i." type=hidden id=mayo".$i." value='$ld_mayo' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
						...
						<input name=agosto".$i." type=hidden id=agosto".$i." value='$ld_agosto' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
						<input name=septiembre".$i." type=hidden id=septiembre".$i." value='$ld_septiembre'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")' >
						<input name=octubre".$i." type=hidden id=octubre".$i." value='$ld_octubre'onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")' >
						<input name=noviembre".$i." type=hidden id=noviembre".$i." value='$ld_noviembre' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>
						<input name=diciembre".$i." type=hidden id=diciembre".$i." value='$ld_diciembre' onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this,".$_SESSION['la_empresa']['estspidecimal'].")'>";
	 }//for
	 if($lb_valido)
...
function ue_validarcomas_puntos(valor,estspidecimal)
{
	if(estspidecimal==0){
		val = valor.value;
		longitud = val.length;
