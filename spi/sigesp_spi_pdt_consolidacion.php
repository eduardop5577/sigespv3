		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				else
				{
					...
					$li_len4=0;
					$li_len5=0;
					$arrResultado = $in_class_mis->uf_loadmodalidad($li_len1,$li_len2,$li_len3,$li_len4,$li_len5,$ls_titulo);
					...
					while($row=$io_sql2->fetch_row($rs_data2))
					{
						...
						$ls_programatica="";
						$ls_estatus="";
						$ls_programatica = $in_class_mis->uf_formatoprogramatica($ls_codestpro,$ls_programatica);
						switch($ls_estcla)
						{
							case "A":
								$ls_estatus="Acción";
...
<?php
	...
	$in_class_mis=new class_funciones_ingreso();
