...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_ingreso->uf_load_seguridad("SPI","sigesp_spi_r_mayor_analitico.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>
  ...
  <table width="580" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
	   ...
	   ?>
        <table width="275" height="77" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          ...
          <tr class="formato-blanco" <?php print $ls_mostrar_estruc ?>>
            ...
            <td height="20">
              <div align="right" <?php print $ls_mostrar_estruc ?>>
      ...
      <td width="321" align="center" <?php print $ls_mostrar_estruc ?>><div align="left">
        <?php 
		  }
		 if($li_estmodest==1)
		 {
    ...
    <tr>
      ...
      <td align="center" <?php print $ls_mostrar_estruc ?>><div align="left">
        <?php 
		 if($li_estmodest==2)
		  {
		?>
