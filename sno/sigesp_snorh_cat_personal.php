	...
	function uf_print($as_codper, $as_cedper, $as_nomper, $as_apeper, $as_numexp, $as_codnom, $as_tipo)
   	{
		...
		$ls_sql="SELECT sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.dirper, ".
				...
				"       sno_personal.fecreingper, sno_personal.fecjubper, sno_personal.codunivipladin,  sno_personal.diasserprevper, ".
				"       sno_personal.situacion, sno_personal.fecsitu, sno_personal.talcamper, sno_personal.talzapper, sno_personal.codcarpat, sno_personal.sercarpat, ".
				"       sno_personal.talpanper,  sno_personal.anoservprecont, sno_personal.anoservprefijo, sno_personal.codorg, sno_personal.codunivipladin,sno_personal.contraorg, sno_personal.tienedis, sno_personal.coreleins, ".
				"		sno_personal.desdis, sno_personal.nrocardis,  ".
				"       sno_personal.porcajahoper, sno_personal.codger, sno_personal.anoperobr,sno_personal.carantper,sno_personal.rifper,sno_personal.messervpreper,sno_personal.preaviso,".
		...
		if($as_tipo=="asignacion")
		{
			...
			$ls_liqnom=$_SESSION["la_nomina"]["nomliq"];
			$ls_repetidos=$io_sno->uf_select_config("SNO","CONFIG","NOPERMITIR_REPETIDOS","1","C");
			if ($ls_liqnom=='1')
			{
				$ls_sql=$ls_sql."  AND sno_personal.estper = '3' ";
			}
			else
			{
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				$as_preaviso2=$rs_data->fields["preaviso"];
				switch ($as_preaviso)
				{
					case "-":
						$as_preaviso="-";
				...
				$ls_codcarpat=$rs_data->fields["codcarpat"];
				$ls_sercarpat=$rs_data->fields["sercarpat"];
				$li_diasserprev=$rs_data->fields["diasserprevper"];
				$ls_contraorg=$rs_data->fields["contraorg"];
				$ls_tienedis=$rs_data->fields["tienedis"];
				$ls_coreleins=$rs_data->fields["coreleins"];
				$ls_desdis=$rs_data->fields["desdis"];
				$ls_nrocardis=$rs_data->fields["nrocardis"];
				switch ($as_tipo)
				{
					case "":
						...
						print "'$ls_codtippersss','$ls_dentippersss','$ld_fecreingper','$ld_fecjubper','$ls_codunivipladin','$ls_denunivipladin',";
						print "'$ls_enviorec','$ls_fecleypen','$ls_codcausa','$ls_situacion','$ls_fecsitu','$ls_talcamper','$ls_talpanper','$ls_talzapper',";
						print "'$ls_anoprevcont','$ls_anoprevfijo','$ls_codorg','$ls_desorg','$li_porcajahoper','$ls_codger', '$ls_denger','$li_anoperobr',";
						print "'$ls_carantper','$ls_tipperrif','$ls_numpririf','$ls_numterrif','$messerprev','$as_preaviso','$ls_codcarpat','$ls_sercarpat',";
						print "'$li_diasserprev','$ls_contraorg','$ls_tienedis','$ls_coreleins','$ls_desdis','$ls_nrocardis');\">";
					...
					case "egreso":
						...
						print "'$ls_obsegrper','$ls_estper','$ld_fecingper','$ld_fecnacper','$ls_codcausa','$as_preaviso2');\">".$ls_codper."</a></td>";
						print "<td>".$ls_cedper."</td>";
						print "<td>".$ls_nomper."  ".$ls_apeper."</td>";
						print "<td>".$ls_tipperrif."-".$ls_numpririf."-".$ls_numterrif."</td>";
						print "<td>".$ls_estper."</td>";
...
function aceptar(codper,cedper,nomper,apeper,dirper,fecnacper,edocivper,telhabper,telmovper,sexper,estaper,pesper,codpro,
				 ...
				 anoperobr, carantper,tipperrif,numpririf,numterrif,jmesserprev,preaviso,codcarpat,sercarpat,diasserprev,
				 contraorg,tienedis,coreleins,desdis,nrocardis)
{
	...
	opener.document.form1.txtpreaviso.value=preaviso;
	opener.document.form1.txtcoreleins.value=coreleins;
	if(contraorg=="1")
	{
		opener.document.form1.chkcontraorg.checked=true;		 
	}
	else
	{
		opener.document.form1.chkcontraorg.checked=false;
	}
	if(tienedis=="1")
	{
		opener.document.form1.chktienedis.checked=true;		 
		opener.document.form1.txtdesdis.value=desdis;
		opener.document.form1.txtnrocardis.value=nrocardis;
	}
	else
	{
		opener.document.form1.chktienedis.checked=false;
		opener.document.form1.txtdesdis.value="";
		opener.document.form1.txtnrocardis.value="";
	}
	...
	opener.document.form1.btnenfermedad.disabled=false;
	...
	opener.document.form1.txtcodcarpat.value=codcarpat;
	opener.document.form1.txtsercarpat.value=sercarpat;
    opener.document.form1.txtdiasserprev.value=diasserprev;
	opener.document.form1.existe.value="TRUE";
	close();
}

function aceptaregreso(codper,nomper,apeper,fecegrper,cauegrper,obsegrper,estper,fecingper,fecnacper,codcausa,preaviso)
{
	opener.document.form1.txtcodper.value=codper;
	opener.document.form1.txtcodper.readOnly=true;
	...
	opener.document.form1.txtfecnacper.value=fecnacper;	
	opener.document.form1.txtcodcausa.value=codcausa;
	opener.document.form1.cmbpreaviso.value=preaviso;
