...
***********************************************************************************/
   ...
   function uf_print($as_codper, $as_cedper, $as_nomper, $as_apeper, $as_numexp, $as_tipo, $ai_subnomina, $as_codnom)
   {
		...
		{
			$ls_criterio="   AND cat_personalnomina.codnom = '".$as_codnom."' ";
			$ls_criterio=$ls_criterio."   AND cat_personalnomina.estencper = '0' ";
		}
		elseif($as_tipo=="encargaduria")
		{
			$ls_criterio="   AND cat_personalnomina.codnom = '".$ls_codnom."' ";
			$ls_criterio=$ls_criterio."   AND cat_personalnomina.estencper = '0' ";
		}
		elseif($as_tipo=="catencargaduria2")
		{
			$ls_criterio=" AND cat_personalnomina.codemp = sno_encargaduria.codemp";
			$ls_criterio=$ls_criterio."   AND cat_personalnomina.codper = sno_encargaduria.codperenc ";
			$ls_criterio=$ls_criterio."   AND cat_personalnomina.codnom = sno_encargaduria.codnomperenc ";
		}
		else
		{
			$ls_criterio="   AND cat_personalnomina.codnom = '".$ls_codnom."' ";
		...
		if ($li_nomliq=='1')
		{
			$ls_estatus=" AND cat_personalnomina.estper = '3' "; 
		}
		else
		{
			$ls_estatus=" AND cat_personalnomina.estper = '1' ";
		}
		...
		print "</tr>";
		$ls_sql="SELECT * ".
                        "  FROM cat_personalnomina ".
			" WHERE cat_personalnomina.codemp = '".$ls_codemp."'".
                        $ls_criterio.				
                        "   AND cat_personalnomina.codper like '".$as_codper."' ".
                        "   AND cat_personalnomina.cedper like '".$as_cedper."' ".
                        "   AND cat_personalnomina.nomper like '".$as_nomper."' ".
                        "   AND cat_personalnomina.apeper like '".$as_apeper."' ".
                        "   AND cat_personalnomina.numexpper like '".$as_numexp."' ".
                        $ls_estatus;
		   ...
		   ($as_tipo=="vacacionhas")||($as_tipo=="personaproyecto"))
		{
			...
			$ls_sql=$ls_sql."	AND cat_personalnomina.staper = '1' ";
		}		
		elseif (($as_tipo=="encargaduria")||($as_tipo=="encargado"))
		{
			$ls_sql=$ls_sql."	AND cat_personalnomina.staper <> '3'  ";
		}
		$ls_sql=$ls_sql." ORDER BY cat_personalnomina.codper ";
				 ...
				 coddep, dendep, tippen, fecvid, prirem, segrem,salnorper, estencper,fecegrper,fecsusper,codger)
{
	...
	else
	{
		if((opener.document.form1.rac.value=="1")&&(opener.document.form1.racobrnom.value=="0"))
		{
			...
			opener.document.form1.txtcodasicarant.value=codasicar;
	...
	if((opener.document.form1.rac.value=="1")&&(opener.document.form1.codunirac.value=="1"))
	{
	    ...
	    opener.document.form1.txtcoduniracant.value=codunirac;
	}
