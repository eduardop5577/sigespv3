	...
	function uf_print($as_codasicar, $as_denasicar, $as_tipo)
   	{
		...
		$ls_sql="SELECT sno_asignacioncargo.codasicar, sno_asignacioncargo.denasicar, sno_asignacioncargo.claasicar, ".
				...
				"		sno_dedicacion.desded, sno_tipopersonal.destipper, sno_unidadadmin.desuniadm,sno_unidadadmin.estcla,sno_nomina.racobrnom, ".
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				$ls_codest4="";
				$ls_codest5="";
				$arrResultado=$io_fun_nomina->uf_formato_estructura($ls_codproasicar,$ls_codest1,$ls_codest2,$ls_codest3,$ls_codest4,$ls_codest5);
				...
				switch ($as_tipo)
				{
					case "":
						...
						print "'$ls_gradobr','$ls_suemin','$ls_tipnom','$ls_rac','$ls_racobrnom');\">".$ls_codasicar."</a></td>";
    ...
    <table width="500" border="0" cellpadding="1" cellspacing="0" class="formato-blanco" align="center">
      <tr>
        ...
        <td width="431"><div align="left">
          <input name="txtcodasicar" type="text" id="txtcodasicar" size="30" maxlength="10" onKeyPress="javascript: ue_mostrar(this,event);">        
        </div></td>
      </tr>
      <tr>
...
function aceptar(codasicar,denasicar,coduniadm,claasicar,codtab,codpas,codgra,codded,codtipper,numvacasicar,numocuasicar,
				 ...
				 denestpro1,denestpro2,denestpro3,denestpro4,denestpro5,estcla,disponasicar,codnom, gradobr, suemin,tipnom,rac,racobrnom)
{
	...
	else if (((tipnom=="3")||(tipnom=="4"))&&(rac==1)&&(racobrnom==0))
	{
		opener.document.form1.txtcodtab.value=codtab;
		opener.document.form1.txtcodtab.readOnly=true;	
		opener.document.form1.txtcodpas.value=codpas;
