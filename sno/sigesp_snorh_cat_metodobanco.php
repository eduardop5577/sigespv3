...
***********************************************************************************/
   ...
   function uf_print($as_codmet, $as_desmet, $as_tipo)
   {
		...
		print "<td width=150>Método</td>";
		print "<td width=200>Entidad Bancaria</td>";
		print "<td width=100>Tipo</td>";
		print "</tr>";
		$ls_sql="SELECT codemp, codmet, desmet, tipmet, codempnom, tipcuecrenom, tipcuedebnom, numplalph, numconlph, suclph, ".
				...
				"		debcuelph, codagelph, apaposlph, numconnom, pagtaqnom, nroref, entbanmet ".
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					...
					case "replisban":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarreplisban('$ls_codmet','$ls_desmet','$ls_pagtaqnom','$ls_ref','$ls_codempnom');\">".$ls_codmet."</a></td>";
						print "<td>".$ls_desmet."</td>";
						print "<td>".$ls_entbanmet."</td>";
						print "<td>".$ls_metodo."</td>";
						print "</tr>";		
...
function aceptarreplisban(codmet,desmet,pagtaqnom,ref,codempnom)
{
	opener.document.form1.txtcodmet.value=codmet;
	opener.document.form1.txtcodmet.readOnly=true;
    opener.document.form1.txtdesmet.value=desmet;
