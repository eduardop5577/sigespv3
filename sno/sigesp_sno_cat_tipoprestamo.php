			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					case "":
						...
						print "<td><a href=\"javascript: aceptar('$ls_codtippre','$ls_destippre');\">".$ls_codtippre."</a></td>";
					...
					case "prestamo":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarprestamo('$ls_codtippre','$ls_destippre');\">".$ls_codtippre."</a></td>";
						print "<td>".$ls_destippre."</td>";
						print "</tr>";			
						break;
...
function ue_search(existe)
{
	f=document.form1;
  	...
  	f.action="sigesp_sno_cat_tipoprestamo.php?tipo=<?PHP print $ls_tipo;?>";
  	f.submit();
}
</script>
</html>