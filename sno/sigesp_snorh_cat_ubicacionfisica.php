...
***********************************************************************************/
   ...
   function uf_print($as_codubifis, $as_desubifis, $as_tipo)
   {
		...
		print "</tr>";
		$ls_sql="SELECT codubifis, desubifis, codpai, codest, codmun, codpar, dirubifis, tietras, codtipesc,  ".
				"		(SELECT dentipesc FROM sno_tipoescuela ".
				"		  WHERE sno_tipoescuela.codemp = sno_ubicacionfisica.codemp ".
				"		    AND sno_tipoescuela.codtipesc = sno_ubicacionfisica.codtipesc ) AS dentipesc, ".
			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					case "":
						...
						print "'$ls_codest','$ls_desest','$ls_codmun','$ls_desmun','$ls_codpar','$ls_despar','$ls_dirubifis','$li_tietras','$ls_codtipesc','$ls_dentipesc');\">".$ls_codubifis."</a></td>";
					...
					case "mintrasdesde":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarmintrasdesde('$ls_codubifis');\">".$ls_codubifis."</a></td>";
						print "<td>".$ls_desubifis."</td>";
						print "</tr>";			
						break;
					...
					case "mintrashasta":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarmintrashasta('$ls_codubifis');\">".$ls_codubifis."</a></td>";
						print "<td>".$ls_desubifis."</td>";
						print "</tr>";			
						break;
					...
					case "recubigeodes":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptaubigeodesde('$ls_codubifis');\">".$ls_codubifis."</a></td>";
						print "<td>".$ls_desubifis."</td>";
						print "</tr>";			
						break;
					...
					case "recubigeohas":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarubigeohasta('$ls_codubifis');\">".$ls_codubifis."</a></td>";
						print "<td>".$ls_desubifis."</td>";
						print "</tr>";			
						break;
					...
					case "reparcdes":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarecarcdesde('$ls_codubifis');\">".$ls_codubifis."</a></td>";
						print "<td>".$ls_desubifis."</td>";
						print "</tr>";			
						break;
					...
					case "reparchas":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarecarchasta('$ls_codubifis');\">".$ls_codubifis."</a></td>";
						print "<td>".$ls_desubifis."</td>";
						print "</tr>";			
						break;
				}
...
<script >
function aceptar(codubifis,desubifis,codpai,despai,codest,desest,codmun,desmun,codpar,despar,dirubifis,tietras,codtipesc,dentipesc)
{
...
function aceptarmintrasdesde(codubifis)
{
	opener.document.form1.txtcodubifisdes.value=codubifis;
	opener.document.form1.txtcodubifisdes.readOnly=true;
	opener.document.form1.txtcodubifishas.value=codubifis;
	opener.document.form1.txtcodubifishas.readOnly=true;
	close();
}

function aceptarmintrashasta(codubifis)
{
	opener.document.form1.txtcodubifishas.value=codubifis;
	opener.document.form1.txtcodubifishas.readOnly=true;
	close();
...
function aceptaubigeodesde(codubifis)
{
	opener.document.form1.txtubigeodes.value=codubifis;
	opener.document.form1.txtubigeodes.readOnly=true;
	opener.document.form1.txtubigeohas.value=codubifis;
	opener.document.form1.txtubigeohas.readOnly=true;
	close();
}

function aceptarubigeohasta(codubifis)
{
	opener.document.form1.txtubigeohas.value=codubifis;
	opener.document.form1.txtubigeohas.readOnly=true;
	close();
...
function aceptarecarcdesde(codubifis)
{
	opener.document.form1.txtcodubifisdes.value=codubifis;
	opener.document.form1.txtcodubifisdes.readOnly=true;
	opener.document.form1.txtcodubifishas.value=codubifis;
...
function aceptarecarchasta(codubifis)
{
	opener.document.form1.txtcodubifishas.value=codubifis;
	opener.document.form1.txtcodubifishas.readOnly=true;
	close();
