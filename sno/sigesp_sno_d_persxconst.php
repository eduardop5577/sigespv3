...
***********************************************************************************/
   ...
   session_start();
	...
	$la_seguridad = Array();
	$la_permisos = Array();	
	$arrResultado=$io_fun_nomina->uf_load_seguridad_nomina("SNO","sigesp_sno_d_persxconst.php",$ls_codnom,$ls_permisos,$la_seguridad,$la_permisos);
	...
	switch ($ls_operacion) 
	{
		...
		case "GUARDAR":
			...
			if($lb_valido)
			{
				...
				$arrResultado=$io_constante->uf_load_constantes_x_personal($ls_codper,$li_totrows,$lo_object);
