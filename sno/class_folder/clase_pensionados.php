...
class pensionados
{
	...
	{	
		global $ruta;
		if(!$ruta){$ruta = '../';}
		require_once($ruta."base/librerias/php/general/sigesp_lib_include.php");
		$io_include=new sigesp_include();
		$io_conexion=$io_include->uf_conectar();
		//$io_conexion_saman=$io_include->uf_conectar_otra_bd('localhost', 'postgres', 'adminsigesp','db_saman_2009','POSTGRES');
		require_once($ruta."base/librerias/php/general/sigesp_lib_sql.php");
		...
		require_once($ruta."base/librerias/php/general/sigesp_lib_funciones2.php");
