...
***********************************************************************************/
   ...
   function uf_print($as_codigo, $as_denominacion, $as_tipo)
   {
		...
		$ls_sql="SELECT codemp,minorguniadm,ofiuniadm,uniuniadm,coduniadmibs,depuniadm,prouniadm,desuniadm,codestpro1, codestpro2, codestpro3, codestpro4, codestpro5,estcla, ".
				"		(SELECT denestpro1 ".
				"		   FROM spg_ep1 ".
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				$coduniadmibs=$rs_data->fields["coduniadmibs"];
				...
				switch($as_tipo)
				{
					case "": // Se hace el llamado desde sigesp_snorh_d_uni_adm.php
						...
						print "<td align=center><a href=\"javascript: aceptar('$codigo','$denominacion','$coduniadmibs','$ls_codest1',";
					...
					case "reprecpagdes": // Se hace el llamado desde sigesp_sno_r_recibopago.php
						print "<tr class=celdas-blancas>";
						print "<td align=center><a href=\"javascript: aceptarreprecpagdes('$ls_minorguniadm','$ls_ofiuniadm',";
						print "'$ls_uniuniadm','$ls_depuniadm','$ls_prouniadm','$denominacion');\">".$codigo."</a></td>";
						print "<td>".$denominacion."</td>";
						print "<td align=center>".$ls_codprouniadm."</td>";
						print "<td>".$ls_estclatipo."</td>";
					...
					case "reprecpaghas": // Se hace el llamado desde sigesp_sno_r_recibopago.php
						print "<tr class=celdas-blancas>";
						print "<td align=center><a href=\"javascript: aceptarreprecpaghas('$ls_minorguniadm','$ls_ofiuniadm',";
						print "'$ls_uniuniadm','$ls_depuniadm','$ls_prouniadm','$denominacion');\">".$codigo."</a></td>";
						print "<td>".$denominacion."</td>";
						print "<td align=center>".$ls_codprouniadm."</td>";
						print "<td>".$ls_estclatipo."</td>";
					...
					case "reparcdes": // Se hace el llamado desde sigesp_snorh_r_unidadadministrativa.php
						print "<tr class=celdas-blancas>";
						print "<td align=center><a href=\"javascript: aceptarreparcdesde('$ls_minorguniadm','$ls_ofiuniadm',";
						print "'$ls_uniuniadm','$ls_depuniadm','$ls_prouniadm');\">".$codigo."</a></td>";
						print "<td>".$denominacion."</td>";
						print "<td align=center>".$ls_codprouniadm."</td>";
						print "<td>".$ls_estclatipo."</td>";
					...
					case "reparchas": // Se hace el llamado desde sigesp_snorh_r_unidadadministrativa.php
						print "<tr class=celdas-blancas>";
						print "<td align=center><a href=\"javascript: aceptarreparchasta('$ls_minorguniadm','$ls_ofiuniadm',";
						print "'$ls_uniuniadm','$ls_depuniadm','$ls_prouniadm');\">".$codigo."</a></td>";
						print "<td>".$denominacion."</td>";
						print "<td align=center>".$ls_codprouniadm."</td>";
						print "<td>".$ls_estclatipo."</td>";
...
<script >
  function aceptar(codigo,deno,coduniadmibs,codest1,codest2,codest3,codest4,codest5,denestpro1,denestpro2,denestpro3,denestpro4,denestpro5,estcla)
  {
    ...
    opener.document.form1.txtcoduniadmibs.value=coduniadmibs;
  ...
  function aceptarreprecpagdes(ministerio,oficina,unidad,departamento,programa,desuniadm)
  {
  ...
  function aceptarreprecpaghas(ministerio,oficina,unidad,departamento,programa,desuniadm)
  {
  ...
  function aceptarreparcdesde(ministerio,oficina,unidad,departamento,programa)
  {
        opener.document.form1.txtcoduniadmdes.value=ministerio+"-"+oficina+"-"+unidad+"-"+departamento+"-"+programa;
        opener.document.form1.txtcoduniadmdes.readOnly=true;
        opener.document.form1.txtcoduniadmhas.value=ministerio+"-"+oficina+"-"+unidad+"-"+departamento+"-"+programa;
  ...
  function aceptarreparchasta(ministerio,oficina,unidad,departamento,programa)
  {
	if(opener.document.form1.txtcoduniadmdes.value<=ministerio+"-"+oficina+"-"+unidad+"-"+departamento+"-"+programa)
	{
		opener.document.form1.txtcoduniadmhas.value=ministerio+"-"+oficina+"-"+unidad+"-"+departamento+"-"+programa;
