...
class sigesp_snorh_c_programacionreporte
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------	
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------
	function uf_insert_programacionreporte0205($as_reporte)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_insert_programacionreporte0205
		//		   Access: public (sigesp_snorh_p_programacionreporte)
		//	    Arguments: as_reporte  // código del Reporte
		//				   ai_totrows  // total de filas del detalle
		//				   ao_object  // objetos del detalle
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Programación Reporte MÉTODO->uf_insert_programacionreporte0205 ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$ls_codigo="";
		...
		return $lb_valido;
	}// end function uf_insert_programacionreporte0205
	//-----------------------------------------------------------------------------------------------------------------------------------	
