...
***********************************************************************************/
	...
	$la_seguridad = Array();
	$la_permisos = Array();	
	$arrResultado=$io_fun_nomina->uf_load_seguridad("SNR","sigesp_snorh_d_entes.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<script  type="text/JavaScript" src="js/sigesp_sno_js_d_entes.js"></script>
<script  type="text/JavaScript" src="../shared/js/js_ajax.js"></script>
<script  src="../shared/js/sigesp_js.js"></script>
