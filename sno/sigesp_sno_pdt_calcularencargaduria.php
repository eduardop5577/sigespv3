			...
			else
			{
				...
				while((!$rs_data->EOF)&&($lb_valido))
				{
					...
					if ($lb_valido)
					{
						...
						$arrResultado=$io_evaluador->uf_evaluar($as_codper,$ls_forcon,$ld_valcon);
						...
						$arrResultado=$io_calenc->uf_buscar_concepto_encargado($as_codperenc, $ls_codcon,$ld_valconenc);
