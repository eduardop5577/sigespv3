		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					...
					case "ajustartabulador":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarajustartabulador('$ls_codtab','$ls_destab');\">".$ls_codtab."</a></td>";
						print "<td>".$ls_destab."</td>";
						print "</tr>";
						break;
				}
...
function aceptarajustartabulador(codtab,destab)
{
    opener.document.form1.txtcodtab.value=codtab;
    opener.document.form1.txtcodtab.readOnly=true;
    opener.document.form1.txtdestab.value=destab;
    ...
    opener.document.form1.action="sigesp_sno_p_ajustartabulador.php";
    opener.document.form1.submit();	
    close();
}
