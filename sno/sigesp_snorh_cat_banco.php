		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					...
					case "config":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarconfig('$ls_codban','$ls_nomban');\">".$ls_codban."</a></td>";
						print "<td>".$ls_nomban."</td>";
						print "</tr>";			
						break;
					...
					case "pagdirche":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarpagdirche('$ls_codban','$ls_nomban');\">".$ls_codban."</a></td>";
						print "<td>".$ls_nomban."</td>";
						print "</tr>";			
						break;
...
function aceptarconfig(codban,nomban)
{
	opener.document.form1.txtcodban.value=codban;
	opener.document.form1.txtcodban.readOnly=true;
	opener.document.form1.txtdenban.value=nomban;
	opener.document.form1.txtdenban.readOnly=true;

	close();
}

function aceptarpagdirche(codban,nomban)
{
	opener.document.form1.txtcodbanperche.value=codban;
	opener.document.form1.txtcodbanperche.readOnly=true;
	opener.document.form1.txtdenbanperche.value=nomban;
	opener.document.form1.txtdenbanperche.readOnly=true;
