...
***********************************************************************************/
	...
	$la_seguridad = Array();
	$la_permisos = Array();	
	$arrResultado=$io_fun_nomina->uf_load_seguridad_nomina("SNO","sigesp_sno_p_hajustarcontabilizacion.php",$ls_codnom,$ls_permisos,$la_seguridad,$la_permisos);
...
<?php 
	...
	switch ($ls_operacion) 
	{
		case "PROCESAR":
			...
			$ls_statusg=0;
			$ls_statusi=0;
			$arrResultado=$io_ajustar->uf_validarcierre_gastos_ingreso($ls_statusg,$ls_statusi);
