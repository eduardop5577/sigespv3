...
***********************************************************************************/
   ...
   //--------------------------------------------------------------
   function uf_print($as_codpai, $as_codest, $as_codmun, $as_desmun, $as_tipo)
   {
		//////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_print
		//		   Access: public
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch($as_tipo)
				{
					...
					case "PERSONAL":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarpersonal('$ls_codmun','$ls_desmun');\">".$ls_codmun."</a></td>";
						print "<td>".$ls_desmun."</td>";
						print "</tr>";			
					break;
				}
...
<?php
	...
	if($ls_operacion=="BUSCAR")
	{
		...
		uf_print($ls_codpai,$ls_codest,$ls_codmun, $ls_desmun, $ls_tipo);
	}
	else
	{
...
{
	opener.document.form1.txtcodmunper.value=codigo;
	opener.document.form1.txtcodmunper.readOnly=true;
    opener.document.form1.txtdesmunper.value=descripcion;
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="sigesp_snorh_cat_municipio.php?tipo=<?php print $ls_tipo;?>";
  	f.submit();
}
</script>
</html>
