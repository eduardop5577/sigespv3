			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					case "":
						...
						print "<td><a href=\"javascript: aceptar('$ls_codarch','$ls_denarch');\">".$ls_codarch."</a></td>";
						print "<td>".$ls_denarch."</td>";
						print "<td>Prestamos</td>";
						
						print "</tr>";
						break;
					case "IMPORTAR":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarimportar('$ls_codarch','$ls_denarch');\">".$ls_codarch."</a></td>";
						print "<td>".$ls_denarch."</td>";
						print "<td>Prestamos</td>";
						print "</tr>";
						break;
...
<html>
<head>
<title>Cat&aacute;logo de Archivos txt para Pr&eacute;stamos</title>
...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" height="20" colspan="2" class="titulo-ventana">Cat&aacute;logo de Archivos txt para Pr&eacute;stamos </td>
    </tr>
  </table>
<br>
...
<script >
function aceptar(codarch,denarch)
{
	...
	opener.document.form1.action="sigesp_snorh_d_archivostxtprestamos.php";
	opener.document.form1.existe.value="TRUE";			
	opener.document.form1.submit();	
	close();
}

function aceptarimportar(codarch,denarch)
{
	opener.document.form1.txtcodarch.value=codarch;
	opener.document.form1.txtcodarch.readOnly=true;
	opener.document.form1.txtdenarch.value=denarch;
