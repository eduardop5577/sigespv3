...
<html>
<head>
<title>Cat&aacute;logo de Concepto  x Persona</title>
  ...
  <p align="center">
    <input name="operacion" type="hidden" id="operacion">
  	 ...
  	 <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    	<tr>
     	 	<td width="500" colspan="2" class="titulo-ventana">Cat&aacute;logo de Concepto x Personal</td>
    	</tr>
	 </table>
	 <br>
...
function ue_search()
{
	...
	f.action="sigesp_sno_cat_persxconce.php";
	f.submit();
}
</script>
</html>