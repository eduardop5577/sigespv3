...
***********************************************************************************/
	...
	$la_seguridad = Array();
	$la_permisos = Array();	
	$arrResultado=$io_fun_nomina->uf_load_seguridad_nomina("SNO","sigesp_sno_p_abrir_periodo.php",$ls_codnom,$ls_permisos,$la_seguridad,$la_permisos);
...
<?php
	...
	{
		case "NUEVO":
		 	$arrResultado=$io_cierreperiodo->uf_select_periodo_anterior($li_totrows,$lo_object); 
			$li_totrows=$arrResultado['ai_totrows'];
			$lo_object=$arrResultado['ao_object'];
			$lb_valido=$arrResultado['lb_valido'];
			$_SESSION["ABRIENDO_PERIODO"]=false;
			break;

		case "ABRIR_PERIODO":
			if (!$_SESSION["ABRIENDO_PERIODO"])
			{
				$_SESSION["ABRIENDO_PERIODO"]=true;
