...
***********************************************************************************/
	...
	$la_seguridad = Array();
	$la_permisos = Array();	
	$arrResultado=$io_fun_nomina->uf_load_seguridad("SNR","sigesp_snorh_d_uni_ad.php",$ls_permisos,$la_seguridad,$la_permisos);
   ...
   function uf_limpiarvariables()
   {
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   		global $ls_codigo,$ls_denominacion,$ls_coduniadmibs,$ls_modalidad,$ls_nomestpro1,$ls_nomestpro2,$ls_nomestpro3,$ls_nomestpro4,$ls_nomestpro5;
   ...
   function uf_load_variables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		global $ls_codigo,$ls_denominacion,$ls_coduniadmibs,$ls_modalidad,$ls_codestpro1,$ls_denestpro1,$ls_codestpro2,$ls_denestpro2,$ls_codestpro3;
		global $ls_denestpro3,$ls_codestpro4,$ls_denestpro4,$ls_codestpro5,$ls_denestpro5,$ls_codpro;
		global $ls_estcla;
		
		$ls_codigo=$_POST["txtcodigo"];
		$ls_denominacion=$_POST["txtdenominacion"];
		$ls_coduniadmibs=$_POST["txtcoduniadmibs"];
...
<?php
	...
	switch ($ls_operacion) 
	{
		case "NUEVO":		
			$ls_statusg=0;
		    $ls_statusi=0;
		    $arrResultado=$io_unidadadm->uf_validarcierre_gastos_ingreso($ls_statusg,$ls_statusi);
			$ls_statusg=$arrResultado['as_statusg'];
			$ls_statusi=$arrResultado['as_statusi'];
		...
		case "GUARDAR":
		    ...
		    {
				uf_load_variables();			
				$lb_valido=$io_unidadadm->uf_guardar($lb_existe,$ls_codigo,$ls_denominacion,$ls_coduniadmibs,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,
      ...
      <tr>
        <td>
		  ...
		  <table width="650" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
              ...
              <tr>
                <td height="22"><div align="right" >
                    C&oacute;digo de Unidad Administrativa IBS
                </div></td>
                <td ><div align="left" >
                  <input name="txtcoduniadmibs" type="text" id="txtcoduniadmibs" value="<?php print $ls_coduniadmibs; ?>" size="16" maxlength="3" onKeyUp="javascript: ue_validarnumero(this);" onBlur="javascript: ue_rellenarcampo(this,3);">
                </div></td>
              </tr>
              <tr>
                <td height="22">&nbsp;</td>
