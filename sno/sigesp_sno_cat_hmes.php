...
***********************************************************************************/
   ...
   function uf_print($as_tipo,$as_codnom,$as_codnomhas)
   {
		...
		if (($as_tipo=="garantia")||($as_tipo=="garantia_seguro"))
		{
			$ls_sql="SELECT DISTINCT sno_hperiodo.anocur, substr(cast(sno_hperiodo.fecdesper as char(10)),6,2) as mes ".
					" FROM sno_hperiodo, sno_hnomina, sno_periodo ".
					" WHERE sno_hnomina.espnom='0' ".
					" AND sno_periodo.cerper= 1 ".
					" AND sno_hperiodo.anocur||substr(cast(sno_hperiodo.fecdesper as char(10)),6,2) >='201205'  ".
					" AND sno_hperiodo.codemp=sno_hnomina.codemp ".
					" AND sno_hperiodo.codemp=sno_periodo.codemp ".
					" AND sno_hperiodo.codnom=sno_periodo.codnom ".
					" AND sno_hperiodo.codperi=sno_periodo.codperi ";	
		...
		if (($as_tipo=="replisintdesde")||($as_tipo=="replisinthasta")||($as_tipo=="replispreantint"))
		{
			if ($as_codnomhas<>'')
			{
				$criterio = "   AND codnom>='".$as_codnom."' ".
			...
			$ls_sql="SELECT DISTINCT anocurper as anocur, mescurper as mes".
		...
		elseif  (($as_tipo=="replisintdesde")||($as_tipo=="replisinthasta")||($as_tipo=="replispreantint"))
		{
			$ls_sql=$ls_sql." ORDER BY anocur, mes ";
		}
		...
		elseif (($as_tipo=="garantia")||($as_tipo=="garantia_seguro"))
		{
			$ls_sql=$ls_sql." GROUP BY sno_hperiodo.anocur,sno_hperiodo.fecdesper ORDER BY sno_hperiodo.anocur  ";
		}
		else
		{
			$ls_sql=$ls_sql." GROUP BY sno_hperiodo.anocur, sno_hperiodo.fechasper ".
		...
		if(($as_tipo=="repapopatdes")||($as_tipo=="repapopathas")||($as_tipo=="replisperracrecdes")||($as_tipo=="replisperracrechas")||($as_tipo=="repdedplan"))
		{
			$ls_sql="SELECT DISTINCT sno_hperiodo.anocur, substr(cast(sno_hperiodo.fecdesper as char(10)),6,2) as mes ".
					"  FROM sno_hperiodo, sno_hnomina, sno_periodo  ".
					" WHERE sno_hnomina.codnom>='".$as_codnom."' ".
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					...
					case "reppermintra":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarreppermintra('$ls_anocur','$ls_mes','$ls_desmes');\">".$ls_anocur."</a></td>";
						print "<td>".$ls_mes."</td>";
						print "<td>".$ls_desmes."</td>";
						print "</tr>";			
						break;
						
					case "garantia": // sigesp_snorh_p_fideicomiso
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptar_garantia('$ls_anocur','$ls_mes','$ls_desmes');\">".$ls_anocur."</a></td>";
						print "<td>".$ls_desmes."</td>";
						print "</tr>";			
						break;
					
					case "garantia_seguro": // sigesp_snorh_p_fideicomiso
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptar_garantia_seguro('$ls_anocur','$ls_mes','$ls_desmes');\">".$ls_anocur."</a></td>";
						print "<td>".$ls_desmes."</td>";
						print "</tr>";			
						break;
					...
					case "repdedplan":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarrepdedplan('$ls_anocur','$ls_mes');\">".$ls_anocur."</a></td>";
						print "<td>".$ls_mes."</td>";
						print "<td>".$ls_desmes."</td>";
						print "</tr>";			
						break;
					...
					case "replisintdesde":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarreplisintdesde('$ls_anocur','$ls_mes','$ls_desmes');\">".$ls_anocur."</a></td>";
						print "<td>".$ls_mes."</td>";
						print "<td>".$ls_desmes."</td>";
						print "</tr>";			
						break;
					...
					case "replisinthasta":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarreplisinthasta('$ls_anocur','$ls_mes','$ls_desmes');\">".$ls_anocur."</a></td>";
						print "<td>".$ls_mes."</td>";
						print "<td>".$ls_desmes."</td>";
						print "</tr>";			
						break;
...
function aceptarreppermintra(anocur,mescurper,desmes)
{
	opener.document.form1.txtanocurper.value=anocur;
	opener.document.form1.txtanocurper.readOnly=true;
	opener.document.form1.txtmescurper.value=mescurper;
...
function aceptar_garantia(anocur,mescurper,desmes)
{
	opener.document.form1.txtanocurper.value=anocur;
	opener.document.form1.txtanocurper.readOnly=true;
	opener.document.form1.txtmescurper.value=mescurper;
...
function aceptar_garantia_seguro(anocur,mescurper,desmes)
{
	opener.document.form1.txtanocurper.value=anocur+" - "+mescurper;
	opener.document.form1.txtanocurper.readOnly=true;
	opener.document.form1.txtdesmesper.value=desmes;
	opener.document.form1.txtdesmesper.readOnly=true;
	close();
}
function aceptarrepdedplan(anocur,mescurper)
{
	opener.document.form1.txtanocur.value=anocur;
	opener.document.form1.txtanocur.readOnly=true;
	opener.document.form1.txtmescur.value=mescurper;
	opener.document.form1.txtmescur.readOnly=true;
	close();
}

function aceptarreplisintdesde(anocur,mescurper,desmes)
{
	opener.document.form1.txtanocurperdes.value=anocur;
	opener.document.form1.txtanocurperdes.readOnly=true;
	opener.document.form1.txtmescurperdes.value=mescurper;
...
function aceptarreplisinthasta(anocur,mescurper,desmes)
{
	opener.document.form1.txtanocurperhas.value=anocur;
	opener.document.form1.txtanocurperhas.readOnly=true;
	opener.document.form1.txtmescurperhas.value=mescurper;
