...
***********************************************************************************/
   ...
   function uf_print($as_codper,$as_stavac)
   {
		...
		$ls_sql="SELECT sno_vacacpersonal.codper, sno_vacacpersonal.codvac, sno_vacacpersonal.fecvenvac, sno_vacacpersonal.fecdisvac, ".
				...
				"		sno_vacacpersonal.cod_5, sno_vacacpersonal.nro_dias_5, sno_vacacpersonal.Monto_5, sno_vacacpersonal.permisos,".
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				$ls_permisosvac=$rs_data->fields["permisos"];
				...
				print "'$li_diavaccal','$li_candiaadi','$ls_permisosvac');\">".$li_codvac."</a></td>";
...
function aceptar(codvac,fecvenvac,fecdisvac,fecreivac,diavac,stavac,sueintbonvac,sueintvac,diabonvac,obsvac,diapenvac,persalvac,
				...
				pagpersal,profueper,diavaccal,candiaadi,permisosvac)
{
	...
	opener.document.form1.txtpermisosvac.value=permisosvac;
