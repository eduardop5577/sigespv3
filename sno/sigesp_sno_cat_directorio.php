...
***********************************************************************************/
   ...
   function uf_print($as_ruta)
   {
		...
		while (false!==$file = readdir($handle))
		{
			 if(($file != '.') && ($file != '..'))
			 {
			 	if(($file!="accord_ticket.xls")&&($file!="accord_tarjeta.xls")&&($file!="valeven_ticket.xls")&&($file!="sodexho_tarjeta.xls")&&($file!="sodexho_ticket.xls")&&($file!="valeven_tarjeta.xls")&&($file!="todoticket_tarjeta.xls")&&($file!=".svn")&&($file!="casapropia.xls")&&($file!="fps_bancoagricolavenezuela.xls")&&($file!="bicentenario.xls")&&($file!="tesoro.xls")&&($file!="sodexho_tarjeta_esp.xls")&&($file!="cestaticket_electronico.xls")&&($file!="bancodeltesoro.xls")&&($file!="bancoagricola.xls")&&($file!="bod.xls"))
				{
					print "<tr>";
