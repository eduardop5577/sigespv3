			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					case "":
						...
						print "'$li_marinfcont','$li_marsupcont','$ls_titcont','$li_tamletpiecont','$ls_arcrtfcont','$ls_consumcont');\">".$ls_codcont."</a></td>";
...
<script >
function aceptar(codigo,descripcion,letra,interlineado,marinfcont,marsupcont,titcont,tamletpiecont,arcrtfcont,consumcont)
{
	f=document.form1;
	...
	opener.document.form1.txtconsumcont.value=consumcont;
