...
***********************************************************************************/
   ...
   //--------------------------------------------------------------
   function uf_print($as_codper,$as_codenf, $as_desenf, $as_tipo)
   {
		//////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_print
		//		   Access: public
		...
		print "</tr>";
		$ls_sql="SELECT sno_personalenfermedad.codenf, sno_enfermedad.desenf, sno_personalenfermedad.observacion ".
				"  FROM sno_personalenfermedad, sno_enfermedad ".
				" WHERE sno_personalenfermedad.codemp='".$ls_codemp."'".
				"   AND sno_enfermedad.codenf like '".$as_codenf."'".
				"   AND sno_enfermedad.desenf like '".$as_desenf."'".
		        ...
		        " ORDER BY sno_personalenfermedad.codenf ";
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				$ls_observacion=$rs_data->fields["observacion"];
				switch ($as_tipo)
				{
					case "": 
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptar('$ls_codenf','$ls_desenf','$ls_observacion');\">".$ls_codenf."</a></td>";
...
<?php
	...
	if($ls_operacion=="BUSCAR")
	{
		...
		uf_print($ls_codper, $ls_codenf, $ls_desenf, $ls_tipo);
	}
	else
	{
...
function aceptar(codenf,desenf,observacion)
{
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="sigesp_snorh_cat_personalenfermedad.php";
  	f.submit();
}
</script>
</html>
