		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch($ls_metodo)
				{
					...
					case "16":
				  		$metodo="Sodexo Tarjeta Esp";
						break;
						
					case "17":
				  		$metodo="Banco Venezuela Electronico";
						break;
					
					case "18":
				  		$metodo="Accord Tarjeta Decimal";
						break;
						
					case "19":
				  		$metodo="Accord Ticket Multivalor Decimal";
						break;
						
					case "20":
				  		$metodo="Banco Bicentenario";
						break;
						
					case "21":
				  		$metodo="Sodexho Decimal";
						break;
						
					case "22":
				  		$metodo="Cestatickets Electronico";
						break;
						
					case "23":
				  		$metodo="Banco Del Tesoro";
						break;
						
					case "24":
				  		$metodo="Banco Venezuela Electronico_2";
						break;
						
					case "25":
				  		$metodo="Banco Agricola";
						break;
						
					case "26":
				  		$metodo="Valeven Ticket Decimal";
						break;
						
					case "27":
				  		$metodo="Valeven Tarjeta Decimal";
						break;
				}
				switch($as_tipo)
				{
					case "":
						...
						print "'$ls_codcli','$ls_codprod','$ls_punent','$ld_valdes','$ls_nrotarjeta');\">".$codigo."</a></td>";
...
<script >
function aceptar(codigo,deno,valor,metodo,codcli,codprod,punent,valdes,nrotarjeta)
{
	...
	opener.document.form1.txtnrotarjeta.value=nrotarjeta;	
