...
***********************************************************************************/
	...
	function uf_insert_seguridad($as_titulo,$as_rango)
	{
		...
		$ls_descripcion="Generó el Reporte ".$as_titulo.". Para ".$as_rango." ";
	...
	function uf_print_encabezado_pagina($as_titulo,$as_rango,$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,720,11,$as_rango); // Agregar el título
	...
	function uf_print_cabecera($as_codnom,$as_desnom,$io_pdf)
	{
		...
		$io_pdf->addText(55,695,11,'<b>Nómina</b>  '.$as_codnom.' - '.$as_desnom.''); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		global $io_pdf;
		$io_pdf->ezSety(688);
		$la_columnas=array('periodo'=>'<b>Período</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('periodo'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'desde'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'hasta'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'cerrada'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'nomina'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($ai_total,$io_pdf)
	{
		...
		global $io_pdf;
		global $ls_bolivares;
		$la_data=array(array('name'=>'<b>Monto Total de la Nómina '.$ls_bolivares.'</b>','total'=>$ai_total));
	...
	$ls_titulo="<b>Resumen de Nómina</b>";
