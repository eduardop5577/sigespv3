...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,950,11,$as_titulo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo2);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,940,11,$as_titulo2); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(11,$as_periodo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,930,11,$as_periodo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(10,$as_desnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,920,10,$as_desnom); // Agregar el título
	...
	function uf_print_detalle_presupuesto($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('programatica'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'estadisticos'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
	...
	function uf_print_pie_cabecera_contable($ai_debe,$ai_haber,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('name'=>array('justification'=>'right','width'=>340), // Justificación y ancho de la columna
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$la_data[5]=array('firma1'=>'___________________________','firma2'=>'___________________________','firma3'=>'___________________________');
		$la_data[6]=array('firma1'=>'ELABORADO POR','firma2'=>'REVISADO POR','firma3'=>'AUTORIZADO POR');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>600, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('firma1'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'firma2'=>array('justification'=>'center','width'=>275),
						 			   'firma3'=>array('justification'=>'center','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.3,2.5,3,3); // Configuración de los margenes en centímetros 3.3,2.5,3,3
