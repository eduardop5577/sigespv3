...
***********************************************************************************/
	...
	else // Imprimimos el reporte
	{
		...
		$lo_hoja->set_column(17,17,40);
		$lo_hoja->set_column(18,18,10);
		$lo_hoja->set_column(19,19,10);
		...
		$lo_hoja->write(4, 15, "Subnómina",$lo_titulo);
		$lo_hoja->write(4, 16, "Dedicación",$lo_titulo);
		$lo_hoja->write(4, 17, "Tipo de Personal",$lo_titulo);
		$lo_hoja->write(4, 18, "Paso",$lo_titulo);
		$lo_hoja->write(4, 19, "Grado",$lo_titulo);
		$li_col=19;
		...
		while(!$io_report->rs_data->EOF)
		{
			...
			$lo_hoja->write($li_row, 15, $ls_dessubnom, $lo_dataleft);
			$lo_hoja->write($li_row, 16, $ls_desded, $lo_dataleft);
			$lo_hoja->write($li_row, 17, $ls_destipper, $lo_dataleft);
			$lo_hoja->write($li_row, 18, $ls_codpas, $lo_dataleft);
			$lo_hoja->write($li_row, 19, $ls_codgra, $lo_dataleft);
			$li_col=19;
