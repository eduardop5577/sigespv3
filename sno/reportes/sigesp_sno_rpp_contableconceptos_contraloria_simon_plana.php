...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$io_pdf->line(60,90,140,90);
		$io_pdf->addText(65,80,7,"JEFE DE RECURSOS"); // Agregar el título
		$io_pdf->addText(80,70,7,"HUMANOS"); // Agregar el título
		$io_pdf->line(180,90,270,90);
		$io_pdf->addText(200,80,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->line(300,90,380,90);
		$io_pdf->addText(310,80,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->line(410,90,535,90);
		$io_pdf->addText(420,80,7,"ADMINISTRACION Y SERVICIOS"); // Agregar el título
		//$io_pdf->line(460,90,570,90);
		//$io_pdf->addText(470,80,7,"CONTRALORA MUNICIPAL"); // Agregar el título
		$io_pdf->line(50,40,555,40);
