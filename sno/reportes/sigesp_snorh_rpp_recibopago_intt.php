...
***********************************************************************************/
	...
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,$io_cabecera,$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-12);
		$la_data=array(array('nombre'=>'<b>Apellidos y Nombres:</b>', 'cedula'=>'<b>Cédula:</b>', 'cargo'=>'<b>Cargo:</b>' ));
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_codusu,$io_pdf)
	{
		...
		$io_pdf->addText(40,440,10,$as_codusu);
		$io_pdf->addText(500,440,10,date("d/m/Y"));
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_pie_cabecera2($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_codusu,$io_pdf)
	{
		...
		$io_pdf->addText(40,22,10,$as_codusu);
		$io_pdf->addText(500,22,10,date("d/m/Y"));
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_piepagina,'all');
		$io_pdf->stopObject($io_piepagina); // Detener el objeto pie de página
