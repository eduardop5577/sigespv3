...
***********************************************************************************/
	...
	function uf_firmas($io_pdf)
	{
		...
		$io_pdf->saveState();
		// cuadro inferior
         $io_pdf->Rectangle(25,35,550,85); 
		$io_pdf->line(25,105,575,105);	//HORIZONTAL	
		$io_pdf->addText(110,110,8,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(115,40,8,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->line(300,35,300,120);	//VERTICAL	
                $io_pdf->addText(320,110,8,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(390,110,8,"DIRECCION DE GESTION HUMANA"); // Agregar el título
                $io_pdf->addText(400,40,8,"FIRMA Y SELLO"); // Agregar el título
                $io_pdf->line(25,50,575,50);	//HORIZONTAL	
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezStartPageNumbers(550,770,10,'','',1); // Insertar el número de página
