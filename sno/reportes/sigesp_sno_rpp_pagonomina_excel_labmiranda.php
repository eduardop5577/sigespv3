	...
	else // Imprimimos el reporte
	{
		...
		if($lb_valido)
		{
			...
			while(!$io_report->rs_data_detalle->EOF)
			{
				...
				$ls_nomcon=$io_report->rs_data_detalle->fields["nomcon"]."   ".$io_report->rs_data_detalle->fields["cueprecon"];
				$li_col++;
		...
		if($lb_valido)
		{
			...
			{
				$ls_codconc=$io_report->rs_data_detalle->fields["codconc"];
				$ls_nomcon=$io_report->rs_data_detalle->fields["nomcon"]."   ".$io_report->rs_data_detalle->fields["cueconcon"];
				$li_col++;
				$lo_hoja->set_column($li_col,$li_col,20);
				$lo_hoja->write(4, $li_col, $ls_nomcon,$lo_titulo);
				$io_report->DS_detalle2->insertRow("codconc",$ls_codconc);
		...
		if($lb_valido)
		{
			...
			{
				$ls_codconc=$io_report->rs_data_detalle->fields["codconc"];
				$ls_nomcon=$io_report->rs_data_detalle->fields["nomcon"]."   ".$io_report->rs_data_detalle->fields["cueconpatcon"];
				$li_col++;
				$lo_hoja->set_column($li_col,$li_col,20);
				$lo_hoja->write(4, $li_col, $ls_nomcon,$lo_titulo);
			...
			{
				$ls_codconc=$io_report->rs_data_detalle->fields["codconc"];
				$ls_nomcon=$io_report->rs_data_detalle->fields["nomcon"]."   ".$io_report->rs_data_detalle->fields["cueprepatcon"];
				$li_col++;
				$lo_hoja->set_column($li_col,$li_col,20);
				$lo_hoja->write(4, $li_col, $ls_nomcon,$lo_titulo);
