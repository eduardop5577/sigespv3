...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecha,$io_pdf)
	{
		...
		// Fecha Creación: 06/07/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $ls_rifente,$ls_dirente,$io_pdf,$ls_telente;
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,660,13,$as_titulo); // Agregar el título
		$io_pdf->addText(50,680,10,$ls_rifente); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(11,"REPUBLICA BOLIVARIANA DE VENEZUELA");
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,735,10,"REPUBLICA BOLIVARIANA DE VENEZUELA"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(11,"CONSEJO DEL MUNICIPIO BANIRAS");
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,720,10,"CONSEJO DEL MUNICIPIO BANIRAS"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(11,"DIRECCION TALENTO HUMANO");
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,705,10,"DIRECCION TALENTO HUMANO"); // Agregar el título
		if($as_fecha=="1")
		{
			$io_pdf->addText(512,750,8,date("d/m/Y")); // Agregar la Fecha
			$io_pdf->addText(518,743,7,date("h:i a")); // Agregar la Hora
		}
		$li_tm=$io_pdf->getTextWidth(9,$ls_dirente." Telef.: ".$ls_telente);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,30,9,$ls_dirente." Telef.: ".$ls_telente); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	$ls_rifente=$_SESSION["la_empresa"]["rifemp"];
	$ls_dirente=$_SESSION["la_empresa"]["direccion"];
	$ls_telente=$_SESSION["la_empresa"]["telemp"];
