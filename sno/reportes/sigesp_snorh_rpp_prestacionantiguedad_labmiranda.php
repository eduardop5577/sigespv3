...
***********************************************************************************/
	...
	function uf_print_cabecera($io_pdf,$as_sueint)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('periodo'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
						 			   ...
						 			   'dias'=>array('justification'=>'center','width'=>25), // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			$ls_dias=($io_report->DS->data["diafid"][$li_i]+$io_report->DS->data["diaadi"][$li_i]);
			...
			$la_data[$li_i]=array('periodo'=>$ls_periodo,'cedula'=>$ls_cedper,'nombre'=>$ls_nomper,'dias'=>$ls_dias,'sueldointegral'=>$li_sueintper,
