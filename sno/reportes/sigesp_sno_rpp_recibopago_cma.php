...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(9,$as_periodo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,350,9,$as_periodo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(9,$as_desnom);
		$tm=306-($li_tm/2);
	...
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_descar,$io_cabecera,$io_pdf)
	{
		...
		global $io_pdf,$io_cabecera;
		$io_pdf->saveState();
		$io_pdf->addText(40,325,'10','______________________________________________________________________________________________');
		$io_pdf->ezSetDy(-125);
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'Cédula:', 'cargo'=>'Cargo:' ));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>220), // Justificación y ancho de la columna
						 			   ...
						 			   'cargo'=>array('justification'=>'left','width'=>260))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(40,314,'10','______________________________________________________________________________________________');
		$la_data=array(array('nombre'=>$as_nomper, 'cedula'=>$as_cedper, 'cargo'=>substr($as_descar,0,100)));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
						 			   ...
						 			   'valordedu'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,286,'10','______________________________________________________________________________________________');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_cabecera,'all');
	}// end function uf_print_cabecera
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$ls_ctnom,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($ls_ctnom=="1")
		{
			$li_tm=$io_pdf->getTextWidth(6,"Este pago no genera incidencia salarial alguna, y en consecuencia no podrán efectuarse deducciones sobre éste, salvo las que expresamente autorice el trabajador para la adquisición");
			$tm=306-($li_tm/2);
			$io_pdf->addText($tm,440,6,"Este pago no genera incidencia salarial alguna, y en consecuencia no podrán efectuarse deducciones sobre éste, salvo las que expresamente autorice el trabajador para la adquisición"); // Agregar el título
			$li_tm=$io_pdf->getTextWidth(6,"de bienes y servicios en el marco de los programas y misiones sociales para la satisfacción de sus necesidades. (Art. 3º Decreto Nº 27 Publicado en Gaceta Oficial");
			$tm=306-($li_tm/2);
			$io_pdf->addText($tm,432,6,"de bienes y servicios en el marco de los programas y misiones sociales para la satisfacción de sus necesidades. (Art. 3º Decreto Nº 27 Publicado en Gaceta Oficial"); // Agregar el título
			$li_tm=$io_pdf->getTextWidth(6,"Extraordinaria Nº 6.296 de fecha 02/05/2017)");
			$tm=306-($li_tm/2);
			$io_pdf->addText($tm,424,6,"Extraordinaria Nº 6.296 de fecha 02/05/2017)"); // Agregar el título
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera2($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$ls_ctnom,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>250), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>250))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,78,'10','------------------------------------------------------------------------------------------------------------------------------------------------------------');
		if($ls_ctnom=="1")
		{
			$li_tm=$io_pdf->getTextWidth(6,"Este pago no genera incidencia salarial alguna, y en consecuencia no podrán efectuarse deducciones sobre éste, salvo las que expresamente autorice el trabajador para la adquisición");
			$tm=306-($li_tm/2);
			$io_pdf->addText($tm,70,6,"Este pago no genera incidencia salarial alguna, y en consecuencia no podrán efectuarse deducciones sobre éste, salvo las que expresamente autorice el trabajador para la adquisición"); // Agregar el título
			$li_tm=$io_pdf->getTextWidth(6,"de bienes y servicios en el marco de los programas y misiones sociales para la satisfacción de sus necesidades. (Art. 3º Decreto Nº 27 Publicado en Gaceta Oficial");
			$tm=306-($li_tm/2);
			$io_pdf->addText($tm,62,6,"de bienes y servicios en el marco de los programas y misiones sociales para la satisfacción de sus necesidades. (Art. 3º Decreto Nº 27 Publicado en Gaceta Oficial"); // Agregar el título
			$li_tm=$io_pdf->getTextWidth(6,"Extraordinaria Nº 6.296 de fecha 02/05/2017)");
			$tm=306-($li_tm/2);
			$io_pdf->addText($tm,54,6,"Extraordinaria Nº 6.296 de fecha 02/05/2017)"); // Agregar el título
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			$ls_ctnom=$io_report->rs_data->fields["ctnom"];
			...
			if($lb_valido)
			{
				...
				if($li_reg==1)
				{
					uf_print_pie_cabecera1($li_toting,$li_totded,$li_totnet,$ls_codcueban,$ls_ctnom,$io_pdf); // Imprimimos pie de la cabecera
				}
				else
				{
					uf_print_pie_cabecera2($li_toting,$li_totded,$li_totnet,$ls_codcueban,$ls_ctnom,$io_pdf); // Imprimimos pie de la cabecera
				}
				unset($la_data_a);
				unset($la_data_d);
				unset($la_data);
