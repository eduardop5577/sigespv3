...
***********************************************************************************/
	...
	function uf_print_pie_cabecera($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$la_data[0]=array('gerente'=>'','espacio2'=>'','personal'=>'');
		$la_data[1]=array('gerente'=>'____________________________________','espacio2'=>'','personal'=>'____________________________________');
		$la_data[2]=array('gerente'=>'GERENTE DE RECURSOS HUMANOS','espacio2'=>'','personal'=>'RECIBI CONFORME');
		$la_columna=array('gerente'=>'','espacio2'=>'','personal'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 7,  // Tamaño de Letras de los títulos
						 'showLines'=>0, // Mostrar Líneas
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('gerente'=>array('justification'=>'center','width'=>200),
						 		 	   'espacio2'=>array('justification'=>'center','width'=>100),
						 		 	   'personal'=>array('justification'=>'center','width'=>200))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);		
		$io_pdf->restoreState();
		$io_pdf->closeObject();
