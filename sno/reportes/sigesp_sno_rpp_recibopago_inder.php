...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_inder.JPG',50,690,90,90); // Agregar Logo
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_inder.JPG',50,280,90,90); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=306-($li_tm/2);
	...
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,$io_cabecera,$as_gerencia,$ad_fechaingreso,$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-11);
		$la_data=array(array('cargo'=>'<b>CARGO</b>', 'departamento'=>'<b>UNIDAD</b>' ,'fecha'=>'<b>FECHA DE INGRESO</b>' ));
		$la_columna=array('cargo'=>'','departamento'=>'', 'fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cargo'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
									   'departamento'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
									   'fecha'=>array('justification'=>'left','width'=>200))); // Justificación y ancho de la columna
		...
		$la_data=array(array('cargo'=>substr($as_descar,0,40), 'departamento'=>substr($as_gerencia,0,40),'fecha'=>$ad_fechaingreso));
		$la_columna=array('cargo'=>'','departamento'=>'', 'fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
						 ...
						 'cols'=>array('cargo'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
									   ...
									   'fecha'=>array('justification'=>'left','width'=>200))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);		
		$io_pdf->addText(40,670,'10','______________________________________________________________________________________________');
		$io_pdf->addText(40,660,'10','______________________________________________________________________________________________');
		$io_pdf->ezSetY(660);
		$la_data=array(array('cedula'=>'<b>CEDULA</b>', 'nombre'=>'<b>NOMBRES Y APELLIDOS</b>'));
		$la_columna=array('cedula'=>'','nombre'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>0, // Mostrar Líneas
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$la_data=array(array('cedula'=>$as_cedper,'nombre'=>$as_nomper));
		$la_columna=array('cedula'=>'','nombre'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
						 'fontSize' => 8, // Tamaño de Letras
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(40,630,'10','______________________________________________________________________________________________');
		$io_pdf->addText(40,620,'10','______________________________________________________________________________________________');
		$io_pdf->ezSetY(618);
		...
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,606,'10','______________________________________________________________________________________________');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->addText(40,480,'10','______________________________________________________________________________________________');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>170), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>110), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,465,'10','______________________________________________________________________________________________');
		$io_pdf->addText(40,453,'10','______________________________________________________________________________________________');
		$io_pdf->ezSety(453);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>50, // Orientación de la tabla
						 'cols'=>array('neto'=>array('justification'=>'right','width'=>250))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,437,'10','______________________________________________________________________________________________');
		$io_pdf->ezSety(435);
		$la_data=array(array('cuenta'=>'<b>TIPO DE PAGO</b>  '.'CUENTA BANCARIA', 'neto'=>'<b>CUENTA N°  </b>'.$as_codcueban));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>273, // Orientación de la tabla
		...
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,420,'10','______________________________________________________________________________________________');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
