...
***********************************************************************************/
	...
	function uf_print_cabecera($io_pdf)
	{
        ...
        $io_pdf->filledRectangle(51,680,500,$io_pdf->getFontHeight(18));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nro'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'personal'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'asignacion'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'aporte'=>array('justification'=>'center','width'=>70))); // Justificación y ancho de la columna
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_piecabecera($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,$ai_personal,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data=array(array('titulo'=>'<b>Totales '.$ls_bolivares.'</b>','personal'=>$ai_personal,'asignacion'=>$ai_totasi,'deduccion'=>$ai_totded,'aporte'=>$ai_totapo));
		$la_columna=array('titulo'=>'','personal'=>'','asignacion'=>'','deduccion'=>'','aporte'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
						 ...
						 'maxWidth'=>470, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>230),
						 			   'personal'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'aporte'=>array('justification'=>'right','width'=>70))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
	...
	function uf_print_firmas($io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_pdf;
		$la_data[0]=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'');
		$la_data[1]=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'');
		$la_data[2]=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'');
		$la_data[3]=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'');
		$la_data[4]=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'');
		$la_data[5]=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'');
		$la_data[6]=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'');
		$la_data[7]=array('firma1'=>'<b>Elaborador Por</b>','firma2'=>'<b>Autorizado Por</b>','firma3'=>'<b>Verificación Disponibilidad Presupuestaria</b>','firma4'=>'<b>Imputación Presupuestaria</b>','firma5'=>'<b>Aprobado Por</b>');
		$la_data[8]=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'');
		$la_data[9]=array('firma1'=>'______________________','firma2'=>'______________________','firma3'=>'______________________','firma4'=>'______________________','firma5'=>'______________________');
		$la_data[10]=array('firma1'=>'<b>Analista</b>','firma2'=>'<b>Director (a) de Recursos Humanos</b>','firma3'=>'<b>Director de Planificación, Presupuesto y Control de Gestión</b>','firma4'=>'<b>Dirección de Administración de Servicios</b>','firma5'=>'<b>Contralor Municipal (I) del Municipio Valencia</b>');
		$la_data[12]=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'');
		$la_columna=array('firma1'=>'','firma2'=>'','firma3'=>'','firma4'=>'','firma5'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('firma1'=>array('justification'=>'center','width'=>108), // Justificación y ancho de la columna
						 			   'firma2'=>array('justification'=>'center','width'=>108),
						 			   'firma3'=>array('justification'=>'center','width'=>108),
						 			   'firma4'=>array('justification'=>'center','width'=>108),
						 			   'firma5'=>array('justification'=>'center','width'=>108))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	if($lb_valido)
	{
		$arrResultado=$io_report->uf_resumenconcepto_conceptos($ls_codconcdes,$ls_codconchas,$ls_aportepatronal,$ls_conceptocero,$ls_subnomdes,
	...
	else  // Imprimimos el reporte
	{
		...
		while ((!$rs_data->EOF)&&($lb_valido))
		{
			...
			if($rs_data->fields["total"]>$li_personal)
			{
				$li_personal= $rs_data->fields["total"];
			}
			switch($ls_tipsal)
			{
				case "A": // Asignación
					$li_totasi=$li_totasi+abs($rs_data->fields["monto"]);
					$la_data[$li_i]=array('nro'=>$li_i,'codigo'=>$ls_codconc,'nombre'=>$ls_nomcon,'personal'=>$li_totalpersonal,'asignacion'=>$li_monto,'deduccion'=>'','aporte'=>'');
					break;
				...
				case "D": // Deducción
					...
					$la_data[$li_i]=array('nro'=>$li_i,'codigo'=>$ls_codconc,'nombre'=>$ls_nomcon,'personal'=>$li_totalpersonal,'asignacion'=>'','deduccion'=>$li_monto,'aporte'=>'');
					break;
				...
				case "P2": // Aporte Patrón
					...
					$la_data[$li_i]=array('nro'=>$li_i,'codigo'=>$ls_codconc,'nombre'=>$ls_nomcon,'personal'=>$li_totalpersonal,'asignacion'=>'','deduccion'=>'','aporte'=>$li_monto);
					break;
		...
		$li_personal=round($li_personal,0);
		uf_print_piecabecera($li_totasi,$li_totded,$li_totapo,$li_totgeneral,$li_personal,$io_pdf); // Imprimimos el pie de la cabecera
