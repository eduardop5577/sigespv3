...
***********************************************************************************/
	...
	$ls_anio_real_des=$io_report->uf_obtener_anio_real($ls_codnomdes,$ls_perdes);
	if ($ls_anio_real_des < $ls_anodes)
	{
		$lb_anio_dist=1;
	}
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_aportepatronal_personal($ls_codnomdes,$ls_codnomhas,$ls_anodes,$ls_mesdes,$ls_anohas,$ls_meshas,
														  $ls_perdes,$ls_perhas,$ls_codconc,$ls_conceptocero,$ls_subnomdes,$ls_subnomhas,$ls_orden,$lb_anio_dist); // Cargar el DS con los datos del reporte
	}
	...
	else  // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			{
				$ls_valor=0;
				$arrResultado=$io_report->uf_obtener_valor_concepto($ls_codnom,$ls_perdes,$ls_perhas, $ls_codper,'0000000001',$ls_valor);//sueldo
				$ls_valor=$arrResultado['as_valor'];
				$lb_valido=$arrResultado['lb_valido'];
				$li_ingresos=$li_ingresos+$ls_valor;
				$arrResultado=$io_report->uf_obtener_valor_concepto($ls_codnom,$ls_perdes,$ls_perhas, $ls_codper,'0000000003',$ls_valor);//compensación
				$ls_valor=$arrResultado['as_valor'];
				$lb_valido=$arrResultado['lb_valido'];
				$li_ingresos=$li_ingresos+$ls_valor;
				$arrResultado=$io_report->uf_obtener_valor_concepto($ls_codnom,$ls_perdes,$ls_perhas, $ls_codper,'0000000005',$ls_valor);//prima antiguedad
				$ls_valor=$arrResultado['as_valor'];
				$lb_valido=$arrResultado['lb_valido'];
				$li_ingresos=$li_ingresos+$ls_valor;
				$arrResultado=$io_report->uf_obtener_valor_concepto($ls_codnom,$ls_perdes,$ls_perhas, $ls_codper,'0000000011',$ls_valor);//prima profesionalización
				$ls_valor=$arrResultado['as_valor'];
				$lb_valido=$arrResultado['lb_valido'];
				$li_ingresos=$li_ingresos+$ls_valor;
				$arrResultado=$io_report->uf_obtener_valor_concepto($ls_codnom,$ls_perdes,$ls_perhas, $ls_codper,'0000000013',$ls_valor);//prima profesionalización
				$ls_valor=$arrResultado['as_valor'];
				$lb_valido=$arrResultado['lb_valido'];
				$li_ingresos=$li_ingresos+$ls_valor;
				$arrResultado=$io_report->uf_obtener_valor_concepto($ls_codnom,$ls_perdes,$ls_perhas, $ls_codper,'0000000024',$ls_valor);//diferencias de ingresos
				$ls_valor=$arrResultado['as_valor'];
				$lb_valido=$arrResultado['lb_valido'];
				$li_ingresos=$li_ingresos+$ls_valor;
			}
