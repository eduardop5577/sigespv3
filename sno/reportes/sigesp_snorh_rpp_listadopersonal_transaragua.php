...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(762,560,8,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(768,553,7,date("h:i a")); // Agregar la Hora
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($io_pdf)
	{
        ...
        $io_pdf->filledRectangle(20,487,800,$io_pdf->getFontHeight(27));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
						 			   ...
						 			   'nomina'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'fechano'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
						 			   ...
						 			   'profesion'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'pais'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'estado'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'municipio'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'parroquia'=>array('justification'=>'center','width'=>60))); // Justificación y ancho de la columna
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_listadopersonal_personal($ls_codnomdes,$ls_codnomhas,$ls_codperdes,$ls_codperhas,$ls_activo,$ls_egresado,
														   ...
														   $ls_codpar,$ls_orden,$ls_uniadmin,$ls_codestper,$ls_codmunper,$ls_codparper); // Obtenemos el detalle del reporte
	}
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.75,2.5,3,3); // Configuración de los margenes en centímetros
		uf_print_encabezado_pagina($ls_titulo,$io_pdf); // Imprimimos el encabezado de la página
		$io_pdf->ezStartPageNumbers(800,50,10,'','',1); // Insertar el número de página
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			$la_data[$li_i]=array('codigo'=>$ls_codper,'nombre'=>$ls_nomper,'fecha'=>$ld_fecingper,'estatus'=>$ls_estper,'nomina'=>$ls_nomina,'fechano'=>$ld_fechano,
								  'estatusno'=>$ls_estnom,'nivel'=>$ls_nivacaper,'profesion'=>$ls_despro,'pais'=>$ls_despaiper,'estado'=>$ls_desestper,'municipio'=>$ls_desmunper,'parroquia'=>$ls_desparper);
		}
