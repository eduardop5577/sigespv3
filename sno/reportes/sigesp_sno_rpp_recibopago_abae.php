...
***********************************************************************************/
	...
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,$io_cabecera,$io_pdf)
	{
		...
		$io_pdf->ezSetY(668);
		$la_data=array(array('denomasig'=>'<b>DENOMINACIÓN</b>', 'canasig'=>'<b>CANT.</b>','valorasig'=>'<b>ASIGNACIÓN</b>', 'denomdedu'=>'<b>DENOMINACIÓN</b>','candedu'=>'<b>CANT.</b>','valordedu'=>'<b>DEDUCCIÓN</b>'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>130), // Justificación y ancho de la columna
						 			   'canasig'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
						 			   ...
						 			   'candedu'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
				...
				{					
					switch($ls_quincena)
					{
						...
						case "2": // segunda quincena;
							...
							$li_valsal=$io_fun_nomina->uf_formatonumerico($li_valsal);
							$la_data_d[$li_dedu]=array('denominacion'=>$ls_nomcon,'valor'=>$li_valsal,'cantidad'=>'');
							break;
