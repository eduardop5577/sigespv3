...
***********************************************************************************/
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   ...
						 			   'asignacion'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'aporte'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>60))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
	...
	function uf_print_piecabecera($ai_totalasignacion,$ai_totaldeduccion,$ai_totalaporte,$ai_total_neto,$as_obsrecper,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						'cols'=>array('totales'=>array('justification'=>'right','width'=>260), // Justificación y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'aporte'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>60))); // Justificación y ancho de la columna
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$io_pdf->line(50,73,550,73); //HORIZONTAL		
		$io_pdf->addText(95,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(60,63,7,"COORDINACION DE GESTION HUMANA"); // Agregar el título
		$io_pdf->line(205,60,205,130);	//VERTICAL	
		$io_pdf->addText(260,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(230,63,7,"COORDINACION DE ADMINISTRACION,"); // Agregar el título
		$io_pdf->addText(237,52,7,"PLANIFICACION Y PRESUPUESTO"); // Agregar el título
		$io_pdf->line(385,60,385,130);	//VERTICAL		
		$io_pdf->addText(435,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(445,63,7,"PRESIDENCIA"); // Agregar el título	
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
