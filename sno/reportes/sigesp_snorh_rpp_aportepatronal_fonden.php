...
***********************************************************************************/
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$io_pdf->addText(55,121,7,"REALIZADO POR:"); // Agregar el título
		$io_pdf->addText(80,78,7,"Analista de Gestion Humana"); // Agregar el título
		
		$io_pdf->line(200,60,200,130);	//VERTICAL	
		$io_pdf->addText(205,121,7,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(230,78,7,"Jefe de Oficina de Gestión Humana"); // Agregar el título
		$io_pdf->line(380,60,380,130);	//VERTICAL
		
        $io_pdf->addText(385,121,7,"AUTORIZADO POR: "); // Agregar el título
		$io_pdf->addText(440,78,7,"Gerente General"); // Agregar el título
