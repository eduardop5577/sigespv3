...
***********************************************************************************/
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$io_pdf->addText(85,63,7,"ANALISTA DE PERSONAL"); // Agregar el título
		$io_pdf->line(205,60,205,130);	//VERTICAL	
		$io_pdf->addText(260,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(230,63,7,"COORD. DE RECURSOS HUMANOS"); // Agregar el título
		$io_pdf->line(385,60,385,130);	//VERTICAL		
		$io_pdf->addText(435,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(405,63,7,"GERENTE DE RECURSOS HUMANOS"); // Agregar el título	
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
