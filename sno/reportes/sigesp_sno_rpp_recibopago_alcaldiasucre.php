...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,330,11,$as_titulo); // Agregar el tï¿½tulo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,$as_gerencia,$io_cabecera,$ld_fechaingreso,$ls_peractnom,$ld_fecdesper,$ld_fechasper,$ls_codgerencia,$ls_codigocar,$ls_codcueban,$ls_sueintper,$ls_banco,$ls_denestpro2,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_codnom=$_SESSION["la_nomina"]["codnom"];
		$io_pdf->addText(330,691,7,''/*$ls_rifper*/); // Agregar el tï¿½tulo
		$io_pdf->ezSetDy(50);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>522, // Orientaciï¿½n de la tabla
						 'cols'=>array('periodo'=>array('justification'=>'center','width'=>90))); // Justificaciï¿½n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Mï¿½ximo de la tabla
						 'xPos'=>522, // Orientaciï¿½n de la tabla
						 'cols'=>array('desde'=>array('justification'=>'left','width'=>90))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>550, // Ancho de la tabla
						 'maxWidth'=>550, // Ancho Mï¿½ximo de la tabla
						 'xPos'=>307, // Orientaciï¿½n de la tabla
						 'cols'=>array('datper'=>array('justification'=>'center','width'=>520))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		...
		$io_pdf->Rectangle(42,630,520,70);
		...
		$la_data[5]=array('trabajador'=>'Banco        : '.$ls_banco.'           ');
		$la_data[6]=array('trabajador'=>'Dirección Laboral        : '.$ls_denestpro2.'           ');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>550, // Ancho de la tabla
						 'maxWidth'=>550, // Ancho Mï¿½ximo de la tabla
						 'xPos'=>207, // Orientaciï¿½n de la tabla
						 'cols'=>array('trabajador'=>array('justification'=>'left','width'=>320))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>550, // Ancho de la tabla
						 'maxWidth'=>550, // Ancho Mï¿½ximo de la tabla
						 'xPos'=>467, // Orientaciï¿½n de la tabla
						 'cols'=>array('trabajador'=>array('justification'=>'left','width'=>200))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>307, // Orientaciï¿½n de la tabla
						 'cols'=>array('concepto'=>array('justification'=>'left','width'=>520))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_descar,$as_gerencia,$io_cabecera,$ld_fechaingreso,$ls_peractnom,$ld_fecdesper,$ld_fechasper,$ls_codgerencia,$ls_codigocar,$ls_codcueban,$ls_sueintper,$ls_banco,$ls_denestpro2,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_desnom=$_SESSION["la_nomina"]["desnom"];
		$ls_codnom=$_SESSION["la_nomina"]["codnom"];
		//$io_pdf->addText(330,293,7,$ls_rifper); // Agregar el tï¿½tulo
		$io_pdf->ezSetDy(-77);
		$la_data[1]=array('trabajador'=>'                                  ');
		$la_data[2]=array('trabajador'=>'                                  ');
		$la_data[3]=array('trabajador'=>'                                  ');
		...
		unset($la_config);
		$io_pdf->setStrokeColor(0,0,0);		
		$io_pdf->Rectangle(42,228,520,70);
	...
	function uf_print_detalle($la_data_a,$la_data_d,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Mï¿½ximo de la tabla
						 'xPos'=>210, // Orientaciï¿½n de la tabla
						 'cols'=>array('concasig'=>array('justification'=>'left','width'=>60), // Justificaciï¿½n y ancho de la columna
						 			   'denomasig'=>array('justification'=>'left','width'=>205), // Justificaciï¿½n y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>60))); // Justificaciï¿½n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Mï¿½ximo de la tabla
						 'xPos'=>260, // Orientaciï¿½n de la tabla
						 'cols'=>array('concdedu'=>array('justification'=>'left','width'=>60), // Justificaciï¿½n y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'left','width'=>205), // Justificaciï¿½n y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>160))); // Justificaciï¿½n y ancho de la columna
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_suelper,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('totales'=>array('justification'=>'left','width'=>500))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Mï¿½ximo de la tabla
						 'xPos'=>360, // Orientaciï¿½n de la tabla
						 'cols'=>array('neto'=>array('justification'=>'left','width'=>160))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$io_pdf->addText(200,410,'5','Nota:  Cualquier consulta favor comunicarse con la Dirección de Recusos Humanos');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_pie_cabecera2($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_suelper,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Mï¿½ximo de la tabla
						 'xPos'=>350, // Orientaciï¿½n de la tabla
						 'cols'=>array('neto'=>array('justification'=>'left','width'=>160))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$io_pdf->addText(200,10,'5','Nota:  Cualquier consulta favor  comunicarse con la Dirección de Recusos Humanos');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_piepagina,'all');
		$io_pdf->stopObject($io_piepagina); // Detener el objeto pie de pï¿½gina
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3,0,1,2); // Configuraciï¿½n de los margenes en centï¿½metros
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($li_reg==1)
			{
				uf_print_cabecera1($ls_cedper,$ls_nomper,$ls_descar,$ls_gerencia,$io_cabecera,$ld_fechaingreso,$ls_peractnom,$ld_fecdesper,$ld_fechasper,$ls_codgerencia,$ls_codigocar,$ls_codcueban,$ls_sueintper,$ls_banco,$ls_denestpro2,$io_pdf); // Imprimimos la cabecera del registro
			}
			else
			{
				uf_print_cabecera2($ls_cedper,$ls_nomper,$ls_descar,$ls_gerencia,$io_cabecera,$ld_fechaingreso,$ls_peractnom,$ld_fecdesper,$ld_fechasper,$ls_codgerencia,$ls_codigocar,$ls_codcueban,$ls_sueintper,$ls_banco,$ls_denestpro2,$io_pdf); // Imprimimos la cabecera del registro
			}
