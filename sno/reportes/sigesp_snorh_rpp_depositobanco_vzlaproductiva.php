...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_periodo,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_vzlaproductiva.jpg',50,530,670,50);
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=396-($li_tm/2);
		$io_pdf->addText($tm,510,11,$as_titulo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(11,$as_periodo);
		$tm=396-($li_tm/2);
		$io_pdf->addText($tm,498,11,$as_periodo); // Agregar el título		
		$io_pdf->addText(650,527,8,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(656,520,7,date("h:i a")); // Agregar la Hora
		// cuadro inferior
		$io_pdf->setStrokeColor(0,0,0);
        $io_pdf->Rectangle(90,60,600,70); 
		$io_pdf->line(90,117,690,117);	//HORIZONTAL	
		$io_pdf->addText(120,121,8,"OFICINA DE TALENTO HUMANO"); // Agregar el título
		$io_pdf->addText(100,105,8,"Elaborado por:");
		$io_pdf->addText(100,65,8,"Fecha/Hora:"); // Agregar el título
		$io_pdf->line(280,60,280,130);	//VERTICAL		
		$io_pdf->addText(355,121,8,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(290,105,8,"Aprobado por:"); // Agregar el título
		$io_pdf->addText(290,65,8,"Fecha/Hora:"); // Agregar el título
		$io_pdf->line(490,60,490,130);	//VERTICAL		
		$io_pdf->addText(505,121,8,"OFICINA DE PLANIFICACIÓN Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(500,105,8,"Imputación por:"); // Agregar el título
		$io_pdf->addText(500,65,8,"Fecha/Hora:"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
