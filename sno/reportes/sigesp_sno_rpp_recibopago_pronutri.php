...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$io_pdf->addText($tm+260,720,10,"<b>PRONUTRI  C.A.</b>"); // Agregar el título
		$io_pdf->addText($tm+280,710,8,$_SESSION['la_empresa']['rifemp']); // Agregar el título
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$io_pdf->addText($tm+260,360,10,"<b>PRONUTRI  C.A.</b>"); // Agregar el título
		$io_pdf->addText($tm+280,350,8,$_SESSION['la_empresa']['rifemp']); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(9,$as_desnom);
		$tm=306-($li_tm/2);
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_sueper,$as_descar,$as_fecingper,$io_cabecera,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->ezSetDy(-11);
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'Cédula:', 'cargo'=>'Cargo:', 'fecing'=>'Fecha de Ingreso:', 'sueldo'=>'Sueldo:' ));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','fecing'=>'','sueldo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
						 			   ...
						 			   'cargo'=>array('justification'=>'left','width'=>150),
									   'fecing'=>array('justification'=>'left','width'=>100),
									   'sueldo'=>array('justification'=>'left','width'=>100))); // Justificación y ancho de la columna
		...
		$la_data=array(array('nombre'=>$as_nomper, 'cedula'=>$as_cedper, 'cargo'=>substr($as_descar,0,100), 'fecing'=>$as_fecingper, 'sueldo'=>$as_sueper));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','fecing'=>'','sueldo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
		...
		$la_data=array(array('denomasig'=>'<b>DENOMINACIÓN</b>', 'cantidadsig'=>'<b>CAN.</b>', 'valorasig'=>'<b>ASIGNACIÓN</b>', 'denomdedu'=>'<b>DENOMINACIÓN</b>', 'cantidaddedu'=>'<b>CAN.</b>', 'valordedu'=>'<b>DEDUCCIÓN</b>'));
		$la_columna=array('denomasig'=>'<b>DENOMINACIÓN</b>',
						  'cantidadsig'=>'<b>CAN.</b>',
						  'valorasig'=>'<b>ASIGNACIÓN</b>',
						  'denomdedu'=>'<b>DENOMINACIÓN</b>',
						  'cantidaddedu'=>'<b>CAN.</b>',
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_sueper,$as_descar,$as_fecingper,$io_cabecera,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('conforme'=>'Dentro de los 15 días se incluyen los días de descanso de ley.','espacio'=>''));
		...
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$la_data=array(array('conforme'=>'','espacio'=>'<b>Recibi Conforme:</b>_________________________________'));
		$la_columna=array('conforme'=>'','espacio'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($li_reg==1)
			{
				uf_print_cabecera1($ls_cedper,$ls_nomper,$ls_sueper,$ls_descar,$ls_fecingper,$io_cabecera,$io_pdf); // Imprimimos la cabecera del registro
			}
			else
			{
				uf_print_cabecera2($ls_cedper,$ls_nomper,$ls_sueper,$ls_descar,$ls_fecingper,$io_cabecera,$io_pdf); // Imprimimos la cabecera del registro
			}
