...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_piecabecera($ai_tottra,$ai_montot,$ai_totunidad,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_pdf;
		$la_data=array(array('total'=>'<b>Total Trabajadores</b>'.' '.$ai_tottra.'','cantidad'=>$ai_totunidad,'monto'=>$ai_montot));
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$la_data[$li_s]=array('nro'=>$li_s,'cedula'=>$ls_cedper,'nombre'=>$ls_apenomper,'cantidad'=>$ls_unidad,'monto'=>$li_valsal);
				}
				$io_report->DS_detalle->resetds("cedper");
				uf_print_detalle($la_data,$io_pdf); // Imprimimos el detalle 
				$li_montot=$io_fun_nomina->uf_formatonumerico(abs($li_montot));
				$li_totunidad=$io_fun_nomina->uf_formatonumerico(abs($li_totunidad));
				$li_s=$li_s-1;
				uf_print_piecabecera($li_s,$li_montot,$li_totunidad,$io_pdf); // Imprimimos el pie de la cabecera
