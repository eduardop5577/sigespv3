...
***********************************************************************************/
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_cedper,$as_nomper,$as_descar,$as_descasicar,$io_cabecera,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// Fecha Creación: 03/09/2007 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_cabecera,$io_pdf;

		$io_pdf->saveState();
		$io_pdf->addText(40,695,'10','______________________________________________________________________________________________');
		$io_pdf->ezSetDy(-11);
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'Cédula:', 'cargo'=>'Asignacion Cargo:', 'dencar'=>'Denominación del Cargo:'  ));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','dencar'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>220), // Justificación y ancho de la columna
						 			   ...
						 			   'dencar'=>array('justification'=>'left','width'=>130))); // Justificación y ancho de la columna
		...
		$la_data=array(array('nombre'=>$as_nomper, 'cedula'=>$as_cedper, 'cargo'=>substr($as_descar,0,100),'dencar'=>substr($as_descasicar,0,100)));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','dencar'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			uf_print_cabecera($ls_cedper,$ls_nomper,$ls_descar,$ls_descasicar,$io_cabecera,$io_pdf); // Imprimimos la cabecera del registro
			$ls_codperi="";
			if($ls_consolidar=="0")
			{
			...
			if ($ls_coreleper!="")
			{
				...
				$ls_servidor='smtp.live.com';
				$ls_puerto='25';
				$ls_remitente='yessimoreno@hotmail.com';
				/**/
				...
				{
					$ls_coreleper="yessimoreno@hotmail";
					/*aqui es donde recibe toda la configuracion el smtp*/
					...
					/*aca va la seguridad del correo*/
					$io_mail->Username   = "yessimoreno@hotmail.com";
                    $io_mail->Password   = "Emilyslm.28";
					/*aca iria el tipo de autentificacion que usara el correo para enviar los netos*/
					/*si es por defecto obviar la linea  $smtp->SMTPSecure = "tls";*/
					$io_mail->SMTPAuth   = true;
                    $io_mail->SMTPSecure = "tls";
					/*si el servidor esta bien configurado enviara el neto de lo contrario verificar la configuracion*/
