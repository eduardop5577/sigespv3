...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$io_pdf->addText(512,720,8,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(518,713,7,date("h:i a")); // Agregar la Hora
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_firmas($io_pdf){
		...
		$io_pdf->addText(275,121,7,"PRESIDENCIA"); // Agregar el título
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.1,4,3,3); // Configuración de los margenes en centímetros
