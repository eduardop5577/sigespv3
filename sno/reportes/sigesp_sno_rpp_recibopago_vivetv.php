...
***********************************************************************************/
	...
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,$io_cabecera,$as_obsrecper,$io_pdf)
	{
		...
		$io_pdf->ezSetY(668);
		$la_data=array(array('denomasig'=>'<b>DENOMINACIÓN</b>', 'cuotaasi'=>'<b>DIAS</b>','valorasig'=>'<b>ASIGNACIÓN</b>', 'denomdedu'=>'<b>DENOMINACIÓN</b>', 'cuotadedu'=>'<b>    </b>','valordedu'=>'<b>DEDUCCIÓN</b>'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>145), // Justificación y ancho de la columna
						 			   'cuotaasi'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
									   'valorasig'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'center','width'=>145), // Justificación y ancho de la columna
						 			   'cuotadedu'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
									   'valordedu'=>array('justification'=>'center','width'=>60))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xPos'=>308, // Orientación de la tabla
						 'cols'=>array('denomasig'=>array('justification'=>'left','width'=>145), // Justificación y ancho de la columna
						 			   'cuotaasi'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
									   'valorasig'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'left','width'=>145), // Justificación y ancho de la columna
									   'cuotadedu'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						...
						case "2": // segunda quincena;
							while(!$io_report->rs_data_detalle->EOF)
							{
								...
								if(($ls_tipsal=="A") || ($ls_tipsal=="V1") || ($ls_tipsal=="V2") || ($ls_tipsal=="R")) // Buscamos las asignaciones
								{
									...
									{
										$arrResultado=$io_report->uf_buscar_valor_conc($ls_consunicon,$ls_codper,$ls_cuota);
