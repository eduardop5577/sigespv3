...
***********************************************************************************/
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$ls_cargo=$io_report->uf_select_cargo_usuario($_SESSION['la_logusr']);
		$la_data[0]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data[1]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data[2]=array('firma1'=>'ELABORADOR POR','firma2'=>'VERIFICADO POR','firma3'=>'APROBADO POR');
		...
		$la_data[6]=array('firma1'=>$ls_nomusu,'firma2'=>'','firma3'=>' ');
		$la_data[7]=array('firma1'=>$ls_cargo,'firma2'=>'Gerente (E) de Talento Humano','firma3'=>' Presidente');
