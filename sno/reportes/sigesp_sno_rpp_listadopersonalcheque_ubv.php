	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('cedula'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'nombre'=>array('justification'=>'center','width'=>230), // Justificación y ancho de la columna
						 			   'ubifis'=>array('justification'=>'left','width'=>110), // Justificación y ancho de la columna
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($lb_valido)
			{
				...
				while(!$io_report->rs_data_detalle->EOF)
				{
					...
					$ls_desubifis=trim($io_report->rs_data_detalle->fields["desubifis"]);
					$li_monnetres=$io_fun_nomina->uf_formatonumerico($io_report->rs_data_detalle->fields["monnetres"]);
					$la_data[$li_s]=array('cedula'=>$ls_cedper,'nombre'=>$ls_nomper,'neto'=>$li_monnetres,'ubifis'=>$ls_desubifis);
					$li_s++;
