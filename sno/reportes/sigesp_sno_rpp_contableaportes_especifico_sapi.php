...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2,$as_titulo3,$as_titulo4,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$io_pdf->setStrokeColor(0,0,0);
 		$io_pdf->line(50,40,555,40);
        $io_pdf->Rectangle(30,60,545,70);
		$io_pdf->line(30,73,575,73);		
		$io_pdf->line(30,117,575,117);		
		$io_pdf->line(140,60,140,130);		
		$io_pdf->line(260,60,260,130);		
		$io_pdf->line(440,60,440,130);		
		$io_pdf->line(350,73,350,117);		
		$io_pdf->addText(50,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(50,63,7,"  FIRMA / FECHA"); // Agregar el título
		$io_pdf->addText(160,122,7,"     VALIDADO POR"); // Agregar el título
		$io_pdf->addText(145,75,7,"COORD. RECURSOS HUMANOS"); // Agregar el título
		$io_pdf->addText(160,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(280,75,7,"PRESUPUESTO                   CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(310,122,7,"   CERTIFICADO POR"); // Agregar el título
		$io_pdf->addText(310,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(465,122,7,"    APROBADO POR"); // Agregar el título
		$io_pdf->addText(455,75,7, "DIR. SOPORTE ADMINISTRATIVO"); // Agregar el título
