...
***********************************************************************************/
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$la_data[6]=array('firma1'=>'Alcalde Lcdo. Fermin Marin','firma2'=>'Administradora T.S.U. Argelis Freitez','firma3'=>' Lcda. Zulimar Mendez Coordinadora de Recursos Humanos (E)');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('firma1'=>array('justification'=>'center','width'=>180), // Justificación y ancho de la columna
						 			   'firma2'=>array('justification'=>'center','width'=>180),
						 			   'firma3'=>array('justification'=>'center','width'=>180))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
