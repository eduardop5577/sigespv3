...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,740,8,$as_periodo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(8,$as_desnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,730,8,$as_desnom); // Agregar el título
		$io_pdf->addText(512,760,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(518,753,6,date("h:i a")); // Agregar la Hora
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>65), // Justificación y ancho de la columna
						 			   'nombre'=>array('justification'=>'left','width'=>155), // Justificación y ancho de la columna
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$la_data[3]=array('firma1'=>'____________________________','firma2'=>'____________________________','firma3'=>'____________________________');
		$la_data[4]=array('firma1'=>'<b>María Caroto Correia</b>','firma2'=>'<b>Cnel. Gustavo Adolfo Espinoza</b>','firma3'=>'<b>Dario Arteaga Paez</b>');
		$la_data[5]=array('firma1'=>'GERENTE DE RECURSOS HUMANOS','firma2'=>'GERENTE DE ADMINISTRACIÓN','firma3'=>'PRESIDENTE DEL INTT');
		$la_data[6]=array('firma1'=>'Gaceta Oficial Nº 40.169 del 17-05-2013','firma2'=>'Gaceta Oficial Nº 40.301 del 25-11-2013','firma3'=>'Gaceta Oficial Nº 40.165 del 13/05/13');
		$la_data[7]=array('firma1'=>'Providcia.Nº 345-2013 del 16-05-13','firma2'=>'Providencia.Nº 311-2013 del 25-11-2013','firma3'=>'Decreto Nº 87 de fecha 13/05/13');
		$la_data[8]=array('firma1'=>'FECHA: ____/____/_______','firma2'=>'FECHA: ____/____/_______','firma3'=>'FECHA: ____/____/_______');
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(2.5,1,2,2); // Configuración de los margenes en centímetros
