...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_piecabecera($ai_totaltrab,$ai_total,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$la_data=array(array('titulo'=>'<b>Total Trabajadores: '.$ai_totaltrab.'</b>                      <b>Total General '.$ls_bolivares.': </b>','neto'=>$ai_total));
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$la_data[1]=array('firma1'=>'','firma2'=>'Firmas Autorizadas','firma3'=>'');
		$la_data[2]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data[3]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data[4]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data[5]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data[6]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data[7]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data[8]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		$la_data[9]=array('firma1'=>'____________________________','firma2'=>'____________________________','firma3'=>'____________________________');
		$la_data[10]=array('firma1'=>'<b>Director de </b>','firma2'=>'<b>Director de </b>','firma3'=>'<b>Contralor Municipal (I) del</b>');
		$la_data[11]=array('firma1'=>'<b>Recursos Humanos</b>','firma2'=>'<b>Administración y Servicios</b>','firma3'=>'<b>Municipio Valencia</b>');
		$la_data[12]=array('firma1'=>'','firma2'=>'','firma3'=>'');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('firma1'=>array('justification'=>'center','width'=>200), // Justificación y ancho de la columna
						 			   'firma2'=>array('justification'=>'center','width'=>140),
	...
	else // Imprimimos el reporte
	{
		...
		{			
			...
			uf_print_piecabecera($li_nro,$li_total,$io_pdf);
