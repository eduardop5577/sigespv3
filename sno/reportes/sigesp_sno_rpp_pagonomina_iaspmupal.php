...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		// cuadro inferior
		$io_pdf->addText(80,70,8,"Elaborado por:"); // Agregar el título
		$io_pdf->addText(60,60,8,"TSU. Marianela Castillo"); // Agregar el título
		
		$io_pdf->addText(235,70,8,"Jefe de Recursos Humanos:"); // Agregar el título
		$io_pdf->addText(255,60,8,"Lic. Karla Rivas"); // Agregar el título
		
        $io_pdf->addText(440,70,8,"Administradora:"); // Agregar el título
		$io_pdf->addText(430,60,8,"Lic. Yulimar Medina"); // Agregar el título
			...
			if($lb_valido)
			{
				...
				while(!$io_report->rs_data_detalle->EOF)
				{
					...
					if ($ls_codconc!=$ls_codconc_ant)
					{
						...
						$ls_codconc_ant=$ls_codconc;
						$li_deduccion_ant=$li_deduccion;
						$li_s++;
					}
					else
					{
						$la_data[$li_s-1]=array('codigo'=>$ls_codconc,'nombre'=>$ls_nomcon,'asignacion'=>$li_asignacion,
											  'deduccion'=>$li_deduccion_ant,'aporte'=>$li_aporte,'neto'=>'');
						$li_deduccion_ant=0;
					}
