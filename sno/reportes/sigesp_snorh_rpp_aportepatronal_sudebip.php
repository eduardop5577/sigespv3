...
***********************************************************************************/
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('nro'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'patron'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
	...
	else  // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$li_sueldo=$io_fun_nomina->uf_formatonumerico(abs($io_report->DS->data["sueintper"][$li_i]));
			...
			$la_data[$li_i]=array('nro'=>$li_i,'cedula'=>$ls_cedper,'nombre'=>$ls_nomper,'sueldo'=>$li_sueldo,'personal'=>$li_personal,'patron'=>$li_patron,'total'=>$li_total);
		}
