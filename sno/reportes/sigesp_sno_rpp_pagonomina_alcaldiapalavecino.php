...
***********************************************************************************/
	...
	function uf_print_cabecera($io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->ezSetY(700);
		$la_data=array(array('personal'=>'<b>Cédula</b>','nomper'=>'<b>Apellidos y Nombre</b>','totasig'=>'<b>TOTAL ASIGNACION</b>',
							 'totded'=>'<b>TOTAL DEDUCCION</b>','netocob'=>'<b>NETO A COBRAR</b>'));
		$la_columnas=array('personal'=>'',
						   'nomper'=>'',
						   'totasig'=>'',
						   'totded'=>'',
						   'netocob'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('personal'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'nomper'=>array('justification'=>'center','width'=>200), // Justificación y ancho de la columna
						 			   'totasig'=>array('justification'=>'center','width'=>80),// Justificación y ancho de la columna
									   'totded'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'netocob'=>array('justification'=>'center','width'=>80))); // Justificación y ancho de la columna
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_new($la_data,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		global $io_pdf;
		//$io_pdf->ezSetDy(-2);
		$la_columnas=array('personal'=>'<b>Código</b>',
						   'nomper'=>'<b>               Concepto</b>',
						   'totasig'=>'<b>Asignación        </b>',
						   'totded'=>'<b>Deducción        </b>',
						   'netocob'=>'<b>Aporte Patronal  </b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
						 ...
						 'cols'=>array('personal'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   ...
						 			   'totasig'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'totded'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'netocob'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
	...
	function uf_print_piepagina($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>270), // Justificación y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(4.05,2.5,3,3); // Configuración de los margenes en centímetros
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($lb_valido)
			{
				...
				$la_data_gen[$li_x]=array('personal'=>$ls_cedper,'nomper'=>$ls_apenomper,'totasig'=>$li_totalasignacion,
										  'totded'=>$li_totaldeduccion,'netocob'=>$li_total_neto);
				$li_x++;
		...
		uf_print_detalle_new($la_data_gen,$io_pdf); // Imprimimos el detalle 
