...
***********************************************************************************/
	...
	function uf_print_piecabecera($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,$ai_personal,$io_pdf)
	{
		...
		global $io_pdf;
		global $ls_bolivares;
		//se elimino el valor de $ai_personal para evitar que aparezca el total de personas en el reporte de Resumen de concepto.
		$la_data=array(array('titulo'=>'<b>Totales '.$ls_bolivares.'</b>','personal'=>'','asignacion'=>$ai_totasi,'deduccion'=>$ai_totded,'aporte'=>$ai_totapo));
	...
	else  // Imprimimos el reporte
	{
		...
		while ((!$rs_data->EOF)&&($lb_valido))
		{
			...
			$li_personal= $li_personal+$rs_data->fields["total"];
			switch($ls_tipsal)
			{
				case "A": // Asignación
