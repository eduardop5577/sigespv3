...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$io_pdf->addText($tm+260,720,10,""); // Agregar el título
		...
		$io_pdf->addText(50,710,9,$ls_rif); // Agregar el título		
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],50,355,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,370,11,$as_titulo); // Agregar el título 310
		$li_tm=$io_pdf->getTextWidth(9,$as_periodo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,360,9,$as_periodo); // Agregar el título 300
		$io_pdf->addText($tm+260,360,10,""); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(9,$as_desnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,345,9,$as_desnom); // Agregar el título
		$ls_rif="Rif.:".$_SESSION['la_empresa']['rifemp'];
		$io_pdf->addText(50,350,9,$ls_rif); // Agregar el título		                
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_sueper,$as_descar,$as_fecingper,$as_desuniadm,$io_cabecera,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->saveState();
		$io_pdf->addText(40,695,'10','______________________________________________________________________________________________'); //695
		$io_pdf->ezSetDy(-11);
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'Cédula:', 'cargo'=>'Cargo:', 'unidad'=>'Unidad Organizativa:', 'fecing'=>'Fec. de Ingreso:', 'sueldo'=>'Sueldo:' ));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
									   ...
									   'fecing'=>array('justification'=>'left','width'=>70))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(40,684,'10','______________________________________________________________________________________________'); //684
		...
		$io_pdf->ezSetY(668); //668
		$la_data=array(array('denomasig'=>'<b>DENOMINACIÓN</b>', 'cantidadsig'=>'<b>UNIDAD</b>', 'valorasig'=>'<b>ASIGNACIÓN</b>', 'denomdedu'=>'<b>DENOMINACIÓN</b>', 'cantidaddedu'=>'<b>UNIDAD</b>', 'valordedu'=>'<b>DEDUCCIÓN</b>'));
		$la_columna=array('cantidadsig'=>'<b>UNIDAD</b>','denomasig'=>'<b>DENOMINACIÓN</b>','valorasig'=>'<b>ASIGNACIÓN</b>',
                'cantidaddedu'=>'<b>UNIDAD</b>','denomdedu'=>'<b>DENOMINACIÓN</b>', 'valordedu'=>'<b>DEDUCCIÓN</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>130), // Justificación y ancho de la columna
								       'cantidadsig'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
									   ...
									   'cantidaddedu'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_sueper,$as_descar,$as_fecingper,$as_desuniadm,$io_cabecera,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		global $io_pdf,$io_cabecera;
		$io_pdf->saveState();
		$io_pdf->addText(40,335,'10','______________________________________________________________________________________________'); //275
		$io_pdf->ezSetDy(-98); //175
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'Cédula:', 'cargo'=>'Cargo:', 'unidad'=>'Unidad Organizativa:', 'fecing'=>'Fec. de Ingreso:', 'sueldo'=>'Sueldo:'));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','unidad'=>'','sueldo'=>'','fecing'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
									   ...
									   'fecing'=>array('justification'=>'left','width'=>70))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(40,324,'10','______________________________________________________________________________________________'); //264
		$la_data=array(array('nombre'=>$as_nomper, 'cedula'=>$as_cedper, 'cargo'=>substr($as_descar,0,100), 'unidad'=>substr($as_desuniadm,0,100), 'fecing'=>$as_fecingper, 'sueldo'=>$as_sueper));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','unidad'=>'','sueldo'=>'','fecing'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
									   ...
									   'fecing'=>array('justification'=>'left','width'=>70))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(40,306,'10','______________________________________________________________________________________________'); //246
		$io_pdf->ezSetY(308); //248
		$la_data=array(array('denomasig'=>'<b>DENOMINACIÓN</b>', 'cantidadsig'=>'<b>UNIDAD</b>', 'valorasig'=>'<b>ASIGNACIÓN</b>', 'denomdedu'=>'<b>DENOMINACIÓN</b>', 'cantidaddedu'=>'<b>UNIDAD</b>', 'valordedu'=>'<b>DEDUCCIÓN</b>'));
		$la_columna=array('cantidadsig'=>'<b>UNIDAD</b>','denomasig'=>'<b>DENOMINACIÓN</b>','valorasig'=>'<b>ASIGNACIÓN</b>',
                'cantidaddedu'=>'<b>UNIDAD</b>','denomdedu'=>'<b>DENOMINACIÓN</b>', 'valordedu'=>'<b>DEDUCCIÓN</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>130), // Justificación y ancho de la columna
									   ...
									   'cantidaddedu'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,296,'10','______________________________________________________________________________________________'); //236
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_cabecera,'all');
	}// end function uf_print_cabecera
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
						               'cantidadsig'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_desubifis,$as_banco,$io_pdf)
	{
		...
		unset($la_config);
                $io_pdf->ezSetDy(5);
		$la_data=array(array('cuenta'=>'<b>Institucion Bancaria:</b>  '.$as_banco, 'ubicacion'=>'<b>Ubicacion Física</b>'.$as_desubifis,'neto'=>'<b>Neto a Cobrar '.$ls_bolivares.':</b>  '.$ai_totnet));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>190), // Justificación y ancho de la columna
                                                               'ubicacion'=>array('justification'=>'left','width'=>190), // Justificación y ancho de la columna
                                                               'neto'=>array('justification'=>'right','width'=>120))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
	...
	function uf_print_pie_cabecera2($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_desubifis,$as_banco,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>130), // Justificación y ancho de la columna
									   ...
									   'valordedu'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,102,'10','------------------------------------------------------------------------------------------------------------------------------------------------------------'); //42
		$la_data=array(array('cuenta'=>'<b>Institucion Bancaria:</b>  '.$as_banco, 'ubicacion'=>'<b>Ubicacion Física:</b>'.$as_desubifis,'neto'=>'<b>Neto Cobrar '.$ls_bolivares.':</b>'.$ai_totnet));
		$la_columna=array('cuenta'=>'','ubicacion'=>'','neto'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'titleFontSize' => 7,  // Tamaño de Letras de los títulos
	...
	else // Imprimimos el reporte
	{
		...
		//if(($io_report->rs_data->RecordCount()>1))
		//{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			$ls_sueper=number_format($ls_sueper,2,",",".");
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_total;$li_s++) 
				{
					...
					$la_data[$li_s]=$la_valores;
                                ...
                                if($li_reg==1)
                                {
                                        uf_print_cabecera1($ls_cedper,$ls_nomper,$ls_sueper,$ls_descar,$ls_fecingper,$ls_desuniadm,$io_cabecera,$io_pdf); // Imprimimos la cabecera del registro
                                }
                                /*else
                                {
                                        uf_print_cabecera2($ls_cedper,$ls_nomper,$ls_sueper,$ls_descar,$ls_fecingper,$ls_desuniadm,$io_cabecera,$io_pdf); // Imprimimos la cabecera del registro
                                }*/
