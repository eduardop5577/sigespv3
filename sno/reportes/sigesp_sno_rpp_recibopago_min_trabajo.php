...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$tm=306-($li_tm/2);*/
		$io_pdf->addText(230,650,8,'<b><i>'.$as_periodo.'</i></b>'); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
							    ...
							    $ls_cargo,$li_total,$io_cabecera,$io_pdf)
	{
		...
		$la_data[1]=array('nombre'=>'<b><i>Apellidos y Nombres: </b></i>'.$as_nomper, 
						  'cedula'=>'<b><i>Cédula de identidad: </b></i>'.$as_cedper);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'rowGap' => 1.2 ,
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>395), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'left','width'=>155))); // Justificación y ancho de la columna
		...
		$la_data[1]=array('tipo_per'=>'<b><i>Tipo de Personal: </b></i>'.$ls_tipper,
		 				  'codigo_nom'=>'<b><i>Código de Nómina: </b></i>'.$ls_codnom);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'rowGap' => 1.2 ,
						 'cols'=>array('tipo_per'=>array('justification'=>'left','width'=>395), // Justificación y ancho de la columna
						 			   'codigo_nom'=>array('justification'=>'left','width'=>155))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'rowGap' => 1.2 ,
						 'cols'=>array('estatus'=>array('justification'=>'left','width'=>395), // Justificación y ancho de la columna
						 			   'estatus2'=>array('justification'=>'left','width'=>155))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		$la_data[1]=array('cargo'=>'<b><i>Cargo: </b></i>'.$ls_cargo,
		 				  'cta'=>'<b><i>Cta. Nómina: </b></i>'.$as_codcueban);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'rowGap' => 1.2 ,
						 'cols'=>array('cargo'=>array('justification'=>'left','width'=>395), // Justificación y ancho de la columna
						 			   'cta'=>array('justification'=>'left','width'=>155))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		$la_data[1]=array('unidad'=>'<b><i>Unidad Administrativa: </b></i>'.$as_desuniadm,
		 				  'sueldo'=>'<b><i>Sueldo/Salario Básico: </b></i>'.$li_total);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'rowGap' => 1.2 ,
						 'cols'=>array('unidad'=>array('justification'=>'left','width'=>395), // Justificación y ancho de la columna
						 			   'sueldo'=>array('justification'=>'left','width'=>155))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		
		$io_pdf->addText(65,630,8,'=================================================================================================='); // Agregar el título
		$io_pdf->ezSety(630);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('denominacion'=>array('justification'=>'left','width'=>310), // Justificación y ancho de la columna
		...
		$io_pdf->addText(65,610,8,'=================================================================================================='); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>450, // Ancho de la tabla
						 'maxWidth'=>450, // Ancho Máximo de la tabla
						 'xPos'=>300, // Mostrar Líneas
						 'rowGap' => 0 ,
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>460))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>450, // Ancho Máximo de la tabla
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>65), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'right','width'=>245), // Justificación y ancho de la columna
						 			   'asignacion'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'deduccion'=>array('justification'=>'right','width'=>70))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
        unset($la_data);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>450, // Ancho de la tabla
						 'maxWidth'=>450, // Ancho Máximo de la tabla
						 'xPos'=>298, // Mostrar Líneas
						 'rowGap' => 0 ,
						 'cols'=>array('codigo'=>array('justification'=>'right','width'=>460))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('neto'=>array('justification'=>'left','width'=>220))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle2($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>450, // Ancho Máximo de la tabla
						 'xPos'=>295,
						 'cols'=>array('title'=>array('justification'=>'left','width'=>470))); // Justificación y ancho de la columna
