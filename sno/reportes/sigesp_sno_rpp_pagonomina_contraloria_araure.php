...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$io_pdf->addText(105,63,7,"FIRMA / SELLO"); // Agregar el título		
		...
		$io_pdf->addText(243,63,7,"DIRECCIÓN DE ADMINISTRACIÓN"); // Agregar el título		
        $io_pdf->addText(440,121,7,"APROBADO POR:"); // Agregar el título
		$io_pdf->addText(428,63,7,"CONTRALOR MUNICIPAL"); // Agregar el título		
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3,4.5,3,3); // Configuración de los margenes en centímetros
