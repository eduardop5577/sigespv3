...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($ls_incunicon,$la_data,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    $la_config=array('showHeadings'=>1, // Mostrar encabezados
                                             ...
                                             'outerLineThickness'=>0.5,
                                                     ...
                                                     'cols'=>array('codigo'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
                                                                               'nombre'=>array('justification'=>'left','width'=>70), // Justificación y ancho de la columna
                                                                               'unidad'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
                                                                               'asignacion'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
                                                                               'deduccion'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
                                                                               'aporte'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
                                                                               'neto'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			$lb_valido=$io_report->uf_pagonomina_conceptopersonal($ls_codper,$ls_conceptocero,$ls_tituloconcepto,$ls_conceptoreporte,$ls_conceptop2,$ls_codnomdes,$ls_codperdes,$ls_codperhas); // Obtenemos el detalle del reporte
			if($lb_valido)
			{
				...
				while(!$io_report->rs_data_detalle->EOF)
				{
					...
					$li_unidad=abs($io_report->rs_data_detalle->fields["unidad"]);
                                        $li_unidad= number_format($li_unidad,2,",",".");
					switch($ls_tipsal)
					{
						case "A":
						...
						case "R":
							...
							break;
                                        ...
                                        {
                                            $la_data[$li_s]=array('codigo'=>$ls_codconc,'nombre'=>$ls_nomcon,'unidad'=>$li_unidad,'asignacion'=>$li_asignacion,
                                                                                      'deduccion'=>$li_deduccion,'aporte'=>$li_aporte,'neto'=>'');
					...
					$io_report->rs_data_detalle->MoveNext();					  
                                ...
                                uf_print_detalle($ls_incunicon,$la_data,$io_pdf); // Imprimimos el detalle  
