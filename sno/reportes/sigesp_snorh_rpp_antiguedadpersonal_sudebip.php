...
***********************************************************************************/
	...
	function uf_print_cabecera($io_pdf)
	{
		...
		$io_pdf->ezSety(720);
                ...
                $io_pdf->filledRectangle(42,697,518,$io_pdf->getFontHeight(19));
		...
		$la_data[1]=array('codigo'=>'<b>Código</b>',
						  ...
						  'mes'=>'<b>Mes</b>',
						  'dia'=>'<b>Día</b>',
                                                  'fechaap'=>'<b>Fecha Ingreso Adm. Pública</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
						 			   ...
						 			   'fechaap'=>array('justification'=>'center','width'=>70))); // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_columna=array('codigo'=>'<b>Código</b>',
						  ...
						  'mes'=>'<b>Mes</b>',
						  'dia'=>'<b>Día</b>',
                                                  'fechaap'=>'<b>Fecha Ingreso Administracion Pública</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			$ld_fecingadmpubper=$io_report->DS->data["fecingadmpubper"][$li_i];
			...
			$ld_fecingadmpubper=$io_funciones->uf_convertirfecmostrar($io_report->DS->data["fecingadmpubper"][$li_i]);
			$la_data[$li_i]=array('codigo'=>$ls_codper,'nombre'=>$ls_nomper,'cargo'=>$ls_cargo,'fecha'=>$ld_fecingper,
								  'ano'=>$li_ano,'mes'=>$li_mes,'dia'=>$li_dia,'fechaap'=>$ld_fecingadmpubper);
		}
