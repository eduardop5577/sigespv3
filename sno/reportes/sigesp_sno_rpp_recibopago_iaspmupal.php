...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,705,10,$as_desnom); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(10,$as_periodo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,330,10,$as_periodo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(10,$as_desnom);
		$tm=306-($li_tm/2);
							    ...
							    $io_cabecera,$io_pdf)
	{
		...
		$la_data[1]=array('nombre'=>'                                                             Apellidos y Nombres', 
						  'cedula'=>'Cedula','fechaingreso'=>'Fecha Ingreso','sueldo'=>'Sueldo             ');
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('cantidadasig'=>'<b>CAN</b>','denomasig'=>'<b>CONCEPTOS</b>', 'valorasig'=>'<b>ASIGNA.</b>', 
		                     'cantidaddedu'=>'<b>CAN</b>','denomdedu'=>'<b>CONCEPTOS</b>','valordedu'=>'<b>DEDUCC.</b>',
							 'valoracumulado'=>'<b></b>'));
		$la_columna=array('cantidadasig'=>'<b>CAN</b>','denomasig'=>'<b>DENOMIN.</b>',
						  'valorasig'=>'<b>ASIGNA.</b>',
						  'cantidaddedu'=>'<b>CAN</b>','denomdedu'=>'<b>DENOMIN.</b>',
						  'valordedu'=>'<b>DEDUCC.</b>',
						  'valoracumulado'=>'<b></b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 7.5,  // Tamaño de Letras de los títulos
						 ...
						 'cols'=>array('cantidadasig'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'denomdedu'=>array('justification'=>'center','width'=>215), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'valoracumulado'=>array('justification'=>'right','width'=>0))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(35,658,'10','____________________________________________________________________________________________');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
								...
								$io_cabecera,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cantidadasig'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'valoracumulado'=>array('justification'=>'right','width'=>0))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->addText(35,263,'10','____________________________________________________________________________________________');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_cabecera,'all');
	}// end function uf_print_cabecera
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cantidadasig'=>array('justification'=>'left','width'=>30), // Justificación y ancho de la columna
									   ...
									   'cantidaddedu'=>array('justification'=>'left','width'=>30), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'left','width'=>215), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'valoracumulado'=>array('justification'=>'right','width'=>0))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_pago,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('forma'=>array('justification'=>'left','width'=>175),
						 			   'cuenta'=>array('justification'=>'left','width'=>170), // Justificación y ancho de la columna
						 			   'neto'=>array('justification'=>'right','width'=>165))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,450,'10','-------------------------------------------------------------------------------------------');
		unset($la_data);
		unset($la_columna);
		unset($la_config);
