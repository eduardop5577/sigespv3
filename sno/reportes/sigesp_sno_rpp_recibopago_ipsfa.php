...
//-----------------------------------------------------  Instancia de las clases  ------------------------------------------------			
	...
	else // Imprimimos el reporte
	{
		...
		{  
			...
			//---------------------------CONCEPTOS--------------------------------------------------------------------------------
			$arrResultado=$io_report->uf_obtener_valor_concepto($ls_codper,'0000000003',$ls_valor,$li_tipo,$ls_codperiodo,$ls_codnom);//////compensaci�n
			$ls_valor=$arrResultado['as_valor'];
			$lb_valido=$arrResultado['lb_valido'];
			$ls_compensacion=$ls_valor;
			$arrResultado=$io_report->uf_obtener_valor_concepto($ls_codper,'0000000013',$ls_valor,$li_tipo,$ls_codperiodo,$ls_codnom);//////decreto 5318
			$ls_valor=$arrResultado['as_valor'];
			$lb_valido=$arrResultado['lb_valido'];
			$ls_prima_prof=$ls_valor;
			$arrResultado=$io_report->uf_obtener_valor_concepto($ls_codper,'0000000005',$ls_valor,$li_tipo,$ls_codperiodo,$ls_codnom);//////prima antiguedad empleado
			$ls_valor=$arrResultado['as_valor'];
			$lb_valido=$arrResultado['lb_valido'];
			$ls_prima_ant=$ls_valor;
			$arrResultado=$io_report->uf_obtener_valor_concepto($ls_codper,'0000000012',$ls_valor,$li_tipo,$ls_codperiodo,$ls_codnom);//////decreto 6660
			$ls_valor=$arrResultado['as_valor'];
			$lb_valido=$arrResultado['lb_valido'];
			...
			if($lb_valido)
			{
				...
				if($li_reg==1)
				{
					...
					$arrResultado=$io_report->uf_seleccionar_quincenas($ls_codper,$ls_priqui,$ls_segqui,$ls_codnom,$ls_codperiodo,$li_tipo);
