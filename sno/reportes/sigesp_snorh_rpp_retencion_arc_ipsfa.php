...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2,$unidad,$ubicacion,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(55,702,10,'<b>Datos Agentes de Retención</b>'); // Agregar el título
                ...
                $la_data[0]=array('titulo'=>'<b>Nombre</b>','descripcion'=>$_SESSION["la_empresa"]["nombre"],
                                  'titulo1'=>'<b>Unidad Administrativa</b>','descripcion1'=>$unidad);
		$la_data[1]=array('titulo'=>'<b>Dirección</b>','descripcion'=>str_pad($_SESSION["la_empresa"]["direccion"],50," "),
                                  'titulo1'=>'<b>Ubicacion Fisica</b>','descripcion1'=>$ubicacion);
		$la_data[2]=array('titulo'=>'<b>Rif</b>','descripcion'=>$_SESSION["la_empresa"]["rifemp"],
                                  'titulo1'=>'','descripcion1'=>'');
		$la_columnas=array('titulo'=>'','descripcion'=>'','titulo1'=>'','descripcion1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>40), // Justificación y ancho de la columna
                                                               'descripcion'=>array('justification'=>'left','width'=>200),
                                                               'titulo1'=>array('justification'=>'left','width'=>85), // Justificación y ancho de la columna
                                                               'descripcion1'=>array('justification'=>'left','width'=>175))); // Justificación y ancho de la columna
		$io_pdf->ezSetDy(10);
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_retencionarc_personal($la_nominas,$li_total,$ls_ano,$ls_orden,$ls_codperdes,$ls_codperhas,
                                                                $ls_codubifisdes,$ls_codubifishas,$ls_coduniadmdes,$ls_coduniadmhas); // Cargar el DS con los datos del reporte
	}
	...
	else  // Imprimimos el reporte
	{
		...
		while(!$io_report->rs_data->EOF)
		{
			...
			$unidad=$io_report->rs_data->fields["desuniadm"];
			$ubicacion=$io_report->rs_data->fields["desubifis"];
			...
			if($lb_valido)
			{
				...
				if($ls_excluir=="1")
				{
					if($lb_arc)
					{				
                                                uf_print_encabezado_pagina($ls_titulo,$ls_titulo2,$unidad,$ubicacion,$io_pdf); // Imprimimos el encabezado de la página
