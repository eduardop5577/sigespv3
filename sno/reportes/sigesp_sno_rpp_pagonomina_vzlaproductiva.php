...
***********************************************************************************/
	...
	function uf_print_firmas($io_pdf){
        ...
        $io_pdf->Rectangle(50,60,510,70); 
		$io_pdf->line(50,117,560,117);	//HORIZONTAL	
		...
		$io_pdf->addText(395,121,7,"OFICINA DE PLANIFICACIÓN Y PRESUPUESTO"); // Agregar el título
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3,5,3,3); // Configuración de los margenes en centímetros
