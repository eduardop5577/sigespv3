...
***********************************************************************************/
	...
	function uf_detalle_salario($as_data,$as_data2,$as_data3,$as_data4,$as_data5,$as_data6,$io_pdf)
	{
       ...
       $la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>131, // Orientación de la tabla						 
						 'cols'=>array('periodo'=>array('justification'=>'left','width'=>80),
						 			   'sueldo1'=>array('justification'=>'center','width'=>70))); // Justificación y ancho de la columna
		...
		$io_pdf->ezSetY(490);
       	...
       	$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>241, // Orientación de la tabla						 
						 'cols'=>array('sueldo2'=>array('justification'=>'center','width'=>70))); // Justificación y ancho de la columna
		...
		$io_pdf->ezSetY(490);
       	...
       	$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>311, // Orientación de la tabla						 						 
						 'cols'=>array('sueldo3'=>array('justification'=>'center','width'=>70))); // Justificación y ancho de la columna
		...
		$io_pdf->ezSetY(490);
       	...
       	$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>381, // Orientación de la tabla						 					 
						 'cols'=>array('sueldo4'=>array('justification'=>'center','width'=>70))); // Justificación y ancho de la columna
		...
		$la_columna=array('sueldo5'=>'');
       	$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>451, // Orientación de la tabla						 				 
						 'cols'=>array('sueldo5'=>array('justification'=>'center','width'=>70))); // Justificación y ancho de la columna
		...
		$la_columna=array('sueldo6'=>'');
       	$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xPos'=>521, // Orientación de la tabla						 					 
						 'cols'=>array('sueldo6'=>array('justification'=>'center','width'=>70))); // Justificación y ancho de la columna
