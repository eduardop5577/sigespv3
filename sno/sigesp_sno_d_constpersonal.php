...
***********************************************************************************/
	...
	$la_seguridad = Array();
	$la_permisos = Array();	
	$arrResultado=$io_fun_nomina->uf_load_seguridad_nomina("SNO","sigesp_sno_d_constpersonal.php",$ls_codnom,$ls_permisos,$la_seguridad,$la_permisos);
...
<?php 
	...
	switch ($ls_operacion) 
	{
		case "NUEVO":
			...
			$ls_esttopmod=$_GET["esttopmod"];
			$arrResultado=$io_constante->uf_load_constantepersonal($ls_codigo,$li_inicio,$li_registros,$li_totrows,$lo_object,$li_totpag,$ls_esttopmod);
