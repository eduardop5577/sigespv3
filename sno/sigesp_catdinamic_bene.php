...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print($as_cedbene, $as_nombene, $as_apebene, $as_codban, $as_tipo, $ai_nro)
   	{
		//////////////////////////////////////////////////////////////////////////////
		//	   Function: uf_print
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch($as_tipo)
				{
					...
					case "LOTE":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarlote('$ls_cedbene','$ai_nro');\">".$ls_cedbene."</a></td>";
						print "<td>".$ls_nombene."</td>";
						print "</tr>";			
						break;
				}
...
<?php
	...
	if($ls_operacion=="BUSCAR")
	{
		...
		uf_print($ls_cedbene, $ls_nombene, $ls_apebene, $ls_codban, $ls_tipo, $li_nro);
	}
	unset($io_fun_nomina);
?>
</form>      
...
<script >
  ...
  function aceptarlote(cedula,nro)
  {
		eval("opener.document.form1.txtcodproben"+nro+".value='"+cedula+"';");
		close();
  }
...
function ue_mostrar(myfield,e)
{
  ...
  function ue_search()
  {
	  ...
	  f.action="sigesp_catdinamic_bene.php?tipo=<?php print $ls_tipo;?>&nro=<?php print $li_nro;?>";
	  f.submit();
  }
</script>
</html>