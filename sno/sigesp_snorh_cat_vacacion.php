...
***********************************************************************************/
   ...
   function uf_print($as_codper,$as_codvac,$as_stavac)
   {
		...
		$ls_sql="SELECT codvac, fecvenvac, fecdisvac, fecreivac, diavac, stavac, sueintbonvac, sueintvac, diabonvac, obsvac, ".
				...
				"       diapervac, pagpersal, diavaccal, candiaadi, permisos ".
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				$li_diavaccal=$row["diavaccal"];
				$li_candiaadi=$row["candiaadi"];
				$ls_permisos=$row["permisos"];
				switch($li_stavac)
				{
				...
				print "'$li_sabdom','$li_diapag','$li_pagcan','$li_diapervac','$ls_pagpersal','$li_diavaccal','$li_candiaadi','$ls_permisos');\">".$li_codvac."</a></td>";
				...
				diavaccal,candiaadi,permisos)
{
	...
	opener.document.form1.hidcandiaadi.value=candiaadi;
	opener.document.form1.txtpermisosvac.value=permisos;
