...
***********************************************************************************/
	...
	$la_seguridad = Array();
	$la_permisos = Array();	
	$arrResultado=$io_fun_nomina->uf_load_seguridad("SNO","sigesp_sno_p_hmodificarnomina.php",$ls_permisos,$la_seguridad,$la_permisos);
   ...
   function uf_limpiarvariables()
   {
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   		...
   		global $ls_perresnom,$ls_operacion,$ls_existe,$io_fun_nomina,$io_nomina,$ls_activo_contabilizacion,$ls_estagrapo;
		...
		global $ls_recdocfid, $ls_tipdocfid, $ls_codbenfid, $ls_cueconfid,$li_genrecdocpagperche,$ls_tipdocpagperche, $li_estctaalt,$ls_recdoccaunom,$ls_tipdoccaunom;
		global $ls_codclanom, $ls_codclaapo, $ls_codclafid, $ls_codclaper, $ls_codclacau, $li_estctaaltapo; 
   ...
   function uf_load_variables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		...
   		global $ls_notdebnom,$ls_numvounom,$ls_recdocnom,$ls_tipdocnom,$ls_recdocapo,$ls_tipdocapo,$ls_estagrapo;
		global $io_fun_nomina,$io_nomina, $ls_confidnom, $ls_recdocfid, $ls_tipdocfid, $ls_cueconfid, $ls_codbenfid;
		global $li_genrecdocpagperche, $ls_tipdocpagperche,$li_estctaalt,$ls_recdoccaunom,$ls_tipdoccaunom;
		global $ls_codclanom, $ls_codclaapo, $ls_codclafid, $ls_codclaper, $ls_codclacau, $li_estctaaltapo; 		
	...
	switch ($ls_operacion) 
	{
		...
		case "GUARDAR":
			...
			$lb_valido=$io_nomina->uf_update_nomina_historico($ls_codnom,$ls_consulnom,substr($ls_descomnom,0,1),
															  ...
															  $ls_tipdocpagperche,$li_estctaalt,$ls_estagrapo,$ls_recdoccaunom,
															  $ls_tipdoccaunom,$ls_codclanom,$ls_codclaapo,$ls_codclafid,
													 		  $ls_codclaper,$ls_codclacau,$li_estctaaltapo,$la_seguridad);
			if($lb_valido)
			{
				uf_limpiarvariables();
				$ls_existe="FALSE";
			...
			else
			{
				...
				$la_tipnom=$io_fun_nomina->uf_seleccionarcombo("1-2-3-4-5-6-7-8-9",$ls_tipnom,$la_tipnom,9);	
				$la_consulnom=$io_fun_nomina->uf_seleccionarcombo("CP-OCP-OC-O",$ls_consulnom,$la_consulnom,4);	
				$la_conaponom=$io_fun_nomina->uf_seleccionarcombo("CP-OCP-OC-O",$ls_conaponom,$la_conaponom,4);	
				$la_confidnom=$io_fun_nomina->uf_seleccionarcombo("OC-OCP",$ls_confidnom,$la_confidnom,2);	
				$la_descomnom=$io_fun_nomina->uf_seleccionarcombo(" -P-B",substr($ls_descomnom,0,1),$la_descomnom,3);	
		...
		case "BUSCAR":
			...
			$li_total="1";
			$ls_informa="";
			$arrResultado=$io_nomina->load_nomina_historico($li_conta_global,$ls_existe,$ls_codnom,$ls_nombre,								  
														 ...
														 $ls_tipdocpagperche,$li_estctaalt,$ls_estagrapo,
														 $ls_recdoccaunom,$ls_tipdoccaunom);
			$ls_existe=$arrResultado['as_existe'];
			$ls_codnom=$arrResultado['as_codnom'];
			$ls_nombre=$arrResultado['as_desnom'];
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="20" colspan="11" bgcolor="#E7E7E7" class="cd-menu"><script type="text/javascript"  src="js/menu_hnomina.js"></script></td>
  </tr>
  <tr>
...
<tr>
			...
			<tr class="titulo-celdanew">
				...
				<tr>
		          ...
		          <td height="22"><input name="txttipdocnom" type="text" id="txttipdocnom" value="<?php print $ls_tipdocnom;?>" readonly>
                    <a href="javascript: ue_buscartipodocumento('NOMINA');"><img src="../shared/imagebank/tools20/buscar.gif" alt="Buscar" width="15" height="15" border="0"></a></td>
		  </tr>
				<tr>
				  <td height="22">&nbsp;</td>
				  <td height="22">&nbsp;</td>
				...
				<tr>
				  ...
				  <td height="22">
				    <div align="left">
				      <input name="chkrecdoccaunom" type="checkbox" class="sin-borde" id="chkrecdoccaunom" value="1" onChange="javascript: ue_recepcioncausanomina();" <?php if($ls_recdoccaunom=="1"){ print " checked ";} print $ls_activo_contabilizacion;?>>
				    </div>				    <div align="right"></div>			        <div align="left"></div></td>
			      <td height="22"><div align="right">Tipo de Documento Causado</div></td>
			      <td height="22"><input name="txttipdoccaunom" type="text" id="txttipdoccaunom" value="<?php print $ls_tipdoccaunom;?>" readonly>
                    <a href="javascript: ue_buscartipodocumento('CAUSADO');"><img src="../shared/imagebank/tools20/buscar.gif" alt="Buscar" width="15" height="15" border="0"></a></td>
				</tr>
                <tr>
                  <td height="22">&nbsp;</td>
                  <td height="22">&nbsp;</td>
              ...
              <tr>
                ...
                <td width="261" height="22"><div align="left">
                ...
                <td width="137" height="22"><div align="right">Generar Nota D&eacute;bito en bancos</div></td>
		  ...
		  <td>
            <div align="left">
              <input name="chkgenrecdocpagper" type="checkbox" class="sin-borde" id="chkgenrecdocpagper" value="1" onChange="javascript: ue_recepcionnominacheque();" <?php  if($li_genrecdocpagperche=="1"){print "checked";} print $ls_activo_contabilizacion;?>>          
            </div></td>
		  ...
		  <td>
			...
			<tr>
			  ...
			  <td><input name="txtcodclaper" type="text" id="txtcodclaper" value="<?php print $ls_codclaper;?>" readonly>
              ...
              <tr>
                ...
                <td height="22">Tipo de Documento Aporte</td>
                <td height="22"><input name="txttipdocapo" type="text" id="txttipdocapo" value="<?php print $ls_tipdocapo;?>" readonly>
                  <a href="javascript: ue_buscartipodocumento('APORTE');"><img src="../shared/imagebank/tools20/buscar.gif" alt="Buscar" width="15" height="15" border="0"></a></td>
              </tr>
              <tr>
			  <td height="22"><div align="right">Utilizar Cuenta Contable para el registro del Gasto por pagar</div></td>
                <td height="22">
              ...
              <tr>
                ...
                <td height="22" colspan="3"><input name="chkestagrapo" type="checkbox" class="sin-borde" id="chkestagrapo" value="1"  <?php if($ls_estagrapo=="1"){ print " checked ";}?>></td>
              </tr>
              <tr>
...
function ue_recepcionnominacheque()
{
	f=document.form1;
	if(f.chkgenrecdocpagper.checked==false)
	{
