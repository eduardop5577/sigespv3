...
$dirweb=$_SERVER['DOCUMENT_ROOT'].'/'.$_SESSION['sigesp_sitioweb'];
require_once($dirweb."/base/librerias/php/general/sigesp_lib_sql.php");  
require_once($dirweb."/base/librerias/php/general/sigesp_lib_datastore.php");
require_once($dirweb."/base/librerias/php/general/sigesp_lib_include.php");
require_once($dirweb."/base/librerias/php/general/sigesp_lib_funciones2.php");
require_once($dirweb."/base/librerias/php/general/sigesp_lib_mensajes.php");
