...
class AsigNivel extends DaoGenerico
{
	public $servidor;
	public $usuario;
	public $clave;
	...
	public function __construct() {
		parent::__construct ( 'sigesp_asig_nivel' );
...
***********************************************************************************/		
	public function leer() 
 	{	
		try
		{
			$consulta = "SELECT codemp, codasiniv, codniv, tipproc, despridoc, 1 as valido".
						"  FROM {$this->_table} ".
						" WHERE codemp='{$this->codemp}'".
						"   AND tipproc='{$this->tipproc}'";
		  	$consulta.= " ORDER BY  codasiniv, codniv";
		...
		{ 
			$this->valido  = false;	
			$this->mensaje='Error al consultar La asignacion de nivel de aprobacion '.$consulta.' '.$this->conexionbd->ErrorMsg();
