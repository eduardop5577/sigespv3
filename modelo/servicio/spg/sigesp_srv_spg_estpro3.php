...
class EstPro3 extends DaoGenerico
{
	var $_table = 'spg_ep3';
	public $valido = true;
	public $mensaje;
...
***********************************************************************************/			
	function incluirLocal()
	{
		...
		try 
		{
	   	...
	   	{
			$this->valido  = false;				
			$this->mensaje = 'Error al Incluir la Estructura Presupuestaria '.$this->codestpro1.$this->codestpro2.$this->codestpro3.$this->estcla.' '.$this->conexionbd->ErrorMsg();
		} 
