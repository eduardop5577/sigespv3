...
***********************************************************************************/			
	function incluirLocal()
	{
		...
		try 
		{
	   	...
	   	{
			$this->valido  = false;				
			$this->mensaje='Error al Incluir la Nómina '.$this->codnom.' '.$this->conexionbd->ErrorMsg();
		} 
...
***********************************************************************************/		
	public function leer() 
 	{	
		...
		{ 
			$this->valido  = false;	
			$this->mensaje='Error al consultar la Nómina '.$consulta.' '.$this->conexionbd->ErrorMsg();
