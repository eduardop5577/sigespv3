...
***********************************************************************************/
	...
	$la_proveedores=$io_analisis->uf_proveedores_item($_GET["tipsolcot"],$ls_numsolcot,$ls_coditem,$la_proveedores);//Se obtienen los proveedores que cotizaron el item seleccionado
...
<form name="formulario" method="post" action="">
  ...
  <p><?php  
		$li_totrow=count((array)$la_proveedores);
		if($li_totrow>=1)
		{
