...
$arrResultado = $io_fun_compra->uf_load_seguridad("SOC","sigesp_soc_p_solicitud_cotizacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
switch ($li_diasem){
  ...
  break;
   ...
   function uf_limpiarvariables()
   {
		...
		global $ls_codfuefin,$ls_denfuefin,$ls_disabled;
   ...
   function uf_load_variables()
   {
		...
		global $ls_codcarper,$ld_fecregsolcot,$ls_chkact,$ls_distipmat,$ls_distipact,$li_estciespg,$li_estciespi,$ls_codfuefin;
		global $ls_denfuefin;
		...
		$ld_fecregsolcot 	  = $_POST["txtfecregsolcot"];
		...
		$ls_codfuefin 	  = trim($_POST["txtcodfuefin"]);
		if($ls_codfuefin=='')
		{
			$ls_codfuefin='--';
		}
...
switch($ls_operacion)
{
  case 'GUARDAR':
            uf_load_variables();
            $arrResultado=$io_soc->uf_guardar($ls_existe,$ls_numsolcot,$ls_tipsolcot,$ls_obssolcot,$ls_consolcot,$ls_uniejeaso,$ld_fecregsolcot,
										   ...
										   $ls_telpersol,$ls_faxpersol,$ls_tipbiesol,$ls_codfuefin,$la_seguridad);
			$ls_numsolcot =	$arrResultado['as_numsolcot'];
...
?>
    <table width="800" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        <td width="118" height="22" style="text-align:right">N&uacute;mero</td>
        <td width="197" height="22"><label>
        ...
        <input name="txtfecregsolcot" type="text" id="txtfecregsolcot" style="text-align:center" value="<?php print $ld_fecregsolcot;?>" size="15"  datepicker="true" <?php echo $ls_disabled;?> onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);">
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="13" style="text-align:right">Fuente de Financiamiento </td>
        <td height="22" colspan="3"><input name="txtcodfuefin" type="text" id="txtcodfuefin" style="text-align:center" value="<?php print $ls_codfuefin;?>" size="5" maxlength="2" readonly="readonly" />
          ...
          <input name="txtdenfuefin" type="text" class="sin-borde" id="txtdenfuefin" value="<?php print $ls_denfuefin;?>" size="50" readonly="readonly" /></td>
      </tr>
      <tr>
		 ...
		 if (f.hidestciespg.value==1 || f.hidestciespi.value==1)
		 ...
		 else
		    {
			  ...
			  if (ls_catalogo=='sigesp_soc_cat_unidad_ejecutora.php')
				 ...
				 {
					if(ls_catalogo=='sigesp_soc_cat_fuente_financiamiento.php')
					{
						if(ls_codunieje=='')
						{
...
function ue_cargargrid()
{
		...
		f.hidestcla.value     = "";
		f.txtcodfuefin.value     = "";
		f.txtdenfuefin.value     = "";
		if (ls_tipsolcot=='B')
		   {
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_soc_solicitud_cotizacion.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
