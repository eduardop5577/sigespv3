		...
		if (li_totrowsep==0)
		   {
			 ...
			 parametros = parametros+"&txtnumsep1="+ls_numsep+"&txtdensep1="+ls_consep+"&txtmonsep1="+ld_monsep+"&txtunieje1="+ls_unieje+"&txtdenuni1="+ls_denuni+"&hidcodestpro1="+ls_codestpro+"&estcla1="+as_estcla+"&codestprosep1="+ls_codestpro+"&estclasep1="+as_estcla;
			 parametros = parametros+"&txtnumsep2="+""+"&txtdensep2="+""+"&txtmonsep2="+""+"&txtunieje2="+""+"&hidcodestpro2="+""+"&estcla2="+""+"&codestprosep2="+""+"&estclasep2="+"";
			 ...
			 for (i=1;i<li_totrowsep;i++)
				 {
				   ...
				   ls_codestproSEP = eval("fop.codestprosep"+i+".value");
				   ls_estclaSEP = eval("fop.estclasep"+i+".value");
				   parametros   = parametros+"&txtnumsep"+i+"="+ls_numsol+"&txtdensep"+i+"="+ls_densep+"&txtmonsep"+i+"="+ld_totsep+"&txtunieje"+i+"="+ls_codunieje+"&txtdenuni"+i+"="+ls_denunieje+"&hidcodestpro"+i+"="+ls_codestpro+"&estcla"+i+"="+ls_estcla+"&codestprosep"+i+"="+ls_codestproSEP+"&estclasep"+i+"="+ls_estclaSEP;
				 }
			 if (!lb_existe_sol)
				{
				  ...
				  ls_uniejeaso = fop.txtuniejeaso.value;
				  ls_codestproSEP2 = as_codestpro1+as_codestpro2+as_codestpro3+as_codestpro4+as_codestpro5;
				  ls_uniejeaso = ls_uniejeaso+" - "+"Nro. SEP = "+ls_numsep+". Unidad Ejecutora :"+ls_unieje+" - "+ls_denuni+";";
				  fop.txtuniejeaso.value = ls_uniejeaso;
				  parametros = parametros+"&txtnumsep"+i+"="+ls_numsep+"&txtdensep"+i+"="+ls_consep+"&txtmonsep"+i+"="+ld_monsep+"&txtunieje"+i+"="+ls_unieje+"&txtdenuni"+i+"="+ls_denuni+"&hidcodestpro"+i+"="+ls_codestpro+"&estcla"+i+"="+ls_estcla+"&codestprosep"+i+"="+ls_codestproSEP2+"&estclasep"+i+"="+ls_estcla;
...
<script type="text/javascript"  src="js/funcion_soc.js"></script></html>