...
***********************************************************************************/
	...
	$la_calificadores=$io_analisis->uf_analisis_cualitativo_items($la_calificadores);
	$la_items=array_keys($la_calificadores);
...
<html>
<head>
<title>An&aacute;lisis Cualitativo Items</title>
...
<form name="formulario" method="post" action="">
  ...
  <table height="107" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco" style=" overflow:scroll">
    <tr class="titulo-nuevo">
      ...
      <div align="center">
        <p>An&aacute;lisis Cualitativo por &Iacute;tem </p>
        </div></th>
    </tr>
    <tr>
          ...
          <?php
		 		for($li_i=0;$li_i<$li_totalitems;$li_i++)
				{
             		...
             		for($li_j=1;$li_j<=$li_totalcotizaciones;$li_j++)
					{
						...
						$ls_calificadores=$la_calificadores[$ls_item][$ls_nompro];	
 						print "<td class=formato-blanco width=100><div align=right>".$ls_calificadores."</div></td>";
					}
            		print "</tr>";         
				}  
		  ?>		        
