...
$arrResultado = $io_fun_compra->uf_load_seguridad("SOC","sigesp_soc_r_articulos.php",$ls_permisos,$la_seguridad,$la_permisos);
$ls_permisos = $arrResultado['as_permisos'];
$la_seguridad = $arrResultado['aa_seguridad'];
$la_permisos = $arrResultado['aa_permisos'];

$ls_reporte = $io_fun_compra->uf_select_config("SOC","REPORTE","ARTICULO_DETALLADO","sigesp_soc_rpp_articulo_detallado.php","C");
...
<title>Reporte de Compras de Articulos Detallado</title>
...
<div align="center">
    ...
    <table width="543" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
        <td height="22" colspan="6" class="titulo-ventana"><input name="operacion" type="hidden" id="operacion" value="<?php print $ls_operacion ?>" />
          Reporte de Compras de Articulos Detallado
      ...
      <tr>
        <td height="22" colspan="6" style="text-align:center"><table width="490" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="4" style="text-align:left"><div align="left"><strong>Articulos </strong></div></td>
          </tr>
          <tr class="formato-blanco">
            <td width="44" style="text-align:right"> Desde</td>
            <td width="196" style="text-align:left"><span class="Estilo2">
            ...
            <td width="46" style="text-align:right"><span style="text-align:left">Hasta</span></td>
            <td width="202" style="text-align:left"><span class="Estilo2">
  ...
  <p>  <div id="ordenes" align="center"></div>
  </form>
</p>
</div>
</body>
...
f = document.formulario;
	...
	function ue_buscar()
	{
		...
		if((ls_fecordcomdes!="")&&(ls_fecordcomhas!=""))
		{
			...
			ajax.send("txtnumordcomdes="+ls_numordcomdes
					 ...
					 +"&rdemi="+rdemi+"&rdpre="+rdpre+"&rdcon="+rdcon+"&rdanu="+rdanu+"&rdinv="+rdinv+"&rdent="+rdent
...
function ue_imprimir()
{
	...
	ls_codarthas    = f.txcodtarthas.value;
		...
		if((ls_fecordcomdes!="")&&(ls_fecordcomhas!=""))
		{
			...
			pagina="reportes/"+ls_reporte+"?txtnumordcomdes="+ls_numordcomdes
							 +"&txtnumordcomhas="+ls_numordcomhas+"&txtcodprodes="+ls_codprodes+"&txtcodprohas="+ls_codprohas
...
function ue_openexcel()
{
	...
	ls_codarthas    = f.txcodtarthas.value;
		...
		if((ls_fecordcomdes!="")&&(ls_fecordcomhas!=""))
		{
			ls_reporte  = "sigesp_soc_rpp_articulo_detallado_excel.php";
			pagina="reportes/"+ls_reporte+"?txtnumordcomdes="+ls_numordcomdes
							 +"&txtnumordcomhas="+ls_numordcomhas+"&txtcodprodes="+ls_codprodes+"&txtcodprohas="+ls_codprohas
							 +"&txtfecordcomdes="+ls_fecordcomdes+"&txtfecordcomhas="+ls_fecordcomhas
							 +"&txtcoduniejedes="+ls_coduniejedes+"&txtcoduniejehas="+ls_coduniadmhas
