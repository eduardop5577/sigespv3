...
function ue_aceptar_bienes_orden_compra(as_codart,as_denart,as_unidad,as_spg_cuenta,ai_precio,ai_totalcargos,ai_existecuenta,ad_mondiscta)
{
	...
	parametros=parametros+"&txtcodart"+rowbienes+"="+as_codart+"&txtdenart"+rowbienes+"="+as_denart+""+
			   ...
			   "&totalbienes="+totalbienes+"&hidcodestpro"+rowbienes+"="+ls_codestpre+"&estcla"+rowbienes+"="+ls_estclauni+"&txtcodfuefin"+rowbienes+"="+codfuefin;
	//---------------------------------------------------------------------------------
	...
	parametros=parametros+"&txtcodservic="+as_codart+"&totalcargos="+totalcargos+"&txtcodfuefincre="+codfuefin+"&cargarcargos=0";
