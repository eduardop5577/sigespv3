...
function ue_aceptar(as_codser,as_denser,ad_mondiscta)
{
	...
	{
		alert("No hay Disponibilidad en la Estructura "+ls_codestpromen+", asociada a la Solicitud");
		 valido = false;
	}
	...
	{ 
		...
		ls_estclaSEP    = eval("opener.document.formulario.estclasep"+j+".value");
	    ls_codestproSEP = eval("opener.document.formulario.codestprosep"+j+".value");
		
		parametros = parametros+"&txtnumsep"+j+"="+ls_numsep+"&txtdensep"+j+"="+ls_densep+"&txtmonsep"+j+"="+ld_monsep+"&txtunieje"+j+"="+ls_unieje+"&txtdenuni"+j+"="+ls_denuni+"&codestprosep"+j+"="+ls_codestproSEP+"&estclasep"+j+"="+ls_estclaSEP;
	}
...
function ue_aceptar_servicio_orden_compra(as_codser,as_denser,ai_precio,as_spg_cuenta,ai_existecuenta,ad_mondiscta)
{
	...
	ls_codestpro4 = opener.document.formulario.txtcodestpro4.value;
	ls_codestpro5 = opener.document.formulario.txtcodestpro5.value;
	codfuefin = opener.document.formulario.txtcodfuefin.value;
    if(li_estmodest==1)
	{
        ls_codestpromen = ls_codestpro1.substr(25-li_loncodestpro1)+"-"+ls_codestpro2.substr(25-li_loncodestpro2)+"-"+ls_codestpro3.substr(25-li_loncodestpro3);
	}
	...
	for(j=1;(j<rowservicios)&&(valido);j++)
	{
		...
		ls_codfuefin = eval("opener.document.formulario.txtcodfuefin"+j+".value");
		...
		parametros=parametros+"&txtcodser"+j+"="+codser+"&txtdenser"+j+"="+denser+""+
				   ...
				   "&txttotser"+j+"="+totser+"&txtspgcuenta"+j+"="+spgcuenta+"&txtcoduniadmsep"+j+"="+ls_codunieje+"&txtcodfuefin"+j+"="+ls_codfuefin;
	}
	totalservicios=eval(rowservicios+"+1");
	parametros=parametros+"&txtcodser"+rowservicios+"="+as_codser+"&txtdenser"+rowservicios+"="+as_denser+""+
			   ...
			   "&estcla"+rowservicios+"="+ls_estclauni+"&txtcodfuefin"+rowservicios+"="+codfuefin;
	//---------------------------------------------------------------------------------
	...
	for(j=1;(j<=rowcargos)&&(valido);j++)
	{
		...
		ls_codfuefin=eval("opener.document.formulario.txtcodfuefincre"+j+".value"); 
		...
		parametros=parametros+"&txtcodservic"+j+"="+codservic+"&txtcodcar"+j+"="+codcar+
				   ...
				   +"&codprogcargo"+j+"="+codprogcargo+"&estclacargo"+j+"="+estclacargo+"&txtcodfuefincre"+j+"="+ls_codfuefin;
	}
	totalcargos=eval(rowcargos);
	parametros=parametros+"&txtcodservic="+as_codser+"&totalcargos="+totalcargos+"&estclacargo="+ls_estclauni+"&txtcodfuefincre="+codfuefin;
	//---------------------------------------------------------------------------------
	...
	parametros=parametros+"&tipconpro="+tipconpro+"&codprounidad="+ls_codestpro1+ls_codestpro2+ls_codestpro3+ls_codestpro4+ls_codestpro5+"&estcla="+ls_estclauni+"&tipsol="+ls_tipsol+"&cargarcargos=0";
	if((parametros!="")&&(valido))
	{
		// Div donde se van a cargar los resultados
		divgrid = opener.document.getElementById("bienesservicios");
