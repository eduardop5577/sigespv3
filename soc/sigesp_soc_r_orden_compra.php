...
$arrResultado = $io_fun_compra->uf_load_seguridad("SOC","sigesp_soc_r_orden_compra.php",$ls_permisos,$la_seguridad,$la_permisos);
      ...
      <tr>
        <td height="13" colspan="6"><table width="490" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td><input name="rdent" type="checkbox" class="sin-borde" id="rdent" value="1" />
              Servicio Entregado </td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_soc_reporte_ordencompra.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
