...
***********************************************************************************/
	...
	$arrResultado = $io_detcot->uf_select_cotizacion($ls_numcot,$ls_codpro,$ls_numsolcot,$la_cotizacion,$la_dt_cotizacion);
	$la_cotizacion = $arrResultado['la_cotizacion'];
	$la_dt_cotizacion = $arrResultado['la_dt_cotizacion'];
    ...
    <tr>
	  ...
	  <?php 
	   		if($la_cotizacion["tipsolcot"]=="B")
				...
				$ls_titulo="Servicios";
	  		$io_grid->makegrid(count((array)$la_dt_cotizacion),$la_titulos,$la_dt_cotizacion,770,$ls_titulo,"grid");
	  ?></th>
