...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_compra->uf_load_seguridad("SOC","sigesp_soc_p_registro_cotizacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
switch ($li_diasem){
  ...
  break;
   ...
   function uf_limpiarvariables()
   {
        ...
        global $ls_codemp,$ls_numcot,$ls_tipcot,$ld_fecregcot,$ls_codpro,$ls_nompro,$ls_tipconpro,$ls_obscot,$li_diaent;
		global $ls_forpag,$ls_estatus,$ls_existe,$ls_numsolcot,$ls_estcot,$ls_parametros,$li_estinciva;
		global $ld_poriva,$ls_operacion,$li_estciespg,$li_estciespi,$ls_disabled,$li_diavalofe,$ls_garanacot,$ls_si1;
		global $ls_no1,$ls_si2,$ls_no2,$ls_disabled;
   ...
   function uf_load_variables()
   {
		...
		// Fecha Creación: 16/05/2007			Fecha Última Modificación : 16/05/2007
		//////////////////////////////////////////////////////////////////////////////
        global $li_totrowbienes,$li_totrowservicios,$ld_subtotal,$ld_creditos,$ld_total,$ld_fecregcot,$ls_numsolcot;		
		...
		$ld_fecregcot 		= $_POST["txtfecregcot"];
...
switch($ls_operacion)
{
  case 'GUARDAR':
			...
			uf_load_variables();
			$arrResultado=$io_soc->uf_guardar($ls_existe,$ld_fecregcot,$ls_numcot,$ls_numsolcot,$ls_tipcot,$ls_obscot,$li_totrowbienes,$li_totrowservicios,$ls_estcot,
					                       	  $ls_forpag,$ls_codpro,$li_diaent,$ld_poriva,$ld_subtotal,$ld_creditos,$ld_total,$li_estinciva,$la_seguridad,$li_diavalofe,
											  $ls_estasitec,$ls_estesp,$ls_garanacot);
			$ls_numcot = $arrResultado['as_numcot'];
			$ls_estcot = $arrResultado['as_estcot'];
...
?>
    <table width="800" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="22"><label>
		 <input name="txtfecregcot" type="text" id="txtfecregcot" style="text-align:center" value="<?php print $ld_fecregcot;?>" size="15"  datepicker="true" <?php echo $ls_disabled;?> onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);">          
        </label></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <input name="txtgarantias" type="text" id="txtgarantias" value="<?php print $ls_garanacot; ?>" size="50"></td>
        </td>  
      </tr>
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_soc_registro_cotizacion.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
