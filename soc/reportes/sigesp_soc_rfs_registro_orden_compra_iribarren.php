...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
        ...
        else
        {
			 ...
			 $ls_titulo_grid="Servicios";
                ...
                $ls_firma1 = "Lcda. Marisol Chacín Montoya";
                $ls_firma2 = "Lcda. Gloria N. Marin L.";
                $io_firmas->cargarFirmasDinamicas();
		if ($io_firmas->existe)
                {
                    $ls_firma1 = $io_firmas->fir1;
                    $ls_firma2 = $io_firmas->fir2;
                }    
		...
		$io_pdf->addText(25,139,7,"UNIDAD CONTRATANTE:"); // Agregar el título
		$io_pdf->addText(25,128,7,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(120,128,7,"REVISADO POR:"); // Agregar el título
		$io_pdf->line(115,60,115,135);	//VERTICAL
		$io_pdf->line(235,60,235,148);	//VERTICAL
		$io_pdf->addText(240,139,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(253,77,6,$ls_firma1); // Agregar el título
		$io_pdf->addText(250,70,6,"Jefe Div. Compras y Suministros"); // Agregar el título
		$io_pdf->addText(241,63,5,"RESN RRHH-035-2018 GMO No. 207 26-02-2018"); // Agregar el título
		$io_pdf->line(355,60,355,148);	//VERTICAL		
		$io_pdf->addText(360,139,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(385,77,6,$ls_firma2); // Agregar el título
		$io_pdf->addText(367,70,6,"Dir. (E) de Admimistracion y Finanzas"); // Agregar el título
		$io_pdf->addText(361,63,5,"RESN RRHH-011-2018 GMO No. 201 15-01-2018"); // Agregar el título
		$io_pdf->line(480,60,480,148);	//VERTICAL		
		$io_pdf->addText(485,139,7,"PROVEEDOR"); // Agregar el título
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-10);
		$la_datatitulo[1]=array('columna1'=>'<b> Descripción de '.$ls_titulo_grid.'</b>');
		$la_columnas=array('columna1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_detalle_cuentas($la_data,$io_pdf)
	{
		...
		if($ls_estmodest==1)
		{
			$ls_titulo="Centro Gestor";
		}
		else
		{
			$ls_titulo="Estructura Programatica";
		}
		$la_datatit[1]=array('titulo'=>'<b> Imputación Presupuestaria </b>');
	...
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,$ls_monlet,$io_pdf)
	{
		...
		$la_data[1]=array('titulo'=>'<b>Base Imponible '.$ls_bolivares.'</b>','contenido'=>$li_subtot,);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
		...
		unset($la_columnas);
		unset($la_config);
		$la_data[1]=array('titulo'=>'<b>I.V.A. '.$ls_bolivares.'</b>','contenido'=>$li_totcar,);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
	...
	function uf_print_detalle_clausulas($la_data,$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-10);
		$la_dataclausulas[1]=array('dencla'=>"CLAUSULAS");
	...
	require_once("../../base/librerias/php/general/sigesp_lib_firmas.php");
	...
	$io_firmas    = new firmasDinamicas($con);
	...
	$rs_data= $arrResultado['rs_data'];
        ...
        $io_firmas    = new firmasDinamicas('SOC', $SESSION['codusu'], SUBSTR($ls_numordcom,0,6), $rs_data->fields['coduniadm'], '', $tipordcom);
