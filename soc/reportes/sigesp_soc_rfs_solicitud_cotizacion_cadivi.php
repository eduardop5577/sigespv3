...
***********************************************************************************/
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		unset($la_config);		
		$io_pdf->ezSetDy(-20);
		$la_data=array(array('name'=>'     Le  informamos que la validez de  esta solicitud de  cotizacion es desde la presente fecha, y el plazo de entrega en caso de ser seleccionado es de <b> 1 semana </b> a partir del envio de la orden de compra. Los números de teléfonos y fax para enviarnos la oferta o para   aclaratorias   son   606-30-21  /  606-39-67. Adicionalmente   tambien  se  puede  contactarnos por  el correo cvillaparedes@cadivi.gob.ve'),
	                	  array('name'=>'     En caso de <b>no poder cotizar</b> agradecemos nos remita dicha información por escrito haciendo referencia a esta solicitud.'),
						  array('name'=>''));
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
		...
		$io_pdf->ezSetDy(-20);
		$la_data=array(array('name'=>'Atentamente,'),
	                	  array('name'=>''),
	                	  array('name'=>''),
						  array('name'=>'Departamento de Compras'));
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'showLines'=>0, // Mostrar Líneas
		...
		$io_pdf->ezSetDy(-20);
		$la_data=array(array('name'=>'<b>Razón Social: </b>'.$ls_nombre),
	                	  array('name'=>'<b>Dirección Fiscal: </b>'.$ls_direccion));
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'showLines'=>0, // Mostrar Líneas
