...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						...
						$as_uniaso,$io_pdf)
	{
		...
		$io_pdf->line(15,129,585,129);	//HORIZONTAL	
		$io_pdf->line(15,119,585,119);	//HORIZONTAL	
		$io_pdf->addText(45,132,6,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(18,122,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(18,63,6,"COORD. DE COMPRAS Y SUMINISTROS"); // Agregar el título
		$io_pdf->addText(55,73,6,"Firma y Sello"); // Agregar el título
		$io_pdf->line(140,60,140,140);	//VERTICAL	
		$io_pdf->addText(173,132,6,"APROBADO POR:"); // Agregar el título
		$io_pdf->addText(143,122,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(143,63,6,"COORD. DE COMPRAS Y SUMINISTROS"); // Agregar el título
		$io_pdf->addText(178,73,6,"Firma y Sello"); // Agregar el título
		$io_pdf->line(265,60,265,140);	//VERTICAL		
		$io_pdf->addText(280,132,6,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(268,122,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(268,63,6,"OFICINA DE ADMIN. Y SERVICIOS"); // Agregar el título
		$io_pdf->addText(298,73,6,"Firma y Sello"); // Agregar el título
		$io_pdf->line(370,60,370,140);	//VERTICAL		
		$io_pdf->addText(390,132,6,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(373,122,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(400,63,6,"DESPACHO"); // Agregar el título
		$io_pdf->addText(400,73,6,"Firma y Sello"); // Agregar el título
		$io_pdf->line(470,60,470,140);	//VERTICAL		
		$io_pdf->addText(505,132,6,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(473,122,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(505,73,6,"Firma y Sello"); // Agregar el título
