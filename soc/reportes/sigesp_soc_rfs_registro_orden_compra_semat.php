...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(18,63,7,"UNIDAD DE COMPRAS Y SERVICIOS"); // Agregar el título
		$io_pdf->line(145,60,145,130);	//VERTICAL	
		$io_pdf->addText(192,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(148,63,7,"GERENTE DE ADMINISTRACION Y FINANZAS"); // Agregar el título
		$io_pdf->line(303,60,303,130);	//VERTICAL		
		$io_pdf->addText(333,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(330,63,7,"GERENTE GENERAL"); // Agregar el título
		$io_pdf->line(430,60,430,130);	//VERTICAL		
		$io_pdf->addText(480,122,7,"PROVEEDOR"); // Agregar el título
