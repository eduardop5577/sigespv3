...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.'logo.jpg',20,715,450,42); // Agregar Logo 
		if ($as_estcom=='3')
		{
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,708,14,$ls_titulo); // Agregar el título
		...
		$io_pdf->addText(40,63,7,"ANALISTA DE COMPRAS"); // Agregar el título
		...
		$io_pdf->addText(290,63,7,"DIRECTOR DE ADMINISTRACION"); // Agregar el título
		$io_pdf->line(410,60,410,130);	//VERTICAL		
		$io_pdf->addText(470,122,7,"DISPONIBILIDAD"); // Agregar el título
		$io_pdf->addText(440,63,7,"PLANIFICACION Y PRESUPUESTO"); // Agregar el título
		$io_pdf->line(15,73,585,73); //HORIZONTAL		
			$io_pdf->addText(250,53,5,"FUNDACION INSTITUTO DE ESTUDIOS AVANZADOS-IDEA"); // Agregar el título
     $io_pdf->addText(180,47,5,"DIRECCION: CARRETERA HOYO DE LA PUERTA-BARUTA, VALLE DE SARTENEJA EDO-MIRANDA RIF G-20005439-5"); // Agregar el título
  $io_pdf->addText(170,41,5,"TELEFONOS: 0212-9035020-9035150 - 9035080 FAX 0212-9035013 CORREO ELECTRONICO: compras.idea502@gmail.com"); // Agregar el título
