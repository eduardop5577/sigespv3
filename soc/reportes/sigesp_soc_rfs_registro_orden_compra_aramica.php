...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->line(470,700,470,760);
		$io_pdf->line(470,730,585,730);
		...
		$io_pdf->addText(475,740,9," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(475,710,9,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		...
		$io_pdf->line(395,60,395,120);		
		$io_pdf->line(490,60,490,130);		

        $io_pdf->Rectangle(15,60,570,70); 
		$io_pdf->addText(35,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(20,68,7,"ANALISTA DE COMPRAS"); // Agregar el título
		$io_pdf->addText(120,122,7,"SUPERVISADO POR"); // Agregar el título
		$io_pdf->addText(120,68,7,"COORD. COMPRAS"); // Agregar el título
		$io_pdf->addText(220,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(215,73,7,"OFIC. PLAN. PRES Y "); // Agregar el título
		$io_pdf->addText(212,63,7,"CONTROL DE GESTION"); // Agregar el título
		$io_pdf->addText(310,68,7,"ADMIN. Y FINANZAS"); // Agregar el título
		$io_pdf->addText(365,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(418,68,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(515,122,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(508,68,7,"FIRMA / SELLO"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(7,"ARAGUA MINAS Y CANTERAS (ARAMICA) S.A.");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,750,7,"ARAGUA MINAS Y CANTERAS (ARAMICA) S.A."); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(7,"Rif: G-20010824-0");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,742,7,"Rif: G-20010824-0"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(7,"Calle Yaracuy cruce con Av. Mariño Sur Local 201 ");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,734,7,"Calle Yaracuy cruce con Av. Mariño Sur Local 201"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(7,"Sector San Ignacio Maracay - Aragua");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,726,7,"Sector San Ignacio Maracay - Aragua"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(7,"Telefonos: 0243-2475733/Fax 0243-2461067");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,718,7,"Telefonos: 0243-2475733/Fax 0243-2461067"); // Agregar el título
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>105), // Justificación y ancho de la columna
