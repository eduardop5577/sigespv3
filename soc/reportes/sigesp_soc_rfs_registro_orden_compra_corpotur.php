...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(35,137,7,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(45,129,7,"SERVICIOS"); // Agregar el título
		$io_pdf->addText(42,121,7,"GENERALES"); // Agregar el título
		$io_pdf->addText(40,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->line(125,60,125,145);	//VERTICAL	
		$io_pdf->addText(150,134,7,"VERIFICADO POR:"); // Agregar el título
		$io_pdf->addText(155,126,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(155,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->line(235,60,235,145);	//VERTICAL	
		$io_pdf->addText(265,137,7,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(268,129,7,"GERENCIA DE"); // Agregar el título
		$io_pdf->addText(263,121,7,"ADMINISTRACIÓN"); // Agregar el título
		$io_pdf->addText(270,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->line(350,60,350,145);	//VERTICAL		
		$io_pdf->addText(375,137,7,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(380,129,7,"PRESIDENCIA / G."); // Agregar el título
		$io_pdf->addText(388,121,7,"GENERAL"); // Agregar el título
		$io_pdf->addText(380,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->line(465,60,465,145);	//VERTICAL		
		$io_pdf->addText(500,129,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(498,63,7,"FIRMA / SELLO"); // Agregar el título
