...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_numanacot,$observacion,$ad_fecha,$io_pdf)
	{
		...
		$io_pdf->Rectangle(30,30,730,70);
		$io_pdf->line(30,42,760,42);	//VERTICAL
		$io_pdf->line(30,88,760,88);	//VERTICAL
		$io_pdf->addText(85,90,8,"<b>ELABORADO  POR:</b>");
		$io_pdf->addText(90,32,8,"<b>COMPRADOR</b>");
		$io_pdf->line(218,30,218,100);	//VERTICAL
		$io_pdf->addText(304,90,8,"<b>REVISADO POR:</b>");
		$io_pdf->addText(283,32,8,"<b>SUPERVISOR DE COMPRAS</b>");
		$io_pdf->line(450,30,450,100);	//VERTICAL
		$io_pdf->addText(570,90,8,"<b>AUTORIZADO POR:</b>");
		$io_pdf->addText(535,32,8,"<b>RESP. AREA DE BIENES Y SUMINISTROS</b>");*/
	...
	function uf_print_pie_pagina($io_pdf)
	{
		...
		$io_pdf->Rectangle(30,30,730,70);
		$io_pdf->line(30,88,760,88);	//VERTICAL
		$io_pdf->addText(75,90,8,"<b>Elaborado  por:</b>");
		$io_pdf->addText(55,43,8,"<b>Coordinadora de Compras</b>");
		$io_pdf->addText(70,33,8,"<b>Lic. Erika Milano</b>");
		$io_pdf->line(180,30,180,100);	//VERTICAL
		$io_pdf->addText(244,90,8,"<b>Conformado por:</b>");
		$io_pdf->addText(205,43,8,"<b>Gerente de Administración y Finanzas</b>");
		$io_pdf->addText(240,33,8,"<b>Lic. Yaritza Toro</b>");
		$io_pdf->line(380,30,380,100);	//VERTICAL
		$io_pdf->addText(550,90,8,"<b>Aprobado por:</b>");
		$io_pdf->line(570,30,570,87);	//VERTICAL
		$io_pdf->addText(450,43,8,"<b>Vicepresidente</b>");
		$io_pdf->addText(430,33,8,"<b>Ing. Abdías Peón García</b>");
		$io_pdf->addText(650,43,8,"<b>Presidente</b>");
		$io_pdf->addText(585,33,8,"<b>Gnral. Bgda.(GN) Pedro Castro Rodríguez</b>");
	}// end function uf_print_encabezado_pagina
	//--------------------------------------------------------------------------------------------------------------------------------
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	//$io_pdf->ezSetCmMargins(0,3,2,2); // Configuración de los margenes en centímetros
	...
	if($lb_valido)
	{
		...
		$la_cotizaciones="";
		$arrResultado=$io_class_report->uf_cargar_cotizaciones($ls_numanacot, $la_cotizaciones);
