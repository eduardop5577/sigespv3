...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$as_denmon,$as_tipsiscam,$ad_tasa,$ad_mondiv,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(482,740,8.5," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(482,710,8.5,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		...
		$la_data[1]=array('columna1'=>'<b>Tipo de Moneda</b>   '.$as_denmon,'columna2'=>'<b> Tasa de Cambio</b>    '.$ad_tasa);
		$la_data[2]=array('columna1'=>'<b>Monto en Divisas</b>   '.$ad_mondiv,'columna2'=>'<b> Sistema Cambiario</b>    '.$as_tipsiscam);
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>85), // Justificación y ancho de la columna
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_estcom,$ls_denmon,$ls_tipsiscam,$ld_tasa,$ld_mondiv,$io_pdf);
