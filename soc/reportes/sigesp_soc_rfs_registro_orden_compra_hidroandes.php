...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(18,122,7,"ELABORADO POR: COMPRAS"); // Agregar el título
		$io_pdf->line(129,60,129,130);	//VERTICAL	
		$io_pdf->addText(152,122,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(152,63,7,"LCDA. KEILA MEJIA"); // Agregar el título
		$io_pdf->line(243,60,243,130);	//VERTICAL		
		$io_pdf->addText(244,122,6.5,"CERTIFICACION PRESUPUESTARIA"); // Agregar el título
		$io_pdf->addText(260,63,7,"LCDO. MARIO SIMBOLO "); // Agregar el título
		$io_pdf->line(357,60,357,130);	//VERTICAL		
		$io_pdf->addText(390,122,7,"PRESIDENTE"); // Agregar el título
		$io_pdf->addText(370,63,7,"ING. CARLOS G. MAST Y."); // Agregar el título
		$io_pdf->line(471,60,471,130);	//VERTICAL		
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>95), // Justificación y ancho de la columna
						 			   ...
						 			   'baseimp'=>array('justification'=>'right','width'=>50), // Justificación y ancho de la columna
						 			   'cargo'=>array('justification'=>'right','width'=>50), // Justificación y ancho de la columna
						 			   'montot'=>array('justification'=>'right','width'=>55))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
	...
	function uf_print_detalle_cuentas($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codestpro'=>array('justification'=>'center','width'=>130), // Justificación y ancho de la columna
						 			   'cuenta'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'denominacio'=>array('justification'=>'center','width'=>300), // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,$ls_monlet,$ls_obsordcom	,$io_pdf)
	{
		...
		unset($la_config);
		$io_pdf->ezSetDy(-10);
		$ls_cumplimiento="Para asegurar el cumplimiento de todas las obligaciones que asume el contratista, con ocasión del contrato para la adquisicion de bienes, ";
		$ls_cumplimiento.="prestación de servicio o ejecución de obra, cuando se requiera, este deberá construir una garantía a satisfacción del contratante, que no podra ";
		$ls_cumplimiento.="ser inferior al (20%) del monto del contrato, incluyendo tributos.";
		$ls_penal="De las penalidades contando a partir de la suscripción del instrumento contractual 'LA CONTRATISTA' deberá pagar 'AL CONTRATANTE' por cada dia o fracción ";
		$ls_penal.=" de retardo de entrega del bien, la totalidad del 1% diario sobre el valor del contrato, hasta un maximo de cinco por ciento (5%) 'EL CONTRATANTE' no ";
		$ls_penal.="aceptará como tiempo de retardo en los servicios de comida y alimentos de bebida, lo anterior comprende la indeterminación por el daño emergente que el ";
		$ls_penal.="incumplimiento antes referido. Si por razones de fuerza mayor o casos fortuitos 'LA CONTRATISTA' no pudiere cumplir con el objeto del contrato no habra ";
		$ls_penal.="pago de penalidad alguna.";
		$ls_especial="Podrá acordarse con 'LA CONTRATISTA' una garantía constituida por la retención del diez por ciento (10%), sobre los pagos que se realicen, cuyo monto ";
		$ls_especial.="total retenido será reintegrado al momento de la recepción definitiva del bien u obra o terminación del servicio.";
		$la_data[1]=array('columna1'=>'<b>GARANTIA DE FIEL CUMPLIMIENTO </b>',
		                  'columna2'=>'<b>CLAUSULA PENAL </b>',
		                  'columna3'=>'<b>CLAUSULA ESPECIAL </b>');
		$la_data[2]=array('columna1'=>$ls_cumplimiento,
		                  'columna2'=>$ls_penal,
		                  'columna3'=>$ls_especial);
		$la_columnas=array('columna1'=>'',
						   'columna2'=>'',
						   'columna3'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 5.5, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'center','width'=>160), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'center','width'=>275),
									   'columna3'=>array('justification'=>'center','width'=>135))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
		$la_data[1]=array('titulo'=>'<b> OBSERVACION: </b>'.$ls_obsordcom);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
