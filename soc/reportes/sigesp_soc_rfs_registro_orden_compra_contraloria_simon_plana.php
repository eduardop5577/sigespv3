...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$ls_lugentre,$ls_cotizaciones,$ls_observaciones,$io_pdf)
	{
		...
		if($as_estcondat=="B") 
        {
			 ...
			 $io_pdf->addText(163,712,10,$ls_titulo); // Agregar el título
        }
        else
        {
             $ls_titulo2="X";
			 $ls_titulo_grid="Servicios";
			 $io_pdf->addText(163,698,10,$ls_titulo2); // Agregar el título
        }
		...
		$io_pdf->addText(504,720,9,$dia."     ".$mes."       ".$anio); // Agregar el título
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>350), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'center','width'=>220))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>65), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>505))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>145), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'center','width'=>190), // Justificación y ancho de la columna
									   'columna3'=>array('justification'=>'left','width'=>215))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>220))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cantidad'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
									   ...
									   'denominacion'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'cosuni'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la columna
	...
	function uf_print_detalle_cuentas($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'rowGap' =>3,
						 'cols'=>array('pro1'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
						 			   'pro2'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
									   'pro3'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
									   'pro4'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
									   'pro5'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
