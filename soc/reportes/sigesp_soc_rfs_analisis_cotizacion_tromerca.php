...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_numanacot,$observacion,$ad_fecha,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_ver_tromerca.jpg',15,550,740,40); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/barra_inf_ver_tromerca.jpg',15,15,740,40);
		$io_pdf->add_texto(120,27,11,"<b>Análisis de Cotizaciones</b>");
		$io_pdf->add_texto(250,22,8,"$ad_fecha");		
		$la_data[0]["1"]="<b>Nro.:</b>";
