...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
	                                   $as_denfuefin,$as_codigo,$as_nombre,$as_conordcom,$as_rifpro,$as_telpro,$as_diaplacom,$as_dirpro,
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$as_numcot,$as_feccot,$as_numsep,$as_fecsep,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->line(120,700,120,760);
		$io_pdf->Rectangle(15,700,570,60);
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],30,705,70,50); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/cmsp2.jpg',500,705,60,50); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		if($as_estcondat=="B") 
        {
             $ls_titulo="<b>Orden de Compra</b>";	
			 $ls_titulo_grid="Bienes";
        }
        else
        {
             $ls_titulo="<b>Orden de Servicio</b>";
			 $ls_titulo_grid="Servicios";
        }
		$li_tm=$io_pdf->getTextWidth(14,$ls_titulo);
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,730,14,$ls_titulo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(10,"<b>No. </b>".$as_numordcom);
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,715,10,"<b>No. </b>".$as_numordcom); // Agregar el título
		
		$io_pdf->ezSetY(695);
		$la_data[1]=array('columna1'=>'<b>Fecha de Elaboración</b>','columna2'=>'<b>Nº Requisición</b>','columna3'=>'<b>Fecha Requisición</b>',
						  'columna4'=>'<b>Nº Cotización</b>','columna5'=>'<b>Fecha de Inicio del Proceso</b>');
		$la_data[2]=array('columna1'=>date("d/m/Y"),'columna2'=>$as_numsep,'columna3'=>$as_fecsep,
						  'columna4'=>$as_numcot,'columna5'=>$as_feccot);
		$la_columna=array('columna1'=>'','columna2'=>'','columna3'=>'','columna4'=>'','columna5'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>110), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>100),
									   'columna3'=>array('justification'=>'left','width'=>110),
									   'columna4'=>array('justification'=>'left','width'=>100),
									   'columna5'=>array('justification'=>'left','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		$ls_uniadm=$as_coduniadm."  -  ".$as_denuniadm;
		$la_data[1]=array('columna1'=>'<b>Unidad Solicitante</b>','columna2'=>'<b>Analista de Compras</b>','columna3'=>'<b>Plazo de Entrega</b>');
		$la_data[2]=array('columna1'=>$ls_uniadm,'columna2'=>$_SESSION["la_logusr"],'columna3'=>$as_diaplacom);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>320), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>150),
									   'columna3'=>array('justification'=>'left','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		$la_data[1]=array('columna1'=>'<b>Proveedor</b>','columna2'=>'<b>Dirección</b>','columna3'=>'<b>RIF</b>','columna4'=>'<b>Teléfono / Fax</b>');
		$la_data[2]=array('columna1'=>$as_nombre,'columna2'=>$as_dirpro,'columna3'=>$as_rifpro,'columna4'=>$as_telpro);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>170), // Justificación y ancho de la columna
									   ...
									   'columna3'=>array('justification'=>'left','width'=>100),
									   'columna4'=>array('justification'=>'left','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
		$la_data[1]=array('columna1'=>'<b>Objeto de la Orden de Compra</b>');
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>115), // Justificación y ancho de la columna
						 			   ...
						 			   'cantidad'=>array('justification'=>'left','width'=>55), // Justificación y ancho de la columna
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$io_pdf->ezSetDy(-5);
		$la_data[1]=array('titulo'=>'<b>Firmas Autorizadas</b>');
		...
		unset($la_config);
		$io_pdf->ezSetDy(-1);
		$la_data[1]=array('elaborado'=>'','revisado'=>'','confirmado'=>'','aprobado'=>'');
		$la_data[2]=array('elaborado'=>'','revisado'=>'','confirmado'=>'','aprobado'=>'');
		$la_data[3]=array('elaborado'=>'_________________________________','revisado'=>'_________________________________','confirmado'=>'_________________________________','aprobado'=>'_________________________________');
		$la_data[4]=array('elaborado'=>'Revisado Por','revisado'=>'Dirección de Planificación, Presupuesto y Control de Gestión','confirmado'=>'Director de Administración y Servicios','aprobado'=>'Contralor Municipal (I)');
		$la_data[5]=array('elaborado'=>'','revisado'=>'','confirmado'=>'','aprobado'=>'');
		$la_columnas=array('elaborado'=>'','revisado'=>'','confirmado'=>'','aprobado'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'titleFontSize' => 9,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('elaborado'=>array('justification'=>'center','width'=>142.5),
						               'revisado'=>array('justification'=>'center','width'=>142.5),
									   'confirmado'=>array('justification'=>'center','width'=>142.5),
									   'aprobado'=>array('justification'=>'center','width'=>142.5))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
		...
		$la_data[3]=array('titulo'=>' Nombres y Apellidos ________________________________________________________________________________  Cédula de Identidad ____________________________');
		$la_data[4]=array('titulo'=>'');
		$la_data[5]=array('titulo'=>' Fecha __________________________         Firma __________________________');
		$la_data[6]=array('titulo'=>'');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'titleFontSize' => 7,  // Tamaño de Letras de los títulos
						 'rowGap' => 0, //Espacio entre lineas 
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 'width'=>540, // Ancho de la tabla
						 'maxWidth'=>540, // Ancho Máximo de la tabla
		...
		unset($la_config);
		$io_pdf->ezSetDy(-5);
		$la_data[1]=array('titulo'=>'<b>EL CONTRATISTA </b>'.'acepta que '.'</b>LA CONTRALORIA, </b>'.'se reserve el decreto de revocar unitariamente por escrito el contrato en los casos siguientes: '); 
		$la_data[2]=array('titulo'=>'1.Por conveniencia institucional, en cuyo caso efectuará el pago proporcional a los servicios prestados por '.'<b>EL CONTRATISTA, </b>'.'para la fecha de revocatoria.');
		$la_data[3]=array('titulo'=>'2.Cuando '.'<b>EL CONTRATISTA, </b>'.'pretenda suministrar sus servicios en contravención a cualquiera de las condiciones aquí estipuladas.');
		$la_data[4]=array('titulo'=>'3.Por incumplimiento de '.'<b>EL CONTRATISTA, </b>'.'de cualquiera de las obligaciones que del presente se derivan.');
		$la_data[5]=array('titulo'=>'');
		$la_data[6]=array('titulo'=>'Igualmente '.'<b>LA CONTRALORIA, </b>'.'se reserva el derecho de resolver el contrato, o excepcionarse de su cumplimiento, por las causas previstas en la Ley, exigir resarcimiento de los daños o perjuicios a qué hubiere lugar.');
		$la_data[7]=array('titulo'=>'<b>EL CONTRATISTA, </b>'.'se compromete a prestar sus servicios en los términos, condiciones y limitaciones aquí contenidas. ');
		$la_data[8]=array('titulo'=>'El presente instrumento se constituye a tenor de lo previsto en el artículo 132 del Reglamento de la Ley de Contrataciones Públicas, publicado en la Gaceta Oficial de la República Bolivariana de Venezuela');
		$la_data[9]=array('titulo'=>'Nª 39.181 de fecha 19/05/2009.');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(9,2,3,3); // Configuración de los margenes en centímetros
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_cadena=explode('@',$io_report->uf_buscar_sep($ls_numordcom,$ls_estcondat));
				$ls_numsep=$ls_cadena[0];
				$ls_fecsep=$ls_cadena[1];
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_estcom,$ls_numcot,$ls_feccot,$ls_numsep,$ls_fecsep,$io_pdf);
