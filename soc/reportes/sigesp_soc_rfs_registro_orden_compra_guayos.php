...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
        ...
        else
        {
			...
			$io_pdf->line(130,60,130,130);	//VERTICAL	
			$io_pdf->addText(167,122,7,""); // Agregar el título
			$io_pdf->addText(140,63,7,"GERENCIA DE ADMINISTRACION"); // Agregar el título
			$io_pdf->line(260,60,260,130);	//VERTICAL		
			$io_pdf->addText(295,122,7,""); // Agregar el título
			$io_pdf->addText(275,72,7,"DIRECCION DE ADMINISTRACION Y"); // Agregar el título
			$io_pdf->addText(275,63,7,"PRESUPUESTO CONTROL GESTION"); // Agregar el título
			$io_pdf->line(410,60,410,130);	//VERTICAL		
			$io_pdf->addText(470,122,7,""); // Agregar el título
			$io_pdf->addText(418,63,7,"DIRECCION DE ADMINISTRACION Y FINANZAS"); // Agregar el título
