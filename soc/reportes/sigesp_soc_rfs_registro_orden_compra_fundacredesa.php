...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
	                                   $as_denfuefin,$as_codigo,$as_nombre,$as_conordcom,$as_rifpro,$as_diaplacom,$as_dirpro,$as_telpro,
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$la_data[1]=array('columna1'=>'<b>Proveedor</b>  '.$as_nombre.'<b>        Rif</b> '.$as_rifpro,
						  ...
						  'columna3'=>'<b>Teléfono</b> '.$as_telpro);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>220), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>240),
									   'columna3'=>array('justification'=>'left','width'=>110))); // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		unset($la_config);
		$io_pdf->ezSetDy(-2);
		$la_columnas=array('item'=>'<b>Ítem</b>',
		                   'codigo'=>'<b>Código</b>',
						   'denominacion'=>'<b>Denominacion</b>',
						   'part_pres'=>'<b>Partida Presupuestaria</b>',
						   'cantidad'=>'<b>Cant.</b>',
						   'unidad'=>'<b>Unidad</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('item'=>array('justification'=>'center','width'=>30),
						               'codigo'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna 115
						               'denominacion'=>array('justification'=>'left','width'=>105), // Justificación y ancho de la columna
									   'part_pres'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   ...
						 			   'baseimp'=>array('justification'=>'right','width'=>55), // Justificación y ancho de la columna
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_telpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_estcom,$io_pdf);
			   ...
			   if ($lb_valido)
			   {
				 ...
				 if ($li_totrows>0)
				 {
				    ...
				    while($row=$io_sql->fetch_row($rs_datos))
					{
						...
						$la_data[$li_i]=array('item'=>$li_i,'codigo'=>$ls_codartser,'denominacion'=>$ls_denartser,'part_pres'=>$ld_spg_cuenta,'cantidad'=>$li_cantartser,
