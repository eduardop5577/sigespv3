...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						...
						$as_uniaso,$io_pdf)
	{
		...
		$io_pdf->addText(185,720,6,"<b>DIRECCION FISCAL: AV. LOS PROCERES CIRCULO MILITAR, SALON</b>"); // Agregar el título
		$io_pdf->addText(245,712,6,"<b> VENEZUELA PISO 3 - CARACAS</b>"); // Agregar el título
		$io_pdf->addText(285,702,6,"<b>G-20000058-9</b>"); // Agregar el título
		...
		$io_pdf->addText(50,122,7,"COMPRAS Y SUMINISTROS"); // Agregar el título
		$io_pdf->addText(60,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(200,60,200,130);	//VERTICAL	
		$io_pdf->addText(270,122,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(260,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(400,60,400,130);	//VERTICAL		
		$io_pdf->addText(470,122,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(460,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
