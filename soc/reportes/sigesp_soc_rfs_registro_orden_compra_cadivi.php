...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$as_estlugcom,$as_numanacot,
									   $ad_fecanacot,$as_lugentdir,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],25,715,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,740,12,$ls_titulo); // Agregar el título
	...
	//	$io_pdf->addText(20,705,7,"MINISTERIO DEL PODER POPULAR DE PLANIFICACION Y FINANZAS"); // Agregar el título
	//	$io_pdf->addText(20,697,7,"COMISION DE ADMINISTRACION DE DIVISAS"); // Agregar el título
	//	$io_pdf->addText(20,689,7,$ls_nomemp." RIF ".$ls_rifemp); // Agregar el título
		$io_pdf->addText(20,681,7,"DIRECCION FISCAL: ".$ls_direccion); // Agregar el título
		// cuadro inferior
		...
		$la_data[1]=array('columna1'=>'<b>Lugar de Compra</b>   ',
						  'columna2'=>'<b>Solicitud de Cotizacion</b>   ',
						  'columna3'=>'<b> Forma de Pago</b>    ');
		$la_data[2]=array('columna1'=>'Local:  '.$ls_nac.'  Exterior:  '.$ls_ext,
						  'columna2'=>'No.: '.$as_numanacot.'   Fecha: '.$ad_fecanacot,
						  'columna3'=>'Orden Directa: X  Carta de Credito:   Avance:   Cheque:    ');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>130), // Justificación y ancho de la columna
									   ...
									   'columna3'=>array('justification'=>'left','width'=>250))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(9.3,6,3,3); // Configuración de los margenes en centímetros
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_numanacot=$row["numsolcot"];
				$ld_fecanacot=$row["fecsol"];
				...
				$ld_fecanacot=$io_funciones->uf_convertirfecmostrar($ld_fecanacot);
				if($ls_tiporeporte==0)
				{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_estcom,$ls_estlugcom,$ls_numanacot,$ld_fecanacot,$ls_lugentdir,$io_pdf);
