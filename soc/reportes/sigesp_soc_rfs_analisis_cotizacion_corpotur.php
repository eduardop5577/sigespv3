...
***********************************************************************************/
	...
	function uf_print_pie_pagina($io_pdf)
	{
		...
		$io_pdf->Rectangle(15,60,730,70); 
		$io_pdf->line(15,117,745,117);	//HORIZONTAL	
		$io_pdf->addText(85,121,8,"JEFE DE COMPRAS");
		$io_pdf->addText(95,63,8,"FIRMA / SELLO");
		$io_pdf->line(250,60,250,130);	//VERTICAL
		$io_pdf->addText(315,121,8,"GERENCIA DE ADMINISTRACIÓN");
		$io_pdf->addText(340,63,8,"FIRMA / SELLO");
		$io_pdf->line(500,60,500,130);	//VERTICAL
		$io_pdf->addText(600,121,8,"PRESIDENCIA");
		$io_pdf->addText(598,63,8,"FIRMA / SELLO");
		$io_pdf->line(15,73,745,73); //HORIZONTAL	
