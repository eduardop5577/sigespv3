...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsolcot,$as_fecsolcot,$as_dentipsolcot,$as_obssolcot,$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->Rectangle(40,700,550,70);
		$io_pdf->line(450,700,450,770);
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/fundapret.jpg',60,712,370,57); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(10,$as_titulo);		
		$io_pdf->addText(140,720,14,"<b>".$as_titulo."</b>"); // Agregar el título
