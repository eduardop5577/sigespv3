...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina_uno($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
											...
											$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(45,122,7.5,"Revisado por la"); // Agregar el título
		$io_pdf->addText(30,113,7.5,"Coordinación de Compras"); // Agregar el título
		$io_pdf->addText(20,102,7,"Nombre(s) y Apellido(s) :"); // Agregar el título
		$io_pdf->addText(80,63,7,"Firma y Sello"); // Agregar el título
	    $io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(145,122,7.5,"Aprobado por la Gerencia"); // Agregar el título
		$io_pdf->addText(145,113,7.5,"General de Administración"); // Agregar el título
		$io_pdf->addText(135,102,7,"Nombre(s) y Apellido(s) :"); // Agregar el título
		$io_pdf->addText(195,63,7,"Firma y Sello"); // Agregar el título
		$io_pdf->line(245,60,245,130);	//VERTICAL		
		$io_pdf->addText(275,122,7.5,"Aprobado Por:"); // Agregar el título
		$io_pdf->addText(275,113,7.5,"Vicepresidente"); // Agregar el título
		$io_pdf->addText(250,102,7,"Nombre(s) y Apellido(s) :"); // Agregar el título
		$io_pdf->addText(305,63,7,"Firma y Sello"); // Agregar el título
		$io_pdf->line(355,60,355,130);	//VERTICAL	
		$io_pdf->addText(385,122,7.5,"Aprobado Por:"); // Agregar el título
		$io_pdf->addText(390,113,7.5,"Presidente"); // Agregar el título
		$io_pdf->addText(360,102,7,"Nombre(s) y Apellido(s) :"); // Agregar el título
		$io_pdf->addText(420,63,7,"Firma y Sello"); // Agregar el título
		$io_pdf->line(470,60,470,130);	//VERTICAL		
		$io_pdf->addText(505,122,7.5,"Recibido Por:"); // Agregar el título
		$io_pdf->addText(510,113,7.5,"Proveedor"); // Agregar el título
		$io_pdf->addText(475,102,7,"Nombre(s) y Apellido(s) :"); // Agregar el título
		$io_pdf->addText(535,63,7,"Firma y Sello"); // Agregar el título
		//$io_pdf->line(15,73,585,73); //HORIZONTAL	
		$io_pdf->addText(130,53,7,$_SESSION["la_empresa"]["direccion"]."  Telf: ".$_SESSION["la_empresa"]["telemp"]); // Agregar el título		
		...
		$la_data[1]=array('columna1'=>'<b>Unidad Ejecutora</b>    '.$ls_uniadm,'columna2'=>'<b>Forma de Pago</b>    '.$ls_forpagcom,'columna3'=>'<b>Telefono</b>    '.$as_telpro);
	...
	}// end function uf_print_encabezado_pagina_uno
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina_dos($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
											$as_denfuefin,$as_codigo,$as_nombre,$as_conordcom,$as_rifpro,$as_telpro,$as_diaplacom,$as_dirpro,
											$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $io_pdf->Rectangle(15,60,570,70); 
		$io_pdf->line(15,110,585,110);	//HORIZONTAL	
		$io_pdf->addText(25,122,7.5,"Revisado por la Coordinación de"); // Agregar el título
		$io_pdf->addText(60,113,7.5,"Compras"); // Agregar el título
		$io_pdf->addText(20,102,7,"Nombre(s) y Apellido(s) :"); // Agregar el título
		$io_pdf->addText(90,63,7,"Firma y Sello"); // Agregar el título
		$io_pdf->line(140,60,140,130);	//VERTICAL	
		$io_pdf->addText(145,122,7.5,"Aprobado por la Gerencia General de"); // Agregar el título
		$io_pdf->addText(175,113,7.5,"Administración"); // Agregar el título
		$io_pdf->addText(145,102,7,"Nombre(s) y Apellido(s) :"); // Agregar el título
		$io_pdf->addText(225,63,7,"Firma y Sello"); // Agregar el título
		$io_pdf->line(275,60,275,130);	//VERTICAL		
		$io_pdf->addText(300,120,7.5,"Aprobado Por: Vicepresidente"); // Agregar el título
		$io_pdf->addText(280,102,7,"Nombre(s) y Apellido(s) :"); // Agregar el título
		$io_pdf->addText(370,63,7,"Firma y Sello"); // Agregar el título
		$io_pdf->line(420,60,420,130);	//VERTICAL		
		$io_pdf->addText(460,120,7.5,"Recibido Por: Proveedor"); // Agregar el título
		$io_pdf->addText(425,102,7,"Nombre(s) y Apellido(s) :"); // Agregar el título
		$io_pdf->addText(535,63,7,"Firma y Sello"); // Agregar el título
		//$io_pdf->line(15,73,585,73); //HORIZONTAL	
		$io_pdf->addText(130,53,7,$_SESSION["la_empresa"]["direccion"]."  Telf: ".$_SESSION["la_empresa"]["telemp"]); // Agregar el título		
		...
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	}// end function uf_print_encabezado_pagina_dos
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				if($ld_moncom<=50000){
					uf_print_encabezado_pagina_dos($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
					...
					uf_print_encabezado_pagina_uno($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
				                                   $ls_codfuefin,$ls_denfuefin,$ls_codpro,$ls_nompro,$ls_obscom,$ls_rifpro,$ls_telpro,
										           $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_estcom,$io_pdf);
				}
