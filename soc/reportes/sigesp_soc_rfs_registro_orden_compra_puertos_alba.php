...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$as_telpro,$as_nomreppro,$as_emailrep,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      /*  $io_pdf->Rectangle(15,60,570,70); 
		...
		$la_data[1]=array('columna1'=>'<b>Proveedor</b>  '.$as_nombre,
		                 'columna2'=>'<b> Rif</b> '.$as_rifpro.'','columna3'=>'<b>Direccion</b> '.$as_dirpro.'');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>180), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>90), // Justificación y ancho de la columna
						 			   'columna3'=>array('justification'=>'left','width'=>300))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);

		$la_data[1]=array('columna1'=>'<b>Telefonos:</b>  '.$as_telpro,
		                 'columna2'=>'<b>Persona Contacto:</b> '.$as_nomreppro.'','columna3'=>'<b>Correo Electronico:</b> '.$as_emailrep.'');
		$la_columna=array('columna1'=>'','columna2'=>'','columna3'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>180), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>180), // Justificación y ancho de la columna
						 			   'columna3'=>array('justification'=>'left','width'=>210))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
...
/*		$la_data[1]=array('columna1'=>'<b>Período de Entrega    Desde:</b> '.$ld_perentdesde.'    <b>Hasta:</b> '.$ld_perenthasta.'');
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$io_pdf->ezSetCmMargins(8.5,0.5,3,3); // Configuración de los margenes en centímetros
		$io_pdf->ezSetY(210);
		$la_data[1]=array('columna1'=>'<b>RESPONSABLE DE COMPRAS</b>',
		                 'columna2'=>'<b>ADMINISTRACIÓN Y FINANZAS</b>',
						 'columna3'=>'<b>PRESUPUESTO</b>',
		                 'columna4'=>'<b>VICEPRESIDENCIA</b>',
		                 'columna5'=>'<b>PRESIDENCIA</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>114), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>114), // Justificación y ancho de la columna
						 			   'columna3'=>array('justification'=>'left','width'=>114), // Justificación y ancho de la columna
						 			   'columna4'=>array('justification'=>'left','width'=>114), // Justificación y ancho de la columna
						 			   'columna5'=>array('justification'=>'left','width'=>114))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		
		$la_data[1]=array('columna1'=>'<b>Elaborado Por:</b>       				                Lic. Erika Milano',
		                 'columna2'=>'<b>Conformado por: </b>      			               Lic. Yaritza Toro',
						 'columna3'=>'<b>Revisado por:</b>        		 		                Lic. Martin Villalobos',
		                 'columna4'=>'<b>Aprobado por: </b>       		                   Ing. Adbías Peón',
		                 'columna5'=>'<b>Aprobado por: </b>        		                   G/B. Pedro Castro');
		$la_data[2]=array('columna1'=>'<b>Fecha:</b>',
		                 'columna2'=>'<b>Fecha:</b>',
						 'columna3'=>'<b>Fecha:</b>',
		                 'columna4'=>'<b>Fecha:</b>',
		                 'columna5'=>'<b>Fecha:</b>');
		$la_data[3]=array('columna1'=>'<b>Firma:</b>       				                                            		                                               				                                           				                                    ',
		                 'columna2'=>'<b>Firma: </b>       				                                            		                                               				                                          			                                        ',
						 'columna3'=>'<b>Firma:</b>        				                                            		                                               				                                           		 		                                    ',
		                 'columna4'=>'<b>Firma: </b>       				                                            		                                               				                                           		                                            ',
		                 'columna5'=>'<b>Firma: </b>       				                                            		                                               				                                            		                                        ');
		$la_data[4]=array('columna1'=>'<b>Sello:</b>       				                                            		                                               				                                           				                                    ',
		                 'columna2'=>'<b>Sello: </b>       				                                            		                                               				                                          			                                        ',
						 'columna3'=>'<b>Sello: </b>       				                                            		                                               				                                            		 		                                ',
		                 'columna4'=>'<b>Sello: </b>       				                                            		                                               				                                           		                                            ',
		                 'columna5'=>'<b>Sello: </b>       				                                            		                                               				                                            		                                        ');
		...
		$la_datatitulo[1]=array('columna1'=>'<b>ACEPTACION DEL PROVEEDOR</b>');
		$la_columnas=array('columna1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		unset($la_columnas);
		unset($la_config);
		$la_data[1]=array('columna1'=>'                         				                                            		                                               				                                           		                                                                                                 <b>Nombre y Apellido:</b>',
		                 'columna2'=>'       	                         			                                            		                                               				                                           		                                                                                                  <b>C.I.:</b>',
						 'columna3'=>'            		                                                   				                                            		                                               				                                           		                                                				                                            		                                               				                                           		                                                                                                                                         <b>Firma:</b>',
		                 'columna4'=>'                                                              				                                            		                                               				                                           		                                                                                                      <b>Sello:</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>114), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>114), // Justificación y ancho de la columna
						 			   'columna3'=>array('justification'=>'left','width'=>214), // Justificación y ancho de la columna
						 			   'columna4'=>array('justification'=>'left','width'=>128))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_estcom,$ls_telpro,$ls_nomreppro,$ls_emailrep,$io_pdf);
