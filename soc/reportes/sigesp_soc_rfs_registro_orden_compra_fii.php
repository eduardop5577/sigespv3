...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo.jpg',20,715,440,40); // Agregar Logo
		...
		$io_pdf->addText(60,63,7,"COMPRAS"); // Agregar el título
		
        //$io_pdf->Rectangle(150,60,570,70); 
		$io_pdf->line(95,117,585,117);	//HORIZONTAL	
		$io_pdf->line(150,60,150,130);	//VERTICAL	
		$io_pdf->addText(195,122,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(170,63,7,"COORDINACION DE COMPRAS"); // Agregar el título
		...
		$io_pdf->addText(350,122,7,"APROBADO POR"); // Agregar el título
		//$io_pdf->addText(160,63,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(350,63,7,"ADMINISTRACION"); // Agregar el título
		...
		$io_pdf->addText(490,122,7,"PROVEEDOR"); // Agregar el título
...
/*		$la_data[1]=array('columna1'=>'<b>Proveedor</b> '.$as_nombre.'<b>    Rif  <b>'.$as_rifpro,
		...
		$la_data[1]=array('columna1'=>'<b>Proveedor</b> '.$as_nombre.'',
		                 ...
		                 'columna3'=>'<b>Direccion</b> '.$as_dirpro.'');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
									   ...
									   'columna3'=>array('justification'=>'left','width'=>270))); // Justificación y ancho de la columna
