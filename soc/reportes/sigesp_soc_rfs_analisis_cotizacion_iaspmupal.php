...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_numanacot,$observacion,$ad_fecha,$io_pdf)
	{
		...
		$io_pdf->add_texto(200,26,10,"<b>Nro.:</b>".$as_numanacot);		
		$io_pdf->add_texto(200,32,10,"<b>Fecha:</b>".$ad_fecha);		
		$la_data[0]["1"]="<b>Observación:</b>";
