...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$as_nomusureg,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->line(380,60,380,120);		
		$io_pdf->line(490,60,490,130);		
		$io_pdf->addText(35,122,7,"ORGANISMO"); // Agregar el título
		$io_pdf->addText(20,68,7,"CACAO ODERI"); // Agregar el título
		$io_pdf->addText(120,122,7,"REVISADO POR"); // Agregar el título
		//$io_pdf->addText(120,68,7,"COORD. COMPRAS"); // Agregar el título
		$io_pdf->addText(220,122,7,"REALIZADO POR"); // Agregar el título
		$io_pdf->addText(205,68,7,$as_nomusureg); // Agregar el título
		$io_pdf->addText(365,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(310,72,7,"ADMINISTRADOR"); // Agregar el título
		$io_pdf->addText(310,62,7,"FECHA"); // Agregar el título
		$io_pdf->addText(382,72,7,"PRESIDENTE/GERENCIA GRAL."); // Agregar el título
		$io_pdf->addText(382,62,7,"FECHA"); // Agregar el título
		$io_pdf->addText(515,122,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(492,68,7,$as_nombre); // Agregar el título
		
		$io_pdf->ezSetY(695);
		$la_data[1]=array('columna1'=>'<b>Codigo Proveedor:</b> '.$as_codigo,
		                 'columna2'=>'<b>Nombre Proveedor:</b> '.$as_nombre,
		                 'columna3'=>'<b>Rif: </b> '.$as_rifpro);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>130), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>350), // Justificación y ancho de la columna
						 			   'columna3'=>array('justification'=>'left','width'=>90))); // Justificación y ancho de la columna
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,$ls_monlet,$ls_obsordcom,$ls_lugent,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[1]=array('titulo'=>'<b>Observaciones:</b>','contenido'=>$ls_obsordcom,);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
		...
		$la_data[1]=array('titulo'=>'<b>Lugar de Entrega:</b>','contenido'=>$ls_lugent,);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_lugent=$ls_despai." - ".$ls_desest." - ".$ls_denmun." - ".$ls_denpar;
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_estcom,$ls_nomusureg,$io_pdf);
		...
		uf_print_piecabecera($ld_monsubtot,$ld_monimp,$ld_montot,$ls_monto,$ls_obsordcom,$ls_lugent,$io_pdf);
	} 	  	 
