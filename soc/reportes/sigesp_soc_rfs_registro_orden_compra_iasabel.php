...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$ls_nomusureg,$ls_nomusu,$io_pdf)
	{
	  ...
	  //	$io_pdf->line(15,40,585,40);
	  	$io_pdf->line(480,695,480,735);
	  	$io_pdf->line(480,715,586,715);
      //  $io_pdf->Rectangle(15,700,570,60);
        ...
        $io_pdf->Rectangle(16,695,570,40); 
		
		$li_tm=$io_pdf->getTextWidth(12,$ls_titulo);
		$tm=256-($li_tm/2);
		$io_pdf->addText($tm,710,12,$ls_titulo); // Agregar el título

		$io_pdf->addText(485,720,9," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(485,700,9,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		...
		$io_pdf->addText(55,152,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(60,102,7,"FIRMA / SELLO"); // Agregar el título

		$io_pdf->line(157,60,157,160);	//VERTICAL	
		$io_pdf->addText(195,152,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(200,102,7,"CONTABILIDAD"); // Agregar el título

		$io_pdf->line(301,60,301,160);	//VERTICAL		
		$io_pdf->addText(340,152,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(320,102,7,"ADMINISTRACION Y FINANZAS"); // Agregar el título

		$io_pdf->line(442,60,442,160);	//VERTICAL		
		$io_pdf->addText(455,152,7,"PRESIDENTE / GERENTE GENERAL"); // Agregar el título
		$io_pdf->addText(487,102,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(400,40,6,"Creado por: ".$ls_nomusureg." el ".$ad_fecordcom ); // Agregar el título
		$io_pdf->addText(400,30,6,"Impreso por: ".$ls_nomusu." el ".date("d/m/Y") ); // Agregar el título
...
*/	
		$la_data[1]=array('columna1'=>'<b>BENEFICIARIO: </b>  '.$as_nombre);
