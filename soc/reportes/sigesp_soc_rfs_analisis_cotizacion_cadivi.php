...
***********************************************************************************/
	...
	function uf_print_pie_pagina($io_pdf)
	{
		...
		$la_data[0]["1"]="";
		$la_data[1]["1"]="<b>Analista de Compras</b>";

		$la_data[0]["2"]="\n";
		$la_data[1]["2"]="<b>Coordinador de Compras</b>";

		$la_data[0]["3"]="\n";
		$la_data[1]["3"]="<b>Gerente de Administración</b>";

		$la_data[0]["4"]="\n";
		$la_data[1]["4"]="<b>Vicepresidencia de Administración</b>";
		$la_anchos_col = array(65,65,65,65);
