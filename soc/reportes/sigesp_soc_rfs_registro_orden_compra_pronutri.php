...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$as_codusureg,$as_telpro,
									   $as_obsordcom,$as_numdiacre,$ls_tipsiscam,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],30,701,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		//$io_pdf->addText(60,719,9,"<b>RIF: J-30893562-0</b>");
		$io_pdf->addText(60,30,8,"<b>Dirreción Fiscal: </b> AV. LAS INDUSTRIAS ENTRE KM 3 Y 4 LOCAL COMPLEJO INDUSTRIAL ANMAR Nº 6 BARQUISIMETO EDO. LARA");
		$io_pdf->addText(180,22,8,"<b>Telf: </b> (0251-2691338, 2692510, 2691316); <b>R.I.F: </b> J-30893562-0");
		$io_pdf->addText(480,740,9," <b>No. </b>".$as_numordcom); // Agregar el título
		...
		$io_pdf->addText(22,63,8,$as_codusureg); // Agregar el título
		$io_pdf->addText(20,80,7,"FIRMA:"); // Agregar el título
		...
		$la_data[2]=array('columna1'=>'<b>Direccion</b>  '.$as_dirpro,
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>370), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>200))); // Justificación y ancho de la columna
		...
		$la_data[1]=array('columna1'=>'<b>Unidad Ejecutora</b>    '.$ls_uniadm,'columna2'=>'<b>Forma de Pago</b> '.$ls_forpagcom.' - <b>Plazo en Dias</b>  '.$as_numdiacre);
		...
		$la_data[1]=array('columna1'=>'<b>Observacion</b>   '.$as_obsordcom);
		$la_columnas=array('columna1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		if($ls_codmon!="")
		{
			$la_data[1]=array('columna1'=>'<b>Sistema Cambiario</b>   '.$ls_tipsiscam);
			$la_columnas=array('columna1'=>'');
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 'fontSize' => 9, // Tamaño de Letras
							 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($la_data,$ls_codmon,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($ls_codmon!="")
		$ls_bolivares = $io_report->uf_select_denominacion('sigesp_moneda','abrmon',"WHERE codmon='".$ls_codmon."'");				   
	else
		$ls_bolivares="Bs.";
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_estcom,
										   $ls_codusureg,$ls_telpro,$ls_obsordcom,$ls_numdiacre,$ls_tipsiscam,$io_pdf);
			   ...
			   if ($lb_valido)
			   {
				 ...
				 if ($li_totrows>0)
				 {
				    ...
				    while($row=$io_sql->fetch_row($rs_datos))
					{
						...
						if($ls_codmon!="")
						{
							$ld_preartser=$ld_preartser/$ld_tasa;
							$ld_totartser=$ld_totartser/$ld_tasa;
							...
							{
								$li_cantartser=number_format($li_cantartser,3,",",".");
							}
					...
					uf_print_detalle($la_data,$ls_codmon,$io_pdf);
					unset($la_data);
