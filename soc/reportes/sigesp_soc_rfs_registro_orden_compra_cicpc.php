...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$as_estrnc,$as_lugentnomdep,
									   $as_nomusu,$as_denestpro,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//		$io_pdf->line(480,730,585,730);
       $io_pdf->Rectangle(15,700,570,60);
		$io_pdf->addJpegFromFile('../../shared/imagebank/banner_cicpc_soc.jpg',25,715,550,40); // Agregar Logo
		if ($as_estcom=='3')
		{
...
//		$io_pdf->addText(546,764,6,date("h:i a")); // Agregar la Hora
		...
		$io_pdf->addText(70,122,7,"JEFE DE COMPRAS"); // Agregar el título
		$io_pdf->line(205,60,205,130);	//VERTICAL	
		$io_pdf->addText(260,122,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->line(395,60,395,130);	//VERTICAL		
		$io_pdf->addText(470,122,7,"DIRECCION"); // Agregar el título
		$ls_anio=substr($ad_fecordcom,6,4);	
		$io_pdf->line(417,683,585,683);
		$io_pdf->ezSetY(700);
		$la_data[1]=array('columna1'=>'<b>'.$ls_titulo.'</b>','columna2'=>'                  PROVEEDOR ');
		$la_data[2]=array('columna1'=>'               No.   '.$as_numordcom,'columna2'=>' ');
		$la_data[3]=array('columna1'=>'               FECHA '.$ad_fecordcom,'columna2'=>' ');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>400), // Justificación y ancho de la columna
		...
		unset($la_config);
		$io_pdf->ezSetDy(-3);
		//$la_data[1]=array('columna1'=>'<b>Proveedor</b>','columna2'=>'<b>RIF</b>','columna3'=>'<b>Direccion</b>');
		$la_data[1]=array('columna1'=>$as_nombre,'columna2'=>$as_rifpro,'columna3'=>$as_dirpro);
		$la_columna=array('columna1'=>'<b>PROVEEDOR: </b>','columna2'=>'<b>RIF: </b>','columna3'=>'<b>DIRECCION: </b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>270), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>130), // Justificación y ancho de la columna
						 			   'columna3'=>array('justification'=>'left','width'=>170))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
	...
	//	$io_pdf->ezSetDy(-3);
		$la_data[1]=array('columna1'=>'<b>NUMERO DE RNC: </b>'.$as_estrnc);
		...
		$la_data[1]=array('columna1'=>'<b>UNIDAD SOLICITANTE:</b>   '.$as_denuniadm,'columna2'=>'<b>FORMA DE PAGO</b>    '.$ls_forpagcom);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>270), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>300))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);

		$la_data[1]=array('columna1'=>'<b>LUGAR DE ENTREGA: </b>'.$as_lugentnomdep,'columna2'=>'<b>BANCO: </b>','columna3'=>'<b>NUMERO DE CUENTA</b>');
		$la_columna=array('columna1'=>'<b>LUGAR DE ENTREGA: </b>','columna2'=>'<b>BANCO: </b>','columna3'=>'<b>Nro. DE CUENTA:</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
		...
		$la_data[1]=array('columna1'=>'<b>FUENTE DE FINANCIAMIENTO:</b>   '.$as_denfuefin,'columna2'=>'<b> ELABORADO POR:</b>    '.$as_nomusu);
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[1]=array('columna1'=>'<b>PLAZO DE ENTREGA:</b>   '.$as_diaplacom.'          <b>VALIDEZ DE LA OFERTA:                 GARANTIA:               LAPSO DE EJECUCIÓN:</b>');
		$la_columnas=array('columna1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[1]=array('columna1'=>'<b>PROYECTO:</b> '.$as_denestpro);
		$la_columnas=array('columna1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[1]=array('columna1'=>'<b>AÑO: </b>'.$ls_anio,'columna2'=>'<b>UNIDAD PRIMARIA: </b>  25','columna3'=>'<b>SECTOR: </b> 02');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>170), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>170), // Justificación y ancho de la columna
						 			   'columna3'=>array('justification'=>'left','width'=>230))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-10);
		$la_datatitulo[1]=array('columna1'=>'<b> DETALLE DEL SERVICIO O COMPRA</b>');
		$la_columnas=array('columna1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		unset($la_config);
		$io_pdf->ezSetDy(-2);
		$la_columnas=array('i'=>'<b>ITEM</b>',
						   'codigo'=>'<b>CODIGO</b>',
						   'denominacion'=>'<b>DENOMINACION</b>',
						   'cantidad'=>'<b>CANT.</b>',
						   'unidad'=>'<b>UNIDAD</b>',
						   'cosuni'=>'<b>Costo '.$ls_bolivares.'</b>',
						   'baseimp'=>'<b>TOTAL'.$ls_bolivares.'</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('i'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   'codigo'=>array('justification'=>'center','width'=>115), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>190), // Justificación y ancho de la columna
	...
	function uf_print_detalle_cuentas($la_data,$io_pdf)
	{
		...
		$la_datatit[1]=array('titulo'=>'<b> DETALLE DEL PRESUPUESTO </b>');
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,$ls_monlet,$as_estcondat,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if($as_estcondat=="S") 
        {
				...
				$ls_clafiecum2= "DEL MONTO DE ESTA ORDEN, OTORGADA POR UN BANCO O COMPAÑIA DE SEGUROS, NOTARIADA Y VIGENTE HASTA LA TOTAL RECEPCION";
				...
				$ls_claesp2="DE CONFORMIDAD CON LO DISPUESTO EN EL REGLAMENTO QUE RIGE LA MATERIA";
	...
	$ls_codusu=$_SESSION["la_logusr"]["codusu"];
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=true;
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_estrnc=$row["estrnc"];
				$ls_lugentnomdep=$row["lugentnomdep"];
				$ls_codusureg=$row["codusureg"];
				...
				$ls_nomusu=$io_report->uf_select_nombre_usuario($ls_codusureg);
				$ls_denestpro=$io_report->uf_select_proyecto($ls_codestpro1,$ls_estcla);
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_estcom,$ls_estrnc,$ls_lugentnomdep,$ls_nomusu,$ls_denestpro,$io_pdf);
			   ...
			   if ($lb_valido)
			   {
				 ...
				 if ($li_totrows>0)
				 {
				    ...
				    while($row=$io_sql->fetch_row($rs_datos))
					{
						...
						$la_data[$li_i]=array('i'=>$li_i,'codigo'=>$ls_codartser,'denominacion'=>$ls_denartser,'cantidad'=>$li_cantartser,
		...
		uf_print_piecabecera($ld_monsubtot,$ld_monimp,$ld_montot,$ls_monto,$ls_estcondat,$io_pdf);
	} 	  	 
