...
***********************************************************************************/
	...
	$arrResultado = $io_report->uf_select_analisis_cotizaciones($ls_anacotdes,$ls_anacothas,$ls_codprodes,$ls_codprohas,
											$ls_fecanades,$ls_fecanahas,$ls_tipanacot,$la_cotizaciones);
	
	$la_cotizaciones = $arrResultado['aa_cotizaciones'];
