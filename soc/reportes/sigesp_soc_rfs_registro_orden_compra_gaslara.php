...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$ls_nomusureg,$ls_nomusu,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      //  $io_pdf->Rectangle(15,700,570,60);
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,700,14,$ls_titulo); // Agregar el título

		$li_tm=$io_pdf->getTextWidth(10,"EMPRESA DE PROPIEDAD SOCIAL AGROPATRIA, S.A.");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,760,10,"EMPRESA DE PROPIEDAD SOCIAL AGROPATRIA, S.A."); // Agregar el título

		$li_tm=$io_pdf->getTextWidth(10,"CALLE INDEPENDENCIA NORTE, EDIF.,");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,750,10,"CALLE INDEPENDENCIA NORTE, EDIF.,"); // Agregar el título

		$li_tm=$io_pdf->getTextWidth(10,"AGROPATRIA, No. 104-39-18, PISO PB OF 1,");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,740,10,"AGROPATRIA, No. 104-39-18, PISO PB OF 1,"); // Agregar el título


		$li_tm=$io_pdf->getTextWidth(10,"SECTOR CENTRO, CAGUA-EDO ARAGUA");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,730,10,"SECTOR CENTRO, CAGUA-EDO ARAGUA"); // Agregar el título

		$li_tm=$io_pdf->getTextWidth(10,"TELEFONO 0244-4479955");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,720,10,"TELEFONO 0244-4479955"); // Agregar el título


		$io_pdf->addText(485,735,9," <b>No. </b>".$as_numordcom); // Agregar el título
		...
		$io_pdf->addText(40,122,7,"ANALISTA DE COMPRAS"); // Agregar el título
		$io_pdf->addText(20,102,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(152,122,7,"JEFE DE COMPRAS"); // Agregar el título
		$io_pdf->addText(140,102,7,"REVISADO POR "); // Agregar el título
		$io_pdf->line(243,60,243,130);	//VERTICAL		
		$io_pdf->addText(260,122,7,"COORD. ADQUISICIONES"); // Agregar el título
		$io_pdf->addText(253,102,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->line(357,60,357,130);	//VERTICAL		
		$io_pdf->addText(385,122,7,"GESTION ADMIN."); // Agregar el título
		$io_pdf->addText(367,102,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(505,122,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(473,102,6.5,"FIRMA, CEDULA, SELLO Y FECHA"); // Agregar el título
		$io_pdf->line(471,60,471,130);	//VERTICAL		
		$io_pdf->addText(400,40,7,"Creado por: ".$ls_nomusureg." el ".$ad_fecordcom ); // Agregar el título
		$io_pdf->addText(400,30,7,"Impreso por: ".$ls_nomusu." el ".date("d/m/Y") ); // Agregar el título
	...
	$ls_nomusu=	$io_report->uf_load_nombre_usuario();
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_estcom,$ls_nomusureg,$ls_nomusu,$io_pdf);
