...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsolcot,$as_fecsolcot,$as_dentipsolcot,$as_obssolcot,$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->rectangle(140,665,450,40);
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/barra_inf_ver_tromerca.jpg',15,15,570,40);
		...
		$io_pdf->addText(555,720,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(560,710,7,date("h:i a")); // Agregar la hora
		$io_pdf->addText(210,100,10,"<b>___________________________________</b>"); // Agregar la Fecha
		$io_pdf->addText(210,80,9,"<b>             GERENCIA ADMINISTRATIVA</b>"); // Agregar la hora
