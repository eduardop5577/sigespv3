...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $as_nomusu,$as_telusu,$as_corele,$io_pdf)
	{
		...
		$io_pdf->addText(465,740,9," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(465,710,9,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
	...
	// cuadro inferior//
		...
		if ($ld_montot>$ls_valorunitrib)
		{
		  ...
		  $io_pdf->addText(30,138,8,"<b>Elaborado Por</b>"); // Agregar el título
		  ...
		  $io_pdf->addText(115,140,8,"<b>$jefe</b>"); // Agregar el título
		  $io_pdf->addText(100,132,8,"<b>$area</b>"); // Agregar el título
		  $io_pdf->addText(105,122,7,"<b>$coordinador_area_compras</b>"); // Agregar el título
		  $io_pdf->addText(105,115,7,"<b>$coordinador_area_compras2</b>"); // Agregar el título
		  $io_pdf->addText(105,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(105,72,7,"<b>Fecha</b>"); // Agregar el título
		  
		  $io_pdf->line(185,60,185,148);	//VERTICAL
		  $io_pdf->addText(202,140,8,"<b>Director(a) de</b>"); // Agregar el título
		  $io_pdf->addText(197,132,8,"<b>Administración</b>"); // Agregar el título
		  $io_pdf->addText(190,122,7,"<b>$director_de_administracion</b>"); // Agregar el título
		  $io_pdf->addText(190,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(190,72,7,"<b>Fecha</b>"); // Agregar el título

		  $io_pdf->line(270,60,270,148);	//VERTICAL
		  $io_pdf->addText(285,140,8,"<b>Director Gral. Oficina de</b>"); // Agregar el título
		  $io_pdf->addText(280,132,8,"<b>Servicios Administrativos</b>"); // Agregar el título
		  $io_pdf->addText(275,122,7,"<b>$director_osa</b>"); // Agregar el título
		  $io_pdf->addText(275,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(275,72,7,"<b>Fecha</b>"); // Agregar el título
		  
		  $io_pdf->line(385,60,385,148);	//VERTICAL
		  $io_pdf->addText(400,140,8,"<b>Secretario General</b>"); // Agregar el título
		  $io_pdf->addText(420,132,8,"<b>Ejecutivo</b>"); // Agregar el título
		  $io_pdf->addText(390,122,7,"<b>$secretario</b>"); // Agregar el título
		  $io_pdf->addText(390,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(390,72,7,"<b>Fecha</b>"); // Agregar el título
		  
		  $io_pdf->line(490,60,490,148);	//VERTICAL
		  $io_pdf->addText(520,138,8,"<b>Proveedor</b>"); // Agregar el título
		  $io_pdf->addText(495,122,7,"<b>Nombre y Apellido</b>"); // Agregar el título
		  $io_pdf->addText(495,96,7,"<b>Firma</b>"); // Agregar el título
		  $io_pdf->addText(495,72,7,"<b>Fecha</b>"); // Agregar el título
		}
		else
		{ 
		   $io_pdf->Rectangle(15,60,570,100);
	...
	function uf_print_detalle_clausulas($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>540, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('dencla'=>array('justification'=>'justify','width'=>570))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_datatit);
		unset($la_columnas);
		unset($la_config);
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(6.5,6,3,3); // Configuración de los margenes en centímetros
			$setNum = $io_pdf->ezStartPageNumbers(570,47,8,'','',1); // Insertar el número de página
