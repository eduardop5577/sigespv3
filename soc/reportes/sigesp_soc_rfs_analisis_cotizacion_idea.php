...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_numanacot,$observacion,$ad_fecha,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.'logo.jpg',20,560,490,42); // Agregar Logo 
	...
	function uf_print_pie_pagina($io_pdf)
	{
		...
		global $io_pdf;
 		...
 		$io_pdf->Rectangle(50,30,650,40);
		$io_pdf->line(50,45,700,45);
        $io_pdf->line(180,30,180,72);		
		$io_pdf->line(330,30,330,72);		
		$io_pdf->line(500,30,500,72);	

        $io_pdf->addText(52,35,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(52,46,7,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]); // Agregar el Usuario
		$io_pdf->addText(220,35,7,"JEFE DE COMPRAS"); // Agregar el título
		$io_pdf->addText(220,46,7,"LIC. YOLIMAR LINDADO"); // Agregar el título
		$io_pdf->addText(350,35,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(350,46,7,"LIC. MAGABI JIMENEZ"); // Agregar el título
		$io_pdf->addText(520,35,7,"DIRECTOR DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(520,46,7,"LIC. CILIBERTO TOVAR"); // Agregar el título
	
		//$io_pdf->add_tabla(30,$la_data,$la_opciones);
	}// end function uf_print_encabezado_pagina
	//--------------------------------------------------------------------------------------------------------------------------------
	//--------------------------------------------------------------------------------------------------------------------------------
