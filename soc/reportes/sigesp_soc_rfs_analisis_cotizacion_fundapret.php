...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_numanacot,$observacion,$ad_fecha,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/fundapret.jpg',200,550,410,57); // Agregar Logo
        ...
        $io_pdf->Rectangle(35,40,740,50); 
        $io_pdf->line(35,75,775,75);                                                //HORIZONTAL    
        $io_pdf->addText(170,78,10,"Elaborado Por:"); 
        $io_pdf->addText(500,78,10,"Revisado: Jefe Dpto. de Adquisiciones"); 
        $io_pdf->addText(75,63,7,"");  
        $io_pdf->line(400,40,400,90);    
