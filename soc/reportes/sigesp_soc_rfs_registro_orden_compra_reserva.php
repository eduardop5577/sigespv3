...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->line(380,60,380,150);	//VERTICAL	
		$io_pdf->line(15,130,585,130);	//HORIZONTAL	
		$io_pdf->line(220,60,220,130);	//VERTICAL	
		$io_pdf->addText(170,135,8,"	<b>CONTRATANTE</b>"); // Agregar el título
		$io_pdf->addText(390,135,8,"	<b>PROVEEDOR</b>"); // Agregar el título
		$io_pdf->addText(25,122,7,"Nombre y Apellido <b>MARIA G. VILLEGAS N.</b>"); // Agregar el título
		$io_pdf->addText(255,122,7,"	<b>CESAR CATARI JIMENEZ</b>"); // Agregar el título
		$io_pdf->line(15,116,585,116);	//HORIZONTAL	
		$io_pdf->addText(25,105,7,"Cargo     <b>DIR. DE ADMINISTRACION DE LA OFICINA</b>"); // Agregar el título
		$io_pdf->addText(48,95,7,"<b>FUNDACION MBR-RA G/J FELIX A. VELASQUEZ</b>"); // Agregar el título
		$io_pdf->addText(225,105,7,"<b>DIR. DE LA OFICINA FUNDACION MBR-RA </b>"); // Agregar el título
		$io_pdf->addText(248,95,7,"<b> G/J FELIX A. VELASQUEZ</b>"); // Agregar el título
		$io_pdf->line(15,90,585,90);	//HORIZONTAL	
		$io_pdf->addText(25,65,7,"Firma"); // Agregar el título
		$io_pdf->addText(225,65,7,"Firma"); // Agregar el título
		$io_pdf->addText(385,122,7,"Nombre y Apellido"); // Agregar el título
		$io_pdf->addText(385,105,7,"Cargo"); // Agregar el título
		$io_pdf->addText(385,65,7,"Firma"); // Agregar el título
