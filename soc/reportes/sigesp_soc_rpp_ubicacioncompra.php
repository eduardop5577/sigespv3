...
***********************************************************************************/
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_listado($la_data)
	{	 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
						 			   'fecha'=>array('justification'=>'left','width'=>60), // Justificación y ancho de la columna
									   ...
									   'estcondat'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la columna
						 			   ...
						 			   'documento'=>array('justification'=>'center','width'=>90),
   						 			   'origen'=>array('justification'=>'left','width'=>110))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	}// end function uf_print_detalle
	//--------------------------------------------------------------------------------------------------------------------------------

	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera($ad_numreg,$ad_totmon)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	$arrResultado = $io_report->uf_select_oc($ls_numordcomdes,$ls_numordcomhas,$ls_codprodes,$ls_codprohas,$ls_estcondat,$lb_valido);
	...
	else // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			uf_print_encabezado_pagina($ls_titulo); // Imprimimos el encabezado de la página
			...
			{     
				while((!$rs_data->EOF))
				{
					...
					$arrResultado=$io_report->uf_load_ubicacion($ls_numord,$ls_codpro,$ls_procede,$lb_valido);
					$rs_data1 = $arrResultado['rs_data'];
					$lb_valido = $arrResultado['lb_valido'];
					...
					if($li_rowdet>0)
					{
						...
						{	
							...
							$la_data[$li_i]= array('codigo'=>$ls_numord,'fecha'=>$ls_fecha,'nombre'=>$ls_nombre,'estcondat'=>$ls_estcondat,
			    ...
			    uf_print_listado($la_data); // Imprimimos el detalle 		
