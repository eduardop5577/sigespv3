...
*/		$io_pdf->addJpegFromFile('../../shared/imagebank/alassa1.jpg',25,705,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/alassa2.jpg',520,705,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		$li_tm=$io_pdf->getTextWidth(14,$ls_titulo." # ".$as_numordcom);
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,730,14,$ls_titulo." # ".$as_numordcom); // Agregar el título
...
//		$io_pdf->line(15,117,585,117);	//HORIZONTAL	
		...
		$io_pdf->addText(50,63,7,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(135,122,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(165,63,7,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(265,122,7,"GERENTE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(305,63,7,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->line(410,60,410,130);	//VERTICAL		
		$io_pdf->addText(415,122,7,"PRESIDENTE ALAS"); // Agregar el título
		$io_pdf->addText(475,63,7,"FIRMA Y SELLO"); // Agregar el título
//		$io_pdf->line(15,73,585,73); //HORIZONTAL		
		$io_pdf->addText(20,43,7,$ls_nomemp."  R.I.F. ".$ls_rifemp); // Agregar el título
