...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(485,740,8," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(485,710,8,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		...
		$io_pdf->addText(50,63,7,""); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(167,122,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(160,63,7,""); // Agregar el título
		$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(275,122,7,"APROBADO POR ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(270,63,7,"FECHA"); // Agregar el título
		$io_pdf->line(410,60,410,130);	//VERTICAL		
		$io_pdf->addText(418,122,7,"RECIBIDO POR BENEFICIARIO O PROVEEDOR"); // Agregar el título
		$io_pdf->addText(420,63,7,"FECHA"); // Agregar el título
		...
		$la_data[1]=array('columna1'=>'<b>Fuente Financiamiento</b>   '.$ls_fuefin,'columna2'=>'<b> Plazo de Entrega</b> '.$as_diaplacom,'columna3'=>'<b> Lugar de Entrega:</b> ');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>300), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>135), // Justificación y ancho de la columna
		...
		$la_data[1]=array('columna1'=>'<b>Período de Entrega    Desde:</b> '.$ld_perentdesde.'    <b>Hasta:</b> '.$ld_perenthasta.'','columna2'=>'Sarare en la sede de la Contraloría Municipal');
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>435), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>135))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		// Fecha Creación: 21/06/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $ls_estcondat,$ls_estmodest, $ls_bolivares;
		global $io_pdf;
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>135), // Justificación y ancho de la columna
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				$la_clausulas="";
				$la_clausulas=$io_report->uf_load_modalidades_clausulas($ls_codtipmod,$la_clausulas);
				if($ls_tiporeporte==0)
				{
