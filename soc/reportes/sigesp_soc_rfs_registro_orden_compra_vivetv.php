...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(30,63,7,"ADMINIST. Y FINANZAS"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(157,122,7,"CONFORMADO POR"); // Agregar el título
		...
		$io_pdf->addText(265,63,7,"VICEPRESIDENCIA DE GESTION INTERNA"); // Agregar el título
