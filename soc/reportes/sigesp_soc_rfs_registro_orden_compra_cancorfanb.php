...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(30,122,7,"SECCION DE COMPRAS"); // Agregar el título
		$io_pdf->addText(35,63,6,"1/ TTE OSMEL COBOS DIAZ"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(145,122,7,"DIRECCIÓN DE GESTIÓN ADMINISTRATIVA"); // Agregar el título
		$io_pdf->addText(160,63,6,"TCNEL LUIS ARVELIO RAMIREZ GARCIA"); // Agregar el título
		$io_pdf->line(305,60,305,130);	//VERTICAL		
		$io_pdf->addText(360,122,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(325,63,6,"M/G. JUAN DE JESÚS GARCÍA TOUSSAINTT"); // Agregar el título
