...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->filledRectangle(16,131,568,$io_pdf->getFontHeight(6.5));
		$io_pdf->setColor(0,0,0);
		$io_pdf->line(15,114,585,114);	//HORIZONTAL
		$io_pdf->line(15,130,585,130);	//HORIZONTAL	
		$io_pdf->addText(30,132,6,"<b>RESPONSABLE DE COMPRAS</b>"); // Agregar el título
		$io_pdf->addText(20,124,6,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(20,116,6,"Lic. Erika Milano"); // Agregar el título
		$io_pdf->addText(30,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(130,60,130,140);	//VERTICAL	
		$io_pdf->addText(145,132,6,"<b>ADMINISTRACIÓN Y FINANZAS</b>"); // Agregar el título
		$io_pdf->addText(133,124,6,"CONFORMADO POR:"); // Agregar el título
		$io_pdf->addText(133,116,6,"Lic. Yaritza Toro"); // Agregar el título
		$io_pdf->addText(150,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(245,60,245,140);	//VERTICAL		
		$io_pdf->addText(280,132,6,"<b>PRESUPUESTO</b>"); // Agregar el título
		$io_pdf->addText(250,124,6,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(250,116,6,"Lic. Martin Villalobos"); // Agregar el título
		$io_pdf->addText(260,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(360,60,360,140);	//VERTICAL		
		$io_pdf->addText(390,132,6,"<b>VICEPRESIDENCIA</b>"); // Agregar el título
		$io_pdf->addText(363,124,6,"APROBADO POR:"); // Agregar el título
		$io_pdf->addText(363,116,6,"Ing. Adbías Peón"); // Agregar el título
		$io_pdf->addText(385,63,6,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(15,73,585,73); //HORIZONTAL
		$io_pdf->line(480,60,480,140);	//VERTICAL
		$io_pdf->addText(510,132,6,"<b>PRESIDENCIA</b>"); // Agregar el título		
		$io_pdf->addText(483,124,6,"APROBADO POR:"); // Agregar el título
		$io_pdf->addText(483,116,6,"G/B. Pedro Castro"); // Agregar el título
