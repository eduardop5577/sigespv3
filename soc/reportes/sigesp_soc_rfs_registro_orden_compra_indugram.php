...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(35,74,6,"ANALISTA DE COMPRAS"); // Agregar el título

		$io_pdf->line(120,60,120,130);	//VERTICAL
		$io_pdf->addText(150,74,6,"COORD. DE COMPRAS"); // Agregar el título

		$io_pdf->line(245,60,245,130);	//VERTICAL
		$io_pdf->addText(280,74,6,"PRESIDENTE"); // Agregar el título

		$io_pdf->line(360,60,360,130);	//VERTICAL
		$io_pdf->addText(375,74,6,"GERENCIA ADMINISTRACION"); // Agregar el título

		$io_pdf->line(475,60,475,130);	//VERTICAL
		$io_pdf->addText(510,74,6,"PROVEEDOR"); // Agregar el título
