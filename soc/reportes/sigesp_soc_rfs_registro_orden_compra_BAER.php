...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
        ...
        $io_pdf->addJpegFromFile('../../shared/imagebank/logo_baer.jpg',25,702,100,55); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		$io_pdf->addText(33,63,7,"COMPRAS"); // Agregar el título
		$io_pdf->line(115,60,115,148);	//VERTICAL
		$io_pdf->addText(120,139,7,"PLANIFICACIÓN, PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(120,130,7,"Y ORGANIZACIÓN"); // Agregar el título
		$io_pdf->addText(125,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título	
		$io_pdf->line(235,60,235,148);	//VERTICAL
		$io_pdf->addText(265,130,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(265,63,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->line(355,60,355,148);	//VERTICAL		
		$io_pdf->addText(375,130,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(360,63,7,"PRESIDENTE /GERENTE GENERAL"); // Agregar el título
		$io_pdf->line(480,60,480,148);	//VERTICAL		
		$io_pdf->addText(500,130,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(490,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		//$io_pdf->line(460,60,460,148);	//VERTICAL	
	...
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,$ls_monlet,$ls_obsordcom,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>540, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>85), // Justificación y ancho de la columna
