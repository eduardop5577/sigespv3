...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(495,680,10,$as_numordcom); // Agregar Numero de la solicitud
		$io_pdf->addText(450,663,10,"<b>  Fecha:</b>"); // Agregar texto
		$io_pdf->addText(495,663,10,$ad_fecordcom); // Agregar la Fecha
		// cuadro inferior
        $io_pdf->Rectangle(15,50,570,70); 
		$io_pdf->line(15,107,585,107);	//HORIZONTAL	
		$io_pdf->addText(40,112,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(50,53,7,"COMPRAS"); // Agregar el título
		$io_pdf->line(120,50,120,120);	//VERTICAL	
		$io_pdf->addText(167,112,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(160,53,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->line(250,50,250,120);	//VERTICAL		
		$io_pdf->addText(295,112,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(300,53,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->line(410,50,410,120);	//VERTICAL		
		$io_pdf->addText(470,112,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(455,53,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(15,63,585,63); //HORIZONTAL		
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(9,4.5,3,3); // Configuración de los margenes en centímetros
			$io_pdf->ezStartPageNumbers(580,17,8,'','',1); // Insertar el número de página
