...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsolcot,$as_fecsolcot,$as_dentipsolcot,$as_obssolcot,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.'logo.jpg',20,747,490,42); // Agregar Logo 
		...
		$la_data=array(array('name'=>'<b>                  TIPO:  </b>'.$as_dentipsolcot),
					   array('name'=>'<b>OBSERVACIÓN: Por medio de la presente nos dirigimos a ustedes con la finalidad de solicitarles presupuesto que especifique: Flete o Transporte, Caracteristicas del servicio. Tiempo de Entrega, Condiciones de Pago, Validez de la Oferta, Impuesto al Valor Agregado (IVA), del servicio o productos detallados a continuacion:</b> '.$as_obssolcot));				
		      ...
		      if ($li_numrows>0)
		         {
				   ...
				   $io_pdf->ezSetCmMargins(5,3,3,3); // Configuración de los margenes en centímetros
                               $io_pdf->addText(255,140,8,"A la atencion de:"); // Agregar el título
                               $io_pdf->addText(260,130,8,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]); // Agregar el título

                               $io_pdf->addText(40,80,7,"Agradeciendo de antemano enviar presupuesto por esta misma vía. Cualquier duda favor consultar por los Telf.(0212)903-51-50/903-51-49/903-50-80/903-50-20/903-50-38"); // Agregar el título
                               $io_pdf->addText(120,70,7,"Fax:( 0212)903-50-21/51-90 ó por los correos Electronicos: compras.idea502@gmail.com / compras@idea.gob.ve"); // Agregar el título
                               $io_pdf->addText(160,60,7,"FUNDACION INSTITUTO DE ESTUDIOS AVANZADOS-(IDEA) RIF G-20005439-5"); // Agregar el título
                               $io_pdf->addText(110,52,6,"CARRETERA NACIONAL HOYO DE LA PUERTA, VALLE DE SARTENEJAS BARUTA -EDO. MIRANDA. APARTADO POSTAL 17606,"); // Agregar el título
