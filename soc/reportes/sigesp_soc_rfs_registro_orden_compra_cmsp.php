...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(165,122,6,"AUTORIZADO"); // Agregar el título
		$io_pdf->addText(160,63,6,"CONTRALOR (A)"); // Agregar el título
		$io_pdf->line(245,60,245,130);	//VERTICAL		
		$io_pdf->addText(255,122,6,"REVISADO POR ADMINISTRACION"); // Agregar el título
		$io_pdf->line(360,60,360,130);	//VERTICAL		
		$io_pdf->addText(385,122,6,"PRESUPUESTO"); // Agregar el título
		$io_pdf->line(465,60,465,130);	//VERTICAL		
		$io_pdf->addText(466,122,6,"PROVEEDOR/PRESTADOR DE SERVICIO"); // Agregar el título
		$io_pdf->addText(510,63,6,"FIRMA/SELLO"); // Agregar el título
