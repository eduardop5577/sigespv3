...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$ls_numsep,$ls_fecsep,$ls_numrnc,
									   $ls_diaplacom,$ls_lugentdir,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->line(350,730,585,730);
        $io_pdf->Rectangle(350,700,235,60);
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_iahuc.jpg',25,725,300,60); // Agregar Logo
		if ($as_estcom=='3')
		{
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText(140,705,13,$ls_titulo); // Agregar el título
		$io_pdf->addText(355,740,9," <b>SEP No. </b>".$ls_numsep); // Agregar el título
		$io_pdf->addText(355,710,9,"<b>Fecha </b>".$ls_fecsep); // Agregar el título
		...
		$io_pdf->addText(17,63,7,"JEFE DE UNIDAD DE COMPRAS"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(167,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(140,63,7,"DIRECTOR DE ADMINISTRACION"); // Agregar el título
		$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(300,122,7,"APROBADO POR"); // Agregar el título
		...
		$io_pdf->ezSetY(695);
		$la_data[1]=array('columna1'=>'<b>Proveedor</b>  '.$as_nombre.'<b>             Rif</b> '.$as_rifpro.'<b>             RNC</b> '.$ls_numrnc,
		...
		$la_data[1]=array('columna1'=>'<b>Período de Entrega    Desde:</b> '.$ld_perentdesde.'    <b>Hasta:</b> '.$ld_perenthasta.'','columna2'=>'Forma de Entrega: '.$ls_lugentdir);
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_detalle_clausulas($la_data,$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-30);
		$la_dataclausulas[1]=array('dencla'=>"GARANTIAS");
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_numrnc=$row["ocei_no_reg"];
				$ls_diaplacom=$row["diaplacom"]." dias";
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_estcom,$ls_numsep,$ls_fecsep,$ls_numrnc,$ls_diaplacom,$ls_lugentdir,$io_pdf);
