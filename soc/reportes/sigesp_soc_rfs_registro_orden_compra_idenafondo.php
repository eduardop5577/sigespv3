...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$as_nomusu,$as_nomusuapr,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(25,90,7,$_SESSION["la_apeusu"].", ".$_SESSION["la_nomusu"]); // Agregar el título
		$io_pdf->addText(55,63,7,"ANALISTA"); // Agregar el título		
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(155,122,7,"CONTABILIZADO POR"); // Agregar el título
		$io_pdf->addText(135,63,7,"PLANIFICACION Y PRESUPUESTO"); // Agregar el título
		$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(300,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(280,63,7,"ADMINISTRADOR FONDO NNA"); // Agregar el título
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>115), // Justificación y ancho de la columna
						 			   ...
						 			   'cantidad'=>array('justification'=>'right','width'=>55), // Justificación y ancho de la columna
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_codusu=$row["codusureg"];
				$ls_codusuapr=$row["codusuapr"];
				...
				$ls_nomusu = $io_report->uf_select_nombre_usuario($ls_codusu);
				$ls_nomusuapr = $io_report->uf_select_nombre_usuario($ls_codusuapr);
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_estcom,$ls_nomusu,$ls_nomusuapr,$io_pdf);
