...
//---------------Modificado por el ing. liobel henriquez proforca 09-08-2011 ----------------------------------------------------------------
		$io_pdf->line(18,40,585,40);
		$io_pdf->line(480,700,480,780);

		$io_pdf->line(480,760,588,760);

		$io_pdf->line(480,730,588,730);

                $io_pdf->Rectangle(18,700,570,80);  
...
//        	$io_pdf->Rectangle(15,700,570,60);
		...
		//---------------Modificado por el ing. liobel henriquez proforca 09-08-2011 para colocar la direccion de la Empresa en el pie de Pagina--------------------------
		$io_pdf->addText(18,50,6,"Dirreción Fiscal: Calle Caicara con Carrera El Miamo, Centro Empresarial Ferrocasa, Torre A, Piso 4,6 y PH. Puerto Ordaz, Ciudad Guayana, Estado Bolivar; Telf: (0286-9238433, 9238445); R.I.F: J-09512855-5"); // Agregar Direccion de Proforca
//--------------------fin de la direccion proforca
//---------------Modificado por el ing. Liobel henriquez para ubicar la bandera del ministerio del poder popular para la agricultura y tierras--------------------
		$io_pdf->addJpegFromFile('../../shared/imagebank/pie_pagina_proforca.jpg',15,20,570,25); // Agregar Pie de pagina proforca
//---------------fin de la bandera del ministerio
		...
		// cuadro inferior
        $io_pdf->Rectangle(18,60,570,70); 
		$io_pdf->line(18,117,588,117);	//HORIZONTAL	
		$io_pdf->addText(40,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(30,63,7,"ANALISTA DE COMPRAS"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(167,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(150,63,7,"JEFE DE DPTO. COMPRAS"); // Agregar el título
		$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(295,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(300,63,7,"GERENTE FINANZAS"); // Agregar el título
		...
		$io_pdf->line(18,73,588,73); //HORIZONTAL		
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			// 3.6,6,3,3			
			$io_pdf->ezSetCmMargins(7.5,5,3.2,3); // Configuración de los margenes en centímetros
			
		///-----	$io_pdf->ezStartPageNumbers(570,47,8,'','',1); // Insertar el número de página
			
			//------------Modificado por ing. Liobel Henriquez 09-08-2011 Proforca-------------------------------

			$io_pdf->ezStartPageNumbers(530,764,8,'','',1); // Insertar el número de página

		//---------para ubicar el numero de pagina en el encabezado no en el pie de pagina--------------------
...
//-------------------------modificado por el ing. liobel henriquez en fecha 11-08-2011, para colocar la unidad de medida asicioda al articulo no la de mayor o detal
						if($ls_estcondat=="B")
							{
