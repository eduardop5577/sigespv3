...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(50,63,6,"COMPRAS"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(162,122,6,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(160,63,6,"ADMINISTRACION"); // Agregar el título
		$io_pdf->line(250,60,250,130);	//VERTICAL		
		$io_pdf->addText(275,122,6,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(273,63,6,"GESTION INTERNA"); // Agregar el título
		$io_pdf->line(355,60,355,130);	//VERTICAL		
		$io_pdf->addText(385,122,6,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(393,63,6,"PRESUPUESTO"); // Agregar el título
		$io_pdf->line(475,60,475,130);	//VERTICAL		
		$io_pdf->addText(510,122,6,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(500,63,6,"FIRMA/SELLO/FECHA"); // Agregar el título
