...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$ls_analista,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(25,145,7,"Por el/la Contratista"); // Agregar el título
		$io_pdf->addText(25,135,7,"___________________________________________"); // Agregar el título
		$io_pdf->addText(40,122,7,"ELABORADO POR"); // Agregar el título
	    $io_pdf->addText(20,75,6,$ls_analista);
		$io_pdf->addText(32,63,7,"UNIDAD DE COMPRAS"); // Agregar el título
		
		$io_pdf->line(130,60,130,129);	//VERTICAL	
		$io_pdf->addText(170,122,7,"VALIDADO POR"); // Agregar el título
		$io_pdf->addText(155,63,7,"FIRMA /SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(165,75,6,"PRESUPUESTO"); // Agregar el título
		
		$io_pdf->line(258,60,258,130);	//VERTICAL		
		$io_pdf->addText(300,122,7,"CERTIFICADO POR"); // Agregar el título
		$io_pdf->addText(295,75,6,"COORD. ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(295,63,7,"FIRMA /SELLO / FECHA"); // Agregar el título
		
//		$io_pdf->line(357,60,357,130);	//VERTICAL		
//		$io_pdf->addText(380,122,7,"AUTORIZADO POR"); // Agregar el título
//		$io_pdf->addText(358,63,7,""); // Agregar el título
		//$io_pdf->addText(380,75,6,"ELIONORA MARINCO"); // Agregar el título
		
		$io_pdf->line(421,60,421,130);	//VERTICAL		
		$io_pdf->addText(470,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(465,63,7,"FIRMA /SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(455,75,6,"DIR. SOPORTE ADMINISTRATIVO"); // Agregar el título
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_analista=strtoupper($row["nomusureg"].' '.$row["apeusureg"]);
				...
				$la_clausulas=$io_report->uf_load_modalidad_clausulas($ls_codtipmod);
				if($ls_tiporeporte==0)
				{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_estcom,$ls_analista,$io_pdf);
		...
		{
			$li_rowcla=count((array)$la_clausulas);
