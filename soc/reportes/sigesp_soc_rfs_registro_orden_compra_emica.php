...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$as_codconobr,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->line(315,655,585,655);
		$io_pdf->line(480,700,585,700);
        $io_pdf->Rectangle(315,640,270,60);
		//$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],15,750,570,30); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_emica.jpg',15,700,570,70); // Agregar Logo
		if ($as_estcom=='3')
		{
			$io_pdf->addText(480,705,9,"<b>ANULADO</b>"); // Agregar la Fecha 765
		}
		if($as_estcondat=="B") 
        {
		...
		$tm=396-($li_tm/2);
		$io_pdf->addText($tm,672,14,$ls_titulo); // Agregar el título
		$io_pdf->addText(17,658,7,"<b>CARRERA 01 ENTRE CALLE 6 Y 7 URB. NUEVA SEGOVIA QTA. MORERE.</b>"); // Agregar el título
		$io_pdf->addText(17,651,7,"<b>TELF: (051) 540433</b>"); // Agregar el título
		$io_pdf->addText(17.5,644,7,"<b>FAX: (051) 552522</b>"); // Agregar el título
		$io_pdf->addText(17.5,637,7,"<b>RIF: G-20009017-0</b>"); // Agregar el título
		$io_pdf->addText(481,685,8.5," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(481,665,8.5,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		$io_pdf->addText(481,645,8.5,"<b> </b>"); // Agregar el título
		$io_pdf->addText(345,645,8.5,"<b>Contrato Asociado Nro. </b>".$as_codconobr); // Agregar el título
		$io_pdf->addText(540,710,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(546,704,6,date("h:i a")); // Agregar la Hora
		// cuadro inferior
        $io_pdf->Rectangle(15,60,570,70); 
		$io_pdf->line(15,117,585,117);	//HORIZONTAL	
		$io_pdf->addText(35,122,7,"UNIDAD DE  COMPRAS"); // Agregar el título
		$io_pdf->addText(56,63,7,"FIRMA"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(140,122,7,"UNIDAD DE  PRESUPUESTO"); // Agregar el título
		...
		$la_data[2]=array('columna1'=>'<b>Rif</b>  '.$as_rifpro,
		                 'columna2'=>' ');
		...
		$la_data[1]=array('columna1'=>'<b>Fuente de Financiamiento</b>    ','columna2'=>'<b>Periodo de Entrega / Plazo de Ejecucion</b>    ');
		$la_data[2]=array('columna1'=>$as_denfuefin,'columna2'=>'<b>Desde</b> '.$ld_perentdesde.'  <b>Hasta</b> '.$ld_perenthasta);
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,$ls_monlet,$ls_ressoc,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($ls_ressoc=="1")
		{
			$ls_desressoc=" Sí   X     No   ___";
		}
		else
		{
			$ls_desressoc=" Sí  ___   No    X";
		}
		$la_data[1]=array('titulo'=>'<b> Compromiso de Responsabilidad Social:                              3% del Monto Contratado Sin IVA               '.$ls_desressoc.'</b>');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		unset($la_columnas);
		unset($la_config);
		$la_data[1]=array('titulo'=>'<b> Clausula de Penalizacion: </b>   Si el Contratista no  inicia o termina  los trabajos  en el  plazo  estipulado,  deberá pagar a EMICA, S.A., por  cada dia de retraso,  sin necesidad de requerimiento  alguno, el dos por  ciento (2%) sobre el monto de la Orden (Art. 181 del Reglamento   de Ley de Contrataciones Publicas).');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_estcom,$ls_codconobr,$io_pdf);
		...
		uf_print_piecabecera($ld_monsubtot,$ld_monimp,$ld_montot,$ls_monto,$ls_ressoc,$io_pdf);
	} 	  	 
