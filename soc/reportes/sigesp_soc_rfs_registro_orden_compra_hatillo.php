...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText($tm,730,14,$ls_titulo); // Agregar el título
                ...
                $io_pdf->addText(410,710,9," <b>G-20000201-8</b>");// Agregar el título
		...
		$io_pdf->addText(169,66,7,"COMPRAS"); // Agregar el título
		$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(295,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(295,63,7,"DIRECCION DE ADMIN"); // Agregar el título
	...
	function uf_print_clausulas($ls_diaplacom)
	{
		...
		$la_data[2]=array('titulo'=>'El monto total de la presente Orden será cancelado en uno  o varios pagos contra la entrega total de los bienes o servicios comprendidos en la misma y previa presentación de la factura original correspondiente, conformada mediante la respectiva Acta de Control Perceptivo.');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[2]=array('titulo'=>'Los bienes o servicios adquiridos, deberán ser entregados en un lapso de no mayor '.$ls_diaplacom.' días, posteriores a la aceptación de la presente Orden y entregados en  las instalaciones o sedes de la Alcaldía del municipio El Hatillo señalado en el Adverso de esta orden');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[2]=array('titulo'=>'El contratista podrá presentar una fianza correspondiente a la garantía de fiel cumplimiento y en caso de no presentarla, en los casos aplicables se le efectuara una la retención del 10% sobre los pagos que se realicen, cuyo monto total retenido será reintegrado al momento de la recepción definitiva del bien o servicios, según lo establecido en el artículo 123 de la Ley de Contrataciones Públicas Vigente. ');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[2]=array('titulo'=>'El Control Perceptivo deberá ser realizado por los funcionarios de la Unidad Usuaria correspondiente, y debe ser consignado a la Dirección General Sectorial de Administración y Finanzas para proceder a realizar el cumplimiento de las obligaciones administrativa adquirida con el proveedor.');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[2]=array('titulo'=>'El contratista se compromete a realizar un aporte equivalente al 3% del Monto del Contrato sin Incluir el Impuesto al valor agregado, el cual deberá realizarse antes del cierre administrativo del Contrato.');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[2]=array('titulo'=>'Los bienes o servicios contemplados en esta Orden sólo se entenderán debidamente recibidos y/o aceptados, previa realización del Control Perceptivo por parte de la Unidad Usuaria correspondiente. ');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[2]=array('titulo'=>'“EL CONTRATISTA” garantiza que los bienes o servicios objeto de esta Orden de cumple con las especificaciones técnicas establecidas en los pliegos de condiciones o  condiciones generales de contratación. Igualmente garantiza en caso que corresponda que los bienes son nuevos, y que están libres de vicios ocultos. ');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$io_pdf->ezSetDy(-2);
		$la_data[1]=array('titulo'=>'<b>8. PROHIBICIÓN DE SUB-CONTRATOS, CESIONES O TRASPASOS.  </b>');
		$la_data[2]=array('titulo'=>'Esta Orden no podrá ser objeto de sub-contratos, cesiones o traspasos, en forma total o parcial.');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$io_pdf->ezSetDy(-2);
		$la_data[1]=array('titulo'=>'<b>9. RESCISIÓN DE LA ORDEN DE COMPRA O SERVICIO. </b>');
		$la_data[2]=array('titulo'=>'La Alcaldía del Municipio El Hatillo podrá rescindir unilateralmente la presente Orden, en cualquier momento y sin que por ello tenga derecho el contratista “a recibir indemnización alguna.');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$io_pdf->ezSetDy(-2);
		$la_data[1]=array('titulo'=>'<b>10. CAUSALES DE RESCISIÓN UNILATERAL DE LA ORDEN DE COMPRAS.  </b>');
		$la_data[2]=array('titulo'=>'Son causales de rescisión unilateral de esta Orden de Compra ');
		...
		$la_data[4]=array('titulo'=>'   b)	Cuando la Alcaldía del municipio El Hatillo considere que sus intereses puedan ser lesionados. ');
		$la_data[5]=array('titulo'=>'   c)	Por cualquiera de las causales de rescisión contempladas en las Leyes y Ordenanzas. ');
		$la_data[6]=array('titulo'=>'La rescisión unilateral de la Orden de Compra declarada en virtud del incumplimiento de las obligaciones asumidas por el contratista dará lugar a la ejecución de la garantía de Fiel Cumplimiento, sin perjuicio del pago de los daños y perjuicios causados. ');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$io_pdf->ezSetDy(-2);
		$la_data[1]=array('titulo'=>'<b>11. CLAUSULA PENAL. Para garantizar el fiel cumplimiento de la obligación, conforme a lo previsto en el artículo 138 del Reglamento de la Ley de Contrataciones Públicas, el contratista deberá pagar a la Alcaldía del Municipio El Hatillo por cada día de retardo en el cumplimiento de su obligación de acuerdo a la fecha fijada en el contrato o la prórroga, una cantidad equivalente al dos por ciento (2%) del monto de los bienes, materiales o servicios no entregados, hasta un máximo de diez por ciento (10%) del monto total de la orden. El pago del mencionado porcentaje por concepto de penalización deberá realizarse a más tardar dentro de los treinta (30) días hábiles siguientes a la fecha de emisión del pronunciamiento al último control perceptivo practicado por la Unidad Usuaria. </b>');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$io_pdf->ezSetDy(-2);
		$la_data[1]=array('titulo'=>'<b>12. ADMINISTRACIÓN DE LA ÓRDEN DE COMPRA O SERVICIO </b>');
		$la_data[2]=array('titulo'=>'Queda expresamente entendido entre las partes que la Dirección General de Administración y Finanzas de la Alcaldía de del Municipio El Hatillo en su carácter de Unidad Requirente, será la responsable de velar por la ejecución de esta Orden de Compra / Servicios, en los términos aquí contemplados.');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[2]=array('titulo'=>'Las notificaciones para todo lo referente a la ejecución de la presente Orden de Compra, sus derivados y consecuencias, se considerarán validamente realizadas, con acuse de recibo de las mismas.');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$io_pdf->ezSetDy(-2);
		$la_data[1]=array('titulo'=>'<b>14. CARÁCTER VINCULANTE DE LAS CONDICIONES DE CONTRATACION. </b>');
		$la_data[2]=array('titulo'=>'Los pliegos de condiciones o condiciones generales de contratación, forman parte de presente contrato y se dan aquí por reproducidas, asi como las condiciones de la oferta aceptadas por el Municipio. ');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 6, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_retencion($li_subtot,$ld_montoret)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'center','width'=>210))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>250, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>120), // Justificación y ancho de la columna
	...
	else  // Imprimimos el reporte
	{
		...
		if($ls_ressoc=="1")
		{
			...
			$io_pdf->ezSetCmMargins(4,4,4,4); // Configuración de los margenes en centímetros
