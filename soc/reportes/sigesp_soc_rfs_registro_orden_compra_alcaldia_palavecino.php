...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$as_uniejeaso,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//		$io_pdf->line(480,720,480,760);
//		$io_pdf->line(480,740,585,740);
        /////$io_pdf->Rectangle(95,720,500,40);
		//////$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],10,715,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		if ($as_estcom=='3')
		{
       ...
       ///// else
		...
		////$tm=296-($li_tm/2);
		$io_pdf->addText(150,685,12,"ORDEN DE COMPRA"); // Agregar el título
		$io_pdf->addText(390,669,15,"<b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(480,688,12,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		// cuadro inferior
        $io_pdf->Rectangle(15,30,570,70); 
		$io_pdf->line(15,85,585,85);	//HORIZONTAL	
		$io_pdf->addText(65,88,8,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(62,34,8,"DIVISION COMPRAS"); // Agregar el título
		$io_pdf->addText(262,88,8,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->line(210,30,210,100);	//VERTICAL	
		$io_pdf->line(400,30,400,100);	//VERTICAL		
		$io_pdf->addText(250,34,8,"JEFE DIVISION DE COMPRAS"); // Agregar el título
		$io_pdf->addText(435,88,8,"CONTROL PRESUPUESTARIO"); // Agregar el título
		$io_pdf->addText(433,34,8,"DIVISION DE PRESUPUESTO"); // Agregar el título
		$io_pdf->line(15,43,585,43); //HORIZONTAL		
		
		$io_pdf->ezSetY(660);
		$la_data[1]=array('columna1'=>'<b>Proveedor:</b>',
		                 'columna2'=>trim($as_codigo)." - ".rtrim($as_nombre).'');
		$la_data[2]=array('columna1'=>'<b>  Direccion:</b>',
		                 'columna2'=>$as_dirpro.'');
		$la_data[3]=array('columna1'=>'<b>  Concepto:</b>',
		                 'columna2'=>$as_conordcom.'');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>60), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>510))); // Justificación y ancho de la columna
...
/*		$ls_uniadm=$as_coduniadm."  -  ".$as_denuniadm;
		...
		unset($la_config);*/
		$io_pdf->EzSetDy(-5);
		$la_data[1]=array('columna1'=>$as_uniejeaso);
		$la_columnas=array('columna1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('nro'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la columna
						 			   'codigo'=>array('justification'=>'center','width'=>115), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>215), // Justificación y ancho de la columna
...
/*		$la_data[1]=array('titulo'=>'<b> Son: '.$ls_monlet.'</b>');
	...
	function uf_print_piecabeceramonto_bsf($li_montotaux,$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-15);
		$la_data[1]=array('titulo'=>$li_montotaux);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$ls_estcom,$ls_uniejeaso,$io_pdf);
			   ...
			   if ($lb_valido)
			   {
				 ...
				 if ($li_totrows>0)
				 {
				    ...
				    while($row=$io_sql->fetch_row($rs_datos))
					{
						...
						$la_data[$li_i]=array('nro'=>$li_i,'codigo'=>$ls_codartser,'denominacion'=>$ls_denartser,'cantidad'=>$li_cantartser,
											  'cosuni'=>$ld_preartser,'baseimp'=>$ld_subtotartser);
					}
		...
		uf_print_piecabeceramonto_bsf($ls_monto,$io_pdf);
		uf_print_piecabecera($ld_monsubtot,$ld_monimp,$ld_montot,$ls_monto,$io_pdf);
	} 	  	 
