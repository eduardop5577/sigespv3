...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,$as_estcom,$io_pdf)
	{
		...
		$io_pdf->addText(40,68,6,"COMPRAS"); // Agregar el título

		$io_pdf->line(105,60,105,130);	//VERTICAL
		$io_pdf->addText(108,121,6,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(138,68,6,"PRESUPUESTO"); // Agregar el título

		$io_pdf->line(215,60,215,130);	//VERTICAL
        $io_pdf->addText(218,121,6,"APROBADO POR:"); // Agregar el título
		$io_pdf->addText(245,68,6," ADMINISTRACION"); // Agregar el título

		$io_pdf->line(335,60,335,130);	//VERTICAL
		$io_pdf->addText(338,121,6,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(385,68,6,"PRESIDENCIA"); // Agregar el título

		$io_pdf->line(475,60,475,130);	//VERTICAL
		$io_pdf->addText(478,121,6,"PROVEEDOR:"); // Agregar el título
		$io_pdf->addText(500,68,6,"FIRMA/SELLO/FIRMA"); // Agregar el título
