...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_compra->uf_load_seguridad("SOC","sigesp_soc_p_anulacion_registro_cotizacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_soc_anulacion_registro_cotizacion.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
