...
$la_seguridad = Array();
$la_permisos = Array();	
$arrResultado=$io_fun_viaticos->uf_load_seguridad("SCV","sigesp_scv_r_solicitudespagoviatico.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="437" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td align="center"><div align="right">Tipo de Mision </div></td>
      <td width="280" align="center"><div align="left">
        <select name="cmbtipvia" id="cmbtipvia" onChange="javascript: ue_tipoviatico();">
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				{
					li_ordenfec=0;
					window.open("reportes/"+formato+"?codsoldes="+ls_solicituddesde+"&codsolhas="+ls_solicitudhasta+"&ordenfec="+li_ordenfec+"&desde="+ld_desde+"&hasta="+ld_hasta+"&tiporeporte="+ls_tiporeporte+"&tipvia="+ls_tipvia,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				}
				else
				{
