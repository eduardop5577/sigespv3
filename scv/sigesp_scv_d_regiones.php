...
$ls_codpais=   $io_fun_viaticos->uf_obtenervalor("cmbpais","058");
...
<table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
	  ...
	  <tr>
        ...
        <td height="22"><?php
          ...
          ?>
           <select name="cmbpais" id="cmbpais" style="width:150px; background-color: gainsboro"  disabled="disabled" onChange="document.form1.hidpais.value=this.value; javascript: ue_nuevo()">
