...
$la_seguridad = Array();
$la_permisos = Array();	
$arrResultado=$io_fun_viaticos->uf_load_seguridad("SCV","sigesp_scv_r_solicitudes.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="476" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="458" colspan="2" class="titulo-ventana">Listado de Solicitudes de Viaticos por Persona </td>
    </tr>
  </table>
  <table width="547" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr>
      <td width="545"></td>
    </tr>
    ...
    <tr>
      <td height="33" colspan="3" align="center">      <div align="left">
        <table width="510" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="2"><strong>Intervalo de Registro </strong></td>
            <td width="33">&nbsp;</td>
            <td width="157">&nbsp;</td>
            <td width="78">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td width="107" height="22"><input name="txtdesde" type="text" id="txtdesde" size="15"  onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);" style="text-align:center" datepicker="true"></td>
          ...
          <tr>
            <td height="23"><div align="right">Beneficiario</div></td>
            <td height="23"><input name="txtcodben" type="text" id="txtcodben" size="17" style="text-align:center" readonly></td>
            <td height="23" colspan="3"><a href="javascript: ue_buscarbeneficiario();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
          ...
          <tr>
            <td height="22"><div align="right">Ubicacion Fisica </div></td>
          ...
          <tr>
            <td height="22"><div align="right">Estatus Modulo Viaticos </div></td>
            <td height="22">&nbsp;</td>
            <td height="22" colspan="3">&nbsp;</td>
          </tr>
          <tr>
            <td height="22"><div align="right">Estatus Modulo CXP </div></td>
            <td height="22">&nbsp;</td>
            <td height="22" colspan="3">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="22"><div align="right">Ruta</div></td>
            <td height="22">&nbsp;</td>
            <td height="22" colspan="3">&nbsp;</td>
          </tr>
        </table>
