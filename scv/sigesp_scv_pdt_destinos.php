...
<html>
<head>
<title>Detalle de Destinos </title>
...
<table width="506" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td width="502" colspan="2" class="titulo-celda">Detalle de Destinos </td>
  </tr>
</table>
<form name="form1" method="post" action="">
  <table width="502" border="0" align="center" class="formato-blanco">
    ...
    <tr>
      <td><div align="right">Distancia</div></td>
      <td colspan="3" align="center"><div align="left">
        <input name="txtcankms" type="text" id="txtcankms" style="text-align:center" onKeyPress="return(ue_formatonumero(this,'.',',',event));" value="0,00" size="8">
       Kms. </div></td>
    </tr>
    <tr>
...
function ue_agregar()
{
	...
	if(lb_valido)
	{
		...
		else
		{
			...
			obj.value=ls_desciu;
			obj=eval("opener.document.form1.txtcankms"+li_totrows+"");
			obj.value=li_cankms;
