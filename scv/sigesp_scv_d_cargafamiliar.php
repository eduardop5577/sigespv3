      ...
      <td width="517" height="170"><div align="center">
        <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
          ...
          <tr>
            ...
            <td height="22"><input name="txtdencar" id="txtdencar" value="<?php print $ls_dencar ?>" type="text" size="60" maxlength="250" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+'.,-');"></td>
          </tr>
          <tr> 
