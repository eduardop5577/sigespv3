...
$la_seguridad = Array();
$la_permisos = Array();	
$arrResultado=$io_fun_viaticos->uf_load_seguridad("SCV","sigesp_scv_d_otrasasignaciones.php",$ls_permisos,$la_seguridad,$la_permisos);
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
   function uf_limpiarvariables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		global $ls_codotrasi,$ls_denotrasi,$li_tarotrasi,$ls_codmon,$ls_denmon;
...
switch ($ls_operacion) 
{
	...
	case "GUARDAR":
		if ($ls_estatus=="C")
		{
			...
			{
				$lb_valido=$io_scv->uf_scv_update_otrasasignaciones($ls_codemp,$ls_codotrasi,$ls_denotrasi,$li_tarotrasi,$ls_codmon,
																	$la_seguridad);
			}
			if($lb_valido)
			{
		...
		{
			$ls_existe=$io_scv->uf_scv_select_otrasasignaciones($ls_codemp,$ls_codotrasi);
			if ($ls_existe==="TRUE")
			{
			...
			{
				$lb_valido=$io_scv->uf_scv_insert_otrasasignaciones($ls_codemp,$ls_codotrasi,$ls_denotrasi,$li_tarotrasi,$ls_codmon,
																	$la_seguridad);
				if ($lb_valido)
				{
