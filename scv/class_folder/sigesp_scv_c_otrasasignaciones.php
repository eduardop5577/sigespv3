...
class sigesp_scv_c_otrasasignaciones
{
	...
	function uf_scv_insert_otrasasignaciones($as_codemp,$as_codotrasi,$as_denotrasi,$ai_tarotrasi,$as_codmon,$aa_seguridad) 
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql=" INSERT INTO scv_otrasasignaciones (codemp, codotrasi, denotrasi, tarotrasi, codmon)".
				"      VALUES ('".$as_codemp."','".$as_codotrasi."','".$as_denotrasi."','".$ai_tarotrasi."','".$as_codmon."')";
	...
	function uf_scv_update_otrasasignaciones($as_codemp,$as_codotrasi,$as_denotrasi,$ai_tarotrasi,$as_codmon,$aa_seguridad) 
	{
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql=" UPDATE scv_otrasasignaciones".
				"    SET denotrasi='".$as_denotrasi."', tarotrasi='".$ai_tarotrasi."', codmon='".$as_codmon."'".
				"  WHERE codemp='" .$as_codemp. "'".
				"    AND codotrasi='".$as_codotrasi."'";
		$rs_data = $this->io_sql->execute($ls_sql);
		if ($rs_data===false)
