...
//		$as_codreg=$this->io_funciondb->uf_generar_codigo(true,$as_codemp,'scv_regiones','codreg',$as_codpai);
		...
		else
		{
			if ($this->uf_insert_dt_incremento($as_codinc,$ar_grid,$ai_total,$aa_seguridad))
			{
				...
				/////////////////////////////////         SEGURIDAD               ////////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion =" Insertó  el Incremento ".$as_codinc." de la region ".$as_codreg." Asociada a la empresa ".$this->ls_codemp;
				...
				{
					$this->io_msg->message("Se Asigno el Código de Incremento: ".$as_codinc);
				}
			}
		}
		return $lb_valido;
			...
			if ($lb_valido)
			{
				...
				if (!empty($ls_codregdes))			            
				{
					...
					{				 
						...
						/////////////////////////////////         SEGURIDAD               /////////////////////////////		
						$ls_evento      ="INSERT";
						$ls_descripcion =" Insertó el detalle de incremento ".$as_codinc." - ".$ls_codregdes." asociado a la Empresa ".$this->ls_codemp;
						$ls_variable    = $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
						$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
						$aa_seguridad["ventanas"],$ls_descripcion);
						/////////////////////////////////         SEGURIDAD               ///////////////////////////// 
	...
	function uf_update_incremento($as_codinc,$as_codreg,$as_codmis,$as_deninc,$ar_grid,$ai_total,$aa_seguridad) 
	{
		...
		{
			if ($this->uf_delete_dt_incremento($as_codinc,$aa_seguridad))//Eliminar todos los estados asociados a una                                                                                   región.
			{                  
				if ($this->uf_insert_dt_incremento($as_codinc,$ar_grid,$ai_total,$aa_seguridad))
				{                        
					$lb_valido=true;
					/////////////////////////////////         SEGURIDAD               /////////////////////////////		
					$ls_evento="UPDATE";
					$ls_descripcion ="Actualizó el Incremento ".$as_codinc." Asociada a la empresa ".$this->ls_codemp;
					$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
													$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
													$aa_seguridad["ventanas"],$ls_descripcion);
					/////////////////////////////////         SEGURIDAD               /////////////////////////////
	...
	{          		 
		...
		if ($this->uf_delete_dt_incremento($as_codinc,$aa_seguridad))  
		{
			...
			else
			{
				...
				/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="DELETE";
				$ls_descripcion ="Eliminó el Incremento ".$as_codinc." Asociada a la empresa ".$this->ls_codemp;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
				/////////////////////////////////         SEGURIDAD               /////////////////////////////
	...
	function uf_load_incremento($as_codinc) 
	{
		...
		// 	          Access:  public
		// 	       Arguments:  $as_codinc // Código de la Empresa.
		//	         Returns:  $lb_valido.
