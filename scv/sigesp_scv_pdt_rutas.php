...
<form name="form1" method="post" action="">
  <table width="502" border="0" align="center" class="formato-blanco">
    ...
    <tr>
      <td><div align="right">Continente Destino </div></td>
      <td colspan="3" align="center"><div align="left">
...
function ue_agregar()
{
	...
	ls_codcont=f.txtcodcont.value;
	ls_dencont=f.txtdencont.value;
	...
	if(lb_valido)
	{
		...
		else
		{
			...
			obj.value=ls_desciu;
			obj=eval("opener.document.form1.txtdencontdes"+li_totrows+"");
			obj.value=ls_dencont;
			obj=eval("opener.document.form1.txtcodcontdes"+li_totrows+"");
