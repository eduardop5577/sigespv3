...
$ls_sql= " SELECT codotrasi,denotrasi,tarotrasi,codmon,(SELECT denmon FROM sigesp_moneda WHERE scv_otrasasignaciones.codmon=sigesp_moneda.codmon) AS denmon".
	...
	for ($z=1;$z<=$totrow;$z++)
	{
		switch($ls_destino)
		{
			case"DEFINICION":
				...
				print "<td><a href=\"javascript: aceptar('$ls_codotrasi','$ls_denotrasi','$li_tarotrasi','$ls_codmon','$ls_denmon');\">".$ls_codotrasi."</a></td>";
...
<script >
function aceptar(ls_codotrasi,ls_denotrasi,li_tarotrasi,li_codmon,li_denmon)
{
	...
	opener.document.form1.txtcodmon.value= li_codmon;
	opener.document.form1.txtdenmon.value= li_denmon;
