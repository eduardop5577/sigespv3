   ...
   function uf_print($as_spg_cuenta, $as_tipo)
   {
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_programatica="";
				$ls_programatica=$io_fun_viaticos->uf_formatoprogramatica($ls_codpro,$ls_programatica);
				switch ($as_tipo)
				{
					case "NACIONALES":
					...
					case "TRANSPORTE":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptar_transporte('$ls_spg_cuenta','$ls_denominacion');\">".$ls_spg_cuenta."</a></td>";
						print "<td>".$ls_denominacion."</td>";
						print "<td align=center>".$ls_programatica."</td>";
						print "</tr>";			
					break;
...
function aceptar_transporte(spg_cuenta,denominacion)
{
	opener.document.form1.txtspgtra.value=spg_cuenta;
    opener.document.form1.txtdenspgtra.value=denominacion;
	close();
}
