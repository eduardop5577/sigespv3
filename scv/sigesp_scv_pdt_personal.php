...
<form name="form1" method="post" action="">
  <table width="555" border="0" align="center" class="formato-blanco">
    <tr>
	 ...
	 ?>
	  <td height="22" colspan="3" align="center"><div align="left">
        <input name="rdbpersonal" type="radio" class="sin-borde" onClick="javascript: ue_personal();" value="radiobutton">
      Personal 
      <input name="rdbpersonal" type="radio" class="sin-borde" value="radiobutton" onClick="javascript: ue_beneficiarios2();">
      For&aacute;neo</div></td>
     <?php
	 	}
	 ?>
...
function ue_beneficiarios2()
{
	f=document.form1;
	alert("El tipo de viatico no permite Beneficiarios foraneos para los viaticos");
	f.rdbpersonal[0].checked=true;
	window.open("sigesp_scv_cat_personal.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
}
...
function ue_agregar()
{
	...
	if((f.rdbpersonal[0].checked==true)&&(ls_codclavia==""))
	{
		alert("El personal debe tener una categoria de viaticos");
	}
	else
	{
...
<script  src="../cfg/scv/js/funciones.js"></script>
</html>
