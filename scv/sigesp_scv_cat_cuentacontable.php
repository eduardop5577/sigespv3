		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					...
					case "PAGO":
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptar_pago('$ls_sc_cuenta','$ls_denominacion');\">".$ls_sc_cuenta."</a></td>";
						print "<td>".$ls_denominacion."</td>";
						print "</tr>";			
					break;
				}
...
function aceptar_pago(sc_cuenta,denominacion)
{
	opener.document.form1.txtscpagodol.value=sc_cuenta;
    opener.document.form1.txtdenpagodol.value=denominacion;
	close();
}
