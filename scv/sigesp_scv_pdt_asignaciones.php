...
function ue_tarifaviaticos()
{
	...
	origen=f.destino.value;
	categoria="";
	if(origen=="NACIONALES")
	{
		categoria=eval("opener.document.form1.txtcodclavia1.value");
		ls_destino="NACIONALES";
	}
	window.open("sigesp_scv_cat_tarifas.php?destino="+ls_destino+"&categoria="+categoria,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
