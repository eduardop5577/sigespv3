...
$ls_categoria=$io_fun_viaticos->uf_obtenervalor_get("categoria","");
?>
...
if($ls_categoria!="")
{
	$ls_filtro= "AND codcat='".$ls_categoria."' AND nacext='0'";
}
if($ls_destino=="NACIONALES")
{
	$ls_filtro= $ls_filtro." AND nacext='0'";
}
$ls_sql= " SELECT scv_tarifas.*,".
		 ...
		 "          WHERE scv_tarifas.codmon=sigesp_moneda.codmon) AS denmon".
		 "   FROM scv_tarifas".
...
function aceptar_definicion(ls_codtar,ls_dentar,ls_codpai,ls_despai,ls_codreg,ls_denreg,ls_codcat,ls_dencat,ls_codnom,
							ls_desnom,ls_codmis,ls_codmon,ls_denmon)
{
	...
	opener.document.form1.txtcodmon.value= ls_codmon;
	opener.document.form1.txtdenmon.value= ls_denmon;
