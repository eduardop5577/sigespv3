...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_cabecera($as_cedper,$as_nomper,$as_desuniadm,$as_codcueban,$as_tipcuebanper,$as_desded,$as_destipper,
							  $as_codclavia,$ad_fecsalvia,$ad_fecregvia,$ai_numdiavia,$ls_obssolvia,$ai_acompanante,$as_cargo,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//	    		   $ls_obssolvia  // Denominación de las misiones
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('mision'=>'<b>12. Concepto de la Misión:</b> '.$ls_obssolvia));
	...
	function uf_print_detalle_asignaciones($la_data,$ai_total,$as_totalletras,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>60),
									   ...
									   'dias'=>array('justification'=>'right','width'=>60),
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$la_data=array(array('elaborado'=>'<b>21. Elaborado Por:</b>','revisado'=>'<b>22. Revisado Por:</b>','autorizado'=>'<b>23. Autorizado Por:</b>'),
					   ...
					   array('elaborado'=>'','revisado'=>'','autorizado'=>''),
					   array('elaborado'=>'','revisado'=>'','autorizado'=>''),
					   array('elaborado'=>$_SESSION["la_apeusu"].", ".$_SESSION["la_nomusu"],'revisado'=>'','autorizado'=>''),
					   array('elaborado'=>'','revisado'=>'','autorizado'=>''),
					   array('elaborado'=>'Nombre y Apellido / Firma','revisado'=>'Firma / Sello','autorizado'=>'Firma / Sello'),
					   array('elaborado'=>'ANALISTA','revisado'=>'COORDINADOR DE NOMINA','autorizado'=>'PRESIDENCIA'));
			...
			else // Imprimimos el reporte
			{
				...
				while($row=$io_report->io_sql->fetch_row($rs_data))
				{
					...
					uf_print_cabecera($ls_cedper,$ls_nomper,$ls_desuniadm,$ls_codcueban,$ls_tipcuebanper,$ls_desded,$ls_destipper,
									  $ls_codclavia,$ld_fecsalvia,$ld_fecregvia,$li_numdiavia,$ls_obssolvia,$li_acompanante,$ls_cargo,&$io_pdf); // Imprimimos la cabecera del registro
