...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_codsolvia,$io_encabezado,$as_tipoviatico,$io_pdf)
	{
		...
		if($as_tipoviatico!="")
		{
			$io_pdf->addText(180,740,11,"<b>SOLICITUD Y APROBACION DE VIATICOS </b>"); // Agregar NRO DE CONTROL
	//		$io_pdf->addText(240,725,11,"<b>DE ".$as_tipoviatico." </b>"); // Agregar NRO DE CONTROL
			$li_tm=$io_pdf->getTextWidth(10,"<b>DE ".$as_tipoviatico." </b>");
			$tm=296-($li_tm/2);
			$io_pdf->addText($tm,725,10,"<b>DE ".$as_tipoviatico." </b>"); // Agregar el título
			//$io_pdf->addText(230,710,10,"<b>Tipo de Viatico: </b>".$as_tipoviatico); // Agregar NRO DE CONTROL
		}
		else
		{
...
/*		$la_data=array(array('titulo'=>'<b>FIRMAS</b>'));
		...
		unset($la_columna);
		unset($la_config); 
*/		$la_data=array(array('1'=>'<b>PRESIDENTE</b>','2'=>'<b>DIRECCION GENERAL</b>','3'=>'<b>RRHH</b>','4'=>'<b>PRESUPUESTO</b>'),
					   array('1'=>'','2'=>'','3'=>'','4'=>''),
					   array('1'=>'','2'=>'','3'=>'','4'=>''),
					   array('1'=>'','2'=>'','3'=>'','4'=>''),
					   array('1'=>'','2'=>'','3'=>'','4'=>''),
					   array('1'=>'','2'=>'','3'=>'','4'=>''),
					   array('1'=>'FIRMA / SELLO','2'=>'FIRMA / SELLO','3'=>'FIRMA / SELLO','4'=>'FIRMA / SELLO'));
		$la_columna=array('1'=>'',
   						  '2'=>'',
						  '3'=>'',
						  '4'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>540, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('1'=>array('justification'=>'center','width'=>135), // Justificación y ancho de la columna
						 			   '2'=>array('justification'=>'center','width'=>135), // Justificación y ancho de la columna
						 			   '3'=>array('justification'=>'center','width'=>135), // Justificación y ancho de la columna
						 			   '4'=>array('justification'=>'center','width'=>135))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('elaborado'=>'ELABORADO POR','revisado'=>'AUDITORIA INTERNA','autorizado'=>'FIRMA Y FECHA'));
