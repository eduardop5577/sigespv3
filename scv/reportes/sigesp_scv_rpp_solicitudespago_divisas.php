...
//--------------------------------------------------------------------------------------------------------------------------------
							  ...
							  $as_codclavia,$ad_fecsalvia,$ad_fecregvia,$ai_numdiavia,$as_denmis,$ai_acompanante,$as_cargo,$ld_fecsolvia,$ls_tipovia,$io_pdf)
	{
		...
		$la_data=array(array('codigo'=>'<b>Código</b>','descripcion'=>'<b>Descripción</b>','tarifa'=>'<b>Tarifa</b>',
							 'dias'=>'<b>Días</b>','subtotal'=>'<b>Subtotal</b>','subtotal'=>'<b>Subtotal</b>','subtotal'=>'<b>Subtotal</b>','tascam'=>'<b>Tasa Cambio</b>','denmon'=>'<b>Moneda</b>','subtotdiv'=>'<b>Subtotal Moneda</b>'));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>40),
									   ...
									   'subtotdiv'=>array('justification'=>'right','width'=>80))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		unset($la_data);
		unset($la_columna);
		unset($la_config);
	...
	function uf_print_detalle_asignaciones($la_data,$ai_total,$as_totalletras,$ls_denmon,$li_totaldiv,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>280),
									   ...
									   'total2'=>array('justification'=>'right','width'=>80))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
