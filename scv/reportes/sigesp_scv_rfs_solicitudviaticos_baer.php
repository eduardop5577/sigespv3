...
/*		unset($la_data);
	...
	function uf_print_firmas($io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('elaborado'=>'<b>24. Elaborado Por:</b>','revisado'=>'<b>25. Gerente de la Unidad:</b>','autorizado'=>'<b>26. Presidente / Gerente General:</b>'),
	...
	$lb_tipben="P";
	//--------------------------------------------------------------------------------------------------------------------------------
	$arrResultado=$io_report->uf_select_solicitudpago_personal_baer($ls_codemp,$ls_codsoldes,$ls_codsolhas,$ld_desde,$ld_hasta,$li_orden,$ls_codsolvia,$rs_data); // Cargar el DS con los datos de la cabecera del reporte
	...
	else // Imprimimos el reporte
	{
		...
		while($row=$io_report->io_sql->fetch_row($rs_data))
		{
			...
			uf_print_cabecera($ls_cedper,$ls_nomper,$ls_denuniadm,$ls_codcueban,$ls_tipcuebanper,$ls_desded,$ls_destipper,
