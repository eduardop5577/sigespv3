...
***********************************************************************************/
							  ...
							  $as_telefono,$ai_sueper,$as_denestpro1,$as_denestpro2,$as_desrut,$ai_solviaext,$as_obssolvia,$io_pdf)
	{
		...
		$la_data=array(array('dependencia'=>'<b>8. Unidad Solicitante:</b> '.$as_desuniadm));
...
/*		unset($la_data);
	...
	function uf_print_firmas($io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('elaborado'=>'<b>24. Autorizado Por:</b>','revisado'=>'<b>25. Coordinación de Planificación, Presupuesto, Organización y Sistemas :</b>','autorizado'=>'<b>26. Oficina de Gestión Administrativa:</b>'),
