...
class sigesp_scv_c_calcularviaticos
{
	...
	function uf_scv_update_misiones($as_codemp,$as_codsolvia,$as_codmis,$ai_tarifa,$ai_aprobado)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->solicitudviaticos MÉTODO->uf_scv_update_misiones ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
			$this->io_sql->rollback();
		}
		else
	...
	function uf_scv_load_dt_personal_int($as_codemp,$as_codsolvia,$ai_totrows,$ao_objectpersonal)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->solicitud_viaticos MÉTODO->uf_scv_load_dt_personal_int ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_scv_select_tarifaextranjero($as_codemp,$as_codpai)
	{
		...
		{print $this->io_sql->message;
			$this->io_msg->message("CLASE->solicitud_viaticos MÉTODO->uf_scv_select_tarifaextranjero ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
...
/*		for($ai_totrows=1;$ai_totrows<3;$ai_totrows++)
	...
	function uf_scv_select_tarifacargo($as_codemp,$as_codcar,$as_codnom,$as_tipvia='-')
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->solicitud_viaticos MÉTODO->uf_scv_select_tarifacargo ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_scv_select_tasacambio_internacional($as_codemp,$as_codcar,$as_codnom,$as_tipvia='-')
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->solicitud_viaticos MÉTODO->uf_scv_select_tasacambio_internacional ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
...
/*	function uf_scv_select_incrementoorden($as_codemp,$as_codsolvia,$as_codregdes)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->solicitud_viaticos MÉTODO->uf_scv_select_incrementoorden ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
...
*/	
	...
	function uf_scv_select_destino($as_codemp,$as_codsolvia)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->solicitud_viaticos MÉTODO->uf_scv_select_destino ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_scv_select_cargafamiliar($as_codemp,$as_codsolvia)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->solicitud_viaticos MÉTODO->uf_scv_select_cargafamiliar ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_scv_select_cargo($as_codemp,$as_codcar,$as_codnom)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->solicitud_viaticos MÉTODO->uf_scv_select_cargo ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
...
*/
	function uf_load_misiones_internacionales($as_codemp,$as_codsolvia,$as_cargo,$as_codnom,$aa_object,$li_i)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->solicitud_viaticos MÉTODO->uf_load_misiones_internacionales ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_scv_tarifas_internacionales($as_codemp,$as_codmis,$as_cargo,$as_codnom)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->solicitud_viaticos MÉTODO->uf_scv_tarifas_internacionales ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_scv_select_tarifacargos($as_codemp,$as_codcar,$as_codnom)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Integración MÉTODO->uf_scv_select_tarifacargos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
