...
require_once ($dirctrscg."/modelo/servicio/scg/sigesp_srv_scg_movimientos_mes.php");
...
if (($_POST['ObjSon']) && ($sessionvalida))
{
    ...
    switch ($objetoJson->operacion)
	{
		...
		case "verificar_estatus_estcencos":
    		$servicioListadoC = new servicioMovimientosMes();
		...
		case "comboanio":
    		$ServResul = new servicioMovimientosMes();
