...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_recepcion.php",$ls_permisos,$la_seguridad,$la_permisos);
$ls_permisos = $arrResultado['as_permisos'];
$la_seguridad = $arrResultado['aa_seguridad'];
$la_permisos = $arrResultado['aa_permisos'];
$ls_reporte=$io_fun_activo->uf_select_config("SIV","REPORTE","RECEPCION","sigesp_siv_rpp_recepcion.php","C");
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td width="20" height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:uf_mostrar_reporte('<?php print $ls_reporte ?>');"><img src="../shared/imagebank/tools20/imprimir.gif" alt="Imprimir" width="20" height="20" border="0"></a></td>
...
function uf_mostrar_reporte(reporte)
{
	...
	if(valido)
	{
		...
		if(li_imprimir)
		{
			...
			if ((ld_desde!="")&&(ld_hasta!=""))
			{
				...
				window.open("reportes/"+reporte+"?ordenfec="+li_ordenfec+"&desde="+ld_desde+"&hasta="+ld_hasta+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
