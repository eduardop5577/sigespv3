...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_cierre.php",$ls_permisos,$la_seguridad,$la_permisos);
		...
		if(valido)
		{
			...
			if(li_imprimir)
			{
				...
				if ((ld_desde!="")&&(ld_hasta!=""))
				{
					...
					window.open("reportes/sigesp_siv_rpp_cierre.php?orden="+li_orden+"&desde="+ld_desde+"&hasta="+ld_hasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
