...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_articuloxsolicitar.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Listado de Art&iacute;culos a Solicitar</title>
...
?>	
  ...
  <table width="500" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="438" colspan="2" class="titulo-ventana">Listado  de Art&iacute;culos a Solicitar</td>
    </tr>
  </table>
...
<script >
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			{li_ordenart=1;}
			window.open("reportes/sigesp_siv_rpp_articulosxsolicitar.php?ordenart="+li_ordenart+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
