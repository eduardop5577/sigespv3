...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_despachos.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="442" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="438" colspan="2" class="titulo-ventana">Reporte de &Oacute;rdenes de Despacho </td>
    </tr>
  </table>
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				if ((ld_desde!="")&&(ld_hasta!=""))
				{
					...
					window.open("reportes/sigesp_siv_rpp_despachos.php?ordenfec="+li_ordenfec+"&desde="+ld_desde+"&hasta="+ld_hasta+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
