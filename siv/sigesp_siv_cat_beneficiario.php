...
<script >
	...
	{
		opener.document.formulario.txtcodrespri.value=as_ced_bene;
		opener.document.formulario.txtdenrespri.value=as_nombene;
		close();
	}
  
  function aceptar_resp_uso(as_ced_bene,as_nombene)
  {
    opener.document.formulario.txtcodresuso.value=as_ced_bene;
    opener.document.formulario.txtdenresuso.value=as_nombene;
	close();
  }
  ...
  function ue_search()
  {
	  ...
	  f.action="sigesp_siv_cat_beneficiario.php";
	  f.submit();
  }
</script>
</html>