...
class sigesp_siv_c_tipoarticulo
{
	...
	function  uf_siv_insert_tipoarticulo($as_codtipart,$as_dentipart,$as_obstipart,$as_clasif,$as_esttipmer,$as_codunimed,$as_spgcuenta,$as_sccuenta, $aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql = "INSERT INTO siv_tipoarticulo (codtipart, dentipart, obstipart, tipart,esttipmer,codunimed,spg_cuenta,sc_cuenta ) ".
					" VALUES('".$as_codtipart."','".$as_dentipart."','".$as_obstipart."','".$as_clasif."','".$as_esttipmer."','".$as_codunimed."','".$as_spgcuenta."','".$as_sccuenta."')" ;
	...
	function uf_siv_update_tipoarticulo($as_codtipart,$as_dentipart,$as_obstipart, $as_clasif,$as_esttipmer,$as_codunimed,$as_spgcuenta,$as_sccuenta, $aa_seguridad) 
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
