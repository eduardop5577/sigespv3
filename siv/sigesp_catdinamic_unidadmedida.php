	...
	if($ls_operacion=="BUSCAR")
	{
		...
		if($li_row>0)
		{
			while($row=$io_sql->fetch_row($rs_cta))
			{
				...
				if($ls_tipo=="tipoarticulo")
				{
					print "<td><a href=\"javascript: aceptar_tipo('$ls_codunimed','$ls_denunimed','$ls_unidad','$ls_obsunimed','$ls_status','$li_linea');\">".$ls_codunimed."</a></td>";
...
<script >
	...
	function aceptar_tipo(ls_codunimed,ls_denunimed,ls_unidad,ls_obsunimed,hidstatus,li_linea)
	{
