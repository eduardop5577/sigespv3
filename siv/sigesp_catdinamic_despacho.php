...
<?php
	...
	if($ls_operacion=="BUSCAR")
	{
		$ls_sql="SELECT siv_despacho.*, ".
				...
				"        WHERE sigesp_fuentefinanciamiento.codfuefin = siv_despacho.codfuefin) AS denfuefin".
				"  FROM	siv_despacho".
		...
		if($row=$io_sql->fetch_row($rs_cta))
		{
			...
			for($z=1;$z<=$totrow;$z++)
			{
				...
				print "                                  '$ls_codunides','$ls_denunides','$ls_obsdes','$ls_codfuefin', '$ls_denfuefin');\">".$ls_numorddes."</a></td>";
...
<script >
	function aceptar(ls_numorddes,ls_numsol,ls_coduniadm,ls_denuniadm,ld_fecdes,ls_codunides,ls_denunides,ls_obsdes,ls_codfuefin,ls_denfuefin)
	{ 
		f=document.form1;
