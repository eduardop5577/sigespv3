...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_articuloxalmacen.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="20" width="25" class="toolbar"><div align="center"><a href="javascript:uf_mostrar_reporte();"><img src="../shared/imagebank/tools20/imprimir.gif" title='Imprimir' alt="Imprimir" width="20" height="20" border="0"></a></div></td>
    ...
    <tr>
      <td colspan="5" align="center">      <div align="left">
        <table width="453" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td height="19"><div align="right">Segmento </div></td>
            <td height="22"><input name="txtcodseg" type="text" id="txtcodseg" size="6" maxlength="4" readonly>
              <a href="javascript: uf_catalogosegmento();"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar" width="15" height="15" border="0"></a>
              <input name="txtdesseg" type="text" class="sin-borde" id="txtdesseg" size="30" readonly>
            </td>
          </tr>
          <tr>
            <td height="19"><div align="right">Familia </div></td>
            <td height="22"><input name="txtcodfam" type="text" id="txtcodfam" size="6" maxlength="4" readonly>
              <a href="javascript: uf_catalogofamilia();"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar" width="15" height="15" border="0"></a>
              <input name="txtdesfam" type="text" class="sin-borde" id="txtdesfam" size="30" readonly>
            </td>
          </tr>
          <tr>
            <td height="19"><div align="right">Clase </div></td>
            <td height="22"><input name="txtcodcla" type="text" id="txtcodcla" size="6" maxlength="4" readonly>
              <a href="javascript: uf_catalogoclase();"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar" width="15" height="15" border="0"></a>
              <input name="txtdescla" type="text" class="sin-borde" id="txtdescla" size="30" readonly>
            </td>
          </tr>
          <tr>
            <td height="19"><div align="right">Producto </div></td>
            <td height="22"><input name="txtcodpro" type="text" id="txtcodpro" size="6" maxlength="4" readonly>
              <a href="javascript: uf_catalogoproducto();"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar" width="15" height="15" border="0"></a>
              <input name="txtdespro" type="text" class="sin-borde" id="txtdespro" size="30" readonly>
            </td>
          </tr>
        </table>
      </div></td>
...
<script >
	...
	function uf_mostrar_reporte()
	{
		...
		ls_codtipart=f.txtcodtipart.value;
                ls_codseg=f.txtcodseg.value;
                ls_codfam=f.txtcodfam.value;
                ls_codcla=f.txtcodcla.value;
                ls_codpro=f.txtcodpro.value;
		...
		window.open("reportes/sigesp_siv_rpp_existencias.php?codart="+ls_codart+"&codalm="+ls_codalm+"&ordenalm="+li_ordenalm+"&ordenart="+li_ordenart+"&codtipart="+ls_codtipart+"&existencia="+existencia+"&codseg="+ls_codseg+"&codfam="+ls_codfam+"&codcla="+ls_codcla+"&codpro="+ls_codpro,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
	...
	function ue_openexcel()
	{
		...
		window.open("reportes/sigesp_siv_rpp_existencias_excel.php?codart="+ls_codart+"&codalm="+ls_codalm+"&ordenalm="+li_ordenalm+"&ordenart="+li_ordenart+"&codtipart="+ls_codtipart+"&existencia="+existencia+"&codseg="+ls_codseg+"&codfam="+ls_codfam+"&codcla="+ls_codcla+"&codpro="+ls_codpro,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
...
function uf_catalogosegmento()
{
        window.open("sigesp_siv_cat_segmento.php?tipo=generico","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
}

function uf_catalogofamilia()
{
    f=document.form1;
    ls_codseg=f.txtcodseg.value;
    //if (ls_codseg!="")
    //{
        window.open("sigesp_siv_cat_familia.php?tipo=generico&codseg="+ls_codseg,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
    /*}
    else
    {
...
function uf_catalogoclase()
{
    ...
    //if (ls_codfam!="")
    //{
        window.open("sigesp_siv_cat_clase.php?tipo=generico&codseg="+ls_codseg+"&codfam="+ls_codfam,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
    /*}
    else
    {
...
function uf_catalogoproducto()
{
    ...
    //if (ls_codcla!="")
    //{
        window.open("sigesp_siv_cat_producto.php?destino=generico&codseg="+ls_codseg+"&codfam="+ls_codfam+"&codcla="+ls_codcla,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
    /*}
    else
    {
