...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_cierresep.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Reporte de Cierre de Solicitudes de Ejecuci&oacute;n Presupuestaria</title>
...
?>	
  ...
  <table width="474" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="438" colspan="2" class="titulo-ventana">Reporte de Cierre de Solicitudes de Ejecuci&oacute;n Presupuestaria</td>
    </tr>
  </table>
  <table width="474" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><div align="left">
        <table width="415" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td width="94" height="22"><div align="right">Unidad Ejecutora </div></td>
            <td width="319"><input name="txtcodunides" type="text" id="txtcodunides" value="<?php print $ls_codunides; ?>" size="15" maxlength="10" style="text-align:center" readonly>
              <a href="javascript: ue_cataunidad();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
              <input name="txtdenunides" type="text" class="sin-borde" id="txtdenunides" value="<?php print $ls_denunides; ?>" size="30" readonly></td>
          </tr>
        </table>
        ...
        <table width="415" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="173" height="22"><div align="right"></div>              
              <div align="right"><span class="style1">Nro. de SEP
          ...
          <tr>
            <td height="22"><div align="right"></div>              
              <div align="right"><span class="style1">Unidad Ejecutora </span>
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir)
			{
				...
				ls_coduniadm=  f.txtcodunides.value;
				if ((ld_desde!="")&&(ld_hasta!=""))
				{
					...
					window.open("reportes/sigesp_siv_rpp_cierresep.php?orden="+li_orden+"&desde="+ld_desde+"&hasta="+ld_hasta+"&coduniadm="+ls_coduniadm+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
					f.action="sigesp_siv_r_cierre.php";
				}
				else
				{
