...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_despachoarticulos.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Despachos de Art&iacute;culos</title>
...
<table width="470" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <div align="center" >Despachos  de Art&iacute;culos</div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" colspan="3" align="center"><table width="455" height="16" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td width="70" height="22"><div align="right"><strong>Unidad</strong></div></td>
          <td width="345" height="22"><input name="txtcodunides" type="text" id="txtcodunides" size="15" maxlength="10" style="text-align:center" readonly>
    ...
    <tr>
      <td height="24" colspan="3" align="center"><input name="chkresumido" type="checkbox" id="chkresumido" value="1">
        Resumido</td>
    </tr>
    <tr>
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				if ((ld_desde!="")&&(ld_hasta!=""))
				{
				    ...
				    denuniadm=f.txtdenunides.value;
					if(f.chkresumido.checked)
				    	resumido="1";
					else
				    	resumido="";
					window.open("reportes/sigesp_siv_rpp_despachoarticulos.php?desde="+ld_desde+"&hasta="+ld_hasta+"&resumido="+resumido+"&denuniadm="+denuniadm+"&coduniadm="+coduniadm,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				}
				else
				{
