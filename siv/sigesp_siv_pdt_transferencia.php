...
$la_permisos = $arrResultado['aa_permisos'];
	...
	switch($ls_operacion)
	{
		...
		case"BUSCAR":
			...
			$arrResultado=$io_siv->uf_select_articulo($ls_codart,$ls_codalm,$ls_denart,$li_unidad,$li_cosart,$li_existencia,$as_denunimed);
			$ls_denart = $arrResultado['as_denart'];
			$li_unidad = $arrResultado['ai_unidad'];
			$li_cosart = $arrResultado['ai_cosart'];
			$li_existencia = $arrResultado['ai_existencia'];
			$as_denunimed = $arrResultado['as_denunimed'];
