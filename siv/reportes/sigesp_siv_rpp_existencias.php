...
***********************************************************************************/
	...
	//$li_ordenart=1;
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=$io_report->uf_select_almacen($ls_codemp,$ls_codalm,$ls_codarti,$ls_codtipart,$li_ordenalm,$ls_codseg,$ls_codfam,$ls_codcla,$ls_codpro); // Cargar el DS con los datos de la cabecera del reporte
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					if ($li_valexistencia==1)
					{
						if ($li_existencia>0)
						{
							...
							$la_data[$li_j]=array('codigo'=>$ls_codart,'articulo'=>$ls_denart,'detal'=>$li_detal,'existencia'=>$li_existencia);
							$li_j++;
						}
					}
					else
