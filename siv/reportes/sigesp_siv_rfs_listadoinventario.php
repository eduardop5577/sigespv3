...
***********************************************************************************/
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$ls_codcla="";
			$ls_codpro="";
			$lb_valido=$io_report->uf_select_articuloxalmacen($ls_codemp,$ls_codalm,$ls_codart,$ls_codtipart,$li_ordenalm,$li_ordenart,$ls_codseg,$ls_codfam,$ls_codcla,$ls_codpro); // Obtenemos el detalle del reporte
			if($lb_valido)
			{
