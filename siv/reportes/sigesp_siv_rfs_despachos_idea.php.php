...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecha,$as_numorddes,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.'logo.jpg',20,550,450,40); // Agregar Logo
		...
		$io_pdf->addText(245,102,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(250,43,7,"JEFE DE COMPRAS"); // Agregar el título
		$io_pdf->addText(420,102,7,"MATERIALES RECIBIDOS"); // Agregar el título
		$io_pdf->addText(400,43,7,"FIRMA AUTOGRAFA, SELLO, FECHA"); // Agregar el título
		$io_pdf->addText(595,102,7,"RECIBIDO"); // Agregar el título
		$io_pdf->addText(580,43,7,"BIENES NACIONALES"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
