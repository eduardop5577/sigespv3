...
***********************************************************************************/
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_pdf;
		$la_columna=array('numsol'=>'<b>Numero de Solicitud </b>',
						  'denuniadm'=>'<b>Unidad Ejecutora</b>',
						  'fecregsol'=>'<b>Fecha de Registro</b>',
						  'feccieinv'=>'<b>Fecha de Cierre</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('numsol'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'denuniadm'=>array('justification'=>'left','width'=>400), // Justificación y ancho de la columna
						 			   'fecregsol'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'feccieinv'=>array('justification'=>'center','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	$ls_titulo="Cierre de Solicitudes de Ejecucion Presupuestaria";
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=$io_report->uf_select_cierresep($ls_codemp,$ld_desde,$ld_hasta,$li_orden,$ls_coduniadm); // Cargar el DS con los datos de la cabecera del reporte
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$ld_feccieinv= $io_report->ds->data["feccieinv"][$li_i];
			$ls_denuniadm=    $io_report->ds->data["denuniadm"][$li_i];
			$ld_fecregsol=$io_funciones->uf_convertirfecmostrar($ld_fecregsol);
			$ld_feccieinv=$io_funciones->uf_convertirfecmostrar($ld_feccieinv);
			$la_data[$li_i]=array('numsol'=>$ls_numsol,'denuniadm'=>$ls_denuniadm,'fecregsol'=>$ld_fecregsol,'feccieinv'=>$ld_feccieinv);
		}
		if($li_totrow>0)
		{
