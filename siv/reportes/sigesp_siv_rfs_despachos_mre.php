...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecha,$as_numorddes,$io_pdf)
	{
		...
		$io_pdf->line(170,40,170,110);
				
		$io_pdf->line(310,40,310,110);
		
		$io_pdf->line(450,40,450,110);
				
		$io_pdf->line(585,40,585,110);
				
		$io_pdf->addText(95,102,6,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(100,43,6,"ALMACÉN"); // Agregar el título
		$io_pdf->addText(220,102,6,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(210,43,6,"JEFE REVISOR ALMACÉN"); // Agregar el título
		
		$io_pdf->addText(360,102,6,"DESPACHO POR"); // Agregar el título
		$io_pdf->addText(370,43,6,"ALMACÉN"); // Agregar el título
		
		$io_pdf->addText(495,102,6,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(460,43,6,"COORD. DE COMPRAS Y SUMINISTROS"); // Agregar el título
		$io_pdf->addText(620,102,6,"MATERIALES RECIBIDOS POR"); // Agregar el título
		$io_pdf->addText(612,43,6,"FIRMA AUTOGRAFA, SELLO, FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			if ($ls_contable==1)
			{
				uf_print_cabecera($ls_numorddes,$ls_numsol,$ls_coduniadm,$ls_denunidam,$ls_obsdes,$ls_denfuefin,$io_pdf); // Imprimimos la cabecera del registro
			}
			else
			{
