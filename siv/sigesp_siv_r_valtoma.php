...
$la_seguridad = Array();
$la_permisos = Array();
$arrResultado = $io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_valtoma.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="500" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="438" colspan="2" class="titulo-ventana">Valoraci&oacute;n de Toma de Inventario </td>
    </tr>
  </table>
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				{
					window.open("reportes/sigesp_siv_rpp_valtoma.php?desde="+ld_desde+"&hasta="+ld_hasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
					f.action="sigesp_siv_r_valtoma.php";
				}
				else
				{
