...
***********************************************************************************/
	...
	if($ls_tipo !="-")
	{
		$ls_tipodestino = $io_fun_sep->uf_obtenervalor_get("cmbtipdes","-");
		$ls_codprovben = $io_fun_sep->uf_obtenervalor_get("txtcodigo","");
		$ls_nomprovben = $io_fun_sep->uf_obtenervalor_get("txtnombre","");
	}
	else
	{
...
function ue_aceptar(ls_numsol,ls_codtipsol,ls_coduniadm,ls_codfuefin,ls_estsol,ls_tipo_destino,ls_codigo,ls_denuniadm,
					...
					ls_nombenalt,ls_estayueco,as_tipsepbie,as_rif,contador,ls_consolanu,ls_numdocori, ls_forpag,ls_numsolini,ls_obssol)
{
	...
	opener.document.formulario.cmbforpag.value=ls_forpag;
	...
	opener.document.formulario.txtnumsolini.value=ls_numsolini;
	opener.document.formulario.txtobssol.value=ls_obssol;
	...
	parametros=parametros+"&subtotal="+li_monbasinm+"&cargos="+li_montotcar+"&total="+li_monto+"&tipsep="+ls_estope;
...
function ue_cambiardestino()
{
	f=document.formulario;
        ...
        if(tipo=='SEPINICIAL')
        {
            alert('No puede cambiar el Proveedor o Beneficiario');
            f.cmbtipdes.value=opener.document.formulario.cmbtipdes.value;
        }
        else
        {
...
function ue_search()
{
	...
	cmbcodtipsol="";
	if((tipo=="COPIARSEP")||(tipo=="SEPINICIAL"))
	{
		cmbcodtipsol  = opener.document.formulario.cmbcodtipsol.value;
	}
	if((fecregdes!="")&&(fecreghas!=""))
	{
		...
		ajax.send("catalogo=SOLICITUD&numsol="+numsol+"&coduniadm="+coduniadm+"&codtipsol="+codtipsol+"&fecregdes="+fecregdes+
				  ...
				  "&tipdes="+tipdes+"&consol="+consol+"&denart="+denart+"&cmbcodtipsol="+cmbcodtipsol);
	}
	else
	{
...
function ue_aceptar_copiar(ls_numsol,ls_codtipsol,ls_coduniadm,ls_codfuefin,ls_estsol,ls_tipo_destino,ls_codigo,ls_denuniadm,
							ls_denfuefin,ls_nombre,ls_estapro,ld_fecregsol,li_monto,li_monbasinm,li_montotcar,ls_estatus,ls_estope,
							ls_modsep,ls_codestpro1,ls_codestpro2,ls_codestpro3,ls_codestpro4,ls_codestpro5,ls_estcla,as_consol,
							ls_nombenalt,ls_estayueco,as_tipsepbie,as_rif,contador,ls_consolanu,ls_numdocori)
{
	f=document.formulario;
	opener.document.formulario.existe.value="FALSE";
	...
	ls_estclauni  = opener.document.formulario.txtestcla.value; 
	ls_codestpre  = ls_codestpro1+ls_codestpro2+ls_codestpro3+ls_codestpro4+ls_codestpro5;
	parametros="";
	parametros=parametros+"&numsol="+ls_numsol+"&codestpre="+ls_codestpre+"&estclauni="+ls_estclauni;
	if(ls_modsep=="B") // Bienes
	{
...
function ue_aceptar_copiarinicial(ls_numsol,ls_codtipsol,ls_coduniadm,ls_codfuefin,ls_estsol,ls_tipo_destino,ls_codigo,ls_denuniadm,
							ls_denfuefin,ls_nombre,ls_estapro,ld_fecregsol,li_monto,li_monbasinm,li_montotcar,ls_estatus,ls_estope,
							ls_modsep,ls_codestpro1,ls_codestpro2,ls_codestpro3,ls_codestpro4,ls_codestpro5,ls_estcla,as_consol,
							ls_nombenalt,ls_estayueco,as_tipsepbie,as_rif,contador,ls_consolanu,ls_numdocori)
{
	f=document.formulario;
	opener.document.formulario.existe.value="FALSE";
	opener.document.formulario.txtnumsolini.value=ls_numsol;
	ls_coduniadm  = opener.document.formulario.txtcoduniadm.value;
	ls_codestpro1 = opener.document.formulario.txtcodestpro1.value;
	ls_codestpro2 = opener.document.formulario.txtcodestpro2.value;
	ls_codestpro3 = opener.document.formulario.txtcodestpro3.value;
