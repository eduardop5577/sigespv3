...
function ue_aceptar(as_codcon,as_dencon,ai_precio,as_spg_cuenta,ai_existecuenta)
{
	...
	parametros=parametros+"&codprounidad="+codestpro1+codestpro2+codestpro3+codestpro4+codestpro5+"&estcla="+ls_estcla+"&tipconpro="+ls_tipconpro+"&coduniadm="+ls_coduniadm+"&cargarcargos=0"; 
