...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addText(42,68,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(157,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(145,68,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(257,73,7,"OFICINA DE PLANIF. PRESUP."); // Agregar el título
		$io_pdf->addText(264,63,7,"Y CONTROL DE GESTION"); // Agregar el título
		$io_pdf->addText(440,122,7,"PROCESADO POR 	"); // Agregar el título
		$io_pdf->addText(400,68,7,"GERENCIA DE ADMINISTRACION Y FINANZAS"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_numsol,$as_dentipsol,$as_denuniadm,$as_denfuefin,$as_codigo,$as_nombre,$as_consol,$io_pdf)
	{
		...
		unset($la_columnas);
		unset($la_config);
		$as_consol1=substr($as_consol,0,1900);
		$as_consol2=substr($as_consol,1901,3800);
		$la_data[1]=array('titulo'=>'<b>Concepto</b>','contenido'=>$as_consol1);
		$la_data[2]=array('titulo'=>'','contenido'=>$as_consol2);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
