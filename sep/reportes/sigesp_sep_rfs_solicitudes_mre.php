...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol, $ls_estsol, $ls_estapro,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//	    		   ad_fecregsol // fecha de registro de la solicitud
                //	    		   
                //	    		   ls_estsol    // Estatus de la Solcitud
                //	    		   ls_estapro   // Estatus de la Aprobacion
                //	    		   
		...
		//$io_pdf->line(15,35,585,40);
		$io_pdf->line(480,700,480,740); // Linea Vertical
		$io_pdf->line(480,723,585,723); // Linea Horizontal  
        	$io_pdf->Rectangle(155,700,430,40);
		
                $io_pdf->addJpegFromFile('../../shared/imagebank/MPPRE.jpg',20,700,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm+20,715,11,$as_titulo); // Agregar el título
		...
		$io_pdf->addText(485,710,9,"Fecha ".$ad_fecregsol); // Agregar el título
                ...
                case "R":
                    $ls_estatus="Registro";					
                     break;
                case "E":
                    if ($ls_estapro==0) {  $ls_estatus="Emitida";  } else { $ls_estatus="Aprobada"; }					
                    break;
                case "C":
                ...
                $io_pdf->addText(485,690,9,"<b>Estatus: " . $ls_estatus .'</b>'); // Agregar el título
		...
		$io_pdf->addText(76,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(250,122,7,"APROBADO UNIDAD SOLICITANTE"); // Agregar el título
		$io_pdf->addText(265,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(460,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(470,63,7,"PRESUPUESTO"); // Agregar el título
                //$io_pdf->addText(475,122,7,"CONTRALORIA INTERNA"); // Agregar el título
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_numsol,$as_dentipsol, $as_coduniadm , $as_denuniadm,$as_denfuefin,$as_codigo,$as_nombre,$as_consol,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//	$la_data[1]=array('titulo'=>'<b> Unidad Ejecutora</b>','contenido'=>$as_denuniadm);
		$la_data[1]=array('titulo'=>'<b> Unidad Ejecutora</b>','contenido'=>'('.$as_coduniadm.') '.$as_denuniadm);
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				//$io_pdf = uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecregsol,$io_pdf);
				$io_pdf = uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecregsol,$ls_estsol, $ls_estapro,$io_pdf);
                                
				$io_pdf = uf_print_cabecera($ls_numsol,$ls_dentipsol, $ls_coduniadm, $ls_denuniadm,$ls_denfuefin,$ls_codigo,$ls_nombre,$ls_consol,$io_pdf);
				...
				if($lb_valido)
				{
					...
					for($li_s=1;$li_s<=$li_totrowdet;$li_s++)
					{
						...
						/////////////////////////////////////////////////////////////////////////////////////////
						//
						// Descripción: Se comentan las siguientes lineas para que no muestre al mayor o al detal
						...
						/////////////////////////////////////////////////////////////////////////////////////
						//
						// Descripción: Se agregan las siguientes lineas para que muestre la unidad de medida. DESDE - HASTA
 						// Modificado por: Ing. Norma Parada
						//
						/////////////////////////////////////////////////////////////////////////////////////
