...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->line(480,690,480,740);
		$io_pdf->line(485,715,600,715);
        $io_pdf->Rectangle(15,690,585,50);
               $io_pdf->addJpegFromFile('../../shared/imagebank/logo_sep.jpg',30,745,400,40);		
               $io_pdf->addJpegFromFile('../../shared/imagebank/logo.jpg',20,10,490,30);
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText(120,720,11,$as_titulo); // Agregar el título
		$io_pdf->addText(485,730,9,"No. ".$as_numsol); // Agregar el título
		$io_pdf->addText(485,700,9,"Fecha ".$ad_fecregsol); // Agregar el título
		$io_pdf->addText(540,770,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(546,764,6,date("h:i a")); // Agregar la Hora
		// cuadro inferior
          $io_pdf->Rectangle(15,80,570,70);
          $io_pdf->line(290,90,290,100);	
          //$io_pdf->Rectangle(15,70,570,70);
          $io_pdf->Rectangle(15,57,570,57);
		$io_pdf->line(15,140,585,140);		
		$io_pdf->line(15,130,585,130);	//LINEAS PARA SEPARAR LAS FIRMAS
		$io_pdf->line(100,55,100,130);
                $io_pdf->line(180,55,180,130);	
                $io_pdf->line(300,55,300,130);	
                $io_pdf->line(400,55,400,130);
		$io_pdf->line(500,55,500,130);
                $io_pdf->addText(60,143,7,"UNIDAD SOLICITANTE"); // Agregar el título		
                $io_pdf->addText(420,143,7,"CERTIFICACION"); // Agregar el título	
        $io_pdf->addText(40,133,7,"OFICINA DE ADMINISTRACION Y SERVICIO"); // Agregar el título		
     $io_pdf->addText(390,133,7,"OFICINA DE PLANIFICACION Y PRESUPUESTO"); // Agregar el título		
		$io_pdf->addText(20,122,6,"ANALISTA DE COMPRAS"); // Agregar el título
		$io_pdf->addText(103,122,6,"COORD. DE COMPRAS"); // Agregar el título
		//$io_pdf->addText(108,63,6,"Lic. Yuleidy De Barriteau"); // Agregar el título
		$io_pdf->addText(200,122,6,"GTE. OFIC. ADMINISTRACION"); // Agregar el título
                $io_pdf->addText(220,114,6,"Y SERVICIOS"); // Agregar el título
               // $io_pdf->addText(210,63,6,"Lic. Giulia Vizzarri"); // Agregar el título
                $io_pdf->addText(310,122,6,"ANALISTA DE PRESUPUESTO"); // Agregar el título
                $io_pdf->addText(402,122,6,"COORD. DE PRESUPUESTO"); // Agregar el título
               // $io_pdf->addText(410,63,6,"T.S.U Rosemarie Chacón"); // Agregar el título
                $io_pdf->addText(502,122,6,"GTE. OFIC. PLANIFICACION"); // Agregar el título
                $io_pdf->addText(515,114,6,"Y PRESUPUESTO"); // Agregar el título
               // $io_pdf->addText(510,63,6,"Lic. Audrey Berroterán"); // Agregar el título
                
 
		$io_pdf->addText(300,63,6,""); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_numsol,$as_dentipsol,$as_denuniadm,$as_denfuefin,$as_codigo,$as_nombre,$as_consol,$io_pdf)
	{
		...
		$la_data[1]=array('titulo'=>'<b>Concepto y Jutificacion</b>','contenido'=>$as_consol,);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
