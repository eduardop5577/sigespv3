...
***********************************************************************************/
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('numsol'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'consol'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'denuniadm'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
						 			   'codestpro'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
						 			   ...
						 			   'spgcuenta'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'monto'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'codusu'=>array('justification'=>'left','width'=>50))); // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($ai_total,$ai_totrows,$io_pdf)
	{
		...
		// Fecha Creación: 13/03/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data=array(array('name'=>'<b>Total </b>','total'=>$ai_total,'codusu'=>''));
		$la_columna=array('name'=>'','total'=>'','codusu'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('name'=>array('justification'=>'right','width'=>830), // Justificación y ancho de la columna
						 			   'total'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'codusu'=>array('justification'=>'right','width'=>50))); // Justificación y ancho de la columna
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezStartPageNumbers(950,30,10,'','',1); // Insertar el número de página
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				if($ls_tipoformato=="SELECTIVO")
				{
					...
					for($li_j=1;$li_j<=$li_totrowdet;$li_j++)
					{
						...
						$la_data[$li_k]=array('numsol'=>$ls_numsol,'consol'=>$ls_consol,'denuniadm'=>$ls_denuniadm,'codestpro'=>$ls_programatica,'nombre'=>$ls_nombre,'fecregsol'=>$ld_fecregsol,'estsol'=>$ls_estsol,'spgcuenta'=>$ls_spgcuenta,'monto'=>$li_monto,'codusu'=>$ls_codusu);
						if($ls_numsol!=$ls_numsolaux)
						{
							$li_k++;
							$li_montosol=number_format($li_montosol,2,",",".");
							$la_data[$li_k]=array('numsol'=>"",'consol'=>"",'denuniadm'=>"",'codestpro'=>"",'nombre'=>"",'fecregsol'=>"",'estsol'=>"",'spgcuenta'=>"Total ",'monto'=>$li_montosol,'codusu'=>$ls_codusu);
							$li_montosol=0;
						}
					}
				...
				else
				{
					...
					$la_data[$li_s]=array('numsol'=>$ls_numsol,'consol'=>$ls_consol,'denuniadm'=>$ls_denuniadm,'codestpro'=>$ls_programatica,'nombre'=>$ls_nombre,'fecregsol'=>$ld_fecregsol,'estsol'=>$ls_estsol,'spgcuenta'=>$ls_spgcuenta,'monto'=>$li_monto,'codusu'=>$ls_codusu);
				//	print "ORIGINAL->".$ls_numsol." SIGUIENTE->".$ls_numsolaux."<br />";
					if($ls_numsol!=$ls_numsolaux)
					{
						$li_s++;
						$li_montosol=number_format($li_montosol,2,",",".");
						$la_data[$li_s]=array('numsol'=>"",'consol'=>"",'denuniadm'=>"",'codestpro'=>"",'nombre'=>"",'fecregsol'=>"",'estsol'=>"",'spgcuenta'=>"Total ",'monto'=>$li_montosol,'codusu'=>$ls_codusu);
						$li_montosol=0;
					}
				}
			}
