...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/banner_cicpc.jpg',25,715,450,40); // Agregar Logo
		if ($as_estsol=="A")
		{
...
//		$io_pdf->addText(546,764,6,date("h:i a")); // Agregar la Hora
		...
		$io_pdf->addText(160,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(277,63,7,"ADMINISTRACIÓN"); // Agregar el título
		$io_pdf->addText(440,122,7,"CONTABILIZADO POR"); // Agregar el título
		$io_pdf->addText(455,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezado_pagina_req
		//		   Access: private 
		//	    Arguments: as_titulo // Título del Reporte
		//	    		   as_numsol // numero de la solicitud
		//	    		   ad_fecregsol // fecha de registro de la solicitud
...
//		$io_pdf->addText(546,764,6,date("h:i a")); // Agregar la Hora
		...
		$io_pdf->line(380,60,380,130);		
		$io_pdf->addText(40,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(42,66,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(157,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(160,66,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(257,75,7,"___ ADMINISTRACIÓN"); // Agregar el título
		$io_pdf->addText(257,65,7,"___ SUMINISTROS"); // Agregar el título
		$io_pdf->addText(455,122,7,"RECIBIDO POR"); // Agregar el título
		$io_pdf->addText(455,66,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
		return $io_pdf;
	}// end function uf_print_encabezado_pagina_req
	//-----------------------------------------------------------------------------------------------------------------------------------
