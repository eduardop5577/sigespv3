...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addText(18,95,8,$_SESSION["la_apeusu"].", ".$_SESSION["la_nomusu"]);
		$io_pdf->addText(45,63,7,"ANALISTA SEP (FIRMA/SELLO)"); // Agregar el título
		$io_pdf->line(180,60,180,130);
		$io_pdf->addText(250,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(240,63,7,"PRESUPUESTO ANALISTA"); // Agregar el título
		$io_pdf->line(380,60,380,130);		
		$io_pdf->addText(450,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(430,63,7,"GERENTE DE PRESUPUESTO"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	}// end function uf_print_encabezado_pagina
