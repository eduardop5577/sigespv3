...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addText(52,122,7,"ANALISTA"); // Agregar el título
		$io_pdf->addText(42,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(160,122,7,"PRESUPUESTO"); // Agregar el título
		...
		$io_pdf->addText(460,122,7,"PRESIDENCIA"); // Agregar el título
