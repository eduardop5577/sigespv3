...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_nomusu,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->line(480,655,480,715);//Y->60
		...
		$io_pdf->addText(160,63,7,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->addText(275,122,7,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(280,63,7,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->addText(445,122,7,"APROBADO POR:"); // Agregar el título
		$io_pdf->addText(445,63,7,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$io_pdf = uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecregsol,$ls_nomusu,$ls_estsol,$io_pdf);
