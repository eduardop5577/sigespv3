...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->line(200,60,200,140);		
		$io_pdf->line(390,60,390,140);		
		$io_pdf->addText(67,125,7,"UNIDAD SOLICITANTE"); // Agregar el título
		$io_pdf->addText(80,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(250,125,7,"COMPRAS Y SUMINISTROS"); // Agregar el título
		$io_pdf->addText(270,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(458,129,7,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(465,121,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(462,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
