...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_nomusu,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addText(55,158,6,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(25,138,7,$as_nomusu."."); // Agregar el título
		$io_pdf->addText(190,158,6,"REVISADO POR:"); // Agregar el título
