...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina_req($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$li_tm=$io_pdf->getTextWidth(10,"INSTITUTO AUTONOMO DE RECOLECCION ORNATO Y MANTENIMIENTO");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,750,10,"INSTITUTO AUTONOMO DE RECOLECCION ORNATO Y MANTENIMIENTO"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(10,"DEL MUNICIPIO GIRARDOT");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,740,10,"DEL MUNICIPIO GIRARDOT"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(10,"REQUISICION INTERNA DE MATERIALES Y SUMINISTROS");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,720,10,"REQUISICION INTERNA DE MATERIALES Y SUMINISTROS"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(10,"EN ALMACEN");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,710,10,"EN ALMACEN"); // Agregar el título
		...
		$io_pdf->addText(135,63,7,"GERENTE O JEFE DE LA UNIDAD SOLICITANTE"); // Agregar el título
		$io_pdf->addText(317,63,7,"GERENTE DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(505,63,7,"ALMACEN"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addText(52,63,7,"COMPRAS"); // Agregar el título
		$io_pdf->addText(157,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(150,63,7,"JEFE DE COMPRAS"); // Agregar el título
		$io_pdf->addText(275,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(277,63,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(450,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(430,63,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
		return $io_pdf;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_req($la_data,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detalle
		//		   Access: private 
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   ...
						 			   'cantidad'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_estope=$io_report->DS->data["estope"][$li_i];
				...
				if($ls_estope=="S")
				{
					$io_pdf = uf_print_encabezado_pagina_req($ls_titulo,$ls_numsol,$ld_fecregsol,$ls_estsol,$io_pdf);
				}
				else
				{
...
*/						$li_monart=number_format($li_monart,2,".","");
						...
						if($ls_estope=="S")
						{
							$io_pdf = uf_print_detalle_req($la_data,$io_pdf);
						}
						else
						{
