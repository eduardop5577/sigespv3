...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addText(495,680,9,"No. ".$as_numsol); // Agregar el título
		$io_pdf->addText(495,660,9,"Fecha ".$ad_fecregsol); // Agregar el título
		// cuadro inferior
 		$io_pdf->setStrokeColor(0,0,0);
       	$io_pdf->Rectangle(15,50,570,70);
		$io_pdf->line(15,63,585,63);		
		$io_pdf->line(15,107,585,107);		
		$io_pdf->line(130,50,130,120);		
		$io_pdf->line(240,50,240,120);		
		$io_pdf->line(380,50,380,120);		
		$io_pdf->addText(40,112,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(42,53,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(157,112,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(145,53,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(275,112,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(257,53,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(440,112,7,"CONTABILIZADO"); // Agregar el título
		$io_pdf->addText(445,53,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(6,4,3,3); // Configuración de los margenes en centímetros
			$io_pdf->ezStartPageNumbers(580,10,8,'','',1); // Insertar el número de página
