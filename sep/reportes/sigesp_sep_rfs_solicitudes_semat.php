...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addText(72,120,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(60,63,7,"FIRMA / SELLO / FIRMA"); // Agregar el título
		$io_pdf->addText(225,120,7,"UNIDAD DE PRESUPUESTO Y FINANZAS"); // Agregar el título
		$io_pdf->addText(250,63,7,"FIRMA / SELLO / FIRMA"); // Agregar el título
		$io_pdf->addText(415,120,7,"GERENCIA DE ADMINISTRACION Y FINANZAS"); // Agregar el título
		$io_pdf->addText(452,63,7,"FIRMA / SELLO / FIRMA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
