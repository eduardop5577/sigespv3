...
***********************************************************************************/
	...
	if($lb_valido)
	{
						...
						if($lb_valido)
						{
							...
							for($li_s=1;$li_s<=$li_totrowcuentas;$li_s++)
							{
								...
								$arrResultado = $io_report->uf_select_disponible($ls_spgcuenta,$ls_codestpro1,$ls_codestpro2,
	                                                                          $ls_codestpro3,$ls_codestpro4,$ls_codestpro5,"A",
																			  $ld_disponible);
								...
								$ld_monantcta = 0;//$io_report->uf_select_saldo_anterior($ls_spgcuenta,$ls_codestpro1,$ls_codestpro2,
	                                            //                                     $ls_codestpro3,$ls_codestpro4,$ls_codestpro5,
												//							         $ld_fecdesant,$ld_fechasant);	
																					 
								$ld_monactcta = 0;//$io_report->uf_select_saldo_actual($ls_spgcuenta,$ls_codestpro1,$ls_codestpro2,
	                                              //                                 $ls_codestpro3,$ls_codestpro4,$ls_codestpro5,
		...
		$io_pdf = uf_print_disponibilidad($la_data2,$io_pdf); // Imprimimos el detalle 
		$io_pdf = uf_print_saldos($la_data3,$io_pdf); // Imprimimos el detalle 
