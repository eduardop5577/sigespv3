...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addText(375,680,16,"No. ".$as_numsol); // Agregar el título
		$io_pdf->addText(485,695,10,"Fecha ".$ad_fecregsol); // Agregar el título
		...
		$io_pdf->addText(60,120,8,"UNIDAD SOLICITANTE"); // Agregar el título
		$io_pdf->addText(65,62,8,"JEFE DE LA UNIDAD"); // Agregar el título
		$io_pdf->addText(260,120,8,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(212,62,8,"ALCALDE / JEFE DE DIVISION DE COMPRAS"); // Agregar el título
		$io_pdf->addText(455,120,8,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(440,62,8,"DIVISION PRESUPUESTO"); // Agregar el título
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_numsol,$as_dentipsol,$as_denuniadm,$as_denfuefin,$as_codigo,$as_nombre,$as_consol,$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $io_pdf->Rectangle(15,545,570,100);
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>110), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'center','width'=>135), // Justificación y ancho de la columna
						 			   ...
						 			   'cosuni'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'baseimp'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'cargo'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
