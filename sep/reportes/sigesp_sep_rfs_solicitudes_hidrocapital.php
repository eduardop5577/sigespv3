...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],25,700,120,60); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/banner_hidrocapital.jpg',15,2,572,30); // Agregar Logo
		if ($as_estsol=="A")
		{
		...
		$io_pdf->addText(70,122,7,"UNIDAD ORIGEN"); // Agregar el título
		$io_pdf->addText(72,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(245,122,7,"GERENCIA"); // Agregar el título
		$io_pdf->addText(237,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(400,122,7,"GERENCIA GENERAL / PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(440,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($as_numsol,$as_dentipsol,$as_denuniadm,$as_denfuefin,$as_codigo,$as_nombre,$as_consol,$as_nomusu,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[1]=array('titulo'=>'<b>Registrado Por</b>','contenido'=>$as_nomusu);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$io_pdf = uf_print_cabecera($ls_numsol,$ls_dentipsol,$ls_denuniadm,$ls_denfuefin,$ls_codigo,$ls_nombre,$ls_consol,$ls_nomusu,$io_pdf);
