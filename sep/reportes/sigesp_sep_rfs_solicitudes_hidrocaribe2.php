...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->line(148,60,148,130);		
		$io_pdf->line(276,60,276,130);		
		$io_pdf->line(420,60,420,130);		
		$io_pdf->addText(55,122,7,"ELABORADO"); // Agregar el título
		$io_pdf->addText(30,63,7,"ANALISTA PRESUP. Y COSTOS"); // Agregar el título
		$io_pdf->addText(190,122,7,"REVISADO"); // Agregar el título
		$io_pdf->addText(160,70,7,"SUBTTE. PRESUP. Y COSTOS/"); // Agregar el título
		$io_pdf->addText(149,61,7,"JEFE CONTROL GESTION Y PRESUP."); // Agregar el título
		$io_pdf->addText(320,122,7,"CONFORMADO"); // Agregar el título
		$io_pdf->addText(305,70,7,"GERENTE CORPORATIVO"); // Agregar el título
		$io_pdf->addText(300,61,7,"PLANIFICACION Y CONTROL"); // Agregar el título
		$io_pdf->addText(480,122,7,"APROBADO"); // Agregar el título
		$io_pdf->addText(445,63,7,"PRESIDENCIA / JUNTA DIRECTIVA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina2($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezado_pagina
		//		   Access: private 
		...
		// cuadro inferior
		$io_pdf->setStrokeColor(0,0,0);
        $io_pdf->Rectangle(15,55,570,75);
		$io_pdf->line(15,117,585,117);
		$io_pdf->line(15,78,585,78);				
		
		$io_pdf->line(190,55,190,130);		
		$io_pdf->line(380,55,380,130);		
		$io_pdf->addText(50,122,7,"ELABORADO / CONFORMADO "); // Agregar el título
		$io_pdf->addText(50,70,7,"ANALISTA DE COMPRAS / "); // Agregar el título
		$io_pdf->addText(47,60,7,"GERENTE DE AREA PROCURA "); // Agregar el título
		$io_pdf->addText(232,122,7,"REVISADO Y CONFORMADO"); // Agregar el título
		$io_pdf->addText(228,70,7,"SUPTTE. PRESUP. Y COSTOS / "); // Agregar el título
		$io_pdf->addText(228,60,7,"ANALISTA PRESUP. Y COSTOS "); // Agregar el título
		$io_pdf->addText(465,122,7,"APROBADO"); // Agregar el título
		$io_pdf->addText(425,65,7,"PRESIDENTE / JUNTA DIRECTIVA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
		return $io_pdf;
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
	 $ls_titulo='<b>PUNTO DE CUENTA DE COMPROMISO</b>';
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				if($ls_nombre=="NINGUNO")
				{
					$io_pdf = uf_print_encabezado_pagina2("PUNTO DE CUENTA DE ".$ls_dentipsol,$ls_numsol,$ld_fecregsol,$ls_estsol,$io_pdf);
				}
				else
				{
