...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->line(5,40,585,40);
		$io_pdf->line(480,700,480,760);
		$io_pdf->line(480,730,585,730);


                 $io_pdf->Rectangle(15,500,570,60);
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.'logo.jpg',26,728,450,40); // Agregar Logo
		if ($as_estsol=="A")
		{
		...
		$io_pdf->addText(40,122,7,"UNIDAD SOLICITANTE"); // Agregar el título
		$io_pdf->addText(42,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(145,122,7,"AUTORIZADO POR ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(165,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(330,122,7,"DISPONIBILIDAD"); // Agregar el título
		$io_pdf->addText(330,63,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(495,122,7,"DIRECTOR DE AREA"); // Agregar el título
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
	 $ls_titulo='<b>REQUISICION DE BIENES O SERVICIOS EN '.$ls_moneda.'</b>';
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezStartPageNumbers(570,47,7,'','',1); // Insertar el número de página
