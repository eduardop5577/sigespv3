	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$io_pdf = uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecregsol,$ls_consol,$ls_estsol,$io_pdf);
				$io_pdf = uf_print_cabecera($ls_numsol,$ls_dentipsol,$ls_denuniadm,$ls_denfuefin,$ls_coduniadm,$ls_nombre,$ls_consol,$io_pdf);
		...
		$io_pdf = uf_print_detalle_firmas_autorizadas($la_datafir,$la_datanom,$la_datafim,$ls_consol,$io_pdf);					   										
