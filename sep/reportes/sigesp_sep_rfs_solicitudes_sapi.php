...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$as_nomusu,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(20,75,6,$as_nomusu); // Agregar el título
		$io_pdf->addText(60,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(200,122,7,"VERIFICADO POR"); // Agregar el título
		//$io_pdf->addText(205,110,6,"JEFE DE UNIDAD"); // Agregar el título
		$io_pdf->addText(187,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(335,122,7,"CERTIFICADO POR"); // Agregar el título
		//$io_pdf->addText(345,110,6,"PRESUPUESTO"); // Agregar el título
		//$io_pdf->addText(340,75,6,"DANIELA ARTEAGA"); // Agregar el título
		$io_pdf->addText(338,63,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(482,122,7,"APROBADO POR"); // Agregar el título
		//$io_pdf->addText(455,110,6,"COORDINACION DE ADMINISTRACION"); // Agregar el título
		//$io_pdf->addText(490,75,6,"NANCY PRIETO"); // Agregar el título
		$io_pdf->addText(450,63,7,"COORDINACION DE ADMINISTRACION"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecregsol,$ls_estsol,$ls_nomusu,$io_pdf);
