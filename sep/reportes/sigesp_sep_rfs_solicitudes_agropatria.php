...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addText(170,63,7,"GERENTE DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(340,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(291,63,7,"GERENTE DE PLANIFICACION Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(490,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(495,63,7,"PRESIDENTE"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
