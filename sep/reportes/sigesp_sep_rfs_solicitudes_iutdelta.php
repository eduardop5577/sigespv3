...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/encabezado_bolivariano_2015.jpg',10,710,460,43); // Agregar Logo
		...
		$io_pdf->addTextWrap(110,$y-48,350,7,$texto7,'centre');*/
		
		$ls_titulo="SOLICITUD DE EJECUCION PRESUPUESTARIA";

		$io_pdf->addTextWrap(110,695,300,13,$ls_titulo,'centre');
		$io_pdf->addText(485,725,9,"<b>No. </b>".$as_numsol); // Agregar el título
		$io_pdf->addText(485,705,9,"<b>Fecha </b>".$ad_fecregsol); // Agregar el título
...
/*
		...
		$io_pdf->addText($x1+5,$y-65,7,"FIRMA Y SELLO"); // Agregar el título


		$io_pdf->addText($x1+5+$t,$y+6,7,"VERIFICADO POR"); // Agregar el título		
		$io_pdf->addText($x1+5+$t,$y-9,7,"FECHA:___/___/_____"); // Agregar el título
		$io_pdf->addText($x1+5+$t,$y-65,7,"FIRMA Y SELLO"); // Agregar el título
		...
		$io_pdf->addText($x1+5+$t*3,$y+6,7,"UNIDAD SOLICITANTE"); // Agregar el título		
		$io_pdf->addText($x1+5+$t*3,$y-9,7,"FECHA:___/___/_____"); // Agregar el título
		$io_pdf->addText($x1+5+$t*3,$y-65,7,"FIRMA Y SELLO"); // Agregar el título
/*
