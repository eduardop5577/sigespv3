...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addText(190,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(340,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(333,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(485,122,7,"APROBADO POR"); // Agregar el título
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,$ls_monlet,$ls_obssol,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		unset($la_config);
		$io_pdf->ezSetDy(-5);
		$la_data[1]=array('titulo'=>'<b> Observaciones:</b> '.$ls_obssol);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
...
*/						$li_monart=number_format($li_monart,2,".","");
		...
		$io_pdf = uf_print_piecabecera($li_monbasimptot,$li_montotcar,$li_monto,$ls_monto,$ls_obssol,$io_pdf);
