...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estsol,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/fundapret.jpg',36,712,410,57); // Agregar Logo
		if ($as_estsol=="A")
		{
		...
		$io_pdf->addText(485,745,9,"No. ".$as_numsol); // Agregar el título
		$io_pdf->addText(485,710,9,"Fecha ".$ad_fecregsol); // Agregar el título
		$io_pdf->addText(540,777,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(546,771,6,date("h:i a")); // Agregar la Hora
		// cuadro inferior
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_codtipsol=$io_report->DS->data["codtipsol"][$li_i];
