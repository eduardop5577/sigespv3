...
if (array_key_exists("operacion",$_POST))
...
else
   {
	 ...
	 $ls_codestpro1 = "";
     $ls_orden      = "ASC";
	 $ls_campoorden = "spg_dt_unidadadministrativa.codestpro1,spg_dt_unidadadministrativa.codestpro2,spg_dt_unidadadministrativa.codestpro3,spg_dt_unidadadministrativa.codestpro4,spg_dt_unidadadministrativa.codestpro5";
   }
?>
