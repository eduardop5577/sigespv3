...
if($ls_operacion=="BUSCAR")
{
	...
	if($ls_logusr!='PSEGIS')
	{
		$ls_criterio="AND upper(codusu) <> 'SIGESP'";
	}
	...
	if($row=$io_sql->fetch_row($rs_cta))
	{
		...
		for($z=1;$z<=$totrow;$z++)
		{
			...
			print "<td><a href=\"javascript: aceptar('$ls_empresa','$ls_codigo','$ls_cedula','$ls_nombre','$ls_apellido',".
								...
								"                    '$ls_destino','$ld_ultingusu','$ls_corele');\">".$ls_codigo."</a></td>";
...
<input name="txtususis" type="hidden" id="txtususis" value="<?php print $ls_ususis;?>">
</form>
<p>&nbsp;</p>
<p>&nbsp;</p>
</body>
<script language="JavaScript">
	function aceptar(empresa,codigo,cedula,nombre,apellido,telefono,nota,status,codviejo,foto,destino,ultingusu,corele)
	{
		if(destino=="")
		{
			...
			opener.document.form1.txtcorele.value=corele;
		...
		if(destino=="Desde")
		{
			opener.document.form1.txtcodusudes.value=codigo;
		}
		if(destino=="Hasta")
		{
			opener.document.form1.txtcodusuhas.value=codigo;
		}
		close();
	}
