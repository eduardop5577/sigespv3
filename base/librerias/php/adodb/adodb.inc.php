...
if (!defined('_ADODB_LAYER')) {
	...
	define('ADODB_QUOTE_FIELDNAMES_DEFAULT', false);
...
class ADORecordSet implements IteratorAggregate {
	...
	function ADONewConnection($db='') {
		...
		define('ADODB_QUOTE_FIELDNAMES', ADODB_QUOTE_FIELDNAMES_DEFAULT);
		$ADODB_QUOTE_FIELDNAMES=ADODB_QUOTE_FIELDNAMES_DEFAULT;
		if (!defined('ADODB_QUOTE_FIELDNAMES')) {
			define('ADODB_QUOTE_FIELDNAMES', false);
		}		
		/*
