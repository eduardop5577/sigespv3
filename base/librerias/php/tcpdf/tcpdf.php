...
if (!class_exists('TCPDF', false)) {
	...
	*/
	class TCPDF {
		...
		*/
		public function AddPage($orientation='', $format='', $image2=false) {
		...
		*/
		 ...
		 */
		public function Header($image2=false) {
			...
			if (($headerdata['logo']) AND ($headerdata['logo'] != K_BLANK_IMAGE)) {
				...
				if($image2){
					$this->Image(K_PATH_IMAGES.'cmsp2.JPG', $this->GetX()+320, $this->getHeaderMargin(), $headerdata['logo_width'],$this->header_logo_height);
				}
		...
		/**
	 	 ...
	 	 * @since 4.0.012 (2008-07-24)
		 */
		protected function setHeader($image2=false) {
