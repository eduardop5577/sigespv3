...
com.sigesp.vista.comCatalogoCuentaSPG = function(options) {
...
//	this.opcionAceptar     = options.opcionaceptar;
	...
	this.buscarDataCatalogo = function() {
		...
		var valorCampo = '';
		var cuentaNoVacio = 0;
		var spg_cuenta  = Ext.getCmp('cuenta'+options.idComponente).getValue();
		...
		nuevosparamentros = nuevosparamentros +",'spg_cuenta':'"+spg_cuenta+"','denominacion':'"+denominacion+"','status':'"+status+"'";
	...
	this.vencatalogo = new Ext.Window({
		title: "<H1 align='center'>Cat�logo de Cuentas Presupuestarias de Gasto</H1>",
		autoScroll:true,
        width:670,
        height:520,
        modal: true,
