...
***********************************************************************************/
	...
	$arrResultado=$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_relacionsaldos.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="578" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="561" colspan="2" class="titulo-ventana">Reporte de Relaci&oacute;n de Saldos por Solicitud </td>
    </tr>
  </table>
...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_imprimir()
	{
		...
		if(li_imprimir==1)
		{
			...
			pantalla="reportes/sigesp_cxp_rpp_relacionsaldos.php?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fecemides="+fecemides+"&fecemihas="+fecemihas+"&tiporeporte="+tiporeporte+"";
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_cxp_rep_relacionsaldos.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}	
</script>
