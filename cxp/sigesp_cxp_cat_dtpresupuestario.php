	...
	for (li=1;li<=li_opener;li++)
	    {
		  ...
		  ls_codfuefin	  = eval("f.txtcodfuefinncnd"+li+".value");
		  if (ls_cuentaspg!="" && ls_codestpro!="" && ldec_monto!="0,00" && ls_estcargo!='C')
		     {
			   ...
			   ls_campos=ls_campos+"&txtcuentaspgncnd"+li_registros+"="+ls_cuentaspg+
								   ...
								   "&txtcodfuefinncnd"+li_registros+"="+ls_codfuefin;		
		     }
	    }
	//////////////////////////////////////////////////////////////////////////
		  ...
		  if (eval("document.formulario.chk"+j+".checked"))
		     {
			   ...
			   codfuefin = eval("document.formulario.txtcodfuefin"+j+".value");
					     ...
					     if (ldec_montoaux>0)
					        {
							  ...
							  ls_campos=ls_campos+"&txtcuentaspgncnd"+li_selected+"="+cuenta+"&txtcodestpro"+li_selected+"="+codestpro+"&txtestclancnd"+li_selected+"="+estcla+"&txtcodpro"+li_selected+"="+codpro+
									    "&txtdencuenta"+li_selected+"="+dencuenta+"&txtmonto"+li_selected+"="+monto+"&txtscgcuenta"+li_selected+"="+scg_cuenta+"&txtdenscgcuentadt"+li_selected+"="+den_scgcuenta+
										"&txtnumdoccom"+li_selected+"="+numdoccom+"&txtprocede"+li_selected+"="+procede+"&txtcodfuefinncnd"+li_selected+"="+codfuefin;					   
					        }						   
					     else
							{
