...
function aceptar(ls_codemp,ls_numncnd,ld_fecha,ls_numord,ls_numrecdoc,ls_codtipdoc,ls_dentipdoc,ls_tipo,ls_codpro,ls_cedbene,
                 ls_nomproben,li_estcon,li_estpre,ls_codope,ls_ctaprov,ls_dencuentaprov,ls_desope,ls_estnota,li_estapro,as_rifproben,ls_fecemi,ls_estlibcom)
{
	...
	if(ls_estlibcom=='1')
	{
		f.chkestlibcom.checked=true;
	}
	else
	{
		f.chkestlibcom.checked=false;
	}
