...
***********************************************************************************/
	...
	$arrResultado=$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_cxp_f1.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Cuentas Por Pagar Formato 2 </title>
...
?>	
  ...
  <table width="578" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="561" colspan="2" class="titulo-ventana">Cuentas Por Pagar Formato 2 </td>
    </tr>
  </table>
...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				{orden="2";}
				pantalla="reportes/sigesp_cxp_rpp_cxp_f2.php?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fecregdes="+fecregdes+"&fecreghas="+fecreghas+"&orden="+orden+"";
	...
	function ue_openexcel()
	{
			...
			if(li_imprimir==1)
			{
				...
				{orden="2";}
				pantalla="reportes/sigesp_cxp_rpp_cxp_f2_excel.php?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fecregdes="+fecregdes+"&fecreghas="+fecreghas+"&orden="+orden+"";
				window.open(pantalla,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			}
			else
			{alert("No tiene permiso para realizar esta operación");}
...
function ue_ayuda()
{
	...
	//window.open("ayudas/sigesp_ayu_cxp_rep_cxp_f1.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}		
