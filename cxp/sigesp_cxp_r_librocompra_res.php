...
***********************************************************************************/
	...
	$arrResultado=$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_librocompra_res.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
             <tr>
               <td width="780" height="30" colspan="11" class="cd-logo"><img src="../shared/imagebank/header.jpg" alt="a" width="808" height="40"></td>
             </tr>
             <tr>
...
?>
	 <table width="426" border="0" cellpadding="0" cellspacing="0" class="contorno">
	   <tr class="titulo-celdanew">
		 <td width="424" height="22" class="titulo-celdanew">Libro de Compras Resumido </td>
	   </tr>
...
function uf_imprimir()
{
	...
	if(li_imprimir==1)
	{
		...
		pagina= "reportes/sigesp_cxp_rpp_librocompra_res.php?mes="+ls_mes+"&agno="+ls_ano+"&tiporeporte="+tiporeporte;
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_cxp_rep_librocompra_res.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}	
</script>
</html>
