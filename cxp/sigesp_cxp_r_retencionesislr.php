...
***********************************************************************************/
	...
	$arrResultado=$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_retencionesislr.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td class="toolbar" width="25"><div align="center"><a href="javascript: ue_procesar();"><img src="../shared/imagebank/tools20/ejecutar.gif" width="20" height="20" border="0" title="Procesar"></a></div></td>
    ...
    <td class="toolbar" width="25"><div align="center"><a href="javascript: ue_printold();"><img src="../shared/imagebank/tools20/imprimir-off.gif" alt="Imprimir" width="20" height="20" border="0" title="Imprimir Documentos Formato Original"></a></div></td>
    ...
    <td class="toolbar" width="25"><a href="javascript: ue_ayuda();"><img src="../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" width="20" height="20" border="0" title="Ayuda"></a></td>
...
function ue_print()
{
	...
	if(li_imprimir==1)
	{
		...
		f.total.value=totrow;
		ls_tiporeporte=f.cmbbsf.value;
		fechades=f.txtfecdes.value;
		fechahas=f.txtfechas.value;
		for(li_i=1;li_i<=totrow;li_i++)
		{
			if(eval("f.checkcmp"+li_i+".checked==true"))
			{
		...
		if(ls_comprobantes!="")
		{
			...
			pagina="reportes/"+formato+"?comprobantes="+ls_comprobantes+"&procedencias="+ls_procedencias+"&tiporeporte="+ls_tiporeporte+"&fechadesde="+fechades+"&fechahasta="+fechahas;
...
function ue_printold()
{
	...
	if(li_imprimir==1)
	{
		...
		if(ls_comprobantes!="")
		{
			formato="sigesp_cxp_rpp_retencionislr.php";
			pagina="reportes/"+formato+"?comprobantes="+ls_comprobantes+"&procedencias="+ls_procedencias+"&tiporeporte="+ls_tiporeporte+"&fechadesde="+fechades+"&fechahasta="+fechahas;
			window.open(pagina,"reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no,left=0,top=0");
		}
		else
...
function ue_search()
{
	...
	ajax.send("catalogo=RETENCIONESISLR&tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+
			  "&fecdes="+fecdes+"&fechas="+fechas+"&basdatcmp="+basdatcmp+"&numsol="+numsol);
}
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_cxp_rep_retencionesislr.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
</script>
</html>