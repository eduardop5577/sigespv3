...
<br>
    <table width="500" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
	  ...
	  ?>
	  <tr>
        <td colspan="2"><div align="right"><a href="javascript: ue_search('<?php $_SESSION["la_empresa"]["estfilpremod"]?>');"><img src="../shared/imagebank/tools20/buscar.gif" alt="Buscar" width="20" height="20" border="0"> Buscar</a></div></td>
	  </tr>
</table> 
	<p>
...
function ue_search(ls_estfilpre)
{
	...
	ajax.send("catalogo=BENEFICIARIO&cedbene="+cedbene+"&nombene="+nombene+"&apebene="+apebene+"&tipo="+tipo+
			  "&orden="+orden+"&campoorden="+campoorden+"&repcajchi="+repcajchi+"&repcon="+repcon);
}
</script>
</html>