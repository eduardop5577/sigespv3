...
<html>
<head>
<title>Declaraci&oacute;n Informativa de Retencion Municipal</title>
...
<?php
	...
	switch ($ls_operacion) 
	{
		case "GENDISK":
			...
			$lb_valido=$io_reporte->uf_declaracioninformativamunicipal($ls_quincena,$ls_mes,$ls_anio,$la_seguridad);
			if($lb_valido)
			{
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="4" align="center">Declaraci&oacute;n Informativa de Retencion Municipal</td>
    </tr>
    <tr>
...
function ue_gendisk()
{
	...
	if(basdatcmp=="")
	{
		...
		f.action="sigesp_cxp_r_retencionesdeclaracionmunicipal.php";
		f.submit();	  
	}
	else
	{
...
function ue_descargar()
{
	...
	if(basdatcmp=="")
	{
		pagina="sigesp_cxp_cat_directorio.php?ruta=declaracionmunicipal";
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_cxp_rep_retencionesdeclaracionmunicipal.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
</script>
</html>