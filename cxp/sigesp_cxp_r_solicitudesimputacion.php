...
***********************************************************************************/
	...
	$arrResultado=$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_solicitudesimputacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<td class="toolbar" width="25"><div align="center"><a href="javascript: ue_ayuda();"></a><a href="javascript: ue_openexcel();"></a><a href="javascript: ue_cerrar();"><img src="../shared/imagebank/tools20/salir.gif" alt="Salir" width="20" height="20" border="0" title="Salir"></a></div></td>
    <td class="toolbar" width="25"><div align="center"><a href="javascript: ue_ayuda();"><img src="../shared/imagebank/tools20/ayuda.gif" alt="Ayuda" width="20" height="20" border="0" title="Ayuda"></a></a></div></td>
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_cxp_rep_solicitudesimputacion.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
</script>
