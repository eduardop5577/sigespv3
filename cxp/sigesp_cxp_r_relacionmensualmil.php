...
***********************************************************************************/
	...
	unset($arrResultado);
	$ls_reporte=$io_fun_cxp->uf_select_config("CXP","REPORTE","REPORTE_REL_MENS","sigesp_cxp_rpp_relacionmensualmil.php","C");
...
?>	
  ...
  <table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="22" colspan="3" align="center"><div align="right">Reporte
          <select name="cmbtiporeporte" id="cmbtiporeporte">
          <option value="1" selected>1 x 1000</option>
          <option value="2">Aporte Social</option>
        </select>
        </div></td>
    </tr>
    <tr>
...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_mostrar_reporte()
	{
			...
			ls_tiporeporte=f.cmbtiporeporte.value;
			if(li_imprimir==1)
			{
				...
				if((fecregdes!="")&&fecreghas!="")
				{
					if(ls_tiporeporte=="2")
					{
						...
						pantalla="reportes/sigesp_cxp_rpp_relacionmensualaporte.php?fecregdes="+fecregdes+"&fecreghas="+fecreghas+"";
	...
	function ue_openexcel()
	{
			...
			if(li_imprimir==1)
			{
				...
				if((fecregdes!="")&&fecreghas!="")
				{
					if(ls_tiporeporte=="2")
					{
						alert("No esta habilitada esta opcion");
					}
					else
					{
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_cxp_rep_relacionmensualmil.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
</script>
