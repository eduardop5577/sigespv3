...
***********************************************************************************/
	...
	$la_seguridad=array();
	$la_permisos=array();
	$arrResultado=$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_p_solicitudpago.php",$ls_permisos,$la_seguridad,$la_permisos);
   ...
   function uf_limpiarvariables()
   {
		...
		global $ls_numordpagmin,$ls_codtipfon,$ls_repcajchi,$ls_nombenaltcre,$ls_estbenalt,$ls_tipdoctesnac,$ls_controlguard;
   ...
   function uf_load_variables()
   {
		...
		global $ls_numordpagmin,$ls_codtipfon,$ls_repcajchi,$ls_nombenaltcre,$ls_tipdoctesnac,$ls_controlguard;
		...
		$ls_tipdoctesnac=$_POST["tipdoctesnac"];
...
<?php
	...
	switch($ls_operacion)
	{
		case "NUEVO":
			...
			$ls_numsol = $io_keygen->uf_generar_numero_nuevo2('CXP','cxp_solicitudes','numsol','CXPSOP',15,'numsolpag','','',$ls_logusr);
			if($ls_numsol===false)
			{
				print "<script language=JavaScript>";
		...
		case "GUARDAR":
			...
			$arrResultado=$io_cxp->uf_guardar($ls_existe,$ls_numsol,$ls_codpro,$ls_cedbene,$ls_codfuefin,$ls_tipodestino,
										   $ld_fecemisol,$ls_consol,$li_monsol,$ls_obssol,"E",
										   $li_totrowrecepciones,$la_seguridad,$la_permisos["administrador"],$ls_numordpagmin,$ls_codtipfon,$ls_repcajchi,$ls_nombenaltcre,$ls_prefijo);
		...
		case "ELIMINAR":
			uf_load_variables();
			$lb_valido=$io_cxp->uf_delete_solicitud($ls_numsol,$ls_codpro,$ls_cedbene,$ld_fecemisol,$li_totrowrecepciones,$ls_repcajchi,$la_seguridad,$la_permisos["administrador"]);
			if(!$lb_valido)
			{
				$ls_parametros=uf_load_data($ls_parametros);
			}
		...
		case "PREFIJO":
			...
			$ls_numsol = $io_keygen->uf_generar_numero_nuevo3('CXP','cxp_solicitudes','numsol','CXPSOP',15,'numsolpag','','',$ls_logusr,$ls_codpre);
    ...
    <table width="726" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
        <td width="790"  height="136"><p>&nbsp;</p>
            <table width="721" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              ...
              <tr>
                ...
                <td height="22" align="left"><?php $io_keygen->uf_prefijo($ls_codpre,"CXP","CXPSOP",$ls_logusr); ?></td>
                <td height="22" colspan="2" style="text-align:left">&nbsp;</td>
              </tr>
              <tr>
                <td height="22" align="right">Numero Solicitud </td>
                <td height="22" align="left"><input name="txtnumsol" type="text" id="txtnumsol" onBlur="javascript: ue_rellenarcampo(this,15);" value="<?php print $ls_numsol; ?>" maxlength="15" <?php if(($la_permisos["administrador"]!=1)||(($ls_operacion!="NUEVO")&&($ls_operacion!="PREFIJO"))){print "readonly";} ?> onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz'+'-/');" style="text-align:center"></td>
              ...
              <tr>
                ...
                <td height="22" colspan="3" align="left"><input name="txtcodfuefin" type="text" id="txtcodfuefin" style="text-align:center" value="<?php print $ls_codfuefin; ?>" size="10" readonly>
                  <a href="javascript: ue_catalogo('sigesp_cxp_cat_fuente.php?tipo=SOLPAG');"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
        ...
        <p>
          ...
          <input name="tipdoctesnac" type="hidden" id="tipdoctesnac" value="<?php print $ls_tipdoctesnac;?>">
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_cxp_solicitudpago.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
