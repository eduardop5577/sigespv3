...
***********************************************************************************/
	...
	$arrResultado=$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_libro_islr_timbrefiscal.php",$ls_permisos,$la_seguridad,$la_permisos);
	...
	$ls_aniofiscal=substr($_SESSION["la_empresa"]["periodo"],0,4);
	if($ls_estempcon!=1)
	{
		print("<script language=JavaScript>");
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="355" align="center"><div align="left">
        <input name="txtano" type="text" id="txtano" value="<?php print $ls_aniofiscal;?>" size="6" maxlength="4" readonly>
</div></td>
    </tr>
   <tr>
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_cxp_rep_libro_islr_timbrefiscal.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}	
