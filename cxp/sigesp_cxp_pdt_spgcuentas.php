...
***********************************************************************************/
	...
	$ls_spgcuenta=$io_fun_cxp->uf_obtenervalor_get("cuentapre","");
	$ls_monto=$io_fun_cxp->uf_obtenervalor_get("montopre","");
	...
	if($ls_spgcuenta!="")
	{
		$arrResultado=$io_fun_cxp->uf_buscar_cuenta_contable("../",$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,$ls_estcla,$ls_spgcuenta);
		$ls_sccuenta=$arrResultado["as_sccuenta"];
		$ls_denominacion=$arrResultado["denominacion"];
		$ls_disponible=$arrResultado["disponible"];
		if(($ls_sccuenta=="")&&($ls_denominacion==""))
		{
			print "<script language=JavaScript>";
			print "alert('La cuenta $ls_spgcuenta no existe en la Estructura de la Unidad Ejecutora seleccionada');";
			print "close();";
			print "</script>";		
		}
	}
...
<form name="formulario" method="post" action="">
  <table width="679" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td height="20" colspan="2" class="titulo-ventana">Detalles Presupuestarios </td>
    </tr>
  </table>
<br>
<table width="672" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
      <tr>
        <td width="116" height="22">&nbsp;</td>
        <td width="550" height="22">&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td height="22"><div align="left">
          <input name="txtcodestpro1" type="text" id="txtcodestpro1" style="text-align:center" value="<?php print $ls_codestpro1aux; ?>" size="<?php print ($li_len1+10); ?>" maxlength="<?php print $li_len1; ?>" readonly>
          <?php if($ls_codestpro1==""){?> <a href="javascript:ue_estructura1();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Buscar"></a><?php }?>
      ...
      <tr>
        ...
        <td height="22"><div align="left">
          <input name="txtcodestpro2" type="text" id="txtcodestpro2" value="<?php print $ls_codestpro2aux; ?>" size="<?php print ($li_len2+10); ?>" maxlength="<?php print $li_len2; ?>" style="text-align:center" readonly>
          <?php if($ls_codestpro2==""){?><a href="javascript:ue_estructura2();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Buscar"></a><?php }?>
      ...
      <tr>
        ...
        <td height="22"><div align="left">
          <input name="txtcodestpro3" type="text" id="txtcodestpro3"  value="<?php print $ls_codestpro3aux; ?>" size="<?php print ($li_len3+10); ?>" maxlength="<?php print $li_len3; ?>"  style="text-align:center" readonly>
          <?php if($ls_codestpro3==""){?><a href="javascript:ue_estructura3();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Buscar"></a><?php }?>
...
<?php }?>
      <tr>
        ...
        <td height="22"><div align="left">
          <input name="txtspgcuenta" type="text" id="txtspgcuenta" style="text-align:center" size="27" maxlength="25" value="<?php print $ls_spgcuenta; ?>" readonly>
          <?php if($ls_spgcuenta==""){?><a href="javascript:ue_cuentasspg();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat&aacute;logo de Cuentas de Gastos"></a> <?php }?>
          <input name="txtdenominacion" type="text" class="sin-borde" id="txtdenominacion" style="text-align:left" size="55"   value="<?php print $ls_denominacion; ?>">
          <input name="sccuenta" type="hidden" id="sccuenta"  value="<?php print $ls_sccuenta; ?>">
          <input name="disponibilidad" type="hidden" id="disponibilidad" value="<?php print $ls_disponible; ?>">
      ...
      <tr>
        ...
        <td height="22"><div align="left">
<?php if($ls_monto==""){?>          <input name="txtmonto" type="text" id="txtmonto" style="text-align:right" size="22" onKeyPress="return(ue_formatonumero(this,'.',',',event));"> <?php } else {?>
          <input name="txtmonto" type="text" id="txtmonto" style="text-align:right" size="22"  value="<?php print $ls_monto; ?>" readonly> <?php }?>
