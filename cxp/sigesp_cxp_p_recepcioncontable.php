...
***********************************************************************************/
   ...
   function uf_limpiarvariables()
   {
		...
		global $ls_codtipfon,$ls_denproalt,$ls_codproalt,$ls_numexprel,$ls_estretasu,$ls_anticipo,$ls_estvalcon;
...
<?php
	...
	switch ($ls_operacion) 
	{
		case "NUEVO":
			...
			$ls_codrecdoc = $io_keygen->uf_generar_numero_nuevo2('CXP','cxp_rd','codrecdoc','CXPRCD',15,'','','',$ls_logusr);
			unset($io_keygen);
			break;
...
<div align="left">
  <input name="txtnumexprel" type="text" id="txtnumexprel" value="<?php print $ls_numexprel; ?>" size="17" maxlength="10"  onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz')" style="text-align:center">
				  ...
				  <tr>
                    ...
                    <td width="178" height="22"><div align="right">Impuesto Municipal
		...
		else
		{
			...
			if(valido)
			{
				if(f.clactacont.value==1)
				{
					...
					if(valor=="--")
					{
						alert("Debe Seleccionar un Codigo de Clasificador.");
						valido=false;
					}
				}
			}
