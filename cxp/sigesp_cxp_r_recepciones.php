...
***********************************************************************************/
	...
	$arrResultado=$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_recepciones.php",$ls_permisos,$la_seguridad,$la_permisos);
	...
	$ls_reporte=$io_fun_cxp->uf_select_config("CXP","REPORTE","FORMATO_RECEPCIONES","sigesp_cxp_rpp_recepciones.php","C");
...
<table width="797" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    ...
    <td class="toolbar" width="26"><div align="center"><a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" title="Excel" width="20" height="20" border="0"></a></div></td>
...
?>	
  ...
  <table width="578" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="561" colspan="2" class="titulo-ventana">Reporte de Recepciones de Documentos </td>
    </tr>
  </table>
  <table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="22" colspan="3" align="center"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td height="22"><strong>Numero de Expediente</strong></td>
        </tr>
        <tr>
          <td height="22"><div align="center">
            <input name="txtnumexprel" type="text" id="txtnumexprel" value="" size="17" maxlength="10"  onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz')" style="text-align:center">
          </div></td>
        </tr>
      </table></td>
    </tr>
...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				numexprel=f.txtnumexprel.value;
				...
				pantalla="reportes/"+formato+"?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fecregdes="+fecregdes+"&fecreghas="+fecreghas+"&codtipdoc="+codtipdoc+"&registrada="+registrada+"&procesada="+procesada+"&anulada="+anulada+"&orden="+orden+"&tiporeporte="+tiporeporte+"&numexprel="+numexprel+"";
	...
	function ue_openexcel()
	{
			...
			if(li_imprimir==1)
			{
				...
				{orden="2";}
				tiporeporte=f.cmbbsf.value;
				pantalla="reportes/sigesp_cxp_rpp_recepciones_excel.php?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fecregdes="+fecregdes+"&fecreghas="+fecreghas+"&codtipdoc="+codtipdoc+"&registrada="+registrada+"&procesada="+procesada+"&anulada="+anulada+"&orden="+orden+"&tiporeporte="+tiporeporte+"&numexprel="+numexprel+"";
				window.open(pantalla,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			}
			else
			{alert("No tiene permiso para realizar esta operación");}
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_cxp_rep_recepciones.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
</script>
