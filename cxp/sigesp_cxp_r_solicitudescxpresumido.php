...
***********************************************************************************/
	...
	$arrResultado=$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_solicitudescxpresumido.php",$ls_permisos,$la_seguridad,$la_permisos);
      ...
      <td height="33" colspan="3" align="center">      <div align="left">
        <table width="511" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="101"><input name="txtfechades" type="text" id="txtfechades" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);" size="15" maxlength="10"  datepicker="true"></td>
            <td width="42"><div align="right">Hasta</div></td>
            <td width="129"><div align="left">
                <input name="txtfechahas" type="text" id="txtfechahas"  onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);" size="15" maxlength="10"  datepicker="true">
            </div></td>
            <td width="101">&nbsp;</td>
          </tr>
        </table>
...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_imprimir()
	{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/sigesp_cxp_rpp_cxpresumido.php?excluir="+excluir+"&fechades="+fechades+"&fechahas="+fechahas+"";
