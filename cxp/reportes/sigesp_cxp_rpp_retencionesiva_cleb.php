...
***********************************************************************************/
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($la_data,$ai_totconiva,$ai_totsiniva,$ai_totbasimp,$ai_totmonimp,$ai_totivaret,$ls_numsop,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezadopagina
		//		   Access: private 
		...
		$io_pdf->Rectangle(520,482,100,29);	
		$io_pdf->addText(525,500,9,"<b>SOLICITUD DE PAGO</b>"); // Agregar el titulo
		$io_pdf->addText(525,485,9,$ls_numsop); // Agregar el titulo								 
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[5]=array('f1'=>'AGENTR DE RETENCION','f2'=>'BENEFICIARIO ','f3'=>'SELLO');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('f1'=>array('justification'=>'center','width'=>333), // Justificacion y ancho de la columna
   						 			   'f2'=>array('justification'=>'center','width'=>334),
  						 			   'f3'=>array('justification'=>'center','width'=>333))); 
		$io_pdf->ezSetDy(-15);
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
					...
					if($lb_valido)
					{
						...
						for($li_i=1;$li_i<=$li_total;$li_i++)
						{
						  ...
						  uf_print_detalle($la_data,$li_totalconiva,$li_totalsiniva,$li_totalbaseimp,$li_totalmontoimp,
						  				   $li_totalivaret,$ls_numsop,$io_pdf); 						 						  
						  unset($la_data);							 
					}
				}
				if($li_z<($li_totrow-1))
