...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		// cuadro inferior
        $io_pdf->Rectangle(15,115,570,70);
		
		$io_pdf->line(15,174,585,174);		
		$io_pdf->line(15,125,585,125);		
		
		$io_pdf->line(187,55,187,185);		
		$io_pdf->line(317,55,317,185);		
		$io_pdf->line(446,55,446,185);		
		
		$io_pdf->line(187,55,446,55);		//segundo cuadro 
		$io_pdf->line(187,105,446,105);
		$io_pdf->line(187,65,446,65);
		$io_pdf->addText(224,97,7,"Directora General"); // Agregar el título
		$io_pdf->addText(341,97,7,"Procesado Por Tesorería"); // Agregar el título
		$io_pdf->addText(204,57,7,"Luisa Maria Lozada Fergusson"); // Agregar el título
		
		$io_pdf->addText(20,177,7,"Elaborado Por"); // Agregar el título
		$io_pdf->addText(20,117,7,"FIRMA"); // Agregar el título
		$io_pdf->addText(20,127,7,''.$_SESSION['la_nomusu'].'  '.$_SESSION['la_apeusu'].''); // Agregar Usuario actual
		$io_pdf->addText(228,177,7,"Revisado Por"); // Agregar el título
		$io_pdf->addText(229,167,7,"Contabilidad"); // Agregar el título
		$io_pdf->addText(226,117,7,"FIRMA / FECHA"); // Agregar el título
		$io_pdf->addText(218,127,7,"Lcda Maria Zambrano"); // Agregar el título
		$io_pdf->addText(356,177,7,"Autorizado Por"); // Agregar el título
		$io_pdf->addText(352,167,7,"Jefe de Finanzas"); // Agregar el título
		$io_pdf->addText(347,127,7,"Lcda Adriana Viadett"); // Agregar el título
		$io_pdf->addText(354,117,7,"FIRMA / FECHA"); // Agregar el título
		$io_pdf->addText(449,177,7,"Director De Administración Y Finanzas"); // Agregar el título
		$io_pdf->addText(449,167,7,"C.A Ovelio Barrera Corrales"); // Agregar el título
		$io_pdf->addText(449,117,7,"FIRMA / FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
