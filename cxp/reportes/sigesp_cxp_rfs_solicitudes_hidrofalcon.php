...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$io_pdf)
	{
		...
		$io_pdf->addText(157,122,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(145,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(275,122,7,"TESORERIA"); // Agregar el título
		$io_pdf->addText(257,63,7,"FIRMA/ SELLO"); // Agregar el título
		$io_pdf->addText(440,122,7,"FINANZAS"); // Agregar el título
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				while(!$rs_compromisos->EOF)
				{
					...
					$ls_anexo=$ls_anexo." Nro. Compromiso: ".$ls_numdoccom." - Procede: ".$ls_procede;
					$rs_compromisos->MoveNext();
				}
				$ls_consol=$ls_consol." ".$ls_anexo;
