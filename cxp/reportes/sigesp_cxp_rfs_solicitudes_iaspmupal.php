...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(495,670,9,"Fecha ".$ad_fecregsol); // Agregar el título
		// cuadro inferior
		...
		$io_pdf->addText(157,112,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(145,53,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(275,112,7,"CONTABILIZADO POR"); // Agregar el título
		$io_pdf->addText(270,53,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(460,112,7,"PRESIDENTE"); // Agregar el título
