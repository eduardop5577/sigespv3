...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,$io_pdf)
	{
		...
		$io_pdf->addText(50,122,7,"SECCION DE COMPRAS"); // Agregar el título
		$io_pdf->addText(220,122,7,"PLANIFICACIÓN Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(435,122,7,"GESTIÓN ADMINISTRATIVA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
