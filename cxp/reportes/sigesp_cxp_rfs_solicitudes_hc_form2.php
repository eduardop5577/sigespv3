...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(105,702,7,$ls_nombre." ".$ls_rif); // Agregar el título
		// cuadro inferior
        $io_pdf->Rectangle(15,60,570,110);
		$io_pdf->line(15,93,585,93);		
		$io_pdf->line(15,140,585,140);		
		$io_pdf->line(110,60,110,170);		
		$io_pdf->line(205,60,205,170);		
		$io_pdf->line(300,60,300,170);		
		$io_pdf->line(395,60,395,170);		
		$io_pdf->line(490,60,490,170);		
		$io_pdf->addText(25,160,7,"ELABORADO/REVISADO/"); // Agregar el título
		$io_pdf->addText(35,150,7,"CONFORMADO"); // Agregar el título
		$io_pdf->addText(135,160,7,"REVISADO"); // Agregar el título
		$io_pdf->addText(230,160,7,"REVISADO"); // Agregar el título
		$io_pdf->addText(325,160,7,"REVISADO Y"); // Agregar el título
		$io_pdf->addText(322,150,7,"CONFORMADO"); // Agregar el título
		$io_pdf->addText(415,160,7,"CONFORMADO "); // Agregar el título
		$io_pdf->addText(515,160,7,"APROBADO "); // Agregar el título
		
		$io_pdf->addText(20,85,6,"ANALISTA TESORERIA/"); // Agregar el título
		$io_pdf->addText(20,78,6,"JEFE TESORERIA/SUPERINT."); // Agregar el título
		$io_pdf->addText(20,71,6,"ADMINISTRACION Y FINAN. /"); // Agregar el título
		$io_pdf->addText(20,64,6,"JEFE ADMON. Y FINANZAS"); // Agregar el título
		$io_pdf->addText(120,85,6,"SUPERINT. GESTION"); // Agregar el título
		$io_pdf->addText(120,78,6,"ADMON"); // Agregar el título
		$io_pdf->addText(210,85,6,"SUPERINT. GESTION"); // Agregar el título
		$io_pdf->addText(210,78,6,"FINANZAS"); // Agregar el título
		$io_pdf->addText(210,71,6,"JEFE DE "); // Agregar el título
		$io_pdf->addText(210,64,6,"CONTABILIDAD"); // Agregar el título
		
		$io_pdf->addText(302,85,6,"JEFE PRESUP. Y COSTOS /"); // Agregar el título
		$io_pdf->addText(302,78,6,"ANALISTA DE PRESUP."); // Agregar el título
		$io_pdf->addText(302,71,6,"Y COSTOS / JEFE CONTROL "); // Agregar el título
		$io_pdf->addText(302,64,6,"DE GESTION Y PRESUP."); // Agregar el título
		$io_pdf->addText(405,85,6,"GERENTE CORP."); // Agregar el título
		$io_pdf->addText(405,78,6,"ADMON "); // Agregar el título
		$io_pdf->addText(405,71,6,"Y FINANZAS "); // Agregar el título
		$io_pdf->addText(515,85,6,"PRESIDENTE"); // Agregar el título
