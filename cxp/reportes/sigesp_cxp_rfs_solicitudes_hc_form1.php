...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(20,64,6,"ADMON."); // Agregar el título
		...
		$io_pdf->addText(302,85,6,"SUPERINT. PRESUPUESTO Y"); // Agregar el título
		$io_pdf->addText(302,78,6,"COSTOS / ANALISTA DE "); // Agregar el título
		$io_pdf->addText(302,71,6,"PRESUP. / COORD CONTROL "); // Agregar el título
