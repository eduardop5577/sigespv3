...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->line(90,60,90,140);		
		$io_pdf->line(170,60,170,140);		
		$io_pdf->line(260,60,260,140);
		$io_pdf->line(370,60,370,140);
		$io_pdf->line(485,60,485,140);
		$io_pdf->addText(20,132,7,"      ELABORADO  "); // Agregar el título
		$io_pdf->addText(100,132,7,"  CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(105,63,7,"     Contador"); // Agregar el título
		$io_pdf->addText(185,132,7,"  PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(178,63,7,"Coord. de Presupuesto"); // Agregar el título
		$io_pdf->addText(295,132,7," FINANZAS"); // Agregar el título
		$io_pdf->addText(270,63,7,"   Coord. General Finanzas"); // Agregar el título
		$io_pdf->addText(395,132,7," ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(375,63,7,"Coord. General de Administración"); // Agegar el título
		$io_pdf->addText(510,132,7,"PRESIDENCIA "); // Agregar el título
		$io_pdf->addText(505,63,7,"Director-Presidente"); // Agegar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
