...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(35,135,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(38,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->line(115,60,115,148);	//VERTICAL
		$io_pdf->addText(145,135,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(148,63,7,"FIRMA / SELLO "); // Agregar el título	
		$io_pdf->line(235,60,235,148);	//VERTICAL
		$io_pdf->addText(270,135,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(270,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->line(355,60,355,148);	//VERTICAL		
		$io_pdf->addText(380,135,7,"APROBADO (GERENCIA)"); // Agregar el título
		$io_pdf->addText(390,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->line(480,60,480,148);	//VERTICAL		
		$io_pdf->addText(495,135,7,"MAXIMA AUTORIDAD"); // Agregar el título
		$io_pdf->addText(505,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
