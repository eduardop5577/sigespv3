...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$tm=396-($li_tm/2);
		$io_pdf->addText(30,510,11,$as_titulo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(9,"ARTICULO 114 Ordenanza Sobre Actividades Economicas");
		$tm=396-($li_tm/2);
		$io_pdf->addText(30,500,9,"ARTICULO 114 Ordenanza Sobre Actividades Economicas"); // Agregar el título
							   ...
							   $as_nomsujret,$as_rif,$as_numlic,$ai_estcmpret,$io_pdf)
	{
		...
		unset($la_config);								 
		$io_pdf->ezSetY(490);
		$la_data[1]=array('name'=>'<b>R. I. F. del agente de retencion</b>');
		...
		unset($la_config);								 
		$io_pdf->ezSetY(385);
		$la_data[1]=array('name'=>'<b>R. I. F. del sujeto retenido</b>');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($la_data,$ai_totbasimp,$ai_totmonimp,$as_rifagenteret,$li_totalmontotdoc,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezadopagina
		//		   Access: private 
		...
		$la_data1[1]=array('numero'=>'<b>Nº</b>',
						  ...
						  'numfacafe'=>'<b>Numero Factura Afectada</b>',				  
						  'montotdoc'=>'<b>Total Factura</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>405, // Orientación de la tabla
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>40), // Justificacion y ancho de la columna
						 			   'fecfac'=>array('justification'=>'center','width'=>50), // Justificacion y ancho de la columna
									   ...
									   'numsop'=>array('justification'=>'center','width'=>90),
						 			   'numfacafe'=>array('justification'=>'center','width'=>70), // Justificacion y ancho de la columna
						 			   'montotdoc'=>array('justification'=>'center','width'=>70),
						 			   'baseimp'=>array('justification'=>'center','width'=>65),
						 			   'porimp'=>array('justification'=>'center','width'=>50),
   						 			   'iva_ret'=>array('justification'=>'center','width'=>65))); 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>40), // Justificacion y ancho de la columna
									   ...
									   'numsop'=>array('justification'=>'center','width'=>90),
						 			   'numfacafe'=>array('justification'=>'center','width'=>70), // Justificacion y ancho de la columna
						 			   'montotdoc'=>array('justification'=>'right','width'=>70),
						 			   'baseimp'=>array('justification'=>'right','width'=>65),
						 			   'porimp'=>array('justification'=>'right','width'=>50),
   						 			   'iva_ret'=>array('justification'=>'right','width'=>65))); 
		$io_pdf->ezSetDy(-0.5);
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data1);
		unset($la_columna);
		...
		$la_data1[1]=array('total'=>'<b>Total</b>',		
						   'totalfac'=>'<b>'.$li_totalmontotdoc.'</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'center','width'=>110), // Justificacion y ancho de la columna
   						 			   'totalfac'=>array('justification'=>'right','width'=>70),
   						 			   'monto'=>array('justification'=>'right','width'=>65),
   						 			   'imponible'=>array('justification'=>'right','width'=>115))); 
		$io_pdf->ezSetDy(-0.5);
		$io_pdf->ezTable($la_data1,$la_columna,'',$la_config);
		unset($la_data1);
		unset($la_columna);
				...
				if($lb_valido)
				{
					...
					if($lb_valido)
					{
						...
						for($li_i=1;$li_i<=$li_total;$li_i++)
						{
							...
							$li_totalmontotdoc=$li_totalmontotdoc + $li_montotdoc;	
							...
							$la_data[$li_i]=array('numero'=>$li_i,'numsop'=>$ls_numsop, 'fecfac'=>$ld_fecfac,'numfac'=>$ls_numfac,
												  'numref'=>$ls_numref,'baseimp'=>$li_baseimp,'porimp'=>$li_porimp,'iva_ret'=>$li_totimp,'numnotdeb'=>'','numnotcre'=>'','numfacafe'=>$ls_numfac,'montotdoc'=>$li_montotdoc);														
						  }																		 																						  
  						  $li_totalbaseimp= number_format($li_totalbaseimp,2,",","."); 
  						  $li_totalmontoimp= number_format($li_totalmontoimp,2,",","."); 
  						  $li_totalmontotdoc= number_format($li_totalmontotdoc,2,",","."); 
						  uf_print_detalle($la_data,$li_totalbaseimp,$li_totalmontoimp,$ls_rifagenteret,$li_totalmontotdoc,$io_pdf); 						 						  
						  unset($la_data);							 
					}
				}
