...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(27,550,9,"<b>SERVICIO AUTONOMO DE ADMINISTRACION TRIBUTARIA DEL ESTADO LARA (SAATEL)</b>"); // Agregar el título
		$io_pdf->addText($tm,535,9,"<b>COMPROBANTE DE RETENCION</b>"); // Agregar el título
							   ...
							   $as_nomsujret,$as_rif,$as_numlic,$ai_estcmpret,$as_conceptosp,$io_pdf)
	{
		...
		$la_data[1]=array('name'=>'<b>CONCEPTO DE LA ORDEN DE PAGO:</b>');
	...
	{						 
		...
		$io_pdf->ezSetDy(-15);
		$la_data1[1]=array('fecfac'=>'<b>Fecha de la orden de pago</b>',
						  'numsop'=>'<b>Numero de la orden de pago</b>',
						  'numfac'=>'<b>Número de Factura</b>',
						  'iva_ret'=>'<b>Monto del impuesto 1x1000 retenido</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>405, // Orientación de la tabla
						 'cols'=>array('fecfac'=>array('justification'=>'center','width'=>130), // Justificacion y ancho de la columna
						 			   'numsop'=>array('justification'=>'center','width'=>130),
						 			   'numfac'=>array('justification'=>'center','width'=>110), // Justificacion y ancho de la columna
   						 			   'iva_ret'=>array('justification'=>'center','width'=>150))); 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('fecfac'=>array('justification'=>'center','width'=>130), // Justificacion y ancho de la columna
						 			   'numsop'=>array('justification'=>'center','width'=>130),
						 			   'numfac'=>array('justification'=>'center','width'=>110), // Justificacion y ancho de la columna
   						 			   'iva_ret'=>array('justification'=>'right','width'=>150))); 
		$io_pdf->ezSetDy(-0.5);
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data1);
		unset($la_columna);
...
*/		$la_data1[1]=array('firma'=>'');	
		...
		$la_data1[3]=array('firma'=>'AGENTE DE RETENCION');	
		...
		$la_data1[1]=array('firma'=>'');	
		$la_data1[2]=array('firma'=>'_________________________________________________');	
		$la_data1[3]=array('firma'=>'RECIBE CONFORME');	
		$la_data1[4]=array('firma'=>'');
		$la_columna=array('firma'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
