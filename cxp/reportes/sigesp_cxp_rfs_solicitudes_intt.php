...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->line(191,60,191,140);		
		$io_pdf->line(411,60,411,140);		
		$io_pdf->addText(66,127.6,8,'<b>ELABORADO</b>');
		$io_pdf->addText(278,127.6,8,'<b>REVISADO</b>');
		...
		$io_pdf->addText(439,130.6,8,'<b>DIRECCIÓN DE GESTIÓN</b>');
		$io_pdf->addText(454,120,8,'<b>ADMINISTRATIVA</b>');	
		$io_pdf->restoreState();
		$io_pdf->closeObject();
