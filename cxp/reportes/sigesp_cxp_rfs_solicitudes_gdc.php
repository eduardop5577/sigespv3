...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$io_pdf)
	{
		...
		$io_pdf->line(15,119,585,119);		
		$io_pdf->line(15,129,585,129);		
		$io_pdf->line(130,60,130,140);		
		$io_pdf->line(260,60,260,140);		
		$io_pdf->line(410,60,410,140);		
		$io_pdf->addText(40,132,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(18,122,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(55,75,6,"Firma y Sello"); // Agregar el título
		$io_pdf->addText(55,63,7,"ANALISTA"); // Agregar el título
		$io_pdf->addText(163,132,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(136,122,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(170,75,6,"Firma y Sello"); // Agregar el título
		$io_pdf->addText(137,63,7,"ESPECIALISTA DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(305,132,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(263,122,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(315,75,6,"Firma y Sello"); // Agregar el título
		$io_pdf->addText(280,63,7,"COORDINACION DE FINANZAS"); // Agregar el título
		$io_pdf->addText(465,132,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(413,122,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(475,75,6,"Firma y Sello"); // Agregar el título
		$io_pdf->addText(425,63,7,"OFICINA DE ADMINISTRACION Y SERVICIOS"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle_scg($aa_data,$ai_totdeb,$ai_tothab,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('sc_cuenta'=>array('justification'=>'center','width'=>160), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'center','width'=>230), // Justificación y ancho de la columna
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(3.6,5.5,3,3); // Configuración de los margenes en centímetros
