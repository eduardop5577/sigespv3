...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_tipproben,$as_codprobendes,$as_codprobenhas,$as_nomprobendes,$as_nomprobenhas,$io_pdf)
	{
		...
		$io_pdf->addText(120,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(360,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(360,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		
		$io_pdf->addText(600,122,7,"AUTORIZADO POR"); // Agregar el título

		$io_pdf->addText(580,63,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		
		//$io_pdf->addText(635,122,7,"CONTRALORIA INTERNA"); // Agregar el título

		//$io_pdf->addText(630,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
	...
	function uf_print_detalle_recepcion($la_data,$li_totaldoc,$li_totalcar,$li_totalded,$li_totbasimp,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numrecdoc'=>array('justification'=>'left','width'=>70), // Justificación y ancho de la columna
						 			   'numexprel'=>array('justification'=>'left','width'=>55), // Justificación y ancho de la columna
						 			   'nombre'=>array('justification'=>'left','width'=>130), // Justificación y ancho de la columna
						 			   'fecemidoc'=>array('justification'=>'center','width'=>51), // Justificación y ancho de la columna
						 			   'fecregdoc'=>array('justification'=>'center','width'=>51), // Justificación y ancho de la columna
									   'procede_doc'=>array('justification'=>'center','width'=>54),// Justificación y ancho de la columna
									   'numdoccom'=>array('justification'=>'left','width'=>78), // Justificación y ancho de la columna
