...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(30,535,9,"<b>COMPROBANTE DE RETENCION DEL IMPUESTO DEL UNO POR MIL (1X1000)</b>"); // Agregar el título
		$io_pdf->addtext(695,548,10,"Fecha de Entrega");
		$io_pdf->addText(710,538,9,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addtext(695,526,9,"Página");
		$io_pdf->ezStartPageNumbers(750,526,9,'','',1); // Insertar el número de página
...
//		$io_pdf->addText(27,550,9,"<b>SERVICIO AUTONOMO DE ADMINISTRACION TRIBUTARIA DEL ESTADO LARA (SAATEL)</b>"); // Agregar el título
		...
		$io_pdf->addText(33,515,9,"En cumplimiento en lo establecido en el Artículo 18 del Reglamento de la Ley Especial de Timbre Fiscal para el Distrito");
							   ...
							   $as_nomsujret,$as_rif,$as_numlic,$ai_estcmpret,$as_conceptosp,$io_pdf)
	{
		...
		$io_pdf->addText(685,458,8,"Año: ".$ls_anio." Mes: ".$ls_mes); // Agregar el titulo
		$io_pdf->ezSetY(525);
		...
		unset($la_config);		
		$io_pdf->ezSetY(525);
		$la_data[1]=array('name'=>'<b>Fecha de Emisión</b>');
		...
		unset($la_config);
//		$io_pdf->ezSetY(420);
		$la_data[1]=array('name'=>'<b>Nombre o Razón Social: </b>'.$as_nomsujret);
		$la_data[2]=array('name'=>'');				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
	...
	{						 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xPos'=>545, // Orientación de la tabla
						 'width'=>320, // Ancho de la tabla						 
						 'maxWidth'=>320,
