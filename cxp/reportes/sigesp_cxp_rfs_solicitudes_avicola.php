...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],30,723,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		if ($as_estprosol=="A")
		{
...
//		$io_pdf->addText($tm,730,11,$as_titulo); // Agregar el título
		$io_pdf->addText(485,715,8,"No. ".$as_numsol); // Agregar el título
		$io_pdf->addText(485,695,8,"Fecha ".$ad_fecregsol); // Agregar el título
		// cuadro inferior
        $io_pdf->Rectangle(15,60,570,70);
		$io_pdf->line(15,117,585,117);		
		$io_pdf->line(158,60,158,130);		
		$io_pdf->line(299,60,299,130);		
		$io_pdf->line(448,60,448,130);		
		$io_pdf->addText(18,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(18,110,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(65,65,7,"ANALISTA"); // Agregar el título
		$io_pdf->addText(161,122,7,"CONTABILIZADO POR"); // Agregar el título
		$io_pdf->addText(161,110,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(170,65,7,"COORDINADOR DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(302,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(302,110,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(300,65,7,"GERENTE DE ADMINISTRACIÓN Y FIANZAS"); // Agregar el título
		$io_pdf->addText(451,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(451,110,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(493,65,7,"PRESIDENTA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
