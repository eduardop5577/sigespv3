...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$ls_periodo,$ls_mes,$ls_ano,$io_pdf)
	{
		...
		$io_pdf->ezSetY(500);
		$la_data   =array(array('name1'=>'<b>Compras Internas o Importaciones ALICUOTA 12%</b>'));
		...
		$la_config =array('showHeadings'=>0,     // Mostrar encabezados
						  ...
						  'maxWidth'=>150,
						  'cols'=>array('name1'=>array('justification'=>'center','width'=>110))); // Justificacin y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->ezSetY(500);
		$la_data   =array(array('name1'=>'<b>Compras Internas o Importaciones ALICUOTA 8%</b>'));
		$la_columna=array('name1'=>'');
		$la_config =array('showHeadings'=>0,     // Mostrar encabezados
						  'fontSize' => 6,       // Tamao de Letras
						  'titleFontSize' => 8, // Tamao de Letras de los ttulos
	...
	function uf_print_cabecera($io_pdf)
	{
		...
		$la_data=array(array('name1'=>'<b>Nro Oper</b>',
							 ...
							 'name4'=>'<b>Nombre o Razon Social</b>',
							 'name6'=>'<b>Nro Planilla Importacin  (C-80 o c-81)</b>','name8'=>'<b>Nro de Factura</b>',
							 'name9'=>'<b>Nro de Control</b>','name10'=>'<b>Nro Nota Dbito</b>','name11'=>'<b>Nro Nota Crdito</b>','name12'=>'<b>Tipo de Transacc.</b>',
							 'name13'=>'<b>Nro de Factura Afectada</b>','name14'=>'<b>Total de Compra Incluyendo IVA</b>','name15'=>'<b>Compra sin Derecho a Crdito IVA</b>',
							 'name16'=>'<b>Base Imponible</b>','name17'=>'<b>%</b>','name18'=>'<b>Impuesto Iva</b>','name161'=>'<b>Base Imponible</b>','name171'=>'<b>%</b>',
							 'name181'=>'<b>Impuesto Iva</b>'));
		$la_columna=array('name1'=>'','name2'=>'','name3'=>'','name4'=>'','name6'=>'','name8'=>'','name9'=>'','name10'=>'','name11'=>'','name12'=>'',
						  'name13'=>'','name14'=>'','name15'=>'','name16'=>'','name17'=>'','name18'=>'','name161'=>'','name171'=>'','name181'=>'');
		$la_config=array('showHeadings'=>0,     // Mostrar encabezados
						 ...
						 'cols'=>array('name1'=>array('justification'=>'center','width'=>15), // Justificacin y ancho de la columna Nro de Operacion.
									   ...
									   'name17'=>array('justification'=>'center','width'=>20), // Justificacin y ancho de la columna
						 			   'name18'=>array('justification'=>'center','width'=>40), // Justificacin y ancho de la columna
						 			   'name161'=>array('justification'=>'center','width'=>50), // Justificacin y ancho de la columna
									   'name171'=>array('justification'=>'center','width'=>20), // Justificacin y ancho de la columna
						 			   'name181'=>array('justification'=>'center','width'=>40))); // Justificacin y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
	}// end function uf_print_cabecera
	//--------------------------------------------------------------------------------------------------------------------------------
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('name1'=>array('justification'=>'center','width'=>15), // Justificacin y ancho de la columna Nro de Operacion.
									   ...
									   'name13'=>array('justification'=>'center','width'=>45), // Justificacin y ancho de la columna
						 			   ...
						 			   'name16'=>array('justification'=>'right','width'=>50), // Justificacin y ancho de la columna
									   'name17'=>array('justification'=>'right','width'=>20), // Justificacin y ancho de la columna
						 			   'name18'=>array('justification'=>'right','width'=>40), // Justificacin y ancho de la columna
						 			   'name161'=>array('justification'=>'right','width'=>50), // Justificacin y ancho de la columna
									   'name171'=>array('justification'=>'right','width'=>20), // Justificacin y ancho de la columna
						 			   'name181'=>array('justification'=>'right','width'=>40))); // Justificacin y ancho de la columna
		$la_columna=array('name1'=>'','name2'=>'','name3'=>'','name4'=>'','name6'=>'',
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_ajustes($io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detalle
		//		   Access: private 
		...
		global $io_pdf;
						...
						$la_data[1]=array('name20'=>'','name1'=>'',
										 'name2'=>'','name3'=>'',
										 'name4'=>'AJUSTES','name6'=>'', 'name7'=>'',
										 'name8'=>'','name9'=>'', 'name10'=>'','name11'=>'',
										 'name12'=>'','name13'=>'', 'name14'=>'',
										 'name15'=>'','name16'=>'',
										 'name17'=>'','name18'=>'','name161'=>'',
										 'name171'=>'','name181'=>'');	
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 5, // Tamao de Letras
						 'titleFontSize' => 10,  // Tamao de Letras de los ttulos
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_subtotales($ldec_totcomsiniva,$totbaseimp8,$totbaseimp12,$totimp8,$totimp12,$baseimpgrl,$impgrl,$ldec_totcomconivaaju,$ldec_totsinderivaaju,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detalle
		//		   Access: private 
		...
		global $io_pdf;
			...
			$la_data[1]=array('name20'=>"",'name1'=>"",
							 'name2'=>"",'name3'=>"",
							 'name4'=>"TOTAL AJUSTES",'name6'=>'', 'name7'=>'',
							 'name8'=>"",'name9'=>"", 'name10'=>"",'name11'=>"",
							 'name12'=>"",'name13'=>'', 'name14'=>number_format($ldec_totcomconivaaju,2,",","."),
							 'name15'=>number_format($ldec_totsinderivaaju,2,",","."),'name16'=>number_format($totbaseimp12,2,",","."),
							 'name17'=>'','name18'=>number_format($totimp12,2,",","."),'name161'=>number_format($totbaseimp8,2,",","."),
							 'name171'=>'','name181'=>number_format($totimp8,2,",","."));
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 5, // Tamao de Letras
						 'titleFontSize' => 10,  // Tamao de Letras de los ttulos
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_table_default($ld_monto,$ad_totbasimp,$ad_totimpuestos,$ld_sumcom,$ad_totcomsiniva,$ad_totimpred,$ad_totbasimp8,$ad_basimpga,$ad_totgenadi,$ad_totivaret,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	    ...
	    $la_data[5] = array('name1'=>'E de las: Compras Internas Afectadas solo en Alicuota General','name2'=>'33','name3'=>$ad_totbasimp,'name4'=>'34','name5'=>$ad_totimpuestos,'name6'=>$ad_totivaret,'name7'=>'');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_table_totales($ldec_totcomsiniva,$totbaseimp8,$totbaseimp12,$totimp8,$totimp12,$baseimpgrl,$impgrl,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[0] = array('name1'=>'RESUMEN DEL MES','name2'=>'BASE IMPONIBLE','name3'=>'MONTO DEL IMPUESTO');
		$la_data[1] = array('name1'=>'Total compras exentas y/o sin derecho a credito fiscal','name2'=>$ldec_totcomsiniva,'name3'=>'0,00');
		$la_data[2] = array('name1'=>'Total Compras 16%','name2'=>$totbaseimp12,'name3'=>$totimp12);
	    $la_data[3] = array('name1'=>'Total Compras 8%','name2'=>$totbaseimp8,'name3'=>$totimp8);
	    $la_data[4] = array('name1'=>'TOTAL GENERAL','name2'=>$baseimpgrl,'name3'=>$impgrl);
		...
		$la_config  = array('showHeadings'=>0, // Mostrar encabezados
						   ...
						   'cols'=>array('name1'=>array('justification'=>'left','width'=>250), // Justificacin y ancho de la columna Nro de Operacion.
						 			     'name2'=>array('justification'=>'right','width'=>100), // Justificacin y ancho de la columna Nro de Operacion.
						 			     'name3'=>array('justification'=>'right','width'=>110))); // Justificacin y ancho de la columna Nro Expediente de Importacin.
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
...
/*	switch($ls_tiprep)
	...
	$io_pdf->ezSetCmMargins(5.35,3,2.5,2.5); // Configuracin de los margenes en centmetros
...
//			print " ldec_montodoc->".$ldec_montodoc."  li_debman->".$li_debman." <br><br><br>";
			...
			$la_data[$li]=array('name20'=>$ls_cheque,'name1'=>$li,
							 ...
							 'name15'=>number_format($ldec_sinderiva,2,",","."),'name16'=>number_format($ldec_baseimp12,2,",","."),
							 'name17'=>$ldec_porcar12,'name18'=>number_format($ldec_monimp12,2,",","."),'name161'=>number_format($ldec_baseimp8,2,",","."),
							 'name171'=>$ldec_porcar8,'name181'=>number_format($ldec_monimp8,2,",","."));
			...
			if($contador!=0)
			{
				...
				//	$ldec_sinderiva    = $ldec_montodoc-$ldec_baseimp-$ldec_monimp;// Total de la Compra sin Derecho a Crédito Iva.
					...
					else
					{
						...
						$la_data[$li]=array('name20'=>$ls_cheque,'name1'=>$li,
										 'name2'=>$io_report->io_funciones->uf_convertirfecmostrar($la_notas["fecope"][$lk]),'name3'=>$ls_rif,
										 'name4'=>$ls_nombre,'name6'=>'', 'name7'=>'',
										 'name8'=>$ls_numrecdoc,'name9'=>$ls_numref, 'name10'=>$ls_numnd,'name11'=>$ls_numnc,
										 'name12'=>'','name13'=>$ls_numrecdoc, 'name14'=>number_format($ls_monnota,2,",","."),
										 'name15'=>'0,00','name16'=>number_format($ldec_baseimp12,2,",","."),
										 'name17'=>$ldec_porcar12,'name18'=>number_format($ldec_monimp12,2,",","."),'name161'=>number_format($ldec_baseimp8,2,",","."),
										 'name171'=>$ldec_porcar8,'name181'=>number_format($ldec_monimp8,2,",","."));	
					 $li_porcentaje   = intval($ldec_porcentaje_conf);
					 if ($ldec_porcar>0)
...
//		uf_print_subtotales(number_format($ldec_totcomsiniva,2,",","."),number_format($totbaseimp8,2,",","."),number_format($totbaseimp12,2,",","."),number_format($totimp8,2,",","."),number_format($totimp12,2,",","."),number_format($baseimpgrl,2,",","."),number_format($impgrl,2,",","."),$io_pdf);
	...
	else
	{
			...
			$la_data2[$li]=array('name20'=>$ls_cheque,'name1'=>$li,
							 'name2'=>$io_report->io_funciones->uf_convertirfecmostrar($row["fecemidoc"]),'name3'=>$ls_rif,
							 'name4'=>$ls_nombre,'name6'=>'', 'name7'=>'',
							 'name8'=>$ls_numrecdoc,'name9'=>$row["numref"], 'name10'=>$ls_numnd,'name11'=>$ls_numnc,
							 'name12'=>$ls_tiptrans,'name13'=>'', 'name14'=>number_format($ldec_montodoc,2,",","."),
		...
		$impgrl=$totimp8+$totimp12;
		uf_print_detalle($la_data2,$io_pdf);
		uf_print_subtotales($ldec_totcomsiniva,$totbaseimpaju8,$totbaseimpaju12,$totimpaju8,$totimpaju12,$baseimpgrl,$impgrl,$ldec_totcomconivaaju,$ldec_totsinderivaaju,$io_pdf);
	}
		uf_print_table_totales(number_format($ldec_totcomsiniva,2,",","."),number_format($totbaseimp8,2,",","."),number_format($totbaseimp12,2,",","."),number_format($totimp8,2,",","."),number_format($totimp12,2,",","."),number_format($baseimpgrl,2,",","."),number_format($impgrl,2,",","."),$io_pdf);
