...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(145,63,7,"COORD, ADM. Y FZAS."); // Agregar el título
		$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(257,63,7,"OFICINA DE GESTION ADMINISTRATIVA"); // Agregar el título
		$io_pdf->addText(440,122,7,"APROBADO"); // Agregar el título
		$io_pdf->addText(445,63,7,"DIRECCION GENERAL"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
