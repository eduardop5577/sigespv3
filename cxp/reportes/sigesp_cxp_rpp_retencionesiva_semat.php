...
***********************************************************************************/
	...
	function uf_print_encabezadopagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],847,539,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		//$io_pdf->addText(910,595,8,date("d/m/Y")); // Agregar la Fecha
		//$io_pdf->addText(916,585,7,date("h:i a")); // Agregar la Hora
		$io_pdf->setStrokeColor(0,0,0);
        $io_pdf->Rectangle(160,520,650,60);	
		$io_pdf->addText(385,560,10,"<b>Republica Bolivariana de Venezuela</b>"); // Agregar el t�ulo				
		$io_pdf->addText(435,550,10,"<b>Estado Lara</b>"); // Agregar el t�ulo				
		$io_pdf->addText(395,540,10,"<b>Alcaldia del Municipio Iribarren</b>"); // Agregar el t�ulo				
		$io_pdf->addText(340,530,10,"<b>Servicio Municipal de Administracion Tributaria (SEMAT)</b>"); // Agregar el t�ulo				
		$io_pdf->addText(100,500,9,"Ley IVA - Art. 11 La administracion Tributaria podra designar como responsable del pago del impuesto, en calidad de");
		$io_pdf->addText(100,490,9,"agentes de retencion, a los compradores o adquirientes de determinados bienes muebles y los receptores de ciertos servicios. ");
        $io_pdf->line(370,100,610,100);	
		$io_pdf->addText(440,90,9,"<b>LCDA. ALHIBIS PEREZ</b>"); // Agregar el t�ulo				
		$io_pdf->addText(360,80,9,"<b>GERENTE DE ADMINISTRACION Y FINANZAS DEL SEMAT</b>"); // Agregar el t�ulo				
		$io_pdf->addText(280,70,9,"<b>RESOLUCION No. 154-2016 GACETA MUNICIPAL ORDINARIA  No. 129 DE FECHA 22/08/2016</b>"); // Agregar el t�ulo				
		$io_pdf->restoreState();
		$io_pdf->closeObject();
