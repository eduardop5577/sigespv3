...
***********************************************************************************/
	...
	function uf_print_cabecera($as_numcon,$ad_fecrep,$as_agenteret,$as_rifagenteret,$as_perfiscal,$as_licagenteret,$as_diragenteret,
							   $as_nomsujret,$as_rif,$as_numlic,$ai_estcmpret,$as_telpro,$as_dirpro,$as_email,$as_emailagenteret,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezadopagina
		//		   Access: private 
		...
		$la_data[2]=array('agen_ret'=>'<b>Email Agente de Retencion </b>',
		                  'ubic'=>$as_emailagenteret,
						  'correlativo'=>'');				
		$la_columna=array('agen_ret'=>'',
		                  'ubic'=>'',
						  'correlativo'=>'');		
		...
		$la_data[3]=array('name'=>'<b>DIRECCION: '.$as_dirpro.'</b>');		
		$la_data[4]=array('name'=>'<b>TELEFONO: '.$as_telpro.'</b>');		
		$la_data[5]=array('name'=>'<b>EMAIL : '.$as_email.'</b>');		
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
						...
						if ($ls_numcom!=$ls_numcomant)
					   {
					    if ($li_z>=1)
					     ...
					     uf_print_cabecera($ls_numcon,$ls_fecrep,$ls_agenteret,$ls_rifagenteret,$ls_perfiscal,$ls_licagenteret,
									  $ls_diragenteret,$ls_nomsujret,$ls_rif,$ls_numlic,$li_estcmpret,$ls_telpro,$ls_dirpro,$ls_email,$ls_emailagenteret,$io_pdf);
