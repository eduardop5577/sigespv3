...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(150,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(132,63,7,"CONTROL PRESUPUESTARIO"); // Agregar el título
		$io_pdf->addText(265,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(243,63,7,"PRESIDENTE (A) DEL CONCEJO"); // Agregar el título
		$io_pdf->addText(370,122,7,"AUTORIZACION DE PAGO"); // Agregar el título
		$io_pdf->addText(357,63,7,"DIRECTOR DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(505,122,7,"CONFORME"); // Agregar el título
