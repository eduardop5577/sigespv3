...
***********************************************************************************/
							   ...
							   $as_nomsujret,$as_rif,$as_numlic,$ai_estcmpret,$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$la_data[1]=array('name'=>'ARTICULO 03 PROVIDENCIA SAATEL-00004 SOBRE ORDENES DE PAGO EMITIDAS');		
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
		...
		unset($la_columna);
		unset($la_config);
		$la_data[1]=array('name'=>'<b>AGENTE DE RETENCIÓN                                                                                                                </b>');		
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
		...
		unset($la_columna);
		unset($la_config);
		$io_pdf->line(590,488,590,464);
		$io_pdf->addText(625,479,7,"<b>FECHA: </b>".date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(610,467,7,"<b>CORRELATIVO: </b>".$as_numcon); // Agregar la Fecha
		$la_data[1]=array('name'=>'<b>RAZON SOCIAL : </b>'.$as_agenteret,);
		$la_data[2]=array('name'=>'<b>Nº DE RIF : </b>'.$as_rifagenteret,);	
		$la_data[3]=array('name'=>'<b>DOMICILIO FISCAL : </b>'.$_SESSION['la_empresa']['direccion']);			
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
		...
		$la_data[2]=array('name'=>'<b>Nº DE RIF : </b>'.$as_rif);		
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
	...
	function uf_print_detalle($la_data,$ai_totbasimp,$ai_totmonimp,$ai_totmoniva,$as_rifagenteret,$io_pdf)
	{
		...
		$la_data1[1]=array('numsop'=>'<b>Orden de Pago Nº</b>',
		...
		$la_columna=array('numsop'=>'<b>Orden de Pago Nº</b>',
		                  'fecfac'=>'<b>Fecha Factura</b>',
		                  'numfac'=>'<b>Nº Factura</b>',
  						  'numref'=>'<b>Nº Control</b>',		
						  'baseimp'=>'<b>Base Imponible</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('fecfac'=>array('justification'=>'center','width'=>70),
									   ...
									   'baseimp'=>array('justification'=>'center','width'=>125), // Justificacion y ancho de la columna
						 			   'iva_ret'=>array('justification'=>'center','width'=>125),
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('fecfac'=>array('justification'=>'center','width'=>70),
						 			   'numfac'=>array('justification'=>'center','width'=>100), // Justificacion y ancho de la columna
						 			   'numref'=>array('justification'=>'center','width'=>90), // Justificacion y ancho de la columna
									   'baseimp'=>array('justification'=>'right','width'=>125), // Justificacion y ancho de la columna
						 			   'iva_ret'=>array('justification'=>'right','width'=>125),
						 			   'porimp'=>array('justification'=>'center','width'=>80),
									   'numsop'=>array('justification'=>'center','width'=>100))); 
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data1);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'colGap'=>1,
						 'maxWidth'=>690, // Ancho Mínimo de la tabla
						 'cols'=>array('total'=>array('justification'=>'right','width'=>360), // Justificacion y ancho de la columna
   						 			   'monto'=>array('justification'=>'right','width'=>125),
									   'iva'=>array('justification'=>'right','width'=>125),
									   'ret'=>array('justification'=>'right','width'=>80))); 
		$io_pdf->ezTable($la_data1,$la_columna,'',$la_config);
		unset($la_data1);
		unset($la_columna);
		unset($la_config);
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$la_data[5]=array('firma1'=>'_______________________________','firma2'=>'_______________________________','firma3'=>'_______________________________');
		$la_data[6]=array('firma1'=>'LIQUIDADO POR','firma2'=>'DIRECCIÓN DE ADMINISTRACIÓN Y SERVICIOS','firma3'=>'RECIBIDO POR');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
				 		 'cols'=>array('firma1'=>array('justification'=>'center','width'=>230), // Justificación y ancho de la columna
						 			   'firma2'=>array('justification'=>'center','width'=>240),
									   'firma3'=>array('justification'=>'center','width'=>230))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
