...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$as_nomusu,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->line(15,73,490,73);		
		$io_pdf->line(15,150,585,150);	// Margen superior del recuadro de los firmantes	
		$io_pdf->addText(25,153,6,"Unidad Responsable"); // Agregar el título
		$io_pdf->line(30,130,80,130);
		$io_pdf->addText(40,123,6,"Director"); // Agregar el título
		$io_pdf->line(25,107,90,107);
		$io_pdf->addText(33,100,6,"Coordinador"); // Agregar el título
		$io_pdf->line(25,90,90,90);
		$io_pdf->addText(33,80,6,"Administrador"); // Agregar el título
		$io_pdf->addText(20,63,5,"Resp. ".$as_nomusu); // Agregar el título
		$io_pdf->line(100,60,100,160);
		$io_pdf->addText(217,153,6,"Maximas Autoridades"); // Agregar el título
		$io_pdf->addText(125,63,6,"Presidente"); // Agregar el título
		$io_pdf->line(200,60,200,150);
		$io_pdf->addText(220,63,6,"Vice-Presidente"); // Agregar el título
		$io_pdf->line(300,60,300,150);
		$io_pdf->addText(327,63,6,"Secretario"); // Agregar el título
		$io_pdf->line(395,60,395,160);
		$io_pdf->addText(411,153,6,"Oficina de Finanzas"); // Agregar el título
		$io_pdf->addText(423,106,6,"Director"); // Agregar el título
		$io_pdf->line(400,115,480,115);
		$io_pdf->addText(423,63,6,"Tesorero"); // Agregar el título
		$io_pdf->line(490,60,490,160);
		$io_pdf->addText(506,153,6,"Beneficiario del Pago"); // Agregar el título
		$io_pdf->addText(495,138,6,"Recibi Conforme:"); // Agregar el título
		$io_pdf->addText(495,130,6,"Nombre:"); // Agregar el título
		$io_pdf->addText(495,100,6,"C.I:"); // Agregar el título
		$io_pdf->addText(495,87,6,"Firma:"); // Agregar el título
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_nomusureg=$io_report->DS->data["nomusureg"][$li_i];
				$ls_apeusureg=$io_report->DS->data["apeusureg"][$li_i];
				$ls_nomusu= $ls_nomusureg." ".$ls_apeusureg;
				if($ls_estretiva=="B")
				{
