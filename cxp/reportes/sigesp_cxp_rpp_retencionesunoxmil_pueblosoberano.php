...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(27,535,12,"<b>COMPROBANTE DE RETENCION DE 1 X 1000</b>"); // Agregar el título
		...
		else
		{
			...
			for ($li_z=0;($li_z<$li_totrow)&&($lb_valido);$li_z++)
			{
				...
				if($lb_valido)
				{
					...
					$arrResultado=$io_report->uf_retencionesunoxmil_detfact($ls_numcom);
					...
					if($lb_valido)
					{
						...
						for($li_i=1;$li_i<=$li_total;$li_i++)
						{
							...
							$la_data2[$li_i]=array('dended'=>$ls_dended,'basimp'=>$li_baseimp, 'porimp'=>$li_porimp,'iva_ret'=>$li_iva_ret);
						  }																		 																						  
