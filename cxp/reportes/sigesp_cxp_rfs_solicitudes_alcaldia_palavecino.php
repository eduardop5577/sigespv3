...
//		$io_pdf->line(480,730,585,730);
  		$io_pdf->addText(379,671,15,"No. ".$as_numsol); // Agregar el título
		$io_pdf->addText(400,689,12,"Fecha ".$ad_fecregsol); // Agregar el título
...
//		$io_pdf->line(15,73,585,73);		
		...
		$io_pdf->line(443,60,443,130);		
		$io_pdf->addText(25,132,7,"REALIZADO Y REVISADO POR"); // Agregar el título
		$io_pdf->addText(20,122,7,"FECHA:              /              /"); // Agregar el título
		$io_pdf->addText(20,102,7,"FIRMA:"); // Agregar el título
	//	$io_pdf->addText(42,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(187,132,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(162,122,7,"FECHA:              /             /"); // Agregar el título
		$io_pdf->addText(162,102,7,"FIRMA:"); // Agregar el título
	//	$io_pdf->addText(145,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(315,132,7,"DIRECCION DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(302,122,7,"FECHA:              /             /"); // Agregar el título
		$io_pdf->addText(302,102,7,"FIRMA:"); // Agregar el título
	//	$io_pdf->addText(257,63,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(447,122,7,"FECHA:              /             /"); // Agregar el título
		$io_pdf->addText(447,102,7,"FIRMA:"); // Agregar el título
		$io_pdf->addText(495,132,7,"ALCALDE"); // Agregar el título
