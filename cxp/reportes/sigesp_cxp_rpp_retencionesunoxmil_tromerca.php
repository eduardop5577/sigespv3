...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(355,710,7,"FECHA DE ELABORACIÓN: "); // Agregar el título
		$io_pdf->addText(485,710,8,date("d/m/Y")); // Agregar el título
		$io_pdf->addText(355,695,7,"INSTRUMENTO FINANCIERO "); // Agregar el título
		$io_pdf->addText(375,685,7,"ORDEN DE PAGO NRO.: ".""); // Agregar el título
		/*$io_pdf->restoreState();
		$io_pdf->closeObject();
							   ...
							   $as_nomsujret,$as_rif,$as_numlic,$ai_estcmpret,$io_pdf)
	{
		...
		$la_data[1]=array('name'=>'<b>TROLEBÚS MERIDA, C.A. (TROMERCA)</b>');	
		$la_data[2]=array('name'=>'PLANILLA PARA EL CALCULO DEL IMPUESTO 1X1000');
		$la_data[3]=array('name'=>'');		
		$la_data[4]=array('name'=>'AGENTES DE RETENCIÓN ORGANISMOS PÚBLICOS NACIONALES, ESTADALES O MUNICIPALES');
		...
		$la_data[2]=array('agen_ret'=>'<b>TROLEBÚS MERIDA, C.A. (TROMERCA)</b>',
	...
	function uf_print_detalle($la_data,$ai_totbasimp,$ai_totmonimp,$ai_totmoniva,$as_rifagenteret,$as_iva_ret,$as_baseimp,$as_concepto,$as_numsop,$io_pdf)
	{
		...
		$io_pdf->addText(480,685,7,$as_numsop); // Agregar el título
		$la_data[1]=array('name'=>'<b> CONCEPTO DE LA RETENCIÓN PRACTICADA :</b>');
	...
	function uf_print_sello($io_pdf)
	{
		...
		$la_config= array('showHeadings'=>0, // Mostrar encabezados
						  ...
						  'cols'=>array('name1'=>array('justification'=>'center','width'=>183),						                
										...
										'name3'=>array('justification'=>'center','width'=>183))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config); 		
		...
		$la_config= array('showHeadings'=>0, // Mostrar encabezados	
						  ...
						  'cols'=>array('name1'=>array('justification'=>'left','width'=>183),						                
										...
										'name3'=>array('justification'=>'left','width'=>183))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config); 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
