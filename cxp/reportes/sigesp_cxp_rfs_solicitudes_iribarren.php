...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		// cuadro inferior
        $io_pdf->Rectangle(15,60,570,88); 
		$io_pdf->line(15,135,585,135);	//HORIZONTAL	
		$io_pdf->line(15,82,585,82);	//HORIZONTAL	
		$io_pdf->addText(25,139,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(38,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->line(115,60,115,148);	//VERTICAL
		$io_pdf->addText(120,139,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(120,73,7,"DIRECCION DE PLANIFICACION"); // Agregar el título
		$io_pdf->addText(145,63,7,"Y PRESUPUESTO"); // Agregar el título
		$io_pdf->line(235,60,235,148);	//VERTICAL
		$io_pdf->addText(240,139,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(245,73,7,"DIVISION DE CONTROL Y"); // Agregar el título
		$io_pdf->addText(246,63,7,"TRAMITACION DE PAGO"); // Agregar el título
		$io_pdf->line(350,60,350,148);	//VERTICAL		
		$io_pdf->addText(355,139,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(360,73,7,"DIVISION DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(385,63,7,"Y ARCHIVO"); // Agregar el título
		$io_pdf->line(468,60,468,148);	//VERTICAL		
		$io_pdf->addText(473,139,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(470,73,7,"DIRECCION DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(505,63,7,"Y FINANZAS"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_numsol,$as_codigo,$as_nombre,$as_denfuefin,$ad_fecemisol,$as_consol,$as_obssol,
							   $ai_monsol,$as_monto,$ls_rif,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_pdf;
		$la_data[1]=array('titulo'=>'<b> Beneficiario</b>','rif'=>'<b> Cedula/RIF</b>');
		$la_data[2]=array('titulo'=>$as_nombre,'rif'=>$ls_rif);
		$la_columnas=array('titulo'=>'','rif'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>450),
						 				'rif'=>array('justification'=>'left','width'=>120))); // Justificación y ancho de la columna
	...
	function uf_print_detalle_recepcion($la_data,$ai_totsubtot,$ai_tottot,$ai_totcar,$ai_totded,$io_pdf)
	{
		...
		$la_datatit[1]=array('numrecdoc'=>'<b>Factura</b>','fecemisol'=>'<b>Fecha</b>','subtotdoc'=>'<b>Monto</b>',
							 'moncardoc'=>'<b>I.V.A.</b>','mondeddoc'=>'<b>Deducciones</b>','montotdoc'=>'<b>Total</b>');
	...
	function uf_print_detalle_spg($aa_data,$ai_totpre,$io_pdf)
	{
		...
		$la_datatit[1]=array('titulo'=>'<b> Imputacion Presupuestaria </b>');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_detalle_scg($aa_data,$ai_totdeb,$ai_tothab,$io_pdf)
	{
		...
		$la_datatit[1]=array('titulo'=>'<b> Contabilidad Fiscal </b>');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
...
*/				$numalet->setNumero($li_monsol);
				...
				uf_print_cabecera($ls_numsol,$ls_codigo,$ls_nombre,$ls_denfuefin,$ld_fecemisol,$ls_consol,$ls_obssol,$li_monsol,$ls_monto,$ls_rif,$io_pdf);
