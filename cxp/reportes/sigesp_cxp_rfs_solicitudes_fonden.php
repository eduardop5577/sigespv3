...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$ls_nomusu,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_prefijo=substr($as_numsol,0,3);
		// cuadro inferior
		if($ls_prefijo=="FAS")
		{
			$io_pdf->Rectangle(15,60,570,70);
			$io_pdf->Rectangle(15,130,570,15);
			$io_pdf->line(15,115,585,115);		
			$io_pdf->line(15,75,585,75);		
			$io_pdf->line(125,60,125,130);		
			$io_pdf->line(235,60,235,145);		
			$io_pdf->line(355,60,355,130);
			$io_pdf->line(470,60,470,130);	
			
			$io_pdf->addText(85,135,7,"<b>OFICINA DE TRIBUTOS</b>"); // Agregar el título
			$io_pdf->addText(345,135,7,"<b>OFICINA DE GESTION ADMINISTRATIVA</b>"); // Agregar el título
			$io_pdf->addText(40,120,7,"<b>ELABORADO POR</b>"); // Agregar el título
			$io_pdf->addText(30,65,6,"<b>ANALISTA DE TRIBUTOS</b>"); // Agregar el título
			$io_pdf->addText(150,120,7,"<b>APROBADO POR</b>"); // Agregar el título
			$io_pdf->addText(128,65,6,"<b>JEFE DE LA OFICINA DE TRIBUTOS</b>"); // Agregar el título
			$io_pdf->addText(260,120,7,"<b>ELABORADO POR</b>"); // Agregar el título
			$io_pdf->addText(260,65,6,"<b>ANALISTA DE PAGOS</b>"); // Agregar el título
			$io_pdf->addText(385,120,7,"<b>REVISADO POR</b>"); // Agregar el título
			$io_pdf->addText(365,65,6,"<b>JEFE DE LA DIVISION DE PAGOS</b>"); // Agregar el título
			$io_pdf->addText(495,120,7,"<b>APROBADO POR</b>"); // Agregar el título
			$io_pdf->addText(490,68,6,"<b>JEFE DE LA OFICINA DE</b>"); // Agregar el título
			$io_pdf->addText(485,62,6,"<b>GESTION ADMINISTRATIVA</b>"); // Agregar el título
		}
		else
		{
			$io_pdf->Rectangle(15,60,570,70);
			...
			$li_tm=$io_pdf->getTextWidth(6,$ls_nomusu);
			$io_pdf->addText(105-($li_tm/2),75,6,$ls_nomusu); // Agregar el título
			$io_pdf->addText(40,63,7,"ANALISTA III DE LA DIVISION DE PAGOS"); // Agregar el título
			$io_pdf->addText(235,122,7,"COORD. DE ORDENACION DE PAGO"); // Agregar el título
			$io_pdf->addText(265,75,6,"Glaidymar M. Cabrera A."); // Agregar el título
			$io_pdf->addText(242,63,7,"JEFE DE LA DIVISION DE PAGOS"); // Agregar el título
			$io_pdf->addText(435,122,7,"GERENCIA DE ADMINISTRACION"); // Agregar el título
			$io_pdf->addText(460,75,6,"O´Nerllys C Guerra C."); // Agregar el título
			$io_pdf->addText(403,63,7,"JEFE DE LA OFICINA DE GESTION ADMINISTRATIVA"); // Agregar el título
		}
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_nomusu=$io_report->DS->data["nomusureg"][$li_i]." ".$io_report->DS->data["apeusureg"][$li_i];
/*				if($ls_estretiva=="B")
				{print "ASAs";
...
*/				$numalet->setNumero($li_monsol);
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_estprosol,$ls_nomusu,$io_pdf);
