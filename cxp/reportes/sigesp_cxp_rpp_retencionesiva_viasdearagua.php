...
***********************************************************************************/
	...
	function uf_print_encabezadopagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(360,555,12,"VIAS DE ARAGUA, S.A.");
		...
		//$io_pdf->line(23,75,357,75); //LINEA HORIZONTAL
                $io_pdf->addtext(220,85,10,"Agente de Retenci�n");
                $io_pdf->addtext(240,75,10,"Firma Y Sello"); 
		//$io_pdf->Rectangle(50,100,400,100);
		$io_pdf->addtext(650,85,10,"Recibido por");
                $io_pdf->addtext(650,75,10,"Firma Y Sello");
