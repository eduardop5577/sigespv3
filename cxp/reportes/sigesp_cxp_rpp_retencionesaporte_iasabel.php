...
***********************************************************************************/
	...
	function uf_print_encabezadopagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/banner_iasabel.jpg',40,540,560,40); // Agregar Logo
  ...
  //      $io_pdf->Rectangle(150,540,800,40);	
		$io_pdf->addText(190,528,10,"<b>".$as_titulo."</b>"); // Agregar el t�ulo				
		$io_pdf->addText(200,518,10,"DECRETO DE LEY No. 1.947 GACETA OFICIAL  No. 40.727"); // Agregar el t�ulo				
		$io_pdf->line(80,85,285,85); //LINEA HORIZONTAL
		$io_pdf->addtext(105,70,10,"<b> PROVEEDOR CONTRIBUYENTE </b>");
		$io_pdf->line(520,85,740,85); //LINEA HORIZONTAL
		$io_pdf->addtext(524,70,10,"<b> FIRMA Y SELLO AGENTE DE RETENCION </b>");
		$io_pdf->restoreState();
		$io_pdf->closeObject();
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);								 
		$io_pdf->Rectangle(845,525,100,28);	
		$io_pdf->addText(850,542,9,"<b>FECHA</b>"); // Agregar el titulo
		$io_pdf->addText(850,528,9,$ad_fecrep); // Agregar el titulo								 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'shaded'=>0, // Sombra entre lineas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xPos'=>225, // Orientacion de la tabla
		...
		unset($la_columna);
		unset($la_config);								 
		$io_pdf->Rectangle(400,485,370,27);	
		$io_pdf->addText(405,502,8,"<b>REGISTRO DE INFORMACION FISCAL DEL AGENTE DE RETENCION</b>"); // Agregar el titulo
		$io_pdf->addText(405,488,8,$as_rifagenteret); // Agregar el t�ulo									 
        //---------------------------------------------------------------------------------------------------
		$la_data[1]=array('titulo'=>'');
		$la_columna=array('titulo'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
		...
		unset($la_columna);
		unset($la_config);								
		$io_pdf->Rectangle(400,392,370,27);	
		$io_pdf->addText(405,410,8,"<b>REGISTRO DE INFORMACION FISCAL DEL SUJETO RETENIDO (R.I.F)</b>"); // Agregar el titulo
		$io_pdf->addText(405,397,8,$as_rif); // Agregar el titulo									 
	...
	function uf_print_detalle($la_data,$ai_totconiva,$ai_totsiniva,$ai_totbasimp,$ai_totmonimp,$ai_totivaret,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('numope'=>array('justification'=>'center','width'=>60), // Justificacion y ancho de la columna
						 			   'fecfac'=>array('justification'=>'center','width'=>90), // Justificacion y ancho de la columna
									   ...
									   'numnotdeb'=>array('justification'=>'center','width'=>100),
		...
		$la_data[1]=array('name'=>'','name1'=>$ai_totconiva,'name2'=>$ai_totsiniva,'name3'=>$ai_totbasimp,
		                  'name4'=>'','name6'=>$ai_totivaret);						                      
		$la_columna=array('name'=>'','name1'=>'','name2'=>'','name3'=>'','name4'=>'','name6'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' =>8,    // Tamaño de Letras
						 ...
						 'cols'=>array('name'=>array('justification'=>'center','width'=>100), // Justificacion y ancho de la columna
									   ...
									   'name4'=>array('justification'=>'center','width'=>70), // Justificacion y ancho de la columna
	...
	$ls_titulo="COMPROBANTE DE RETENCION DE FONDO NEGRO PRIMERO";	
					...
					if($lb_valido)
					{
						...
						for($li_i=1;$li_i<=$li_total;$li_i++)
						{
							...
							$la_data[$li_i]=array('numope'=>$ls_numope,'fecfac'=>$ld_fecfac,'numfac'=>$ls_numfac,'numref'=>$ls_numref,
												  'numnotdeb'=>$ls_numsop,'numnotcre'=>$ls_numnotcre,'tiptrans'=>$ls_tiptrans,
