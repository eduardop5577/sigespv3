...
***********************************************************************************/
	...
	function uf_print_encabezadopagina($as_titulo,$as_numcon,$ad_fecrep,$io_pdf)
	{
		...
		$io_pdf->line(800,520,800,580);
		$io_pdf->line(800,550,950,550);
		$io_pdf->addText(110,545,16,"<b>".$as_titulo."</b>"); // Agregar el t�ulo				
		$io_pdf->addText(830,570,10,"<b>Nro De Comprobante</b>"); // Agregar el t�ulo				
		$io_pdf->addText(840,555,10,$as_numcon); // Agregar el t�ulo				
		$io_pdf->addText(860,540,10,"<b>Fecha</b>"); // Agregar el t�ulo				
		$io_pdf->addText(850,525,10,$ad_fecrep); // Agregar el t�ulo				
		$io_pdf->restoreState();
		$io_pdf->closeObject();
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,$io_pdf)
	{
		...
		$la_data[1]=array('name'=>'<b>Ley IVA - Art. 11 Seran responsables del pago del Impuesto en calidad de agente de retencion, los compradores o adquirientes de determinados bienes muebles y los receptores de ciertos servicios, a quienes la Administracion Tributaria designe como tal</b>  ');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>503, // Orientacion de la tabla
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('name'=>array('justification'=>'center','width'=>460), // Justificacion y ancho de la columna
						 			   'name1'=>array('justification'=>'center','width'=>260), // Justificacion y ancho de la columna
	...
	function uf_print_detalle($la_data,$ai_totconiva,$ai_totsiniva,$ai_totbasimp,$ai_totmonimp,$ai_totivaret,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>200,
						 'cols'=>array('name'=>array('justification'=>'right','width'=>49), // Justificacion y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>900, // Ancho de la tabla						 
						 'maxWidth'=>725, // Orientación de la tabla
						 'cols'=>array('name'=>array('justification'=>'center','width'=>448), // Justificacion y ancho de la columna
						 			   'name1'=>array('justification'=>'center','width'=>448))); 
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>900, // Ancho de la tabla						 
						 'maxWidth'=>725, // Orientación de la tabla
						 'cols'=>array('name'=>array('justification'=>'center','width'=>498), // Justificacion y ancho de la columna
						 			   'name1'=>array('justification'=>'center','width'=>398))); 
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>900, // Ancho de la tabla						 
						 'maxWidth'=>725, // Orientación de la tabla
						 'cols'=>array('name'=>array('justification'=>'left','width'=>498), // Justificacion y ancho de la columna
						 			   'name1'=>array('justification'=>'center','width'=>398))); 
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
	...
	function uf_print_piepagina($ls_numsol,$ls_fecsol,$ls_numche,$ls_fecche,$io_pdf)
	{
		...
		$io_pdf->addText(450,20,8,"Fecha ".date("d/m/Y")."  Hora: ".date("h:i a")); // Agregar la Fecha
		$io_pdf->addText(820,70,8,"<b>FECHA OP1: </b>".$ls_fecsol); // Agregar el t�ulo				
		$io_pdf->addText(820,60,8,"<b>OP1: </b>".$ls_numsol); // Agregar el t�ulo				
		$io_pdf->addText(820,50,8,"<b>FECHA CHEQUE_1: </b>".$ls_fecche); // Agregar el t�ulo				
		$io_pdf->addText(820,40,8,"<b>CHEQUE_1: </b>".$ls_numche); // Agregar el t�ulo				
	}// end function uf_print_encabezadopagina
	//--------------------------------------------------------------------------------------------------------------------------------	
