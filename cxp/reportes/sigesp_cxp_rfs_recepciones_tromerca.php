...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,$as_nomusu,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_ver_tromerca.jpg',15,730,570,40); // Agregar Logo
		...
		$io_pdf->addText(540,725,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(546,720,6,date("h:i a")); // Agregar la Hora
		// cuadro inferior
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numrecdoc,$ld_fecrecdoc,$ls_estprodoc,$ls_nomusu,$io_pdf);
				if($ls_codpro!="----------")
				{
					$ls_codigo=$ls_codpro;
...
//////////////////////////   GRID DETALLE PRESUPUESTARIO		//////////////////////////////////////
				...
				if($lb_valido)
				{
					...
					for($li_s=1;$li_s<=$li_totrowspg;$li_s++)
					{
						...
						$as_programatica="";
						$arrResultado=$io_fun_cxp->uf_formatoprogramatica($ls_codestpro,$as_programatica);
						$as_programatica=$arrResultado["as_programatica"];
