...
***********************************************************************************/
	...
	function uf_print_encabezadopagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(280,542,11," <b>COMPROBANTE DE RETENCION DEL IVA </b>");
	...
	function uf_print_firmas($io_pdf)
	{
		...
		$la_data[3]=array('firma1'=>'_____________________________________','firma2'=>'_____________________________________');
		$la_data[4]=array('firma1'=>'Firma y Sello del Agente de Retencion','firma2'=>'Firma del Contribuyente');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientaci�n de la tabla
				 		 'cols'=>array('firma1'=>array('justification'=>'center','width'=>300), // Justificaci�n y ancho de la columna
						 			   'firma2'=>array('justification'=>'center','width'=>300))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	if($lb_valido)
	{
		...
		else
		{
			...
			$io_pdf->ezSetCmMargins(3.5,2,3,3);
			$lb_valido=true;
