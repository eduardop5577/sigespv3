...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,$io_pdf)
	{
		...
		$io_pdf->addText(72,63,7,"ANALISTA"); // Agregar el título
		$io_pdf->addText(240,122,7,"VERIFICADO POR:"); // Agregar el título
		$io_pdf->addText(210,63,7,""); // Agregar el título
		$io_pdf->addText(450,122,7,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->addText(430,63,7,"ADMINISTRADOR FONDO NNA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
