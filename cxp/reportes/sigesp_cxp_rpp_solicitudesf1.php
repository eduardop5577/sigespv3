...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_subtitulo,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$li_tm=$io_pdf->getTextWidth(11,$as_subtitulo);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,715,11,$as_subtitulo); // Agregar el título
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$li_totrow = $li_i -1;
			uf_print_encabezado_pagina($ls_titulo,$ls_subtitulo,$io_pdf);
