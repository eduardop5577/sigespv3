...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(37,706,4,"VIAS DE ARAGUA, S.A."); // Agregar el título
		$io_pdf->addText(40,702,4,"RIF: G-20010618-2"); // Agregar el título
		// cuadro inferior
		...
		$io_pdf->addText(30,63,6,"FIRMA / SELLO"); // Agregar el título
                $io_pdf->addText(105,122,6,"GERENCIA DE PLANIFICACION Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(150,63,6,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(280,122,6,"UNIDAD DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(300,63,6,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(400,122,6,"GERENCIA ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(410,63,6,"FIRMA / SELLO"); // Agregar el título
		//$io_pdf->addText(425,122,6,"GERENCIA GENERAL"); // Agregar el título
		//$io_pdf->addText(422,63,6,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(520,122,6,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(512,63,6,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(105,53,5,"VIAS DE ARAGUA, RIF: G-20010618-2, AV. AGUSTIN ALVAREZ ZERPA, EDIF. GOBERNACION EDO ARAGUA PISO 7 OFIC.1 10 LAS DELICIAS/ Telefono (0243)2328805"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
