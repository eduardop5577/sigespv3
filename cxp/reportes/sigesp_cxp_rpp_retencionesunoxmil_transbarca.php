...
***********************************************************************************/
	...
	function uf_print_detalle($la_data,$ai_totbasimp,$ai_totmonimp,$ai_totmoniva,$as_rifagenteret,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('fecfac'=>array('justification'=>'center','width'=>70),
									   ...
									   'baseimp'=>array('justification'=>'center','width'=>106), // Justificacion y ancho de la columna
						 			   'iva_ret'=>array('justification'=>'center','width'=>100),
						 			   'porimp'=>array('justification'=>'center','width'=>120),
									   'numsop'=>array('justification'=>'center','width'=>106))); 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'colGap'=>1,
						 'maxWidth'=>690, // Ancho Mínimo de la tabla
						 'cols'=>array('total'=>array('justification'=>'center','width'=>260), // Justificacion y ancho de la columna
   						 			   'monto'=>array('justification'=>'right','width'=>106),
									   'iva'=>array('justification'=>'right','width'=>100),
									   'ret'=>array('justification'=>'right','width'=>120),
									   'orpag'=>array('justification'=>'right','width'=>106))); 
		$io_pdf->ezTable($la_data1,$la_columna,'',$la_config);
		unset($la_data1);
		unset($la_columna);
		unset($la_config);
	...
	function uf_print_sello($io_pdf)
	{
	    ...
	    $la_data[1]=array('name1'=>'COORDINADOR GENERAL DE ADMINISTRACIÓN</b>',
						'name3'=>'<b>CONTADOR</b>');	
        $la_columna=array('name1'=>'','name3'=>'');
		$la_config= array('showHeadings'=>0, // Mostrar encabezados
						  ...
						  'colGap'=>1,
						  'width'=>690,
						  'cols'=>array('name1'=>array('justification'=>'center','width'=>340),						                
										'name3'=>array('justification'=>'center','width'=>350))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config); 		
		 
	    $la_data[1]=array('name1'=>'','name3'=>'');
		$la_data[2]=array('name1'=>'','name3'=>'');	
		$la_data[3]=array('name1'=>'','name3'=>'');	
		$la_data[4]=array('name1'=>'','name3'=>'');	
		$la_data[5]=array('name1'=>'','name3'=>'');		
        $la_columna=array('name1'=>'','name3'=>'');
		$la_config= array('showHeadings'=>0, // Mostrar encabezados					  
						  'shaded'=>0, // Sombra entre líneas
						  'shadeCol'=>array(0.9,0.9,0.9),
	...
	if($lb_valido)
	{
		...
		else
		{
			...
			$io_pdf->ezStartPageNumbers(740,47,8,'','{PAGENUM} de {TOTALPAGENUM}',1); // Insertar el número de página
			$lb_valido=true;
			$ls_numcomant = "";
