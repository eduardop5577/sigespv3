...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(9,$ls_nomemp);
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,763,9,$ls_nomemp); // Agregar el título
		...
		// cuadro inferior
        $io_pdf->Rectangle(15,20,570,120);
		$io_pdf->line(15,30,585,30);		
		$io_pdf->line(15,80,585,80);		
		$io_pdf->line(15,90,585,90);		
//		$io_pdf->line(15,117,585,117);		
		$io_pdf->line(205,20,205,140);		
		$io_pdf->line(395,20,395,140);		
//		$io_pdf->line(380,60,380,130);		
		$io_pdf->addText(60,82,7,"DISPONIBILIDAD FINANCIERA"); // Agregar el título
		$io_pdf->addText(75,22,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(237,82,7,"DISPONIBILIDAD PRESUPUESTARIA"); // Agregar el título
		$io_pdf->addText(270,22,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(465,82,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(465,22,7,"BENEFICIARIO"); // Agregar el título
...
//		$io_pdf->addText(445,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
	...
	function uf_print_cabecera($as_numsol,$as_codigo,$as_nombre,$as_denfuefin,$ad_fecemisol,$as_consol,$as_obssol,
							   $ai_monsol,$as_monto,$ls_rifpro,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_pdf;
		$la_data[1]=array('titulo'=>'<b> Beneficiario</b>','titulo1'=>'<b>Cedula/RIF</b>');
		$la_data[2]=array('titulo'=>"                 ".$as_nombre,'titulo1'=>"      ".$ls_rifpro);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>400), // Justificación y ancho de la columna
						 			   'titulo1'=>array('justification'=>'left','width'=>170))); // Justificación y ancho de la columna
	...
	function uf_print_carded($la_datacar,$io_pdf)
	{
		...
		$la_columnacar=array('denominacion'=>'<b>Denominación</b>',						  
						     'monobjret'=>'<b>Monto Objeto Retención </b>',
							 'objret'=>'<b>Retención </b>');
		...
		$io_pdf->ezTable($la_datacar,$la_columnacar,'<b>RETENCIONES</b>',$la_configcar);			
	}
	//--------------------------------------------------------------------------------------------------------------------------------	
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(3.6,4.6,3,3); // Configuración de los margenes en centímetros
			$io_pdf->ezStartPageNumbers(570,10,8,'','',1); // Insertar el número de página
