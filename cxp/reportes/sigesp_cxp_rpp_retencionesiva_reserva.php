...
***********************************************************************************/
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_pdf;
		$io_pdf->addText(180,520,9,"<b>Ley IVA - Art. 11 Seran responsables del pago del Impuesto en calidad de agente de retencion, los</b>");
		$io_pdf->addText(180,510,9,"<b>compradores o adquirientes de determinados bienes muebles y los receptores de </b>");
		$io_pdf->addText(190,500,9,"<b>ciertos servicios, a quienes la Administracion Tributaria designe como tal</b>");
		...
		$io_pdf->addText(850,500,9,"<b>FECHA</b>"); // Agregar el titulo
            $io_pdf->addText(70,105,9,"<b>__________________________________________</b>"); // Agregar el titulo
            $io_pdf->addText(87,90,9,"<b>Firma y Sello del Agente de Retencion</b>"); // Agregar el titulo
         //////   $io_pdf->addText(458,105,9,"<b>____________________________</b>"); // Agregar el titulo
           /////7 $io_pdf->addText(480,90,9,"<b>RECIBI CONFORME</b>"); // Agregar el titulo
            $io_pdf->addText(600,105,9,"<b>___________________________________________</b>"); // Agregar el titulo
            $io_pdf->addText(650,90,9,"<b>Firma y sello del Proveedor </b>"); // Agregar el titulo
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'shaded'=>0, // Sombra entre lineas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xPos'=>210, // Orientacion de la tabla
		...
		unset($la_columna);
		unset($la_config);								
		$io_pdf->Rectangle(400,350,370,30);	
		$io_pdf->addText(405,370,9,"<b>REGISTRO DE INFORMACION FISCAL DEL SUJETO RETENIDO (R.I.F)</b>"); // Agregar el titulo
		$io_pdf->addText(405,355,9,$as_rif); // Agregar el titulo									 
	...
	{
		$ls_titulo="COMPROBANTE DE RETENCION DEL IMPUESTO AL VALOR AGREGADO (I.V.A.)";	
	}
