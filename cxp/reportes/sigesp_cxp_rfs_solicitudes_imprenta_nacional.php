...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$as_nomusu,$as_nomusuapr,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_codusuapr=$io_report->DS->data["usuaprosol"][$li_i];
				$ls_nomusureg=$io_report->uf_sep_select_usuario($ls_codusureg);
				$ls_nomusuapr=$io_report->uf_sep_select_usuario($ls_codusuapr);
				
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_estprosol,$ls_nomusureg,$ls_nomusuapr,$io_pdf);
