...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],25,705,150,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		if ($as_estprosol=="A")
		{
		...
		$io_pdf->addText(257,63,7,"ADMINISTRACION Y FINANZAS"); // Agregar el t?tulo
		$io_pdf->addText(440,122,7,"PRESIDENCIA GAS LARA"); // Agregar el t?tulo
