...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(25,110,7,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(92,63,7,"FIRMA"); // Agregar el título
		$io_pdf->addText(215,122,7,"FECHA                    /                     / "); // Agregar el título
		$io_pdf->addText(215,110,7,"ADMINISTRACION: "); // Agregar el título
		//$io_pdf->addText(155,63,7,"PRESUPUESTO"); // Agregar el título
		//$io_pdf->addText(300,122,7,"APROBADO "); // Agregar el título
		$io_pdf->addText(287,63,7,"FIRMA"); // Agregar el título
		$io_pdf->addText(405,122,7,"FECHA                    /                     / "); // Agregar el título
		$io_pdf->addText(405,110,7,"ALCALDE:"); // Agregar el título
		$io_pdf->addText(475,63,7,"FIRMA"); // Agregar el título
							   ...
							   $ai_monsol,$as_monto,$ls_rifpro,$io_pdf)
	{
		...
		$la_data[1]=array('titulo'=>'<b> Beneficiario</b>                                                                                                                                           <b>R.I.F.:  </b>'.$ls_rifpro);
