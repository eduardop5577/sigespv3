...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,$ls_codusureg,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//$io_pdf->addText(53,110,6,"UNIDAD DE ORDEN DE PAGO"); // Agregar el título
		$io_pdf->addText(20,75,6,$ls_nomusu); // Agregar el título
		$io_pdf->addText(50,63,7,"UNIDAD DE ORDEN DE PAGO"); // Agregar el título
		$io_pdf->addText(257,122,7,"VERIFICADO POR"); // Agregar el título
		//$io_pdf->addText(230,110,6,"COORDINACION DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(245,63,7,"UNIDAD DE FINANZAS"); // Agregar el título
		$io_pdf->addText(450,122,7,"CERTIFICADO POR"); // Agregar el título
		//$io_pdf->addText(435,110,6,"DIR. SOPORTE ADMINISTRATIVO"); // Agregar el título
		//$io_pdf->addText(453,75,6,"ELIONORA MARINCO"); // Agregar el título
		$io_pdf->addText(425,63,7,"DIR. SOPORTE ADMINISTRATIVO"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numrecdoc,$ld_fecrecdoc,$ls_estprodoc,$ls_codusureg,$io_pdf);
				if($ls_codpro!="----------")
				{
					$ls_codigo=$ls_codpro;
