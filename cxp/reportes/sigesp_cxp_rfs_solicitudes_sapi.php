...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$ls_nomusureg,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->line(157.5,60,157.5,130);		
		$io_pdf->line(300,60,300,130);		
		$io_pdf->line(442,60,442,130);		
		$io_pdf->addText(55,122,7,"ELABORADO POR"); // Agregar el título
		//$io_pdf->addText(43,110,6,"UNIDAD DE ORDEN DE PAGO"); // Agregar el título
		$io_pdf->addText(20,75,6,$ls_nomusureg); // Agregar el título
		$io_pdf->addText(55,63,7,"UNIDAD DE PAGO"); // Agregar el título
		$io_pdf->addText(200,122,7,"VERIFICADO POR"); // Agregar el título
		//$io_pdf->addText(175,110,6,"COORDINACION DE ADMINISTRACION"); // Agregar el título
		//$io_pdf->addText(205,75,6,"NANCY PRIETO"); // Agregar el título
		$io_pdf->addText(192,63,7,"UNIDAD DE FINANZAS"); // Agregar el título
		$io_pdf->addText(335,122,7,"CERTIFICADO POR"); // Agregar el título
		//$io_pdf->addText(320,110,6,"DIR. SOPORTE ADMINISTRATIVO"); // Agregar el título
		//$io_pdf->addText(335,75,6,"ELIONORA MARINCO"); // Agregar el título
		$io_pdf->addText(318,63,7,"DIR. SOPORTE ADMINISTRATIVO"); // Agregar el título
		$io_pdf->addText(482,122,7,"APROBADO POR"); // Agregar el título
		//$io_pdf->addText(490,110,6,"DIR. GENERAL"); // Agregar el título
		//$io_pdf->addText(475,75,6,"JOSE MIGUEL VILLANUEVA"); // Agregar el título
		$io_pdf->addText(485,63,7,"DIR. GENERAL"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_nomusureg=$io_report->DS->data["nomusureg"][$li_i]." ".$io_report->DS->data["apeusureg"][$li_i];
/*				if($ls_estretiva=="B")
				{print "ASAs";
...
*/				$numalet->setNumero($li_monsol);
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_estprosol,$ls_nomusureg,$io_pdf);
...
//////////////////////////   GRID DETALLE PRESUPUESTARIO		//////////////////////////////////////
						...
						if($lb_valido)
						{
							...
							for($li_s=1;$li_s<=$li_totrowspg;$li_s++)
							{
								...
								$li_len5=0;
								$ls_titulo="";
								$arrResultado=$io_fun_cxp->uf_loadmodalidad($li_len1,$li_len2,$li_len3,$li_len4,$li_len5,$ls_titcuentas);
								...
								$ls_titcuentas=$arrResultado["as_titulo"];
