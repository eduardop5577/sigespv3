...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(165,122,7,"REVISADO "); // Agregar el título
		$io_pdf->addText(155,63,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(300,122,7,"APROBADO "); // Agregar el título
		$io_pdf->addText(247,63,7,"DIRECCION DE ADMINISTRACION Y SERVICIOS"); // Agregar el título
		$io_pdf->addText(445,122,7,"ORDENADO Y AUTORIZADO"); // Agregar el título
		$io_pdf->addText(445,63,7,"CONTRALOR (A) MUNICIPAL"); // Agregar el título
