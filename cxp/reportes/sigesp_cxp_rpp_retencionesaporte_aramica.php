...
***********************************************************************************/
	...
	function uf_print_sello($io_pdf)
	{
		...
		$la_data1[2]=array('name1'=>'Procesado Por:','name2'=>'','name3'=>'');		
	    $la_data1[3]=array('name1'=>'<b>Gerencia de Administracion y Finanzas:</b>','name2'=>'','name3'=>'Recibo Por:');
		...
		$la_data2[1]=array('name1'=>'','name2'=>'','name3'=>'Nombre: _____________________');
		$la_data2[2]=array('name1'=>'','name2'=>'','name3'=>'_____________________________');		
	    $la_data2[3]=array('name1'=>'','name2'=>'','name3'=>'C.I.:_________________________');
	    $la_data2[3]=array('name1'=>'','name2'=>'','name3'=>'');
	    $la_data2[3]=array('name1'=>'<b>Firma y Sello</b>','name2'=>'','name3'=>'Firma y Sello');
	...
	$ls_titulo="COMPROBANTE DE RETENCION DE RESPONSABILIDAD SOCIAL";	
