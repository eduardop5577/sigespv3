...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,&$io_pdf)
	{
		...
		$io_pdf->addText(66,125,8,'<b>ELABORADO POR: </b>');
		$io_pdf->addText(18,95,8,$_SESSION["la_apeusu"].", ".$_SESSION["la_nomusu"]);
		$io_pdf->addText(50,65,7,'<b>ANALISTA (FIRMA/SELLO)</b>');
		$io_pdf->line(191,60,191,135);				
		$io_pdf->addText(260,125,8,'<b>VERIFICADO POR:</b>');
		$io_pdf->addText(230,65,7,'<b>COORDINACION DE CONTABILIDAD</b>');
		$io_pdf->line(400,60,400,135);		
		$io_pdf->addText(455,125,8,'<b>AUTORIZADO POR:</b>');
		$io_pdf->addText(410,65,7,'<b>GERENCIA DE ADMINISTRACION Y SERVICIOS</b>');	
		$io_pdf->restoreState();
		$io_pdf->closeObject();
