...
***********************************************************************************/
	...
	function uf_print_encabezadopagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(350,490,11,"<b> COMPROBANTE DE RETENCION DEL IVA </b>"); // Agregar el t?ulo				
		$io_pdf->restoreState();
		$io_pdf->closeObject();
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,$io_pdf)
	{
		...
		$io_pdf->Rectangle(500,520,120,28);	
		$io_pdf->addText(510,536,9,"<b>NRO COMPROBANTE</b>"); // Agregar el titulo
		$io_pdf->addText(520,522,9,$as_numcon); // Agregar el titulo								 
							 
		$io_pdf->Rectangle(670,520,100,28);	
		$io_pdf->addText(700,536,9,"<b>FECHA</b>"); // Agregar el titulo
		$io_pdf->addText(695,522,9,$ad_fecrep); // Agregar el titulo								 
		
		$line1="Año: ".substr($as_perfiscal,0,4)."      Mes: ".substr($as_perfiscal,5,2); // Agregar el titulo									 
		$line1=utf8_decode($line1);
		$io_pdf->Rectangle(845,432,100,37);	
		$io_pdf->addText(850,456,9,"<b>PERIODO FISCAL</b>"); // Agregar el titulo	
		$io_pdf->addText(850,440,9,$line1); // Agregar el titulo									 
		...
		unset($la_columna);
		unset($la_config);								 
		$io_pdf->Rectangle(400,432,370,38);	
		...
		unset($la_columna);
		unset($la_config);								
		$io_pdf->Rectangle(400,345,370,30);	
	...
	function uf_print_detalle($la_data,$ai_totconiva,$ai_totsiniva,$ai_totbasimp,$ai_totmonimp,$ai_totivaret,$io_pdf)
	{
		...
		$ls_titulo2="COMPRA SIN DERECHO A CREDITO FISCAL";
		$la_columna=array('numope'=>'<b>OPER NRO.</b>',
						  'fecfac'=>'<b>FECHA DE LA FACTURA</b>',
						  'numfac'=>'<b>NUMERO DE LA FACTURA</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('numope'=>array('justification'=>'center','width'=>60), // Justificacion y ancho de la columna
									   ...
									   'numnotdeb'=>array('justification'=>'center','width'=>60),
   						 			   'tiptrans'=>array('justification'=>'center','width'=>60),		
									   'numfacafec'=>array('justification'=>'center','width'=>70),		   									   
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>200,
						 'xPos'=>700,      // Ancho de la tabla
						 'rowGap' => 4,						 
						 'maxWidth'=>200,
						 'cols'=>array('name'=>array('justification'=>'center','width'=>70), // Justificacion y ancho de la columna
									   ...
									   'name4'=>array('justification'=>'center','width'=>60), // Justificacion y ancho de la columna
									   'name5'=>array('justification'=>'center','width'=>60), // Justificacion y ancho de la columna
				...
				if($lb_valido)
				{
					...
					if($lb_valido)
					{
						...
						for($li_i=1;$li_i<=$li_total;$li_i++)
						{
							...
							$ls_numfacafec=str_replace("-","",$ls_numfac);
