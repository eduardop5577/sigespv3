...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$io_pdf)
	{
		...
		$texto3="PARA LA EDUCACION UNIVERSITARIA, CIENCIA Y TECNOLOGIA";
		$texto4="UNIVERSIDAD TERRITORIAL DELTAICA";
		$texto5="FRANCISCO TAMAYO";
		...
		$ls_titulo="SOLICITUD DE PAGO";

		$io_pdf->addTextWrap(110,$y-63,300,13,$as_titulo,'centre');
							   ...
							   $ai_monsol,$as_monto,$io_pdf)
	{
		...
		$la_data[2]=array('titulo'=>'<b>Fuente Financiamiento:   </b>'.$as_denfuefin,);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
