...
***********************************************************************************/
	...
	function uf_print_detalle_recepcion($li_totrows,$lo_libro,$lo_hoja,$la_data,$totcmp_con_iva,$totimp,$iva_ret,$li_fila)
	{
		...
		$li_fila++;
		$lo_hoja->write($li_fila, 0, "Cargo:                Gerente de Administración y Finanzas",$lo_libro->addformat(array('bold'=>0,'font'=>'Verdana','align'=>'left','size'=>'8')));
		...
		$li_fila++;
		$lo_hoja->write($li_fila, 0, "Teléfono:             0416-5013988",$lo_libro->addformat(array('bold'=>0,'font'=>'Verdana','align'=>'left','size'=>'8')));
		...
		$li_fila++;
		$lo_hoja->write($li_fila, 0, "Correo Electrónico:   emicasa1999@hotmail.com",$lo_libro->addformat(array('bold'=>0,'font'=>'Verdana','align'=>'center','size'=>'8')));
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$lo_hoja->write(6, 0, "Ente Público:            ".$_SESSION["la_empresa"]["nombre"],$lo_libro->addformat(array('bold'=>0,'font'=>'Verdana','align'=>'left','size'=>'8')));
			$lo_hoja->write(7, 0, "R.I.F.:                     ".$_SESSION["la_empresa"]["rifemp"],$lo_libro->addformat(array('bold'=>0,'font'=>'Verdana','align'=>'left','size'=>'8')));
			$lo_hoja->write(8, 0, "Dirección:               ".$_SESSION["la_empresa"]["direccion"],$lo_libro->addformat(array('bold'=>0,'font'=>'Verdana','align'=>'left','size'=>'8')));
