...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(11,"DIRECCION E.P.P DE TESORERIA");
		$tm=505-($li_tm/2);
		$io_pdf->addText($tm,550,11,"DIRECCION E.P.P DE TESORERIA"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(11,"RELACION MENSUAL IMPUESTO 1 X 1000");
		$tm=505-($li_tm/2);
		$io_pdf->addText($tm,540,11,"RELACION MENSUAL IMPUESTO 1 X 1000"); // Agregar el título
		// cuadro inferior
/*        $io_pdf->Rectangle(10,60,762,70);
	...
	function uf_print_detalle_recepcion($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>185,
						 'cols'=>array('name'=>array('justification'=>'center','width'=>220)));  // Ancho Minimo de la tabla
		...
		$la_columnas=array('numsop'=>'<b>ORDEN DE PAGO</b>',
							 ...
							 'fecmov'=>'<b>FECHA</b>',
							 'rif'=>'<b>C.I. Ó R.I.F.</b>',
							 'totcmp_con_iva'=>'<b>MONTO NETO</b>',
							 'iva_ret'=>'<b>MONTO DEL IMPUESTO   1 X 1000</b>',
							 'vacio4'=>'<b>No. DE LA PLANILLA DE DEPOSITO</b>',
							 'vacio3'=>'<b>MUNICIPIO DONDE SE EFECTUO EL PAGO EN EL ESTADO MERIDA</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('numsop'=>array('justification'=>'center','width'=>75), // Justificación y ancho de la columna
									   ...
									   'fecmov'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
						 			   ...
						 			   'vacio4'=>array('justification'=>'center','width'=>75), // Justificación y ancho de la columna
						 			   'vacio3'=>array('justification'=>'center','width'=>100))); // Justificación y ancho de la columna
...
//				$li_totalded= $li_totalded + $li_mondeddoc;
				...
				$la_data[$li_i]=array('numsop'=>$ls_numsop,'numdocpag'=>$ls_numdocpag,'vacio1'=>"",'numcom'=>$ls_numcom,'nomban'=>$ls_nomban,
									  ...
									  'totcmp_con_iva'=>$li_totcmp_con_iva,'totimp'=>$li_totimp,'iva_ret'=>$li_iva_ret,'vacio4'=>"",'vacio3'=>"CAMPO ELIAS");
			}
