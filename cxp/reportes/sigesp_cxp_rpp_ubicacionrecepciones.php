...
***********************************************************************************/
	...
	function uf_print_detalle_recepcion($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numrecdoc'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'numexprel'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
						 			   ...
						 			   'estatus'=>array('justification'=>'center','width'=>75), // Justificación y ancho de la columna
	...
	if($lb_valido)
	{
		...
		$lb_valido=$io_report->uf_select_ubicacion_recepciones($ls_tipproben,$ls_codprobendes,$ls_codprobenhas,$ld_fecregdes,$ld_fecreghas,
													 		   $ls_codtipdoc,$ls_registrada,$ls_anulada,$ls_procesada,$ls_orden,
															   $ls_numrecdoc,$ls_numexprel); // Cargar el DS con los datos del reporte
		...
		else  // Imprimimos el reporte
		{
			...
			while (!$io_report->rs_data->EOF)
			{
				...
				$ls_numexprel= $io_report->rs_data->fields["numexprel"]; 
				switch($ls_estprodoc)
				{
					case "R": 
				...
				$la_data[$li_i]=array('numrecdoc'=>$ls_numrecdoc,'numexprel'=>$ls_numexprel,'tipo'=>$ls_dentipdoc, 'nombre'=>$ls_nombre,'estatus'=>$ls_estprodoc,'solicitud'=>$ls_numsol,
