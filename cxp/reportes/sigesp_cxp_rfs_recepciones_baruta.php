...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,$io_pdf)
	{
		...
		$io_pdf->addText(23,63,7,"TESORERIA Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(157,122,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(157,63,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(255,63,7,"ADMINISTRADOR(A) GENERAL"); // Agregar el título
		$io_pdf->addText(450,122,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(440,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
