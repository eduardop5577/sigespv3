...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$ls_codusureg,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_nomusu=$io_report->uf_sep_select_usuario($ls_codusureg);
		...
		$io_pdf->line(150,60,150,130);		
		$io_pdf->line(280,60,280,130);		
		$io_pdf->line(440,60,440,130);		
		$io_pdf->addText(60,122,7,"ELABORADO"); // Agregar el título
		$io_pdf->addText(65,63,7,"ANALISTA"); // Agregar el título
		$io_pdf->addText(45,75,7,$ls_nomusu); // Agregar el título
		$io_pdf->addText(194,122,7,"REVISADO"); // Agregar el título
		$io_pdf->addText(183,75,7,"Lcda. Línley Gómez"); // Agregar el título
		$io_pdf->addText(152,63,7,"COORDINADORA DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(325,122,7,"CONFORMADO"); // Agregar el título
		$io_pdf->addText(317,75,7,"M.Sc. Veronica Ibarra"); // Agregar el título
		$io_pdf->addText(283,63,7,"GERENTE DE ADMINISTRACION Y FINANZAS"); // Agregar el título
		$io_pdf->addText(485,122,7,"AUTORIZADO"); // Agregar el título
		$io_pdf->addText(482,75,7,"Cnel. Jose Raga"); // Agregar el título
		$io_pdf->addText(485,63,7,"PRESIDENTE"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
...
*/				$numalet->setNumero($li_monsol);
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_estprosol,$ls_codusureg,$io_pdf);
