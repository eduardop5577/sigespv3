...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(115,122,7,"GESTIÓN ADMINISTRATIVA"); // Agregar el título
		$io_pdf->addText(115,75,6,"LUIS ARVELIO RAMIREZ GARCIA"); // Agregar el título
		$io_pdf->addText(155,69,6,"MAYOR"); // Agregar el título
		$io_pdf->addText(140,63,6,"ADMINISTRADOR"); // Agregar el título
		$io_pdf->addText(410,122,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(380,75,6,"JUAN DE JESÚS GARCÍA TOUSSAINTT"); // Agregar el título
		$io_pdf->addText(410,69,6,"MAYOR GENERAL"); // Agregar el título
		$io_pdf->addText(417,63,6,"PRESIDENTE"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
