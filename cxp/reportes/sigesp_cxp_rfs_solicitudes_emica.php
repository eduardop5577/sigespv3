...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->line(480,680,585,680);
        $io_pdf->Rectangle(480,660,105,40);
		//$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_emica.jpg',67,715,390,55); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_emica.jpg',15,700,570,50); // Agregar Logo
		if ($as_estprosol=="A")
		{
			$io_pdf->addText(470,760,10,"<b>ANULADO</b>"); // Agregar la Fecha
		}
		$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=256-($li_tm/2);
		$io_pdf->addText($tm,667,11,$as_titulo); // Agregar el título
		$io_pdf->addText(485,685,9,"No. ".$as_numsol); // Agregar el título
