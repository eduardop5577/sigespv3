...
***********************************************************************************/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_dentipdoc,$as_estprosol,$ls_nomusureg,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],24,703,$_SESSION["ls_width"],$_SESSION["ls_height"]); //    Agregar Logo
		if ($as_estprosol=="A")
		{
		...
		// cuadro inferior
		$io_pdf->line(90,110,270,110);		
		$io_pdf->line(340,110,530,110);		
		$io_pdf->addText(120,100,9,"DIRECTOR DE FINANZAS"); // Agregar el título
		$io_pdf->addText(360,100,9,"DG. ADMINISTRACION Y FINANZAS"); // Agregar el título
//		$io_pdf->addText(140,96,5,"DIRECTOR DE FINANZAS"); // Agregar el título
//		$io_pdf->addText(402,96,5,"DG. ADMINISTRACION Y FINANZAS"); // Agregar el título
		$io_pdf->addText(20,58,7,"Emitido por: ".$_SESSION['la_apeusu'].' '.$_SESSION['la_nomusu'].""); // Agregar el título*/
		$io_pdf->addText(20,50,7,"Elaborado por: ".$ls_nomusureg.""); // Agregar el título*/
		...
		else  // Imprimimos el reporte
		{
			...
			if($li_totrow>1)
			{
				 ...
				 for($li_i=1;$li_i<=$li_totrow;$li_i++)
				 {
					  ...
					  $ds_dentipdoc->insertRow("dencla",$ls_dencla);
				 }
...
*/				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_dencla,$ls_estprosol,$ls_nomusureg,$io_pdf);
