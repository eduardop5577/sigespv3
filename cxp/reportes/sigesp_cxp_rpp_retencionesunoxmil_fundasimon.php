...
***********************************************************************************/
	...
	function uf_print_sello($ls_numsop,$ls_fecsol,$ls_numche,$ls_fecche,$io_pdf)
	{
	    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(620,110,8,"<b>FECHA OP1: </b>".$ls_fecsol); 			
		$io_pdf->addText(620,100,8,"<b>OP1: </b>".$ls_numsop); 		
		$io_pdf->addText(620,90,8,"<b>FECHA CHEQUE_1: </b>".$ls_fecche);			
		$io_pdf->addText(620,80,8,"<b>CHEQUE_1: </b>".$ls_numche);
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	}
				...
				if($lb_valido)
				{
					...
					if($lb_valido)
					{
						...
						for($li_i=1;$li_i<=$li_total;$li_i++)
						{
						  ...
						  uf_print_sello($ls_numsop,$ls_fecsol,$ls_numche,$ls_fecche,$io_pdf);
						  unset($la_data);							 
