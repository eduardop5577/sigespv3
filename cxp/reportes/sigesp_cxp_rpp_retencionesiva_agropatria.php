...
***********************************************************************************/
	...
	function uf_print_encabezadopagina($as_titulo,$io_pdf)
	{
       ...
       // $io_pdf->Rectangle(150,540,800,40);	
		...
		$io_pdf->addText(50,514,10,'(LEY IVA-ART.11: "Seran responsables del pago del impuesto en calidad de agentes de retencion,');
		$io_pdf->addText(50,502,10,'los compradores o adquirientes de determinados bienes muebles y los receptores de ciertos servicios,');
		$io_pdf->addText(50,490,10,'a quienes la Administracion Tributaria designe como tal")'); // Agregar el titulo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
