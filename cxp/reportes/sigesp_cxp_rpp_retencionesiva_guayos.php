...
***********************************************************************************/
	...
	function uf_print_encabezadopagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(680,595,8,'Emitido el dia: '.date("d/m/Y")); // Agregar la Fecha
		$io_pdf->setStrokeColor(0,0,0);
		$io_pdf->addText(190,580,9,"Ley IVA - Art. 11 Seran responsables del pago del Impuesto en calidad de agente de retencion, los");
		$io_pdf->addText(190,570,9,"compradores o adquirientes de determinados bienes muebles y los receptores de ");
		$io_pdf->addText(190,560,9,"ciertos servicios, a quienes la Administracion Tributaria designe como tal.");
		$io_pdf->line(80,65,250,65);
		$io_pdf->addText(125,50,9,'Agente de Retencion'); // Agregar la Fecha
		
		$io_pdf->line(480,65,650,65);
		$io_pdf->addText(525,50,9,'Fecha de Entrega'); // Agregar la Fecha
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>720, // Orientación de la tabla
						 'width'=>150, // Ancho de la tabla						 
						 'maxWidth'=>150,
						 'yPos'=>250 ); // Ancho Minimo de la tabla
      //  $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);								 
		$io_pdf->Rectangle(660,483,110,30);	
		$io_pdf->addText(670,500,9,"<b>NRO COMPROBANTE</b>"); // Agregar el titulo
		$io_pdf->addText(670,485,9,$as_numcon); // Agregar el titulo								 
		$io_pdf->Rectangle(540,483,100,30);	
		$io_pdf->addText(555,502,9,"<b>PERIODO FISCAL</b>"); // Agregar el titulo	
		$io_pdf->addText(555,487,9,$as_perfiscal); // Agregar el titulo									 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'shaded'=>0, // Sombra entre lineas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xPos'=>185, // Orientacion de la tabla
		...
		unset($la_columna);
		unset($la_config);								 
		$io_pdf->Rectangle(340,483,170,30);	
		$io_pdf->addText(350,502,9,"<b>RIF DEL AGENTE DE RETENCION</b>"); // Agregar el titulo
		$io_pdf->addText(350,487,9,$as_rifagenteret); // Agregar el t�ulo									 
        //---------------------------------------------------------------------------------------------------
		$la_data[1]=array('titulo'=>'');
		$la_columna=array('titulo'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
		...
		unset($la_columna);
		unset($la_config);								
		$io_pdf->Rectangle(600,400,170,30);	
		$io_pdf->addText(605,415,9,"<b>RIF DEL SUJETO RETENIDO</b>"); // Agregar el titulo
		$io_pdf->addText(605,405,9,$as_rif); // Agregar el titulo									 
