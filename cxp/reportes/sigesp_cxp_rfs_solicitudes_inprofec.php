...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->line(15,133,585,133);		         // Horizontal Firmante Superior
		$io_pdf->addText(22,137,7,"DIR. DE GESTIÓN ADMINISTRATIVA");  // Agregar el título		
		$io_pdf->addText(50,80,7,"FIRMA Y SELLO");  // Agregar el título
		$io_pdf->line(147,75,147,145);		         // Vertical
		$io_pdf->addText(152,137,7,"DIR. DE PLANIFICACIÓN Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(185,80,7,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->line(299,75,299,145);              // Vertical
		$io_pdf->addText(335,137,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(325,80,7,"FIRMA Y SELLO"); // Agregar el título
		$io_pdf->line(435,75,435,145);		        // Vertical
		$io_pdf->addText(485,137,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(470,80,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(15,90,585,90);		        // Horizontal Firmante Inferior
	...
	function uf_print_cabecera($as_numsol,$as_codigo,$as_nombre,$as_denfuefin,$ad_fecemisol,$as_consol,$as_obssol,
							   $ai_monsol,$as_monto,$as_rifpro,$as_nomban,$as_ctaban,$as_correo,$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[1]=array('titulo'=>'<b> Beneficiario</b>','titulo1'=>'');
		$la_data[2]=array('titulo'=>"                  ".$as_codigo.' - '.$as_nombre,'titulo1'=>$as_rifpro);
		$la_columnas=array('titulo'=>'','titulo1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>500), // Justificación y ancho de la columna
						 			   'titulo1'=>array('justification'=>'left','width'=>70))); // Justificación y ancho de la columna
		...
		$la_data[1]=array('titulo'=>'<b> Banco:</b>'.$as_nomban.'             <b> Cuenta:</b>'.$as_ctaban.'             <b> Correo:</b>'.$as_correo);
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_detalle_spg($aa_data,$ai_totpre,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codestpro'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'denestpro3'=>array('justification'=>'center','width'=>170), // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>500), // Justificación y ancho de la columna
						 			   'totpre'=>array('justification'=>'right','width'=>70))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_datatot,$la_columnas,'',$la_config);
	}// end function uf_print_detalle
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_carded($la_datacar,$io_pdf)
	{
		...
		$la_datatit[1]=array('titulo'=>'<b> Cargos y Deducciones </b>');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[1]=array('codigo'=>'<b>Código</b>',
		                  'denominacion'=>'<b>Denominacion</b>',
						  'porded'=>'<b>Porcentaje</b>',
						  'monobjret'=>'<b>Base Imponible</b>',
						  'objret'=>'<b>Monto Retenido</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   ...
						 			   'porded'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'monobjret'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'objret'=>array('justification'=>'center','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_datatit);
		unset($la_columnas);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   ...
						 			   'monobjret'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'objret'=>array('justification'=>'center','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_datacar,$la_columnas,'',$la_config);
	}
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ls_correo=$io_report->DS->data["correo"][$li_i];
				...
				uf_print_cabecera($ls_numsol,$ls_codigo,$ls_nombre,$ls_denfuefin,$ld_fecemisol,$ls_consol,$ls_obssol,$li_monsol,$ls_monto,$ls_rifpro,$ls_nomban,
								  $ls_ctaban,$ls_correo,$io_pdf);
...
//////////////////////////   GRID DETALLE PRESUPUESTARIO		//////////////////////////////////////
						...
						if($lb_valido)
						{
							...
							for($li_s=1;$li_s<=$li_totrowspg;$li_s++)
							{
								...
								$ls_denestpro3=$io_report->ds_detalle_spg->data["denestpro3"][$li_s];
								...
								if($ls_estmodest==1)
								{
									$la_data[$li_s]=array('codestpro'=>$ls_codestpro1." - ".$ls_codestpro2." - ".$ls_codestpro3,'denestpro3'=>$ls_denestpro3,'spg_cuenta'=>$ls_spgcuenta,
														  'denominacion'=>$ls_denominacion,'monto'=>$li_monto);
								}
								else
								{
									$ls_titcuentas="Estructura Programatica";
									$la_data[$li_s]=array('codestpro'=>$ls_codestpro1." - ".$ls_codestpro2." - ".$ls_codestpro3." - ".$ls_codestpro4." - ".$ls_codestpro5,'denestpro3'=>$ls_denestpro3,'spg_cuenta'=>$ls_spgcuenta,
														  'denominacion'=>$ls_denominacion,'monto'=>$li_monto);
								}
							}	
...
//////////////////////////         GRID DETALLE CONTABLE	    //////////////////////////////////////
				...
				//-------------------------------DEDUCCIONES--------------------------------------
				$li_totdet=0;
				$lb_validoded = $io_report->uf_select_sol_deducciones($_SESSION["la_empresa"]["codemp"],$ls_numsol);
				if ($lb_validoded)
				   {
					 ...
					 {										
						   ...
						   $ld_porded   	  = $io_report->ds_ded_dt->data["porded"][$li_x];
						   ...
						   $ld_porded      = number_format($ld_porded,2,",",".");	
						   $la_datacar[$li_x] = array('codigo'=>$ls_codded,'denominacion'=>$ls_dended,
													 'porded'=>$ld_porded,'monobjret'=>$ld_monobjded,'objret'=>$ld_objretded);
					 }							  							   
