...
***********************************************************************************/
	...
	function uf_print_encabezadopagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(180,80,9,"CONTADOR"); // Agregar la Hora
		$io_pdf->addText(720,80,9,"ADMINISTRADOR"); // Agregar la Hora
		$io_pdf->setStrokeColor(0,0,0);
		$io_pdf->line(130,95,280,95);
		$io_pdf->line(680,95,830,95);
