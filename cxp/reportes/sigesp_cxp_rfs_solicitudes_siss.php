...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->line(120,60,120,130);		
		$io_pdf->line(220,60,220,130);		
		$io_pdf->line(418,60,418,130);		
		...
		$io_pdf->addText(130,68,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(287,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(266,73,7,"MARIA ALEJANDRA NOGUERA"); // Agregar el título
		$io_pdf->addText(222,63,7,"GERENTE GENERAL DE ADMIN., FINANZAS Y SERVICIOS"); // Agregar el título
		$io_pdf->addText(460,122,7,"CONTRALORIA INTERNA"); // Agregar el título
		$io_pdf->addText(453,73,7,"DR. JULIO CESAR ALVAREZ"); // Agregar el título
		$io_pdf->addText(458,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
