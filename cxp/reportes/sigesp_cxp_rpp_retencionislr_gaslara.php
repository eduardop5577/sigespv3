...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numdoc,$ld_fecemidoc,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],40,510,200,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(10,$as_titulo);
		//$io_pdf->rectangle(40,510,700,40);
		$io_pdf->addText(280,570,12,"<b> </b>");// Agregar el título
		$io_pdf->addText(600,120,9,"Beneficiario");// Agregar el título
		$io_pdf->addText(598,110,9,"Firma y Sello");// Agregar el título
		$io_pdf->addText(130,120,9,"Agente de Retencion");// Agregar el título
                $io_pdf->addText(150,110,9,"Firma y Sello");//
		$io_pdf->addText(280,525,14,"<b>COMPROBANTE DE RETENCION ISLR</b>");// Agregar el título
	...
	function uf_print_encabezado($as_agente,$as_nomproben,$as_rifproben,$as_nitproben,$as_condoc,$ld_fecemidoc,$ls_telemp,$ls_direccion,$io_pdf)
	{
		...
		$io_pdf->rectangle(600,510,100,40);
		  $io_pdf->addText(625,540,9,"<b>1. FECHA</b> ");
		  $io_pdf->addText(625,518,9,$ld_fecemidoc);
