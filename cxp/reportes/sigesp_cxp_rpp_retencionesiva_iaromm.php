...
***********************************************************************************/
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,$io_pdf)
	{
		...
		$io_pdf->addText(87,90,9,"<b>GERENTE DE ADMINISTRACION Y FINANZAS</b>"); // Agregar el titulo
		$io_pdf->addText(600,105,9,"<b>___________________________________________</b>"); // Agregar el titulo
		$io_pdf->addText(650,90,9,"<b>BENEFICIARIO</b>"); // Agregar el titulo*/
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[2]=array('f1'=>'_________________________________','f2'=>'','f3'=>'_________________________________');
		$la_data[3]=array('f1'=>'GERENTE DE ADMINISTRACION Y FINANZAS','f2'=>' ','f3'=>'BENEFICIARIO');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('f1'=>array('justification'=>'center','width'=>233), // Justificacion y ancho de la columna
   						 			   'f2'=>array('justification'=>'center','width'=>300),
	...
	if($lb_valido)
	{
		...
		else
		{
			...
			$io_pdf->ezSetCmMargins(3.5,3.5,3,3);
			$lb_valido=true;
