...
//		$io_pdf->addText(546,764,6,date("h:i a")); // Agregar la Hora
		...
		$io_pdf->line(127,75,127,160);		
		$io_pdf->line(250,75,250,160);		
		$io_pdf->line(400,75,400,160);		
		$io_pdf->line(510,75,510,160);		
		$io_pdf->addText(50,152,7,"REVISADO"); // Agregar el título
		$io_pdf->addText(32,88,7,"SUPER.GEST.ADMON"); // Agregar el título		
		...
		$io_pdf->addText(275,152,7,"REVISADO Y CONFORMADO"); // Agregar el título
		$io_pdf->addText(267,96,7,"SUPERINTEND.PRESUP.Y COSTOS/"); // Agregar el título
		$io_pdf->addText(275,86,7,"ANALISTA PRESUP.Y COSTOS/"); // Agregar el título
		$io_pdf->addText(255,76,7,"COORD.CONTROL DE GESTION Y PRESUP"); // Agregar el título		
		$io_pdf->addText(430,152,7,"CONFORMADO"); // Agregar el título
		$io_pdf->addText(410,93,7,"GERENTE CORP. ADMON."); // Agregar el título
		$io_pdf->addText(435,83,7,"Y FINANZAS"); // Agregar el título
		$io_pdf->addText(530,152,7,"APROBADO"); // Agregar el título
		$io_pdf->addText(525,88,7,"PRESIDENTE"); // Agregar el título
