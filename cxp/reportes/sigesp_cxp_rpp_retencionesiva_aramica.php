...
***********************************************************************************/
	...
	function uf_print_encabezadopagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(110,160,8,"Procesado Por"); 
		$io_pdf->addText(110,145,8,"<b>Gerencia de Administracion y</b>"); 
		$io_pdf->addText(110,130,8,"<b>Finanzas</b>"); 
		$io_pdf->addText(110,90,8,"Firma y Sello"); 
		$io_pdf->addText(690,160,8,"Recibido por:"); 
		$io_pdf->addText(690,145,8,"Nombre:______________________"); 
		$io_pdf->addText(690,125,8,"_____________________________"); 
		$io_pdf->addText(690,90,8,"Firma y Sello"); 
		$io_pdf->restoreState();
		$io_pdf->closeObject();
