...
***********************************************************************************/
							   ...
							   $as_nomsujret,$as_rif,$as_numlic,$ai_estcmpret,$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$la_data[1]=array('name'=>'<b>Agente de Retencion</b> '.$as_agenteret);		
		$la_data[2]=array('name'=>'<b>Direccion Agente de Retencion</b> '.$as_diragenteret);		
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
		...
		$io_pdf->addText(635,452,9,date("d/m/Y")); // Agregar la Fecha	
	...
	function uf_print_detalle($la_data,$ai_totbasimp,$ai_totmonimp,$ai_totmoniva,$as_rifagenteret,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('fecfac'=>array('justification'=>'center','width'=>70),
									   ...
									   'baseimp'=>array('justification'=>'center','width'=>100), // Justificacion y ancho de la columna
						 			   ...
						 			   'porimp'=>array('justification'=>'center','width'=>95),
									   'numsop'=>array('justification'=>'center','width'=>155))); 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'center','width'=>240), // Justificacion y ancho de la columna
									   ...
									   'orpag'=>array('justification'=>'right','width'=>250))); 
		$io_pdf->ezTable($la_data1,$la_columna,'',$la_config);
		unset($la_data1);
		unset($la_columna);
		unset($la_config);
