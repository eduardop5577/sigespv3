...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$ls_periodo,$ls_mes,$ls_ano,$io_pdf)
	{
		...
		$io_pdf->addText($tm,530,12,$ls_periodo); // Agregar el ttulo
                $io_pdf->addtext(390,580,20,"VIAS DE ARAGUA, S.A.");
                $io_pdf->addtext(450,570,10,"G-20010618-2");  
		$io_pdf->ezSetY(500);
	...
	function uf_print_cabecera($io_pdf)
	{
		...
		$la_columna=array('name1'=>'','name2'=>'','name3'=>'','name4'=>'','name5'=>'','name8'=>'','name9'=>'','name10'=>'','name11'=>'','name13'=>'','name14'=>'','name15'=>'','name16'=>'','name17'=>'','name18'=>'','name19'=>'');
		$la_config=array('showHeadings'=>0,     // Mostrar encabezados
