...
***********************************************************************************/
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezadopagina($as_titulo,$as_rifagenteret,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->line(400,100,600,100);
		$io_pdf->addText(410,90,8,"FIRMA Y SELLO DEL AGENTE DE RETENCION"); // Agregar el t�ulo				
		$io_pdf->addText(470,80,8,$as_rifagenteret); // Agregar el t�ulo				
		$io_pdf->restoreState();
		$io_pdf->closeObject();
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,$io_pdf)
	{
		...
		$io_pdf->Rectangle(45,480,240,50);		
		$io_pdf->addText(50,520,6,"LEY DEL IVA ART. 11: 'SERAN RESPONSABLES DEL IMPUESTO EN CALIDAD DE"); 
		$io_pdf->addText(50,510,6,"AGENTE    DE    RETENCION    LOS    COMPRADORES   O   ADQUIRIENTES    DE"); 
		$io_pdf->addText(50,500,6,"DETERMINADOS    BIENES    MUEBLES   Y   LOS   RECEPTORES   DE   CIERTOS"); 
		$io_pdf->addText(50,490,6,"SERVICIOS, A QUIENES LA ADMINISTRACION TRIBUTARIA DESIGNE COMO TAL."); 

		if($ai_estcmpret==2)
		{
		    $io_pdf->Rectangle(345,480,180,30);		
			$io_pdf->addText(390,490,15,"<b> ANULADO </b>"); 
		}	
	...
	if($lb_valido)
	{
		...
		else
		{
			...
			{
				uf_print_encabezadopagina($ls_titulo,$ls_rifagenteret,$io_pdf); 
