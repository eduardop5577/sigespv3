...
//		$io_pdf->addText(916,585,7,date("h:i a")); // Agregar la Hora
      ...
      //  $io_pdf->Rectangle(150,540,800,40);	
		...
		$io_pdf->addText(110,501,8,"Ley IVA - Art. 11 Seran responsables del pago del Impuesto en calidad de agente de retencion, los compradores o adquirientes de");
		$io_pdf->addText(130,493,8," determinados bienes muebles y los receptores de ciertos servicios, a quienes la Administracion Tributaria designe como tal");
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle($la_data,$ai_totconiva,$ai_totsiniva,$ai_totbasimp,$ai_totmonimp,$ai_totivaret,$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$la_data1[1]=array('firma'=>'Fecha:_______________________________________','firma2'=>'Recibido Por:_______________________________________');	
		$la_columna=array('firma'=>'','firma2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 9,  // Tamaño de Letras de los títulos
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
		$ls_titulo="COMPROBANTE DE RETENCION DE IVA";	
