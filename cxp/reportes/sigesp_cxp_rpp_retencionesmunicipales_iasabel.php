...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/banner_iasabel.jpg',40,540,500,40); // Agregar Logo
  ...
  //      $io_pdf->Rectangle(150,540,800,40);	
		$io_pdf->addText(150,528,10,"<b>".$as_titulo."</b>");			
		$io_pdf->addText(200,518,10,"RETENCION LEY DE TIMBRE FISCAL"); 			
							   ...
							   $as_nomsujret,$as_rif,$as_numlic,$ai_estcmpret,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>615, // Orientación de la tabla
						 'width'=>140, // Ancho de la tabla						 
						 'maxWidth'=>140,
						 'cols'=>array('name'=>array('justification'=>'center','width'=>120))); // Ancho Minimo de la tabla
