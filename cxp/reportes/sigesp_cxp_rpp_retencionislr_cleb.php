...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numdoc,$ld_fecemidoc,$as_perfiscal,$as_numsol,$io_pdf)
	{
		...
		$io_pdf->addText(430,535,9,"<b> No. Comprobante</b> ");
	...
	function uf_print_encabezado($as_agente,$as_nomproben,$as_rifproben,$io_pdf)
	{
		...
		global $io_pdf;
	      ...
	      $la_columna = array('ageret'=>' NOMBRE O RAZON SOCIAL DEL AGENTE DE RETENCION','rifageret'=>' REGISTRO DE INFORMACION FISCAL DEL AGENTE DE RETENCION');
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>185,
						 'cols'=>array('name'=>array('justification'=>'center','width'=>270)));  // Ancho Minimo de la tabla
		$io_pdf->ezTable($la_data1,$la_columna,'',$la_config);	
		unset($la_data1);
		unset($la_columna);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('numope'=>array('justification'=>'center','width'=>40), // Justificacion y ancho de la columna
