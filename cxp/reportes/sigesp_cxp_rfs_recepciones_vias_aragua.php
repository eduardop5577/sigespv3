...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprodoc,$io_pdf)
	{
		...
		$io_pdf->addText(215,122,7,"UNIDAD DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(227,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(410,122,7,"GERENCIA PLANIFICACION Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(445,63,7,"FIRMA / SELLO"); // Agregar el título
