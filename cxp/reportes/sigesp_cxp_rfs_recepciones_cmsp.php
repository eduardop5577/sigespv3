...
//		$io_pdf->line(380,60,380,130);		
		$io_pdf->addText(70,122,7,"ELABORADO"); // Agregar el título
		$io_pdf->addText(68,63,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(230,122,7,"REVISADO"); // Agregar el título
		$io_pdf->addText(227,63,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(420,122,7,"APROBADO Y AUTORIZADO"); // Agregar el título
		$io_pdf->addText(385,63,7,"DIRECCION DE ADMINISTRACION Y SERVICIOS"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
