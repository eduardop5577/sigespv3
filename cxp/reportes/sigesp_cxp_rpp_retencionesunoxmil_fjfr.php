...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(9,"COMPROBANTE DE RETENCION");
		$tm=396-($li_tm/2);
		/*$io_pdf->addText(27,570,9,"<b>REPUBLICA BOLIVARIANA DE VENEZUELA</b>"); // Agregar el título
		$io_pdf->addText(27,560,9,"<b>GOBERNACION DEL ESTADO LARA</b>"); // Agregar el título*/
		$io_pdf->addText(220,550,9,"<b>COMPROBANTE DE RETENCION DEL IMPUESTO DEL UNO POR MIL (1x1000)</b>"); // Agregar el título
		$io_pdf->addText(185,535,9,"Consagrado en el Articulo 9 de la Ordenanza de Timbre Fiscal del Distrito Metropolitano de Caracas"); // Agregar el título
							   ...
							   $as_nomsujret,$as_rif,$as_numlic,$ai_estcmpret,$as_conceptosp,$io_pdf)
	{
        ...
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->ezSetY(490);
		$la_data[1]=array('name'=>'<b>NOMBRE O RAZON SOCIAL DEL AGENTE DE RETENCIÓN</b>');
		...
		unset($la_config);								 
		$io_pdf->ezSetY(490);
		$la_data[1]=array('name'=>'<b>REGISTRO DE INFORMACION FISCAL DEL AGENTE DE RETENCION</b>');
		...
		$io_pdf->ezSetY(455);
		$la_data[1]=array('name'=>'<b>DIRECCION FISCAL DEL AGENTE DE RETENCIÓN</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>470, // Ancho de la tabla						 
						 'maxWidth'=>470,
						 'cols'=>array('name'=>array('justification'=>'left','width'=>470))); // Ancho Minimo de la tabla
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);	
		...
		$io_pdf->ezSetY(455);
		$la_data[1]=array('name'=>'<b>TELEFONO</b>');
		$la_data[2]=array('name'=>$as_rifagenteret);				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 ...
						 'maxWidth'=>150,
						 'cols'=>array('name'=>array('justification'=>'left','width'=>150))); // Ancho Minimo de la tabla
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
	...
	{						 
		...
		$io_pdf->ezSetDy(-20);
		$la_data4[1]=array('titulo'=>'<b>Por concepto de:</b>');
		$la_columna=array('titulo'=>'<b>Por concepto de:</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 ...
						 'width'=>150, // Ancho de la tabla
						 'maxWidth'=>150, // Ancho Mínimo de la tabla
						 'xPos'=>110, // Orientación de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>150))); 
		$io_pdf->ezTable($la_data4,$la_columna,'',$la_config);
		unset($la_data4);
		unset($la_columna);
		unset($la_config);
		$io_pdf->ezSetDy(-0.6);
		$la_data3[1]=array('titulo'=>'<b>Prestacion de Servicios:</b>',
						   'titulo2'=>'<b>Adquisicion de Bienes o suministros:</b>',
						   'titulo3'=>'<b>Ejecucion de Obras:</b>');
		$la_columna=array('titulo'=>'<b>Prestacion de Servicios:</b>',
						  'titulo2'=>'<b>Adquisicion de Bienes o suministros:</b>',
						  'titulo3'=>'<b>Ejecucion de Obras:</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>250),
									   'titulo2'=>array('justification'=>'left','width'=>240),
								       'titulo3'=>array('justification'=>'left','width'=>250))); 
		$io_pdf->ezTable($la_data3,$la_columna,'',$la_config);
		unset($la_data3);
		unset($la_columna);
		unset($la_config);
		$io_pdf->ezSetDy(-0.6);
		$la_data2[1]=array('titulo'=>'<b>Descripcion</b>');
		$la_columna=array('titulo'=>'<b>Descripcion</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 9,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
						 ...
						 'maxWidth'=>740, // Ancho Mínimo de la tabla
						 'xPos'=>405, // Orientación de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'center','width'=>740))); 
		$io_pdf->ezTable($la_data2,$la_columna,'',$la_config);
		unset($la_data2);
		unset($la_columna);
		unset($la_config);
		$io_pdf->ezSetDy(-0.6);
		//'baseimp'=>$li_baseimp,'porimp'=>$li_porimp,'ivaret'=>$li_totimp
		
		$la_data1[1]=array('numope'=>'<b>Oper. Nro.</b>',
		                   'fecfac'=>'<b>Fecha</b>',
						   'numfac'=>'<b>Numero de Factura</b>',
						   'numref'=>'<b>Num. Control Fac.</b>',
						   'totalconiva'=>'<b>Monto Bruto de la Operacion</b>',
						   'baseimp'=>'<b>Base Imponible</b>',
						   'porimp'=>'<b>Alicuota 1x100</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>740, // Ancho Mínimo de la tabla
						 'xPos'=>405, // Orientación de la tabla
						 'cols'=>array('numope'=>array('justification'=>'center','width'=>70),
						               'fecfac'=>array('justification'=>'center','width'=>70), // Justificacion y ancho de la columna
						 			   ...
						 			   'numref'=>array('justification'=>'center','width'=>90), // Justificacion y ancho de la columna
   						 			   'totalconiva'=>array('justification'=>'center','width'=>120),
									   'baseimp'=>array('justification'=>'center','width'=>120),
									   'porimp'=>array('justification'=>'center','width'=>90),
									   'ivaret'=>array('justification'=>'center','width'=>90))); 
		...
		$io_pdf->ezSetDy(-0.6);
		$la_datatotal[1]=array('numfac'=>"<b>TOTALES BS.</b>",'totalconiva'=>$ai_totbasimp,
							   'baseimp'=>$ai_totmonimp,'porimp'=>"",'ivaret'=>$ai_totmoniva);								  
		$la_columna=array('numfac'=>'',
						  'totalconiva'=>'',
						  'baseimp'=>'',
						  'porimp'=>'',
						  'ivaret'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>465, // Orientación de la tabla
						 'cols'=>array('numfac'=>array('justification'=>'left','width'=>200), // Justificacion y ancho de la columna
   						 			   'totalconiva'=>array('justification'=>'center','width'=>120),
									   'baseimp'=>array('justification'=>'center','width'=>120),
						 			   'porimp'=>array('justification'=>'center','width'=>90),
  						 			   'ivaret'=>array('justification'=>'center','width'=>90))); 
		//$io_pdf->ezSetDy(-15);
		$io_pdf->ezTable($la_datatotal,$la_columna,'',$la_config);
		unset($la_datatotal);
		unset($la_columna);
		unset($la_config);
		
		$io_pdf->ezSetY(240);
		$la_data[1]=array('name'=>'<b>Llenar solo en caso de pagos efectuados directamente en cuentas receptoras en Fondos Distritales:</b>');				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
		...
		$io_pdf->ezSetY(210);
		$la_data[1]=array('name'=>'<b>Banco:</b>');				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
						 ...
						 'width'=>330, // Ancho de la tabla						 
						 'maxWidth'=>330,
						 'cols'=>array('name'=>array('justification'=>'left','width'=>330))); // Ancho Minimo de la tabla
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);	
		...
		$io_pdf->ezSetY(210);
		$la_data[1]=array('name'=>'<b>Planilla Nro.</b>');			
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
						 'shaded'=>0, // Sombra entre lineas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xPos'=>590, // Orientación de la tabla
						 'width'=>330, // Ancho de la tabla						 
						 'maxWidth'=>330,
						 'cols'=>array('name'=>array('justification'=>'left','width'=>330))); // Ancho Minimo de la tabla
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$io_pdf->ezSetY(180);
		$la_data[1]=array('name'=>'<b>Monto Pagado Bs.</b>');				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
		...
		$io_pdf->ezSetY(125);
		$la_data[1]=array('firma'=>'_________________________________________________');	
		$la_data[2]=array('firma'=>'<b>Lcdo. Fren Sanchez</b>');
		$la_data[3]=array('firma'=>'<b>Agente de Retencion</b>');		
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>600,
						 'cols'=>array('firma'=>array('justification'=>'center','width'=>650))); // Ancho Minimo de la tabla
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
				...
				if($lb_valido)
				{
					...
					if($lb_valido)
					{
						...
						for($li_i=1;$li_i<=$li_total;$li_i++)
						{
							...
							$ls_totalconiva=$io_report->ds_detalle->data["totcmp_con_iva"][$li_i];								
							...
							$li_totalconiva=$li_totalconiva + $ls_totalconiva;
							...
							$li_porimp=number_format(($li_porimp/1000),4,",",".");				
							$li_totimp=number_format($li_totimp,2,",",".");	
							$ls_totalconiva=number_format($ls_totalconiva,2,",",".");								
							...
							$la_data[$li_i]=array('numope'=>$li_i,'fecfac'=>$ld_fecfac,'numfac'=>$ls_numfac,'numref'=>$ls_numref,
										          'totalconiva'=>$ls_totalconiva,'baseimp'=>$li_baseimp,'porimp'=>$li_porimp,'ivaret'=>$li_iva_ret);													
						  }																		 																						  
						  ...
						  uf_print_detalle($la_data,$li_totalconiva,$li_totalbaseimp,$li_totmontoiva,$ls_rifagenteret,$io_pdf);
