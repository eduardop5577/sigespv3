...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(275,122,7,"ADMINISTRACIÓN"); // Agregar el título
		$io_pdf->addText(277,63,7,"FIRMA / SELLO / FECHA "); // Agregar el título
		$io_pdf->addText(460,122,7,"PRESIDENTE"); // Agregar el título
