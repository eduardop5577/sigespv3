...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		// cuadro inferior
        $io_pdf->Rectangle(15,45,570,97);
		$li_tm=$io_pdf->getTextWidth(7,"FIRMAS AUTORIZADAS");
		$tm=285-($li_tm/2);
		$io_pdf->addText($tm,135,7,"FIRMAS AUTORIZADAS"); // Agregar el título
		$io_pdf->line(15,130,585,130);		
		$io_pdf->line(15,73,585,73);		//H
		$io_pdf->line(15,60,585,60);		
		...
		$io_pdf->addText(40,122,7,"ELABORADO POR"); 
		$io_pdf->addText(42,63,7,"FIRMA / SELLO"); 
		$io_pdf->addText(163,122,7,"CONTABILIDAD"); 
		$io_pdf->addText(160,63,7,"FIRMA / SELLO "); 
		$io_pdf->addText(249,122,7,"ADMINISTRACIÓN Y FINANZAS"); 
		$io_pdf->addText(275,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(375,122,7,"DIRECCION GENERAL"); // Agregar el título
		$io_pdf->addText(385,63,7,"FIRMA / SELLO "); // Agregar el título
		$io_pdf->addText(505,122,7,"PRESIDENTE"); // Agregar el título
		$io_pdf->addText(502,63,7,"FIRMA / SELLO "); // Agregar el título
		$io_pdf->addText(100,48,7,"AUDITORIA INTERNA                                                 FIRMA                                                           FECHA"); 
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezStartPageNumbers(570,37,7,'','',1); // Insertar el número de página
