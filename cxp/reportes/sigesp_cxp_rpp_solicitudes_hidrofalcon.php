...
***********************************************************************************/
	...
	function uf_print_detalle_solicitudes_actuales($la_data,$io_pdf)
	{
		...
		$la_columna = array('numsol'=>'<b>Documento</b>','consol'=>'<b>Concepto</b>','procedencia'=>'<b>Procedencia</b>','fecha'=>'<b>F. Emisión</b>','recepcion'=>'<b>Factura</b>','debe'=>'<b>Debe</b>','haber'=>'<b>Haber</b>','saldo'=>'<b>Saldo</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('numsol'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
									   ...
									   'recepcion'=>array('justification'=>'center','width'=>60),
			...
			if($lb_valido)
			{
				...
				if($lb_valido)
				{
					...
					while(!$io_report->rs_solicitudes->EOF)
					{
						...
						$ls_numrecaso=$io_report->uf_select_recepciones_relacionadas($ls_numsol);
						$la_datasol[$li_j]= array('numsol'=>$ls_numsol,'consol'=>$ls_consol,'procedencia'=>"Solicitud",'fecha'=>$ld_fecsol,'recepcion'=>$ls_numrecaso,'debe'=>"0,00",'haber'=>$ls_monto,'saldo'=>$ls_salsol);
