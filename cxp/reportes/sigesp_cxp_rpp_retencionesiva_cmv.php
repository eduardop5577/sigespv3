...
***********************************************************************************/
	...
	function uf_print_encabezadopagina($as_titulo,$io_pdf)
	{
		...
		$io_pdf->addText(270,555,13,"<b>".$as_titulo."</b>"); // Agregar el t�ulo				
		$io_pdf->restoreState();
		$io_pdf->closeObject();
					           ...
					           $as_numcon,$ad_fecrep,$ai_estcmpret,$io_pdf)
	{
		...
		$io_pdf->addText(850,500,9,"<b>FECHA DE EMISION</b>"); // Agregar el titulo
		...
		$io_ano=substr($as_perfiscal,0,4);
		$io_mes=substr($as_perfiscal,4,2);
		$io_pdf->addText(850,443,9,$io_ano." / ".$io_mes); // Agregar el titulo									 
