...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(9,"<b>COMPROBANTE DE RETENCION DEL IMPUESTO MUNICIPAL</b>");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,720,9,"<b>COMPROBANTE DE RETENCION DEL IMPUESTO MUNICIPAL</b>"); 
		$li_tm=$io_pdf->getTextWidth(9,"<b>ORDENANZA DE IMPUESTO SOBRE ACTIVIDAD ECONOMICA DE INDUSTRIAS, COMERCIO, SERVICIOS O DE INDOLES SIMILARES</b>");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,710,9,"<b>ORDENANZA DE IMPUESTO SOBRE ACTIVIDAD ECONOMICA DE INDUSTRIAS, COMERCIO, SERVICIOS O DE INDOLES SIMILARES</b>"); 
	...
	function uf_print_cabecera($as_numcon,$ad_fecrep,$as_agenteret,$as_rifagenteret,$as_perfiscal,$as_licagenteret,$as_diragenteret,
							   $as_nomsujret,$as_rif,$as_numlic,$ai_estcmpret,$ls_dirsujret,$ls_telpro,$ls_emailpro,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezadopagina
		//		   Access: private 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>140,
						 'cols'=>array('name'=>array('justification'=>'center','width'=>130))); // Ancho Minimo de la tabla
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);								 
		$io_pdf->ezSetY(705);
		$la_data[1]=array('name'=>'<b>FECHA  </b>'.date("d/m/Y"));
		$la_data[2]=array('name'=>'<b>PERÍODO FISCAL  </b>'.$as_perfiscal);				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'showLines'=>2, // Mostrar Lieas
						 'shaded'=>0, // Sombra entre lineas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xPos'=>530, // Orientación de la tabla
						 'width'=>90, // Ancho de la tabla						 
						 'maxWidth'=>90,
						 'cols'=>array('name'=>array('justification'=>'left','width'=>130))); // Ancho Minimo de la tabla
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->ezSetY(681);
		...
		unset($la_config);								 
		$io_pdf->ezSetY(681);
		$la_data[1]=array('name'=>'<b>CODIGO DE REGISTRO </b>');
		$la_data[2]=array('name'=>'R000000074');				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
		...
		$io_pdf->ezSetY(657);
		$as_diragenteret=substr($as_diragenteret,0,70);
		...
		unset($la_columna);
		unset($la_config);								 
		$ls_corele=$_SESSION["la_empresa"]["email"];

		$io_pdf->ezSetY(657);
		$la_data[1]=array('name'=>'<b>CORREO ELECTRONICO </b>');
		$la_data[2]=array('name'=>$ls_corele);				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
						 ...
						 'width'=>140, // Ancho de la tabla						 
						 'maxWidth'=>140,
						 'cols'=>array('name'=>array('justification'=>'center','width'=>150))); // Ancho Minimo de la tabla
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);								 
		...
		$la_data[2]=array('name'=>$ls_telemp);				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
						 'shaded'=>0, // Sombra entre lineas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'xPos'=>540, // Orientación de la tabla
						 'width'=>140, // Ancho de la tabla						 
						 'maxWidth'=>140,
						 'cols'=>array('name'=>array('justification'=>'center','width'=>110))); // Ancho Minimo de la tabla
        $io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);								 
		...
		unset($la_config);								 
		$io_pdf->ezSetY(625);
		$la_data[1]=array('name'=>'<b>LICENCIA </b>');
...
//////$ls_dirsujret,$ls_telpro,$ls_emailpro
		$io_pdf->ezSetY(601);
		$as_diragenteret=substr($as_diragenteret,0,70);
		$la_data[1]=array('name'=>'<b>DIRECCIÓN FISCAL DEL SUJETO RETENIDO</b>');
		$la_data[2]=array('name'=>$ls_dirsujret);				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
		...
		$io_pdf->ezSetY(601);
		$la_data[1]=array('name'=>'<b>CORREO ELECTRONICO </b>');
		$la_data[2]=array('name'=>$ls_emailpro);				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
		...
		$io_pdf->ezSetY(601);
		$la_data[1]=array('name'=>'<b>TELEFONO </b>');
		$la_data[2]=array('name'=>$ls_telpro);				
		$la_columna=array('name'=>'');		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Lieas
	...
	function uf_print_detalle($la_data,$ai_totbasimp,$ai_totmonimp,$as_rifagenteret,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>30), // Justificacion y ancho de la columna
									   'numsop'=>array('justification'=>'center','width'=>75),
						 			   'fecfac'=>array('justification'=>'center','width'=>65), // Justificacion y ancho de la columna
						 			   'numfac'=>array('justification'=>'center','width'=>70), // Justificacion y ancho de la columna
									   'numref'=>array('justification'=>'center','width'=>70), // Justificacion y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'center','width'=>110), // Justificacion y ancho de la columna
   						 			   ...
   						 			   'imponible'=>array('justification'=>'right','width'=>120))); 
		$io_pdf->ezTable($la_data1,$la_columna,'',$la_config);
		unset($la_data1);
		unset($la_columna);
		unset($la_config);
		$io_pdf->ezSetY(502);
		$la_data1[1]=array('firma'=>'_________________________________________________','firma1'=>'_________________________________________________');	
		$la_data1[2]=array('firma'=>'FIRMA Y SELLO ','firma1'=>'FIRMA Y SELLO ');	
		$la_columna=array('firma'=>'','firma1'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('firma'=>array('justification'=>'center','width'=>250),
						 			   'firma1'=>array('justification'=>'center','width'=>250))); 
		$io_pdf->ezTable($la_data1,$la_columna,'',$la_config);
		unset($la_data1);
		unset($la_columna);
		unset($la_config);
...
/*------------------------------------------------------------------------------------------------------------------------------------------------*/
	...
	function uf_print_encabezado_pagina2($as_titulo,$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(9,"<b>COMPROBANTE DE RETENCION DEL IMPUESTO MUNICIPAL</b>");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,320,9,"<b>COMPROBANTE DE RETENCION DEL IMPUESTO MUNICIPAL</b>"); 
		$li_tm=$io_pdf->getTextWidth(9,"<b>ORDENANZA DE IMPUESTO SOBRE ACTIVIDAD ECONOMICA DE INDUSTRIAS, COMERCIO, SERVICIOS O DE INDOLES SIMILARES</b>");
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,310,9,"<b>ORDENANZA DE IMPUESTO SOBRE ACTIVIDAD ECONOMICA DE INDUSTRIAS, COMERCIO, SERVICIOS O DE INDOLES SIMILARES</b>"); 
	}// end function uf_print_encabezadopagina
	//--------------------------------------------------------------------------------------------------------------------------------
...
//////$ls_dirsujret,$ls_telpro,$ls_emailpro
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle2($la_data,$ai_totbasimp,$ai_totmonimp,$as_rifagenteret,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_encabezadopagina
		//		   Access: private 
			...
			for ($li_z=0;($li_z<$li_totrow)&&($lb_valido);$li_z++)
			{
				...
				if($lb_valido)
				{
					...
					for($li_i=1;$li_i<=$li_total;$li_i++)
					{
						...
						$ls_emailpro=$io_report->DS->data["email"][$li_i];									
					}											
					uf_print_cabecera($ls_numcon,$ls_fecrep,$ls_agenteret,$ls_rifagenteret,$ls_perfiscal,$ls_licagenteret,
									  $ls_diragenteret,$ls_nomsujret,$ls_rif,$ls_numlic,$li_estcmpret,$ls_dirsujret,$ls_telpro,$ls_emailpro,$io_pdf);
					...
					if($lb_valido)
					{
						...
						for($li_i=1;$li_i<=$li_total;$li_i++)
						{
							...
							$la_data[$li_i]=array('numero'=>$li_i,'numsop'=>$ls_numsop, 'fecfac'=>$ld_fecfac,'numfac'=>$ls_numfac,
												  'numref'=>$ls_numref,'baseimp'=>$li_baseimp,'porimp'=>$li_porimp,'iva_ret'=>$li_totimp,'tipo'=>"SERVICIOS Y SIMILARES");														
						  }																		 																						  
					...
					uf_print_cabecera2($ls_numcon,$ls_fecrep,$ls_agenteret,$ls_rifagenteret,$ls_perfiscal,$ls_licagenteret,
									  $ls_diragenteret,$ls_nomsujret,$ls_rif,$ls_numlic,$li_estcmpret,$ls_dirsujret,$ls_telpro,$ls_emailpro,$io_pdf);
						  uf_print_detalle2($la_data,$li_totalbaseimp,$li_totalmontoimp,$ls_rifagenteret,$io_pdf);
						  unset($la_data);							 
					}
				}
