...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(145,73,7,"OFICINA DE PLANIF. PRESUP."); // Agregar el título
		$io_pdf->addText(150,63,7,"Y CONTROL DE GESTION"); // Agregar el título
		//$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(280,68,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(475,68,7,"PRESIDENCIA"); // Agregar el título
