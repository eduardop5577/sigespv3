...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->line(392,60,392,130);		
		$io_pdf->addText(40,122,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(30,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(136,122,7,"UNIDAD DE PRESUPUESTO Y FINANZAS"); // Agregar el título
		$io_pdf->addText(165,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(290,122,7,"UNIDAD DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(295,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(410,122,7,"GERENCIA DE ADMINISTRACION Y FINANZAS"); // Agregar el título
