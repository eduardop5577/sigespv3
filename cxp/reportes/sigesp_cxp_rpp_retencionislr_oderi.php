...
***********************************************************************************/
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado($as_agente,$as_nombre,$as_rif,$as_nit,$as_telefono,$as_direccion,$ls_email,$ls_emailagenteret,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[2]=array('name'=>'<b><i>Email Agente de Retención: </i></b>'."  ".$ls_emailagenteret);
		...
		$la_data[7]=array('name'=>'<b><i>Email: </i></b>'.$ls_email);
				...
				if($lb_valido)
				{
					...
					for($li_i=1;($li_i<=$li_total);$li_i++)
					{
						...
						if($ls_tipproben=="P")
						{
							...
							$ls_email=$io_report->DS->data["proemail"][$li_i];
						}
						else
						{
							...
							$ls_email=$io_report->DS->data["emailben"][$li_i];
						}						 
						...
						if($ls_codigo!=$ls_codigoant)
						{
							...
							uf_print_encabezado($ls_agente,$ls_nombre,$ls_rif,$ls_nit,$ls_telefono,$ls_direccion,$ls_email,$ls_emailagenteret,$io_pdf);
