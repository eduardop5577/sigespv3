...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->line(15,126,585,126);		
		$io_pdf->addText(255,128,8,"FIRMAS AUTORIZADAS"); // Agregar el título
		$io_pdf->line(15,113,585,113);		
		$io_pdf->addText(45,116,8,"ELABORADO Y REVISADO POR"); // Agregar el título
		$io_pdf->addText(275,116,8,"AUTORIZADO"); // Agregar el título
		$io_pdf->addText(465,116,8,"APROBADO"); // Agregar el título
		$io_pdf->line(15,73,585,73);		
		$io_pdf->line(205,60,205,126);		
		$io_pdf->line(395,60,395,126);		
		$io_pdf->addText(55,75,7,"LCDA. CARLA T. SUAREZ R."); // Agregar el título
		$io_pdf->addText(47,63,8,"CONTADOR Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(220,75,7,"ING. MARIA G. DE DE LOS R. VILLEGAS NAVAS"); // Agregar el título
		$io_pdf->addText(250,63,8,"DIR. DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(437,75,7,"LCDO. CESAR CATARI JIMENEZ"); // Agregar el título
		$io_pdf->addText(445,63,8,"DIR. FUNDACION LARA"); // Agregar el título
