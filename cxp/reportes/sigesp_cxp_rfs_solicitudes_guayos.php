...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addText(25,63,6,"GERENCIA DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(140,63,6,"GERENCIA DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(260,70,6,"DIRECCION DE ADMINISTRACIÓN Y "); // Agregar el título
		$io_pdf->addText(257,63,6,"PRESUPUESTO CONTROL Y GESTION"); // Agregar el título
		$io_pdf->addText(415,63,6,"DIRECCION DE ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
