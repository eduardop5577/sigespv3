...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		if ($as_estprosol=="N")
		{
			$io_pdf->addText(400,765,10,"<b>ANULADA SIN AFECTACION</b>"); // Agregar la Fecha
		}
        ...
        $io_pdf->Rectangle(15,60,570,75);
		$io_pdf->line(15,120,585,120);
		$io_pdf->line(15,75,585,75);
		$io_pdf->addText(40,125,8,'<b>ELABORADO POR: </b>');
		$io_pdf->addText(18,95,8,$_SESSION["la_apeusu"].", ".$_SESSION["la_nomusu"]);
		$io_pdf->addText(50,65,7,'<b>ANALISTA</b>');
		$io_pdf->line(150,60,150,135);				
		$io_pdf->addText(160,125,8,'<b>APROB Y CONTABILIZADO POR:</b>');
		$io_pdf->addText(180,65,7,'<b>UNID. DE CONTABILIDAD</b>');
		$io_pdf->line(300,60,300,135);
		$io_pdf->addText(330,125,8,'<b>VERIFICADO POR:</b>');
		$io_pdf->addText(310,65,7,'<b>PLANIFICACION Y PRESUPUESTO</b>');	
		$io_pdf->line(440,60,440,135);
		$io_pdf->addText(470,125,8,'<b>AUTORIZADO POR:</b>');
		$io_pdf->addText(460,65,7,'<b>ADMINISTRADOR FONDO NNA</b>');	
		$io_pdf->restoreState();
		$io_pdf->closeObject();
							   ...
							   $ai_monsol,$as_monto,$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_pdf;
		$la_data[1]=array('titulo'=>'<b> Beneficiario: </b>'.$as_nombre);
	...
	function uf_print_detalle_recepcion($la_data,$ai_totsubtot,$ai_tottot,$ai_totcar,$ai_totded,$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-2);
		$la_datatit[1]=array('numrecdoc'=>'<b>Factura/Documento</b>','fecemisol'=>'<b>Fecha</b>','subtotdoc'=>'<b>Monto</b>',
	...
	function uf_print_detalle_scg($aa_data,$ai_totdeb,$ai_tothab,$io_pdf)
	{
		...
		unset($la_config);
		$io_pdf->ezSetDy(-2);
		$la_data[1]=array('sc_cuenta'=>'<b>Cuenta</b>','denominacion'=>'<b>Denominación</b>','mondeb'=>'<b>Debe</b>',
						   'monhab'=>'<b>Haber</b>');
