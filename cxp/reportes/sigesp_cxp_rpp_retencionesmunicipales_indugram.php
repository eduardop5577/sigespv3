...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$io_pdf)
	{
		...
		$li_tm=$io_pdf->getTextWidth(9,"ARTICULO 5 ORDENANZA DE AGENTES DE RETENCION DEL IMPUESTO SOBRE ACTIVIDADES ECONOMICAS");
		$tm=396-($li_tm/2);
		$io_pdf->addText($tm,530,9,"ARTICULO 5 ORDENANZA DE AGENTES DE RETENCION DEL IMPUESTO SOBRE ACTIVIDADES ECONOMICAS"); // Agregar el título
	...
	function uf_print_detalle($la_data,$ai_totbasimp,$ai_totmonimp,$as_rifagenteret,$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
        $la_data1[1]=array('firma'=>'ARTICULO 5 "LOS AGENTES DE RETENCION ESTAN OBLIGADOS A RETENER EL IMPUESTO A LAS ACTIVIDADES ECONOMICAS DE INDUSTRIA, COMERCIO, SERVICIO O DE INDOLE SIMILAR, DERIVADOS DE LOS PAGOS EFECTUADOS A CONTRATISTAS, POR CONCEPTO DE LA EJECUCION DE OBRAS O DE PRESTACION DE SERVICIOS EN LA JURISDICCION DEL MUNICIPIO FALCON."');
		$la_columna=array('firma'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 9,  // Tamaño de Letras de los títulos
						 ...
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'width'=>200, // Ancho de la tabla
						 'maxWidth'=>770, // Ancho Mínimo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('firma'=>array('justification'=>'center','width'=>650))); 
		$io_pdf->ezTable($la_data1,$la_columna,'',$la_config);
		unset($la_data1);
		unset($la_columna);
		unset($la_config);
