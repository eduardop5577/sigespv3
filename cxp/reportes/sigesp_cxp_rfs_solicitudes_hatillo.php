...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_estprosol,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],20,708,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		if ($as_estprosol=="A")
		{
		...
		$io_pdf->addText($tm,720,11,$as_titulo); // Agregar el título
                $io_pdf->addText(150,760,9,"REPÚBLICA BOLIVARIANA DE VENEZUELA"); // Agregar el título
		$io_pdf->addText(150,750,9,"ALCALDIA EL HATTILLO"); // Agregar el título
		$io_pdf->addText(150,740,9,"DIRECCIÓN DE ADMINISTRACIÓN"); // Agregar el título
		...
		$io_pdf->line(285,60,285,130);		
		$io_pdf->line(414,60,414,130);		
		$io_pdf->addText(17,122,7,"COORDINACION DE TESORERIA"); // Agregar el título
		$io_pdf->addText(48,63,7,"FIRMA / SELLO"); // Agregar el título
		$io_pdf->addText(134,122,7,"COORDINACION DE ORDENACION DE PAGO"); // Agregar el título
		$io_pdf->addText(162,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(289,122,7,"COORDINACION DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(308,63,7,"FIRMA/ SELLO/ FECHA"); // Agregar el título
		$io_pdf->addText(420,122,7,"DIRECCION DE ADMINISTRACION Y FINANZAS"); // Agregar el título
...
//		$io_pdf->ezSetDy(-1);
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_totales($li_totsubtot,$li_tottot,$li_totcar,$li_totded)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detalle_cuentas
		//		   Access: private 
		...
		global $io_pdf;
		$io_pdf->ezSetDy(-5);
		$la_datatot[1]=array('titulo'=>'<b>Sub - Totales </b>','totpre'=>$li_totsubtot);
		$la_datatot[2]=array('titulo'=>'<b>Cargos </b>','totpre'=>$li_totcar);
		$la_datatot[3]=array('titulo'=>'<b>Deducciones </b>','totpre'=>$li_totded);
		$la_datatot[4]=array('titulo'=>'<b>Total a Pagar </b>','totpre'=>$li_tottot);
		$la_columnas=array('titulo'=>'<b>Factura</b>',
						   'totpre'=>'<b>Total</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 ...
						 'width'=>540, // Ancho de la tabla
						 'maxWidth'=>540, // Ancho Máximo de la tabla
						 'xPos'=>495, // Orientación de la tabla
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la columna
						 			   'totpre'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_datatot,$la_columnas,'',$la_config);
	}// end function uf_print_detalle
	//-----------------------------------------------------------------------------------------------------------------------------------
...
//////////////////////////         GRID DETALLE CONTABLE	    //////////////////////////////////////
		...
		uf_print_totales($li_totsubtot,$li_tottot,$li_totcar,$li_totded);
