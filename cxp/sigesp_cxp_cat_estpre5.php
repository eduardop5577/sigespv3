...
***********************************************************************************/
	...
	$ls_codestprog4=$io_fun_cxp->uf_obtenervalor_get_post("1","codestpro4","txtcodestpro4","");
	$ls_denestprog4=$io_fun_cxp->uf_obtenervalor_get_post("1","denestpro4","txtdenestpro4","");
...
function aceptar(codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,denestpro1,denestpro2,denestpro3,denestpro4,
				 denestpro5,estcla,estint,cuentaint)
{
	opener.document.formulario.estcla.value=estcla;
	opener.document.formulario.estint.value=estint;
	opener.document.formulario.cuentaint.value=cuentaint;
