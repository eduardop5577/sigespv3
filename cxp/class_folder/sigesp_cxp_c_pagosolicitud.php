...
class sigesp_cxp_c_pagosolicitud
 {
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	function uf_load_solicitudes($as_numsol,$ad_fecemides,$ad_fecemihas,$as_tipproben,$as_proben,$as_tipooperacion)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->PagoSolicitud MÉTODO->uf_load_solicitudes ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		return $rs_data;
