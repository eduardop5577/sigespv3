...
***********************************************************************************/
	...
	{	
		...
		$rs_datasol=$io_anulacion->uf_load_solicitudes($as_numsol,$ad_fecemides,$ad_fecemihas,$as_tipproben,$as_proben,$as_tipooperacion,$ls_repcon);
		$li_fila=0;
		if($rs_datasol!=false)
		{
			while($row=$io_anulacion->io_sql->fetch_row($rs_datasol))
			{
				...
				$arrResultado=$io_anulacion->uf_verificar_recepciones($ls_numsol,$lb_imprimir); 
