...
class sigesp_cxp_c_cmp_islr
{
	...
	public function __construct($as_path)
	{
		...
		{
			$arrResultado="";
			$arrResultado=$io_include->uf_obtener_parametros_conexion($as_path,$this->ls_basdatcmp,$as_hostname,$as_login,
	...
	function uf_procesar_comprobantes_islr($as_comprobantes,$as_procedencias,$aa_seguridad)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$la_procedencias=explode('<<<',$as_procedencias);
		$la_comprobantes=explode('<<<',$as_comprobantes);
