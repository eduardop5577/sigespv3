...
<table width="530" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <br>
    <table width="520" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        <td height="22"><div align="right">Recepcion</div></td>
        <td height="22"><div align="left">
          <input name="txtnumrecdoc" type="text" id="txtnumrecdoc">
        </div></td>
      </tr>
	  <tr>
...
function ue_search()
{
	...
	if((fecemides!="")&&(fecemihas!=""))
	{
		...
		ajax.send("catalogo=SOLICITUDPAGO&numsol="+numsol+"&fecemides="+fecemides+"&fecemihas="+fecemihas+"&consol="+consol+
				  "&tipdes="+tipdes+"&codproben="+codproben+"&tipo="+tipo+"&orden="+orden+"&campoorden="+campoorden+"&repcajchi="+repcajchi+"&numrecdoc="+numrecdoc);
	}
	else
	{
