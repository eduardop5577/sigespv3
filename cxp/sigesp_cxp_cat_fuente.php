...
function ue_search()
{
	...
	if(tipo!="SOLPAG")
	{
		estcla=opener.document.formulario.hidestcla.value;
	...
	ajax.send("catalogo=FUENTEFINANCIAMIENTO&tipo="+tipo+"&orden="+orden+"&campoorden="+campoorden+"&codestpro1="+codestpro1+
