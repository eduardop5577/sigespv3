...
***********************************************************************************/
	...
	$arrResultado=$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_ubicacion_recepciondocumento.php",$ls_permisos,$la_seguridad,$la_permisos);
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/sigesp_cxp_rpp_ubicacionrecepciones.php?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+
						 ...
						 "&anulada="+anulada+"&orden="+orden+"&numrecdoc="+numrecdoc+"&numexprel="+numexprel+"";
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_cxp_rep_ubi_recepciondocumento.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}	
