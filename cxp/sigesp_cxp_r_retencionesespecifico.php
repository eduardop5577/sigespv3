...
***********************************************************************************/
	...
	$la_seguridad=array();
	$la_permisos=array();
	$arrResultado=$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_retencionesespecifico.php",$ls_permisos,$la_seguridad,$la_permisos);
...
function ue_print()
{
	...
	if(li_imprimir==1)
	{
		...
		if((fecdes!="")&&(fechas!=""))
		{
			...
			pagina="reportes/"+formato+"?tipproben="+tipproben+"&codprobendes="+codprobendes+"&tipper="+tipper+"&tipded="+tipded+"&codded="+codded+"&tiporeporte="+tiporeporte;
			pagina=pagina+"&codprobenhas="+codprobenhas+"&fecdes="+fecdes+"&fechas="+fechas;
...
function ue_ayuda()
{
	...
	window.open("ayudas/sigesp_ayu_cxp_rep_retencionesespecifico.pdf","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
</script>
</html>