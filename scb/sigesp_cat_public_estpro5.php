...
if ($ls_operacion=="BUSCAR")
   {
	 ...
	 $ls_sql=" SELECT codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,denestpro5, estcla ".
             ...
             "  WHERE codemp='".$la_empresa["codemp"]."'
				  ...
				  AND denestpro5 like '%".$ls_denestpro5."%'
				  AND estcla = '".$ls_estcla."'
				  AND codestpro5<>'-------------------------'
			    ORDER BY codestpro1, codestpro2, codestpro3, codestpro4, codestpro5 ASC";
	 ...
	 if ($rs_data===false)
	 ...
	 else
	    {
	      ...
	      if ($li_numrows>0)
		     {
			   $ls_denestcla = $_SESSION["la_empresa"]["nomestpro5"];
			   while ($row=$io_sql->fetch_row($rs_data))
			         {
					   ...
					   print "<td width=130 style=text-align:left title='".$ls_denestpro5."'>".$ls_denestpro5."</td>";
