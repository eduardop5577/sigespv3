	...
	function uf_procesar_eliminacion($ls_numdoc,$ls_codban,$ls_ctaban,$ls_codope,$ls_provbene,$ls_tipo,$ls_estprosol,$ls_estprogpago,$ls_numcarta)
	{
		...
		else
		{
			if($row=$this->SQL->fetch_row($rs_solbanco))
			{
				...
				{
					$ls_sql="DELETE FROM scb_movbco_spg WHERE codemp='".$ls_codemp."' AND codban='".$ls_codban."' AND ctaban='".$ls_ctaban."' AND codope='ND' AND numdoc='".$ls_numdoc."' ";
				...
				{
					$ls_sql="DELETE FROM scb_movbco_scg WHERE codemp='".$ls_codemp."' AND codban='".$ls_codban."' AND ctaban='".$ls_ctaban."' AND codope='ND' AND numdoc='".$ls_numdoc."' ";
				...
				if($lb_valido)//Eliminacion de lo detalles de contabilidad
				{
					$ls_sql="DELETE FROM scb_movbco_spi WHERE codemp='".$ls_codemp."' AND codban='".$ls_codban."' AND ctaban='".$ls_ctaban."' AND codope='ND' AND numdoc='".$ls_numdoc."' ";
