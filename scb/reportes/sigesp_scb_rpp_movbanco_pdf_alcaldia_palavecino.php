...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$ls_numdoc,$io_pdf)
	{
		...
		$io_pdf->Rectangle(15,530,570,145);
        	$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);		
		$io_pdf->Rectangle(11,43,580,160);
		$io_pdf->line(11,110,590,110);
                $io_pdf->line(11,178,590,178);
		$io_pdf->line(11,95,590,95);		
		$io_pdf->line(200,110,200,204);
		///$io_pdf->line(300,110,300,204);
		$io_pdf->line(400,110,400,204);
		////$io_pdf->line(475,90,475,148);		
		$io_pdf->line(191,43,191,95);
		$io_pdf->line(310.5,43,310.5,95);
		$io_pdf->line(411,43,411,95);	
		
		$io_pdf->addText(20,184.6,9,'<b>Realizado y Elaborado por:</b>');
		$io_pdf->addText(230,184.6,9,'<b>Direccion de Administracion:</b>');		
		$io_pdf->addText(480,184.6,10,'<b>Alcalde:</b>');		
		$io_pdf->addText(258,100,10,'<b>Recibí Conforme</b>');
		
		$io_pdf->addText(16,82,10,'<b>Nombre:</b>');		
		$io_pdf->addText(196,82,10,'<b>Cédula de Identidad:</b>');		
		$io_pdf->addText(316,82,10,'<b>Fecha:</b>');
		$io_pdf->addText(416,82,10,'<b>Firma:</b>');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
		return $io_pdf;
