...
***********************************************************************************/
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// modificacion realizada por: José gregorio Vera Duarte.
		//                              TSU. Informática.
		//								coordinador INTT. 
		//								FECHA 19/09/2014.
		...
		$io_pdf->line(191,90,191,158); //Vertical
		$io_pdf->line(411,90,411,158); //Vertical
		...
		$io_pdf->addText(66,147.6,8,'<b>ELABORADO</b>'); //$io_pdf->addText(36,147.6,8,'<b>ELABORADO</b>');
		$io_pdf->addText(278,147.6,8,'<b>REVISADO</b>'); //$io_pdf->addText(172,147.6,8,'<b>REVISADO</b>');
		...
		$io_pdf->addText(439,147.6,8,'<b>DIRECCIÓN DE GESTIÓN</b>');  //$io_pdf->addText(449,147.6,8,'<b>DIRECCIÓN DE GESTIÓN</b>');
		$io_pdf->addText(454,137,8,'<b>ADMINISTRATIVA</b>');	//$io_pdf->addText(464,137,8,'<b>ADMINISTRATIVA</b>');	
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					$io_pdf=uf_print_encabezado_pagina_cheque(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
					$io_pdf=uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$ls_nomban,$ls_ctaban,$ls_numdoc,$io_pdf); // Imprimimos el encabezado de la página
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$ls_monto= $numalet->letra();
			$io_pdf=uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$ls_nomban,$ls_ctaban,$ls_numdoc,$io_pdf); // Imprimimos el encabezado de la página
			$io_pdf=uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_tipodestino,$ls_cedula,$io_pdf); // Imprimimos la cabecera del registro
