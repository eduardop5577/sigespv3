...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_numdoc,$as_fecha,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],80,690,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
	...
	if(!array_key_exists("opener",$_GET))
	{
		...
		$la_campo["fecha"]=$_SESSION["la_empresa"]["ciuemp"].", ".substr($ls_fecha_corta,0,2)." de ".$ls_mes." de ".substr($ls_fecha_corta,6,4)."" ;
