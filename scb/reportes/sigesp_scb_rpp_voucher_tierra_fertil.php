...
***********************************************************************************/
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->addText(18,115,8,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]); // Agregar el título
		$io_pdf->addText(16,147,9,'<b>Elaborado por:</b>');
		$io_pdf->addText(132,147,9,'<b>Revisado por:</b>');
		$io_pdf->addText(273,147,9,'<b>Presupuesto</b>');		
		$io_pdf->addText(384,147,9,'<b>Administración</b>');		
		$io_pdf->addText(497,147,9,'<b>Gerencia General</b>');
	...
	if ($ls_tipimp=='lote')
	{
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
			...
			if ((trim($ls_codban)=="001")||(trim($ls_codban)=="008")||(trim($ls_codban)=="009")||(trim($ls_codban)=="010")||(trim($ls_codban)=="011")||(trim($ls_codban)=="012")||(trim($ls_codban)=="013")||(trim($ls_codban)=="014")||(trim($ls_codban)=="015")||(trim($ls_codban)=="016"))//Banco Industrial de Vzla.
			   {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		$thisPageNum=$io_pdf->ezPageCount;
		$io_pdf->ezStartPageNumbers(570,30,10,'','',1); // Insertar el número de página
		if (trim($ls_codban)=="001")//Banco Agricola.
		   {
		...
		elseif((trim($ls_codban)=="003")||(trim($ls_codban)=="004"))//Banco de Vzla.
		   {
			 $ls_archivo   = "cheque_configurable/medidas_venezuela.txt";
			 $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
			 $li_medidas   = 22;
