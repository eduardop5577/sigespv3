...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$io_pdf)
	{
		...
		//$ls_fecha_corta=substr($ls_fecha,0,(strlen($ls_fecha)));	
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'cols'=>array('banco'=>array('justification'=>'left','width'=>135),'cheque'=>array('justification'=>'left','width'=>75),
						 'cuenta'=>array('justification'=>'left','width'=>135),'voucher'=>array('justification'=>'left','width'=>135))); // Ancho Máximo de la tabla
	...
	function uf_print_detalle($la_title,$la_data,$io_pdf)
	{
		...
		$io_pdf->set_margenes(50,137,0,0);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>280),'title2'=>array('justification'=>'center','width'=>200))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>155),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>55),
						 			   ...
						 			   'debe'=>array('justification'=>'right','width'=>50), // Justificación y ancho de la columna
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);		
		$io_pdf->Rectangle(61,283,480,105);
		$io_pdf->line(61,330,540,330);
		$io_pdf->line(61,314.6,540,314.6);		
		$io_pdf->line(205,330,205,388);
		$io_pdf->line(410,330,410,388);
		$io_pdf->line(191,283,191,315);
		$io_pdf->line(310.5,283,310.5,315);
		$io_pdf->line(411,283,411,315);	
		
		$io_pdf->addText(70,377.6,9,'<b>Elaborado por:</b>');
		$io_pdf->addText(280,377.6,9,'<b>Revisado por:</b>');
		$io_pdf->addText(440,377.6,9,'<b>Administración</b>');		
		$io_pdf->addText(258,318.85,10,'<b>Recibí Conforme</b>');
		
		$io_pdf->addText(66,303.27,10,'<b>Nombre:</b>');		
		$io_pdf->addText(196,303.27,10,'<b>Cédula de Identidad:</b>');		
		$io_pdf->addText(316,303.27,10,'<b>Fecha:</b>');
		$io_pdf->addText(416,303.27,10,'<b>Firma:</b>');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		$thisPageNum=$io_pdf->ezPageCount;
		$io_pdf->ezStartPageNumbers(570,30,10,'','',1); // Insertar el número de página
		if (trim($ls_codban)=="001")//Banco Bicentenario.
		   {
		...
		elseif(trim($ls_codban)=="004")//Banco Industrial de Vzla.
		   {
			 $ls_archivo   = "cheque_configurable/medidas_industrial.txt";
			 $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
			 $li_medidas   = 22;
		   }
		elseif(trim($ls_codban)=="005")//Banco Banesco.
		   {
			 $ls_archivo	= "cheque_configurable/medidas_banesco.txt";
			 $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
			 $li_medidas   = 16;
		   }
		elseif(trim($ls_codban)=="006")//Banco Mercantil.
		   {
		...
		elseif(trim($ls_codban)=="007")//Banco Provincial.
		   {
			 $ls_archivo   = "cheque_configurable/medidas_provincial.txt";
			 $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
			 $li_medidas   = 22;
		   }
		elseif(trim($ls_codban)=="008")//Corp. Banca.
		   {
