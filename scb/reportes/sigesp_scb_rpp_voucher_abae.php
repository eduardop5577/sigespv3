	...
	if ($ls_tipimp=='lote')
	{
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
			...
			if ((trim($ls_codban)=="001")||(trim($ls_codban)=="008")||(trim($ls_codban)=="009")||(trim($ls_codban)=="010")||(trim($ls_codban)=="011")||(trim($ls_codban)=="012")||(trim($ls_codban)=="013")||(trim($ls_codban)=="014")||(trim($ls_codban)=="015")||(trim($ls_codban)=="016")||(trim($ls_codban)=="019")||(trim($ls_codban)=="020")||(trim($ls_codban)=="021")||(trim($ls_codban)=="022")||(trim($ls_codban)=="023"))//Banco Industrial de Vzla.
			   {
