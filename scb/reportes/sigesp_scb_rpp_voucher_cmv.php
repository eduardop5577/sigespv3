...
***********************************************************************************/
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_monto,$ls_fechas,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(365,100,9,$ls_numdoc); // Agregar el título
		$io_pdf->addText(515,100,9,date("d/m/Y")); // Agregar el título
		$io_pdf->addText(195,89,9,$ls_ctaban); // Agregar el título
		$io_pdf->addText(400,89,9,$ls_nomban); // Agregar el título 
		$io_pdf->addText(480,400,7,$ls_chevau); // Agregar el título 
		$io_pdf->ezSetDy(-150);
		$la_data[1]=array('name'=>'','name2'=>'','name3'=>'','name4'=>'');
		$la_data[2]=array('name'=>'','name2'=>$ls_solicitudes,'name3'=>'','name4'=>$ls_fechas);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 //'height'=>250,
						 'maxWidth'=>50,
						 'cols'=>array('name'=>array('justification'=>'left','width'=>110),
						               'name2'=>array('justification'=>'left','width'=>110),
									   'name3'=>array('justification'=>'left','width'=>105),
									   'name4'=>array('justification'=>'left','width'=>175),)); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		$la_data[1]=array('name'=>'','name2'=>'');
		$la_data[2]=array('name'=>'','name2'=>$ls_nomproben);
		$la_data[3]=array('name'=>'','name2'=>'');
		$la_data[4]=array('name'=>'','name2'=>'');
		$la_data[5]=array('name'=>'','name2'=>'');
		$la_data[6]=array('name'=>'','name2'=>$ls_monto);
		$la_data[7]=array('name'=>'','name2'=>'');
		$la_data[8]=array('name'=>'','name2'=>'');
		$la_data[9]=array('name'=>'','name2'=>$ls_conmov);
		$la_data[10]=array('name'=>'','name2'=>'');
		$la_data[11]=array('name'=>'','name2'=>'');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 //'height'=>250,
						 'maxWidth'=>50,
						 'cols'=>array('name'=>array('justification'=>'left','width'=>115),
						               'name2'=>array('justification'=>'left','width'=>425))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_detalle($la_title,$la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('scg_cuenta'=>array('justification'=>'center','width'=>90),
			 						   'den_scg'=>array('justification'=>'left','width'=>270),
						 			   'debe'=>array('justification'=>'center','width'=>110), // Justificación y ancho de la columna
						 			   'haber'=>array('justification'=>'left','width'=>110))); // Justificación y ancho de la columna
	...
	function uf_print_detalle_presupuestario($la_title,$la_data,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detalle
		//		    Acess: private 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>500))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data_title,$la_columna,'',$la_config);	
		//Imprimo los detalles tanto `de presupuesto como contablwe del movimiento
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('estructura'=>array('justification'=>'center','width'=>80),
			 						   'spg_cuenta'=>array('justification'=>'center','width'=>80),
									   'den_spg'=>array('justification'=>'left','width'=>200),
						 			   'monto'=>array('justification'=>'center','width'=>90))); // Justificación y ancho de la columna
		$la_columnas=array('estructura'=>'ESTRUCTURA',
						   'spg_cuenta'=>'CUENTA ',
						   'den_spg'=>'DESCRIPCIÓN',
						   'monto'=>'MONTO');
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					$ls_cadena      = $class_report->uf_select_solicitudes_completa($ls_numdoc,$ls_codban,$ls_ctaban);
					$ls_arreglo     = explode('@',$ls_cadena);
					$ls_solicitudes = $ls_arreglo[0];
					$ls_fechas      = $ls_arreglo[1];
					...
					uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_monto,$ls_fechas,$io_pdf); // Imprimimos la cabecera del registro
					...
					uf_print_detalle_presupuestario(array('title'=>'DETALLE PRESUPUESTARIO'),$la_data_pres,$io_pdf);
