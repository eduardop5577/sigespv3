...
***********************************************************************************/
	...
	if ($ls_conchk==1)
	{
		...
		for($li_p=0;$li_p<$li_total;$li_p++)
		{
			...
			$rs_data   = $io_report->uf_cargar_documentos_ch_co($ls_codope,$ld_fecdesde,$ld_fechasta,$ls_codban,$ls_ctaban,$ls_codconcep,$ls_estmov,$ls_orden,$ls_documento,$ls_conchk);
			//---------------------------------------------------------------------------------------------------------------------------
