...
***********************************************************************************/
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->addText(170,33,11,"''Cumplace con las disposiciones legales vigentes''"); // Agregar el título			
		$io_pdf->addText(24,137.6,9,'<b>ELABORADO POR:</b>');
		$io_pdf->addText(42,98,6,"Cecili Cervantes"); // Agregar el título
		$io_pdf->addText(145,137.6,9,'<b>REVISADO POR:</b>');
		$io_pdf->addText(160,98,6,"Dany Sanchez"); // Agregar el título
		$io_pdf->addText(263,137.6,9,'<b>APROBADO POR:</b>');		
		$io_pdf->addText(284,98,7,"Sandra Moreno"); // Agregar el título
		$io_pdf->addText(265,90,9,'<b>ADMINISTRACION</b>');	
		$io_pdf->addText(370,137.6,9,'<b>GERENCIA GENERAL</b>');
		$io_pdf->addText(398,98,6,""); // Agregar el título		
		$io_pdf->addText(498,137.6,9,'<b>PRESIDENCIA</b>');
		$io_pdf->addText(508,98,6,"Juan Carlos Santander"); // Agregar el título
