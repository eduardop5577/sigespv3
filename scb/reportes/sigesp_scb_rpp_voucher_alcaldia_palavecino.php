...
***********************************************************************************/
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);		
		$io_pdf->Rectangle(11,30,580,140);
		$io_pdf->line(11,100,590,100);
              $io_pdf->line(11,158,590,158);
		$io_pdf->line(11,89,590,89);		
		$io_pdf->line(200,100,200,170);
		$io_pdf->line(400,100,400,170);
		$io_pdf->line(191,31,191,89);
		$io_pdf->line(310.5,31,310.5,89);
		$io_pdf->line(411,31,411,89);	
		
		$io_pdf->addText(20,160,9,'<b>Realizado y Elaborado por:</b>');
		$io_pdf->addText(230,160,9,'<b>Direccion de Administracion:</b>');		
		$io_pdf->addText(480,160,10,'<b>Alcalde:</b>');		
		$io_pdf->addText(258,90,9,'<b>Recibí Conforme</b>');
		
		$io_pdf->addText(16,75,10,'<b>Nombre:</b>');		
		$io_pdf->addText(196,75,10,'<b>Cédula de Identidad:</b>');		
		$io_pdf->addText(316,75,10,'<b>Fecha:</b>');
		$io_pdf->addText(416,75,10,'<b>Firma:</b>');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		$io_pdf->transaction('start'); // Iniciamos la transacción
		$thisPageNum=$io_pdf->ezPageCount;
		$io_pdf->ezStartPageNumbers(570,05,10,'','',1); // Insertar el número de página
		$io_pdf=uf_print_autorizacion($io_pdf);	
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			unset($la_data);
