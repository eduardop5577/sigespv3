...
***********************************************************************************/
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$io_pdf)
	{
		...
		$io_pdf->addText(420,490,7,$ls_chevau);
		
		$ls_concepto_cortado=wordwrap($ls_conmov,70,"?");
		$la_arregloc=array();
		$la_arregloc=explode("?",$ls_concepto_cortado);
		if(array_key_exists(0,$la_arregloc))
			$io_pdf->addText(20,506,7,"$la_arregloc[0]");
		if(array_key_exists(1,$la_arregloc))
			$io_pdf->addText(20,498,7,"$la_arregloc[1]");
		
		$io_pdf->addText(70,312,7,$ls_numdoc);
		$io_pdf->addText(170,312,7,$ls_nomban);
		$io_pdf->addText(17,280,7,$ls_solicitudes);
		$io_pdf->addText(97,280,7,$ls_ctaban);
		return $io_pdf;	
	...
	function uf_print_detalle($la_title,$la_data,$io_pdf)
	{
		...
		$io_pdf->set_margenes(90,125,0,0);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>230),'title2'=>array('justification'=>'center','width'=>230))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'xPos'=>250, // Orientación de la tabla
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>75),
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->addText(290,137.6,9,'<b>Adm. y Fzas.</b>');		
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		$thisPageNum=$io_pdf->ezPageCount;
		//$io_pdf->ezStartPageNumbers(570,30,10,'','',1); // Insertar el número de página
		if (trim($ls_codban)=="001")//Banco de Vzla.
		   {
			  $ls_archivo   = "cheque_configurable/medidas_venezuela.txt";
			  $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
			  $li_medidas   = 22;
		   }
		elseif(trim($ls_codban)=="002")//Banco Industrial de Vzla.
		   {
			 $ls_archivo   = "cheque_configurable/medidas_industrial.txt";
			 $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00-10.00-91.00-8.00-100.00-12.00-117.00";
			 $li_medidas   = 22;
