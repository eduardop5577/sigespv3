...
***********************************************************************************/
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_monto,$ld_total,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(10,540,8,'<b>Banco: '.$ls_nomban.'</b>');
		$io_pdf->addText(220,540,8,'<b>N° Cuenta: '.$ls_ctaban.'</b>');
		$io_pdf->addText(400,540,8,'<b>Voucher N°: '.$ls_chevau.'</b>');
		$io_pdf->addText(280,525,8,'<b>Beneficiario: '.$ls_nomproben.'</b>');
		$io_pdf->addText(360,505,8,'<b>N° Cheque: '.$ls_numdoc.'</b>');
		$io_pdf->addText(500,505,8,'<b>Monto: '.$ld_total.'</b>');
		$as_concepto = $io_pdf->addTextWrap(20,470,550,8,$ls_conmov);
		$as_concepto = $io_pdf->addTextWrap(20,460,550,8,$as_concepto);
		$io_pdf->addText(20,290,8,'<b>Son: '.$ls_monto.'</b>');
		return $io_pdf;		
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);		
		$io_pdf->Rectangle(11,180,305,105);
		$io_pdf->Rectangle(320,180,280,105);
		$io_pdf->line(11,265,315,265);
		$io_pdf->line(320,265,600,265);
		$io_pdf->line(320,230,600,230);
		$io_pdf->line(320,205,600,205);
		$io_pdf->line(110,180,110,285);
		$io_pdf->line(210,180,210,285);
		$io_pdf->addText(16,270,9,'<b>Elaborado Por:</b>');
		$io_pdf->addText(132,270,9,'<b>Revisado Por:</b>');
		$io_pdf->addText(230,270,9,'<b>Aprobado Por:</b>');
		$io_pdf->addText(325,270,9,'<b>RECIBI CONFORME:</b>');
		$io_pdf->addText(325,215,9,'<b>Nombre:</b>');
		$io_pdf->addText(325,185,9,'<b>Fecha:</b>');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$ls_monto= $numalet->letra();
			$io_pdf=uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
			$io_pdf=uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_monto,number_format($ldec_total,2,",","."),$io_pdf); // Imprimimos la cabecera del registro
