...
***********************************************************************************/
	...
	$io_pdf->selectFont('../../base/librerias/php/ezpdf/fonts/Times-Roman.afm');
	...
	//------------------------------------------------//
for($li_k=0;$li_k<count((array)$la_comprobantes);$li_k++)
{
...
//-------------------------Fila 2---------------------------//
 ...
 $la_opciones = array("color_texto" => array(0,0,0),
  ...
  //--------------------------------Detalle de la Tabla----------------------------------------//
 $li_totalfilas=floor((count((array)$la_datacomprobantes, COUNT_RECURSIVE) / count((array)$la_datacomprobantes)) - 1);
 $li_pos=$io_pdf->y-2;
 $io_pdf->ezSetY($li_pos);
 $la_data=array();
 $la_anchos_col="";
...
//--------------------------Agregar Totales-------------------------------//
 ...
 $la_opciones = array("color_texto" => array(0,0,0),
  ...
  if(($li_k+1)<count((array)$la_comprobantes))
  {
  		$io_pdf->ezNewPage();
  }
 }
