...
***********************************************************************************/
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->line(200,90,200,148);
		$io_pdf->line(390,90,390,148);
		...
		$io_pdf->addText(210,137.6,9,'<b>Revisado por:</b>');
		$io_pdf->addText(400,137.6,9,'<b>Administracion:</b>');
...
$ls_tipimp = "";
	...
	if ($ls_tipimp=='lote')
	{
		...
		$ls_operaciones = $_GET["operaciones"];
			...
			elseif(trim($ls_codban)=="020")//Banco Banplus.
			   {
			  ...
			  elseif(trim($ls_codban)=="014")//Banco Occidental de Descuento.
				 {
