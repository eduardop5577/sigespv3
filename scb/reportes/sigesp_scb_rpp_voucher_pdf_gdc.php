...
***********************************************************************************/
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);		
        $io_pdf->Rectangle(11,60,580,80);
		$io_pdf->line(11,119,590,119);		
		$io_pdf->line(11,129,590,129);		
		$io_pdf->line(310,88,310,140);		
		$io_pdf->addText(15,145,10,"EMISIÓN DE CHEQUE"); // Agregar el título
		$io_pdf->addText(140,132,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(15,122,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(150,90,6,"Firma y Sello"); // Agregar el título
		$io_pdf->addText(425,132,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(315,122,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(435,90,6,"Firma y Sello"); // Agregar el título


		$io_pdf->Rectangle(11,43,580,45);
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					$io_pdf=uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_ctabanext,$io_pdf); // Imprimimos la cabecera del registro
