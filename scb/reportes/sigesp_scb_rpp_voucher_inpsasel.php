...
***********************************************************************************/
   ...
   //--------------------------------------------------------------------------------------------------------------------------------
	...
	//	$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('scg_cuenta'=>array('justification'=>'center','width'=>100),
						               'denctascg'=>array('justification'=>'left','width'=>225),  
			 						   'debe'=>array('justification'=>'right','width'=>75),
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_pagina($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_nomproben,$ls_fecmov,$ls_conmov,$ls_chevau,$ldec_total,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->add_texto(105,105,10,$ls_fecmov);
		$li_pos=108;
		$io_pdf->convertir_valor_mm_px($li_pos);		
	
		$io_pdf->ezSetY(400);
		$la_data=array(array('1'=>'','2'=>$ls_conmov,'3'=>'','4'=>''));
		$la_columna=array('1'=>'','2'=>'','3'=>'','4'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 8,  // Tamaño de Letras de los títulos
						 'showLines'=>0, // Mostrar Líneas
						 ...
						 'colGap'=> 1, //Separacion de los caracteres entre las barras de las tablas.
						 'xPos'=>260, // Orientación de la tabla
						 'cols'=>array('1'=>array('justification'=>'center','width'=>100),
						               '2'=>array('justification'=>'left','width'=>225),  
			 						   '3'=>array('justification'=>'right','width'=>75),
			 						   '4'=>array('justification'=>'right','width'=>75))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);

		$io_pdf->ezSetY(353);
		$la_data=array(array('1'=>'','2'=>'<b>TOTALES</b>','3'=>$ldec_total,'4'=>$ldec_total));
		$la_columna=array('1'=>'','2'=>'','3'=>'','4'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 8,  // Tamaño de Letras de los títulos
						 ...
						 'xPos'=>260, // Orientación de la tabla
						 'cols'=>array('1'=>array('justification'=>'center','width'=>100),
						               '2'=>array('justification'=>'right','width'=>225),  
			 						   '3'=>array('justification'=>'right','width'=>75),
			 						   '4'=>array('justification'=>'right','width'=>75))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		...
		$la_data=array(array('cheque'=>'','banco'=>''),
						array('cheque'=>'','banco'=>''),
						array('cheque'=>$ls_numdoc,'banco'=>'<b>'.$ls_nomban.'</b>'),
						array('cheque'=>'','banco'=>'<b>'.$ls_ctaban.'</b>'));
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				uf_print_pie_pagina($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_nomproben,$ld_fecmov,$ls_conmov,$ls_chevau,number_format($ldec_total,2,",","."),$io_pdf); // Imprimimos la cabecera del registro
				$io_pdf->closeObject();
