...
***********************************************************************************/
	...
	function uf_print_detalle($la_title,$la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>185),
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->addText(140,137.6,9,'<b>Revisado por:</b>');
		//$io_pdf->addText(273,137.6,9,'<b>Presupuesto</b>');		
		$io_pdf->addText(314,137.6,9,'<b>Administración</b>');		
		$io_pdf->addText(450,137.6,9,'<b>Presidente / Gerente General</b>');
