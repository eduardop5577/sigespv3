		...
		if ($as_tiprep=='E') 
		   {
		     $la_columna=array('beneficiario'=>'<b>Proveedor \ Benef.</b>','solicitud'=>'<b>Solicitud</b>', 'conmov'=>'<b>Concepto</b>',
						       'documento'=>'<b>Documento</b>','factura'=>'<b>Factura</b>','operacion'=>'<b>Operación</b>','nomban'=>'<b>Banco</b>',
				...
				$la_config=array('showHeadings'=>1, // Mostrar encabezados
								 ...
								 'cols'=>array('beneficiario'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
											   ...
											   'factura'=>array('justification'=>'center','width'=>77), // Justificación y ancho de la columna
		...
		else
		   {
		     $la_columna=array('beneficiario'=>'<b>Proveedor \ Benef.</b>','solicitud'=>'<b>Solicitud</b>','nomban'=>'<b>Banco</b>', 'cuenta'=>'<b>Cuenta</b>',
						       'documento'=>'<b>Documento</b>','operacion'=>'<b>Operación</b>','factura'=>'<b>Factura</b>', 'fecha'=>'<b>Fecha</b>','monto'=>'<b>Monto</b>','monret'=>'<b>Retenido</b>');
			 $la_config=array('showHeadings'=>1, // Mostrar encabezados
				 'fontSize' => 8, // Tamaño de Letras
				 'showLines'=>0, // Mostrar Líneas
				 'shaded'=>2, // Sombra entre líneas
				 ...
				 'width'=>580, // Ancho de la tabla
				 'maxWidth'=>580, // Ancho Máximo de la tabla
				 'xPos'=>480, // Justificación y ancho de la columna
				 'cols'=>array('beneficiario'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
							   'solicitud'=>array('justification'=>'center','width'=>77), // Justificación y ancho de la columna
