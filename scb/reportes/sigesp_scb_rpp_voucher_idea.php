...
***********************************************************************************/
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_rif,$ls_cedula,$ld_total,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(30,510,9,$_SESSION['la_empresa']['nombre']);
		$io_pdf->addText(398,533,7,$ls_chevau);
		$io_pdf->addText(405,390,9,$ld_total);
		/*****/
		$ls_numdoc=substr($ls_numdoc,-9);
		$io_pdf->addText(80,353,7,$ls_numdoc);
		$io_pdf->addText(170,355,5,$ls_nomban);
		$io_pdf->addText(270,310,5,$ls_cedula);
		$io_pdf->addText(398,310,5,$ls_rif);
	...
	function uf_print_detalle($la_title,$la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>220, // Ancho Máximo de la tabla
						 'xPos'=>120,
						 'cols'=>array('scg_cuenta'=>array('justification'=>'center','width'=>80),
	...
	function uf_print_detalle_presupuestario($la_title,$la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'showLines'=>0, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 'width'=>460, // Ancho de la tabla
						 'maxWidth'=>460, // Ancho Máximo de la tabla
						 'xPos'=>230,
						 'cols'=>array('spg_cuenta'=>array('justification'=>'center','width'=>90),
			 						   'den_spg'=>array('justification'=>'left','width'=>310),
						 			   'monto'=>array('justification'=>'center','width'=>60))); // Justificación y ancho de la columna
		$la_columnas=array('spg_cuenta'=>'CUENTA',
						   'den_spg'=>'DESCRIPCIÓN',
						   'monto'=>'MONTO');
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_cedrif,$io_pdf); // Imprimimos la cabecera del registro
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$ldec_total		= $ldec_monto-$ldec_monret;
			$ls_rifpro		= $ds_voucher->getValue("rifpro",$li_i);
			$ls_cedula		= $ds_voucher->getValue("cedben",$li_i);
			$ls_rifben		= $ds_voucher->getValue("rifben",$li_i);
			$ls_rif = '';
			if ($ls_rifpro != '') {
				$ls_rif = $ls_rifpro;
			}
			...
			$ls_monto= $numalet->letra();
			uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
			uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_rif,$ls_cedula,number_format($ldec_total,2,",","."),$io_pdf); // Imprimimos la cabecera del registro
			...
			if (empty($la_data))
			   ...
			   uf_print_detalle_presupuestario(array('title'=>''),$la_data_pres,$io_pdf);
			   uf_print_detalle(array('title'=>'','title2'=>''),$la_data,$io_pdf);
