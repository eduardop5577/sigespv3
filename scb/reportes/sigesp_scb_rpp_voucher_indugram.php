...
***********************************************************************************/
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'cols'=>array('banco'=>array('justification'=>'left','width'=>130),
						 'cheque'=>array('justification'=>'left','width'=>100),
						 'cuenta'=>array('justification'=>'left','width'=>130),
						 'voucher'=>array('justification'=>'left','width'=>130))); // Ancho M�ximo de la tabla
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('ordenes'=>array('justification'=>'left','width'=>490))); // Ancho M�ximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		return $io_pdf;
	...
	function uf_print_detalle($la_title,$la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>300),
						 'title2'=>array('justification'=>'center','width'=>190))); // Ancho M�ximo de la tabla
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>165),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>65),
						 			   'scg_cuenta'=>array('justification'=>'center','width'=>70), // Justificaci�n y ancho de la columna
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);		
		$io_pdf->Rectangle(11,43,580,75);
		$io_pdf->line(150,43,150,118);
		$io_pdf->line(300,43,300,118);
		$io_pdf->line(450,43,450,118);
		$io_pdf->addText(35,110,9,'<b>PREPARADA POR:</b>');
		$io_pdf->addText(180,110,9,'<b>REVISADA POR:</b>');		
		$io_pdf->addText(330,110,9,'<b>APROBADA POR:</b>');
		$io_pdf->addText(470,110,9,'<b>RECIBIDA CONFORME:</b>');
		//$io_pdf->addText(16,35,6,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
