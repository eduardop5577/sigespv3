...
***********************************************************************************/
	...
	if ($ls_tiporeporte==1)
	   ...
	   $arrResultado="";
		...
		$ls_nomban="";
		$ls_nomtipcta="";
	$arrResultado=$io_report->uf_generar_estado_cuenta_resumido($ls_codban,$ls_ctaban,$ld_fecdesde,$ld_fechasta,$ldec_saldoanterior,$ldec_total_debe,$ldec_total_haber,$ls_nomban,$ls_nomtipcta);
	   	$data=$arrResultado["data"];
		$ldec_saldoanterior=$arrResultado["ldec_saldoanterior"];
		...
		$ls_nomtipcta=$arrResultado["ls_nomtipcta"];
	$ds_edocta->data=$data;
	...
	$io_pdf=uf_print_encabezado_pagina("<b>Estado de Cuenta Resumido $ls_tipbol</b>","<b>Del $ld_fecdesde al $ld_fechasta</b>",$io_pdf); // Imprimimos el encabezado de la página
	...
	$io_pdf=uf_print_cabecera($ls_nomban,$ls_ctaban,$ls_nomtipcta,$ldec_saldoant,$io_pdf); // Imprimimos la cabecera del registro
