...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_numdoc,$as_fecha,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/cabecera_oficios_idena.jpg',30,700,550,80); // Agregar Cabecera
		$io_pdf->addJpegFromFile('../../shared/imagebank/pie_oficios_idena.jpg',20,39,559,60); // Agregar Pie
		$io_pdf->addText(426,685,11,"<b>Nro.:</b>  ".$as_numdoc); // Numero de Docuento
		$io_pdf->addText(380,670,11,$as_fecha); // Numero de Docuento
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		...
		if ($as_tipproben=='B')
		   {
			 $la_config=array('showHeadings'=>1, // Mostrar encabezados
							  ...
							  'xOrientation'=>'full', // Orientación de la tabla
							  'cols'=>array('cedbene'=>array('justification'=>'full','width'=>60),// Justificación y ancho de la columna
										    'nombene'=>array('justification'=>'full','width'=>240),// Justificación y ancho de la columna
										    'ctaban'=>array('justification'=>'full','width'=>120), // Justificación y ancho de la columna
										    'monto'=>array('justification'=>'full','width'=>100))); // Justificación y ancho de la columna
		...
		elseif($as_tipproben=='P')
		   {
			 $la_config=array('showHeadings'=>1, // Mostrar encabezados
							  ...
							  'cols'=>array('cod_pro'=>array('justification'=>'full','width'=>60),// Justificación y ancho de la columna
										    'nompro'=>array('justification'=>'full','width'=>240),// Justificación y ancho de la columna
										    'ctaban'=>array('justification'=>'full','width'=>120), // Justificación y ancho de la columna
										    'monto'=>array('justification'=>'full','width'=>100))); // Justificación y ancho de la columna
	...
	if(!array_key_exists("opener",$_GET))
	{
		...
		$li_cont=count((array)$la_cartaorden);
		$li_totales=0;
		for ($i=1;$i<=$li_cont;$i++)
		{
