...
***********************************************************************************/
	...
	function uf_print_autorizacion($io_pdf,$ls_codigo,$ls_nomusu)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(155,137.6,9,'<b>Revisado por:</b>');	
		$io_pdf->addText(305,137.6,9,'<b>Aprobado por:</b>');	
		$io_pdf->addText(455,137.6,9,'<b>Autorizado por:</b>');	
		//$nombre = $_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"];
		$li_tm=$io_pdf->getTextWidth(6,$ls_nomusu);
		$io_pdf->addText(80-($li_tm/2),100,6,$ls_nomusu); // Agregar el título
		//$io_pdf->addText(30,100,6,$ls_nomusu); 
		$io_pdf->addText(50,93,7,'<b>Analista de Pago</b>');
		$nombre = "Glaidynar Cabrera";
		$io_pdf->addText(195,100,7,$nombre); 
		$io_pdf->addText(200,93,7,'<b>Jefe de Pagos</b>');
		...
		if ($ls_codigo=='002')
		{
			$io_pdf->addText(350,100,7,'Onerllys Guerra');
			$io_pdf->addText(318,93,7,'<b>Jefe de Oficina de Administracion</b>');
			
			$io_pdf->addText(492,100,7,'Josefina Muñoz');		
			$io_pdf->addText(490,93,7,'<b>Gerente General</b>');
		}
		if ($ls_codigo=='003')
		{
			$io_pdf->addText(350,100,7,'Onerllys Guerra');
			...
			$io_pdf->addText(500,100,7,'Laura Guerra');		
			$io_pdf->addText(502,93,7,'<b>Presidenta</b>');
		}
		if ($ls_codigo=='004')
		{
			$io_pdf->addText(350,100,7,'Josefina Muñoz');
			$io_pdf->addText(348,93,7,'<b>Gerente General</b>');
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					$ls_nomusu		= $ds_voucher->data["nomusureg"][$li_i]." ".$ds_voucher->data["apeusureg"][$li_i];
			    ...
			    uf_print_autorizacion($io_pdf,$ls_codigo,$ls_nomusu);	
				if ($i<$li_total)
				{			
