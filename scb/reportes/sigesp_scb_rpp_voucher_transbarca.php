...
***********************************************************************************/
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_cedrif,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->add_texto(130,102,7,$ls_chevau);
		$io_pdf->add_texto(180,100,9,date('d/m/Y'));
		$ls_numdoc=substr($ls_numdoc,7,8);
		$la_data=array(array('banco'=>'','cheque'=>'','cuenta'=>'','voucher'=>''),
				       array('banco'=>'','cheque'=>'','cuenta'=>'','voucher'=>''),
				array('banco'=>'','cheque'=>'','cuenta'=>'','voucher'=>''),
					   array('banco'=>$ls_solicitudes,'cheque'=>'    '.$ls_nomban,'cuenta'=>'       '.$ls_ctaban,'voucher'=>$ls_numdoc),
				       array('banco'=>'','cheque'=>'','cuenta'=>'','voucher'=>''),
				       array('banco'=>'','cheque'=>'','cuenta'=>'','voucher'=>''),
				       array('banco'=>'','cheque'=>'','cuenta'=>'','voucher'=>''));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 //'height'=>250,
						 'maxWidth'=>50,
						 'cols'=>array('banco'=>array('justification'=>'left','width'=>100),'cheque'=>array('justification'=>'left','width'=>200),
						 'cuenta'=>array('justification'=>'left','width'=>150),'voucher'=>array('justification'=>'right','width'=>100))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$la_data=array(array('ordenes'=>'Ordenes de Pago: '.$ls_solicitudes),
		...
		$la_data=array(array('beneficiario'=>'', 'rif'=>''),
				       array('beneficiario'=>'', 'rif'=>''),
				       array('beneficiario'=>'', 'rif'=>''),
				       array('beneficiario'=>'', 'rif'=>''),
					   array('beneficiario'=>$ls_nomproben, 'rif'=>$ls_cedrif));
	...
	function uf_print_detalle_presupuestario($la_title,$la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('estructura'=>array('justification'=>'center','width'=>180),
			 						   'den_spg'=>array('justification'=>'left','width'=>300),
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					$io_pdf=uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_cedrif,$io_pdf); // Imprimimos la cabecera del registro
					...
					$io_pdf=uf_print_detalle(array('title'=>'','title2'=>''),$la_data,$io_pdf);
					$io_pdf=uf_print_detalle_presupuestario(array('title'=>'DETALLE PRESUPUESTARIO'),$la_data_pres,$io_pdf);
	...
	else 
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			if (empty($la_data))
			   ...
			   $io_pdf=uf_print_detalle_presupuestario(array('title'=>''),$la_data_pres,$io_pdf);
			   $io_pdf=uf_print_detalle(array('title'=>'','title2'=>''),$la_data,$io_pdf);
