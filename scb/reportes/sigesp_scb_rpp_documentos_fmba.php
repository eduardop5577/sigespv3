	...
	if ($ls_conchk==1)
	{
		...
		for($li_p=0;$li_p<$li_total;$li_p++)
		{
			...
			if($lb_valido)
			{
				...
				if ($li_check==1)
				{
					$io_pdf=uf_print_encabezado_pagina($ls_titulo,$ld_fecdesde,$ld_fechasta,$ls_nomban,$ls_nomtipcta,$ls_ctaban,$ls_tipolistado,$io_pdf); // Imprimimos el encabezado de la página
