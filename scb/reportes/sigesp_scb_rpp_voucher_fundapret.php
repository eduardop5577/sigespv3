...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$io_pdf)
	{
		...
		$io_pdf->add_texto($valores[12],$valores[13],10,"<b>NO ENDOSABLE</b>");
	...
	$io_pdf->addText(60,415,10,$ls_numdoc);        	//numero de documento
	$io_pdf->addText(430,460,10,$ls_chevau);			//numero de cheque voucher
	$io_pdf->addText(230,415,10,$ls_nomban);	     	//nombre del banco
	//$io_pdf->addText(200,376,10,$ls_ctaban);	     	//nombre del banco
	$io_pdf->addText(440,415,10,$ld_fechaact);        	//numero de documento
	$io_pdf->addText(70,397,10,$ls_nomproben);		//nombre del proveedor o beneficiario	
	
	//cuadro ajustando el concepto a un arreglo
	$io_pdf->setStrokeColor(0,0,0);
	
	$ls_concepto_cortado=wordwrap($ls_conmov,76,"?");
	$la_arreglo_conc=array();
	$la_arreglo_conc=explode("?",$ls_concepto_cortado);
	if(array_key_exists(0,$la_arreglo_conc))
	{
		$io_pdf->addText(100,377,9,$la_arreglo_conc[0]);		//nombre del proveedor o beneficiario
	}
	if(array_key_exists(1,$la_arreglo_conc))
	{
		$io_pdf->addText(30,358,9,$la_arreglo_conc[1]);		//nombre del proveedor o beneficiario
	}
	...
	function uf_print_detalle($la_title,$la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>333, // Orientación de la tabla
						 'rowGap'=>0.1,
						 'cols'=>array('estpro'=>array('justification'=>'left','width'=>120),
						 			   'spg_cuenta'=>array('justification'=>'left','width'=>70),
									   'monto_spg'=>array('justification'=>'left','width'=>100))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>550, // Ancho de la tabla
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xPos'=>435, // Orientación de la tabla
						 'cols'=>array('scg_cuenta'=>array('justification'=>'left','width'=>100), // Justificación y ancho de la columna
	...
	if ($ls_tipimp=='lote')
	{
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
			...
			if (trim($ls_codban)=="001")//Banco del tesoro
			   {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		$thisPageNum=$io_pdf->ezPageCount;
		//$io_pdf->ezStartPageNumbers(570,30,10,'','',1); // Insertar el número de página
			if (trim($ls_codban)=="001")//Banco Tesoro.
			   {
			     $ls_archivo   = "cheque_configurable/medidas_tesoro.txt";
