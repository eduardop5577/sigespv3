...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$ls_numdoc,$io_pdf)
	{
		...
		$io_pdf->addText(520,760,9,$ls_fecha); // Agregar la Fecha
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ld_fecmov,$ls_operacion,$ls_tipodest,$ldec_monto,$ls_numcarord,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data=array(array('ordenes'=>'<b>Banco :</b>  '.$ls_nomban),
					   ...
					   array('ordenes'=>'<b>Carta Orden :</b> '.$ls_numcarord),
	...
	function uf_print_detalle($la_title,$la_data,$li_totrow_spi,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>340),'title2'=>array('justification'=>'center','width'=>240))); // Ancho Máximo de la tabla
	...
	function uf_print_autorizacion($ls_nomusureg,$io_pdf)
	{
		...
		$io_pdf->addText(16,95,7,$ls_nomusureg);	
...
for($li_i=1;$li_i<=$li_totrow;$li_i++)
{
	...
	$io_pdf=uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$ld_fecmov,$ls_numdoc,$io_pdf); // Imprimimos el encabezado de la página
	$io_pdf=uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ld_fecmov,$ls_operacion,$ls_tipodest,number_format($ldec_total,2,",","."),$ls_numcarord,$io_pdf); // Imprimimos la cabecera del registro
