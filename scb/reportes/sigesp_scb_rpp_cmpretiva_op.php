	...
	$class_report->uf_generar_cmpret_ordendepagodirecta($ls_codemp,$ls_numdoc,$ls_codban,$ls_ctaban,$ls_tipodestino,$ls_codpro,$ls_cedben,$ld_fecmov,$la_data_compret);
	 ...
	 $io_pdf->ezStartPageNumbers(950,50,10,'','',1);
			...
			else 
			{
				...
				$io_pdf =uf_print_encabezado_pagina($ls_titulo,$ls_org,$ls_rifageret,$io_pdf); 
													
				$io_pdf =uf_print_cabecera($ls_nomageret,$ls_rifageret,$ls_rifageret,$ls_perfis,
				...
				{				
					...
					{  
					  ...
					  //print_r($la_data);
					  $io_pdf =uf_print_det_ret_iva($la_data,$ldec_totconiva,$ldec_totsiniva,$ldec_totbasimp,
										   $ldec_totmonimp,$ldec_totivaret,$io_pdf); 						 						  
					  unset($la_data);							 
					}
			   }										
