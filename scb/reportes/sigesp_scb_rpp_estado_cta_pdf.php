...
***********************************************************************************/
	...
	$ldec_total_debe=0;
	$ldec_total_haber=0;
	$arrResultado=$io_report->uf_generar_estado_cuenta($ls_codemp,$ls_codban,$ls_ctaban,$ls_orden,$ld_fecdesde,$ld_fechasta,$ldec_saldoant,$ldec_total_debe,$ldec_total_haber,false,'C','---');
	...
	$io_pdf=uf_print_encabezado_pagina("<b>Estado de Cuenta $ls_tipbol</b>","<b>Del $ld_fecdesde al $ld_fechasta</b>",$io_pdf); // Imprimimos el encabezado de la página
	...
	$io_pdf=uf_print_cabecera($ls_nomban,$ls_ctaban,$ls_nomtipcta,$ldec_saldoant,$li_totrow,$io_pdf); // Imprimimos la cabecera del registro
	$li_pos=0;
	if($li_totrow>0)
	{
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$ldec_monret      = floatval($ds_edocta->getValue("monret",$li_i));
			$ldec_monto       = floatval($ds_edocta->getValue("monto",$li_i));
