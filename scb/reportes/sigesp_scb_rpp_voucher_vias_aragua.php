...
***********************************************************************************/
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>170),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>75),
						 			   'scg_cuenta'=>array('justification'=>'center','width'=>105), // Justificación y ancho de la columna
	...
	function uf_print_autorizacion($ls_codban,$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			$io_pdf->addText(180,137.6,9,'<b>Contabilidad</b>');
			/*$io_pdf->addText(273,137.6,9,'<b>Presupuesto</b>');*/		
			$io_pdf->addText(320,137.6,9,'<b>Administración</b>');		
			$io_pdf->addText(480,137.6,9,'<b>Presidencia</b>');
	...
	if ($ls_tipimp=='lote')
	{
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
			...
			if (trim($ls_codban)=="002")//Banco Industrial.
			   {
			...
			elseif(trim($ls_codban)=="001")//Banco de Venezuela.
			   {
			...
			for ($i=1;$i<=$li_total;$i++)
			{
		    	...
		    	$io_pdf=uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_codban,$ld_fecmov,$la_data,$ls_cedbene,$io_pdf); // Imprimimos la cabecera del registro

			   $io_pdf= uf_print_autorizacion($ls_codban,$io_pdf);	
				if ($i<$li_total)
				{			
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$io_pdf=uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ls_codban,$ld_fecmov,$la_data,$ls_cedbene,$io_pdf);
			if ($ls_codban !='001')
			{
			$io_pdf=uf_print_detalle(array('title'=>'Detalle Presupuestario Pago','title2'=>'Detalle Contable Pago'),$la_data,$io_pdf);
			}
