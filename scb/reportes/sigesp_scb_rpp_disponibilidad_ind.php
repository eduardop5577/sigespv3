...
***********************************************************************************/
	...
	$io_pdf=uf_print_encabezado_pagina("<b>Disponibilidad Financiera $ls_tipbol </b>"," <b>Acumulada al ".$ld_fecha.'</b>',$io_pdf); // Imprimimos el encabezado de la página
	...
	$io_pdf=uf_print_totales(number_format($ldec_totaldebitos,2,",","."),number_format($ldec_totalcreditos,2,",","."),number_format($ldec_saldo_total,2,",","."),$io_pdf); // Imprimimos el detalle	 
