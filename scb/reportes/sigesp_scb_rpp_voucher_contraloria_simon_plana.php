...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$io_pdf)
	{
		...
		$io_pdf->addText(24,137.6,8,'<b>ELABORADO POR</b>');
		$io_pdf->addText(150,137.6,8,'<b>ADMINISTRACION</b>');
		$io_pdf->addText(305,137.6,8,'<b>CONTABILIDAD</b>');		
		///$io_pdf->addText(330,137.6,9,'<b>AUDITORIA INETERNA</b>');		
		$io_pdf->addText(473,137.6,8,'<b>CONTRALOR(A)</b>');
		$io_pdf->addText(258,78.85,8,'<b>RECIBI CONFORME</b>');
		
		$io_pdf->addText(16,63.27,8,'<b>Nombre:</b>');		
		$io_pdf->addText(196,63.27,8,'<b>Cédula de Identidad:</b>');		
		$io_pdf->addText(316,63.27,8,'<b>Fecha:</b>');
		$io_pdf->addText(416,63.27,8,'<b>Firma:</b>');
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$io_pdf)
	{
		...
		$io_pdf->ezSetY(523);
		$la_data=array(array('banco'=>'Banco','cheque'=>'No. de Documento','cuenta'=>'Cuenta No.','voucher'=>'No. Control Interno'),
		               array('banco'=>$ls_nomban,'cheque'=>$ls_numdoc,'cuenta'=>$ls_ctaban,'voucher'=>$ls_chevau));
		$la_columna=array('banco'=>'Banco','cheque'=>'Cheque No.','cuenta'=>'Cuenta No.','voucher'=>'Voucher No.');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'cols'=>array('banco'=>array('justification'=>'left','width'=>150),'cheque'=>array('justification'=>'left','width'=>100),
						 'cuenta'=>array('justification'=>'left','width'=>160),'voucher'=>array('justification'=>'left','width'=>160))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$la_data=array(array('ordenes'=>' Orden(es) de Pago(s): '.$ls_solicitudes),
					   array('ordenes'=>' Beneficiario: '.$ls_nomproben),
					   array('ordenes'=>' Concepto'.$ls_conmov));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>580, // Ancho de la tabla
						 'maxWidth'=>580,
						 'cols'=>array('ordenes'=>array('justification'=>'left','width'=>570))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_detalle($la_title,$la_data,$io_pdf)
	{
		...
		$la_columna=array('title'=>'Detalle Presupuestario Pago','title2'=>'');
		$la_data_title[0]=array('title'=>'Detalle Presupuestario Pago','title2'=>'Detalle Contable Pago');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 ...
						 'xPos'=>315, // Orientación de la tabla
						 'cols'=>array('title'=>array('justification'=>'center','width'=>255),
			 						   'title2'=>array('justification'=>'center','width'=>315))); // Justificación y ancho de la columna
/*		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
...
*/		$io_pdf->ezTable($la_data_title,$la_columna,'',$la_config);	
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>580, // Ancho Máximo de la tabla
						 'xPos'=>315, // Orientación de la tabla
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>130),
			 						   'spg_cuenta'=>array('justification'=>'center','width'=>65),
									   'monto_spg'=>array('justification'=>'center','width'=>60),
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					$ls_numconint		= $ds_voucher->data["numconint"][$li_i];
					...
					uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_numconint,$ls_nomproben,$ls_solicitudes,$ls_conmov,$io_pdf); // Imprimimos la cabecera del registro
						 ...
						 for ($li_s=1;$li_s<=$li_totrow_det;$li_s++)
							 {
							   ...
							   $la_data[$li_s]=array('spg_cuenta'=>$ls_cuentaspg,'estpro'=>$ls_estpro,'monto_spg'=>$ldec_monto_spg,'scg_cuenta'=>$ls_scg_cuenta,'denominacion'=>$ls_denominacion,'debe'=>$ldec_mondeb,'haber'=>$ldec_monhab);
							 }
					   }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		elseif(trim($ls_codban)=="002")//Banco Casa Propia.
		{
