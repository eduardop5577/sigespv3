...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_numdoc,$as_fecha,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/banner_FMM_2017.jpg',65,730,520,70); // Agregar Logo
		$io_pdf->Rectangle(75,700,500,40);
		$io_pdf->line(370,720,575,720);		
		$io_pdf->line(370,740,370,700);		
		$io_pdf->addText(380,727,11,"<b>Nro.:</b>     ".$as_numdoc); // Nmero de Orden de compra
		$io_pdf->addText(180,715,13,"<b>CARTA ORDEN</b>"); // Agregar el t?ulo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
		//Fecha actual
		$io_pdf->addText(380,705,10,"<b>".$as_fecha."</b>"); // Nmero de Orden de compra
