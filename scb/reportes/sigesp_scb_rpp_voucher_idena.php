...
***********************************************************************************/
	...
	$io_pdf->Rectangle(11,43,580,105);
		...
		$io_pdf->addText(18,110,8,$_SESSION["la_apeusu"].", ".$_SESSION["la_nomusu"]);
		$io_pdf->line(130,90,130,148);
		$io_pdf->addText(140,137.6,9,'<b>COORDINACION TESORERIA</b>');
		$io_pdf->line(275,90,275,148);
		$io_pdf->addText(280,137.6,9,'<b>GCIA ADMINISTRACION Y SERV.</b>');
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				if (trim($ls_codban)=="002" || trim($ls_codban)=="003" )//Banco de Venezuela.
					 {
				  ...
				  elseif(trim($ls_codban)=="004")//Banco Bicentenario
					 {
					   $ls_archivo	 = "cheque_configurable/medidas_bicentenario.txt";
					   $ls_contenido = "138.00-6.00-32.00-22.00-32.00-28.00-32.00-34.00-32.00-43.00-77.00-43.00-137.00-65.00-131.00-70.00";
					   $li_medidas   = 16;
					 }
				  elseif(trim($ls_codban)=="001")//Banco Industrial de Venezuela.
					 {
					   $ls_archivo   = "cheque_configurable/medidas_industrial.txt";
					   $ls_contenido = "138.00-6.00-32.00-22.00-32.00-28.00-32.00-34.00-32.00-43.00-77.00-43.00-137.00-65.00-131.00-70.00-10.00-91.00-8.00-100.00-12.00-117.00";
					   $li_medidas   = 22;
					 }
				  elseif(trim($ls_codban)=="005")//Banco del Tesoro.
					 {
