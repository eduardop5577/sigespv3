...
***********************************************************************************/
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$io_pdf)
	{
		...
		$la_data=array(array('banco'=>'<b>Banco</b>  ','cheque'=>'<b>Cheque Nº</b>  ','cuenta'=>'<b>Cuenta Nº:</b>  ','voucher'=>'<b>Comprobante Egreso:</b>  '),
	...
	function uf_print_autorizacion($as_nomusu,$as_apeusu,$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);		
		$io_pdf->Rectangle(11,43,580,115); //105
		$io_pdf->line(11,90,590,90);
		$io_pdf->line(11,105,590,105);
		$io_pdf->line(11,74.6,590,74.6);		
		$io_pdf->line(127,90,127,158);
		$io_pdf->line(243,90,243,158);
		$io_pdf->line(359,90,359,158);
		$io_pdf->line(475,90,475,158);		
		$io_pdf->line(191,43,191,75);
		$io_pdf->line(310.5,43,310.5,75);
		$io_pdf->line(411,43,411,75);	
		
		$io_pdf->addText(16,145.6,9,'<b>Elaborado por:</b>');
		$io_pdf->addText(16,120,9,$as_nomusu);
		$io_pdf->addText(16,110,9,$as_apeusu);
		$io_pdf->addText(40,95,9,'<b>Firma y Sello</b>');
		$io_pdf->addText(132,145,9,'<b>Revisado por:</b>');
		$io_pdf->addText(157,95,9,'<b>Firma y Sello</b>');
		$io_pdf->addText(273,145,9,'<b>Presupuesto</b>');	
		$io_pdf->addText(273,95,9,'<b>Firma y Sello</b>');		
		$io_pdf->addText(384,145,9,'<b>Administración</b>');	
		$io_pdf->addText(390,95,9,'<b>Firma y Sello</b>');		
		$io_pdf->addText(492,145,9,'<b>Gerencia General</b>');
		$io_pdf->addText(505,95,9,'<b>Firma y Sello</b>');	
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					$ls_nomusu		= $ds_voucher->getValue("nomusureg",$li_i);
					$ls_apeusu      = $ds_voucher->getValue("apeusureg",$li_i);
			    ...
			    $io_pdf=uf_print_autorizacion($ls_nomusu,$ls_apeusu,$io_pdf);	
				if ($i<$li_total)
				{			
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		$thisPageNum=$io_pdf->ezPageCount;
		$io_pdf->ezStartPageNumbers(570,30,10,'','',1); // Insertar el número de página
		//uf_print_autorizacion($ls_nomusu,$ls_apeusu,$io_pdf);	
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			unset($la_data);
			$li_totprenom = 0;
