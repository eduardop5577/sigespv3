...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$io_pdf)
	{
		...
		global $valores;
		//Imprimo el monto
		$io_pdf->addText(440,140,9,$ldec_monto);
	...
	$io_pdf->addText(10,440,7,$ls_chevau);			//numero de cheque voucher
	$io_pdf->addText(122,465,7,$ls_nomban);	     	//nombre del banco
	$io_pdf->addText(270,465,7,$ls_numdoc);        	//numero de documento
	$io_pdf->addText(420,465,7,$ls_ctaban);			//cuenta de banco
	$io_pdf->addText(10,465,7,$ls_solicitudes);		//numero de solicitudes canceladas con el cheque	
	...
	function uf_print_detalle($la_title,$la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'cols'=>array('title'=>array('justification'=>'center','width'=>200),'title2'=>array('justification'=>'center','width'=>220))); // Ancho Máximo de la tabla
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'left','width'=>100),
						 			   'spg_cuenta'=>array('justification'=>'center','width'=>100),
									   'monto_spg'=>array('justification'=>'left','width'=>65),
	   ...
	   //Descompongo la cadena de operaciones en un arreglo tomando como separación el '-'
		...
		{	
		    ...
		    $io_pdf->ezStartPageNumbers(570,30,10,'','',1); // Insertar el número de página
						...
						if(trim($ls_codban)=="002")//Banco Bicentenario.
			 {
			...
			elseif(trim($ls_codban)=='005')// Banco Mercantil
	     	 {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$io_pdf=uf_print_detalle(array('title'=>'Detalle Presupuestario','title2'=>'Detalle Contable'),$la_data,$io_pdf);
		}
		//$io_pdf->ezStopPageNumbers(1,1);
		$io_pdf->ezStream();
