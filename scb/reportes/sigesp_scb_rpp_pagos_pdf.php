...
***********************************************************************************/
	...
	function uf_print_detalle($la_data,$as_tiprep,$io_pdf)
	{
		...
		if (($ls_estretiva!='C')||($ls_estretmil!='C')||($ls_modageret!='C'))
		{
			if ($as_tiprep=='E') 
			   {
		...
		else
		{
			if ($as_tiprep=='E') 
			   {
				 $la_columna=array('beneficiario'=>'<b>Proveedor \ Benef.</b>','solicitud'=>'<b>Solicitud</b>', 'conmov'=>'<b>Concepto</b>',
								   'documento'=>'<b>Documento</b>','operacion'=>'<b>Operación</b>','nomban'=>'<b>Banco</b>','cuenta'=>'<b>Cuenta</b>', 'fecha'=>'<b>Fecha</b>','monto'=>'<b>Monto</b>');
					$la_config=array('showHeadings'=>1, // Mostrar encabezados
									 'fontSize' => 8, // Tamaño de Letras
									 'showLines'=>0, // Mostrar Líneas
									 'shaded'=>2, // Sombra entre líneas
									 ...
									 'xOrientation'=>'center', // Justificación y ancho de la columna
									 'cols'=>array('beneficiario'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
												   'solicitud'=>array('justification'=>'center','width'=>87), // Justificación y ancho de la columna
												   'conmov'=>array('justification'=>'center','width'=>140),
												   'documento'=>array('justification'=>'center','width'=>87), // Justificación y ancho de la columna
												   'operacion'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
			   ...
			   {
				 $la_columna=array('beneficiario'=>'<b>Proveedor \ Benef.</b>','solicitud'=>'<b>Solicitud</b>','nomban'=>'<b>Banco</b>', 'cuenta'=>'<b>Cuenta</b>',
								   'documento'=>'<b>Documento</b>','operacion'=>'<b>Operación</b>', 'fecha'=>'<b>Fecha</b>','monto'=>'<b>Monto</b>');
				 $la_config=array('showHeadings'=>1, // Mostrar encabezados
					 'fontSize' => 8, // Tamaño de Letras
					 'showLines'=>0, // Mostrar Líneas
					 'shaded'=>2, // Sombra entre líneas
					 ...
					 'xOrientation'=>'center', // Justificación y ancho de la columna
					 'cols'=>array('beneficiario'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
								   'solicitud'=>array('justification'=>'center','width'=>97), // Justificación y ancho de la columna
								   'nomban'=>array('justification'=>'center','width'=>110), // Justificación y ancho de la columna
								   'cuenta'=>array('justification'=>'center','width'=>140),
								   'documento'=>array('justification'=>'center','width'=>87), // Justificación y ancho de la columna
								   'operacion'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
								   'fecha'=>array('justification'=>'center','width'=>65), // Justificación y ancho de la columna
								   'monto'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de la columna
	...
	if($li_total>0)
	{
		...
		$io_pdf=uf_print_encabezado_pagina($ls_titulo,$io_pdf,$ls_tipproben,$ls_tiprep,$ls_probendesde,$ls_probenhasta,$ld_fecdesde,$ld_fechasta,$ls_nomban,$ls_ctaban,$ls_tipbol); // Imprimimos el encabezado de la página
