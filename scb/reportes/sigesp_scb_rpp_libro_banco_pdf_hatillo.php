...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_periodo,$ls_banco,$ls_nomtipcta,$ls_ctaban,$as_denctaban,$ldec_saldoant,$io_pdf)
	{
		...
		$io_pdf->addText(500,757,8,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(506,750,7,date("h:i a")); // Agregar la Hora
        $io_pdf->setStrokeColor(0,0,0);
		$io_pdf->Rectangle(50,700,500,45);
		$io_pdf->line(30,65,580,65);
	...
	function uf_print_cabecera($li_totrow,$io_pdf)
	{
		...
		if($li_totrow>0)
			{
			$la_data[0]=array('fecha'=>'<b>Fecha</b>','operacion'=>'<b>Oper</b>','numdoc'=>'<b>Documento</b>','beneficiario'=>'<b>Proveedor/Beneficiario</b>','descripcion'=>'<b>Descripción</b>','debito'=>'<b>Débitos</b>','credito'=>'<b>Créditos</b>','saldo'=>'<b>Saldo</b>');
			...
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
							 ...
							 'cols'=>array('fecha'=>array('justification'=>'center','width'=>45),
										   'operacion'=>array('justification'=>'center','width'=>30),
										   'numdoc'=>array('justification'=>'center','width'=>65),
										   'beneficiario'=>array('justification'=>'center','width'=>100),
										   'descripcion'=>array('justification'=>'center','width'=>130),									   
										   'debito'=>array('justification'=>'center','width'=>70),
										   'credito'=>array('justification'=>'center','width'=>70),
										   'saldo'=>array('justification'=>'center','width'=>70))); // Ancho Máximo de la tabla
	...
	$ldec_total_debe="";
	$ldec_total_haber="";
	$arrResultado = $io_report->uf_generar_estado_cuenta($ls_codemp,$ls_codban,$ls_ctaban,$ls_orden,$ld_fecdesde,$ld_fechasta,$ldec_saldoant,$ldec_total_debe,$ldec_total_haber,true,$ls_tiprep,$ls_codconmov);
	...
	$io_pdf=uf_print_encabezado_pagina("<b>Libro de Banco $ls_tipbol</b>","<b>Del</b> $ld_fecdesde <b>al</b> $ld_fechasta",$ls_nomban,$ls_nomtipcta,$ls_ctaban,$ls_denctaban,$ldec_saldoant,$io_pdf); // Imprimimos el encabezado de la página
	$io_pdf=uf_print_cabecera($li_totrows,$io_pdf); // Imprimimos 
	...
	if ($li_totrows>=0)
	   {	
		...
		unset($la_data);
		$io_pdf=uf_print_totales(number_format($ldec_total_debe,2,",","."),number_format($ldec_total_haber,2,",","."),number_format($ldec_saldoactual,2,",","."),$io_pdf); // Imprimimos el detalle
