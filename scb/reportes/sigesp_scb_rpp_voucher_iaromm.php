...
***********************************************************************************/
	...
	$io_pdf->addText(40,380,10,$ls_numdoc);        	//numero de documento
	$io_pdf->addText(380,430,10,$ls_chevau);			//numero de cheque voucher
	$io_pdf->addText(220,388,10,$ls_nomban);	     	//nombre del banco
	$io_pdf->addText(200,376,10,$ls_ctaban);	     	//nombre del banco
	$io_pdf->addText(400,380,10,$ld_fechaact);        	//numero de documento
	$io_pdf->addText(40,350,10,$ls_nomproben);		//nombre del proveedor o beneficiario	
	
	//cuadro ajustando el concepto a un arreglo
	$io_pdf->setStrokeColor(0,0,0);
	
	$ls_concepto_cortado=wordwrap($ls_conmov,90,"?");
	$la_arreglo_conc=array();
	$la_arreglo_conc=explode("?",$ls_concepto_cortado);
	if(array_key_exists(0,$la_arreglo_conc))
	{
		$io_pdf->addText(40,318,9,$la_arreglo_conc[0]);		//nombre del proveedor o beneficiario
	}
	if(array_key_exists(1,$la_arreglo_conc))
	{
		$io_pdf->addText(40,298,9,$la_arreglo_conc[1]);		//nombre del proveedor o beneficiario
	}
	...
	function uf_print_detalle($la_title,$la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'left','width'=>70),
						 			   'spg_cuenta'=>array('justification'=>'left','width'=>70),
									   'monto_spg'=>array('justification'=>'left','width'=>100),
						 			   'scg_cuenta'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		$thisPageNum=$io_pdf->ezPageCount;
		//$io_pdf->ezStartPageNumbers(570,30,10,'','',1); // Insertar el número de página
			if (trim($ls_codban)=="001")//Banco BNC.
			   {
			     $ls_archivo	 = "cheque_configurable/medidas_bnc.txt";
