...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_periodo,$io_pdf)
	{
		...
		$io_pdf->line(40,90,570,90);
		$io_pdf->line(40,75,570,75);
	//	$io_pdf->line(40,45,570,45);
		$io_pdf->line(40,30,570,30);
		$io_pdf->line(40,90,40,30);
		$io_pdf->line(570,90,570,30);
		$io_pdf->addText(90,80,9,'<b>Elaborado por</b>'); // Agregar el título
		$io_pdf->addText(50,35,8,$ls_nomusu); // Agregar el título
		$io_pdf->line(220,90,220,30);
		$io_pdf->addText(270,80,9,'<b>Unidad de Finanzas</b>'); // Agregar el título
		//$io_pdf->addText(230,35,9,'<b></b>'); // Agregar el título
		$io_pdf->line(400,90,400,30);
		$io_pdf->addText(415,80,9,'<b>Coordinacion de Administracion</b>'); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		//$io_pdf->addText(410,35,9,'<b>Unidad de Contabilidad </b>'); // Agregar el título
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	}	
	...
	$arr_bancos   = explode("-",$ls_bancos);
	$li_totbancos = count((array)$arr_bancos);
	...
	$io_pdf->ezStartPageNumbers(550,20,9,'','',1); // Insertar el número de página
