...
***********************************************************************************/
	...
	function uf_print_autorizacion($ls_nomusureg,$io_pdf)
	{
		...
		$io_pdf->line(273,90,273,148);
		$io_pdf->line(429,90,429,148);
		...
		$io_pdf->addText(132,95,9,'Unidad de Finanzas');
		$io_pdf->addText(278,137.6,9,'<b>Presupuesto</b>');		
		$io_pdf->addText(278,95.6,9,'Coordinacion');		
		$io_pdf->addText(435,137.6,9,'<b>Administración</b>');		
...
for($li_i=1;$li_i<=$li_totrow;$li_i++)
{
	...
	uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$ls_numdoc,$io_pdf); // Imprimimos el encabezado de la página
