...
***********************************************************************************/
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		global $io_report;
		$ls_nomusu=$io_report->uf_select_usuario($_SESSION["la_logusr"]);
		...
		$io_pdf->addText(40,25,9,$ls_nomusu); // Agregar el título
		$io_pdf->line(140,80,140,20);
		$io_pdf->addText(160,70,9,'<b>Verificado por:</b>'); // Agregar el título
		$io_pdf->addText(160,25,9,'<b>Unidad de Finanzas</b>'); // Agregar el título
		$io_pdf->line(280,80,280,20);
		$io_pdf->addText(290,70,9,'<b>Aprobado por </b>'); // Agregar el título
		$io_pdf->addText(290,25,9,'<b>Unidad de Contabilidad </b>'); // Agregar el título
		$io_pdf->line(420,80,420,20);
		$io_pdf->addText(430,70,9,'<b>Certificado por </b>'); // Agregar el título
		$io_pdf->addText(430,25,9,'<b>Coordinacion de Admin.</b>'); // Agregar el título
		$io_pdf->closeObject();
