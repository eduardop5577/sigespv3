	...
	if ($lb_valido)
	   {
		 ...
		 $io_pdf=uf_print_encabezado_pagina("<b>Libro de Banco $ls_tipbol</b>","<b>Del</b> $ld_fecdesde <b>al</b> $ld_fechasta",$ls_nomban,$ls_nomtipcta,$ls_ctaban,$ls_denctaban,$ldec_saldoant,$ls_desconmov,$io_pdf); // Imprimimos el encabezado de la página
	     $io_pdf->ezStartPageNumbers(720,50,10,'','',1); // Insertar el número de página
		 $io_pdf=uf_print_cabecera($li_totrows,$io_pdf); // Imprimimos la cabecera del registro
