...
***********************************************************************************/
	...
	function uf_print_detalle($la_data,$io_pdf)
	{
		...
		$la_columna=array('fecha'=>'<b>Fecha</b>','documento'=>'<b>Documento</b>','cedrif'=>'<b>Cedula-Rif</b>','proveedor'=>'<b>Proveedor/Beneficiario</b>','monto'=>'<b>Monto</b>','estmov'=>'<b>Estatus</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('fecha'=>array('justification'=>'center','width'=>70),
						               'documento'=>array('justification'=>'center','width'=>90),
									   'cedrif'=>array('justification'=>'center','width'=>80),	
						 			   'proveedor'=>array('justification'=>'left','width'=>170),
						 			   'monto'=>array('justification'=>'right','width'=>105),
   ...
   //Descompongo la cadena de documentos en un arreglo tomando como separación el '-'
	...
	$la_data=$io_report->uf_cargar_documentos_relacion($arr_documentos,$arr_fecmov,$arr_operaciones,$ls_codban,$ls_ctaban,false,true);
	...
	if (!empty($la_data))
	   {
		 ...
		 $io_pdf=uf_print_encabezado_pagina($ls_titulo,$ld_fecdes,$ld_fechas,$ls_denban,$ls_ctaban,$ls_dencta,$io_pdf); // Imprimimos el encabezado de la página
