...
***********************************************************************************/
	...
	function uf_print_detalle($la_title,$la_data,$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'right','width'=>170),
			 						   'spg_cuenta'=>array('justification'=>'right','width'=>60),
...
if ($ls_tipimp=='lote')
   {
	 ...
	 if ($li_total>0)
		{	
		  ...
		  elseif(trim($ls_codban)=="002" || trim($ls_codban)=="003")//Banco Del Caribe;Central;Casa Propia;Banesco;Mercantil;Banfoandes.
			 {
		  ...
		  elseif(trim($ls_codban)=="006")//Banco Central.
			 {
		  ...
		  elseif(trim($ls_codban)=="010")//Banco Occidental de Descuento.
			 {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
else 
   {
	 ...
	 elseif(trim($ls_codban)=="009")//Bancamiga
		{
		   $ls_archivo   = "cheque_configurable/medidas_bancamiga.txt";
		   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
		   $li_medidas   = 16;
		}	
		if(trim($ls_codban)=="006")//Banco Bicentenario.
		 {
		   $ls_archivo   = "cheque_configurable/medidas_bicentenario.txt";
		   $ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
		   $li_medidas   = 16;
		 }
		if(trim($ls_codban)=="010")//Banco Occidental de Descuento.
		{
			$ls_archivo	 = "cheque_configurable/medidas_bnc.txt";
			$ls_contenido = "144.00-0.00-24.00-20.00-26.00-30.00-27.00-33.00-22.00-38.00-79.00-38.00-120.00-60.00-130.00-65.00";
			$li_medidas   = 16;
