...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	else 
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			//Obtengo el texto del monto enviado.
			$ls_monto= $numalet->letra();
			$io_pdf=uf_print_encabezado_pagina($ls_ctaban,$ls_nomban,$ls_codtipcta,$ls_codope,number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
			$io_pdf=uf_print_cabecera($ldec_total,$ld_fecmov,$ls_codope,$ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$io_pdf); // Imprimimos la cabecera del registro
			...
			if (($ls_codope!='ND')&&($ls_codope!='NC'))
			{
				$io_pdf=uf_print_detalle($ldec_total,$ls_codope,array('title'=>'Detalle Presupuestario Pago','title2'=>'Detalle Contable Pago'),$la_data,$io_pdf);
			}
			else
			{
				$io_pdf=uf_print_detalle($ldec_total,$ls_codope,array('title'=>'','title2'=>'<b>Contabilidad</b>'),$la_data,$io_pdf);
			}	
		}
		$io_pdf->ezStopPageNumbers(1,1);
		$io_pdf->ezStream();
