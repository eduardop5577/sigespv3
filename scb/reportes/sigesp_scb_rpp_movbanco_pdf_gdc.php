...
***********************************************************************************/
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);		
        $io_pdf->Rectangle(11,40,580,60);
		$io_pdf->line(11,80,590,80);		
		$io_pdf->line(11,90,590,90);		
		$io_pdf->line(310,40,310,100);		
		$io_pdf->addText(140,92,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(15,82,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(150,45,6,"Firma y Sello"); // Agregar el título
		$io_pdf->addText(425,92,7,"REVISADO POR"); // Agregar el título
		$io_pdf->addText(315,82,6,"Nombre y Apellido:"); // Agregar el título
		$io_pdf->addText(435,45,6,"Firma y Sello"); // Agregar el título
