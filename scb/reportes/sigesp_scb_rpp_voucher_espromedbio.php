...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_espromedbio.jpg',25,750,500,40); // Agregar Logo
		$io_pdf->ezSetY(600);
		//Imprimo el monto
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->line(11,125,590,125);
		$io_pdf->line(11,60,590,60);
		$io_pdf->line(107,43,107,148);
		$io_pdf->line(203,43,203,148);
		$io_pdf->line(319,43,319,148);
		$io_pdf->line(405,43,405,148);
		$io_pdf->line(520,43,520,125);
		
		
		$io_pdf->addText(26,137.6,8,'<b>ELABORADO</b>');
		$io_pdf->addText(26,50,8,'<b>FIRMA / SELLO</b>');
		$io_pdf->addText(112,137.6,8,'<b>COORDINADOR DE</b>');
		$io_pdf->addText(125,127.6,8,'<b>TESORERIA</b>');
		$io_pdf->addText(125,50,8,'<b>FIRMA / SELLO</b>');
		$io_pdf->addText(215,137.6,8,'<b>GG ADMINISTRACION</b>');
		$io_pdf->addText(225,127.6,8,'<b>Y SERVICIOS</b>');
		$io_pdf->addText(225,50,8,'<b>FIRMA / SELLO</b>');
		$io_pdf->addText(334,137.6,8,'<b>PRESIDENCIA</b>');
		$io_pdf->addText(330,50,8,'<b>FIRMA / SELLO</b>');
		$io_pdf->addText(450,137.6,8,'<b>BENEFICIARIO</b>');
		$io_pdf->addText(430,50,8,'<b>FIRMA / SELLO</b>');
		$io_pdf->addText(540,50,8,'<b>HUELLA</b>');
