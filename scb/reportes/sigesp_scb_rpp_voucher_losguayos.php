...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$io_pdf)
	{
		...
		//Fecha del Cheque
		$io_pdf->add_texto(10,25,9,"<b>$ls_fecha_corta</b>");
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$io_pdf)
	{
		...
		$io_pdf->add_texto(80,10,12,"<b>COMPROBANTE DE EGRESO</b>");
		$io_pdf->rectangle(150,740,320,40);
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->convertir_valor_mm_px($li_pos);
		$io_pdf->ezSetY($li_pos);
		$la_data[0]=array('elaborado'=>'<b>Elaborado por:</b>','revisado'=>'<b>Revisado por:</b>');
		$la_data[1]=array('elaborado'=>'','revisado'=>'');
		$la_data[2]=array('elaborado'=>'','revisado'=>'');
		$la_data[3]=array('elaborado'=>'','revisado'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
						 ...
						 'maxWidth'=>580, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('elaborado'=>array('justification'=>'left','width'=>290),
			 						   'revisado'=>array('justification'=>'left','width'=>290))); // Justificación y ancho de la columna
		$la_columnas=array('elaborado'=>'','revisado'=>'');
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		...
		$la_data=array(array('nombre'=>'<b>Nombre:</b>  ','cedula'=>'<b>Cedula de Identidad:</b>  ','fecha'=>'<b>Fecha:</b>  ','firma'=>'<b>Firma y Sello:</b>  '),
