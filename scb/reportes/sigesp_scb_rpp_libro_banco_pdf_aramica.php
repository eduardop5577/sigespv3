...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($as_titulo,$as_periodo,$ls_banco,$ls_nomtipcta,$ls_ctaban,$as_denctaban,$ldec_saldoant,$io_pdf)
	{
		...
		// cuadro inferior
        $io_pdf->setStrokeColor(0,0,0);
		$io_pdf->Rectangle(90,90,570,90);
		$io_pdf->line(90,160,660,160);
		$io_pdf->line(280,90,280,180);
		$io_pdf->line(480,90,480,180);
		$io_pdf->addText(150,165,7,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(350,165,7,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(530,165,7,"APROBADO POR:"); // Agregar el título
	...
	$io_pdf->ezSetCmMargins(6,6,3.5,3.5); // Configuración de los margenes en centímetros
		 ...
		 $la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('fecha'=>array('justification'=>'center','width'=>60),
									'operacion'=>array('justification'=>'center','width'=>55),
									   ...
									   'saldo'=>array('justification'=>'right','width'=>80))); // Ancho Máximo de la tabla
		$io_pdf=uf_print_detalle($la_columna,$la_config,$la_data,$io_pdf); // Imprimimos el detalle 
		unset($la_data);
