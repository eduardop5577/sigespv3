...
***********************************************************************************/
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);		
		$io_pdf->Rectangle(11,30,580,130);
		$io_pdf->line(11,90,590,90);
		$io_pdf->line(11,148,590,148);
		$io_pdf->line(11,74.6,590,74.6);		
		$io_pdf->line(207,90,207,148);
		$io_pdf->line(404,90,404,148);
//		$io_pdf->line(359,90,359,148);
//		$io_pdf->line(475,90,475,148);		
		$io_pdf->line(191,30,191,75);
		//$io_pdf->line(310.5,43,310.5,75);
		$io_pdf->line(360,30,360,75);	
		
		$io_pdf->addText(260,150,8,'FIRMAS AUTORIZADAS');
		$io_pdf->addText(36,137.6,9,'<b>CONTABILIDAD Y PRESUPUESTO</b>');
		$io_pdf->addText(245,137.6,9,'<b>DIR. DE ADMINISTRACION</b>');
		$io_pdf->addText(450,137.6,9,'<b>DIR. FUNDACION LARA</b>');		
		$io_pdf->addText(58,93,7,'<b>LCDA. CARLA T. SUAREZ R.</b>');
		$io_pdf->addText(230,93,7,'<b>ING. MARIA G. DE LOS R. VILLEGAS NAVAS</b>');
		$io_pdf->addText(445,93,7,'<b>LCDO. CESAR CATARI JIMENEZ</b>');		
//		$io_pdf->addText(384,137.6,9,'<b>Administración</b>');		
//		$io_pdf->addText(508,137.6,9,'<b>Presidencia</b>');
		$io_pdf->addText(258,78.85,9,'<b>Recibí Conforme</b>');
		
		$io_pdf->addText(70,63.27,9,'Beneficiario');		
		$io_pdf->addText(55,35,8,'NOMBRE Y APELLIDO');		
		$io_pdf->addText(255,63.27,9,'Fecha');
		$io_pdf->addText(410,63.27,9,'Firma y Cedula de Identidad');
		$io_pdf->restoreState();
		$io_pdf->closeObject();
