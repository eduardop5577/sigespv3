		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'center','width'=>140),
									   ...
									   'monto_spg'=>array('justification'=>'right','width'=>65),
						 			   ...
						 			   'debe'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
						 			   'haber'=>array('justification'=>'right','width'=>65))); // Justificaci�n y ancho de la columna
...
//----------------------------------------------------------------------------------------------------------------------------------
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera($ls_nomproben,$ls_conmov,$as_identidad,$as_chevau, $ls_ctaban,  $ls_nonban,   $io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// Fecha Creaci�n: 24/04/2006 
		//
		//   Modificacion: Ing. Anibal Tillero 
		//  Fecha Modificacion: 28-09-20012 
		//
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$li_pos=273;
		...
		//
		// Descripcion: Los ultimos cuatro (4) digitos de cheque de seguridad.
		//
		$as_chevau2=substr(  $as_chevau , 10 , 15);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550,
						 'xPos'=>350,
						 'cols'=>array('numcheq'=>array('justification'=>'center','width'=>100))); // Ancho M�ximo de la tabla
		$io_pdf->ezTable($la_data_num2,$la_columna,'',$la_config);
		
		//
		// Descripcion: numero de cheque completo.
		//
		$io_pdf->ezSetDy(-240);	
		$as_chevau1=substr($as_chevau,0,15);
		$la_data_num[1]=array('numcheq'=>'<b>Cheque No: '.$as_chevau1.'</b>');
		$la_columna=array('numcheq'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'showLines'=>0, // Mostrar L�neas
						 'shaded'=>0, // Sombra entre l�neas
						 ...
						 'maxWidth'=>550,
						 'xPos'=>-44,						 
						 'cols'=>array('numcheq'=>array('justification'=>'right','width'=>530))); // Ancho M�ximo de la tabla
		$io_pdf->ezTable($la_data_num,$la_columna,'',$la_config);

		//
		// Descripcion: Cuenta y Nombre del Banco
		//
		$la_data[1]=array('ctabanco'=>'<b> Banco: '.$ls_ctaban .'</b>' ,'nomban'=>'<b>'.$ls_nonban.'</b>' );
		$la_columna=array('ctabanco'=>'','nomban'=>'');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 'showLines'=>0, // Mostrar L�neas
						 'shaded'=>0, // Sombra entre l�neas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 ...
						 'maxWidth'=>580,
						 'xPos'=>330,
						 'cols'=>array('ctabanco'=>array('justification'=>'left','width'=>180),
						               'nomban'=>array('justification'=>'left','width'=>350))); // Ancho M�ximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		//
		// Descripcion: Concepto del Voucher 
		//
		$io_pdf->ezSetDy(-10);
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>550,
						 'xPos'=>320,
						 'cols'=>array('concepto'=>array('justification'=>'left','width'=>500))); // Ancho M�ximo de la tabla
		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					$io_pdf=uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf,$y_pos); // Imprimimos el encabezado de la p�gina
					
					//uf_print_cabecera($ls_nomproben, $ls_conmov,$ls_identidad,$ls_chevau,$io_pdf); // Imprimimos la cabecera del registro
					$io_pdf=uf_print_cabecera($ls_nomproben, $ls_conmov,$ls_identidad,$ls_numdoc, $ls_ctaban,  $ls_nomban, $io_pdf); // Imprimimos la cabecera del registro
					...
					$io_pdf=uf_print_detalle($la_dataaux,$io_pdf,$x_pos); // Imprimimos el detalle 							
				} // Fin del for 2
