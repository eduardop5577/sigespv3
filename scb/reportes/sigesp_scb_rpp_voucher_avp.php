	...
	function uf_inicializar_variables()
	{
		...
		if((file_exists($ls_archivo)) && (filesize($ls_archivo)>0))
		{
			...
			if(count((array)$valores)<>$li_medidas)
			{
				...
				fclose($archivo);			
				print "<script>";
				print "alert('1Ocurrio un error, por favor cargue de nuevo el cheque (Las medidas seran inicializadas por fallo de lectura y escritura)');";
				print "close();";
				print "</script>";
			}
		}
		...
		{
			print "<script>";
			print "alert('2Ocurrio un error, por favor cargue de nuevo el cheque (Las medidas seran inicializadas por fallo de lectura y escritura)');";
			print "close();";
			print "</script>";
		}
