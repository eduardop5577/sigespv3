		...
		{	
			...
			for ($i=1;$i<=$li_total;$i++)
			{
				...
				for($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
					...
					$io_pdf=uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_cedrif,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
					...
					$io_pdf=uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_conmov,$ls_nomproben,$ls_cedrif,$ldec_total,$ld_fecmov,number_format($ls_montospg,2,",","."),$io_pdf); // Imprimimos la cabecera del registro
					...
					$io_pdf=uf_print_detalle_ret(array('title'=>'','title2'=>''),$la_data,$io_pdf);   
					$io_pdf->ezNewPage();
					$io_pdf=uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_cedrif,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf); // Imprimimos el encabezado de la página
