...
***********************************************************************************/
	...
	function uf_print_autorizacion($io_pdf)
	{
		...
		$io_pdf->line(200,43,200,118);
		$io_pdf->line(380,43,380,118);
		$io_pdf->addText(16,110,9,'<b>ELABORADO POR</b>');
		$io_pdf->addText(203,110,9,'<b>GERENTE ADMINISTRACION</b>');		
		$io_pdf->addText(383,110,9,'<b>PRESIDENTE ALAS</b>');
