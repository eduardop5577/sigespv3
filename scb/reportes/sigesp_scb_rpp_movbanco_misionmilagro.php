...
***********************************************************************************/
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,$ls_numdoc,$io_pdf)
	{
		...
		$io_pdf->line(480,668,480,728);
		$io_pdf->line(480,698,585,698);
        $io_pdf->Rectangle(15,668,570,60);
		$io_pdf->addJpegFromFile('../../shared/imagebank/banner_FMM_2017.jpg',20,730,550,70); // Agregar Logo
		$io_pdf->addText(200,715,12,'<b>Movimiento de Banco</b>');
		$io_pdf->addText(483,705,9,"<b>Fecha: </b>"); // Agregar el título
		$io_pdf->addText(520,705,9,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(483,675,9,"<b>Nro: </b>".$ls_numdoc); // Agregar el título			
		$io_pdf->Rectangle(15,540,570,120);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_autorizacion($ls_nomusureg,$io_pdf)
	{
		...
		$io_pdf->addText(480,137.6,9,'<b>Observaciones:</b>');
		$io_pdf->addText(258,78.85,10,'<b>Recibí Conforme</b>');
		$io_pdf->addText(16,95,8,$ls_nomusureg);	
