...
<form name="form1" method="post" action="">
  ...
  <div align="center">
	...
	print "<td>Procede</td>";
	print "<td>Voucher / No. Control</td>";
	...
	if ($ls_operacion=="BUSCAR")
       {
		 $ls_sql = "SELECT scb_movbco.codemp,scb_movbco.codban,scb_movbco.ctaban,scb_movbco.numdoc,scb_movbco.numordpagmin, ".
				   ...
				   "	   scb_movbco.procede,scb_movbco.estmovint,scb_movbco.numcarord,scb_banco.nomban, scb_movbco.codmon, scb_movbco.tascam, scb_movbco.montot, ".
		           ...
		           "      (SELECT sigesp_moneda.denmon
							 FROM sigesp_moneda
							WHERE sigesp_moneda.codemp=scb_movbco.codemp 
							  AND sigesp_moneda.codmon=scb_movbco.codmon) as denmon ".
...
<script language="JavaScript">
  ...
  function uf_aceptar(ls_documento,ls_codope,ls_fecha,ls_descripcion,ldec_monto,ldec_monobjret,ldec_monret,ls_tipo_destino,ls_prov,ls_bene,ls_provbene,ls_codban,
					  ...
					  ls_codfuefin,ls_numchequera,ls_numordpagmin,ls_codtipfon,ls_dentipfon,ls_numconint,ls_estreglib,ls_conanu,ls_voucher,
                                          ls_codmon,ls_denmon,ldec_tascam,ldec_montot)
  {
	...
	f.txtcodmon.value=ls_codmon;
	f.txtdenmon.value=ls_denmon;
	f.txttascam.value=ldec_tascam;
	f.txtmontot.value=ldec_montot;
