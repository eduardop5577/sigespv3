...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_modifnumdoc.php",$ls_permisos,$la_seguridad,$la_permisos);
    ...
    <tr>
	  ...
	  <?php
		 ...
		 if($ls_operacion=='CARGAR_DT')
		 {
			...
			$arr_object=Array();
			$li_total_record="";
	     	$arrResultado=$in_class_contabiliza->uf_select_banco_contabilizar_documento( $ls_operacion_bco, $arr_object ,$li_total_record,"N",$ls_numdoc,$ld_fecha);
			$arr_object=$arrResultado["arr_object"];
			$li_total_record=$arrResultado["ai_total_record"];
