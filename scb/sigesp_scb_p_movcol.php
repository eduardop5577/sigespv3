...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_movcol.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<?php
	...
	function uf_cargar_dt()
	{
		...
		$ldec_montoret="";
		$arrResultado="";
		$arrResultado=$in_classmovcol->uf_cargar_dt($ls_docmov,$ls_numcol,$ls_codban,$ls_cuenta_banco,$ls_mov_operacion,$objectScg,$li_row_scg,$ldec_mondeb,$ldec_monhab,$objectSpg,$li_temp_spg,$ldec_monto_spg,$objectSpi,$li_temp_spi,$ldec_monto_spi,$objectRet,$li_temp_ret,$ldec_montoret);
		...
		$objectRet=$arrResultado['objectRet'];
		$li_rows_ret=$arrResultado['li_temp_ret'];
		$ldec_montoret=$arrResultado['ldec_monto_ret'];
