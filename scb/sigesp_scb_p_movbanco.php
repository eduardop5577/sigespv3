...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="18" colspan="11" bgcolor="#E7E7E7" class="cd-menu"><script type="text/javascript"  src="js/menu.js"></script></td>
  </tr>
  <tr>
...
<?php
	...
	if( array_key_exists("operacion",$_POST))
	{
		...
		$ls_codmon=$_POST["txtcodmon"];
                ...
                $ldec_tascam=$_POST["txttascam"];
		$ldec_montot=$_POST["txtmontot"];
		...
		$ldec_montoret=str_replace(",",".",$ldec_montoret);
		$ldec_tascam=str_replace(".","",$ldec_tascam);
		$ldec_tascam=str_replace(",",".",$ldec_tascam);
		$ldec_montot=str_replace(".","",$ldec_montot);
		$ldec_montot=str_replace(",",".",$ldec_montot);
		$ldec_tascam=intval($ldec_tascam);
...
//		$ls_numcontint= $io_keygen->uf_generar_numero_nuevo("SCB","scb_movbco","numconint","SCBBRE",15,"valinimovban","","");
	...
	function uf_cargar_dt()
	{
		...
		global $ls_chevau;
                global $ls_codmon, $ls_denmon, $ldec_tascam, $ldec_montot;
		$objectScg=Array();
		$li_row="";
		$ldec_mondeb=0;
		$ldec_monhab=0;
		...
		//$ldec_diferencia= number_format(($ldec_mondeb-$ldec_monhab),2,',','.');
...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td width="97" height="22" style="text-align:right">Banco</td>
      <td colspan="3" style="text-align:left"><input name="txtcodban" type="text" id="txtcodban"  style="text-align:center" value="<?php print $ls_codban;?>" size="10" readonly>
        ...
        <input name="txtdenban" type="text" id="txtdenban" value="<?php print $ls_denban?>" size="51" class="sin-borde" readonly>      </td><td width="87" style="text-align:right">Fecha</td>
      <td width="164" style="text-align:left"><input name="txtfecha" type="text" id="txtfecha"  style="text-align:center" value="<?php print $ld_fecha;?>" size="24" maxlength="10" datepicker="true" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);"></td>
    </tr>
...
-->	<tr>
      ...
      <td colspan="3" style="text-align:">
        ...
        <a href="javascript:catalogo_cuentabanco(<?php echo $_SESSION["la_empresa"]["confi_ch"]?>,'<?php echo $ls_mov_operacion?>');"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat&aacute;logo de Cuentas Bancarias"></a>
    ...
    <tr>
      <td height="22" style="text-align:right">Moneda</td>
      <td colspan="3" style="text-align:left">
        <input name="txtcodmon" type="text" id="txtcodmon" style="text-align:center" value="<?php print $ls_codmon;?>" size="4" maxlength="3" readonly>
        <input name="txtdenmon" type="text" id="txtdenmon" style="text-align:center" value="<?php print $ls_denmon;?>" size="20" maxlength="50" readonly>
        Tasa de Cambio
        <input name="txttascam" type="text" id="txttascam" style="text-align:center" value="<?php print number_format($ldec_tascam,8,",",".");?>" size="15" maxlength="13" readonly></td>
    ...
    <tr>
      ...
      <td width="127" style="text-align:left"></td>
    </tr>
    ...
    <tr>
	  ...
	  {
	  ?>
	  <td align="right"><input name="chkimpco" type="checkbox" class="sin-borde" id="chkimpco" onClick="javascript:uf_imprimircarta();" style="width:15px; height:15px" value="1"></td>
      <td width="134" align="left">Imprimir Carta Orden </td>
	  <?php 
	  }
	  else
	  {
	  ?>
	  <td align="right"><input name="chkimpco" type="checkbox" class="sin-borde" id="chkimpco" onClick="javascript:uf_imprimircarta();"style="width:15px; height:15px" ></td>
      <td width="164" align="left">Imprimir Carta Orden </td>
	  <?php
	  }
	  ?>  
	  <input name="checkboxco" type="hidden" id="checkboxco" value="<?php print $chk_co;?>">
      <td align="right"><?php if($ls_mov_operacion=="CH")
								{
									print "Voucher";
								}
								?></td>
      <td width="142" style="text-align:left"><?php if($ls_mov_operacion=="CH")
								{?>
...
<input name="txtmonto" type="text" id="txtmonto" style="text-align:right" onBlur="javascript:uf_montoobjret(this);javascript:uf_verificar_monto(this);" onKeyPress="return(currencyFormat(this,'.',',',event));" value="<?php print number_format($ldec_montomov,2,",",".");?>" size="24" maxlength="22">	  </div></td>
      <td width="62"><div align="right">M.O.R.</div></td>
      <td>
        <div align="left">
    ...
    <tr>
      ...
      <td>Monto Total</td>
      <td><input name="txtmontot" type="text" id="txtmontot" style="text-align:right" value="<?php print  number_format($ldec_montot,2,",",".");?>" size="24" maxlength="22" readonly></td>
		    ...
		    if ((ls_codban!=""))
		       {
				 ...
				 {
					 if(operacion == 'CH'){
						pagina="sigesp_cat_ctabanco2.php?codigo="+ls_codban+"&hidnomban="+ls_nomban+"&codcon="+valor+"&fecha="+ls_fecha;	
					 }
					 else {
						pagina="sigesp_cat_ctabanco.php?codigo="+ls_codban+"&hidnomban="+ls_nomban+"&codcon="+valor+"&fecha="+ls_fecha;	
					 }
					   ...
					   if ((ls_status!="C")&&(ls_status!='O')&&(ls_status!='A'))
						  {
							...
							{		
								...
								ls_codfuefin=f.txtftefinanciamiento.value;
                                                                ...
                                                                ls_tascam=f.txttascam.value;
                                                                ldec_montot=f.txtmontot.value;
                                                                while(ls_tascam.indexOf('.')>0)
                                                                {//Elimino todos los puntos o separadores de miles
                                                                        ls_tascam=ls_tascam.replace(".","");
                                                                }
                                                                ls_tascam=ls_tascam.replace(",",".");
                                                                while(ldec_montot.indexOf('.')>0)
                                                                {//Elimino todos los puntos o separadores de miles
                                                                        ldec_montot=ldec_montot.replace(".","");
                                                                }
                                                                ldec_montot=ldec_montot.replace(",",".");
								if (f.nocontabili.checked==true)
								   {
									 ...
									 if (lb_valido)
										{
										  ...
										  ls_pagina = "sigesp_w_regdt_contable.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+ld_fecha+"&procede="+ls_procede+"&tipo="+ls_tipo+
													  ...
													  "&anticipo="+ls_anticipo+"&codtipfon="+ls_codtipfon+"&numordpagmin="+ls_numordpagmin+"&estcob="+li_estcob+"&numconint="+ls_numconint+
                                                                                                          "&reglibro="+ls_reglibro+"&nocontabiliza="+ls_contabilizable+"&codmon="+ls_codmon+"&tascam="+ls_tascam+"&montot="+ldec_montot;
							  ...
							  if (lb_valido)
								 {
								   ...
								   ls_pagina = "sigesp_w_regdt_presupuesto.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+ld_fecha+"&procede="+ls_procede+
											  ...
											  "&estmov="+ls_estmov+"&codconmov="+ls_codconmov+"&tip_mov= &opener=sigesp_scb_p_movbanco.php&estdoc="+ls_estdoc+"&codfuefin="+ls_codfuefin+
                                                                                          "&numordpagmin="+ls_numordpagmin+"&codtipfon="+ls_codtipfon+"&estcob="+li_estcob+"&numconint="+ls_numconint+"&reglibro="+ls_reglibro+
                                                                                          "&codmon="+ls_codmon+"&tascam="+ls_tascam+"&montot="+ldec_montot;
			  	...
			  	if ((ls_status!="P"))
				{
						...
						if((lb_valido)&&(ls_provbene!="")&&(ls_descripcion!="")&&(ls_codban!="")&(ls_ctaban!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ls_codconmov!="")&&(ldec_monto>0))
						{
							if((ls_operacion=="NC")||(ls_operacion=="DP"))
							{
								...
								ls_pagina = "sigesp_w_regdt_ingreso.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+
                                                                            "&fecha="+ld_fecha+"&procede="+ls_procede+"&tipo="+ls_tipo+"&provbene="+ls_provbene+
                                                                            "&descripcion="+ls_descripcion+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&cuenta_scg="+ls_cuenta_scg+
                                                                            "&mov_operacion="+ls_operacion+"&monto="+ldec_monto+"&objret="+ldec_objret+"&retenido="+ldec_monret+
                                                                            ...
                                                                            "&tip_mov= &opener=sigesp_scb_p_movbanco.php&estdoc="+ls_estdoc+"&codfuefin="+ls_codfuefin+
                                                                            "&numordpagmin="+ls_numordpagmin+"&codtipfon="+ls_codtipfon+"&estcob="+li_estcob+"&numconint="+ls_numconint+
                                                                            "&codmon="+ls_codmon+"&tascam="+ls_tascam+"&montot="+ldec_montot;;
		   ...
		   if ((ls_status!="C")&&(ls_status!='O')&&(ls_status!='A'))
			  {
			  	if ((ls_status!="P"))
				{
					...
					if(lb_valido)
					{
						...
						{
						 if ((ls_operacion=="CH")&&(ls_tascam==1))
							{
							  ld_totmondis = f.txtdisponible.value;
							  ls_tipvaldis = "<?php echo $ls_tipvaldis; ?>";
							  lb_valido    = uf_validar_disponible(ls_operacion,ls_tipvaldis,ld_totmondis,f.txtmonto.value);
...
function  uf_montoobjret(obj)
{
    ...
    tascam=parseFloat(uf_convertir_monto(f.txttascam.value));      
    if(tascam>1)
    {
        ldec_monto=parseFloat(uf_convertir_monto(ldec_monto));
        ldec_montototal=eval(ldec_monto*tascam);
        f.txtmontot.value=uf_convertir(ldec_montototal);
    }
    else
    {
        f.txtmontot.value=ldec_monto;
    }
}
