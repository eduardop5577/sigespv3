...
<html>
<head>
<title>Configuraci&oacute;n Formato Cheque Voucher Banco Sofitasa</title>
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
$ls_archivo="reportes/cheque_configurable/medidas_sofitasa.txt";
$li_medidas=22;
...
function uf_obtener_data_archivo()
{
	...
	else
	{
		...
		if(count((array)$valores)==$li_medidas)
		{
			...
			$ls_elaboradoporx=number_format($valores[20],2,",",".");
			global $ls_elaboradopory;
			$ls_elaboradopory=number_format($valores[21],2,",",".");
			
		}
		else
		{
			print "<script>";
			print "alert('Error de Lectura y Escritura 5: Debe generar un Cheque Voucher de prueba para inicializar las medidas');";
			print "location.href='sigespwindow_blank.php';";
			print "</script>";
		}		
	}
...
?> 
  <table width="395" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="6" align="center">Configuraci&oacute;n Formato Cheque Voucher Banco Sofitasa </td>
    </tr>
    <tr>
      <td height="13" colspan="6" align="center">&nbsp;</td>
    </tr>
    <tr class="titulo-ventana">
      <td height="506" colspan="6" align="center" class="celdas-blancas"><div align="left"></div>        
