			    ...
			    while(!$rs_data->EOF)
				     {
					   ...
					   $ls_scgcta = $rs_data->fields["sc_cuenta"];
						...
						$arrResultado="";
						$lb_valido ="";
						$arrResultado=$io_ctaban->uf_verificar_saldo($ls_codban,$ls_ctaban,$ldec_saldo);
						$ldec_saldo=$arrResultado['ldec_saldo'];
						$lb_valido=$arrResultado['lb_valido'];
					   echo "<td width=90  style=text-align:center><a href=\"javascript: uf_aceptar('$ls_cedben','$ls_nomben','$ls_codban','$ls_nomban','$ls_ctaban','$ls_nomcta','$ls_scgcta','$ldec_saldo');\">".$ls_cedben."</a></td>";
