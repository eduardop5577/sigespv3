...
<html>
<head>
<title>Listado de Documentos Descuadrados</title>
...
<form name="form1" method="post" action="">
  ...
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="4" align="center">Listado de Documentos Descuadrados </td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" align="center"><div align="right">Operaci&oacute;n</div></td>
    ...
    <tr>
      ...
      <td width="151" height="22" align="center"><div align="left">
        <input name="txtfecdesde" type="text" id="txtfecdesde"  style="text-align:center" size="24" maxlength="10" onKeyPress="currencyDate(this);"  datepicker="true">
      </div></td>
      <td width="80" align="center"><div align="right">Hasta</div></td>
      <td width="245" align="center"><div align="left">
        <input name="txtfechasta" type="text" id="txtfechasta" style="text-align:center" onKeyPress="currencyDate(this);"  datepicker="true">
      </div></td>
    </tr>
    <tr>
...
function ue_search()
{
  ...
  pagina="reportes/sigesp_scb_rpp_descuadrados_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codope="+ls_codope+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&orden="+ls_orden;
