...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_r_comp_ret_mun.php",$ls_permisos,$la_seguridad,$la_permisos);
...
if (array_key_exists("operacion",$_POST))
   ...
   if($ls_operacion=="CARGAR_DT")
   {
		...
		$object="";
		$li_total="";
		$arrResultado=uf_cargar_docs($object,$li_total,$ls_mes,$ls_agno);
