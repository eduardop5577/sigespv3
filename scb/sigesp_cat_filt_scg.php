...
<br>
      ...
      <tr>
        ...
        <input name="filtro" type="hidden" id="filtro" value="<?php print $ls_filtro;?>"></td>
...
if($ls_operacion=="BUSCAR")
{
	$ls_cadena ="SELECT sc_cuenta, denominacion, status, asignado, distribuir," . 
		   ...
		   "WHERE codemp = '".$as_codemp."' AND sc_cuenta like '".$ls_filtro."%' AND denominacion like '".$ls_denominacion."' ORDER BY sc_cuenta";
...
//$ls_sql="SELECT SC_cuenta,denominacion FROM SIGESP_Plan_unico ";
	...
	{
		$msg->message("No se han creado Cuentas Contables");
	}
}
print "</table>";
?>
...
<script language="JavaScript">
  ...
  {
    opener.document.form1.txtcuentascg.value=cuenta;
	opener.document.form1.txtdenominacionscg.value=d;
