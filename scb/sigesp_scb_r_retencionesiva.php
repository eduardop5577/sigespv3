...
$la_seguridad=Array();
$la_permisos=Array();
    $arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_r_retencionesiva.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_permisos=$arrResultado["as_permisos"];
	$la_seguridad=$arrResultado["aa_seguridad"];
	$la_permisos=$arrResultado["aa_permisos"];
	$ls_reporte=$io_fun_banco->uf_select_config("CXP","REPORTE","FORMATO_RETIVA","sigesp_cxp_rpp_retencionesiva.php","C");
	$li_diasem = date('w');
	switch ($li_diasem){
...
function ue_print()
{
	...
	if(li_imprimir==1)
	{
		...
		if(ls_comprobantes!="")
		{
			...
			pagina="../cxp/reportes/"+formato+"?comprobantes="+ls_comprobantes+"&tiporeporte="+tiporeporte;
