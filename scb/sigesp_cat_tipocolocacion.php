  ...
  <p align="center">
    <input name="operacion" type="hidden" id="operacion">
  	 ...
  	 <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    	<tr>
     	 	<td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Tipos de Colocaciones </td>
    	</tr>
	 </table>
	 <br>
...
<script language="JavaScript">
  ...
  {
    opener.document.form1.txttipocolocacion.value=codigo;
    opener.document.form1.txtnomtipcol.value=deno;
	close();
  }
  function ue_search()
  {
  ...
  f.action="sigesp_catdinamic_tipocolocacion.php";
  f.submit();
  }
</script>
</html>
