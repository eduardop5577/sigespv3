...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_r_reg_contables.php",$ls_permisos,$la_seguridad,$la_permisos);
  ...
  { 
	...
	function cat_ctabanco()
	{
	   ...
	   tipo2="RPT";
		...
		{
			window.open("sigesp_cat_ctabanco.php?codigo="+ls_codban+"&hidnomban="+ls_denban+"&tipo2="+tipo2,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=620,height=400,left=50,top=50,location=no,resizable=yes");
		}
	}
