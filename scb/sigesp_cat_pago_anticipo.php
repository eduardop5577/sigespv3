...
<form name="form1" method="post" action="">
  ...
  <div align="center">
	...
	if ($ls_operacion=="BUSCAR")
       {
		 $ls_sql = "SELECT scb_movbco.codemp,scb_movbco.codban,scb_movbco.ctaban,scb_movbco.numdoc, ".
				   ...
				   "	   scb_ctabanco.dencta,scb_ctabanco.sc_cuenta,scb_cheques.numchequera, ".
...
<script language="JavaScript">
  ...
  function uf_aceptar(ls_documento,ls_codope,ls_fecha,ls_descripcion,ldec_monto,ldec_monobjret,ldec_monret,ls_tipo_destino,ls_prov,ls_bene,ls_provbene,ls_codban,
  					  ls_nomban,ls_ctaban,ls_dencta,ldec_saldo,ls_estmov,ls_cuenta_scg,li_cobing,li_estint,ls_codconmov,ls_numcarord,li_estimpche,ls_estcon,
					  ls_codfuefin,ls_numchequera)
  {
	...
	if(document.form1.opener.value=='sigesp_scb_p_pago_anticipo')
	{
  ...
  function ue_search()
  {
	  ...
	  if((ls_fecdesde!="")&&(ls_fechasta!=""))
	  {
		  ...
		  f.action="sigesp_cat_pago_anticipo.php";
		  f.submit();
	  }
	  else
	  {
