...
if ($ls_operacion=="BUSCAR")
   {
	 ...
	 $ls_sql = " SELECT a.codestpro1 as codestpro1,a.denestpro1 as denestpro1,b.codestpro2 as codestpro2,
				  ...
				  ORDER BY a.codestpro1,b.codestpro2,c.codestpro3,d.codestpro4,e.codestpro5";
			   ...
			   while ($row=$io_sql->fetch_row($rs_data))
			         {
				       ...
				       if ($ls_tipo=="")
				          {
							print "<td width=120 style=text-align:center><a href=\"javascript: aceptar('$ls_codestpro1','$ls_denestpro1','$ls_codestpro2','$ls_denestpro2','$ls_codestpro3','$ls_denestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".$ls_codestpro1."</a></td>";
							print "<td width=120 style=text-align:center><a href=\"javascript: aceptar('$ls_codestpro1','$ls_denestpro1','$ls_codestpro2','$ls_denestpro2','$ls_codestpro3','$ls_denestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".$ls_codestpro2."</a></td>";
							print "<td width=120 style=text-align:center><a href=\"javascript: aceptar('$ls_codestpro1','$ls_denestpro1','$ls_codestpro2','$ls_denestpro2','$ls_codestpro3','$ls_denestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".$ls_codestpro3."</a></td>";
							print "<td width=120 style=text-align:center><a href=\"javascript: aceptar('$ls_codestpro1','$ls_denestpro1','$ls_codestpro2','$ls_denestpro2','$ls_codestpro3','$ls_denestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".$ls_codestpro4."</a></td>";
							print "<td width=120 style=text-align:center><a href=\"javascript: aceptar('$ls_codestpro1','$ls_denestpro1','$ls_codestpro2','$ls_denestpro2','$ls_codestpro3','$ls_denestpro3','$ls_codestpro4','$ls_denestpro4','$ls_codestpro5','$ls_denestpro5','$ls_estcla');\">".$ls_codestpro5."</a></td>";
				          }
				       if ($ls_tipo=="apertura")
						  {
					   ...
					   print "<td width=120 style=text-align:left title='".$ls_denestpro5."'>".$ls_denestpro5."</td>";
...
<script language="JavaScript">
  ...
  function aceptar(codestprog1,denestprog1,codestprog2,denestprog2,codestprog3,denestprog3,codestprog4,denestprog4,
                   codestprog5,denestprog5,as_estcla)
  {
	...
	opener.document.form1.hidtipestpro.value=as_estcla;
	close();
  }
