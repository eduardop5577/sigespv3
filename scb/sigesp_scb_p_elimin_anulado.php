...
$la_seguridad=array();
$la_permisos=array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_elimin_anulado.php",$ls_permisos,$la_seguridad,$la_permisos);
    ...
    <tr>
	  ...
	  <?php
		 ...
		 if($ls_operacion=='CARGAR_DT')
		 {
			...
			$arr_object=array();
			$li_total_record=0;
	     	$arrResultado=$in_class_contabiliza->uf_select_banco_contabilizar( $ls_operacion_bco, $arr_object ,$li_total_record,"A",$ls_numdoc,$ld_fecha);
