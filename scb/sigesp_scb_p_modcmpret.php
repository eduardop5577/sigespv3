...
$la_seguridad=Array();
$la_permisos=Array();
	$arrResultado=$io_fun_scb->uf_load_seguridad("SCB","sigesp_scb_p_modcmpret.php",$ls_permisos,$la_seguridad,$la_permisos);
...
switch($ls_operacion)
{
	case "NEW":
	  ...
	  $ls_mes=date('m');
	  $ls_numcom="";
	  $ls_numcom=$io_cmpret->uf_get_nrocomprobante($ls_ano.$ls_mes,$ls_numcom);
	  $ls_parametros="";
