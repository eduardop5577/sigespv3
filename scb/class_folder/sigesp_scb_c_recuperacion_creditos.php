...
class sigesp_scb_c_recuperacion_creditos
{
  public function __construct($as_path)
  {
					  ...
					  if ($lb_exiban && $lb_exicta)
						 {
						   ...
						   $ls_nomban ="";
						   $ls_denctaban="";
					       $arrResultado = $this->uf_load_denominaciones($ls_codban,$ls_ctaban,$ls_denctaban);
	...
	function uf_insert_movimiento_banco($as_filnam,$as_numdoc,$as_codban,$as_ctaban,$as_codope,$aa_datos,$aa_seguridad)
	{
	  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_insert_movimiento_banco_scg($as_filnam,$as_numdoc,$as_codban,$as_ctaban,$as_codope,$aa_datos,$aa_seguridad)
	{
	  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      $lb_valido = true;
	  $li_totscg = count((array)$aa_datos);
	  if ($li_totscg>0)
		 {
	...
	function uf_insert_movimiento_banco_spi($as_filnam,$as_numdoc,$as_codban,$as_ctaban,$as_codope,$aa_datos,$aa_seguridad)
	{
	  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      $lb_valido = true;
	  $li_totspi = count((array)$aa_datos);
	  if ($li_totspi>0)
		 {
			     ...
			     if (!empty($ls_filnam))
				    {
					  ...
					  $li_totdat = count((array)$la_datmov);
					  for ($li_z=1;$li_z<=$li_totdat;$li_z++)
					      {
							...
							if (!$lb_existe && $lb_valido)
							   {
							   	 $ls_errmsg="";
							     $lb_valido = $this->uf_insert_movimiento_banco($ls_filnam,$ls_numdoc,$ls_codban,$ls_ctaban,$ls_codope,$la_datmov,$aa_seguridad);
							     if ($lb_valido)
								    {
									  $la_datscg = $this->io_xml->uf_cargar_scb_movbco_scg($ls_rutori);
									  if (!empty($la_datscg))
									     {$ls_errmsg="";
										   $lb_valido = $this->uf_insert_movimiento_banco_scg($ls_filnam,$ls_numdoc,$ls_codban,$ls_ctaban,$ls_codope,$la_datscg,$aa_seguridad); 
										   unset($la_datscg);
										 }									  
									  else
									     {
							     ...
							     if ($lb_valido)
								    {
									  ...
									  if (!empty($la_datspi))
									     {$ls_errmsg="";
										   $lb_valido = $this->uf_insert_movimiento_banco_spi($ls_filnam,$ls_numdoc,$ls_codban,$ls_ctaban,$ls_codope,$la_datspi,$aa_seguridad); 
										   unset($la_datspi);
										 }									  
									}
							   }							
