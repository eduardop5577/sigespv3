...
//Catalogo utilizado para  selección de la cuenta auxiliar en la transferencia bancaria
?>
...
<script language="JavaScript">
  ...
  {
    opener.document.form1.txtctascg.value=cuenta;
	opener.document.form1.txtdenctascg.value=d;
