...
$la_seguridad=array();
$la_permisos=array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_cmp_ret_mun_otros.php",$ls_permisos,$la_seguridad,$la_permisos);
...
$lb_selDiciembre="";
	...
	if($ls_operacion=="NUEVO")
	{
		...
		$lb_valido="";
		$ls_nrocomp="";
		$arrResultado = $io_cmpret->uf_ccr_get_nro($ls_periodofiscal,$ls_numcom);
		$lb_valido=$arrResultado["lb_valido"];
		$ls_numcom=$arrResultado["ls_nrocomp"];
		if(!$lb_valido) 
		{
