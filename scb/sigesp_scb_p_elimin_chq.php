...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_elimin_chq.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<?php
	...
	if($ls_operacion=="CAMBIO_TIPO")
	{
		...
		$lb_valido="";
		$rs_data="";
		$arrResultado= $io_cheques->uf_cargar_cheques_filtrados($ls_empresa,$ls_tipo,$ld_fechadesde,$ld_fechahasta,$ls_documento,$lb_valido);
