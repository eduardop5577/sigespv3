...
<html>
<head>
<title>Cat&aacute;logo de Movimientos Bancarios ( Cheques )</title>
...
<form name="form1" method="post" action="">
  ...
  <table width="565" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Movimientos Bancarios ( Cheques ) </td>
    </tr>
  </table>
  <br>
  <div align="center">
...
if($ls_operacion=="BUSCAR")
{
		$ls_sql="SELECT * FROM scb_movbco 
				 WHERE codemp='".$as_codemp."' AND numdoc like '".$ls_documento."' AND codope='CH' AND estbpd ='D'";
...
<script language="JavaScript">
  ...
  function uf_aceptar(ls_documento,ls_codope,ls_fecha,ls_descripcion,ldec_monto,ldec_monobjret,ldec_monret,ls_prov,ls_bene,ls_provbene,ls_codban,ls_nomban,ls_ctaban,ls_dencta,ls_estmov,ls_cuenta_scg,li_cobing,li_estint,ls_codconmov,ldec_saldo)
  {
	...
	f.txtdisponible=ldec_saldo;
	f.totalchq.value=uf_convertir(ldec_monto);
  ...
  function ue_search()
  {
	  ...
	  f.action="sigesp_cat_mov_chq.php";
	  f.submit();
  }
