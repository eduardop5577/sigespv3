...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_r_documentos.php",$ls_permisos,$la_seguridad,$la_permisos);
...
else
{
	...
	$ls_numdocmov = "";
	  ...
	  else
	  {
		if($ls_orden==1)
		{
			$ls_orden = " scb_movbco.numdoc ASC, scb_movbco.fecmov ASC";
		}
		if($ls_orden==2)
		{
			$ls_orden = " scb_movbco.fecmov ASC, scb_movbco.numdoc ASC";
		}	
	}
}

function uf_load_documentos($as_codemp,$as_codban,$as_ctaban,$as_codope,$as_conmov,$as_fecdes,$as_fechas,$as_estmov,$ls_numdocmov,$ls_orden,$lb_valido)
{
  global $io_sql;
  global $io_funcion;
  ...
  if (!empty($as_conmov))
  {
    $ls_straux = $ls_straux." AND scb_concepto.denconmov like '%".$as_conmov."%'";
  }
  ...
  $ls_sql  = " SELECT scb_movbco.codemp,scb_movbco.codban,scb_movbco.ctaban,scb_movbco.numdoc,scb_movbco.codope,scb_movbco.estmov, ".
			 ...
			 " ORDER BY $ls_orden ";//print $ls_sql;
...
?>
  <table width="603" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="116" height="22" align="center"><div align="left">
      ...
      <td width="313" height="22" align="center"><div align="left">
    ...
    <tr>
      <td height="22" colspan="4" align="center"  class="titulo-ventana">Ordenado Por</td>
    </tr>
    <tr>
      <td height="22" align="right">Nro Documento </td>
      <td height="22" colspan="3" align="left"><input name="rdborden" type="radio" class="sin-borde" value="1" checked></td>
    </tr>
    <tr>
      <td height="22" align="right">Fecha</td>
      <td height="22" colspan="3" align="left"><input name="rdborden" type="radio" class="sin-borde" value="2"></td>
    </tr>
    <tr>
...
if ($ls_operacion=="BUSCAR")
   {
	 $lb_valido = true;
	 $li_fila   = 0;
	 $rs_data   = uf_load_documentos($ls_codemp,$ls_codban,$ls_ctaban,$ls_codope,$ls_conmov,$ld_fecdes,$ld_fechas,$ls_estmov,$ls_numdocmov,$ls_orden,$lb_valido);
	 if ($lb_valido)
	    {
	      $title[1] = ""; 
	...
	function catalogo_cuentabanco()
	 {
	   ...
	   tipo2="RPT";
	  	   if((ls_codban!=""))
		   {
			   pagina="sigesp_cat_ctabanco.php?codigo="+ls_codban+"&hidnomban="+ls_nomban+"&tipo2="+tipo2;
...
function ue_imprimir()
{
  ...
  ls_textconc    = f.txtconcepto.value;
  ls_docs		 = "";
  ls_chkmarc=0;
  if (li_imprimir=='1')
     {
	   ...
	   if (ls_codban=="" || ls_ctaban=="" || ls_nomban=="")
	      ...
	      {
 	        pagina="reportes/"+ls_reporte+"?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codope="+ls_codope+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&codconcep="+ls_concepto+"&orden="+ls_orden+"&hidestmov="+ls_estmov+"&nomban="+ls_nomban+"&tiporeporte="+ls_tiporeporte+"&documento="+ls_numdoc+"&chked="+ls_chkmarc+"&chkados="+ls_docs+"&conceptos="+ls_textconc;
