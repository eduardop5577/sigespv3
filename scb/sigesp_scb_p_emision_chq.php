  ...
  <table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td height="22" style="text-align:left">
        ...
        ?>
        <input name="txtdocumento" type="text" id="txtdocumento" value="<?php print $ls_numdoc;?>" size="24" maxlength="15" onBlur="javascript:chequear_numero_IBS();" style="text-align:center" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+'-()[]{}#/');" <?php print $ls_lectura; echo $ls_disabled;?> >
        <?php 
         }
         else {
        ?>
		...
		for(i=1;i<=li_total;i++)
	  	{
	  		if(eval("f.chk"+i+".checked"))
			{
				...
				if (valid_fecha==false)
		  		...
		  		{
		  			alert("La fecha de emisión de cheque no debe ser menor a la solicitud de pago !!!");
		  		}
			}
	 	}	 
	}
