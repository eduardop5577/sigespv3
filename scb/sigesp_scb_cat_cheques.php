...
if($ls_operacion=="BUSCAR")
{
		...
		$li_x=0;
		$ls_sql="SELECT distinct(a.numchequera),a.numchequera as numchequera,a.codban as codban,a.ctaban as ctaban ,b.nomban as nomban,c.dencta as dencta,d.codtipcta as codtipcta,d.nomtipcta as nomtipcta
			 FROM scb_cheques a,scb_banco b,scb_ctabanco c,scb_tipocuenta d
			 WHERE a.codemp=b.codemp AND a.codemp=c.codemp  AND a.codban=b.codban AND a.ctaban=c.ctaban
			 AND b.codban=c.codban AND c.codtipcta=d.codtipcta AND a.codemp='".$ls_codemp."' AND a.codban  like '".$ls_codban."' AND a.ctaban like '".$ls_cuenta."'";
