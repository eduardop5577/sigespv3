...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_entregach.php",$ls_permisos,$la_seguridad,$la_permisos);
...
if ($ls_operacion == "CARGAR")
   {			
	 ...
	 $li_total=0;
	 $arrResultado=array();
	 $arrResultado=$in_classentrega->uf_cargar_cheques($ls_provbene,$ls_tipo,$object,$li_total);
