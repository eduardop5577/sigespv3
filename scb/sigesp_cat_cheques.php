...
if ($ls_operacion=="BUSCAR")
   {
	 $ls_sql = "SELECT scb_cheques.codban as codban,scb_cheques.ctaban as ctaban ,scb_cheques.numche as numche,
		 	     ...
		 	     WHERE scb_cheques.codemp='".$ls_codemp."' 
				   ...
				   AND scb_cheques.codusu like '%:".$_SESSION['la_logusr'].":%' 
...
<script language="JavaScript">
  ...
  {
		if(opener.document.form1.id == 'sigesp_scb_p_transferencias.php') {
			opener.document.form1.txtdocorigen.value = numche;
		}
		else {
