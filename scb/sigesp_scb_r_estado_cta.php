...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_r_estado_cta.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Estado de Cuenta Formato 1</title>
...
?>
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="4" align="center">Estado de Cuenta Formato 1 </td>
    </tr>
    ...
    <tr>
      ...
      <td width="143" height="22" style="text-align:left"><input name="txtfecdesde" type="text" id="txtfecdesde"  style="text-align:center" onKeyPress="currencyDate(this);" value="<?php print $ld_fecdesde?>" size="24" maxlength="10"  datepicker="true"></td>
  ...
  if (li_imprimir=='1')
     {
       if ((ld_fecdesde!="")&&(ld_fechasta!="")&&(ls_codban!="")&&(ls_ctaban!=""))
          {
	        pagina="reportes/sigesp_scb_rpp_estado_cta_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&orden="+ls_orden+"&tiporeporte="+ls_tiporeporte;
	...
	function catalogo_cuentabanco()
	 {
	   ...
	   tipo2="RPT";
	  	   if((ls_codban!=""))
		   {
			   pagina="sigesp_cat_ctabanco.php?codigo="+ls_codban+"&hidnomban="+ls_denban+"&tipo2="+tipo2;
