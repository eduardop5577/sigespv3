...
$la_seguridad=array();
$la_permisos=array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_reverso_entregach.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<?php
 ...
 if ($ls_operacion == "CARGAR")
	{			
		...
		$li_total=0;
		$arrResultado=array();
		$arrResultado=$in_classentrega->uf_cargar_cheques($ls_cedula,$ls_nombre,$ls_provbene,$ls_tipo,$object,$li_total);
