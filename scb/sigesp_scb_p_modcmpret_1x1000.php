...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_modcmpret_1x1000.php",$ls_permisos,$la_seguridad,$la_permisos);
...
if ($ls_operacion=='NUEVO')
 ...
 if ($ls_operacion=="GUARDAR")
	...
	if($ls_operacion=="CARGAR_DT")	
	{
		...
		$object="";
		$li_total="";
		$arrResultado=$io_cmpret->uf_select_cmp_ret($ls_numcom,$ls_codret,$object,$li_total);
		$object=$arrResultado["object"];
		$li_total=$arrResultado["li_total_rows"];
	}
?>
<p>&nbsp;</p>
