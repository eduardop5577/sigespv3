...
if(array_key_exists("operacion",$_POST))
{
	...
	{
		uf_obtener_data_archivo($ls_archivo,$li_medidas);		
	}
...
function uf_obtener_data_archivo($ls_archivo,$li_medidas)
{
	global $ls_archivo;
	global $li_medidas;
	...
	else
	{
		...
		{
			print "<script>";
			print "alert('Error de Lectura y Escritura: Debe generar un Cheque Voucher de prueba para inicializ2ar las medidas');";
			print "location.href='sigespwindow_blank.php';";
			print "</script>";
		}		
	}
