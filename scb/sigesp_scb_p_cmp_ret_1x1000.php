...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_cmp_ret_1x1000.php",$ls_permisos,$la_seguridad,$la_permisos);
...
else
{
	...
	{		
		...
		{
			require_once("../cxp/class_folder/sigesp_cxp_c_cmp_retencion.php");
		...
		//	$in_class_cmp_ret->uf_comprobante_ret($ls_mes,$ls_agno,$ls_provbenedesde,$ls_provbenehasta,$ls_tipo);		
	        ...
	        $arrResultado=$io_retencion->uf_procesar_cmp_retencion($ls_mes,$ls_agno,$ls_provbenedesde,$ls_provbenehasta,$ls_tipo,"1",$la_numcmp,$la_seguridad);
