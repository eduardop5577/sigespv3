...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_conf_cartaorden.php",$ls_permisos,$la_seguridad,$la_permisos);
                  ...
                  <tr class="formato-blanco">
                    <td width="142" height="153" rowspan="4"><label>
                      <select name="lista" size="11" >
                        ...
                        <option value="@cuentabancariaemisor@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">N&ordm; de Cuenta Movimiento Emisor</option>						
                      	<option value="@conceptocarta@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">Concepto de la Carta Orden</option>
						...
						<option value="@fechaprogramacion@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">Fecha Programacion</option>
						<option value="@bancoreceptor@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">Banco Receptor</option>
						<option value="@cuentaproveedor@" onDblClick="javascript:uf_pasar('','selStart','selEnd');">Cuenta Bancaria Proveedor</option>
					  </select>
                    </label></td>
