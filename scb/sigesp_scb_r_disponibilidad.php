...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_r_disponibilidad.php",$ls_permisos,$la_seguridad,$la_permisos);
...
$arrResultado=uf_cargar_bancos($object_bancos,$li_total);
   ...
   $grid="grid";
	...
	//////////////////////////////////////////////////////////////////////////////
	  ...
	  $ls_sql="SELECT codban,MAX(nomban) AS nomban ".
	          "  FROM scb_banco, sss_permisos_internos".  
