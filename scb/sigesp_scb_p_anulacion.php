...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_anulacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<?php
	...
	if(($ls_operacion=="CAMBIO_TIPO"))
	{
		...
		$object="";
		$li_total="";
		$arrResultado=$io_documentos->uf_cargar_documentos($ls_codemp,$ls_codope,$object,$li_total);
