...
$la_seguridad=array();
$la_permisos=array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_orden_pago_directo.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<html>
<head>
<title>Orden de Pago Directa</title>
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="25" colspan="11" bgcolor="#E7E7E7" class="cd-menu"><script type="text/javascript"  src="js/menu.js"></script></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="toolbar" width="22"><div align="center"><a href="javascript:ue_generar_cmp();"><img src="../shared/imagebank/tools20/ejecutar.gif" alt="Generar Comprobante de Retenci&oacute;n IVA" title="Generar Comprobante de Retenci&oacute;n IVA"  width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="22"><div align="center"><a href="javascript:ue_generar_cmp_mun();"><img src="../shared/imagebank/tools20/ejecutar.gif" alt="Comprobante de Retenci&oacute;n Municipal" title="Comprobante de Retenci&oacute;n Municipal" width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="22"><div align="center"><a href="javascript:ue_generar_cmp_islr();"><img src="../shared/imagebank/tools20/ejecutar.gif" alt="Comprobante ISLR" title="Comprobante ISLR" width="20" height="20" border="0"></a></div></td>
...
if (($li_estciespg==1 || $li_estciespi==1) && $ls_operacion=="NUEVO")
   {
	...
	function uf_cargar_dt()
	{
		...
		$ldec_monspi="";
		$arrResultado="";
		$arrResultado=$in_classmovbco->uf_cargar_dt($ls_docmov,$ls_codban_tesoreria,$ls_ctaban_tesoreria,$ls_mov_operacion,$ls_estmov,$objectScg,$li_row,$ldec_mondeb,$ldec_monhab,$objectSpg,$li_rows_spg,$ldec_monspg,$objectSpi,$li_rows_spi,$ldec_monspi);
		$objectScg=$arrResultado['objectScg'];
		$li_row=$arrResultado['li_row_scg'];
		$ldec_mondeb=$arrResultado['ldec_mondeb'];
		$ldec_monhab=$arrResultado['ldec_monhab'];
		$objectSpg=$arrResultado['objectSpg'];
		$li_rows_spg=$arrResultado['li_temp_spg'];
		$ldec_monspg=$arrResultado['ldec_monto_spg'];
		$objectSpi=$arrResultado['objectSpi'];
		$li_rows_spi=$arrResultado['li_temp_spi'];
		$ldec_monspi=$arrResultado['ldec_monto_spi'];
	...
	function uf_nuevo($ls_config_ordpag)
	{
		...
		global $ls_nombanaut;
		global $ls_rifaut;
		global $ls_ctabanaut,$ls_estserext;
		$ls_nombreaut="";
		$ls_codbanaut="";
		$ls_nombanaut="";
		$ls_rifaut="";
		$ls_ctabanaut = $ls_estserext = "";
		...
		$objectSpg[$li_temp_spg][7]  = "<input type=text name=txtmonto".$li_temp_spg."        id=txtmonto".$li_temp_spg."        value='' class=sin-borde readonly style=text-align:right><input type=text name=txtmonobjret".$li_temp_spg."        id=txtmonobjret".$li_temp_spg."        value='' >";		
...
?>
  <form name="form1" method="post" action="" id="sigesp_scb_p_orden_pago_directo.php">
<?php
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr class="titulo-ventana">
      ...
      <input name="codestpro4" type="hidden" id="codestpro4">
      <input name="codestpro5" type="hidden" id="codestpro5">
      <input name="denestpro4" type="hidden" id="denestpro4">
      <input name="denestpro5" type="hidden" id="denestpro5"></td>
    </tr>
    <tr>
      <td colspan="6">&nbsp;</td>
    </tr>
    <tr>
      <td width="86" height="22"><div align="right">Modalidad  </div></td>
      <td height="22" colspan="3"><select name="cmbmodalidad" onChange="javascript:uf_valida_cambio();">
    ...
    <tr>
      ...
      <td height="22"><input name="txtdocumento" type="text" id="txtdocumento" style="text-align:center" value="<?php print $ls_docmov;?>" size="24" maxlength="<?php print $li_size_numordpag;?>" onBlur="javascript:rellenar_cad(this.value,<?php print $li_size_numordpag;?>,'doc')">
        <a href="javascript:cat_cheque();"></a>
        <input name="estmov" type="hidden" id="estmov" value="<?php print $ls_estmov;?>">
        <input name="txtchequera" type="hidden" id="txtchequera" value="<?php print $ls_numchequera;?>">      </td>
      <td height="22">&nbsp;</td>
      <td width="199" height="22">&nbsp;</td>
      <td width="75" height="22" style="text-align:right">Fecha</td>
      <td width="145" height="22" style="text-align:left"><input name="txtfecha" type="text" id="txtfecha"  style="text-align:center" value="<?php print $ld_fecha;?>" size="24" maxlength="10" datepicker="true" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);"></td>
    </tr>
	   <script >uf_validar_estatus_mes();</script>
    <tr>
      <td height="22"><div align="right">Unidad Administradora</div></td>
      <td height="22" colspan="5" style="text-align:left"><input name="txtcoduniadm" type="text" id="txtcoduniadm" value="<?php print $ls_unidad;?>" size="8" readonly style="text-align:center">
        ...
        <input name="txtdenuniadm" type="text" class="sin-borde" id="txtdenuniadm" value="<?php print $ls_denuniadm;?>" size="105" readonly>
        <input name="txtestuac" type="hidden" id="txtestuac" value="<?php print $ls_estuac;?>" size="5">
        <input name="txtresuac" type="hidden" id="txtresuac" value="<?php print $ls_respuac;?>" size="5">      <input name="codestpro3" type="hidden" id="codestpro3" style="text-align:center" value="<?php print $ls_codestpro3;?>" size="5">
        <input name="hidestcla" type="hidden" id="hidestcla" value="<?php echo $ls_estcla ?>"></td>
    </tr>
    <tr>
      <td height="20" style="text-align:right">Proyecto</td>
      <td height="20" colspan="5"><input name="codestpro1" type="text" id="codestpro1" style="text-align:center" value="<?php print $ls_codestpro1;?>" size="<?php echo $li_size1 ?>" maxlength="<?php echo $li_loncodestpro1 ?>" readonly>
        <a href="javascript:catalogo_estpro();"><img src="../shared/imagebank/tools15/buscar.gif" alt="Catalogo Estructura Presupuestaria" width="15" height="15" border="0"></a>
      <input name="denestpro1" type="text" class="sin-borde" id="denestpro1" value="<?php print $ls_proyecto;?>" size="90" readonly>
      ...
      <input name="denestpro3" type="hidden" id="denestpro3">      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="22" style="text-align:left"><table width="175" border="0" align="left" cellpadding="0" cellspacing="0" class="formato-blanco">
            <tr>
      ...
      <td height="22"><input name="tipo" type="hidden" id="tipo"></td>
    ...
    <tr>
      ...
      <td colspan="2"><input name="opepre" type="text" id="opepre" value="CCP" readonly size="8" maxlength="3" style="text-align:center" >
        <span class="Estilo1">      Compromete Causa y Paga  </span>        <div align="right">
          </div></td>
    </tr>
    <tr>
      <td height="22"><div align="right">Tipo Concepto</div></td>
      <td colspan="3"><div align="left">
    ...
    <tr>
      ...
      <td colspan="5"><div align="left">
          <input name="txtconcepto" type="text" id="txtconcepto" value="<?php print $ls_desmov;?>" size="120" onKeyPress="return keyRestrict(event,'0123456789'+'abcdefghijklmnopqrstuvwxyzñ .,*/-()$%&!ºªáéíóú[]{}<>')">
      </div></td>
    </tr>
    <tr>
      <td height="22"><div align="right">Monto</div></td>
      <td width="185"><div align="left">
          <input name="txtmonto" type="text" id="txtmonto" style="text-align:right" onBlur="javascript:uf_format(this);uf_montoobjret(this);" value="<?php print number_format($ldec_montomov,2,",",".");?>" size="24" onKeyPress="return(currencyFormat(this,'.',',',event));">
      </div></td>
      <td width="88"><div align="right">M. O. R.</div></td>
      <td><input name="txtmonobjret" type="text" id="txtmonobjret" style="text-align:right" onBlur="javascript:validar_monto();javascript:uf_format(this);" value="<?php print  number_format($ldec_monobjret,2,",",".");?>" size="24" onKeyPress="return(currencyFormat(this,'.',',',event));"></td>
      <td style="text-align:right">Retenido</td>
      <td><div align="left">
    ...
    <tr>
      ...
      <td colspan="3"><div align="left">
				...
				{
				?>
          			<input name="chkinteres" type="checkbox" class="sin-borde" id="chkinteres" onClick="uf_selec_interes(this);" value="1" <?php print $lb_checked;?>>
         		<?php	
				}	
				?>
    ...
    <tr>
      <td height="28"><div align="right">Tipo Documento </div></td>
      <td height="28"><div align="left">
        <input name="txttipdocres" type="text" id="txttipdocres" value="<?php print $ls_tipdocressig;?>" size="15" maxlength="2" style="text-align:center">
      </div></td>
      <td height="28"><div align="right">Nro. Documento </div></td>
      <td height="28"><div align="left">
        <input name="txtnumdocres" type="text" id="txtnumdocres" value="<?php print $ls_numdocressig;?>" size="17" maxlength="15">
      </div></td>
      <td height="28"><div align="right">Fecha de Pago </div></td>
      <td height="28"><div align="left">
        <input name="txtfecdocres" type="text" id="txtfecdocres" style="text-align:center" value="<?php print $ls_fecordpagsig;?>"  size="24" maxlength="10"  datepicker="true" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);">
      </div></td>
    </tr>
    <tr>
      ...
      <td height="13"><div align="right">Origen</div></td>
    ...
    <tr>
      ...
      <td height="13"><div align="right">Medio de Pago </div></td>
      ...
      <td height="13"><div align="right">Nro.Control</div></td>
    ...
    <tr>
      <td height="13"><div align="right">Nombre</div></td>
      <td height="13" colspan="2"><input name="nombreaut" type="text" id="nombreaut" value="<?php print $ls_nombreaut;?>" size="45" maxlength="60"></td>
      <td height="13" style="text-align:right">R.I.F</td>
      <td height="13" colspan="2"><input name="rifaut" type="text" id="rifaut" value="<?php print $ls_rifaut;?>" size="15" maxlength="10"></td>
    </tr>
    <tr>
      <td height="22" style="text-align:right">Banco</td>
      <td height="22" colspan="2" style="text-align:left"><input name="codbanaut" type="text" id="codbanaut" value="<?php print $ls_codbanaut;?>" size="4" maxlength="3" style="text-align:center" readonly><a href="javascript:catbanaut();"><img src="../shared/imagebank/tools15/buscar.gif" alt="Catalogo de Bancos" name="bot_provbene" width="15" height="15" border="0" id="bot_provbene"></a>  
        <input name="nombanaut" type="text" class="sin-borde" id="nombanaut" value="<?php print $ls_nombanaut;?>" size="33" readonly>      </td>
      <td height="22" style="text-align:right">Cuenta Nro.</td>
      <td height="22" colspan="2"><input name="ctabanaut" type="text" id="ctabanaut" value="<?php print $ls_ctabanaut;?>" size="30" maxlength="25"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" colspan="6"><div align="center"><?php $io_grid->makegrid($li_rows_spg,$title,$objectSpg,770,'Detalles Presupuestarios',$grid1);?>
              ...
              <input name="totalcargo" type="hidden" id="totalcargo" value="<?php print $ldec_cargos;?>">
      </div></td>
    </tr>
    <tr>
  ...
  if (uf_evaluate_cierre('SPG'))
     {
	   ...
	   f.action="sigesp_scb_p_orden_pago_directo.php";
	   f.submit();
	 }
}
			 ...
			 if ((ls_status!='C')&&(ls_status!='O')&&(ls_status!='A'))
			   {
				...
				ldec_monret=ldec_monret.replace(",",".");
				if((lb_valido)&&(ls_provbene!="")&&(ls_descripcion!="")&&(ls_codban!="")&(ls_ctaban!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto>0)&&(ls_codbansig!=""))
				{
...
function ue_imprimir()
{
	...
	ls_pagina="reportes/sigesp_scb_rpp_ordenpago.php?codban="+ls_codban+"&ctaban="+ls_ctaban+"&numdoc="+ls_numdoc+"&codope="+ls_codope+"&numdocres="+ls_numdocres+"&fecdocres="+ls_fecdocres+"&nrocontrol="+ls_nrocontrol+"&desope="+ls_desope;
		    ...
		    if (f.rb_provbene[0].checked==true)
		       {
			     ...
			     window.open("sigesp_cat_prov_op.php","Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=540,height=400,left=50,top=50,location=no,resizable=yes");
		       }
		    else if(f.rb_provbene[1].checked==true)
		       {
			     f.txtprovbene.disabled=false;	
			     window.open("sigesp_cat_bene_op.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=540,height=400,left=50,top=50,location=no,resizable=yes");
		       }
	      }
	   else
	      {
				...
				else
				{
					if((lb_valido)&&(ls_provbene!="")&&(ls_descripcion!="")&&(ls_codban!="")&(ls_ctaban!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto>0))
					{
						ls_pagina = "sigesp_w_regdt_cargos_op.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+
										...
										ls_codconmov+"&tip_mov= &opener=sigesp_scb_p_orden_pago_directo.php&estdoc="+ls_estdoc+"&tipdocres="+
										...
										"&codbanbene="+ls_codbanbene+"&ctabanbene="+ls_ctabanbene+"&nombanbene="+ls_nombanbene+"&hidestserext="+li_estserext;
						window.open(ls_pagina,"Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=585,height=310,left=50,top=50,location=no,resizable=yes,dependent=yes");
					}
					else
					{
	  ...
	  if (uf_evaluate_cierre('SPG'))
		 {
			...
			if((ls_status!='C')&&(ls_status!='O')&&(ls_status!='A'))
			{
				...
				else
				{
					if((lb_valido)&&(ls_provbene!="")&&(ls_descripcion!="")&&(ls_codban!="")&(ls_ctaban!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto>0))
					{
						ls_pagina = "sigesp_w_regdt_presupuesto_op.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+
										ld_fecha+"&procede="+ls_procede+"&tipo="+ls_tipo+"&provbene="+ls_provbene+"&descripcion="+
										ls_descripcion+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&cuenta_scg="+
										ls_cuenta_scg+"&mov_operacion="+ls_operacion+"&monto="+ldec_monto+"&objret="+ldec_objret+"&retenido="+
										ldec_monret+"&chevau="+ls_chevau+"&estint="+li_estint+"&cobrapaga="+li_cobrapaga+"&afectacion="+
										...
										"&tippag="+ls_tippag+"&mediopago="+ls_mediopago+"&modalidad="+ls_modalidad+"&coduniadm="+ls_coduniadm+"&estuac="+ls_estuac+"&codestpro1="+ls_codestpro1+"&denestpro1="+ls_denestpro1+"&codbansig="+ls_codbansig+
										"&nombreaut="+ls_nombreaut+"&codbanaut="+ls_codbanaut+"&nombanaut="+ls_nombanaut+"&rifaut="+ls_rifaut+"&ctabanaut="+ls_ctabanaut+
										"&codbanbene="+ls_codbanbene+"&ctabanbene="+ls_ctabanbene+"&nombanbene="+ls_nombanbene+"&hidestcla="+ls_estcla+"&hidestserext="+li_estserext;
	  ...
	  if (uf_evaluate_cierre('SPG'))
		 {
			...
			if((ls_status!='C')&&(ls_status!='O')&&(ls_status!='A'))
			{
				...
				ldec_objret=f.txtmonobjret.value;
				ldec_monret=f.txtretenido.value;
				ls_codconmov=f.ddlb_conceptos.value;alert("Antes=>"+ldec_objret);
				while(ldec_objret.indexOf('.')>0)
				{//Elimino todos los puntos o separadores de miles
					ldec_objret=ldec_objret.replace(".","");
				}
				ldec_objret=ldec_objret.replace(",",".");
				alert("Despues=>"+ldec_objret);
				...
				ls_nombanbene=f.txtdenban.value;
				ls_nrocontrol=f.txtnrocontrol.value;
				ldec_totalcargo=f.totalcargo.value;
				if(!lb_retencion)
				{
				...
				else
				{
					if((lb_valido)&&(ls_provbene!="")&&(ls_descripcion!="")&&(ls_codban!="")&(ls_ctaban!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto>0))
					{
						ls_pagina = ls_opener+"?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+
										...
										"&tippag="+ls_tippag+"&mediopago="+ls_mediopago+"&modalidad="+ls_modalidad+"&coduniadm="+ls_coduniadm+"&estuac="+ls_estuac+"&codestpro1="+ls_codestpro1+"&denestpro1="+ls_denestpro1+"&codbansig="+ls_codbansig+
										"&nombreaut="+ls_nombreaut+"&codbanaut="+ls_codbanaut+"&nombanaut="+ls_nombanaut+"&rifaut="+ls_rifaut+"&ctabanaut="+ls_ctabanaut+
										"&codbanbene="+ls_codbanbene+"&ctabanbene="+ls_ctabanbene+"&nombanbene="+ls_nombanbene+"&totalcargo="+ldec_totalcargo+"&hidestserext="+li_estserext;
