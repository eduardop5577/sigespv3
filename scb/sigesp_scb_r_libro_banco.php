...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_r_libro_banco.php",$ls_permisos,$la_seguridad,$la_permisos);
$ls_permisos=$arrResultado["as_permisos"];
$la_seguridad=$arrResultado["aa_seguridad"];
$la_permisos=$arrResultado["aa_permisos"];

$ls_reporte   = $io_fun_banco->uf_select_config("SCB","REPORTE","LIBRO_BANCO","sigesp_scb_rpp_libro_banco_pdf.php","C");
$li_diasem = date('w');
switch ($li_diasem){
...
?>
  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td width="70"><input name="formato"    type="hidden" id="formato"    value="<?php print $ls_reporte; ?>"></td></td>
    </tr>
