...
<form name="form1" method="post" action="">
  ...
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="13" colspan="4" align="center">Estado de Cuenta Formato 1 </td>
    </tr>
    <tr>
...
function ue_search()
{
  ...
  if((ld_fecdesde!="")&&(ld_fechasta!="")&&(ls_codban!="")&&(ls_ctaban!=""))
  {
	//  ls_orden=f.orden.value; 
	   pagina="reportes/sigesp_scb_rpp_libro_banco_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codban="+ls_codban+"&ctaban="+ls_ctaban;
