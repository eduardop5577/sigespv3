...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_conciliacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<?php
	...
	if( array_key_exists("operacion",$_POST))
	{
		...
		$la_hidarray1	= explode('<<<',$ls_hidarray1);
		
		$ls_hidarray2	= $_POST["hidarraycod"];
		$la_hidarray2	= explode('<<<',$ls_hidarray2);
		
		$ls_hidarray3	= $_POST["hidarraychk"];
		$la_hidarray3	= explode('<<<',$ls_hidarray3);
		
		$ls_genmonto	= $_POST["hidgenmonto"];
	}
	else
	{
		$ls_operacion= "NUEVO" ;	
...
if (array_key_exists("hidorden",$_POST))
...
else
   {
	...
	function uf_nuevo()
	{
		...
		$ls_cuenta_banco="";
		global $ls_dencuenta_banco, $ls_codmon, $ls_denmon;
		$ls_dencuenta_banco="";	
                $ls_codmon="";
                $ls_denmon="";        
	...
	if ($ls_operacion=="CARGAR_DT")
	   {
		 ...
		 $li_rows="";
		 $arrResultado="";
		 $arrResultado=$in_classconciliacion->uf_cargar_movimientos_a_conciliar($ls_codban,$ls_cuenta_banco,$object,$ld_desde,$ld_hasta,$li_rows,$ls_filtro,$ls_orden);
	...
	if ($ls_operacion=="GUARDAR")
	   {		
		 ...
		 $li_total=count((array)$la_hidarray1);
	...
	function uf_cargar_montos_conciliacion($as_codban,$as_ctaban,$ld_fecha)
	{
		...
		if($ld_fecha!="")
		{
			...
			if ($ldec_diferencia < 0.0000000001)
			{
				$ldec_diferencia=$ldec_diferencia*(-1);
			}*/
...
?>
  <form name="form1" method="post" action="" id="sigesp_scb_p_conciliacion.php">
<?php
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td colspan="3" align="left">
          <input name="txtcodmon" type="text" id="txtcodmon" style="text-align:center" value="<?php print $ls_codmon; ?>" size="10" maxlength="25" readonly>
          <input name="txtdenmon" type="text" class="sin-borde" id="txtdenmon" style="text-align:left" value="<?php print $ls_denmon; ?>" size="80" maxlength="254" readonly>
      </td>
    </tr>
    <tr>
    ...
    <tr>
	  <td height="13" colspan="4"><div align="center">
        <div align="left">
		<input name="btngenmonto" type="button" class="boton" id="btngenmonto" value="Generar Monto a Conciliar" onClick="javascript:uf_calcular();" <?php print $ls_botn;?>>
		<input name="hidgenmonto" type="hidden" id="hidgenmonto" value="<?php print $ls_genmonto;?>">
		</div>
		<table width="770" border="0" cellpadding="0" cellspacing="0" class="formato-blancotabla">
          ...
          <tr>
            ...
            <td width="120"><div align="left">
              <input name="txtsalsegban" type="text" id="txtsalsegban" style="text-align:right" value="<?php print number_format($ldec_salsegban,2,",",".");?>" onBlur="javascript:uf_format(this);" onFocus="select()">
           </div></td>
...
function ue_guardar()
{
	...
	{
		alert("Genere el monto a conciliar antes de guardar !");
	}
}
...
function uf_verificar_provbene(lb_checked,obj)
{
    ...
    function uf_format(obj)
   {
	...
	function uf_calcular()
	{
		...
		ldec_total=0;
		f.hidgenmonto.value=1;
		f.btngenmonto.disabled=true;
  	...
  	function uf_verificar_conciliacion()
	{
		...
		{
			alert("Genere el monto a conciliar antes de cerrar la conciliación !");
			f.chkcloseconcil.checked=false;
		}
