...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_r_relacion_sel_docs.php",$ls_permisos,$la_seguridad,$la_permisos);
...
else
{
   ...
   if($ls_operacion=="CARGAR_DT")
   {
		...
		$li_total=0;
		$arrResultado=array();
   		$arrResultado=uf_cargar_docs($object_bancos,$li_total,$ls_codban,$ls_ctaban,$ld_fecdesde,$ld_fechasta,$ls_codope);
