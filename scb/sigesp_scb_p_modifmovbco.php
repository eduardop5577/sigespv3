...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_modifmovbco.php",$ls_permisos,$la_seguridad,$la_permisos);
      ...
      <td>
       ...
       <?php
		 ...
		 if($ls_operacion=='CARGAR_DT')
		 {
			...
			$arr_object="";
			$li_total_record="";
	     	$arrResultado=$in_class_contabiliza->uf_select_banco_contabilizar_documento3( $ls_operacion_bco, $arr_object ,$li_total_record,"N",$ls_numdoc,$datos);
