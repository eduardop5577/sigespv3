...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_pago_anticipo.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<?php
	...
	function uf_cargar_dt()
	{
		...
		$ldec_monhab="";
		$arrResultado="";
		$arrResultado=$in_classmovbco->uf_cargar_dt_cont($ls_docmov,$ls_codban,$ls_cuenta_banco,$ls_mov_operacion,$ls_estmov,$objectScg,$li_row,$ldec_mondeb,$ldec_monhab);
	...
	{
		$ls_estmanant="";
		$ls_estmanant=$in_classmovbco->uf_validar_pago_anticipo($ls_estmanant);
		if ($ls_estmanant==0)
		{
			print("<script language=JavaScript>");
