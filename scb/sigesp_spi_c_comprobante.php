...
function uf_guardar_automatico($as_comprobante,$ad_fecha,$as_proccomp,$as_desccomp,$as_prov,$as_bene,$as_tipo,$ai_tipo_comp)
{
	...
	$as_bene="";
	$arrResultado="";
	$arrResultado=$this->uf_valida_datos_cmp($as_comprobante,$ad_fecha,$as_proccomp,$as_desccomp,$as_prov,$as_bene,$as_tipo);
	$lb_valido= $arrResultado["lb_valido"];
	$as_prov=$arrResultado["as_cod_prov"];
	$as_bene=$arrResultado["as_ced_bene"];
...
function uf_valida_datos_cmp($as_comprobante,$ad_fecha,$as_procedencia,$as_desccomp,$as_cod_prov,$as_ced_bene,$as_tipo)
{
	...
	{
	   $this->io_msg->message("Procedencia invalida.",$as_procedencia);
	   $lb_valido= false	;
	} 
	...
	$arrResultado["as_cod_prov"]=$as_cod_prov;
...
function uf_guardar_movimientos($arr_cmp,$ls_cuenta,$ls_procede_doc,$ls_descripcion,$ls_documento,$ls_operacionpre,$ldec_monto_ant,$ldec_monto_act,$ls_tipocomp)
{
	...
	if($ls_mensaje!="")
	{
		...
		$lb_valido="";
		$ldec_monto="";
		$arrResultado=$this->uf_spi_valida_datos_movimiento($ls_cuenta,$ls_descripcion,$ls_documento,$ldec_monto);
		$lb_valido=$arrResultado["lb_valido"];
