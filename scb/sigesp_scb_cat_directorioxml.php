		...
		if(is_dir($as_ruta))
		{
			...
			while ($file = readdir($handle))
			{
				 if(($file != '.') && ($file != '..'))
				 {
					...
					print "<td width='70' height='22'><div align='center'><a href='sigesp_scb_cat_descarga_xml.php?enlace=".$as_ruta."&file=".$file."'><img src='../shared/imagebank/tools20/download.gif' width='20' height='20' border='0'></a></div></td>";
...
function ue_delete(ruta,file)
{
	...
	{
		f=document.form1;
		f.action="sigesp_scb_cat_directorioxml.php?ruta="+ruta+"&file="+file+"";
		f.submit();
	}
}
</script>
