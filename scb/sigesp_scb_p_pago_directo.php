...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_pago_directo.php",$ls_permisos,$la_seguridad,$la_permisos);
...
if (($li_estciespg==1 || $li_estciespi==1) && $ls_operacion=="NUEVO")
   {
	...
	function uf_cargar_dt()
	{
		...
		$ldec_montoret=0;
		$arrResultado=array();
		$arrResultado=$in_classmovbco->uf_cargar_dt($ls_docmov,$ls_codban,$ls_cuenta_banco,$ls_mov_operacion,$ls_estmov,$objectScg,$li_row,$ldec_mondeb,$ldec_monhab,$objectSpg,$li_rows_spg,$ldec_monspg,$objectSpi,$li_rows_spi,$ldec_monspi,$objectRet,$li_rows_ret,$ldec_montoret);
...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr class="titulo-ventana">
	  ...
	  <input name="fuente1x1000" type="hidden" id="fuente1x1000" value="<?php print $ls_fuente1x1000;?>"></td>
    </tr>
    <tr>
      <td colspan="8">&nbsp;</td>
    </tr>
...
Beneficiario</label>
    ...
    <tr>
      ...
      <td><span style="text-align:left">
        ...
        <a href="javascript:uf_cat_deducciones();"></a></span></td>
    </tr>
    <tr>
