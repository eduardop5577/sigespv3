...
$la_seguridad=array();
$la_permisos=array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_transferencias.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<?php
	...
	{			
		...
		//Inserto en el datastore los datos del origen del movimiento
		 ...
		 $arr_data["ced_bene"][1]=$ls_provbene;
		 $arr_data["cod_prov"][1]='----------';
		 $arr_data["debhab"][1]='H'; 
		 $arr_data["scg_cuenta"][1]=$ls_cuenta_scg;
		 $arr_data["nomproben"][1]=$ls_desproben;
		 $arr_data["estmov"][1]='N';	
	     ...
	     $arr_data["chequera"][1]=$ls_numchequera;
		...
		if(array_key_exists("la_deducciones",$_SESSION))
		{
			...
			$li_total=count((array)$la_deducciones["Codded"]);
		...
		//Inserto en el datastore los datos del destino del movimiento
		 ...
		 $arr_datadestino["ced_bene"][$li_row]=$ls_provbene;
		 $arr_datadestino["cod_prov"][$li_row]='----------';
		 $arr_datadestino["nomproben"][$li_row]=$ls_desproben;
		 ...
		 $arr_datadestino["docdestrans"][$li_row]='---------------';
		 $arr_datadestino["tiptrans"][$li_row]=1;
		 $arr_data["docdestrans"][$li_row]=$ls_docdestino;		 
...
?>
  <form name="form1" method="post" action="" id="sigesp_scb_p_transferencias.php">
<?php
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
?>
  ...
  <table width="722" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
     ...
     <tr>
      ...
      <td colspan="3"><div align="left">
        ...
        <a href="javascript:cat_bene();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat&aacute;logo de Bancos"></a>
    ...
    <tr>
      ...
      <td><div align="left">
          <input name="txtmonto" type="text" id="txtmonto" style="text-align:right" onBlur="javascript:uf_format(this);" onKeyPress="return(currencyFormat(this,'.',',',event));" value="<?php print number_format($ldec_montomov,2,",",".");?>" size="24" <?php echo $ls_disabled; ?>>
      </div></td>
      <td><div align="right">
	  ...
	  {
	  ?>
	  <input name="txtmonobjret" type="text" id="txtmonobjret" style="text-align:right" onBlur="javascript:validar_monto();javascript:uf_format(this);" onKeyPress="return(currencyFormat(this,'.',',',event));" value="<?php print  number_format($ldec_monobjret,2,",",".");?>" size="24">
	  <?php
	  }
	  ?>
	  </div></td>
    ...
    <tr>
      <td width="123" height="22"><div align="right">Operaci&oacute;n</div></td>
      <td width="189"><div align="left">
          <select name="cmboperacionorigen" id="cmboperacionorigen" style="width:110px;text-align:center" onChange="javascript:uf_verificar_operacion();" <?php echo $ls_disabled; ?>>
            <option value="CH" <?php print $lb_selCH;?>>Cheque</option>
            <option value="ND" <?php print $lb_selND;?>>Nota de D&eacute;bito</option>
          </select>
         </div></td>
      <td width="228">&nbsp;</td>
      <td width="180">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="3"><div align="left">
          ...
          <a href="javascript:catalogo_cuentabanco(<?php echo $_SESSION["la_empresa"]["confi_ch"]?>);"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat&aacute;logo de Cuentas Bancarias"></a>
    ...
    <tr>
      ...
      <td style="text-align:left"><input name="txtdocorigen" type="text" id="txtdocorigen" style="text-align:center" onBlur="rellenar( this,15)" value="<?php print $ls_docorigen;?>" size="24" maxlength="15" <?php echo $ls_disabled; ?>>
         <?php
         if ($_SESSION["la_empresa"]["confi_ch"]==0 && $ls_opeorigen=='CH')
		    {
		?>
...
function catalogo_cuentabanco(conf_ch)
{
	  ...
	  if (uf_evaluate_cierre('SCG'))
		 {
		   ...
		   if ((ls_codban!=""))
			  {
				pagina="sigesp_cat_ctabancoorigen.php?codigo="+ls_codban+"&denban="+ls_denban+"&conf_ch="+conf_ch;
