...
$la_seguridad=array();
$la_permisos=array();
$arrResultado=$io_fun_scb->uf_load_seguridad("SCB","sigesp_scb_p_recuperacion_creditos.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="20" width="780" colspan="11" bgcolor="#E7E7E7" class="cd-menu"><script type="text/javascript"  src="js/menu.js"></script></td>
  </tr>
  <tr>
...
switch ($ls_operacion){
  ...
  $la_object=array();
  $li_totrows=0;
	$arrResultado = $io_scb->uf_load_movimientos_bancarios($ls_rutfil,$li_totrows);
  $la_object=$arrResultado["la_object"];
  $li_totrows=$arrResultado["li_totrow"];
  break;
  case 'PROCESAR':
    $la_object= uf_load_variables($la_object);
