...
$la_seguridad=Array();
$la_permisos=Array();
$arrResultado=$io_fun_banco->uf_load_seguridad("SCB","sigesp_scb_p_opd_causapaga.php",$ls_permisos,$la_seguridad,$la_permisos);
...
function ue_imprimir()
{
  ...
  if(f.rb_provbene[0].checked)
	...
	ls_provbene=f.txtprovbene.value;
  ls_pagina="reportes/sigesp_scb_rpp_ordenpago.php?codban="+ls_codban+"&ctaban="+ls_ctaban+"&numdoc="+ls_numdoc+"&codope="+ls_codope+"&numdocres="+ls_numdocres+"&fecdocres="+ls_fecdocres+"&nrocontrol="+ls_nrocontrol+"&desope="+ls_desope+"&monto="+ldec_monto+"&tipodestino="+ls_tipo+"&codpro="+ls_codpro+"&cedbene="+ls_cedbene+"&fecmov="+ld_fecha;
