...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
$ls_archivo="reportes/cheque_configurable/medidas_mercantil.txt";
$li_medidas=24;
if(array_key_exists("operacion",$_POST))
{
	...
	$ls_conceptox=$_POST["txtconcepto_x"];
	$ls_conceptoy=$_POST["txtconcepto_y"];
...
function uf_obtener_data_archivo()
{
	...
	else
	{
		...
		if(count((array)$valores)==$li_medidas)
		{
			...
			global $ls_conceptox;
			$ls_conceptox=number_format($valores[16],2,",",".");
			global $ls_conceptoy;
			$ls_conceptoy=number_format($valores[17],2,",",".");
			global $ls_informacionx;
			$ls_informacionx=number_format($valores[18],2,",",".");
			global $ls_informaciony;
			$ls_informaciony=number_format($valores[19],2,",",".");
			global $ls_numerox;
			$ls_numerox=number_format($valores[20],2,",",".");
			global $ls_numeroy;
			$ls_numeroy=number_format($valores[21],2,",",".");
			global $ls_elaboradoporx;
			$ls_elaboradoporx=number_format($valores[22],2,",",".");
			global $ls_elaboradopory;
			$ls_elaboradopory=number_format($valores[23],2,",",".");
...
else
{
	...
	print("</script>");
		...
		//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?> 
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
   
    <tr>
      <td width="398"></td>
    </tr>
    <tr class="titulo-ventana">
      <td height="13" colspan="6" align="center">Configuraci&oacute;n del Formato del Cheque Voucher (Banco Mercantil) </td>
    </tr>
    <tr class="titulo-ventana">
      <td height="556" colspan="6" align="center" class="celdas-blancas"><div align="left"></div>        
	  <table width="306" border="1" align="center" cellpadding="0" cellspacing="1" class="contorno">
          ...
          <tr class="titulo-ventana">
            <td height="41" align="center" class="celdas-blancas">N&uacute;mero de Cheque </td>
            <td height="41" align="center" class="celdas-blancas"><input name="txtnumero_x" type="text" id="txtnumero_x" style="text-align:right" onBlur="javascript:ue_getformat(this)" onKeyPress="return(validaCajas(this,'d',event))" value="<?php print $ls_numerox?>" size="8" maxlength="8"></td>
            <td height="41" align="center" class="celdas-blancas"><input name="txtnumero_y" type="text" id="txtnumero_y" style="text-align:right" onBlur="javascript:ue_getformat(this)" onKeyPress="return(validaCajas(this,'d',event))" value="<?php print $ls_numeroy?>" size="8" maxlength="8"></td>
          </tr>
          <tr class="titulo-ventana">
          ...
          <tr class="titulo-ventana">
            <td height="41" align="center" class="celdas-blancas">Concepto del Movimiento </td>
            <td height="41" align="center" class="celdas-blancas"><label>
              <input name="txtconcepto_x" type="text" id="txtconcepto_x" value="<?php print $ls_conceptox?>" size="8" maxlength="8" style="text-align:right" onKeyPress="return(validaCajas(this,'d',event))" onBlur="javascript:ue_getformat(this)">
            </label></td>
            <td height="41" align="center" class="celdas-blancas"><input name="txtconcepto_y" type="text" id="txtconcepto_y" value="<?php print $ls_conceptoy?>" size="8" maxlength="8" style="text-align:right" onKeyPress="return(validaCajas(this,'d',event))" onBlur="javascript:ue_getformat(this)"></td>
          </tr>
          <tr class="titulo-ventana">
            <td height="41" align="center" class="celdas-blancas">Bloque Informaci&oacute;n </td>
            <td height="41" align="center" class="celdas-blancas"><input name="txtinformacion_x" type="text" id="txtinformacion_x" value="<?php print $ls_informacionx?>" size="8" maxlength="8" style="text-align:right" onKeyPress="return(validaCajas(this,'d',event))" onBlur="javascript:ue_getformat(this)"></td>
            <td height="41" align="center" class="celdas-blancas"><input name="txtinformacion_y" type="text" id="txtinformacion_y" value="<?php print $ls_informaciony?>" size="8" maxlength="8" style="text-align:right" onKeyPress="return(validaCajas(this,'d',event))" onBlur="javascript:ue_getformat(this)"></td>
          </tr>
		  <tr class="titulo-ventana">
            <td height="41" align="center" class="celdas-blancas">Elaborado Por ____ </td>
            <td height="41" align="center" class="celdas-blancas"><input name="txtelaboradopor_x" type="text" id="txtelaboradopor_x" value="<?php print $ls_elaboradoporx?>" size="8" maxlength="8" style="text-align:right" onKeyPress="return(validaCajas(this,'d',event))" onBlur="javascript:ue_getformat(this)"></td>
            <td height="41" align="center" class="celdas-blancas"><input name="txtelaboradopor_y" type="text" id="txtelaboradopor_y" value="<?php print $ls_elaboradopory?>" size="8" maxlength="8" style="text-align:right" onKeyPress="return(validaCajas(this,'d',event))" onBlur="javascript:ue_getformat(this)"></td>
          </tr>
        </table></td>
    </tr>
  </table>
